...
func (b *RaftBackend) CollectMetrics(sink *metricsutil.ClusterMetricSink) {
	...
	sink.SetGauge([]string{"raft", "logstore", "bolt", "freelist", "free_pages"}, float32(stats.FreePageN))
	sink.SetGauge([]string{"raft", "logstore", "bolt", "freelist", "pending_pages"}, float32(stats.PendingPageN))
	sink.SetGauge([]string{"raft", "logstore", "bolt", "freelist", "allocated_bytes"}, float32(stats.FreeAlloc))
	sink.SetGauge([]string{"raft", "logstore", "bolt", "freelist", "used_bytes"}, float32(stats.FreelistInuse))
	sink.SetGauge([]string{"raft", "logstore", "bolt", "transaction", "started_read_transactions"}, float32(stats.TxN))
	sink.SetGauge([]string{"raft", "logstore", "bolt", "transaction", "currently_open_read_transactions"}, float32(stats.OpenTxN))
	sink.SetGauge([]string{"raft", "logstore", "bolt", "page", "count"}, float32(txstats.PageCount))
	sink.SetGauge([]string{"raft", "logstore", "bolt", "page", "bytes_allocated"}, float32(txstats.PageAlloc))
	sink.SetGauge([]string{"raft", "logstore", "bolt", "cursor", "count"}, float32(txstats.CursorCount))
	sink.SetGauge([]string{"raft", "logstore", "bolt", "node", "count"}, float32(txstats.NodeCount))
	sink.SetGauge([]string{"raft", "logstore", "bolt", "node", "dereferences"}, float32(txstats.NodeDeref))
	sink.SetGauge([]string{"raft", "logstore", "bolt", "rebalance", "count"}, float32(txstats.Rebalance))
	sink.AddSample([]string{"raft", "logstore", "bolt", "rebalance", "time"}, float32(txstats.RebalanceTime))
	sink.SetGauge([]string{"raft", "logstore", "bolt", "split", "count"}, float32(txstats.Split))
	sink.SetGauge([]string{"raft", "logstore", "bolt", "spill", "count"}, float32(txstats.Spill))
	sink.AddSample([]string{"raft", "logstore", "bolt", "spill", "time"}, float32(txstats.SpillTime))
	sink.SetGauge([]string{"raft", "logstore", "bolt", "write", "count"}, float32(txstats.Write))
	sink.AddSample([]string{"raft", "logstore", "bolt", "write", "time"}, float32(txstats.WriteTime))
}
