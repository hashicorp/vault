...
package raft // import "github.com/hashicorp/vault/physical/raft"
...
func (*LogOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_7bd5f9d5a428fbac, []int{0}
}
...
func (*LogData) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_7bd5f9d5a428fbac, []int{1}
}
...
func (*IndexValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_7bd5f9d5a428fbac, []int{2}
}
...
func (dst *IndexValue) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IndexValue.Merge(dst, src)
}
...
func (*Server) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_7bd5f9d5a428fbac, []int{3}
}
...
func (*ConfigurationValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_7bd5f9d5a428fbac, []int{4}
}
...
func (dst *ConfigurationValue) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConfigurationValue.Merge(dst, src)
}
...
func init() { proto.RegisterFile("physical/raft/types.proto", fileDescriptor_types_7bd5f9d5a428fbac) }

var fileDescriptor_types_7bd5f9d5a428fbac = []byte{
