...
sidebar_current: "docs-concepts-namespaces"
description: |-
  Vault can support secure multitenancy, providing isolation and self-management for teams and groups.
---

# Namespaces 

Vault supports implementing Secure Multi-Tenancy (SMT) by providing isolated
environments for teams to operate within and self-manage. These environments 
are known as namespaces, self-containe 
