...
- `connection_timeout` `(integer: 60 or string: "60s")` - Timeout, in seconds, when attempting to connect to the LDAP server before trying the next URL in the configuration.
