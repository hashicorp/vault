...
- `disable_escaping` `(boolean: false)` - Determines whether special characters in the
  username and password fields will be escaped into their percent-encoding. Useful for
  alternate connection string formats like ADO. Defaults to `false.`
