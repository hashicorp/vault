---
layout: api
page_title: InfluxdbV2 - Database - Secrets Engines - HTTP API
description: >-
  The InfluxdbV2 plugin for Vault's database secrets engine generates database
  credentials to access InfluxdbV2 servers. This is the token based access control version of Influxdb
---

# InfluxdbV2 Database Plugin HTTP API

The InfluxdbV2 database plugin is one of the supported plugins for the database
