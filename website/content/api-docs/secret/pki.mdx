...
- `allow_different_signature_algorithm` `(bool: false)` - If true, allows the submitted 
certificate to be signed when the signature algorithm does not match that of the root.
