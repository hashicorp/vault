...
manage protocol](https://datatracker.ietf.org/doc/html/rfc8555) for issuing
...
have a valid external account binding. Before registering a new account,
...
ACME protocol. With EAB however, an Vault authenticated client will have to
...
$ curl \
    --header "X-Vault-Token: ..." \
    --request LIST \
    http://127.0.0.1:8200/v1/pki/acme/eab
```
...
$ curl \
    --header "X-Vault-Token: ..." \
    --request DELETE \
    http://127.0.0.1:8200/v1/pki/acme/eab/bc8088d9-3816-5177-ae8e-d8393265f7dd
```
...
#### Parameters
 ...
 - `allowed_issuers` `(list: ["*"])` - Specifies a list issuers to allow to
