...
- `allowed_serial_numbers` `(string: "")` – Defines allowed Subject serial 
  numbers. This can be a comma-delimited list or a JSON string slice. 
  Values can contain glob patterns.
