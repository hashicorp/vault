...
- `state`: one of _Inactive_, _Running_, _Finished_, _Error_
...
- `message`: One of _Tidying certificate store: checking entry N of TOTAL_ or
  _Tidying revoked certificates: checking certificate N of TOTAL_
