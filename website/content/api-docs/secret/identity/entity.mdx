...
<Warning>
It is recommended to execute merges from the primary cluster's leader node. For additional information, please refer to the release notes of the respective version in use.
</Warning>
