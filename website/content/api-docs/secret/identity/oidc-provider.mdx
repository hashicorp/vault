...
- `id_token_ttl` `(int or duration: <optional>)` – The time-to-live for ID tokens obtained by the client.
  Can be specified as a number of seconds or as a [Go duration format string](https://golang.org/pkg/time/#ParseDuration)
...
- `access_token_ttl` `(int or duration: <optional>)` – The time-to-live for access tokens obtained by the client.
  Can be specified as a number of seconds or as a [Go duration format string](https://golang.org/pkg/time/#ParseDuration) like `"30m"` or `"6h"`.
