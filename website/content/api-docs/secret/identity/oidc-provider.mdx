...
- `name` `(string: <required>)` – The name of the provider to create. This parameter is specified as part of the URL.
...
- `name` `(string: <required>)` – The name of the scope to create. This parameter is specified as part of the URL. The `openid` scope name is reserved.
...
- `name` `(string: <required>)` – Name of the scope.
