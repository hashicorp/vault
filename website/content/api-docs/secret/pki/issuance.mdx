...
- `restrict_ca_chain_to_issuer` `(bool: false)` - whether to return the full CA chain within GetCACert responses, this
  should be set to `true` for compatibility with Microsoft Intune.
