...
- `service_account_name` `(string: "")` - The pre-existing service account to
  ...
  a Kubernetes token will be created. See the
...
- `kubernetes_role_name` `(string: "")` - The pre-existing Role or ClusterRole
  ...
  account, and role binding objects will be created. See the
  [Kubernetes roles documentation](https://kubernetes.io/docs/reference/access-authn-authz/rbac/#role-and-clusterrole)
  for more details.
...
- `generated_role_rules` `(string: "")` - The Role or ClusterRole rules to use
  ...
  entire chain of Kubernetes objects will be generated. The value should be the
  `rules` key and an array of [PolicyRule](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#policyrule-v1-rbac-authorization-k8s-io)
...
- `extra_annotations` `(map<string|string>: nil)` - Additional annotations to
  apply to all generated object in Kubernetes. See the [Kubernetes annotations documentation](https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations/)
  for more details.
  - `extra_labels` `(map<string|string>: nil)` - Additional labels to apply to
  all generated object in Kubernetes. See the [Kubernetes labels documentation](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/)
  for more details.
