...
- `rotation_period` `(string/int)` – Enterprise Only: Specifies the amount of time Vault should
...
- `rotation_schedule` `(string)` – Enterprise Only: A cron-style string that will define the
...
- `rotation_window` `(string/int)` – Enterprise Only: Specifies the amount of time in which the
