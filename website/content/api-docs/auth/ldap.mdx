...
- `rotation_period` `(string: "0")` – <EnterpriseAlert product="vault" inline />
  The amount of time, in [duration format](/vault/docs/concepts/duration-format),
...
- `rotation_window` `(string: "0")` – <EnterpriseAlert product="vault" inline />
  The maximum amount of time, in
  [duration format](/vault/docs/concepts/duration-format), allowed to complete
