...
- `vm_name` `(string: "")` - The virtual machine name for the machine that
  generated the MSI token. This information can be obtained through instance
  metadata. If _vmss_name_ is provided, this value is ignored.
- `vmss_name` `(string: "")` - The virtual machine scale set name for the machine
  ...
  metadata.
- `resource_id` `(string: "")` - The resource ID for the Azure resource that
  generated the MSI token. If _vm_name_ or _vmss_name_ is provided, this value
  is ignored.
