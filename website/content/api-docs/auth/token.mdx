...
## List Details of Each Token Accessor

Returns information about each token accessor.

| Method | Path                           |
| :----- | :----------------------------- |
| `GET`  | `/auth/token/accessors/detail` |
...
$ curl \
    --header "X-Vault-Token: ..." \
    http://127.0.0.1:8200/v1/auth/token/accessors/detail
```
...
```json
{
  "request_id": "ae66f314-9933-1047-74d9-23a8ec87f755",
  "lease_id": "",
  "lease_duration": 0,
  "renewable": false,
  "data": {
    "accessors": [
      {
        "accessor_id": "QoXSVZpzmL9AkPYvgxR1SxfH",
      ...
      {
        "accessor_id": "aMlFUgL0xmQ4qNcftb9gyAsg",
        "token_display_name": "root",
        "token_policies": [
          "root"
        ],
        "token_role": "",
