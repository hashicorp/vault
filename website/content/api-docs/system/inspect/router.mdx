...
# `/sys/raw`
The `/sys/internal/inspect/router` is intended to inspect a specific internal subsytem for debugging purposes.
It can be accessed with a root token or sudo priveleges.
...
| Method | Path          |
| :----- | :------------ |
| `GET`  | `/sys/internal/inspect/router/stroage` |
