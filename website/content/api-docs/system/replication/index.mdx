...
This endpoint prints information about the corruption status of the merkle tree.
This endpoint would offer a certain level of assurance that issues with replication
can be resolved through reindexing. This is desirable in particular since reindexing
can be time-consuming and lead to downtime, which may not be appealing to customers.
Thus, the endpoint serves as a valuable aid in helping customers decide whether a
