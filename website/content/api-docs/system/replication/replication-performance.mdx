...
This endpoint changes a performance secondary cluster's assigned primary cluster. This does not
...
way to call `update-primary`. When this is used, Vault does a lot of extra work behind the scenes.
...
works best for performance secondary clusters.
