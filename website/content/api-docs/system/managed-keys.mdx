...
- `endpoint` `(string: "")`: Used to specify a custom AWS endpoint. This can also be provided in
the `AWS_KMS_ENDPOINT` environment variable. If not set, Vault will use the default API endpoint
for your region.
