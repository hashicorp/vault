...
all child namespaces of the specified path namespace will inherit this quota. `inheritable` cannot be set to true if the path does not specify a namespace. All global quotas are inheritable by default. All namespace quotas
