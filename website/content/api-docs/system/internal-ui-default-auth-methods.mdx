...
The `/sys/internal/ui/default-auth-methods` endpoint is used to return explicitly set or inherited default and backup auth methods for a given namespace.
...
This endpoint returns any configured or inherited default and backup auth methods for a given namespace.
