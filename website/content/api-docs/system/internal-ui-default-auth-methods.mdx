...
The `/sys/internal/ui/default-auth-methods` endpoint is used to return explicitly set or inherited default and backup auth method types for a given namespace.
