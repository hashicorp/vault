...
The `/sys/internal/counters` endpoints are used to return data about the number of Clients and Entities in Vault. They return information for the entire cluster.
