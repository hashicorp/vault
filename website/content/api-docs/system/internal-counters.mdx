...
- This endpoint can be called from all namespaces. The requested namespace (specified via the `X-Vault-Namespace`
  header or as part of the path) will act as a filter. The exported data will include activity for the requested
...
```json
{
  "entity_name": "3f210722-7210-98e8-1f0d-e6a39ffb29c6",
...

{
  ...
  "entity_alias_metadata": null,
  "entity_alias_custom_metadata": null,
  "entity_group_ids": null
}
