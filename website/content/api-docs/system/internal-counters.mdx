...
The `/sys/internal/counters` endpoints are used to return data about the number of Tokens and Entities in Vault. The information returned by these endpoints are cluster level values.
