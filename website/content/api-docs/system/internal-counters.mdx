...
- `start_time` `(string, optional)` - An RFC3339 timestamp or Unix epoch time. Specifies the start of the
  ...
  The [billing start date](/docs/concepts/billing-start-date) is automatically updated to the date in the most recent billing year i.e; billing start dates from 
...
<Note>
    As of 1.15.13, 1.16.7, 1.17.3, 1.18 and later, the billing start date (license start date if not configured) will automatically rollover to the latest billing year. 
    Refer to <a href="/vault/docs/upgrading/upgrade-to-1.15.x#auto-roll-billing-start-date">Upgrade to 1.15.x</a>, <a href="/vault/docs/upgrading/upgrade-to-1.16.x#auto-roll-billing-start-date">Upgrade to 1.16.x</a>, <a href="/vault/docs/upgrading/upgrade-to-1.17.x#auto-roll-billing-start-date">Upgrade to 1.17.x</a>, <a href="/vault/docs/upgrading/upgrade-to-1.18.x#auto-roll-billing-start-date">Upgrade to 1.18.x</a>, for additional information on auto-roll billing start date.
</Note> 
