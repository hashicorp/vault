...
[transit](/docs/secrets/transit) keys, GET requests of key/value
...
- [Performance Standby Nodes](/docs/enterprise/performance-standby)
...
[`disable_performance_standby`](/docs/configuration#vault-enterprise-parameters)
flag to `true`.
