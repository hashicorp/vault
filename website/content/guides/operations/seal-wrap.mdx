...
**_Vault Enterprise_** integrates with [HSM platforms](/docs/enterprise/hsm)
to opt-in automatic [unsealing](/docs/concepts/seal#unsealing).
...
- [Seal Wrap documentation](/docs/enterprise/sealwrap)
- [Vault Configuration - pkcs11 Seal](/docs/configuration/seal/pkcs11)
- [Vault Enterprise HSM Support](/docs/enterprise/hsm)
...
- Conformance with FIPS 140-2 directives on Key Storage and Key Transport as [certified by Leidos](/docs/enterprise/sealwrap#fips-140-2-compliance)
...
file must define the [`PKCS11 seal` stanza](/docs/configuration/seal/pkcs11)
...
generate the key yourself. Refer to the [key generation attributes](/docs/configuration/seal/pkcs11#vault-key-generation-attributes).
...
Sharing](/docs/enterprise/hsm/behavior#initialization), similar to Vault's
