...
- [Templated Policies](/docs/concepts/policies#templated-policies)
- [Policy API](/api/system/policy)
...
Enterprise](/docs/enterprise/sentinel).
...
Identities](/docs/secrets/identity) to inject values into ACL policy
paths.
