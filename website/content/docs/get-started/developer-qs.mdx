...
- A development environment applicable to one of the languages in this quickstart (currently **Go**, **Ruby**, **C#**, **Python**, and **Java (Spring)**)
...
- [Go](https://pkg.go.dev/github.com/hashicorp/vault/api) (official): `go get github.com/hashicorp/vault/api`
- [Ruby](https://github.com/hashicorp/vault-ruby) (official): `gem install vault`
- [C#](https://github.com/rajanadar/VaultSharp): `dotnet add package VaultSharp`
- [Python](https://github.com/hvac/hvac): `pip install hvac`
- [Java (Spring)](https://spring.io/projects/spring-vault): Add the following to pom.xml:
...
The complete code samples for the steps you've just performed in this quickstart are available here:
