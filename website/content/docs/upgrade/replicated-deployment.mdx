...
[Pre-1.11 Vault deployments or deployments without autopilot upgrade automation](https://developer.hashicorp.com/vault/docs/v1.13.x/upgrading/vault-ha-upgrade).
