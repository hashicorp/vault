...
Dead server cleanup automatically removes those nodes from the Raft, that are
deemed failed, avoiding the manual operator intervention. This feature can be
...
By default, Autopilot will be enabled with clusters using Vault 1.7+. Upgrade of
