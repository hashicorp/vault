...
Vault uses the [/sys/internal/ui/resultant-acl](/vault/api-docs/system/internal-ui-resultant-acl)
endpoint to repackage information used by the UI. If you do not have have
