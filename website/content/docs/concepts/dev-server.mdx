...
- **AppRole Authentication** - The server will be automatically initialized
  with an `approle` authentication method for exploring a common method to
  authenticate applications.
- **Sample Secret** - The server will be automatically initialized
  with a secret stored in the KVv2 secrets engine.
