...
User lockout parameters be configured using config file for "all" auth methods or a specific auth method (userpass, ldap or approle).
...
Please see [sys/lockedusers API](/api-docs/system/user-lockout) for more details. 