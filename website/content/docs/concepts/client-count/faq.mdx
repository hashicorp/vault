...
- For the example above, say I do not have an entity `prat` in `ns2/`. That will result in a creation of a default entity in the target mount (`ns2/`). This increases the client count by 1.
