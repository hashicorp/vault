...
- Vault 1.9:
  ...
  - Added ability to display clients per namespace (top 10, descending order) in the UI and export data for all namespaces. Prior to Vault 1.9, you could not view the split of clients per namespace on the UI, nor could you export this data via the UI.
