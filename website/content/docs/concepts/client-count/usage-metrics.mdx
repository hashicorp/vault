...
![Query](/img/ui-client-usage-period.png)
...
![Namespace attribution example](/img/ui-client-usage-namespace.png)
...
![Client usage by mount attribution](/img/ui-client-usage-mounts.png)
