...
namespaces and auth mounts. The **Vault Client Usage** dashboard on Vault UI
...
1. Select **Edit configuration**.
   ...
   ![Edit configuration](/img/ui-client-usage-config.png)
...
- **ACME clients** are the ACME connections that authenticate under the same
  ...
  for more details.
    ...
    ![ACME clients example](/img/ui-client-usage-acme.png)
...
![Query](/img/ui-client-usage-period-enterprise.png)

For Vault CE, under the **Client counting period**, select **Edit** to query the data for
a different billing period.
![Query](/img/ui-client-usage-period-ce.png)
...
![Filter by namespace](/img/ui-client-usage-filter.png)
...
![Metrics UI](/img/ui-client-usage-export.png)
