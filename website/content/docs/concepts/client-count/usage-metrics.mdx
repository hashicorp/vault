...
1. Sign into Vault UI. 

   ![Vault UI default dashboard example](/img/ui-client-count.png)

   The main dashboard displays the total number of clients for the current
   billing period. 

1. Select **Details** to open the **Vault Usage Metrics** dashboard.
...
```shell-session
$ vault operator usage -ns education
