...
Vault ships with a Default Password Policy and this gets applied to any password that Vault 
generates where a custom password policy is not explicitly set. The default password policy is 
defined below.

<details>
<summary>20 characters long and it will contain at least 1 uppercase, 1 lowercase, 1 numeric, 1 <code>-</code> (hyphen character)</summary>
