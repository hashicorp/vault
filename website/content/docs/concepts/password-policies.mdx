...
description: >-
  Password policies are used in some secret engines to allow users to define how
  passwords are generated for dynamic & static users within those engines.
---
...
1. A character set (charset) to select characters from.
