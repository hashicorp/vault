...
<Warning title="You can only have 1 fallback device">
  ...
  Choose your fallback audit device carefully. Regadless of type, you can only designate one
  fallback **out of all your active audit devices regardless of type** to act as backup for your entire Vault installation.
</Warning>
