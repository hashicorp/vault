...
seal configured independently of the primary, and if properly configured guard 
against _some_ of this risk.  Unreplicated items such as local mounts could still 
be lost.
