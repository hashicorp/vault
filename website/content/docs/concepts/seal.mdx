...
in the keyring. But Vault encrypts the encryption key using another key known as the root key.
...
You can perform an online migration between auto-unseal types except for any Shamir
seals using Seal High Availability (Seal HA) without
any downtime.
