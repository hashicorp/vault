...
to customize how usernames are generated for said external systems. This uses the
...
truncated value will be the first 8 characters of the SHA256 hash of the truncated characters.<br/>
