...
Plugin binaries can be obtained from [releases.hashicorp.com](https://releases.hashicorp.com/)
...
To run an external Enterprise plugin, an `.zip` artifact of the plugin is required.
Enterprise plugin artifacts can be obtained from
