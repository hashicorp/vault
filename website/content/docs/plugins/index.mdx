...
or they can be [built from source](/docs/internals/plugins/plugin-development#building-a-plugin-from-source).
...
can be made to implement [plugin multiplexing](/docs/internals/plugins/plugin-architecture#plugin-multiplexing)
