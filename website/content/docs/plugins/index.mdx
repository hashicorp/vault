...
Vault supports 3 types of plugin; auth methods, secret engines, and database
...
Starting in 1.12.0, Vault supports managing, running and upgrading plugins using
