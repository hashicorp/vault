...
The adoption of Cloud means organizations shift away from static infrastructure to now provisioning and managing dynamic infrastructure. This implies distribution of services, embracing ephemerality and immutability, and the ability to deploy onto multiple target environments. 
...
Vault safely store credentials, keys, and other types of secrets without deplying and managing a complex key management infrastructure.

- Read the [Versioned Key/Vault Secrets Engine](https://learn.hashicorp.com/tutorials/vault/versioned-kv?in=vault/secrets-management) tutorial and learn how a versioned key-value secrets engine protects your static secrets.
...
- Read the [Dynamic Secrets: Database Secrets Engine](https://learn.hashicorp.com/tutorials/vault/database-secrets) tutorial and learn how Vault can dynamically manage your database credentials.
