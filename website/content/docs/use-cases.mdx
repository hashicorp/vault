...
Try our [Encryption as a Service: Transit Secrets Engine](https://learn.hashicorp.com/collections/vault/encryption-as-a-service) tutorial to learn the essential workings of the Transit secrets engine handles cryptographic functions on data in-transit.
