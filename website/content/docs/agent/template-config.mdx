...
`static_secret_refresh_interval` `(string or integer: 5m)` - If specified, configures
  how often Vault Agent Template should fetch non-leased secrets such as KV v2.
