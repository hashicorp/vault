...
1. A file containing credentials
1. From any identity services available in its physical environment like container environment variables or role-based instance metadata
