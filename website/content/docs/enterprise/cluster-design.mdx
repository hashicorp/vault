...
Vault clusters and replicated storage interact.
...
## Step 1: Design the general architecture
...
1. Review the [Terraform intro](https://developer.hashicorp.com/terraform/intro).
