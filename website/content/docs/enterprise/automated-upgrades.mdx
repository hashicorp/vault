...
Vault Enterprise Automated Upgrades allows operators to upgrade the version of Vault running in
a cluster in an automated fashion. There are a few different ways to make this upgrade happen,
...
style deploy is desired, Vault can be made to use a version of your choosing, regardless of
what version of Vault is currently running.
...
If this is present, it will override the actual version of Vault that is running for the purposes of
automated upgrades.
