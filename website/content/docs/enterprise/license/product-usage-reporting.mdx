...
| `vault.operator.import.kv.version2.secrets.source.vault.count` | The total secrets imported by operator import command which had source vault.      |
| `vault.operator.import.kv.version2.secrets.source.aws.count`   | The total secrets imported by operator import command which had source aws.        |
| `vault.operator.import.kv.version2.secrets.source.gcp.count`   | The total secrets imported by operator import command which had source gcp.        |
| `vault.operator.import.kv.version2.secrets.source.azure.count` | The total secrets imported by operator import command which had source azure.      |
| `vault.operator.import.kv.version2.secrets.count`              | The total secrets imported by operator import command.                             |
