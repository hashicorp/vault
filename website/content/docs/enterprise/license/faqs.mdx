...
This FAQs section is for the license changes introduced in Vault Enterprise 1.8. We will no longer support the old license system (`vault write sys/license`), and autoload will be the only way to manage your license.

- [Q: When will these licensing changes be release for Vault?](#q-when-will-these-licensing-changes-be-released-for-vault)
