...
- `metadata` - Optional product-specific metadata
   ...
   <Note>
    As of 1.16.7, 1.17.3 and later, the <a href="concepts/billing-start-date">billing start date</a> will automatically rollover to the most recent year. 
    Refer to <a href="upgrading/upgrade-to-1.16.x#auto-roll-billing-start-date">Upgrade to 1.16.x</a>, <a href="upgrading/upgrade-to-1.17.x#auto-roll-billing-start-date">Upgrade to 1.17.x</a>, for additional information on auto-roll billing start date.
    </Note> 
