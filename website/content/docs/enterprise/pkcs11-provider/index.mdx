...
-> **Note**: This feature is part of the [KMIP Secret Engine](https://developer.hashicorp.com/vault/docs/secrets/kmip), which requires [Vault Enterprise](https://www.hashicorp.com/products/vault/)
