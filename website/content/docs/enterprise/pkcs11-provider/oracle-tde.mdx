...
1. Set WALLET_ROOT and TDE_CONFIGURATION parameters on the Oracle database.
   ...
   ~> **Note**: The directory is a root wallet directory and is only required for the purposes of setting `TDE_CONFIGURATION`. More on these parameters in the [Oracle databse Documentation](https://docs.oracle.com/en/database/oracle/oracle-database/19/refrn/TDE_CONFIGURATION.html).
