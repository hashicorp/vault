...
for Vault to be able to act accordingly.

<Note title="Request's Namespace">
  The Namespace on a request may be specified either as part of the path or the
...
The requested operation, one of the following:
