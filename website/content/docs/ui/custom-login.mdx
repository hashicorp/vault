...
users. You can customize your login flow with a default authentication method,
...
@include 'gui-instructions/enable-auth-plugin.mdx'
...
@include 'gui-instructions/update-auth-plugin.mdx'
...
## Step 4: Set your preferred authentication methods ((#step4))
