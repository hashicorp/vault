...
_*When specifying a path for the direct link, the corresponding mount’s [listing_visibility](/vault/api-docs/system/auth#listing_visibility-1) must be tuned to `unauth`._
