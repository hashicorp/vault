...
(`auth_kubernetes_bcecb1e1`) from the [`sys/auth`](https://developer.hashicorp.com/vault/api-docs/system/auth) endpoint or the [`vault auth list`](https://developer.hashicorp.com/vault/docs/commands/auth/list) command.
