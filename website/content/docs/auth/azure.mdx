...
## Known issues and workarounds
 ### Description
 One reported [GitHub issue](https://github.com/hashicorp/vault-plugin-auth-azure/issues/141#issuecomment-2757840078), where workload running inside AKS uses Azure Auth Method configured on vault server (hosted on Azure VM), it throws following error. 
