...
associated claim must include at least one of the following claims
to pass validation: `xms_mirid` or `xms_az_rid`.

Vault also expects specific metadata and identity information depending on your
system configuration.

System assigned managed identity | User-assigned identity| Identity specified in Azure managed identity REST endpoint
-------------------------------- | ----------------------| ----------------------------------------------------------
Enabled                          | Any                   | Not required
Not enabled                      | 1                     | Not required
Not enabled                      | Multiple              | Required
...
#### When System-assigned managed identity is enabled

Claim        | Required format
------------ | ---------------
`xms_mirid`  | `/subscriptions/{subscription-id}/resourcegroups/{resource-group-name}/providers/Microsoft.Compute/virtualMachines/{virtual-machine-name}`
`xms_az_rid` | Does not exist

#### When System-assigned managed identity is not enabled

Claim        | Required format
------------ | ---------------
`xms_mirid`  | `/subscriptions/{subscription-id}/resourcegroups/{resource-group-name}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{user-assigned-managed-identity}`
`xms_az_rid` | `/subscriptions/{subscription-id}/resourcegroups/{resource-group-name}/providers/Microsoft.Compute/virtualMachines/{virtual-machine-name}`
...
When Vault evaluates the claim, it checks the validation parameter values
