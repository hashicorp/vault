...
The auth method uses the Okta [Authentication API](https://developer.okta.com/docs/reference/api-docs/authn/).
It does not manage Okta [sessions](https://developer.okta.com/docs/reference/api-docs/sessions/) for authenticated
