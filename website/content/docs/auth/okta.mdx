...
It does not manage an Okta [session](https://developer.okta.com/docs/reference/api/sessions/) for the
user. This means that if MFA Push is configured, it will be required during both login and token renewal.
