...
1. Vault extracts the `kid` header value, which contains the ID of the
...
1. Vault authorizes the confirmed service account against the given role. If
...
1. Vault authorizes the confirmed instance against the given role, ensuring
