---
layout: docs
page_title: Use multi-factor authentication (MFA)
description: >-
  Use Multi-Factor Authentication (MFA) with Vault to add an extra level of
  user verification to your authentication workflow for Vault.
---

# Use multi-factor authentication (MFA)

Vault supports Use multi-factor authentication (MFA) for authenticating to
