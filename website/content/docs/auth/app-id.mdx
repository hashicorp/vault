...
1. Store the app IDs within configuration management systems.

1. An out-of-band process run by security operators map unique user IDs to
...
1. A new server is provisioned. Configuration management configures the app
