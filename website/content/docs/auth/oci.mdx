...
1.  Log into Vault using the user API key.
    ...
    - [Add an API Key](https://docs.cloud.oracle.com/iaas/Content/api-docs/Concepts/apisigningkey.htm) for a user in the console. This user should be part of a group that has previously been added to the Vault admin role.
    - Create the config file `~/.oci/config` using the user's credentials as detailed in [https://docs.cloud.oracle.com/iaas/Content/api-docs/Concepts/sdkconfig.htm](https://docs.cloud.oracle.com/iaas/Content/api-docs/Concepts/sdkconfig.htm).
...
With User credentials: [SDK Config](https://docs.cloud.oracle.com/iaas/Content/api-docs/Concepts/sdkconfig.htm)
