...
- [AppRole](/content/docs/auth/approle)
- [Amazon Web Services (AWS)](/content/docs/auth/aws)
...
- [GitHub](/content/docs/auth/github)
...
- [Okta](/content/docs/auth/okta)
- [Oracle Cloud Infrastructure (OCI)](https://github.com/hashicorp/vault-plugin-auth-oci)
- [RADIUS](/content/docs/auth/radius)
- [TLS Certificates](/content/docs/auth/cert)
- [Username/Password](/content/docs/auth/userpass)
...
- [Cassandra](/content/api-docs/secret/databases/cassandra)
...
- [InfluxDB](/content/docs/secrets/databases/influxdb)
- [HanaDB](/content/docs/secrets/databases/hanadb)
- [MongoDB](/content/docs/secrets/databases/mongodb)
- [MongoDB Atlas](https://github.com/hashicorp/vault-plugin-database-mongodbatlas)
- [MSSQL](/content/docs/secrets/databases/mssql)
- [MySQL/MariaDB](/content/docs/secrets/databases/mysql-maria)
- [Oracle Database](https://github.com/hashicorp/vault-plugin-database-oracle) <Tag title='external' color='yellow' />
- [PostgreSQL](/content/docs/secrets/databases/postgresql)
- [Redshift](/content/docs/secrets/databases/redshift)
...
- [Amazon Web Services AWS](/content/api-docs/secret/aws)
- [Azure](https://github.com/hashicorp/vault-plugin-secrets-azure)
- [Consul](/content/docs/secrets/consul)
...
- [KMIP](/content/api-docs/secret/kmip) <sup>ENTERPRISE</sup>
...
- [Nomad](/content/docs/secrets/nomad)
- [OpenLDAP](https://github.com/hashicorp/vault-plugin-secrets-openldap)
- [PKI](/content/docs/secrets/pki)
- [RabbitMQ](/content/docs/secrets/rabbitmq)
- [SSH](/content/docs/secrets/ssh)
- [TOTP](/content/docs/secrets/totp)
- [Transform](/content/docs/secrets/transform) <sup>ENTERPRISE</sup>
- [Transit](/content/docs/secrets/transit)
