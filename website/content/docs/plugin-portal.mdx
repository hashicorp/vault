...
- [AppRole](/website/content/api-docs/auth/approle)
- [Amazon Web Services (AWS)](/website/content/api-docs/auth/aws)
...
- [GitHub](/website/content/api-docs/auth/github)
...
- [Okta](/website/content/api-docs/auth/okta)
- [Oracle Cloud Infrastructure (OCI)](https://github.com/hashicorp/vault-plugin-auth-oci)
- [RADIUS](/website/content/api-docs/auth/radius)
- [TLS Certificates](/website/content/api-docs/auth/cert)
- [Username/Password](/website/content/api-docs/auth/userpass)
...
- [InfluxDB](/website/content/api-docs/secret/databases/influxdb)
- [HanaDB](/website/content/api-docs/secret/databases/hanadb)
- [MongoDB](/website/content/api-docs/secret/databases/mongodb)
- [MongoDB Atlas](https://github.com/hashicorp/vault-plugin-database-mongodbatlas)
- [MSSQL](/website/content/api-docs/secret/databases/mssql)
- [MySQL/MariaDB](/website/content/api-docs/secret/databases/mysql-maria)
- [Oracle Database](https://github.com/hashicorp/vault-plugin-database-oracle) <Tag title='external' color='yellow' />
- [PostgreSQL](/website/content/api-docs/secret/databases/postgresql)
- [Redshift](/website/content/api-docs/secret/databases/redshift)
...
- [Consul](/website/content/api-docs/secret/consul)
...
- [Nomad](/website/content/api-docs/secret/nomad)
- [OpenLDAP](https://github.com/hashicorp/vault-plugin-secrets-openldap)
- [PKI](/website/content/api-docs/secret/pki)
- [RabbitMQ](/website/content/api-docs/secret/rabbitmq)
- [SSH](/website/content/api-docs/secret/ssh)
- [TOTP](/website/content/api-docs/secret/totp)
- [Transform](/website/content/api-docs/secret/transform) <sup>ENTERPRISE</sup>
- [Transit](/website/content/api-docs/secret/transit)
