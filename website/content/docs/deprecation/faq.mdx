...
- [Q: I'd like to become a community maintainer of `vault-ruby` or `vault-rails`. What should I do?](#q-ruby-libraries) 
...
### Q: I'd like to become a community maintainer of `vault-ruby` or `vault-rails`. What should I do?

You can take over maintenance of the [Ruby Client](https://github.com/hashicorp/vault-ruby) or the [Rails Plugin](https://github.com/hashicorp/vault-rails) by forking their linked repositories and opening a GitHub issue.

The GitHub issue should mention this FAQ and the deprecation notice. We'll likely need a bit of time to assess the repository, after which we'll be able to update our community-supported resources [page](https://developer.hashicorp.com/vault/api-docs/libraries#community).
