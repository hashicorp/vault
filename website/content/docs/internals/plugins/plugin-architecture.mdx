...
As of Vault 1.10, database plugins can be made to implement plugin multiplexing
...
non-multiplexed plugin, simply run an older version of the plugin. i.e. the
plugin calls the `dbplugin.Serve` function.
