...
description: >-
  Technical reference for Raft (integrated storage) related telemetry values.
--- 

# Raft telemetry

Raft telemetry provides information on the Raft-based,
[integrated storage](/vault/docs/configuration/storage/raft) used by your Vault
instance.
...
@include 'telemetry-metrics/vault/raft/delete_prefix.mdx'

@include 'telemetry-metrics/vault/raft/delete.mdx'
...
@include 'telemetry-metrics/vault/raft/put.mdx'
