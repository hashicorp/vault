...
-> **Note:** Knowledge of Vault internals is recommended but not required to use Vault. However, if you're operating fault, we recommend understanding the internals.
