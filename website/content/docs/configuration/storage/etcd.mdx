...
be decommissioned by Etcd v3.6. Support for Etcd v2 API has been removed in Vault
1.16.0. Users of the Etcd storage backend should [migrate](/vault/docs/commands/operator/migrate)
Vault storage to an Etcd v3 cluster. All storage migrations should have
[backups](/vault/docs/concepts/storage#backing-up-vault-s-persisted-data) taken prior to upgrade.
