...
- **High Availability** – the Azure storage backend supports high
  availability. Because the Azure storage backend uses the system
...
This example shows configuring the Azure storage backend with high availability
enabled.
