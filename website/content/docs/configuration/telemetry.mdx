...
A value of "none" disables the collection. Uses [time format strings](/configuration/time-format).
...
minutes. Uses [time format strings](/configuration/time-format).
...
Uses [time format strings](/configuration/time-format).
