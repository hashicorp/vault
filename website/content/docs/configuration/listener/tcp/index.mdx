...
<Note title="Sweet32 and 3DES">
  ...
  long lived connections. According to the [vulnerability disclosure](https://sweet32.info/), Sweet32 took a
  ...
  the team did [de-prioritize 3DES](https://github.com/golang/go/issues/45430) in favor of AES-based ciphers.
