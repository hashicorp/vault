...
- `request_limiter` `([Request Limiter][request-limiter]: <none>)` – Allows operators to disable Vault's Request Limiter functionality.
...
[request-limiter]: /vault/docs/configuration/request-limiter
