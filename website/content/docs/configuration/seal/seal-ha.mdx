...
In order to use Seal HA, there must be more than one defined [`seal` stanza](..) 
...
Here is a hypothetical configuration for an [AWS seal](awskms) compatible with Seal
HA:
