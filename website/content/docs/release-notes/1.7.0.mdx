...
- **Client Controlled Consistency (Enterprise):** New options to use one of two configurable headers to control the consistency of reads after writes to performance secondary clusters and performance standby nodes.
