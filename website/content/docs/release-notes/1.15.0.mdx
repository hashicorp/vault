...
<table>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle', textAlign: 'center'}}>BETA</td>
    <td style={{verticalAlign: 'middle'}}>
      Sync sensitive data between Vault and AWS, Azure, Google Cloud Platform
      (GCP), GitHub, or Vercel.
      <br /><br />
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
      ...
      and remediation.
      <br /><br />
      Learn more: <a href="/vault/docs/enterprise/replication">Vault Enterprise replicationSSe</a>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
      ...
      <br /><br />
      Learn more: <a href="/vault/docs/enterprise/sealwrap">Seal wrap</a>
    </td>
  </tr>
