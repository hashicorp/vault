...
<table>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
      Run the Vault Secrets Operator (v0.2.0) on Red Hat OpenShift.
      <br /><br />
...
<table>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle'}}>
      Updated to use the latest Azure SDK version and Windows Identity
      Federation (WIF).
      <br /><br />
      Learn more:&nbsp;
      <a href="#">TBD</a>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle', textAlign: 'center'}}>ENHANCED</td>
    <td style={{verticalAlign: 'middle'}}>
      Upgrades and improves the audit logging backend.
    </td>
  </tr>
  ...
  <tr>
    <td style={{verticalAlign: 'middle', textAlign: 'center'}}>ENHANCED</td>
    <td style={{verticalAlign: 'middle'}}>
      &bull; Improved backend LDAP management and landing page dashboard.<br />
