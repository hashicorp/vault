...
Vault can now act as an OIDC Provider so applications can leverage the pre-existing [Vault identities](https://www.vaultproject.io/api-docs/secret/identity) to authenticate into applications.
