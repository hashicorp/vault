...
The [KMS Engine for GCP](https://www.vaultproject.io/docs/secrets/gcpkms) provides key management via the Google Cloud KMS to assist with automating many GCP key management functions. This was introduced as a Tech Preview feature in Vault 1.8 and is now being supported as a generally available feature.
