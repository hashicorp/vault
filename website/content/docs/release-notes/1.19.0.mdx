...
<table>
  ...
  <tr>
    ...
    <td style={{verticalAlign: 'middle', textAlign: 'center'}}>GA</td>
    <td style={{verticalAlign: 'middle'}}>
      Use a rotation manager to regularly rotate credentials for AWS, Azure,
      GCP, LDAP and DB plugins without manual intervention.
      <br /><br />
      Learn more: <a href="/vault/docs/">TBD</a>
    </td>
  </tr>
