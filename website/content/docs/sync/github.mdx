...
1. Create an association between the destination and a secret to synchronize.
  ...
  **Output:**
  ...
  Key                   Value
  ---                   -----
  associated_secrets    map[kv_7532a8b4/my-secret:map[accessor:kv_7532a8b4 secret_name:my-secret sync_status:SYNCED updated_at:2023-09-22T14:45:28.031262-07:00]]
  store_name            my-gh-1
  store_type            gh
  ```
...
* Unsupported characters in the secret name will be replaced by an underscore character.
