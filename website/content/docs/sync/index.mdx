...
This page describes the secrets sync feature relative to Vault Enterprise. Refer to the HCP documentation for information on 
using secrets sync with [HCP Vault Secrets](/hcp/docs/vault-secrets/integrations).
