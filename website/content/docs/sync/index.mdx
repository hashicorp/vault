...
there to prevent users from maliciously or unintentionally leverage elevated permissions on an external system to access
...
To prevent Vault from accidentally overwriting existing secrets, it is recommended to use either the name pattern of
