...
With this, Vault remains the system of record but can cache a subset of secrets on various external systems acting as
...
from Vault, it is deleted on the external system as well. This process is asynchronous and event-based. The Vault modifications
are propagated into the proper destinations automatically in a handful of seconds.
