...
To add these conditions and others to IAM principals in GCP, refer to the image below and the 
[IAM Conditions overview documentation](https://cloud.google.com/iam/docs/conditions-overview).

![GCP IAM Conditions](/img/gcp-add-iam-conditions_light.png#light-theme-only)
![GCP IAM Conditions](/img/gcp-add-iam-conditions_dark.png#dark-theme-only)

![GCP IAM Conditions](/img/gcp-add-iam-conditions_light2.png#light-theme-only)
![GCP IAM Conditions](/img/gcp-add-iam-conditions_dark2.png#dark-theme-only)
