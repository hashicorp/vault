...
your applications stores data and syncs secrets. You can enable specific GCP 
regions for each sync location during creation that limit where Vault writes 
secrets. 
