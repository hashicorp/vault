...
Updating VSO's CRDs is a manual step that should be executed after upgrading to a newer version of the operator.
Applicable when VSO is managed by Helm.
...
All supported chart values are documented [here](/vault/docs/platform/k8s/vso/helm)
