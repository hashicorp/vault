...
1. Follow Google's [Use Workload Identity](https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity) to enable workload identity on a GKE cluster so your Kubernetes service account can impersonate a Google IAM service account. 
...
See the full list of GCP VaultAuth options on the [VSO API page](https://github.com/hashicorp/vault-secrets-operator/blob/c9eb11f776c7f86895383fc32740bbb73e141aa5/docs/api/api-reference.md#vaultauthconfiggcp).
