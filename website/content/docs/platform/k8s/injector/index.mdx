...
[Vault Agent Templates](/vault/docs/agentandproxy/agent/template).
...
[Agent documentation](/vault/docs/agentandproxy/agent/template#renewals-and-updating-secrets).
