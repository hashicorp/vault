...
| -------------------- | ----------- |
| `AGENT_INJECT_TLS_MIN_VERSION` | Minimum supported version of TLS. Defaults to **tls12**. Accepted values are [tls10, tls11, tls12, tls13][tls-versions]. |
...
[tls-versions]: https://github.com/hashicorp/go-secure-stdlib/blob/tlsutil/v0.1.1/tlsutil/tlsutil.go#L18-L24
[tls-suites]: https://github.com/hashicorp/go-secure-stdlib/blob/tlsutil/v0.1.1/tlsutil/tlsutil.go#L26-L53
