...
- `injector` - Values that configure running a Vault Agent Injector Admission Webhook Controller within Kubernetes.
  ...
  - `namespaceSelector` (`dictionary: {}`) - Deprecated: please use 'webhook.namespaceSelector' instead.
  ...
  - `failurePolicy` (`string: "Ignore"`) - Deprecated: please use `webhook.failurePolicy` instead.

  - `webhookAnnotations` (`dictionary: {}`) - Deprecated: please use 'webhook.annotations' instead
