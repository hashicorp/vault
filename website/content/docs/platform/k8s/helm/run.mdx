...
resource "helm_release" "vault" {
  ...
  set {
    ...
    value = "/vault/userconfig/kms-creds"
  }
  set {
...
resource "helm_release" "vault" {
  ...
  set {
    name  = "server.extraSecretEnvironmentVars[1].envName"
    value = "AWS_SECRET_ACCESS_KEY"
  }
  set {
    name  = "server.extraSecretEnvironmentVars[1].secretName"
    value = "kms-creds"
  }
  set {
    name  = "server.extraSecretEnvironmentVars[1].secretKey"
    value = "AWS_SECRET_ACCESS_KEY"
  }
