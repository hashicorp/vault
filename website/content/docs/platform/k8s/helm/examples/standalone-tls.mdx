...
2. Create a Certificate Signing Request (CSR).
   ...
   2. Create a CSR.
      ...
      The prefix `system:node:` in CN and Org `system:nodes` are required in new CSR API along with k8s 1.22+.
...
3. Create the certificate
   ...
   1. Create a file `${TMPDIR}/csr.yaml` with the following contents:
      ...
      # Since k8s 1.22 CSR is moved to `v1`, previously apiVersion: certificates.k8s.io/v1beta1
      ...
      spec:
        ...
        - key encipherment
        - server auth
        # signerName is required in certificates.k8s.io/v1
