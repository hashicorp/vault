...
The below `custom-values.yaml` or Terraform configuration can be used to set up a single server Vault cluster using TLS.
...
resource "helm_release" "vault" {
  ...
  set {
    ...
    value = "userconfig-vault-server-tls"
  }
  set {
  ...
  set {
    ...
    value = "vault-server-tls" # Matches the ${SECRET_NAME} from above
  }
