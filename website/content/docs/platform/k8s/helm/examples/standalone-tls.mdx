...
description: Describes how to set up a standalone Vault with TLS certificate
---
...
1. Store key & cert into [Kubernetes secrets store](https://kubernetes.io/docs/concepts/configuration/secret/)
1. Configure helm chart to use Kubernetes secret from step 2
