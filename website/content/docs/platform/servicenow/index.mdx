---
layout: docs
page_title: Vault Credential Resolver
description: >-
...
directly from Vault for the purpose of performing discovery.
...
are stored in a database. Naturally, this process requires a very wide array of
...
- TLS communications with Vault Agent.

## Setting up an external credential
