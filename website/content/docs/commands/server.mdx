...
- `-dev-quickstart` `(bool: false)` - Configure the development server to include
  a suite of preconfigured options, including an Identity Entity, App Role authentication,
  a sample secret and sample polices.
