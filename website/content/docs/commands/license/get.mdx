...
flag it will return the actual license string, but only if the license mechanism
is stored, as opposed to [autoloading](/docs/enterprise/license/autoloading).
