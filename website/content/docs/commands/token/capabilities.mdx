...
<Tip title="Related API endpoints">
  ...
  ListTokenCapabilities - [`POST:/sys/capabilities`](/vault/api-docs/system/capabilities)
  ListTokenCapabilitiesSelf - [`POST:/sys/capabilities-self`](/vault/api-docs/system/capabilities-self)
  ListTokenCapabilitiesAccessor - [`POST:/sys/capabilities-accessor`](/vault/api-docs/system/capabilities-accessor)
