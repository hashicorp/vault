...
All audit devices support a [common set of options](/vault/docs/audit#common-configuration-options),
for more details, refer to the specific audit device type page under the [Audit Devices](/vault/docs/audit)
overview.
