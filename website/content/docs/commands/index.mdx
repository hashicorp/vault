...
### Passing key/value data

CLI commands that take key/value pairs accept data in three ways: inline, as a
`stdin` stream, or from a local file.

<Tabs>

<Tab heading="Inline">

To pass input inline with the command, use the `<name>=<value>` syntax:
