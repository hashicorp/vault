...
paths will contain secrets, other paths might contain configuration. Whatever it
...
Use `path-help` to retrieve API help on any API paths. Vault API paths provide
...
However, some Vault API requires more advanced structures such as maps. You can
