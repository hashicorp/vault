...
This health check verifies that ACME is enabled within a mount that contains an intermediary issuer. Any findings will be informational, as this is considered a best-practice to support a self-rotating PKI infrastructure.
