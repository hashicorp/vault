...
Before tune the auth method configuration, view the current configuration of the
...
Tune the default lease for the auth method enabled at "github/" to be 72 hours.
