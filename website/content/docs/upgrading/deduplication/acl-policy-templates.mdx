...
description: >-
  Fix templated ACL behavior for deduplicated entities and groups.
---
...
There are two ways to fix user access:
...
Compare the list of template keys against the list of deduplication targets
found in your system logs to determine if the policy will break after
duplication.
