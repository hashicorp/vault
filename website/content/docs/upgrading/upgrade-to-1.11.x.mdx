...
upgrades](/docs/concepts/integrated-storage/autopilot#automated-upgrades) as a
part of the Integrated Storage Autopilot features. If your Vault environment is
