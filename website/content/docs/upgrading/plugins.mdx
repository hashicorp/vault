...
1. Finally, trigger a global [plugin reload](/vault/docs/commands/plugin/reload)
   to reload all instances of the plugin.
...
1. **Optional:** Check the config's `running_plugin_version` field to verify
