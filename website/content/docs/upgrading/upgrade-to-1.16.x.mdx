...
### Auto-roll billing start date

 As of 1.16.7 and later, the billing start date (license start date if not configured) will automatically rollover to the most recent year. 
