...
### Auto-rolled billing start date
 ...
 As of 1.16.7 and later, the billing start date (license start date if not configured) automatically rolls over to the latest billing year at the end of the last cycle i.e; billing start dates from 
