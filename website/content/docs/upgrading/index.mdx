...
You should also consult the [deprecation notices](/vault/docs/deprecation), which
contains a comprehensive list of all deprecated features, and which versions they
are removed (or scheduled to be removed).
