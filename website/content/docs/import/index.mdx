...
These conditions are applied to the secret fields, which are:
...
Parentheses designate capture groups that are used to define the name that secrets matching the regular
