...
Caching](/vault/docs/agentandproxy/agentandproxy/agent/caching/persistent-caches) page for more information on
this functionality.
...
[described in the API Proxy documentation](/vault/docs/agentandproxy/agent/apiproxy#configuration-api_proxy) only to
...
[agent-template]: /vault/docs/agentandproxy/agent/template
[agent-listener]: /vault/docs/agentandproxy/agent#listener-stanza
...
the [API Proxy](/vault/docs/agentandproxy/agent/apiproxy) and enables the API proxy to use the cache, if configured.
