...
An example configuration, using approle to enable [auto-auth](/vault/docs/agentandproxy/autoauth)
and creating both a plaintext token sink and a [response-wrapped token sink file](/vault/docs/agentandproxy/autoauth#wrap_ttl), follows:
