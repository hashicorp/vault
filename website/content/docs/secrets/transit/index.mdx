...
- `slh-dsa` - SLH-DSA; supports signing and signature verification  (experimental) <EnterpriseAlert inline="true" />
...
~> **Warning**: ML-DSA and SLH-DSA are considered experimental functionality and
