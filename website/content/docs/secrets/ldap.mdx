...
### Schedule-based root rotation

<EnterpriseAlert product="vault" />

The LDAP secrets engine supports configuring schedule-based automatic
...
Root rotation can be temporarily disabled by setting [disable_automated_rotation](/vault/api-docs/secret/ldap#disable_automated_rotation)
