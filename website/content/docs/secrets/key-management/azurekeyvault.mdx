...
over an Azure Private Endpoint. For example, the given [KMS configuration](https://www.vaultproject.io/docs/secrets/key-management/azurekeyvault#configuration)
...
[environment](https://www.vaultproject.io/api-docs/secret/key-management/azurekeyvault#environment)
