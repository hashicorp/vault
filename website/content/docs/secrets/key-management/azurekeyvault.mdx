...
description: >-
  Azure Key Vault is a supported KMS provider of the Key Management secrets
  engine.
---
...
1. [KMS provider credentials](/api/secret/key-management/azurekeyvault#credentials)
1. [Managed Service Identity (MSI)](https://docs.microsoft.com/en-us/azure/active-directory/managed-service-identity/overview)
