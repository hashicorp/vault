...
description: >-
  GCP Cloud KMS is a supported KMS provider of the Key Management secrets
  engine.
---
...
1. [KMS provider credentials](/api/secret/key-management/gcpkms#credentials) parameter
