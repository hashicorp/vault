...
[Programmatic API Keys Doc](https://docs.atlas.mongodb.com/configure-api-access/#programmatic-api-keys).

~> **NOTE: The information below relates to the **MongoDB Altas secrets engine**. Refer to the
