...
1. <details>
  <summary>Supports the following objects</summary>
  ...
  2. <details>
    <summary>Supports the following subsets of attributes</summary>
    ...
    | Process Start Date [[KMIP-SPEC] 3.25][kmip-spec-3.25]                    | ✅        | Supported from vault version 1.11 |
    | Protect Stop Date [[KMIP-SPEC] 3.26][kmip-spec-3.26]                     | ✅        | Supported from vault version 1.11 |
    ...
    | Alternative Name [[KMIP-SPEC] 3.40][kmip-spec-3.40]                      | ✅        | Supported from vault version 1.12 |
    | Key Value Present [[KMIP-SPEC] 3.41][kmip-spec-3.41]                     | ✅        | Supported from vault version 1.12 |
  ...
  3. <details>
    <summary>Supports the following client-to-server operations</summary>
    ...
    | Modify Attribute [[KMIP-SPEC] 4.15][kmip-spec-4.15]     | ✅        | Supported from vault version 1.12 |
    | Delete Attribute [[KMIP-SPEC] 4.16][kmip-spec-4.16]     | ✅        | Supported from vault version 1.12 |
    | Activate [[KMIP-SPEC] 4.19][kmip-spec-4.19]             | ✅        |        |
    | Revoke [[KMIP-SPEC] 4.20][kmip-spec-4.20]               | ✅        |        |
    | Destroy [[KMIP-SPEC] 4.21][kmip-spec-4.21]              | ✅        |        |
    | Query [[KMIP-SPEC] 4.25][kmip-spec-4.25]                | ✅        | Supported from vault version 1.11 |
    | Discover Versions [[KMIP-SPEC] 4.26][kmip-spec-4.26]    | ✅        |        |

  </details>
  4. <details>
    <summary>Supports the following message contents</summary>
...
## [Symmetric Key Lifecycle Server][lifecycle-server]
  ...
  5. <details>
  <summary>Supports the following message encoding</summary>

  | Message Encoding                                                                     | Supported | Notes |
  | -------------------------------------------------------------------------------------| :--------:|:-----:|
  | Cryptographic Algorithm [[KMIP-SPEC] 9.1.3.2.13][kmip-spec-9.1.3.2.13] with values:  |           |       |
  | i. 3DES                                                                              | 🟠        | While the Create and Register handlers do not verify the algorithm, they only accept keys of lengths of 128, 192 or 256. This means 3DES keys cannot be created as the key sizes for it are 112 and 168. After discussion with the Cryptosec team, it was decided that we don’t want to support 3DES due to its weaknesses.|
  | ii. AES                                                                              | ✅        |        |
  ...
  | i. Raw                                                                               | ✅        |        |
  | ii. Transparent Symmetric Key                                                        |   🟠      | We don’t support Transparent Symmetric Key. However, only the Raw format is used in the mandatory and optional profile test cases. |
  </details>
...
## [Basic Cryptographic Server][basic-cryptographic-server]
  ...
  | Operation                                               | Supported | Notes     |
  | --------------------------------------------------------| :--------:| --------|
  | Encrypt [[KMIP-SPEC] 4.29][kmip-spec-4.29]              | ✅        | For AES symmetric keys.<br/>Supported Block Cipher Modes: <br/> <ol> <li> GCM </li> <li> CBC </li> <li> CFB </li> <li> CTR </li> <li> ECB </li> <li> OFB </li> </ol> <br/> Stream operations are supported except for GCM block cipher mode. <br/> Supported padding methods: <br/> <ol> <li> None </li> <li> PKCS5 </li> </ol>  |
  | Decypt [[KMIP-SPEC] 4.30][kmip-spec-4.30]               | ✅        | For AES symmetric keys.<br/>Supported Block Cipher Modes: <br/> <ol> <li> GCM </li> <li> CBC </li> <li> CFB </li> <li> CTR </li> <li> ECB </li> <li> OFB </li> </ol> <br/> Stream operations are supported except for GCM block cipher mode. <br/> Supported padding methods: <br/> <ol> <li> None </li> <li> PKCS5 </li> </ol>  |
