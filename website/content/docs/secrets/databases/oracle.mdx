...
-> **Note:** Enterprise Oracle database secrets engine is available starting with version 0.11.0.
See [Plugin management for Enterprise plugins](/vault/docs/plugins/plugin-management#enterprise-plugins)
