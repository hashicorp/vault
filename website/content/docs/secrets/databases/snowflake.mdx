...
<Warning title="Password authentication removal">
    Snowflake is disabling password authentication for all users in November of 2025.
    HashiCorp is working to support key pair authentication in place of passwords.
    For more information, please visit https://www.snowflake.com/en/blog/blocking-single-factor-password-authentification.
</Warning>
