...
1. Create a role with the necessary permissions for your users to access DynamoDB.
...
1. Use the dynamic credentials generated by Vault to access DynamoDB. For example, using
