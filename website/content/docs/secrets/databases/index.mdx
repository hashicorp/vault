...
The database secrets engine supports using client certificates to connect to the
database making it possible to manage a database without having to create a
password for the user Vault will use to generate credentials.
