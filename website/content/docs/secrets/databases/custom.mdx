...
As of Vault 1.10, database plugins can be made to implement
[plugin multiplexing](/docs/internals/plugins/plugin-architecture#plugin-multiplexing)
...
func Run() error {
	dbplugin.Serve(dbType.(dbplugin.New))
