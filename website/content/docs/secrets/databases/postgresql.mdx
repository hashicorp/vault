...
| Plugin Name                  | Root Credential Rotation | Dynamic Roles | Static Roles | Username Customization | Credential Types             | Rootless Password Rotation for Static Roles |
| ---------------------------- | ------------------------ | ------------- | ------------ | ---------------------- | ---------------------------- | ------------------------------------------- |
| `postgresql-database-plugin` | Yes                      | Yes           | Yes          | Yes (1.7+)             | password, gcp_iam            | Yes (1.18+ent)                              |
