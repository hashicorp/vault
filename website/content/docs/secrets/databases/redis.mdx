...
3.  You should consider rotating the admin password. Note that if you do, the
...
containing the Redis ACL rules which are documented [here](https://redis.io/commands/acl-cat) or in the output
