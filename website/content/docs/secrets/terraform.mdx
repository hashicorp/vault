...
description: >-
  The Terraform Cloud secret backend for Vault generates tokens for Terraform
  Cloud dynamically.
---
...
1. Configure Vault to connect and authenticate to Terraform Cloud:
...
1. Configure a role that maps a name in Vault to a Terraform Cloud User. At
