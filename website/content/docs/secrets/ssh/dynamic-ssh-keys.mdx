...
1. _Generating dynamic keys consumes entropy_: Unless equipped with a hardware
...
1. This type makes connections to client hosts; when this happens the host key
   is _not_ verified.
