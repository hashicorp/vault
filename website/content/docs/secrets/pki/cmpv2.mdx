---
layout: docs
page_title: CMPv2 within Vault | PKI - Secrets Engines
...
The current implementation of CMPv2 only supports
[Certificate TLS authentication](/vault/docs/auth/cert). With TLS
 authentication, Vault clients must prove possession of a TLS client
 certificate when authenticating to Vault.
...
>>>>>>> dfbe4d9b72dc44f3d056089df13e4f9b2e3abf00
