...
2. Vault can bootstrap the ACL system of your Consul cluster if it has
...
3.  Configure a role that maps a name in Vault to a Consul ACL policy. Depending on your Consul version,
