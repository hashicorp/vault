...
|----------------------------|--------------------------|-----
| Primary                    | Yes                      | [Value depends on cluster specifics](/vault/docs/configuration#disable_mlock)
| Performance Secondary      | Yes                      | [Value depends on cluster specifics](/vault/docs/configuration#disable_mlock)
| DR Secondary               | Yes                      | [Value depends on cluster specifics](/vault/docs/configuration#disable_mlock)
