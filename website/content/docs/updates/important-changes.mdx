...
If an auth method is mounted at a path that includes an underscore (e.g. oidc_test)
...
You can create a [UI custom message](/vault/docs/ui/custom-message) describing the workaround steps.
