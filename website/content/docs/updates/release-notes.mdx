...
| Change          | Description
|---------------- | -----------
| Support change  | 1.16.x moves to [long term support](/vault/docs/enterprise/lts) and 1.19 becomes the current LTS version.
...
| Breaking change | [Security improvement for LDAP user DN search with `upndomain`](/vault/docs/updates/important-changes#ldap)
| Known issue     | [Duplicate unseal/seal wrap HSM keys](/vault/docs/updates/important-changes##hsm-keys)
| New behavior    | [Anonymized cluster data returned with license utilization](/vault/docs/updates/important-changes#anon-data)
| New behavior    | [Uppercase values are no longer forced to lower case](/vault/docs/updates/important-changes#case-sensitive)
| Known issue     | [Login/token renewal failures after group changes](/vault/docs/updates/important-changes#group-writes)
| New behavior    | [Strict validation for Azure auth login requests](/vault/docs/updates/important-changes#strict-azure)
| Known issue     | [Unexpected LDAP static role rotations on upgrade](/vault/docs/updates/important-changes#ldap-static-role-rotations)
| Known issue     | [Unexpected DB static role rotations on upgrade](/vault/docs/updates/important-changes#db-static-role-rotations)
| Known issue     | [Vault log file missing subsystem logs](/vault/docs/updates/important-changes#missing-logs)
| Known issue     | [Automated rotation stops after unseal](/vault/docs/updates/important-changes#rotation-stops)
| Known issue     | [Azure Auth fails to authenticate Uniform VMSS instances](/vault/docs/updates/important-changes#azure-vmss)
