...
When a Vault TCP listener is configured with the `deny_unauthorized` [proxy_protocol_behavior](https://developer.hashicorp.com/vault/docs/configuration/listener/tcp#proxy_protocol_behavior)
...
Do not configure a [proxy_protocol_behavior](https://developer.hashicorp.com/vault/docs/configuration/listener/tcp#proxy_protocol_behavior)
