### URL change for KV v2 plugin ((#kv2-url-change))
...
Recent improvements to Vault included improvements and refactoring to the KV v2
engine that affect existing plugin URLs.
