...
This issue was fixed in 1.15.10. If possible, upgrade to 1.15.10 or higher to avoid impact.

If for some reason it is absolutley necessary to proceed with an upgrade to one of the affected versions, the following workaround is possible.
