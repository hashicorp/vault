...
Preexisting | 1.18.9   | All        | [LDAP static role rotations on upgrade](/vault/docs/v1.16.x/upgrading/upgrade-to-1.16.x#ldap-static-role-rotations-on-upgrade)
Preexisting | 1.18.9   | All        | [Database static role rotations on upgrade](/vault/docs/v1.16.x/upgrading/upgrade-to-1.16.x#database-static-role-rotations-on-upgrade)
Preexisting | 1.18.7   | All        | [Vault log file missing subsystem logs](/vault/docs/v1.16.x/upgrading/upgrade-to-1.16.x#vault-log-file-missing-subsystem-logs)
