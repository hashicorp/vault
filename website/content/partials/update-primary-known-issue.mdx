...
associated with the use of update-primary.
...
We've decided that this update-primary behaviour is a bug and we'll be reworking
...
data, and will delete it if it already had it.  If the DR secondary is promoted before
the PR secondary is repaired, the newly promoted PR secondary will not contain the loca
