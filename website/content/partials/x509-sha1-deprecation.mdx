~> **Note**: This engine can use external X.509 certificates or load certificates into Vault.
   X.509 certificates with signatures that use SHA-1 are deprecated and will no longer be
