...
with a permission denied error. We will call this behavior as "user lockout". The time for which 
...
The user lockout feature is enabled by default. The default values for "lockout threshold" is 5, 
