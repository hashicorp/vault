...
recommended to use these supported storage backends for best outcomes. Version 1.12.0 of Vault Enterprise will not startup if configured to use a storage backend
