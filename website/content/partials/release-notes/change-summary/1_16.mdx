...
Found   | Fixed   | Recs    | Edition    | Issue
------- |-------- | ------- | ---------- | -----
1.16.0  | N/A     | **Yes** | All        | [Docker image no longer contains curl](/vault/docs/v1.16.x/updates/important-changes#docker-image-no-longer-contains-curl)
...
Found  | Fixed   | Recs    | Edition    | Issue
------ |-------- | ------- | ---------- | -----
1.16.0  | N/A    | No      | Enterprise | [Activity log changes](/vault/docs/v1.16.x/updates/important-changes#activity-log-changes)
1.16.0  | N/A    | No      | All        | [Auto-rolled billing start date](/vault/docs/v1.16.x/updates/important-changes#auto-rolled-billing-start-date)
1.16.0  | N/A    | **Yes** | All        | [Default lease count quota enabled when upgrading from Vault versions before 1.9](/vault/docs/v1.16.x/updates/important-changes#default-lease-count-quota-enabled-when-upgrading-from-vault-versions-before-1-9)
1.16.0  | N/A    | **Yes** | All        | [External plugin variables take precedence over system variables](/vault/docs/v1.16.x/updates/important-changes#external-plugin-variables-take-precedence-over-system-variables)
1.16.0  | N/A    | **Yes** | All        | [LDAP auth login changes](/vault/docs/v1.16.x/updates/important-changes#ldap-auth-entity-alias-names-no-longer-include-upndomain)
1.16.0  | N/A    | **Yes** | All        | [Product usage reporting](/vault/docs/v1.16.x/updates/important-changes#product-usage-reporting)
1.16.0  | N/A    | **Yes** | All        | [Secrets Sync cannot be activated from chroot namespace](/vault/docs/v1.16.x/updates/important-changes#secrets-sync-cannot-be-activated-from-chroot-namespace)
1.16.0  | N/A    | No      | Enterprise | [Secrets Sync now requires setting a one-time flag before use](/vault/docs/v1.16.x/updates/important-changes#secrets-sync-now-requires-setting-a-one-time-flag-before-use)
1.16.18 | N/A    | No      | All        | [Strict validation for Azure auth login requests](/vault/docs/v1.16.x/updates/important-changes#strict-azure)
