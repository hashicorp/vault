...
- [`LogRateLimitIntervalSec`, `LogRateLimitBurst`](https://www.freedesktop.org/software/systemd/man/systemd.exec.html#LogRateLimitIntervalSec=) - Prevent JournalD from suppressing messages sent by Vault.
