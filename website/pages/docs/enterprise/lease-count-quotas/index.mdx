...
Lease count quotas defined in a namespace will be inherited to all the child
namespaces. By extension, this means that a quota that is defined in the `root`
namespace is inherited to all namespaces and mounts, essentially to the entire
Vault API.
