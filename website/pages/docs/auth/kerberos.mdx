...
[LDAP](/docs/auth/ldap.html) and
[Azure](/docs/auth/azure.html) only require
...
See [its documentation](/docs/auth/ldap.html)
...
- Configure the Vault policies that should be granted to those
  ...
  [Group Membership Resolution](/docs/auth/ldap.html#group-membership-resolution)
  and [LDAP Group -> Policy Mapping](/docs/auth/ldap.html#ldap-group-gt-policy-mapping)
