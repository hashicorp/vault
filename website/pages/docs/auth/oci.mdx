...
1.  Use the received token to read secrets, writer secrets, and add roles per the instructions in [/docs/secrets/kv/kv-v1.html](/docs/secrets/kv/kv-v1.html).
...
1.  Stop Vault and re-start it in the production environment. See [/docs/configuration](/docs/configuration/) for more information.
