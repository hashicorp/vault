...
2. Replace the Vault binary with the new version; ensure that `mlock()` capability is added to the new binary with [setcap](/docs/configuration/index.html#disable_mlock)
3. Start the node
