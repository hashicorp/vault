...
and Venafi's [VCert Client SDK](https://github.com/Venafi/vcert).  If you're a
developer and you are interested in contributing to this secrets engine, visit
[Venafi GitHub](https://github.com/Venafi/vault-pki-backend-venafi).
...
information see the *Venafi Administration Guide*.
...
1. Configure a [role](https://www.vaultproject.io/docs/secrets/pki/index.html)
...
[Vault API](https://www.vaultproject.io/api/secret/pki/index.html)
