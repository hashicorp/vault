...
organizations to maintain centralized control of their keys from Vault while still taking advantage
...
1. Distribute a key to a KMS provider:
   ...
   ~> The amount of time it takes to distribute a key to a KMS provider is proportional to the
...
Refer to the [Key Management Secrets Engine](https://learn.hashicorp.com/vault/adp/TODO) guide for
