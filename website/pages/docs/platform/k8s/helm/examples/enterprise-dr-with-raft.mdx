...
sidebar_current: "docs-platform-k8s-examples-ha-enterprise-dr-with-raft"
sidebar_title: "Highly Available Vault Enterprise Disaster Recovery Clusters with Raft"
description: |-
  Describes how to set up Diaster Recovery clusters with with Integrated Storage (Raft)
---
