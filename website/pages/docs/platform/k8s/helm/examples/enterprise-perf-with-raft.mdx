...
sidebar_current: "docs-platform-k8s-examples-ha-enterprise-perf-with-raft"
sidebar_title: "Highly Available Vault Enterprise Performance Clusters with Raft"
description: |-
  Describes how to set up Performance clusters with with Integrated Storage (Raft)
---
