...
The following documentation describe installing, running and using 
...
* Cluster Admin privileges: Vault requires a cluster role to review 
  Kubernetes service accounts and their associated JSON Web Tokens for login requests.
* OpenShift 4.X
* Helm v3
* Vault Helm v0.6.0+
* Vault K8s v0.4.0+
