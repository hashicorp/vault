...
See TLS settings in the [`vault` Stanza](/docs/agent/index.html#vault-stanza)
...
- `name` `(string: optional)` - The trusted certificate role which should be used
  ...
  try to authenticate against [all trusted certificates](/docs/auth/cert.html#authentication).
