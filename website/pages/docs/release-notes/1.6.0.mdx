...
* **Automated snapshots** provides in-built Vault functionality for automated snapshots that takes snapshots of the
...
**New Command “vault usage”**: Support for analyzing active usage of applications and users with new metric client
count. This usage tracking is configurable and enabled by default on Vault Enterprise.

**Support for seal migration** for all use cases to migrate from any to any unseal interface (including auto-unseal to auto-unseal)
