...
- [Keberos](https://github.com/hashicorp/vault-plugin-auth-kerberos)
...
- [Oracle Database](https://github.com/hashicorp/vault-plugin-database-oracle)
...
Plugin authors who wish to have their plugins listed may open a pull request
submission with changes to [this page](https://github.com/hashicorp/vault/blob/master/website/pages/api-docs/plugin-portal.mdx).
