...
- `cluster_name` `(string: "")` - Specifies the name of the cluster for use in metric labeling.
- `usage_gauge_period` `(string: "30s")` - Specifies the duration between gauge collections.
- `maximum_gauge_cardinality` `(int: 100)` - The maximum cardinality of gauge labels.
