...
- `max_parallel` `(string: "128")` – Specifies the maximum number of concurrent
  requests to Consul.  Make sure that your Consul servers are configured to
  support this level of parallelism, see
  [rpc_max_conns_per_client](https://www.consul.io/docs/agent/options.html#rpc_max_conns_per_client).
