...
| `vault.raft.state.follower`											| Increments whenever raft server becomes a follower                                          | ms   | counter |
...
| `vault.raft.state.candidate`										| Increments whenever raft server starts an election                                                            | ms    | counter |
| `vault.raft.state.leader`												| Increments whenever raft server becomes a leader                                                              | ms    | counter |
