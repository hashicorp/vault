...
token](/docs/concepts/response-wrapping.html) to the
...
the [configuration file](/docs/configuration/index.html).
...
settings (like Vault, plugins support [the use of mlock when available](/docs/configuration/index.html#disable_mlock)).
