...
!> The Fine-Grained Control mechanism is only supported by KV v1 Secret Engine, nevertheless a more sophisticated control is possible by  using Sentinel policies
