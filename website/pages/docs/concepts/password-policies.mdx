...
down. This is because the chance of generating a given character from each of the required subsets increases
simply because the number of "tries" increases. The chance of selecting a character from each of the required
subsets increases as we select more characters. Combine this with the increasing time required to generate more
characters and you get a performance graph as shown above.

<details>
<summary><b>More details regarding probability for generating passwords</b></summary>
