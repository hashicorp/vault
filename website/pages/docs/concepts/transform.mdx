...
for *transforming* sensitive information to protect it even as it lives outside 
Vault's sphere. 

Transform consists of three modes, called *transformations*.  Format Preserving
