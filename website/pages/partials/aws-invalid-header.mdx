...
This issue affects 1.5.2, 1.4.5, 1.3.9, and 1.2.6 as well. It will be corrected in the next update.
The currently released versions can work around the issue by manually configuring the allowed header
list, including all needed headers. A recommended configuration is shown below:
