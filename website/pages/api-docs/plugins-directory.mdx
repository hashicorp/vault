...
The following plugins are officially supported and maintained by HashiCorp.
...
- [AliCloud](https://github.com/hashicorp/vault-plugin-auth-alicloud) <Tag title='test' color='red' />
...
The following plugins are maintained and supported by our Partners.
...
The following plugins are maintained and supported by the community.
