...
- [Vault Interaction](https://marketplace.visualstudio.com/items?itemName=Fizcko.azure-devops-vault-interaction) - Azure DevOps extension to interact with HashiCorp Vault.
