...
description: The `/sys/quotas/rate-limit` endpoint is used to create, edit and list rate limit quotas.
---

# `/sys/quotas/rate-limit`

The `/sys/quotas/rate-limit` endpoint is used to create, edit and list rate limit quotas.

## Create or Update a Rate Limit Quota

This endpoint is used to create a rate limit quota by `name`. A rate limit quota
must include a `rate` and `burst` value with an optional `path` that can either
be a namespace or mount.
