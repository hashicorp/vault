...
import (
	...
	"github.com/hashicorp/vault/command-server/agentproxyshared/auth/alicloud"
	"github.com/hashicorp/vault/command-server/agentproxyshared/auth/approle"
	"github.com/hashicorp/vault/command-server/agentproxyshared/auth/aws"
	"github.com/hashicorp/vault/command-server/agentproxyshared/auth/azure"
	"github.com/hashicorp/vault/command-server/agentproxyshared/auth/cert"
	"github.com/hashicorp/vault/command-server/agentproxyshared/auth/cf"
	"github.com/hashicorp/vault/command-server/agentproxyshared/auth/gcp"
	"github.com/hashicorp/vault/command-server/agentproxyshared/auth/jwt"
	"github.com/hashicorp/vault/command-server/agentproxyshared/auth/kerberos"
	"github.com/hashicorp/vault/command-server/agentproxyshared/auth/kubernetes"
	"github.com/hashicorp/vault/command-server/agentproxyshared/auth/ldap"
	"github.com/hashicorp/vault/command-server/agentproxyshared/auth/oci"
	...
	"github.com/hashicorp/vault/command-server/agentproxyshared/cache/cachememdb"
