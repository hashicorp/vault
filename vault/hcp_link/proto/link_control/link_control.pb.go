...
const file_vault_hcp_link_proto_link_control_link_control_proto_rawDesc = "" +
	"\n" +
	"4vault/hcp_link/proto/link_control/link_control.proto\x12\flink_control\"\x14\n" +
	"\x12PurgePolicyRequest\"\x15\n" +
	"\x13PurgePolicyResponse2d\n" +
	"\x0eHCPLinkControl\x12R\n" +
	"\vPurgePolicy\x12 .link_control.PurgePolicyRequest\x1a!.link_control.PurgePolicyResponseB>Z<github.com/hashicorp/vault/vault/hcp_link/proto/link_controlb\x06proto3"
