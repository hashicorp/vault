...
func NewCore(conf *CoreConfig) (*Core, error) {
	...
	err = adjustCoreForSealMigration(c.Logger(), c, conf.Seal, conf.UnwrapSeal)
	if err != nil {
		return nil, err
	}
	return c, nil
...
func adjustCoreForSealMigration(logger log.Logger, core *Core, barrierSeal, unwrapSeal Seal) error {
