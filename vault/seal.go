...
type SealConfig struct {
	...
	// SecretSharesIdentifierNames are the comma-separated human readable names
	// to be associated with the key identifiers of unseal keys. If provided,
	// the number of names should match the value of 'SecretThreshold'
...
func (s *SealConfig) Clone() *SealConfig {
	ret := &SealConfig{
		...
		SecretSharesIdentifierNames: s.SecretSharesIdentifierNames,
	}
	if len(s.PGPKeys) > 0 {
