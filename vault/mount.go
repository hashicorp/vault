...
type MountConfig struct {
	...
	EnableIdentityGroupCreation bool                  `json:"enable_identity_group_creation" structs:"enable_identity_group_creation" mapstructure:"enable_identity_group_creation"`
