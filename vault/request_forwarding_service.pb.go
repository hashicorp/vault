...
type TxnEntry_Operation int32

const (
	TxnEntry_PUT    TxnEntry_Operation = 0
	TxnEntry_DELETE TxnEntry_Operation = 1
)

// Enum value maps for TxnEntry_Operation.
var (
	TxnEntry_Operation_name = map[int32]string{
		0: "PUT",
		1: "DELETE",
	}
	TxnEntry_Operation_value = map[string]int32{
		"PUT":    0,
		"DELETE": 1,
	}
)

func (x TxnEntry_Operation) Enum() *TxnEntry_Operation {
	p := new(TxnEntry_Operation)
	*p = x
	return p
}

func (x TxnEntry_Operation) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TxnEntry_Operation) Descriptor() protoreflect.EnumDescriptor {
	return file_vault_request_forwarding_service_proto_enumTypes[0].Descriptor()
}

func (TxnEntry_Operation) Type() protoreflect.EnumType {
	return &file_vault_request_forwarding_service_proto_enumTypes[0]
}

func (x TxnEntry_Operation) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TxnEntry_Operation.Descriptor instead.
func (TxnEntry_Operation) EnumDescriptor() ([]byte, []int) {
	return file_vault_request_forwarding_service_proto_rawDescGZIP(), []int{6, 0}
}
...
type TxnEntry struct {
	...
	Operation TxnEntry_Operation     `protobuf:"varint,1,opt,name=operation,proto3,enum=vault.TxnEntry_Operation" json:"operation,omitempty"`
	Entry     *TxnEntry_StorageEntry `protobuf:"bytes,2,opt,name=entry,proto3" json:"entry,omitempty"`
}

func (x *TxnEntry) Reset() {
	*x = TxnEntry{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vault_request_forwarding_service_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *TxnEntry) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TxnEntry) ProtoMessage() {}

func (x *TxnEntry) ProtoReflect() protoreflect.Message {
	mi := &file_vault_request_forwarding_service_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TxnEntry.ProtoReflect.Descriptor instead.
func (*TxnEntry) Descriptor() ([]byte, []int) {
	return file_vault_request_forwarding_service_proto_rawDescGZIP(), []int{6}
}

func (x *TxnEntry) GetOperation() TxnEntry_Operation {
	if x != nil {
		return x.Operation
	}
	return TxnEntry_PUT
...
func (x *TxnEntry) GetEntry() *TxnEntry_StorageEntry {
	if x != nil {
		return x.Entry
	}
	return nil
...
type StorageTxnRequestInput struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Operations []*TxnEntry `protobuf:"bytes,1,rep,name=operations,proto3" json:"operations,omitempty"`
}

func (x *StorageTxnRequestInput) Reset() {
	*x = StorageTxnRequestInput{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vault_request_forwarding_service_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *StorageTxnRequestInput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StorageTxnRequestInput) ProtoMessage() {}

func (x *StorageTxnRequestInput) ProtoReflect() protoreflect.Message {
	mi := &file_vault_request_forwarding_service_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StorageTxnRequestInput.ProtoReflect.Descriptor instead.
func (*StorageTxnRequestInput) Descriptor() ([]byte, []int) {
	return file_vault_request_forwarding_service_proto_rawDescGZIP(), []int{7}
}

func (x *StorageTxnRequestInput) GetOperations() []*TxnEntry {
	if x != nil {
		return x.Operations
	}
	return nil
...
func (x *StorageTxnReply) Reset() {
	*x = StorageTxnReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vault_request_forwarding_service_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *StorageTxnReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StorageTxnReply) ProtoMessage() {}

func (x *StorageTxnReply) ProtoReflect() protoreflect.Message {
	mi := &file_vault_request_forwarding_service_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StorageTxnReply.ProtoReflect.Descriptor instead.
func (*StorageTxnReply) Descriptor() ([]byte, []int) {
	return file_vault_request_forwarding_service_proto_rawDescGZIP(), []int{8}
}

func (x *StorageTxnReply) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
type TxnEntry_StorageEntry struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TxnEntry_StorageEntry) Reset() {
	*x = TxnEntry_StorageEntry{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vault_request_forwarding_service_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *TxnEntry_StorageEntry) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TxnEntry_StorageEntry) ProtoMessage() {}

func (x *TxnEntry_StorageEntry) ProtoReflect() protoreflect.Message {
	mi := &file_vault_request_forwarding_service_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TxnEntry_StorageEntry.ProtoReflect.Descriptor instead.
func (*TxnEntry_StorageEntry) Descriptor() ([]byte, []int) {
	return file_vault_request_forwarding_service_proto_rawDescGZIP(), []int{6, 0}
}

func (x *TxnEntry_StorageEntry) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *TxnEntry_StorageEntry) GetValue() []byte {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *TxnEntry_StorageEntry) GetSealWrap() bool {
	if x != nil {
		return x.SealWrap
	}
	return false
...
var file_vault_request_forwarding_service_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x45, 0x0a, 0x0a, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x54, 0x78, 0x6e, 0x12, 0x1d, 0x2e,
	0x76, 0x61, 0x75, 0x6c, 0x74, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x54, 0x78, 0x6e,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x1a, 0x16, 0x2e, 0x76,
	0x61, 0x75, 0x6c, 0x74, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x54, 0x78, 0x6e, 0x52,
...
var file_vault_request_forwarding_service_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_vault_request_forwarding_service_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_vault_request_forwarding_service_proto_goTypes = []interface{}{
	(TxnEntry_Operation)(0),             // 0: vault.TxnEntry.Operation
	(*EchoRequest)(nil),                 // 1: vault.EchoRequest
	(*EchoReply)(nil),                   // 2: vault.EchoReply
	(*NodeInformation)(nil),             // 3: vault.NodeInformation
	(*ClientKey)(nil),                   // 4: vault.ClientKey
	(*PerfStandbyElectionInput)(nil),    // 5: vault.PerfStandbyElectionInput
	(*PerfStandbyElectionResponse)(nil), // 6: vault.PerfStandbyElectionResponse
	(*TxnEntry)(nil),                    // 7: vault.TxnEntry
	(*StorageTxnRequestInput)(nil),      // 8: vault.StorageTxnRequestInput
	(*StorageTxnReply)(nil),             // 9: vault.StorageTxnReply
	(*TxnEntry_StorageEntry)(nil),       // 10: vault.TxnEntry.StorageEntry
...
var file_vault_request_forwarding_service_proto_depIDxs = []int32{
	3,  // 0: vault.EchoRequest.node_info:type_name -> vault.NodeInformation
	3,  // 1: vault.EchoReply.node_info:type_name -> vault.NodeInformation
	4,  // 2: vault.PerfStandbyElectionResponse.client_key:type_name -> vault.ClientKey
	0,  // 3: vault.TxnEntry.operation:type_name -> vault.TxnEntry.Operation
	10, // 4: vault.TxnEntry.entry:type_name -> vault.TxnEntry.StorageEntry
	7,  // 5: vault.StorageTxnRequestInput.operations:type_name -> vault.TxnEntry
	11, // 6: vault.RequestForwarding.ForwardRequest:input_type -> forwarding.Request
	1,  // 7: vault.RequestForwarding.Echo:input_type -> vault.EchoRequest
	5,  // 8: vault.RequestForwarding.PerformanceStandbyElectionRequest:input_type -> vault.PerfStandbyElectionInput
	8,  // 9: vault.RequestForwarding.StorageTxn:input_type -> vault.StorageTxnRequestInput
	12, // 10: vault.RequestForwarding.ForwardRequest:output_type -> forwarding.Response
	2,  // 11: vault.RequestForwarding.Echo:output_type -> vault.EchoReply
	6,  // 12: vault.RequestForwarding.PerformanceStandbyElectionRequest:output_type -> vault.PerfStandbyElectionResponse
	9,  // 13: vault.RequestForwarding.StorageTxn:output_type -> vault.StorageTxnReply
...
func file_vault_request_forwarding_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vault_request_forwarding_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TxnEntry); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_vault_request_forwarding_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StorageTxnRequestInput); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_vault_request_forwarding_service_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StorageTxnReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_vault_request_forwarding_service_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TxnEntry_StorageEntry); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_vault_request_forwarding_service_proto_enumTypes,
...
type RequestForwardingClient interface {
	...
	StorageTxn(ctx context.Context, in *StorageTxnRequestInput, opts ...grpc.CallOption) (*StorageTxnReply, error)
}
...
func (c *requestForwardingClient) StorageTxn(ctx context.Context, in *StorageTxnRequestInput, opts ...grpc.CallOption) (*StorageTxnReply, error) {
	out := new(StorageTxnReply)
	err := c.cc.Invoke(ctx, "/vault.RequestForwarding/StorageTxn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RequestForwardingServer interface {
	...
	StorageTxn(context.Context, *StorageTxnRequestInput) (*StorageTxnReply, error)
}
...
func (*UnimplementedRequestForwardingServer) StorageTxn(context.Context, *StorageTxnRequestInput) (*StorageTxnReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StorageTxn not implemented")
}
...
func _RequestForwarding_StorageTxn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StorageTxnRequestInput)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RequestForwardingServer).StorageTxn(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vault.RequestForwarding/StorageTxn",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RequestForwardingServer).StorageTxn(ctx, req.(*StorageTxnRequestInput))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _RequestForwarding_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "StorageTxn",
			Handler:    _RequestForwarding_StorageTxn_Handler,
		},
	},
