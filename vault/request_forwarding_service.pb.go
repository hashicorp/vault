...
type SendControlHubCredentialsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ID            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
...
func (x *SendControlHubCredentialsRequest) Reset() {
	*x = SendControlHubCredentialsRequest{}
	mi := &file_vault_request_forwarding_service_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SendControlHubCredentialsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SendControlHubCredentialsRequest) ProtoMessage() {}

func (x *SendControlHubCredentialsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_vault_request_forwarding_service_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SendControlHubCredentialsRequest.ProtoReflect.Descriptor instead.
func (*SendControlHubCredentialsRequest) Descriptor() ([]byte, []int) {
	return file_vault_request_forwarding_service_proto_rawDescGZIP(), []int{6}
}

func (x *SendControlHubCredentialsRequest) GetID() string {
	if x != nil {
		return x.ID
	}
	return ""
...
func (x *SendControlHubCredentialsRequest) GetValue() []byte {
	if x != nil {
		return x.Value
	}
	return nil
...
type SendControlHubCredentialsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SendControlHubCredentialsResponse) Reset() {
	*x = SendControlHubCredentialsResponse{}
	mi := &file_vault_request_forwarding_service_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SendControlHubCredentialsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SendControlHubCredentialsResponse) ProtoMessage() {}

func (x *SendControlHubCredentialsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_vault_request_forwarding_service_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SendControlHubCredentialsResponse.ProtoReflect.Descriptor instead.
func (*SendControlHubCredentialsResponse) Descriptor() ([]byte, []int) {
...
var file_vault_request_forwarding_service_proto_rawDesc = string([]byte{
	...
	,
...
var file_vault_request_forwarding_service_proto_goTypes = []any{
	...
	(*SendControlHubCredentialsRequest)(nil),  // 6: vault.SendControlHubCredentialsRequest
	(*SendControlHubCredentialsResponse)(nil), // 7: vault.SendControlHubCredentialsResponse
	(*timestamppb.Timestamp)(nil),             // 8: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),               // 9: google.protobuf.Duration
	(*forwarding.Request)(nil),                // 10: forwarding.Request
	(*forwarding.Response)(nil),               // 11: forwarding.Response
}
var file_vault_request_forwarding_service_proto_depIDxs = []int32{
	...
	8,  // 1: vault.EchoRequest.now:type_name -> google.protobuf.Timestamp
	9,  // 2: vault.EchoRequest.last_roundtrip_time:type_name -> google.protobuf.Duration
	2,  // 3: vault.EchoReply.node_info:type_name -> vault.NodeInformation
	8,  // 4: vault.EchoReply.now:type_name -> google.protobuf.Timestamp
	3,  // 5: vault.PerfStandbyElectionResponse.client_key:type_name -> vault.ClientKey
	10, // 6: vault.RequestForwarding.ForwardRequest:input_type -> forwarding.Request
	...
	6,  // 9: vault.RequestForwarding.SendControlHubCredentials:input_type -> vault.SendControlHubCredentialsRequest
	11, // 10: vault.RequestForwarding.ForwardRequest:output_type -> forwarding.Response
	1,  // 11: vault.RequestForwarding.Echo:output_type -> vault.EchoReply
	5,  // 12: vault.RequestForwarding.PerformanceStandbyElectionRequest:output_type -> vault.PerfStandbyElectionResponse
	7,  // 13: vault.RequestForwarding.SendControlHubCredentials:output_type -> vault.SendControlHubCredentialsResponse
