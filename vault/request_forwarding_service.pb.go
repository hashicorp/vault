...
type SyncBarrierEncryptionsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Encryptions uint64 `protobuf:"varint,1,opt,name=encryptions,proto3" json:"encryptions,omitempty"`
}

func (x *SyncBarrierEncryptionsRequest) Reset() {
	*x = SyncBarrierEncryptionsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *SyncBarrierEncryptionsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SyncBarrierEncryptionsRequest) ProtoMessage() {}

func (x *SyncBarrierEncryptionsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_vault_request_forwarding_service_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SyncBarrierEncryptionsRequest.ProtoReflect.Descriptor instead.
func (*SyncBarrierEncryptionsRequest) Descriptor() ([]byte, []int) {
	return file_vault_request_forwarding_service_proto_rawDescGZIP(), []int{6}
}

func (x *SyncBarrierEncryptionsRequest) GetEncryptions() uint64 {
	if x != nil {
...
type SyncBarrierEncryptionsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *SyncBarrierEncryptionsResponse) Reset() {
	*x = SyncBarrierEncryptionsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SyncBarrierEncryptionsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SyncBarrierEncryptionsResponse) ProtoMessage() {}

func (x *SyncBarrierEncryptionsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_vault_request_forwarding_service_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SyncBarrierEncryptionsResponse.ProtoReflect.Descriptor instead.
func (*SyncBarrierEncryptionsResponse) Descriptor() ([]byte, []int) {
...
var file_vault_request_forwarding_service_proto_rawDesc = []byte{
	...
	,
	...
	0x6c, 0x74, 0x2f, 0x76, 0x61, 0x75, 0x6c, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_vault_request_forwarding_service_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_vault_request_forwarding_service_proto_goTypes = []interface{}{
	...
	(*SyncBarrierEncryptionsRequest)(nil),  // 6: vault.SyncBarrierEncryptionsRequest
	(*SyncBarrierEncryptionsResponse)(nil), // 7: vault.SyncBarrierEncryptionsResponse
...
var file_vault_request_forwarding_service_proto_depIDxs = []int32{
	...
	8, // 3: vault.RequestForwarding.ForwardRequest:input_type -> forwarding.Request
	...
	6, // 6: vault.RequestForwarding.SyncBarrierEncryptions:input_type -> vault.SyncBarrierEncryptionsRequest
	9, // 7: vault.RequestForwarding.ForwardRequest:output_type -> forwarding.Response
	1, // 8: vault.RequestForwarding.Echo:output_type -> vault.EchoReply
	5, // 9: vault.RequestForwarding.PerformanceStandbyElectionRequest:output_type -> vault.PerfStandbyElectionResponse
	7, // 10: vault.RequestForwarding.SyncBarrierEncryptions:output_type -> vault.SyncBarrierEncryptionsResponse
...
func file_vault_request_forwarding_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vault_request_forwarding_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SyncBarrierEncryptionsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_vault_request_forwarding_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SyncBarrierEncryptionsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type RequestForwardingClient interface {
	...
	SyncBarrierEncryptions(ctx context.Context, in *SyncBarrierEncryptionsRequest, opts ...grpc.CallOption) (*SyncBarrierEncryptionsResponse, error)
}
...
func (c *requestForwardingClient) SyncBarrierEncryptions(ctx context.Context, in *SyncBarrierEncryptionsRequest, opts ...grpc.CallOption) (*SyncBarrierEncryptionsResponse, error) {
	out := new(SyncBarrierEncryptionsResponse)
	err := c.cc.Invoke(ctx, "/vault.RequestForwarding/SyncBarrierEncryptions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RequestForwardingServer interface {
	...
	SyncBarrierEncryptions(context.Context, *SyncBarrierEncryptionsRequest) (*SyncBarrierEncryptionsResponse, error)
}
...
func (*UnimplementedRequestForwardingServer) SyncBarrierEncryptions(context.Context, *SyncBarrierEncryptionsRequest) (*SyncBarrierEncryptionsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SyncBarrierEncryptions not implemented")
}
...
func _RequestForwarding_SyncBarrierEncryptions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SyncBarrierEncryptionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RequestForwardingServer).SyncBarrierEncryptions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vault.RequestForwarding/SyncBarrierEncryptions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RequestForwardingServer).SyncBarrierEncryptions(ctx, req.(*SyncBarrierEncryptionsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _RequestForwarding_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SyncBarrierEncryptions",
			Handler:    _RequestForwarding_SyncBarrierEncryptions_Handler,
		},
	},
