...
func TestStrUtil_BitMaskedIndex(t *testing.T) {
	...
	checkFunc(t, input, 5, "c")
	checkFunc(t, input, 6, "19")
	checkFunc(t, input, 7, "33")
	checkFunc(t, input, 8, "66")
	checkFunc(t, input, 9, "cc")
	checkFunc(t, input, 10, "199")
	checkFunc(t, input, 12, "666")
	checkFunc(t, input, 15, "3337")
	checkFunc(t, input, 16, "666f")
