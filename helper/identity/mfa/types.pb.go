...
func (*Config) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_a449c9b1cef4fcee, []int{0}
}
...
func (*TOTPConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_a449c9b1cef4fcee, []int{1}
}
...
func (dst *TOTPConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TOTPConfig.Merge(dst, src)
}
...
func (*DuoConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_a449c9b1cef4fcee, []int{2}
}
...
func (dst *DuoConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DuoConfig.Merge(dst, src)
}
...
func (*OktaConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_a449c9b1cef4fcee, []int{3}
}
...
func (dst *OktaConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OktaConfig.Merge(dst, src)
}
...
func (*PingIDConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_a449c9b1cef4fcee, []int{4}
}
...
func (dst *PingIDConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PingIDConfig.Merge(dst, src)
}
...
func (*Secret) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_a449c9b1cef4fcee, []int{5}
}
...
func (*TOTPSecret) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_a449c9b1cef4fcee, []int{6}
}
...
func (dst *TOTPSecret) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TOTPSecret.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("helper/identity/mfa/types.proto", fileDescriptor_types_a449c9b1cef4fcee)
}

var fileDescriptor_types_a449c9b1cef4fcee = []byte{
