...
proto:
	protoc vault/*.proto --go_out=plugins=grpc:$(GOPATH)/src
	protoc helper/storagepacker/types.proto --go_out=plugins=grpc:$(GOPATH)/src
	protoc helper/forwarding/types.proto --go_out=plugins=grpc:$(GOPATH)/src
	protoc logical/*.proto --go_out=plugins=grpc:$(GOPATH)/src
	protoc physical/types.proto --go_out=plugins=grpc:$(GOPATH)/src
	protoc helper/identity/types.proto --go_out=plugins=grpc:$(GOPATH)/src
	protoc builtin/logical/database/dbplugin/*.proto --go_out=plugins=grpc:$(GOPATH)/src
	protoc logical/plugin/pb/*.proto --go_out=plugins=grpc:$(GOPATH)/src
