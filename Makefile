...
build:
	...
	@go build -v -tags "$(GO_TAGS)" -ldflags " -X github.com/hashicorp/vault/version.GitCommit=$(VAULT_REVISION) -X github.com/hashicorp/vault/sdk/version.BuildDate=$(VAULT_BUILD_DATE)" -o dist/
