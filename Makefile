...
# ci-config is just an alias for .circleci/config.yml for now
ci-config: .circleci/config.yml

.circleci/config.yml: .circleci/template.yml Makefile check-circleci-installed
	@echo "### Generated by 'make $@' do not manually edit this file." > $@
