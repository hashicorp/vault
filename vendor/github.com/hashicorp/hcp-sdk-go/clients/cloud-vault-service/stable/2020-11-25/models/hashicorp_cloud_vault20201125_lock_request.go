...
func (m *HashicorpCloudVault20201125LockRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudVault20201125LockRequest) validateLocation(formats strfmt.Registry) error {
...
func (m *HashicorpCloudVault20201125LockRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudVault20201125LockRequest) contextValidateLocation(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudVault20201125LockRequest) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudVault20201125LockRequest
