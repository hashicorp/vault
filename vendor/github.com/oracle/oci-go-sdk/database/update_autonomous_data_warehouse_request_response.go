...
func (request UpdateAutonomousDataWarehouseRequest) String() string {
...
func (request UpdateAutonomousDataWarehouseRequest) RetryPolicy() *common.RetryPolicy {
...
func (response UpdateAutonomousDataWarehouseResponse) String() string {
