...
func (request RestoreAutonomousDataWarehouseRequest) String() string {
...
func (request RestoreAutonomousDataWarehouseRequest) RetryPolicy() *common.RetryPolicy {
...
func (response RestoreAutonomousDataWarehouseResponse) String() string {
