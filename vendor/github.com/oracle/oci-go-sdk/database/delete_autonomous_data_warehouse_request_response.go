...
func (request DeleteAutonomousDataWarehouseRequest) String() string {
...
func (request DeleteAutonomousDataWarehouseRequest) RetryPolicy() *common.RetryPolicy {
...
func (response DeleteAutonomousDataWarehouseResponse) String() string {
