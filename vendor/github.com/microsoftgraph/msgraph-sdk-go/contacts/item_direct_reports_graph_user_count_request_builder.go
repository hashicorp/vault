...
func NewItemDirectReportsGraphUserCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDirectReportsGraphUserCountRequestBuilder) {
    m := &ItemDirectReportsGraphUserCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/contacts/{orgContact%2Did}/directReports/graph.user/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewItemDirectReportsGraphUserCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDirectReportsGraphUserCountRequestBuilder) {
    ...
    return NewItemDirectReportsGraphUserCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
// returns a *ItemDirectReportsGraphUserCountRequestBuilder when successful
func (m *ItemDirectReportsGraphUserCountRequestBuilder) WithUrl(rawUrl string)(*ItemDirectReportsGraphUserCountRequestBuilder) {
    return NewItemDirectReportsGraphUserCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
