...
func NewItemOwnedObjectsGraphServicePrincipalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnedObjectsGraphServicePrincipalRequestBuilder) {
    m := &ItemOwnedObjectsGraphServicePrincipalRequestBuilder{
...
func NewItemOwnedObjectsGraphServicePrincipalRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnedObjectsGraphServicePrincipalRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemOwnedObjectsGraphServicePrincipalRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *ItemOwnedObjectsGraphServicePrincipalCountRequestBuilder when successful
func (m *ItemOwnedObjectsGraphServicePrincipalRequestBuilder) Count()(*ItemOwnedObjectsGraphServicePrincipalCountRequestBuilder) {
...
func (m *ItemOwnedObjectsGraphServicePrincipalRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemOwnedObjectsGraphServicePrincipalRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ServicePrincipalCollectionResponseable, error) {
...
func (m *ItemOwnedObjectsGraphServicePrincipalRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemOwnedObjectsGraphServicePrincipalRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemOwnedObjectsGraphServicePrincipalRequestBuilder) WithUrl(rawUrl string)(*ItemOwnedObjectsGraphServicePrincipalRequestBuilder) {
    return NewItemOwnedObjectsGraphServicePrincipalRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
