...
func NewAuthenticationStrengthPoliciesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AuthenticationStrengthPoliciesCountRequestBuilder) {
    ...
    return NewAuthenticationStrengthPoliciesCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *AuthenticationStrengthPoliciesCountRequestBuilder) WithUrl(rawUrl string)(*AuthenticationStrengthPoliciesCountRequestBuilder) {
    return NewAuthenticationStrengthPoliciesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
