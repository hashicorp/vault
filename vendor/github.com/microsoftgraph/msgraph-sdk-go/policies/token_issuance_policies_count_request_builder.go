...
func NewTokenIssuancePoliciesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TokenIssuancePoliciesCountRequestBuilder) {
    m := &TokenIssuancePoliciesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/policies/tokenIssuancePolicies/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewTokenIssuancePoliciesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TokenIssuancePoliciesCountRequestBuilder) {
    ...
    return NewTokenIssuancePoliciesCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *TokenIssuancePoliciesCountRequestBuilder) WithUrl(rawUrl string)(*TokenIssuancePoliciesCountRequestBuilder) {
    return NewTokenIssuancePoliciesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
