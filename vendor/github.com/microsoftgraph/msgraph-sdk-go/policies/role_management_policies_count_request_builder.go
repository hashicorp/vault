...
func NewRoleManagementPoliciesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RoleManagementPoliciesCountRequestBuilder) {
    m := &RoleManagementPoliciesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/policies/roleManagementPolicies/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewRoleManagementPoliciesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RoleManagementPoliciesCountRequestBuilder) {
    ...
    return NewRoleManagementPoliciesCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *RoleManagementPoliciesCountRequestBuilder) WithUrl(rawUrl string)(*RoleManagementPoliciesCountRequestBuilder) {
    return NewRoleManagementPoliciesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
