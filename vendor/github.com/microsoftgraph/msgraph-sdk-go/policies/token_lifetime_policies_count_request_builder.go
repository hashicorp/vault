...
func NewTokenLifetimePoliciesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TokenLifetimePoliciesCountRequestBuilder) {
    m := &TokenLifetimePoliciesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/policies/tokenLifetimePolicies/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewTokenLifetimePoliciesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TokenLifetimePoliciesCountRequestBuilder) {
    ...
    return NewTokenLifetimePoliciesCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *TokenLifetimePoliciesCountRequestBuilder) WithUrl(rawUrl string)(*TokenLifetimePoliciesCountRequestBuilder) {
    return NewTokenLifetimePoliciesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
