...
func NewAttributeMappingFunctionSchemaItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AttributeMappingFunctionSchemaItemRequestBuilder) {
    m := &AttributeMappingFunctionSchemaItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/functions/{attributeMappingFunctionSchema%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *AttributeMappingFunctionSchemaItemRequestBuilder) Get(ctx context.Context, requestConfiguration *AttributeMappingFunctionSchemaItemRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AttributeMappingFunctionSchemaable, error) {
...
// returns a AttributeMappingFunctionSchemaable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *AttributeMappingFunctionSchemaItemRequestBuilder) Patch(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AttributeMappingFunctionSchemaable, requestConfiguration *AttributeMappingFunctionSchemaItemRequestBuilderPatchRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.AttributeMappingFunctionSchemaable, error) {
...
func (m *AttributeMappingFunctionSchemaItemRequestBuilder) WithUrl(rawUrl string)(*AttributeMappingFunctionSchemaItemRequestBuilder) {
    return NewAttributeMappingFunctionSchemaItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
