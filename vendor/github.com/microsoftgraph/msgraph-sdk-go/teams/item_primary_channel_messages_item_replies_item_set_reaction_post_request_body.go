...
type ItemPrimaryChannelMessagesItemRepliesItemSetReactionPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemPrimaryChannelMessagesItemRepliesItemSetReactionPostRequestBody instantiates a new ItemPrimaryChannelMessagesItemRepliesItemSetReactionPostRequestBody and sets the default values.
func NewItemPrimaryChannelMessagesItemRepliesItemSetReactionPostRequestBody()(*ItemPrimaryChannelMessagesItemRepliesItemSetReactionPostRequestBody) {
    m := &ItemPrimaryChannelMessagesItemRepliesItemSetReactionPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemPrimaryChannelMessagesItemRepliesItemSetReactionPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemPrimaryChannelMessagesItemRepliesItemSetReactionPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemPrimaryChannelMessagesItemRepliesItemSetReactionPostRequestBody) GetReactionType()(*string) {
...
func (m *ItemPrimaryChannelMessagesItemRepliesItemSetReactionPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemPrimaryChannelMessagesItemRepliesItemSetReactionPostRequestBody) SetReactionType(value *string)() {
    err := m.GetBackingStore().Set("reactionType", value)
    if err != nil {
        panic(err)
    }
}
type ItemPrimaryChannelMessagesItemRepliesItemSetReactionPostRequestBodyable interface {
