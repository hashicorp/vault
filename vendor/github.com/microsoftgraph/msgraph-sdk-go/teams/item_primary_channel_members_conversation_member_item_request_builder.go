...
// ItemPrimaryChannelMembersConversationMemberItemRequestBuilderGetQueryParameters a collection of membership records associated with the channel.
...
// NewItemPrimaryChannelMembersConversationMemberItemRequestBuilderInternal instantiates a new ItemPrimaryChannelMembersConversationMemberItemRequestBuilder and sets the default values.
func NewItemPrimaryChannelMembersConversationMemberItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemPrimaryChannelMembersConversationMemberItemRequestBuilder) {
    m := &ItemPrimaryChannelMembersConversationMemberItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/teams/{team%2Did}/primaryChannel/members/{conversationMember%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemPrimaryChannelMembersConversationMemberItemRequestBuilder instantiates a new ItemPrimaryChannelMembersConversationMemberItemRequestBuilder and sets the default values.
...
// Delete delete navigation property members for teams
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemPrimaryChannelMembersConversationMemberItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemPrimaryChannelMembersConversationMemberItemRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ConversationMemberable, error) {
...
// Patch update the navigation property members in teams
// returns a ConversationMemberable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
...
// ToDeleteRequestInformation delete navigation property members for teams
...
// returns a *ItemPrimaryChannelMembersConversationMemberItemRequestBuilder when successful
func (m *ItemPrimaryChannelMembersConversationMemberItemRequestBuilder) WithUrl(rawUrl string)(*ItemPrimaryChannelMembersConversationMemberItemRequestBuilder) {
    return NewItemPrimaryChannelMembersConversationMemberItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
