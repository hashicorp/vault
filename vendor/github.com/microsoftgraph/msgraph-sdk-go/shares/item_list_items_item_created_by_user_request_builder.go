...
// NewItemListItemsItemCreatedByUserRequestBuilderInternal instantiates a new ItemListItemsItemCreatedByUserRequestBuilder and sets the default values.
...
// NewItemListItemsItemCreatedByUserRequestBuilder instantiates a new ItemListItemsItemCreatedByUserRequestBuilder and sets the default values.
func NewItemListItemsItemCreatedByUserRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemListItemsItemCreatedByUserRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemListItemsItemCreatedByUserRequestBuilderInternal(urlParams, requestAdapter)
}
// Get identity of the user who created the item. Read-only.
// returns a Userable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemListItemsItemCreatedByUserRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemListItemsItemCreatedByUserRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Userable, error) {
...
func (m *ItemListItemsItemCreatedByUserRequestBuilder) WithUrl(rawUrl string)(*ItemListItemsItemCreatedByUserRequestBuilder) {
    return NewItemListItemsItemCreatedByUserRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
