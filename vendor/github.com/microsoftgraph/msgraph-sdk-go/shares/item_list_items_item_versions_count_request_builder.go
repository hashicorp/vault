...
func NewItemListItemsItemVersionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemListItemsItemVersionsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemListItemsItemVersionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemListItemsItemVersionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemListItemsItemVersionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemListItemsItemVersionsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemListItemsItemVersionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *ItemListItemsItemVersionsCountRequestBuilder when successful
func (m *ItemListItemsItemVersionsCountRequestBuilder) WithUrl(rawUrl string)(*ItemListItemsItemVersionsCountRequestBuilder) {
    return NewItemListItemsItemVersionsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
