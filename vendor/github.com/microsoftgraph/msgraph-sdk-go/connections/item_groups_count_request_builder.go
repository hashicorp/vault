...
// NewItemGroupsCountRequestBuilderInternal instantiates a new ItemGroupsCountRequestBuilder and sets the default values.
func NewItemGroupsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGroupsCountRequestBuilder) {
    m := &ItemGroupsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/connections/{externalConnection%2Did}/groups/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemGroupsCountRequestBuilder instantiates a new ItemGroupsCountRequestBuilder and sets the default values.
...
func (m *ItemGroupsCountRequestBuilder) WithUrl(rawUrl string)(*ItemGroupsCountRequestBuilder) {
    return NewItemGroupsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
