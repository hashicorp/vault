...
func NewItemGraphRoomListRoomsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGraphRoomListRoomsCountRequestBuilder) {
    m := &ItemGraphRoomListRoomsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/places/{place%2Did}/graph.roomList/rooms/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewItemGraphRoomListRoomsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGraphRoomListRoomsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemGraphRoomListRoomsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemGraphRoomListRoomsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemGraphRoomListRoomsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemGraphRoomListRoomsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemGraphRoomListRoomsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemGraphRoomListRoomsCountRequestBuilder) WithUrl(rawUrl string)(*ItemGraphRoomListRoomsCountRequestBuilder) {
    return NewItemGraphRoomListRoomsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
