...
func (m *DirectoryRoleEligibilityScheduleRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRoleEligibilityScheduleRequestsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
