...
func NewDirectoryRoleEligibilityScheduleRequestsFilterByCurrentUserWithOnGetResponse()(*DirectoryRoleEligibilityScheduleRequestsFilterByCurrentUserWithOnGetResponse) {
    m := &DirectoryRoleEligibilityScheduleRequestsFilterByCurrentUserWithOnGetResponse{
...
func CreateDirectoryRoleEligibilityScheduleRequestsFilterByCurrentUserWithOnGetResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewDirectoryRoleEligibilityScheduleRequestsFilterByCurrentUserWithOnGetResponse(), nil
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *DirectoryRoleEligibilityScheduleRequestsFilterByCurrentUserWithOnGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *DirectoryRoleEligibilityScheduleRequestsFilterByCurrentUserWithOnGetResponse) GetValue()([]iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UnifiedRoleEligibilityScheduleRequestable) {
...
func (m *DirectoryRoleEligibilityScheduleRequestsFilterByCurrentUserWithOnGetResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *DirectoryRoleEligibilityScheduleRequestsFilterByCurrentUserWithOnGetResponse) SetValue(value []iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UnifiedRoleEligibilityScheduleRequestable)() {
    err := m.GetBackingStore().Set("value", value)
    if err != nil {
        panic(err)
    }
}
type DirectoryRoleEligibilityScheduleRequestsFilterByCurrentUserWithOnGetResponseable interface {
