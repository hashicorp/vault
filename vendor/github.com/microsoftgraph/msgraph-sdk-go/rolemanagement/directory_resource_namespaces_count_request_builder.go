...
func NewDirectoryResourceNamespacesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryResourceNamespacesCountRequestBuilder) {
    m := &DirectoryResourceNamespacesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/roleManagement/directory/resourceNamespaces/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewDirectoryResourceNamespacesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryResourceNamespacesCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDirectoryResourceNamespacesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *DirectoryResourceNamespacesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryResourceNamespacesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *DirectoryResourceNamespacesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DirectoryResourceNamespacesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DirectoryResourceNamespacesCountRequestBuilder) WithUrl(rawUrl string)(*DirectoryResourceNamespacesCountRequestBuilder) {
    return NewDirectoryResourceNamespacesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
