...
// NewEntitlementManagementRoleEligibilityScheduleInstancesItemDirectoryScopeRequestBuilderInternal instantiates a new EntitlementManagementRoleEligibilityScheduleInstancesItemDirectoryScopeRequestBuilder and sets the default values.
func NewEntitlementManagementRoleEligibilityScheduleInstancesItemDirectoryScopeRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementRoleEligibilityScheduleInstancesItemDirectoryScopeRequestBuilder) {
    m := &EntitlementManagementRoleEligibilityScheduleInstancesItemDirectoryScopeRequestBuilder{
...
// NewEntitlementManagementRoleEligibilityScheduleInstancesItemDirectoryScopeRequestBuilder instantiates a new EntitlementManagementRoleEligibilityScheduleInstancesItemDirectoryScopeRequestBuilder and sets the default values.
func NewEntitlementManagementRoleEligibilityScheduleInstancesItemDirectoryScopeRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementRoleEligibilityScheduleInstancesItemDirectoryScopeRequestBuilder) {
    ...
    return NewEntitlementManagementRoleEligibilityScheduleInstancesItemDirectoryScopeRequestBuilderInternal(urlParams, requestAdapter)
}
// Get the directory object that is the scope of the assignment or role eligibility. Read-only.
// returns a DirectoryObjectable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *EntitlementManagementRoleEligibilityScheduleInstancesItemDirectoryScopeRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementRoleEligibilityScheduleInstancesItemDirectoryScopeRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DirectoryObjectable, error) {
...
func (m *EntitlementManagementRoleEligibilityScheduleInstancesItemDirectoryScopeRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *EntitlementManagementRoleEligibilityScheduleInstancesItemDirectoryScopeRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *EntitlementManagementRoleEligibilityScheduleInstancesItemDirectoryScopeRequestBuilder when successful
func (m *EntitlementManagementRoleEligibilityScheduleInstancesItemDirectoryScopeRequestBuilder) WithUrl(rawUrl string)(*EntitlementManagementRoleEligibilityScheduleInstancesItemDirectoryScopeRequestBuilder) {
    return NewEntitlementManagementRoleEligibilityScheduleInstancesItemDirectoryScopeRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
