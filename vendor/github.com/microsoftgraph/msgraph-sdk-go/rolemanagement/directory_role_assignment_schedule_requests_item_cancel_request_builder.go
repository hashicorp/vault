...
func (m *DirectoryRoleAssignmentScheduleRequestsItemCancelRequestBuilder) WithUrl(rawUrl string)(*DirectoryRoleAssignmentScheduleRequestsItemCancelRequestBuilder) {
    return NewDirectoryRoleAssignmentScheduleRequestsItemCancelRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
