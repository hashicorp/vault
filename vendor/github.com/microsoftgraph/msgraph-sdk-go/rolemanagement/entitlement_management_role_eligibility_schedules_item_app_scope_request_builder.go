...
// NewEntitlementManagementRoleEligibilitySchedulesItemAppScopeRequestBuilderInternal instantiates a new EntitlementManagementRoleEligibilitySchedulesItemAppScopeRequestBuilder and sets the default values.
...
// NewEntitlementManagementRoleEligibilitySchedulesItemAppScopeRequestBuilder instantiates a new EntitlementManagementRoleEligibilitySchedulesItemAppScopeRequestBuilder and sets the default values.
...
func (m *EntitlementManagementRoleEligibilitySchedulesItemAppScopeRequestBuilder) WithUrl(rawUrl string)(*EntitlementManagementRoleEligibilitySchedulesItemAppScopeRequestBuilder) {
    return NewEntitlementManagementRoleEligibilitySchedulesItemAppScopeRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
