...
func NewUserExperienceAnalyticsBaselinesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserExperienceAnalyticsBaselinesCountRequestBuilder) {
    m := &UserExperienceAnalyticsBaselinesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsBaselines/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewUserExperienceAnalyticsBaselinesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserExperienceAnalyticsBaselinesCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewUserExperienceAnalyticsBaselinesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *UserExperienceAnalyticsBaselinesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsBaselinesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *UserExperienceAnalyticsBaselinesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *UserExperienceAnalyticsBaselinesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UserExperienceAnalyticsBaselinesCountRequestBuilder) WithUrl(rawUrl string)(*UserExperienceAnalyticsBaselinesCountRequestBuilder) {
    return NewUserExperienceAnalyticsBaselinesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
