...
func NewUserExperienceAnalyticsDeviceScoresCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserExperienceAnalyticsDeviceScoresCountRequestBuilder) {
    m := &UserExperienceAnalyticsDeviceScoresCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsDeviceScores/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewUserExperienceAnalyticsDeviceScoresCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserExperienceAnalyticsDeviceScoresCountRequestBuilder) {
    ...
    return NewUserExperienceAnalyticsDeviceScoresCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *UserExperienceAnalyticsDeviceScoresCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsDeviceScoresCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *UserExperienceAnalyticsDeviceScoresCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *UserExperienceAnalyticsDeviceScoresCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UserExperienceAnalyticsDeviceScoresCountRequestBuilder) WithUrl(rawUrl string)(*UserExperienceAnalyticsDeviceScoresCountRequestBuilder) {
    return NewUserExperienceAnalyticsDeviceScoresCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
