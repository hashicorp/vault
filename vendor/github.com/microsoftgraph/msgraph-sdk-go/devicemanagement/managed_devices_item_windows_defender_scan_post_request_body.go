...
func (m *ManagedDevicesItemWindowsDefenderScanPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ManagedDevicesItemWindowsDefenderScanPostRequestBody) GetQuickScan()(*bool) {
    val, err := m.GetBackingStore().Get("quickScan")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ManagedDevicesItemWindowsDefenderScanPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ManagedDevicesItemWindowsDefenderScanPostRequestBody) SetQuickScan(value *bool)() {
    err := m.GetBackingStore().Set("quickScan", value)
    if err != nil {
        panic(err)
    }
}
type ManagedDevicesItemWindowsDefenderScanPostRequestBodyable interface {
