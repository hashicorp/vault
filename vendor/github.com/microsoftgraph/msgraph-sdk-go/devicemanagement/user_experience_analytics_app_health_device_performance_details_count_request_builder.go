...
func NewUserExperienceAnalyticsAppHealthDevicePerformanceDetailsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserExperienceAnalyticsAppHealthDevicePerformanceDetailsCountRequestBuilder) {
    m := &UserExperienceAnalyticsAppHealthDevicePerformanceDetailsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthDevicePerformanceDetails/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewUserExperienceAnalyticsAppHealthDevicePerformanceDetailsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserExperienceAnalyticsAppHealthDevicePerformanceDetailsCountRequestBuilder) {
    ...
    return NewUserExperienceAnalyticsAppHealthDevicePerformanceDetailsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *UserExperienceAnalyticsAppHealthDevicePerformanceDetailsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsAppHealthDevicePerformanceDetailsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *UserExperienceAnalyticsAppHealthDevicePerformanceDetailsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *UserExperienceAnalyticsAppHealthDevicePerformanceDetailsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UserExperienceAnalyticsAppHealthDevicePerformanceDetailsCountRequestBuilder) WithUrl(rawUrl string)(*UserExperienceAnalyticsAppHealthDevicePerformanceDetailsCountRequestBuilder) {
    return NewUserExperienceAnalyticsAppHealthDevicePerformanceDetailsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
