...
func NewReportsGetConfigurationSettingNonComplianceReportPostRequestBody()(*ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) {
    m := &ReportsGetConfigurationSettingNonComplianceReportPostRequestBody{
    }
...
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) GetFilter()(*string) {
...
// returns a []string when successful
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) GetGroupBy()([]string) {
...
// returns a *string when successful
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) GetName()(*string) {
...
// returns a []string when successful
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) GetOrderBy()([]string) {
...
// returns a *string when successful
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) GetSearch()(*string) {
...
// returns a []string when successful
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) GetSelectEscaped()([]string) {
...
// returns a *string when successful
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) GetSessionId()(*string) {
...
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) GetSkip()(*int32) {
...
// returns a *int32 when successful
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) GetTop()(*int32) {
...
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) SetFilter(value *string)() {
...
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) SetGroupBy(value []string)() {
...
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) SetName(value *string)() {
...
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) SetOrderBy(value []string)() {
...
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) SetSearch(value *string)() {
...
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) SetSelectEscaped(value []string)() {
...
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) SetSessionId(value *string)() {
...
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) SetSkip(value *int32)() {
...
func (m *ReportsGetConfigurationSettingNonComplianceReportPostRequestBody) SetTop(value *int32)() {
