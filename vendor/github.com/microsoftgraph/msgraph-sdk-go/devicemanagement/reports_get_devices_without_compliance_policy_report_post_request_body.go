...
func NewReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody()(*ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody) {
    m := &ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody{
    }
...
func (m *ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody) GetFilter()(*string) {
...
// returns a []string when successful
func (m *ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody) GetGroupBy()([]string) {
...
// returns a *string when successful
func (m *ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody) GetName()(*string) {
...
// returns a []string when successful
func (m *ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody) GetOrderBy()([]string) {
...
// returns a *string when successful
func (m *ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody) GetSearch()(*string) {
...
// returns a *string when successful
func (m *ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody) GetSessionId()(*string) {
...
func (m *ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody) GetSkip()(*int32) {
...
// returns a *int32 when successful
func (m *ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody) GetTop()(*int32) {
...
func (m *ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody) SetFilter(value *string)() {
...
func (m *ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody) SetGroupBy(value []string)() {
...
func (m *ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody) SetName(value *string)() {
...
func (m *ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody) SetOrderBy(value []string)() {
...
func (m *ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody) SetSearch(value *string)() {
...
func (m *ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody) SetSessionId(value *string)() {
...
func (m *ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody) SetSkip(value *int32)() {
...
func (m *ReportsGetDevicesWithoutCompliancePolicyReportPostRequestBody) SetTop(value *int32)() {
