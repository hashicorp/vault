...
func NewReportsGetSettingNonComplianceReportPostRequestBody()(*ReportsGetSettingNonComplianceReportPostRequestBody) {
    m := &ReportsGetSettingNonComplianceReportPostRequestBody{
    }
...
func (m *ReportsGetSettingNonComplianceReportPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ReportsGetSettingNonComplianceReportPostRequestBody) GetFilter()(*string) {
...
// returns a []string when successful
func (m *ReportsGetSettingNonComplianceReportPostRequestBody) GetGroupBy()([]string) {
...
// returns a *string when successful
func (m *ReportsGetSettingNonComplianceReportPostRequestBody) GetName()(*string) {
...
// returns a []string when successful
func (m *ReportsGetSettingNonComplianceReportPostRequestBody) GetOrderBy()([]string) {
...
// returns a *string when successful
func (m *ReportsGetSettingNonComplianceReportPostRequestBody) GetSearch()(*string) {
...
// returns a []string when successful
func (m *ReportsGetSettingNonComplianceReportPostRequestBody) GetSelectEscaped()([]string) {
...
// returns a *string when successful
func (m *ReportsGetSettingNonComplianceReportPostRequestBody) GetSessionId()(*string) {
...
func (m *ReportsGetSettingNonComplianceReportPostRequestBody) GetSkip()(*int32) {
...
// returns a *int32 when successful
func (m *ReportsGetSettingNonComplianceReportPostRequestBody) GetTop()(*int32) {
...
func (m *ReportsGetSettingNonComplianceReportPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ReportsGetSettingNonComplianceReportPostRequestBody) SetFilter(value *string)() {
...
func (m *ReportsGetSettingNonComplianceReportPostRequestBody) SetGroupBy(value []string)() {
...
func (m *ReportsGetSettingNonComplianceReportPostRequestBody) SetName(value *string)() {
...
func (m *ReportsGetSettingNonComplianceReportPostRequestBody) SetOrderBy(value []string)() {
...
func (m *ReportsGetSettingNonComplianceReportPostRequestBody) SetSearch(value *string)() {
...
func (m *ReportsGetSettingNonComplianceReportPostRequestBody) SetSessionId(value *string)() {
...
func (m *ReportsGetSettingNonComplianceReportPostRequestBody) SetSkip(value *int32)() {
...
func (m *ReportsGetSettingNonComplianceReportPostRequestBody) SetTop(value *int32)() {
