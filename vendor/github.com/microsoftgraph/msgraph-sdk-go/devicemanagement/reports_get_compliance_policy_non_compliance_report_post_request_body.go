...
func NewReportsGetCompliancePolicyNonComplianceReportPostRequestBody()(*ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) {
    m := &ReportsGetCompliancePolicyNonComplianceReportPostRequestBody{
    }
...
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) GetFilter()(*string) {
...
// returns a []string when successful
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) GetGroupBy()([]string) {
...
// returns a *string when successful
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) GetName()(*string) {
...
// returns a []string when successful
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) GetOrderBy()([]string) {
...
// returns a *string when successful
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) GetSearch()(*string) {
...
// returns a []string when successful
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) GetSelectEscaped()([]string) {
...
// returns a *string when successful
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) GetSessionId()(*string) {
...
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) GetSkip()(*int32) {
...
// returns a *int32 when successful
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) GetTop()(*int32) {
...
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) SetFilter(value *string)() {
...
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) SetGroupBy(value []string)() {
...
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) SetName(value *string)() {
...
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) SetOrderBy(value []string)() {
...
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) SetSearch(value *string)() {
...
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) SetSelectEscaped(value []string)() {
...
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) SetSessionId(value *string)() {
...
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) SetSkip(value *int32)() {
...
func (m *ReportsGetCompliancePolicyNonComplianceReportPostRequestBody) SetTop(value *int32)() {
