...
func NewVirtualEndpointCloudPCsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEndpointCloudPCsCountRequestBuilder) {
    m := &VirtualEndpointCloudPCsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewVirtualEndpointCloudPCsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEndpointCloudPCsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewVirtualEndpointCloudPCsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *VirtualEndpointCloudPCsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEndpointCloudPCsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *VirtualEndpointCloudPCsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *VirtualEndpointCloudPCsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *VirtualEndpointCloudPCsCountRequestBuilder) WithUrl(rawUrl string)(*VirtualEndpointCloudPCsCountRequestBuilder) {
    return NewVirtualEndpointCloudPCsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
