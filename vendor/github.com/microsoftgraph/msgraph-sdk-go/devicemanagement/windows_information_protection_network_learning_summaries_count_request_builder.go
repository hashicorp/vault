...
func NewWindowsInformationProtectionNetworkLearningSummariesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WindowsInformationProtectionNetworkLearningSummariesCountRequestBuilder) {
    m := &WindowsInformationProtectionNetworkLearningSummariesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/windowsInformationProtectionNetworkLearningSummaries/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewWindowsInformationProtectionNetworkLearningSummariesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WindowsInformationProtectionNetworkLearningSummariesCountRequestBuilder) {
    ...
    return NewWindowsInformationProtectionNetworkLearningSummariesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *WindowsInformationProtectionNetworkLearningSummariesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *WindowsInformationProtectionNetworkLearningSummariesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *WindowsInformationProtectionNetworkLearningSummariesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *WindowsInformationProtectionNetworkLearningSummariesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *WindowsInformationProtectionNetworkLearningSummariesCountRequestBuilder when successful
func (m *WindowsInformationProtectionNetworkLearningSummariesCountRequestBuilder) WithUrl(rawUrl string)(*WindowsInformationProtectionNetworkLearningSummariesCountRequestBuilder) {
    return NewWindowsInformationProtectionNetworkLearningSummariesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
