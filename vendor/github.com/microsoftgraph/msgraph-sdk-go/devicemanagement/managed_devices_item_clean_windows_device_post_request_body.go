...
func NewManagedDevicesItemCleanWindowsDevicePostRequestBody()(*ManagedDevicesItemCleanWindowsDevicePostRequestBody) {
    m := &ManagedDevicesItemCleanWindowsDevicePostRequestBody{
    }
...
func (m *ManagedDevicesItemCleanWindowsDevicePostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ManagedDevicesItemCleanWindowsDevicePostRequestBody) GetKeepUserData()(*bool) {
...
func (m *ManagedDevicesItemCleanWindowsDevicePostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
type ManagedDevicesItemCleanWindowsDevicePostRequestBodyable interface {
