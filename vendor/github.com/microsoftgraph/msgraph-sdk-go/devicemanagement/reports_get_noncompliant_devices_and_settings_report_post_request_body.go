...
// returns a []string when successful
func (m *ReportsGetNoncompliantDevicesAndSettingsReportPostRequestBody) GetSelectEscaped()([]string) {
...
func (m *ReportsGetNoncompliantDevicesAndSettingsReportPostRequestBody) SetSelectEscaped(value []string)() {
