...
func NewReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody()(*ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) {
    m := &ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody{
    }
...
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) GetFilter()(*string) {
...
// returns a []string when successful
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) GetGroupBy()([]string) {
...
// returns a *string when successful
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) GetName()(*string) {
...
// returns a []string when successful
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) GetOrderBy()([]string) {
...
// returns a *string when successful
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) GetSearch()(*string) {
...
// returns a []string when successful
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) GetSelectEscaped()([]string) {
...
// returns a *string when successful
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) GetSessionId()(*string) {
...
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) GetSkip()(*int32) {
...
// returns a *int32 when successful
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) GetTop()(*int32) {
...
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) SetFilter(value *string)() {
...
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) SetGroupBy(value []string)() {
...
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) SetName(value *string)() {
...
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) SetOrderBy(value []string)() {
...
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) SetSearch(value *string)() {
...
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) SetSelectEscaped(value []string)() {
...
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) SetSessionId(value *string)() {
...
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) SetSkip(value *int32)() {
...
func (m *ReportsGetConfigurationPolicyNonComplianceSummaryReportPostRequestBody) SetTop(value *int32)() {
