...
func NewVirtualEndpointGalleryImagesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEndpointGalleryImagesCountRequestBuilder) {
    m := &VirtualEndpointGalleryImagesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/virtualEndpoint/galleryImages/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewVirtualEndpointGalleryImagesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEndpointGalleryImagesCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewVirtualEndpointGalleryImagesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *VirtualEndpointGalleryImagesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *VirtualEndpointGalleryImagesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *VirtualEndpointGalleryImagesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *VirtualEndpointGalleryImagesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *VirtualEndpointGalleryImagesCountRequestBuilder) WithUrl(rawUrl string)(*VirtualEndpointGalleryImagesCountRequestBuilder) {
    return NewVirtualEndpointGalleryImagesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
