...
func NewRemoteAssistancePartnersCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RemoteAssistancePartnersCountRequestBuilder) {
    m := &RemoteAssistancePartnersCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/remoteAssistancePartners/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewRemoteAssistancePartnersCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RemoteAssistancePartnersCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewRemoteAssistancePartnersCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *RemoteAssistancePartnersCountRequestBuilder) Get(ctx context.Context, requestConfiguration *RemoteAssistancePartnersCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *RemoteAssistancePartnersCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *RemoteAssistancePartnersCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *RemoteAssistancePartnersCountRequestBuilder) WithUrl(rawUrl string)(*RemoteAssistancePartnersCountRequestBuilder) {
    return NewRemoteAssistancePartnersCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
