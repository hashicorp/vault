...
// returns a []string when successful
func (m *ReportsGetDeviceManagementIntentPerSettingContributingProfilesPostRequestBody) GetSelectEscaped()([]string) {
...
func (m *ReportsGetDeviceManagementIntentPerSettingContributingProfilesPostRequestBody) SetSelectEscaped(value []string)() {
