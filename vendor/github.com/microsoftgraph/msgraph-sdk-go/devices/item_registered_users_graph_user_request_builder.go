...
func NewItemRegisteredUsersGraphUserRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredUsersGraphUserRequestBuilder) {
    m := &ItemRegisteredUsersGraphUserRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/devices/{device%2Did}/registeredUsers/graph.user{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
...
func NewItemRegisteredUsersGraphUserRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRegisteredUsersGraphUserRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemRegisteredUsersGraphUserRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *ItemRegisteredUsersGraphUserCountRequestBuilder when successful
func (m *ItemRegisteredUsersGraphUserRequestBuilder) Count()(*ItemRegisteredUsersGraphUserCountRequestBuilder) {
    return NewItemRegisteredUsersGraphUserCountRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemRegisteredUsersGraphUserRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRegisteredUsersGraphUserRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UserCollectionResponseable, error) {
...
func (m *ItemRegisteredUsersGraphUserRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemRegisteredUsersGraphUserRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *ItemRegisteredUsersGraphUserRequestBuilder when successful
func (m *ItemRegisteredUsersGraphUserRequestBuilder) WithUrl(rawUrl string)(*ItemRegisteredUsersGraphUserRequestBuilder) {
    return NewItemRegisteredUsersGraphUserRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
