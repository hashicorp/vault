...
func (m *GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder) WithUrl(rawUrl string)(*GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder) {
    return NewGetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
