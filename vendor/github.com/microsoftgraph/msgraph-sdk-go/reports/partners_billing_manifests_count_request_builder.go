...
func NewPartnersBillingManifestsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PartnersBillingManifestsCountRequestBuilder) {
    m := &PartnersBillingManifestsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/partners/billing/manifests/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewPartnersBillingManifestsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PartnersBillingManifestsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewPartnersBillingManifestsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *PartnersBillingManifestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *PartnersBillingManifestsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *PartnersBillingManifestsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *PartnersBillingManifestsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *PartnersBillingManifestsCountRequestBuilder) WithUrl(rawUrl string)(*PartnersBillingManifestsCountRequestBuilder) {
    return NewPartnersBillingManifestsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
