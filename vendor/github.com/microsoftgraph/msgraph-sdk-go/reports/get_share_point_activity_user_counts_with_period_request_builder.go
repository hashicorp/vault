...
func (m *GetSharePointActivityUserCountsWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetSharePointActivityUserCountsWithPeriodRequestBuilder) {
    return NewGetSharePointActivityUserCountsWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
