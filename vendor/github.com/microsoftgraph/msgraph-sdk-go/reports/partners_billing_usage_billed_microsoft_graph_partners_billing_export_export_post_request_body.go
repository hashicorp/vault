...
func NewPartnersBillingUsageBilledMicrosoftGraphPartnersBillingExportExportPostRequestBody()(*PartnersBillingUsageBilledMicrosoftGraphPartnersBillingExportExportPostRequestBody) {
    m := &PartnersBillingUsageBilledMicrosoftGraphPartnersBillingExportExportPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreatePartnersBillingUsageBilledMicrosoftGraphPartnersBillingExportExportPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreatePartnersBillingUsageBilledMicrosoftGraphPartnersBillingExportExportPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewPartnersBillingUsageBilledMicrosoftGraphPartnersBillingExportExportPostRequestBody(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *PartnersBillingUsageBilledMicrosoftGraphPartnersBillingExportExportPostRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *PartnersBillingUsageBilledMicrosoftGraphPartnersBillingExportExportPostRequestBody) GetAttributeSet()(*ieaa1d050ea8ba883c482e05cf2306cb5376cc6e2cf5966c1a6850c42c6118fa4.AttributeSet) {
...
func (m *PartnersBillingUsageBilledMicrosoftGraphPartnersBillingExportExportPostRequestBody) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
    return m.backingStore
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *PartnersBillingUsageBilledMicrosoftGraphPartnersBillingExportExportPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *PartnersBillingUsageBilledMicrosoftGraphPartnersBillingExportExportPostRequestBody) GetInvoiceId()(*string) {
...
func (m *PartnersBillingUsageBilledMicrosoftGraphPartnersBillingExportExportPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *PartnersBillingUsageBilledMicrosoftGraphPartnersBillingExportExportPostRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *PartnersBillingUsageBilledMicrosoftGraphPartnersBillingExportExportPostRequestBody) SetAttributeSet(value *ieaa1d050ea8ba883c482e05cf2306cb5376cc6e2cf5966c1a6850c42c6118fa4.AttributeSet)() {
...
func (m *PartnersBillingUsageBilledMicrosoftGraphPartnersBillingExportExportPostRequestBody) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
    m.backingStore = value
}
// SetInvoiceId sets the invoiceId property value. The invoiceId property
func (m *PartnersBillingUsageBilledMicrosoftGraphPartnersBillingExportExportPostRequestBody) SetInvoiceId(value *string)() {
    err := m.GetBackingStore().Set("invoiceId", value)
    if err != nil {
        panic(err)
    }
}
type PartnersBillingUsageBilledMicrosoftGraphPartnersBillingExportExportPostRequestBodyable interface {
