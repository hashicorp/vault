...
func (m *GetSharePointActivityUserDetailWithPeriodRequestBuilder) WithUrl(rawUrl string)(*GetSharePointActivityUserDetailWithPeriodRequestBuilder) {
    return NewGetSharePointActivityUserDetailWithPeriodRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
