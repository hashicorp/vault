...
func NewPartnersBillingOperationsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PartnersBillingOperationsCountRequestBuilder) {
    m := &PartnersBillingOperationsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/reports/partners/billing/operations/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewPartnersBillingOperationsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PartnersBillingOperationsCountRequestBuilder) {
    ...
    return NewPartnersBillingOperationsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *PartnersBillingOperationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *PartnersBillingOperationsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *PartnersBillingOperationsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *PartnersBillingOperationsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *PartnersBillingOperationsCountRequestBuilder) WithUrl(rawUrl string)(*PartnersBillingOperationsCountRequestBuilder) {
    return NewPartnersBillingOperationsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
