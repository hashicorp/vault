...
func NewAttackSimulationLoginPagesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AttackSimulationLoginPagesCountRequestBuilder) {
    m := &AttackSimulationLoginPagesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/attackSimulation/loginPages/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewAttackSimulationLoginPagesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AttackSimulationLoginPagesCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewAttackSimulationLoginPagesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *AttackSimulationLoginPagesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AttackSimulationLoginPagesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *AttackSimulationLoginPagesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *AttackSimulationLoginPagesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *AttackSimulationLoginPagesCountRequestBuilder) WithUrl(rawUrl string)(*AttackSimulationLoginPagesCountRequestBuilder) {
    return NewAttackSimulationLoginPagesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
