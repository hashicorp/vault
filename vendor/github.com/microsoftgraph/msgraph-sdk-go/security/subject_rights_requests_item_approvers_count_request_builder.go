...
func NewSubjectRightsRequestsItemApproversCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SubjectRightsRequestsItemApproversCountRequestBuilder) {
    m := &SubjectRightsRequestsItemApproversCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/approvers/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewSubjectRightsRequestsItemApproversCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SubjectRightsRequestsItemApproversCountRequestBuilder) {
    ...
    return NewSubjectRightsRequestsItemApproversCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *SubjectRightsRequestsItemApproversCountRequestBuilder) Get(ctx context.Context, requestConfiguration *SubjectRightsRequestsItemApproversCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *SubjectRightsRequestsItemApproversCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *SubjectRightsRequestsItemApproversCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SubjectRightsRequestsItemApproversCountRequestBuilder) WithUrl(rawUrl string)(*SubjectRightsRequestsItemApproversCountRequestBuilder) {
    return NewSubjectRightsRequestsItemApproversCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
