...
func NewAttackSimulationSimulationAutomationsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AttackSimulationSimulationAutomationsCountRequestBuilder) {
    m := &AttackSimulationSimulationAutomationsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/attackSimulation/simulationAutomations/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func (m *AttackSimulationSimulationAutomationsCountRequestBuilder) WithUrl(rawUrl string)(*AttackSimulationSimulationAutomationsCountRequestBuilder) {
    return NewAttackSimulationSimulationAutomationsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
