...
func NewThreatIntelligenceHostSslCertificatesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatIntelligenceHostSslCertificatesCountRequestBuilder) {
    m := &ThreatIntelligenceHostSslCertificatesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/threatIntelligence/hostSslCertificates/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewThreatIntelligenceHostSslCertificatesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatIntelligenceHostSslCertificatesCountRequestBuilder) {
    ...
    return NewThreatIntelligenceHostSslCertificatesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ThreatIntelligenceHostSslCertificatesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceHostSslCertificatesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ThreatIntelligenceHostSslCertificatesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ThreatIntelligenceHostSslCertificatesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ThreatIntelligenceHostSslCertificatesCountRequestBuilder) WithUrl(rawUrl string)(*ThreatIntelligenceHostSslCertificatesCountRequestBuilder) {
    return NewThreatIntelligenceHostSslCertificatesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
