...
func NewIdentitiesHealthIssuesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*IdentitiesHealthIssuesCountRequestBuilder) {
    m := &IdentitiesHealthIssuesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/identities/healthIssues/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewIdentitiesHealthIssuesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*IdentitiesHealthIssuesCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewIdentitiesHealthIssuesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *IdentitiesHealthIssuesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *IdentitiesHealthIssuesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *IdentitiesHealthIssuesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *IdentitiesHealthIssuesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *IdentitiesHealthIssuesCountRequestBuilder) WithUrl(rawUrl string)(*IdentitiesHealthIssuesCountRequestBuilder) {
    return NewIdentitiesHealthIssuesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
