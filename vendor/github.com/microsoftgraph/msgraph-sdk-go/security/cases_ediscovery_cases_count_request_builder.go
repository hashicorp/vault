...
func NewCasesEdiscoveryCasesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoveryCasesCountRequestBuilder) {
    m := &CasesEdiscoveryCasesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewCasesEdiscoveryCasesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoveryCasesCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewCasesEdiscoveryCasesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *CasesEdiscoveryCasesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *CasesEdiscoveryCasesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CasesEdiscoveryCasesCountRequestBuilder) WithUrl(rawUrl string)(*CasesEdiscoveryCasesCountRequestBuilder) {
    return NewCasesEdiscoveryCasesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
