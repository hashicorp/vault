...
func NewCasesEdiscoveryCasesItemReviewSetsItemQueriesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoveryCasesItemReviewSetsItemQueriesCountRequestBuilder) {
    m := &CasesEdiscoveryCasesItemReviewSetsItemQueriesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/reviewSets/{ediscoveryReviewSet%2Did}/queries/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewCasesEdiscoveryCasesItemReviewSetsItemQueriesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CasesEdiscoveryCasesItemReviewSetsItemQueriesCountRequestBuilder) {
    ...
    return NewCasesEdiscoveryCasesItemReviewSetsItemQueriesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *CasesEdiscoveryCasesItemReviewSetsItemQueriesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesItemReviewSetsItemQueriesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *CasesEdiscoveryCasesItemReviewSetsItemQueriesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *CasesEdiscoveryCasesItemReviewSetsItemQueriesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CasesEdiscoveryCasesItemReviewSetsItemQueriesCountRequestBuilder) WithUrl(rawUrl string)(*CasesEdiscoveryCasesItemReviewSetsItemQueriesCountRequestBuilder) {
    return NewCasesEdiscoveryCasesItemReviewSetsItemQueriesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
