...
func NewRiskyUsersConfirmCompromisedPostRequestBody()(*RiskyUsersConfirmCompromisedPostRequestBody) {
    m := &RiskyUsersConfirmCompromisedPostRequestBody{
    }
...
func (m *RiskyUsersConfirmCompromisedPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *RiskyUsersConfirmCompromisedPostRequestBody) GetUserIds()([]string) {
...
func (m *RiskyUsersConfirmCompromisedPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetUserIds() != nil {
...
type RiskyUsersConfirmCompromisedPostRequestBodyable interface {
