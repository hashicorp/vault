...
func NewItemFederationConfigurationCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemFederationConfigurationCountRequestBuilder) {
    m := &ItemFederationConfigurationCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/domains/{domain%2Did}/federationConfiguration/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewItemFederationConfigurationCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemFederationConfigurationCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemFederationConfigurationCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemFederationConfigurationCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemFederationConfigurationCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ItemFederationConfigurationCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemFederationConfigurationCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemFederationConfigurationCountRequestBuilder) WithUrl(rawUrl string)(*ItemFederationConfigurationCountRequestBuilder) {
    return NewItemFederationConfigurationCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
