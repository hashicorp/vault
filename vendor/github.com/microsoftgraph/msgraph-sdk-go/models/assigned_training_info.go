...
func (m *AssignedTrainingInfo) GetAssignedUserCount()(*int32) {
    val, err := m.GetBackingStore().Get("assignedUserCount")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *AssignedTrainingInfo) GetCompletedUserCount()(*int32) {
    val, err := m.GetBackingStore().Get("completedUserCount")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *AssignedTrainingInfo) SetAssignedUserCount(value *int32)() {
    err := m.GetBackingStore().Set("assignedUserCount", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *AssignedTrainingInfo) SetCompletedUserCount(value *int32)() {
    err := m.GetBackingStore().Set("completedUserCount", value)
    if err != nil {
        panic(err)
    }
}
