...
// NewSubjectRightsRequestMailboxLocation instantiates a new SubjectRightsRequestMailboxLocation and sets the default values.
...
func CreateSubjectRightsRequestMailboxLocationFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    if parseNode != nil {
...
func (m *SubjectRightsRequestMailboxLocation) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *SubjectRightsRequestMailboxLocation) GetOdataType()(*string) {
...
func (m *SubjectRightsRequestMailboxLocation) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *SubjectRightsRequestMailboxLocation) SetOdataType(value *string)() {
    err := m.GetBackingStore().Set("odataType", value)
    if err != nil {
        panic(err)
    }
}
type SubjectRightsRequestMailboxLocationable interface {
