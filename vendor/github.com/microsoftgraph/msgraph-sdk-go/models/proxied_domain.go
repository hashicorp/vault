...
func (m *ProxiedDomain) GetIpAddressOrFQDN()(*string) {
    val, err := m.GetBackingStore().Get("ipAddressOrFQDN")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ProxiedDomain) GetProxy()(*string) {
    val, err := m.GetBackingStore().Get("proxy")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ProxiedDomain) SetIpAddressOrFQDN(value *string)() {
    err := m.GetBackingStore().Set("ipAddressOrFQDN", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *ProxiedDomain) SetProxy(value *string)() {
    err := m.GetBackingStore().Set("proxy", value)
    if err != nil {
        panic(err)
    }
}
type ProxiedDomainable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackedModel
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)
    GetIpAddressOrFQDN()(*string)
    GetOdataType()(*string)
    GetProxy()(*string)
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetIpAddressOrFQDN(value *string)()
