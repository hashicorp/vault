...
// MobileAppsItemGraphWindowsMobileMSICategoriesRequestBuilder provides operations to manage the categories property of the microsoft.graph.mobileApp entity.
type MobileAppsItemGraphWindowsMobileMSICategoriesRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// MobileAppsItemGraphWindowsMobileMSICategoriesRequestBuilderGetQueryParameters the list of categories for this app.
type MobileAppsItemGraphWindowsMobileMSICategoriesRequestBuilderGetQueryParameters struct {
...
// MobileAppsItemGraphWindowsMobileMSICategoriesRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type MobileAppsItemGraphWindowsMobileMSICategoriesRequestBuilderGetRequestConfiguration struct {
    // Request headers
