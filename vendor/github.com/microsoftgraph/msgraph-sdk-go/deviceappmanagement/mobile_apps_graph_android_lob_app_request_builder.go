...
// NewMobileAppsGraphAndroidLobAppRequestBuilderInternal instantiates a new MobileAppsGraphAndroidLobAppRequestBuilder and sets the default values.
func NewMobileAppsGraphAndroidLobAppRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MobileAppsGraphAndroidLobAppRequestBuilder) {
    m := &MobileAppsGraphAndroidLobAppRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.androidLobApp{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewMobileAppsGraphAndroidLobAppRequestBuilder instantiates a new MobileAppsGraphAndroidLobAppRequestBuilder and sets the default values.
...
// returns a AndroidLobAppCollectionResponseable when successful
