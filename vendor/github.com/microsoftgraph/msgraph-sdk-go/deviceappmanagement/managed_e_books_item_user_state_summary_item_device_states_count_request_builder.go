...
// NewManagedEBooksItemUserStateSummaryItemDeviceStatesCountRequestBuilderInternal instantiates a new ManagedEBooksItemUserStateSummaryItemDeviceStatesCountRequestBuilder and sets the default values.
func NewManagedEBooksItemUserStateSummaryItemDeviceStatesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ManagedEBooksItemUserStateSummaryItemDeviceStatesCountRequestBuilder) {
    m := &ManagedEBooksItemUserStateSummaryItemDeviceStatesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}/userStateSummary/{userInstallStateSummary%2Did}/deviceStates/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewManagedEBooksItemUserStateSummaryItemDeviceStatesCountRequestBuilder instantiates a new ManagedEBooksItemUserStateSummaryItemDeviceStatesCountRequestBuilder and sets the default values.
...
// returns a *ManagedEBooksItemUserStateSummaryItemDeviceStatesCountRequestBuilder when successful
func (m *ManagedEBooksItemUserStateSummaryItemDeviceStatesCountRequestBuilder) WithUrl(rawUrl string)(*ManagedEBooksItemUserStateSummaryItemDeviceStatesCountRequestBuilder) {
    return NewManagedEBooksItemUserStateSummaryItemDeviceStatesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
