...
// NewMobileAppsItemGraphMicrosoftStoreForBusinessAppCategoriesCountRequestBuilderInternal instantiates a new MobileAppsItemGraphMicrosoftStoreForBusinessAppCategoriesCountRequestBuilder and sets the default values.
func NewMobileAppsItemGraphMicrosoftStoreForBusinessAppCategoriesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MobileAppsItemGraphMicrosoftStoreForBusinessAppCategoriesCountRequestBuilder) {
    m := &MobileAppsItemGraphMicrosoftStoreForBusinessAppCategoriesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.microsoftStoreForBusinessApp/categories/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewMobileAppsItemGraphMicrosoftStoreForBusinessAppCategoriesCountRequestBuilder instantiates a new MobileAppsItemGraphMicrosoftStoreForBusinessAppCategoriesCountRequestBuilder and sets the default values.
