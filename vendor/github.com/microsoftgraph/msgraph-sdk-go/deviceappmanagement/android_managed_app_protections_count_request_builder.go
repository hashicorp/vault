...
// NewAndroidManagedAppProtectionsCountRequestBuilderInternal instantiates a new AndroidManagedAppProtectionsCountRequestBuilder and sets the default values.
func NewAndroidManagedAppProtectionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AndroidManagedAppProtectionsCountRequestBuilder) {
    m := &AndroidManagedAppProtectionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceAppManagement/androidManagedAppProtections/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewAndroidManagedAppProtectionsCountRequestBuilder instantiates a new AndroidManagedAppProtectionsCountRequestBuilder and sets the default values.
...
// returns a *AndroidManagedAppProtectionsCountRequestBuilder when successful
func (m *AndroidManagedAppProtectionsCountRequestBuilder) WithUrl(rawUrl string)(*AndroidManagedAppProtectionsCountRequestBuilder) {
    return NewAndroidManagedAppProtectionsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
