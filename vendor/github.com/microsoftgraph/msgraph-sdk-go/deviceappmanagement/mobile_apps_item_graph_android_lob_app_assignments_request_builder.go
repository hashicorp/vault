...
// MobileAppsItemGraphAndroidLobAppAssignmentsRequestBuilderGetQueryParameters the list of group assignments for this mobile app.
...
// NewMobileAppsItemGraphAndroidLobAppAssignmentsRequestBuilderInternal instantiates a new MobileAppsItemGraphAndroidLobAppAssignmentsRequestBuilder and sets the default values.
func NewMobileAppsItemGraphAndroidLobAppAssignmentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MobileAppsItemGraphAndroidLobAppAssignmentsRequestBuilder) {
    m := &MobileAppsItemGraphAndroidLobAppAssignmentsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.androidLobApp/assignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewMobileAppsItemGraphAndroidLobAppAssignmentsRequestBuilder instantiates a new MobileAppsItemGraphAndroidLobAppAssignmentsRequestBuilder and sets the default values.
