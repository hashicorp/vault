...
// NewMobileAppsItemGraphMacOSLobAppCategoriesCountRequestBuilderInternal instantiates a new MobileAppsItemGraphMacOSLobAppCategoriesCountRequestBuilder and sets the default values.
func NewMobileAppsItemGraphMacOSLobAppCategoriesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MobileAppsItemGraphMacOSLobAppCategoriesCountRequestBuilder) {
    m := &MobileAppsItemGraphMacOSLobAppCategoriesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.macOSLobApp/categories/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewMobileAppsItemGraphMacOSLobAppCategoriesCountRequestBuilder instantiates a new MobileAppsItemGraphMacOSLobAppCategoriesCountRequestBuilder and sets the default values.
