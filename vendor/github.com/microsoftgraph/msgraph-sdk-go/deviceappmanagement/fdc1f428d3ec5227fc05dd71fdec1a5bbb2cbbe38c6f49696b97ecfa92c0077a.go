...
type MobileAppsItemGraphManagedMobileLobAppContentVersionsItemFilesItemCommitPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewMobileAppsItemGraphManagedMobileLobAppContentVersionsItemFilesItemCommitPostRequestBody instantiates a new MobileAppsItemGraphManagedMobileLobAppContentVersionsItemFilesItemCommitPostRequestBody and sets the default values.
func NewMobileAppsItemGraphManagedMobileLobAppContentVersionsItemFilesItemCommitPostRequestBody()(*MobileAppsItemGraphManagedMobileLobAppContentVersionsItemFilesItemCommitPostRequestBody) {
...
// CreateMobileAppsItemGraphManagedMobileLobAppContentVersionsItemFilesItemCommitPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *MobileAppsItemGraphManagedMobileLobAppContentVersionsItemFilesItemCommitPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *MobileAppsItemGraphManagedMobileLobAppContentVersionsItemFilesItemCommitPostRequestBody) GetFileEncryptionInfo()(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.FileEncryptionInfoable) {
...
func (m *MobileAppsItemGraphManagedMobileLobAppContentVersionsItemFilesItemCommitPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *MobileAppsItemGraphManagedMobileLobAppContentVersionsItemFilesItemCommitPostRequestBody) SetFileEncryptionInfo(value iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.FileEncryptionInfoable)() {
    err := m.GetBackingStore().Set("fileEncryptionInfo", value)
    if err != nil {
        panic(err)
    }
}
type MobileAppsItemGraphManagedMobileLobAppContentVersionsItemFilesItemCommitPostRequestBodyable interface {
