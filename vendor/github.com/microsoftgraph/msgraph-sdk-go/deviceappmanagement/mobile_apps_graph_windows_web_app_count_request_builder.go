...
// NewMobileAppsGraphWindowsWebAppCountRequestBuilderInternal instantiates a new MobileAppsGraphWindowsWebAppCountRequestBuilder and sets the default values.
func NewMobileAppsGraphWindowsWebAppCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MobileAppsGraphWindowsWebAppCountRequestBuilder) {
    m := &MobileAppsGraphWindowsWebAppCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.windowsWebApp/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewMobileAppsGraphWindowsWebAppCountRequestBuilder instantiates a new MobileAppsGraphWindowsWebAppCountRequestBuilder and sets the default values.
