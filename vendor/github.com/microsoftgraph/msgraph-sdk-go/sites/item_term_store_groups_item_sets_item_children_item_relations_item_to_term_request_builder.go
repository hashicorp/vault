...
// NewItemTermStoreGroupsItemSetsItemChildrenItemRelationsItemToTermRequestBuilderInternal instantiates a new ItemTermStoreGroupsItemSetsItemChildrenItemRelationsItemToTermRequestBuilder and sets the default values.
func NewItemTermStoreGroupsItemSetsItemChildrenItemRelationsItemToTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTermStoreGroupsItemSetsItemChildrenItemRelationsItemToTermRequestBuilder) {
    m := &ItemTermStoreGroupsItemSetsItemChildrenItemRelationsItemToTermRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStore/groups/{group%2Did}/sets/{set%2Did}/children/{term%2Did}/relations/{relation%2Did}/toTerm{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemTermStoreGroupsItemSetsItemChildrenItemRelationsItemToTermRequestBuilder instantiates a new ItemTermStoreGroupsItemSetsItemChildrenItemRelationsItemToTermRequestBuilder and sets the default values.
...
// returns a *ItemTermStoreGroupsItemSetsItemChildrenItemRelationsItemToTermRequestBuilder when successful
func (m *ItemTermStoreGroupsItemSetsItemChildrenItemRelationsItemToTermRequestBuilder) WithUrl(rawUrl string)(*ItemTermStoreGroupsItemSetsItemChildrenItemRelationsItemToTermRequestBuilder) {
    return NewItemTermStoreGroupsItemSetsItemChildrenItemRelationsItemToTermRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
