...
// NewItemOnenoteNotebooksItemSectionsItemCopyToSectionGroupRequestBuilderInternal instantiates a new ItemOnenoteNotebooksItemSectionsItemCopyToSectionGroupRequestBuilder and sets the default values.
...
// NewItemOnenoteNotebooksItemSectionsItemCopyToSectionGroupRequestBuilder instantiates a new ItemOnenoteNotebooksItemSectionsItemCopyToSectionGroupRequestBuilder and sets the default values.
...
func (m *ItemOnenoteNotebooksItemSectionsItemCopyToSectionGroupRequestBuilder) WithUrl(rawUrl string)(*ItemOnenoteNotebooksItemSectionsItemCopyToSectionGroupRequestBuilder) {
    return NewItemOnenoteNotebooksItemSectionsItemCopyToSectionGroupRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
