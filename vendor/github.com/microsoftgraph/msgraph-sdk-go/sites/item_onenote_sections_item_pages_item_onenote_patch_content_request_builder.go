...
// NewItemOnenoteSectionsItemPagesItemOnenotePatchContentRequestBuilderInternal instantiates a new ItemOnenoteSectionsItemPagesItemOnenotePatchContentRequestBuilder and sets the default values.
func NewItemOnenoteSectionsItemPagesItemOnenotePatchContentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOnenoteSectionsItemPagesItemOnenotePatchContentRequestBuilder) {
    m := &ItemOnenoteSectionsItemPagesItemOnenotePatchContentRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/onenotePatchContent", pathParameters),
    }
    return m
}
// NewItemOnenoteSectionsItemPagesItemOnenotePatchContentRequestBuilder instantiates a new ItemOnenoteSectionsItemPagesItemOnenotePatchContentRequestBuilder and sets the default values.
