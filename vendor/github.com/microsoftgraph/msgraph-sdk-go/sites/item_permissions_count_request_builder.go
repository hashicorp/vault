...
// NewItemPermissionsCountRequestBuilderInternal instantiates a new ItemPermissionsCountRequestBuilder and sets the default values.
func NewItemPermissionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemPermissionsCountRequestBuilder) {
    m := &ItemPermissionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/permissions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemPermissionsCountRequestBuilder instantiates a new ItemPermissionsCountRequestBuilder and sets the default values.
...
func (m *ItemPermissionsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemPermissionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemPermissionsCountRequestBuilder) WithUrl(rawUrl string)(*ItemPermissionsCountRequestBuilder) {
    return NewItemPermissionsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
