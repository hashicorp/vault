...
// NewItemTermStoreSetsItemChildrenTermItemRequestBuilderInternal instantiates a new ItemTermStoreSetsItemChildrenTermItemRequestBuilder and sets the default values.
func NewItemTermStoreSetsItemChildrenTermItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTermStoreSetsItemChildrenTermItemRequestBuilder) {
    m := &ItemTermStoreSetsItemChildrenTermItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/children/{term%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemTermStoreSetsItemChildrenTermItemRequestBuilder instantiates a new ItemTermStoreSetsItemChildrenTermItemRequestBuilder and sets the default values.
...
// returns a *ItemTermStoreSetsItemChildrenItemSetRequestBuilder when successful
...
func (m *ItemTermStoreSetsItemChildrenTermItemRequestBuilder) WithUrl(rawUrl string)(*ItemTermStoreSetsItemChildrenTermItemRequestBuilder) {
    return NewItemTermStoreSetsItemChildrenTermItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
