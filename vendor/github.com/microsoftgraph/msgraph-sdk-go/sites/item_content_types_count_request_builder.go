...
// NewItemContentTypesCountRequestBuilderInternal instantiates a new ItemContentTypesCountRequestBuilder and sets the default values.
func NewItemContentTypesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemContentTypesCountRequestBuilder) {
    m := &ItemContentTypesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/contentTypes/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemContentTypesCountRequestBuilder instantiates a new ItemContentTypesCountRequestBuilder and sets the default values.
...
func (m *ItemContentTypesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemContentTypesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemContentTypesCountRequestBuilder) WithUrl(rawUrl string)(*ItemContentTypesCountRequestBuilder) {
    return NewItemContentTypesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
