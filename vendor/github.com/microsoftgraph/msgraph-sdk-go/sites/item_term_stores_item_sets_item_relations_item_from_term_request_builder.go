...
// NewItemTermStoresItemSetsItemRelationsItemFromTermRequestBuilderInternal instantiates a new ItemTermStoresItemSetsItemRelationsItemFromTermRequestBuilder and sets the default values.
func NewItemTermStoresItemSetsItemRelationsItemFromTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTermStoresItemSetsItemRelationsItemFromTermRequestBuilder) {
    m := &ItemTermStoresItemSetsItemRelationsItemFromTermRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/relations/{relation%2Did}/fromTerm{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemTermStoresItemSetsItemRelationsItemFromTermRequestBuilder instantiates a new ItemTermStoresItemSetsItemRelationsItemFromTermRequestBuilder and sets the default values.
...
func (m *ItemTermStoresItemSetsItemRelationsItemFromTermRequestBuilder) WithUrl(rawUrl string)(*ItemTermStoresItemSetsItemRelationsItemFromTermRequestBuilder) {
    return NewItemTermStoresItemSetsItemRelationsItemFromTermRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
