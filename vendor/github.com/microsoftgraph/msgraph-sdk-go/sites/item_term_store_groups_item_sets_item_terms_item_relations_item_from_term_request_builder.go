...
// NewItemTermStoreGroupsItemSetsItemTermsItemRelationsItemFromTermRequestBuilderInternal instantiates a new ItemTermStoreGroupsItemSetsItemTermsItemRelationsItemFromTermRequestBuilder and sets the default values.
func NewItemTermStoreGroupsItemSetsItemTermsItemRelationsItemFromTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTermStoreGroupsItemSetsItemTermsItemRelationsItemFromTermRequestBuilder) {
    m := &ItemTermStoreGroupsItemSetsItemTermsItemRelationsItemFromTermRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms/{term%2Did}/relations/{relation%2Did}/fromTerm{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemTermStoreGroupsItemSetsItemTermsItemRelationsItemFromTermRequestBuilder instantiates a new ItemTermStoreGroupsItemSetsItemTermsItemRelationsItemFromTermRequestBuilder and sets the default values.
