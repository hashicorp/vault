...
// NewItemColumnsCountRequestBuilderInternal instantiates a new ItemColumnsCountRequestBuilder and sets the default values.
func NewItemColumnsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemColumnsCountRequestBuilder) {
    m := &ItemColumnsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/columns/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemColumnsCountRequestBuilder instantiates a new ItemColumnsCountRequestBuilder and sets the default values.
...
func (m *ItemColumnsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemColumnsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *ItemColumnsCountRequestBuilder when successful
func (m *ItemColumnsCountRequestBuilder) WithUrl(rawUrl string)(*ItemColumnsCountRequestBuilder) {
    return NewItemColumnsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
