...
// ItemTermStoresItemSetsItemTermsTermItemRequestBuilderGetQueryParameters all the terms under the set.
...
// NewItemTermStoresItemSetsItemTermsTermItemRequestBuilderInternal instantiates a new ItemTermStoresItemSetsItemTermsTermItemRequestBuilder and sets the default values.
func NewItemTermStoresItemSetsItemTermsTermItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTermStoresItemSetsItemTermsTermItemRequestBuilder) {
    m := &ItemTermStoresItemSetsItemTermsTermItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/terms/{term%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemTermStoresItemSetsItemTermsTermItemRequestBuilder instantiates a new ItemTermStoresItemSetsItemTermsTermItemRequestBuilder and sets the default values.
...
// returns a *ItemTermStoresItemSetsItemTermsTermItemRequestBuilder when successful
func (m *ItemTermStoresItemSetsItemTermsTermItemRequestBuilder) WithUrl(rawUrl string)(*ItemTermStoresItemSetsItemTermsTermItemRequestBuilder) {
    return NewItemTermStoresItemSetsItemTermsTermItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
