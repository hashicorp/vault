...
// NewItemTermStoreGroupsItemSetsItemTermsItemChildrenCountRequestBuilderInternal instantiates a new ItemTermStoreGroupsItemSetsItemTermsItemChildrenCountRequestBuilder and sets the default values.
func NewItemTermStoreGroupsItemSetsItemTermsItemChildrenCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTermStoreGroupsItemSetsItemTermsItemChildrenCountRequestBuilder) {
    m := &ItemTermStoreGroupsItemSetsItemTermsItemChildrenCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms/{term%2Did}/children/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemTermStoreGroupsItemSetsItemTermsItemChildrenCountRequestBuilder instantiates a new ItemTermStoreGroupsItemSetsItemTermsItemChildrenCountRequestBuilder and sets the default values.
...
// returns a *ItemTermStoreGroupsItemSetsItemTermsItemChildrenCountRequestBuilder when successful
func (m *ItemTermStoreGroupsItemSetsItemTermsItemChildrenCountRequestBuilder) WithUrl(rawUrl string)(*ItemTermStoreGroupsItemSetsItemTermsItemChildrenCountRequestBuilder) {
    return NewItemTermStoreGroupsItemSetsItemTermsItemChildrenCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
