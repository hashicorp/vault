...
// NewItemTermStoresItemSetsItemParentGroupSetsItemRelationsItemFromTermRequestBuilderInternal instantiates a new ItemTermStoresItemSetsItemParentGroupSetsItemRelationsItemFromTermRequestBuilder and sets the default values.
func NewItemTermStoresItemSetsItemParentGroupSetsItemRelationsItemFromTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTermStoresItemSetsItemParentGroupSetsItemRelationsItemFromTermRequestBuilder) {
    m := &ItemTermStoresItemSetsItemParentGroupSetsItemRelationsItemFromTermRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/relations/{relation%2Did}/fromTerm{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemTermStoresItemSetsItemParentGroupSetsItemRelationsItemFromTermRequestBuilder instantiates a new ItemTermStoresItemSetsItemParentGroupSetsItemRelationsItemFromTermRequestBuilder and sets the default values.
...
func (m *ItemTermStoresItemSetsItemParentGroupSetsItemRelationsItemFromTermRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemTermStoresItemSetsItemParentGroupSetsItemRelationsItemFromTermRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *ItemTermStoresItemSetsItemParentGroupSetsItemRelationsItemFromTermRequestBuilder when successful
func (m *ItemTermStoresItemSetsItemParentGroupSetsItemRelationsItemFromTermRequestBuilder) WithUrl(rawUrl string)(*ItemTermStoresItemSetsItemParentGroupSetsItemRelationsItemFromTermRequestBuilder) {
    return NewItemTermStoresItemSetsItemParentGroupSetsItemRelationsItemFromTermRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
