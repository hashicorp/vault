...
// NewItemContentTypesItemColumnLinksCountRequestBuilderInternal instantiates a new ItemContentTypesItemColumnLinksCountRequestBuilder and sets the default values.
func NewItemContentTypesItemColumnLinksCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemContentTypesItemColumnLinksCountRequestBuilder) {
    m := &ItemContentTypesItemColumnLinksCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/contentTypes/{contentType%2Did}/columnLinks/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemContentTypesItemColumnLinksCountRequestBuilder instantiates a new ItemContentTypesItemColumnLinksCountRequestBuilder and sets the default values.
...
func (m *ItemContentTypesItemColumnLinksCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemContentTypesItemColumnLinksCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *ItemContentTypesItemColumnLinksCountRequestBuilder when successful
func (m *ItemContentTypesItemColumnLinksCountRequestBuilder) WithUrl(rawUrl string)(*ItemContentTypesItemColumnLinksCountRequestBuilder) {
    return NewItemContentTypesItemColumnLinksCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
