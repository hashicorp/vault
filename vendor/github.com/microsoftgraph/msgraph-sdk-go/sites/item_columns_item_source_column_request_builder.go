...
// NewItemColumnsItemSourceColumnRequestBuilderInternal instantiates a new ItemColumnsItemSourceColumnRequestBuilder and sets the default values.
...
// NewItemColumnsItemSourceColumnRequestBuilder instantiates a new ItemColumnsItemSourceColumnRequestBuilder and sets the default values.
...
func (m *ItemColumnsItemSourceColumnRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemColumnsItemSourceColumnRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ColumnDefinitionable, error) {
...
func (m *ItemColumnsItemSourceColumnRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemColumnsItemSourceColumnRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *ItemColumnsItemSourceColumnRequestBuilder when successful
func (m *ItemColumnsItemSourceColumnRequestBuilder) WithUrl(rawUrl string)(*ItemColumnsItemSourceColumnRequestBuilder) {
    return NewItemColumnsItemSourceColumnRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
