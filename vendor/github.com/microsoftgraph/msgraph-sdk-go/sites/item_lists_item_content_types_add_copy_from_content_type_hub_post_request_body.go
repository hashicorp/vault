...
func (m *ItemListsItemContentTypesAddCopyFromContentTypeHubPostRequestBody) GetContentTypeId()(*string) {
    val, err := m.GetBackingStore().Get("contentTypeId")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ItemListsItemContentTypesAddCopyFromContentTypeHubPostRequestBody) SetContentTypeId(value *string)() {
    err := m.GetBackingStore().Set("contentTypeId", value)
    if err != nil {
        panic(err)
    }
}
type ItemListsItemContentTypesAddCopyFromContentTypeHubPostRequestBodyable interface {
