...
// NewItemListColumnsItemSourceColumnRequestBuilderInternal instantiates a new ItemListColumnsItemSourceColumnRequestBuilder and sets the default values.
func NewItemListColumnsItemSourceColumnRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemListColumnsItemSourceColumnRequestBuilder) {
    m := &ItemListColumnsItemSourceColumnRequestBuilder{
...
// NewItemListColumnsItemSourceColumnRequestBuilder instantiates a new ItemListColumnsItemSourceColumnRequestBuilder and sets the default values.
func NewItemListColumnsItemSourceColumnRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemListColumnsItemSourceColumnRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemListColumnsItemSourceColumnRequestBuilderInternal(urlParams, requestAdapter)
}
// Get the source column for the content type column.
// returns a ColumnDefinitionable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemListColumnsItemSourceColumnRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemListColumnsItemSourceColumnRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ColumnDefinitionable, error) {
...
func (m *ItemListColumnsItemSourceColumnRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemListColumnsItemSourceColumnRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *ItemListColumnsItemSourceColumnRequestBuilder when successful
func (m *ItemListColumnsItemSourceColumnRequestBuilder) WithUrl(rawUrl string)(*ItemListColumnsItemSourceColumnRequestBuilder) {
    return NewItemListColumnsItemSourceColumnRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
