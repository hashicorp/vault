...
type ItemItemsItemWorkbookFunctionsGamma_InvPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemItemsItemWorkbookFunctionsGamma_InvPostRequestBody instantiates a new ItemItemsItemWorkbookFunctionsGamma_InvPostRequestBody and sets the default values.
func NewItemItemsItemWorkbookFunctionsGamma_InvPostRequestBody()(*ItemItemsItemWorkbookFunctionsGamma_InvPostRequestBody) {
    m := &ItemItemsItemWorkbookFunctionsGamma_InvPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemItemsItemWorkbookFunctionsGamma_InvPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemItemsItemWorkbookFunctionsGamma_InvPostRequestBody) GetAlpha()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
...
// returns a UntypedNodeable when successful
func (m *ItemItemsItemWorkbookFunctionsGamma_InvPostRequestBody) GetBeta()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
...
func (m *ItemItemsItemWorkbookFunctionsGamma_InvPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a UntypedNodeable when successful
func (m *ItemItemsItemWorkbookFunctionsGamma_InvPostRequestBody) GetProbability()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
...
func (m *ItemItemsItemWorkbookFunctionsGamma_InvPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemItemsItemWorkbookFunctionsGamma_InvPostRequestBody) SetAlpha(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
...
func (m *ItemItemsItemWorkbookFunctionsGamma_InvPostRequestBody) SetBeta(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
...
func (m *ItemItemsItemWorkbookFunctionsGamma_InvPostRequestBody) SetProbability(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    err := m.GetBackingStore().Set("probability", value)
    if err != nil {
        panic(err)
    }
}
type ItemItemsItemWorkbookFunctionsGamma_InvPostRequestBodyable interface {
