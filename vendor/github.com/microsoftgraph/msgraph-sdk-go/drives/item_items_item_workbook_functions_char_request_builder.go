...
// NewItemItemsItemWorkbookFunctionsCharRequestBuilderInternal instantiates a new ItemItemsItemWorkbookFunctionsCharRequestBuilder and sets the default values.
...
// NewItemItemsItemWorkbookFunctionsCharRequestBuilder instantiates a new ItemItemsItemWorkbookFunctionsCharRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookFunctionsCharRequestBuilder) WithUrl(rawUrl string)(*ItemItemsItemWorkbookFunctionsCharRequestBuilder) {
    return NewItemItemsItemWorkbookFunctionsCharRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
