...
// ItemItemsItemVersionsItemContentRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemItemsItemVersionsItemContentRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
...
// Delete the content stream for this version of the item.
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemItemsItemVersionsItemContentRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemItemsItemVersionsItemContentRequestBuilderDeleteRequestConfiguration)(error) {
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemItemsItemVersionsItemContentRequestBuilder) Put(ctx context.Context, body []byte, requestConfiguration *ItemItemsItemVersionsItemContentRequestBuilderPutRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DriveItemVersionable, error) {
...
// ToDeleteRequestInformation the content stream for this version of the item.
// returns a *RequestInformation when successful
func (m *ItemItemsItemVersionsItemContentRequestBuilder) ToDeleteRequestInformation(ctx context.Context, requestConfiguration *ItemItemsItemVersionsItemContentRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
