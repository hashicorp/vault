...
// NewItemItemsItemWorkbookFunctionsTrimRequestBuilderInternal instantiates a new ItemItemsItemWorkbookFunctionsTrimRequestBuilder and sets the default values.
...
// NewItemItemsItemWorkbookFunctionsTrimRequestBuilder instantiates a new ItemItemsItemWorkbookFunctionsTrimRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookFunctionsTrimRequestBuilder) WithUrl(rawUrl string)(*ItemItemsItemWorkbookFunctionsTrimRequestBuilder) {
    return NewItemItemsItemWorkbookFunctionsTrimRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
