...
type ItemItemsItemWorkbookFunctionsCountIfPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemItemsItemWorkbookFunctionsCountIfPostRequestBody instantiates a new ItemItemsItemWorkbookFunctionsCountIfPostRequestBody and sets the default values.
func NewItemItemsItemWorkbookFunctionsCountIfPostRequestBody()(*ItemItemsItemWorkbookFunctionsCountIfPostRequestBody) {
    m := &ItemItemsItemWorkbookFunctionsCountIfPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemItemsItemWorkbookFunctionsCountIfPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemItemsItemWorkbookFunctionsCountIfPostRequestBody) GetCriteria()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
...
func (m *ItemItemsItemWorkbookFunctionsCountIfPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a UntypedNodeable when successful
func (m *ItemItemsItemWorkbookFunctionsCountIfPostRequestBody) GetRangeEscaped()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
...
func (m *ItemItemsItemWorkbookFunctionsCountIfPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemItemsItemWorkbookFunctionsCountIfPostRequestBody) SetCriteria(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
...
func (m *ItemItemsItemWorkbookFunctionsCountIfPostRequestBody) SetRangeEscaped(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    err := m.GetBackingStore().Set("rangeEscaped", value)
    if err != nil {
        panic(err)
    }
}
type ItemItemsItemWorkbookFunctionsCountIfPostRequestBodyable interface {
