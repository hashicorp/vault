...
type ItemItemsItemWorkbookFunctionsBinom_Dist_RangePostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemItemsItemWorkbookFunctionsBinom_Dist_RangePostRequestBody instantiates a new ItemItemsItemWorkbookFunctionsBinom_Dist_RangePostRequestBody and sets the default values.
func NewItemItemsItemWorkbookFunctionsBinom_Dist_RangePostRequestBody()(*ItemItemsItemWorkbookFunctionsBinom_Dist_RangePostRequestBody) {
    m := &ItemItemsItemWorkbookFunctionsBinom_Dist_RangePostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemItemsItemWorkbookFunctionsBinom_Dist_RangePostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemItemsItemWorkbookFunctionsBinom_Dist_RangePostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["numberS2"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetNumberS2(val.(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable))
        }
        return nil
    }
...
func (m *ItemItemsItemWorkbookFunctionsBinom_Dist_RangePostRequestBody) GetNumberS()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
...
// returns a UntypedNodeable when successful
func (m *ItemItemsItemWorkbookFunctionsBinom_Dist_RangePostRequestBody) GetNumberS2()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
    val, err := m.GetBackingStore().Get("numberS2")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
// returns a UntypedNodeable when successful
func (m *ItemItemsItemWorkbookFunctionsBinom_Dist_RangePostRequestBody) GetProbabilityS()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
...
// returns a UntypedNodeable when successful
func (m *ItemItemsItemWorkbookFunctionsBinom_Dist_RangePostRequestBody) GetTrials()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
...
func (m *ItemItemsItemWorkbookFunctionsBinom_Dist_RangePostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemItemsItemWorkbookFunctionsBinom_Dist_RangePostRequestBody) SetNumberS(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
...
func (m *ItemItemsItemWorkbookFunctionsBinom_Dist_RangePostRequestBody) SetNumberS2(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    err := m.GetBackingStore().Set("numberS2", value)
    if err != nil {
        panic(err)
    }
}
// SetProbabilityS sets the probabilityS property value. The probabilityS property
func (m *ItemItemsItemWorkbookFunctionsBinom_Dist_RangePostRequestBody) SetProbabilityS(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
...
func (m *ItemItemsItemWorkbookFunctionsBinom_Dist_RangePostRequestBody) SetTrials(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    err := m.GetBackingStore().Set("trials", value)
    if err != nil {
        panic(err)
    }
}
type ItemItemsItemWorkbookFunctionsBinom_Dist_RangePostRequestBodyable interface {
    ...
    GetNumberS2()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)
    ...
    SetNumberS2(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)()
