...
type ItemItemsItemWorkbookTablesItemRowsAddPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemItemsItemWorkbookTablesItemRowsAddPostRequestBody instantiates a new ItemItemsItemWorkbookTablesItemRowsAddPostRequestBody and sets the default values.
func NewItemItemsItemWorkbookTablesItemRowsAddPostRequestBody()(*ItemItemsItemWorkbookTablesItemRowsAddPostRequestBody) {
    m := &ItemItemsItemWorkbookTablesItemRowsAddPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemItemsItemWorkbookTablesItemRowsAddPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemItemsItemWorkbookTablesItemRowsAddPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemItemsItemWorkbookTablesItemRowsAddPostRequestBody) GetIndex()(*int32) {
...
func (m *ItemItemsItemWorkbookTablesItemRowsAddPostRequestBody) GetValues()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
...
func (m *ItemItemsItemWorkbookTablesItemRowsAddPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemItemsItemWorkbookTablesItemRowsAddPostRequestBody) SetIndex(value *int32)() {
...
func (m *ItemItemsItemWorkbookTablesItemRowsAddPostRequestBody) SetValues(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    err := m.GetBackingStore().Set("values", value)
    if err != nil {
        panic(err)
    }
}
type ItemItemsItemWorkbookTablesItemRowsAddPostRequestBodyable interface {
