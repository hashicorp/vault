...
func NewItemItemsItemPermissionsItemGrantPostRequestBody()(*ItemItemsItemPermissionsItemGrantPostRequestBody) {
    m := &ItemItemsItemPermissionsItemGrantPostRequestBody{
    }
...
func (m *ItemItemsItemPermissionsItemGrantPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemItemsItemPermissionsItemGrantPostRequestBody) GetRecipients()([]iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DriveRecipientable) {
...
func (m *ItemItemsItemPermissionsItemGrantPostRequestBody) GetRoles()([]string) {
...
func (m *ItemItemsItemPermissionsItemGrantPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *ItemItemsItemPermissionsItemGrantPostRequestBody) SetRecipients(value []iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DriveRecipientable)() {
...
func (m *ItemItemsItemPermissionsItemGrantPostRequestBody) SetRoles(value []string)() {
    err := m.GetBackingStore().Set("roles", value)
    if err != nil {
        panic(err)
    }
}
type ItemItemsItemPermissionsItemGrantPostRequestBodyable interface {
