...
func (m *ItemItemsItemWorkbookWorksheetsItemTablesItemSortRequestBuilder) Apply()(*ItemItemsItemWorkbookWorksheetsItemTablesItemSortApplyRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemTablesItemSortApplyRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemItemsItemWorkbookWorksheetsItemTablesItemSortRequestBuilder) Clear()(*ItemItemsItemWorkbookWorksheetsItemTablesItemSortClearRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemTablesItemSortClearRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// NewItemItemsItemWorkbookWorksheetsItemTablesItemSortRequestBuilderInternal instantiates a new ItemItemsItemWorkbookWorksheetsItemTablesItemSortRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookWorksheetsItemTablesItemSortRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookWorksheetsItemTablesItemSortRequestBuilder) {
    m := &ItemItemsItemWorkbookWorksheetsItemTablesItemSortRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/sort{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemItemsItemWorkbookWorksheetsItemTablesItemSortRequestBuilder instantiates a new ItemItemsItemWorkbookWorksheetsItemTablesItemSortRequestBuilder and sets the default values.
...
// returns a *ItemItemsItemWorkbookWorksheetsItemTablesItemSortReapplyRequestBuilder when successful
func (m *ItemItemsItemWorkbookWorksheetsItemTablesItemSortRequestBuilder) Reapply()(*ItemItemsItemWorkbookWorksheetsItemTablesItemSortReapplyRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemTablesItemSortReapplyRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemItemsItemWorkbookWorksheetsItemTablesItemSortRequestBuilder) WithUrl(rawUrl string)(*ItemItemsItemWorkbookWorksheetsItemTablesItemSortRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemTablesItemSortRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
