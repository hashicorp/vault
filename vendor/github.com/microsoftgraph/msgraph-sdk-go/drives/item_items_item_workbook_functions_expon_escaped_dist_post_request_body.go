...
type ItemItemsItemWorkbookFunctionsExpon_DistPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemItemsItemWorkbookFunctionsExpon_DistPostRequestBody instantiates a new ItemItemsItemWorkbookFunctionsExpon_DistPostRequestBody and sets the default values.
func NewItemItemsItemWorkbookFunctionsExpon_DistPostRequestBody()(*ItemItemsItemWorkbookFunctionsExpon_DistPostRequestBody) {
    m := &ItemItemsItemWorkbookFunctionsExpon_DistPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemItemsItemWorkbookFunctionsExpon_DistPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemItemsItemWorkbookFunctionsExpon_DistPostRequestBody) GetCumulative()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
...
func (m *ItemItemsItemWorkbookFunctionsExpon_DistPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["lambda"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetLambda(val.(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable))
        }
        return nil
    }
...
// returns a UntypedNodeable when successful
func (m *ItemItemsItemWorkbookFunctionsExpon_DistPostRequestBody) GetLambda()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
    val, err := m.GetBackingStore().Get("lambda")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
// returns a UntypedNodeable when successful
func (m *ItemItemsItemWorkbookFunctionsExpon_DistPostRequestBody) GetX()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
...
func (m *ItemItemsItemWorkbookFunctionsExpon_DistPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemItemsItemWorkbookFunctionsExpon_DistPostRequestBody) SetCumulative(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
...
func (m *ItemItemsItemWorkbookFunctionsExpon_DistPostRequestBody) SetLambda(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    err := m.GetBackingStore().Set("lambda", value)
    if err != nil {
        panic(err)
    }
}
// SetX sets the x property value. The x property
func (m *ItemItemsItemWorkbookFunctionsExpon_DistPostRequestBody) SetX(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    err := m.GetBackingStore().Set("x", value)
    if err != nil {
        panic(err)
    }
}
type ItemItemsItemWorkbookFunctionsExpon_DistPostRequestBodyable interface {
    ...
    GetLambda()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)
    ...
    SetLambda(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)()
