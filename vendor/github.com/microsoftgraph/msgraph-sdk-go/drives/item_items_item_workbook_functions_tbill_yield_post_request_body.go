...
type ItemItemsItemWorkbookFunctionsTbillYieldPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemItemsItemWorkbookFunctionsTbillYieldPostRequestBody instantiates a new ItemItemsItemWorkbookFunctionsTbillYieldPostRequestBody and sets the default values.
func NewItemItemsItemWorkbookFunctionsTbillYieldPostRequestBody()(*ItemItemsItemWorkbookFunctionsTbillYieldPostRequestBody) {
    m := &ItemItemsItemWorkbookFunctionsTbillYieldPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemItemsItemWorkbookFunctionsTbillYieldPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemItemsItemWorkbookFunctionsTbillYieldPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemItemsItemWorkbookFunctionsTbillYieldPostRequestBody) GetMaturity()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
...
// returns a UntypedNodeable when successful
func (m *ItemItemsItemWorkbookFunctionsTbillYieldPostRequestBody) GetPr()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
...
// returns a UntypedNodeable when successful
func (m *ItemItemsItemWorkbookFunctionsTbillYieldPostRequestBody) GetSettlement()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
...
func (m *ItemItemsItemWorkbookFunctionsTbillYieldPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemItemsItemWorkbookFunctionsTbillYieldPostRequestBody) SetMaturity(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
...
func (m *ItemItemsItemWorkbookFunctionsTbillYieldPostRequestBody) SetPr(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
...
func (m *ItemItemsItemWorkbookFunctionsTbillYieldPostRequestBody) SetSettlement(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    err := m.GetBackingStore().Set("settlement", value)
    if err != nil {
        panic(err)
    }
}
type ItemItemsItemWorkbookFunctionsTbillYieldPostRequestBodyable interface {
