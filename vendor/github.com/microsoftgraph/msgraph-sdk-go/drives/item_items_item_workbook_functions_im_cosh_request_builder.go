...
// ItemItemsItemWorkbookFunctionsImCoshRequestBuilder provides operations to call the imCosh method.
type ItemItemsItemWorkbookFunctionsImCoshRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemItemsItemWorkbookFunctionsImCoshRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemItemsItemWorkbookFunctionsImCoshRequestBuilderPostRequestConfiguration struct {
    // Request headers
