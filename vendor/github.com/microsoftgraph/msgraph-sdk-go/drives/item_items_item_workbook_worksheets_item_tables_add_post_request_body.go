...
type ItemItemsItemWorkbookWorksheetsItemTablesAddPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemItemsItemWorkbookWorksheetsItemTablesAddPostRequestBody instantiates a new ItemItemsItemWorkbookWorksheetsItemTablesAddPostRequestBody and sets the default values.
func NewItemItemsItemWorkbookWorksheetsItemTablesAddPostRequestBody()(*ItemItemsItemWorkbookWorksheetsItemTablesAddPostRequestBody) {
    m := &ItemItemsItemWorkbookWorksheetsItemTablesAddPostRequestBody{
    }
...
func (m *ItemItemsItemWorkbookWorksheetsItemTablesAddPostRequestBody) GetAddress()(*string) {
...
func (m *ItemItemsItemWorkbookWorksheetsItemTablesAddPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemItemsItemWorkbookWorksheetsItemTablesAddPostRequestBody) GetHasHeaders()(*bool) {
    val, err := m.GetBackingStore().Get("hasHeaders")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ItemItemsItemWorkbookWorksheetsItemTablesAddPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemItemsItemWorkbookWorksheetsItemTablesAddPostRequestBody) SetAddress(value *string)() {
...
func (m *ItemItemsItemWorkbookWorksheetsItemTablesAddPostRequestBody) SetHasHeaders(value *bool)() {
    err := m.GetBackingStore().Set("hasHeaders", value)
    if err != nil {
        panic(err)
    }
}
type ItemItemsItemWorkbookWorksheetsItemTablesAddPostRequestBodyable interface {
