...
// NewItemItemsItemWorkbookFunctionsEffectRequestBuilderInternal instantiates a new ItemItemsItemWorkbookFunctionsEffectRequestBuilder and sets the default values.
...
// NewItemItemsItemWorkbookFunctionsEffectRequestBuilder instantiates a new ItemItemsItemWorkbookFunctionsEffectRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookFunctionsEffectRequestBuilder) WithUrl(rawUrl string)(*ItemItemsItemWorkbookFunctionsEffectRequestBuilder) {
    return NewItemItemsItemWorkbookFunctionsEffectRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
