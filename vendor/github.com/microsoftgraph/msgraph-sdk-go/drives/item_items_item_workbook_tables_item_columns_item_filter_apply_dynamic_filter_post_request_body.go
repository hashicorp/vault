...
type ItemItemsItemWorkbookTablesItemColumnsItemFilterApplyDynamicFilterPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemItemsItemWorkbookTablesItemColumnsItemFilterApplyDynamicFilterPostRequestBody instantiates a new ItemItemsItemWorkbookTablesItemColumnsItemFilterApplyDynamicFilterPostRequestBody and sets the default values.
func NewItemItemsItemWorkbookTablesItemColumnsItemFilterApplyDynamicFilterPostRequestBody()(*ItemItemsItemWorkbookTablesItemColumnsItemFilterApplyDynamicFilterPostRequestBody) {
...
// CreateItemItemsItemWorkbookTablesItemColumnsItemFilterApplyDynamicFilterPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemItemsItemWorkbookTablesItemColumnsItemFilterApplyDynamicFilterPostRequestBody) GetCriteria()(*string) {
...
func (m *ItemItemsItemWorkbookTablesItemColumnsItemFilterApplyDynamicFilterPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemItemsItemWorkbookTablesItemColumnsItemFilterApplyDynamicFilterPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemItemsItemWorkbookTablesItemColumnsItemFilterApplyDynamicFilterPostRequestBody) SetCriteria(value *string)() {
    err := m.GetBackingStore().Set("criteria", value)
    if err != nil {
        panic(err)
    }
}
type ItemItemsItemWorkbookTablesItemColumnsItemFilterApplyDynamicFilterPostRequestBodyable interface {
