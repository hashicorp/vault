...
// NewItemItemsItemWorkbookFunctionsF_Dist_RTRequestBuilderInternal instantiates a new ItemItemsItemWorkbookFunctionsF_Dist_RTRequestBuilder and sets the default values.
...
// NewItemItemsItemWorkbookFunctionsF_Dist_RTRequestBuilder instantiates a new ItemItemsItemWorkbookFunctionsF_Dist_RTRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookFunctionsF_Dist_RTRequestBuilder) WithUrl(rawUrl string)(*ItemItemsItemWorkbookFunctionsF_Dist_RTRequestBuilder) {
    return NewItemItemsItemWorkbookFunctionsF_Dist_RTRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
