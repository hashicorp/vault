...
type ItemItemsItemWorkbookFunctionsErf_PrecisePostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemItemsItemWorkbookFunctionsErf_PrecisePostRequestBody instantiates a new ItemItemsItemWorkbookFunctionsErf_PrecisePostRequestBody and sets the default values.
func NewItemItemsItemWorkbookFunctionsErf_PrecisePostRequestBody()(*ItemItemsItemWorkbookFunctionsErf_PrecisePostRequestBody) {
    m := &ItemItemsItemWorkbookFunctionsErf_PrecisePostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemItemsItemWorkbookFunctionsErf_PrecisePostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemItemsItemWorkbookFunctionsErf_PrecisePostRequestBody) GetX()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
...
func (m *ItemItemsItemWorkbookFunctionsErf_PrecisePostRequestBody) SetX(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    err := m.GetBackingStore().Set("x", value)
    if err != nil {
        panic(err)
    }
}
type ItemItemsItemWorkbookFunctionsErf_PrecisePostRequestBodyable interface {
