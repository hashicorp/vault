...
// ItemItemsItemWorkbookFunctionsSqrtRequestBuilder provides operations to call the sqrt method.
type ItemItemsItemWorkbookFunctionsSqrtRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemItemsItemWorkbookFunctionsSqrtRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemItemsItemWorkbookFunctionsSqrtRequestBuilderPostRequestConfiguration struct {
    // Request headers
