...
// ItemCreatedByUserMailboxSettingsRequestBuilder builds and executes requests for operations under \drives\{drive-id}\createdByUser\mailboxSettings
...
// NewItemCreatedByUserMailboxSettingsRequestBuilderInternal instantiates a new ItemCreatedByUserMailboxSettingsRequestBuilder and sets the default values.
func NewItemCreatedByUserMailboxSettingsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCreatedByUserMailboxSettingsRequestBuilder) {
    m := &ItemCreatedByUserMailboxSettingsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/drives/{drive%2Did}/createdByUser/mailboxSettings{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemCreatedByUserMailboxSettingsRequestBuilder instantiates a new ItemCreatedByUserMailboxSettingsRequestBuilder and sets the default values.
func NewItemCreatedByUserMailboxSettingsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCreatedByUserMailboxSettingsRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemCreatedByUserMailboxSettingsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemCreatedByUserMailboxSettingsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCreatedByUserMailboxSettingsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.MailboxSettingsable, error) {
...
// returns a MailboxSettingsable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemCreatedByUserMailboxSettingsRequestBuilder) Patch(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.MailboxSettingsable, requestConfiguration *ItemCreatedByUserMailboxSettingsRequestBuilderPatchRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.MailboxSettingsable, error) {
...
func (m *ItemCreatedByUserMailboxSettingsRequestBuilder) WithUrl(rawUrl string)(*ItemCreatedByUserMailboxSettingsRequestBuilder) {
    return NewItemCreatedByUserMailboxSettingsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
