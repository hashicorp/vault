...
// NewItemDrivesCountRequestBuilderInternal instantiates a new ItemDrivesCountRequestBuilder and sets the default values.
func NewItemDrivesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDrivesCountRequestBuilder) {
    m := &ItemDrivesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/drives/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemDrivesCountRequestBuilder instantiates a new ItemDrivesCountRequestBuilder and sets the default values.
...
func (m *ItemDrivesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemDrivesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemDrivesCountRequestBuilder) WithUrl(rawUrl string)(*ItemDrivesCountRequestBuilder) {
    return NewItemDrivesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
