...
type ItemChatsItemMessagesItemRepliesItemUnsetReactionPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemChatsItemMessagesItemRepliesItemUnsetReactionPostRequestBody instantiates a new ItemChatsItemMessagesItemRepliesItemUnsetReactionPostRequestBody and sets the default values.
func NewItemChatsItemMessagesItemRepliesItemUnsetReactionPostRequestBody()(*ItemChatsItemMessagesItemRepliesItemUnsetReactionPostRequestBody) {
    m := &ItemChatsItemMessagesItemRepliesItemUnsetReactionPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemChatsItemMessagesItemRepliesItemUnsetReactionPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemChatsItemMessagesItemRepliesItemUnsetReactionPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemChatsItemMessagesItemRepliesItemUnsetReactionPostRequestBody) GetReactionType()(*string) {
...
func (m *ItemChatsItemMessagesItemRepliesItemUnsetReactionPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemChatsItemMessagesItemRepliesItemUnsetReactionPostRequestBody) SetReactionType(value *string)() {
    err := m.GetBackingStore().Set("reactionType", value)
    if err != nil {
        panic(err)
    }
}
type ItemChatsItemMessagesItemRepliesItemUnsetReactionPostRequestBodyable interface {
