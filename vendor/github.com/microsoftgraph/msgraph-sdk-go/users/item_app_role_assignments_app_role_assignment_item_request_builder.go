...
// ItemAppRoleAssignmentsAppRoleAssignmentItemRequestBuilder provides operations to manage the appRoleAssignments property of the microsoft.graph.user entity.
...
// ItemAppRoleAssignmentsAppRoleAssignmentItemRequestBuilderGetQueryParameters represents the app roles a user is granted for an application. Supports $expand.
...
func NewItemAppRoleAssignmentsAppRoleAssignmentItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemAppRoleAssignmentsAppRoleAssignmentItemRequestBuilder) {
    m := &ItemAppRoleAssignmentsAppRoleAssignmentItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/appRoleAssignments/{appRoleAssignment%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
...
// Get represents the app roles a user is granted for an application. Supports $expand.
...
// Patch update the navigation property appRoleAssignments in users
// returns a AppRoleAssignmentable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
...
// ToDeleteRequestInformation delete an appRoleAssignment that has been granted to a user.
...
// ToGetRequestInformation represents the app roles a user is granted for an application. Supports $expand.
// returns a *RequestInformation when successful
...
// ToPatchRequestInformation update the navigation property appRoleAssignments in users
// returns a *RequestInformation when successful
