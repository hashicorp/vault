...
type ItemCalendarsItemEventsItemSnoozeReminderPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemCalendarsItemEventsItemSnoozeReminderPostRequestBody instantiates a new ItemCalendarsItemEventsItemSnoozeReminderPostRequestBody and sets the default values.
func NewItemCalendarsItemEventsItemSnoozeReminderPostRequestBody()(*ItemCalendarsItemEventsItemSnoozeReminderPostRequestBody) {
    m := &ItemCalendarsItemEventsItemSnoozeReminderPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarsItemEventsItemSnoozeReminderPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
type ItemCalendarsItemEventsItemSnoozeReminderPostRequestBodyable interface {
