...
// NewItemJoinedTeamsItemPrimaryChannelMessagesItemRepliesItemSetReactionRequestBuilderInternal instantiates a new ItemJoinedTeamsItemPrimaryChannelMessagesItemRepliesItemSetReactionRequestBuilder and sets the default values.
...
// NewItemJoinedTeamsItemPrimaryChannelMessagesItemRepliesItemSetReactionRequestBuilder instantiates a new ItemJoinedTeamsItemPrimaryChannelMessagesItemRepliesItemSetReactionRequestBuilder and sets the default values.
...
func (m *ItemJoinedTeamsItemPrimaryChannelMessagesItemRepliesItemSetReactionRequestBuilder) WithUrl(rawUrl string)(*ItemJoinedTeamsItemPrimaryChannelMessagesItemRepliesItemSetReactionRequestBuilder) {
    return NewItemJoinedTeamsItemPrimaryChannelMessagesItemRepliesItemSetReactionRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
