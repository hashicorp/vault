...
// NewItemEventsItemAcceptRequestBuilderInternal instantiates a new ItemEventsItemAcceptRequestBuilder and sets the default values.
func NewItemEventsItemAcceptRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemEventsItemAcceptRequestBuilder) {
    m := &ItemEventsItemAcceptRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/events/{event%2Did}/accept", pathParameters),
    }
    return m
}
// NewItemEventsItemAcceptRequestBuilder instantiates a new ItemEventsItemAcceptRequestBuilder and sets the default values.
