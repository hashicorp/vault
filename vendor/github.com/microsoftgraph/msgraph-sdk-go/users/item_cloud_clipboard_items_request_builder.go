...
func (m *ItemCloudClipboardItemsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCloudClipboardItemsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CloudClipboardItemCollectionResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateCloudClipboardItemCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CloudClipboardItemCollectionResponseable), nil
}
// Post create new navigation property to items for users
// returns a CloudClipboardItemable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemCloudClipboardItemsRequestBuilder) Post(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CloudClipboardItemable, requestConfiguration *ItemCloudClipboardItemsRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CloudClipboardItemable, error) {
