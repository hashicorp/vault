...
// ItemOnenoteSectionsItemPagesRequestBuilderGetQueryParameters the collection of pages in the section.  Read-only. Nullable.
...
// NewItemOnenoteSectionsItemPagesRequestBuilderInternal instantiates a new ItemOnenoteSectionsItemPagesRequestBuilder and sets the default values.
func NewItemOnenoteSectionsItemPagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOnenoteSectionsItemPagesRequestBuilder) {
    m := &ItemOnenoteSectionsItemPagesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/sections/{onenoteSection%2Did}/pages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemOnenoteSectionsItemPagesRequestBuilder instantiates a new ItemOnenoteSectionsItemPagesRequestBuilder and sets the default values.
...
func (m *ItemOnenoteSectionsItemPagesRequestBuilder) WithUrl(rawUrl string)(*ItemOnenoteSectionsItemPagesRequestBuilder) {
    return NewItemOnenoteSectionsItemPagesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
