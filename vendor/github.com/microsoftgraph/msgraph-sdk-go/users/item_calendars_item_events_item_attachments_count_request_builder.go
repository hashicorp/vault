...
// NewItemCalendarsItemEventsItemAttachmentsCountRequestBuilderInternal instantiates a new ItemCalendarsItemEventsItemAttachmentsCountRequestBuilder and sets the default values.
func NewItemCalendarsItemEventsItemAttachmentsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarsItemEventsItemAttachmentsCountRequestBuilder) {
    m := &ItemCalendarsItemEventsItemAttachmentsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/attachments/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemCalendarsItemEventsItemAttachmentsCountRequestBuilder instantiates a new ItemCalendarsItemEventsItemAttachmentsCountRequestBuilder and sets the default values.
...
// returns a *ItemCalendarsItemEventsItemAttachmentsCountRequestBuilder when successful
