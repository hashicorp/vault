...
type ItemPresenceSetUserPreferredPresencePostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemPresenceSetUserPreferredPresencePostRequestBody instantiates a new ItemPresenceSetUserPreferredPresencePostRequestBody and sets the default values.
func NewItemPresenceSetUserPreferredPresencePostRequestBody()(*ItemPresenceSetUserPreferredPresencePostRequestBody) {
    m := &ItemPresenceSetUserPreferredPresencePostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemPresenceSetUserPreferredPresencePostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateItemPresenceSetUserPreferredPresencePostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemPresenceSetUserPreferredPresencePostRequestBody(), nil
}
// GetActivity gets the activity property value. The activity property
// returns a *string when successful
func (m *ItemPresenceSetUserPreferredPresencePostRequestBody) GetActivity()(*string) {
...
// returns a *string when successful
func (m *ItemPresenceSetUserPreferredPresencePostRequestBody) GetAvailability()(*string) {
...
func (m *ItemPresenceSetUserPreferredPresencePostRequestBody) GetExpirationDuration()(*i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ISODuration) {
...
func (m *ItemPresenceSetUserPreferredPresencePostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemPresenceSetUserPreferredPresencePostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemPresenceSetUserPreferredPresencePostRequestBody) SetActivity(value *string)() {
...
func (m *ItemPresenceSetUserPreferredPresencePostRequestBody) SetAvailability(value *string)() {
...
func (m *ItemPresenceSetUserPreferredPresencePostRequestBody) SetExpirationDuration(value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ISODuration)() {
    err := m.GetBackingStore().Set("expirationDuration", value)
    if err != nil {
        panic(err)
    }
}
type ItemPresenceSetUserPreferredPresencePostRequestBodyable interface {
