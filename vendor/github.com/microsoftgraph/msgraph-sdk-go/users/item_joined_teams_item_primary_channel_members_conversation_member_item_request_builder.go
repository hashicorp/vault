...
// NewItemJoinedTeamsItemPrimaryChannelMembersConversationMemberItemRequestBuilderInternal instantiates a new ItemJoinedTeamsItemPrimaryChannelMembersConversationMemberItemRequestBuilder and sets the default values.
func NewItemJoinedTeamsItemPrimaryChannelMembersConversationMemberItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemJoinedTeamsItemPrimaryChannelMembersConversationMemberItemRequestBuilder) {
    m := &ItemJoinedTeamsItemPrimaryChannelMembersConversationMemberItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel/members/{conversationMember%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemJoinedTeamsItemPrimaryChannelMembersConversationMemberItemRequestBuilder instantiates a new ItemJoinedTeamsItemPrimaryChannelMembersConversationMemberItemRequestBuilder and sets the default values.
...
func (m *ItemJoinedTeamsItemPrimaryChannelMembersConversationMemberItemRequestBuilder) WithUrl(rawUrl string)(*ItemJoinedTeamsItemPrimaryChannelMembersConversationMemberItemRequestBuilder) {
    return NewItemJoinedTeamsItemPrimaryChannelMembersConversationMemberItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
