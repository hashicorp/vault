...
func NewItemDirectReportsGraphOrgContactCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDirectReportsGraphOrgContactCountRequestBuilder) {
    m := &ItemDirectReportsGraphOrgContactCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/directReports/graph.orgContact/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewItemDirectReportsGraphOrgContactCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDirectReportsGraphOrgContactCountRequestBuilder) {
    ...
    return NewItemDirectReportsGraphOrgContactCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemDirectReportsGraphOrgContactCountRequestBuilder) WithUrl(rawUrl string)(*ItemDirectReportsGraphOrgContactCountRequestBuilder) {
    return NewItemDirectReportsGraphOrgContactCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
