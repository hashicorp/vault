...
type ItemJoinedTeamsItemChannelsItemMessagesItemSetReactionPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemJoinedTeamsItemChannelsItemMessagesItemSetReactionPostRequestBody instantiates a new ItemJoinedTeamsItemChannelsItemMessagesItemSetReactionPostRequestBody and sets the default values.
func NewItemJoinedTeamsItemChannelsItemMessagesItemSetReactionPostRequestBody()(*ItemJoinedTeamsItemChannelsItemMessagesItemSetReactionPostRequestBody) {
    m := &ItemJoinedTeamsItemChannelsItemMessagesItemSetReactionPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemJoinedTeamsItemChannelsItemMessagesItemSetReactionPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemJoinedTeamsItemChannelsItemMessagesItemSetReactionPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemJoinedTeamsItemChannelsItemMessagesItemSetReactionPostRequestBody) GetReactionType()(*string) {
...
func (m *ItemJoinedTeamsItemChannelsItemMessagesItemSetReactionPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemJoinedTeamsItemChannelsItemMessagesItemSetReactionPostRequestBody) SetReactionType(value *string)() {
    err := m.GetBackingStore().Set("reactionType", value)
    if err != nil {
        panic(err)
    }
}
type ItemJoinedTeamsItemChannelsItemMessagesItemSetReactionPostRequestBodyable interface {
