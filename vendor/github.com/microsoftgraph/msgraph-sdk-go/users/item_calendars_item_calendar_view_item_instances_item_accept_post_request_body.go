...
type ItemCalendarsItemCalendarViewItemInstancesItemAcceptPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemCalendarsItemCalendarViewItemInstancesItemAcceptPostRequestBody instantiates a new ItemCalendarsItemCalendarViewItemInstancesItemAcceptPostRequestBody and sets the default values.
func NewItemCalendarsItemCalendarViewItemInstancesItemAcceptPostRequestBody()(*ItemCalendarsItemCalendarViewItemInstancesItemAcceptPostRequestBody) {
    m := &ItemCalendarsItemCalendarViewItemInstancesItemAcceptPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarsItemCalendarViewItemInstancesItemAcceptPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
type ItemCalendarsItemCalendarViewItemInstancesItemAcceptPostRequestBodyable interface {
