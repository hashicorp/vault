...
// ItemCalendarViewCountRequestBuilder provides operations to count the resources in the collection.
type ItemCalendarViewCountRequestBuilder struct {
...
type ItemCalendarViewCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemCalendarViewCountRequestBuilderGetQueryParameters
}
...
func NewItemCalendarViewCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarViewCountRequestBuilder) {
    m := &ItemCalendarViewCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/calendarView/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemCalendarViewCountRequestBuilder instantiates a new ItemCalendarViewCountRequestBuilder and sets the default values.
func NewItemCalendarViewCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarViewCountRequestBuilder) {
