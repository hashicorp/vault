...
// NewItemCalendarEventsItemAttachmentsCreateUploadSessionRequestBuilderInternal instantiates a new ItemCalendarEventsItemAttachmentsCreateUploadSessionRequestBuilder and sets the default values.
func NewItemCalendarEventsItemAttachmentsCreateUploadSessionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarEventsItemAttachmentsCreateUploadSessionRequestBuilder) {
    m := &ItemCalendarEventsItemAttachmentsCreateUploadSessionRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/calendar/events/{event%2Did}/attachments/createUploadSession", pathParameters),
    }
    return m
}
// NewItemCalendarEventsItemAttachmentsCreateUploadSessionRequestBuilder instantiates a new ItemCalendarEventsItemAttachmentsCreateUploadSessionRequestBuilder and sets the default values.
...
func (m *ItemCalendarEventsItemAttachmentsCreateUploadSessionRequestBuilder) WithUrl(rawUrl string)(*ItemCalendarEventsItemAttachmentsCreateUploadSessionRequestBuilder) {
    return NewItemCalendarEventsItemAttachmentsCreateUploadSessionRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
