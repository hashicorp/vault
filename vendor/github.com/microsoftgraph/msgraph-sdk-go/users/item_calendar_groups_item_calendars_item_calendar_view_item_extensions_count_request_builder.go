...
// NewItemCalendarGroupsItemCalendarsItemCalendarViewItemExtensionsCountRequestBuilder instantiates a new ItemCalendarGroupsItemCalendarsItemCalendarViewItemExtensionsCountRequestBuilder and sets the default values.
...
// returns a *ItemCalendarGroupsItemCalendarsItemCalendarViewItemExtensionsCountRequestBuilder when successful
