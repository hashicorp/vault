...
func NewItemDirectReportsItemGraphUserRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemDirectReportsItemGraphUserRequestBuilder) {
    ...
    return NewItemDirectReportsItemGraphUserRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemDirectReportsItemGraphUserRequestBuilder) WithUrl(rawUrl string)(*ItemDirectReportsItemGraphUserRequestBuilder) {
    return NewItemDirectReportsItemGraphUserRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
