...
// ItemInsightsUsedUsedInsightItemRequestBuilderGetQueryParameters calculated relationship that identifies the latest documents viewed or modified by a user, including OneDrive for work or school and SharePoint documents, ranked by recency of use.
...
// NewItemInsightsUsedUsedInsightItemRequestBuilderInternal instantiates a new ItemInsightsUsedUsedInsightItemRequestBuilder and sets the default values.
func NewItemInsightsUsedUsedInsightItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemInsightsUsedUsedInsightItemRequestBuilder) {
    m := &ItemInsightsUsedUsedInsightItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/insights/used/{usedInsight%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemInsightsUsedUsedInsightItemRequestBuilder instantiates a new ItemInsightsUsedUsedInsightItemRequestBuilder and sets the default values.
...
func (m *ItemInsightsUsedUsedInsightItemRequestBuilder) Resource()(*ItemInsightsUsedItemResourceRequestBuilder) {
    return NewItemInsightsUsedItemResourceRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemInsightsUsedUsedInsightItemRequestBuilder) WithUrl(rawUrl string)(*ItemInsightsUsedUsedInsightItemRequestBuilder) {
    return NewItemInsightsUsedUsedInsightItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
