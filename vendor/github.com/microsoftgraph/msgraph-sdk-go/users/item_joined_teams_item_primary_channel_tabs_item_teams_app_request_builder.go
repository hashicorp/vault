...
// ItemJoinedTeamsItemPrimaryChannelTabsItemTeamsAppRequestBuilderGetQueryParameters the application that is linked to the tab. This can't be changed after tab creation.
...
// NewItemJoinedTeamsItemPrimaryChannelTabsItemTeamsAppRequestBuilderInternal instantiates a new ItemJoinedTeamsItemPrimaryChannelTabsItemTeamsAppRequestBuilder and sets the default values.
...
// NewItemJoinedTeamsItemPrimaryChannelTabsItemTeamsAppRequestBuilder instantiates a new ItemJoinedTeamsItemPrimaryChannelTabsItemTeamsAppRequestBuilder and sets the default values.
...
func (m *ItemJoinedTeamsItemPrimaryChannelTabsItemTeamsAppRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemJoinedTeamsItemPrimaryChannelTabsItemTeamsAppRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.TeamsAppable, error) {
...
// returns a *ItemJoinedTeamsItemPrimaryChannelTabsItemTeamsAppRequestBuilder when successful
func (m *ItemJoinedTeamsItemPrimaryChannelTabsItemTeamsAppRequestBuilder) WithUrl(rawUrl string)(*ItemJoinedTeamsItemPrimaryChannelTabsItemTeamsAppRequestBuilder) {
    return NewItemJoinedTeamsItemPrimaryChannelTabsItemTeamsAppRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
