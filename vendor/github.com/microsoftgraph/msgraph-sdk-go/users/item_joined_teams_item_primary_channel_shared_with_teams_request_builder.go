...
// ItemJoinedTeamsItemPrimaryChannelSharedWithTeamsRequestBuilderGetQueryParameters a collection of teams with which a channel is shared.
...
// NewItemJoinedTeamsItemPrimaryChannelSharedWithTeamsRequestBuilderInternal instantiates a new ItemJoinedTeamsItemPrimaryChannelSharedWithTeamsRequestBuilder and sets the default values.
func NewItemJoinedTeamsItemPrimaryChannelSharedWithTeamsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemJoinedTeamsItemPrimaryChannelSharedWithTeamsRequestBuilder) {
    m := &ItemJoinedTeamsItemPrimaryChannelSharedWithTeamsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel/sharedWithTeams{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemJoinedTeamsItemPrimaryChannelSharedWithTeamsRequestBuilder instantiates a new ItemJoinedTeamsItemPrimaryChannelSharedWithTeamsRequestBuilder and sets the default values.
