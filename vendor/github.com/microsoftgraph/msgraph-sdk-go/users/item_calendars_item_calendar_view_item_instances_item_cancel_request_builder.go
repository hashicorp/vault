...
// NewItemCalendarsItemCalendarViewItemInstancesItemCancelRequestBuilderInternal instantiates a new ItemCalendarsItemCalendarViewItemInstancesItemCancelRequestBuilder and sets the default values.
...
// NewItemCalendarsItemCalendarViewItemInstancesItemCancelRequestBuilder instantiates a new ItemCalendarsItemCalendarViewItemInstancesItemCancelRequestBuilder and sets the default values.
...
func (m *ItemCalendarsItemCalendarViewItemInstancesItemCancelRequestBuilder) WithUrl(rawUrl string)(*ItemCalendarsItemCalendarViewItemInstancesItemCancelRequestBuilder) {
    return NewItemCalendarsItemCalendarViewItemInstancesItemCancelRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
