...
// NewItemCalendarsItemEventsItemInstancesItemAttachmentsCreateUploadSessionRequestBuilderInternal instantiates a new ItemCalendarsItemEventsItemInstancesItemAttachmentsCreateUploadSessionRequestBuilder and sets the default values.
...
// NewItemCalendarsItemEventsItemInstancesItemAttachmentsCreateUploadSessionRequestBuilder instantiates a new ItemCalendarsItemEventsItemInstancesItemAttachmentsCreateUploadSessionRequestBuilder and sets the default values.
...
// returns a *ItemCalendarsItemEventsItemInstancesItemAttachmentsCreateUploadSessionRequestBuilder when successful
func (m *ItemCalendarsItemEventsItemInstancesItemAttachmentsCreateUploadSessionRequestBuilder) WithUrl(rawUrl string)(*ItemCalendarsItemEventsItemInstancesItemAttachmentsCreateUploadSessionRequestBuilder) {
    return NewItemCalendarsItemEventsItemInstancesItemAttachmentsCreateUploadSessionRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
