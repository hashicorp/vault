...
// NewItemJoinedTeamsItemScheduleSharePostRequestBody instantiates a new ItemJoinedTeamsItemScheduleSharePostRequestBody and sets the default values.
...
func (m *ItemJoinedTeamsItemScheduleSharePostRequestBody) GetEndDateTime()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
...
func (m *ItemJoinedTeamsItemScheduleSharePostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemJoinedTeamsItemScheduleSharePostRequestBody) GetNotifyTeam()(*bool) {
    val, err := m.GetBackingStore().Get("notifyTeam")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
// returns a *Time when successful
func (m *ItemJoinedTeamsItemScheduleSharePostRequestBody) GetStartDateTime()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
...
func (m *ItemJoinedTeamsItemScheduleSharePostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemJoinedTeamsItemScheduleSharePostRequestBody) SetEndDateTime(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
...
func (m *ItemJoinedTeamsItemScheduleSharePostRequestBody) SetNotifyTeam(value *bool)() {
    err := m.GetBackingStore().Set("notifyTeam", value)
    if err != nil {
        panic(err)
    }
}
// SetStartDateTime sets the startDateTime property value. The startDateTime property
func (m *ItemJoinedTeamsItemScheduleSharePostRequestBody) SetStartDateTime(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    err := m.GetBackingStore().Set("startDateTime", value)
    if err != nil {
        panic(err)
    }
}
type ItemJoinedTeamsItemScheduleSharePostRequestBodyable interface {
