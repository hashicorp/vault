...
// NewItemOnenoteSectionsItemPagesItemParentSectionRequestBuilderInternal instantiates a new ItemOnenoteSectionsItemPagesItemParentSectionRequestBuilder and sets the default values.
func NewItemOnenoteSectionsItemPagesItemParentSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOnenoteSectionsItemPagesItemParentSectionRequestBuilder) {
    m := &ItemOnenoteSectionsItemPagesItemParentSectionRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/parentSection{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemOnenoteSectionsItemPagesItemParentSectionRequestBuilder instantiates a new ItemOnenoteSectionsItemPagesItemParentSectionRequestBuilder and sets the default values.
...
func (m *ItemOnenoteSectionsItemPagesItemParentSectionRequestBuilder) WithUrl(rawUrl string)(*ItemOnenoteSectionsItemPagesItemParentSectionRequestBuilder) {
    return NewItemOnenoteSectionsItemPagesItemParentSectionRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
