...
func (m *ItemJoinedTeamsItemChannelsItemMembersAddPostRequestBody) GetValues()([]iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ConversationMemberable) {
...
func (m *ItemJoinedTeamsItemChannelsItemMembersAddPostRequestBody) SetValues(value []iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ConversationMemberable)() {
    err := m.GetBackingStore().Set("values", value)
    if err != nil {
        panic(err)
    }
}
type ItemJoinedTeamsItemChannelsItemMembersAddPostRequestBodyable interface {
