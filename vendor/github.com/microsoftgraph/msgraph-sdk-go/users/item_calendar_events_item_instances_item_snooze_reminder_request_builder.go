...
// NewItemCalendarEventsItemInstancesItemSnoozeReminderRequestBuilderInternal instantiates a new ItemCalendarEventsItemInstancesItemSnoozeReminderRequestBuilder and sets the default values.
func NewItemCalendarEventsItemInstancesItemSnoozeReminderRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarEventsItemInstancesItemSnoozeReminderRequestBuilder) {
    m := &ItemCalendarEventsItemInstancesItemSnoozeReminderRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/snoozeReminder", pathParameters),
    }
    return m
}
// NewItemCalendarEventsItemInstancesItemSnoozeReminderRequestBuilder instantiates a new ItemCalendarEventsItemInstancesItemSnoozeReminderRequestBuilder and sets the default values.
