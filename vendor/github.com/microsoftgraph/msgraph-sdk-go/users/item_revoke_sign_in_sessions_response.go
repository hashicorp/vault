...
// NewItemRevokeSignInSessionsResponse instantiates a new ItemRevokeSignInSessionsResponse and sets the default values.
func NewItemRevokeSignInSessionsResponse()(*ItemRevokeSignInSessionsResponse) {
    m := &ItemRevokeSignInSessionsResponse{
        ItemRevokeSignInSessionsPostResponse: *NewItemRevokeSignInSessionsPostResponse(),
    }
    return m
}
