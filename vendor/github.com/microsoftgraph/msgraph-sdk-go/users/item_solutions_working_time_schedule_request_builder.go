...
// ItemSolutionsWorkingTimeScheduleRequestBuilder provides operations to manage the workingTimeSchedule property of the microsoft.graph.userSolutionRoot entity.
type ItemSolutionsWorkingTimeScheduleRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemSolutionsWorkingTimeScheduleRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemSolutionsWorkingTimeScheduleRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
...
// ItemSolutionsWorkingTimeScheduleRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemSolutionsWorkingTimeScheduleRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *ItemSolutionsWorkingTimeScheduleRequestBuilderGetQueryParameters
}
// ItemSolutionsWorkingTimeScheduleRequestBuilderPatchRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemSolutionsWorkingTimeScheduleRequestBuilderPatchRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// NewItemSolutionsWorkingTimeScheduleRequestBuilderInternal instantiates a new ItemSolutionsWorkingTimeScheduleRequestBuilder and sets the default values.
func NewItemSolutionsWorkingTimeScheduleRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSolutionsWorkingTimeScheduleRequestBuilder) {
    m := &ItemSolutionsWorkingTimeScheduleRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/solutions/workingTimeSchedule{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemSolutionsWorkingTimeScheduleRequestBuilder instantiates a new ItemSolutionsWorkingTimeScheduleRequestBuilder and sets the default values.
func NewItemSolutionsWorkingTimeScheduleRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSolutionsWorkingTimeScheduleRequestBuilder) {
...
// EndWorkingTime provides operations to call the endWorkingTime method.
...
func (m *ItemSolutionsWorkingTimeScheduleRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSolutionsWorkingTimeScheduleRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.WorkingTimeScheduleable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateWorkingTimeScheduleFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.WorkingTimeScheduleable), nil
}
// Patch update the navigation property workingTimeSchedule in users
// returns a WorkingTimeScheduleable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemSolutionsWorkingTimeScheduleRequestBuilder) Patch(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.WorkingTimeScheduleable, requestConfiguration *ItemSolutionsWorkingTimeScheduleRequestBuilderPatchRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.WorkingTimeScheduleable, error) {
...
// StartWorkingTime provides operations to call the startWorkingTime method.
// returns a *ItemSolutionsWorkingTimeScheduleStartWorkingTimeRequestBuilder when successful
func (m *ItemSolutionsWorkingTimeScheduleRequestBuilder) StartWorkingTime()(*ItemSolutionsWorkingTimeScheduleStartWorkingTimeRequestBuilder) {
