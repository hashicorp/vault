...
// NewItemContactFoldersItemChildFoldersItemContactsCountRequestBuilder instantiates a new ItemContactFoldersItemChildFoldersItemContactsCountRequestBuilder and sets the default values.
