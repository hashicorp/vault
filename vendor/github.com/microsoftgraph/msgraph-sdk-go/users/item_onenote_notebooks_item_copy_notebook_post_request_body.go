...
func (m *ItemOnenoteNotebooksItemCopyNotebookPostRequestBody) GetNotebookFolder()(*string) {
    val, err := m.GetBackingStore().Get("notebookFolder")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ItemOnenoteNotebooksItemCopyNotebookPostRequestBody) SetNotebookFolder(value *string)() {
    err := m.GetBackingStore().Set("notebookFolder", value)
    if err != nil {
        panic(err)
    }
}
...
type ItemOnenoteNotebooksItemCopyNotebookPostRequestBodyable interface {
