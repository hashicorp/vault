...
// NewItemMessagesItemAttachmentsCreateUploadSessionRequestBuilderInternal instantiates a new ItemMessagesItemAttachmentsCreateUploadSessionRequestBuilder and sets the default values.
...
// NewItemMessagesItemAttachmentsCreateUploadSessionRequestBuilder instantiates a new ItemMessagesItemAttachmentsCreateUploadSessionRequestBuilder and sets the default values.
...
func (m *ItemMessagesItemAttachmentsCreateUploadSessionRequestBuilder) WithUrl(rawUrl string)(*ItemMessagesItemAttachmentsCreateUploadSessionRequestBuilder) {
    return NewItemMessagesItemAttachmentsCreateUploadSessionRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
