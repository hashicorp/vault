...
type ItemCalendarGroupsItemCalendarsItemEventsItemForwardPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemCalendarGroupsItemCalendarsItemEventsItemForwardPostRequestBody instantiates a new ItemCalendarGroupsItemCalendarsItemEventsItemForwardPostRequestBody and sets the default values.
func NewItemCalendarGroupsItemCalendarsItemEventsItemForwardPostRequestBody()(*ItemCalendarGroupsItemCalendarsItemEventsItemForwardPostRequestBody) {
    m := &ItemCalendarGroupsItemCalendarsItemEventsItemForwardPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarGroupsItemCalendarsItemEventsItemForwardPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
type ItemCalendarGroupsItemCalendarsItemEventsItemForwardPostRequestBodyable interface {
