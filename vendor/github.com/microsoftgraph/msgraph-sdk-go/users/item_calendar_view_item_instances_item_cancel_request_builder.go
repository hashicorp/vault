...
// NewItemCalendarViewItemInstancesItemCancelRequestBuilderInternal instantiates a new ItemCalendarViewItemInstancesItemCancelRequestBuilder and sets the default values.
func NewItemCalendarViewItemInstancesItemCancelRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarViewItemInstancesItemCancelRequestBuilder) {
    m := &ItemCalendarViewItemInstancesItemCancelRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/cancel", pathParameters),
    }
    return m
}
// NewItemCalendarViewItemInstancesItemCancelRequestBuilder instantiates a new ItemCalendarViewItemInstancesItemCancelRequestBuilder and sets the default values.
