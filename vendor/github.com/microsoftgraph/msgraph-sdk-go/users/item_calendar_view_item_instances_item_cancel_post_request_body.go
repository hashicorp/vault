...
type ItemCalendarViewItemInstancesItemCancelPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemCalendarViewItemInstancesItemCancelPostRequestBody instantiates a new ItemCalendarViewItemInstancesItemCancelPostRequestBody and sets the default values.
func NewItemCalendarViewItemInstancesItemCancelPostRequestBody()(*ItemCalendarViewItemInstancesItemCancelPostRequestBody) {
    m := &ItemCalendarViewItemInstancesItemCancelPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemCalendarViewItemInstancesItemCancelPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
type ItemCalendarViewItemInstancesItemCancelPostRequestBodyable interface {
