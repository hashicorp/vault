...
// NewItemOnenoteResourcesOnenoteResourceItemRequestBuilderInternal instantiates a new ItemOnenoteResourcesOnenoteResourceItemRequestBuilder and sets the default values.
func NewItemOnenoteResourcesOnenoteResourceItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOnenoteResourcesOnenoteResourceItemRequestBuilder) {
    m := &ItemOnenoteResourcesOnenoteResourceItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/onenote/resources/{onenoteResource%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemOnenoteResourcesOnenoteResourceItemRequestBuilder instantiates a new ItemOnenoteResourcesOnenoteResourceItemRequestBuilder and sets the default values.
...
// returns a OnenoteResourceable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ItemOnenoteResourcesOnenoteResourceItemRequestBuilder) Patch(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.OnenoteResourceable, requestConfiguration *ItemOnenoteResourcesOnenoteResourceItemRequestBuilderPatchRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.OnenoteResourceable, error) {
