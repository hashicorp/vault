...
// NewItemCalendarsItemEventsItemInstancesItemExtensionsCountRequestBuilderInternal instantiates a new ItemCalendarsItemEventsItemInstancesItemExtensionsCountRequestBuilder and sets the default values.
func NewItemCalendarsItemEventsItemInstancesItemExtensionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarsItemEventsItemInstancesItemExtensionsCountRequestBuilder) {
    m := &ItemCalendarsItemEventsItemInstancesItemExtensionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/instances/{event%2Did1}/extensions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemCalendarsItemEventsItemInstancesItemExtensionsCountRequestBuilder instantiates a new ItemCalendarsItemEventsItemInstancesItemExtensionsCountRequestBuilder and sets the default values.
...
// returns a *ItemCalendarsItemEventsItemInstancesItemExtensionsCountRequestBuilder when successful
func (m *ItemCalendarsItemEventsItemInstancesItemExtensionsCountRequestBuilder) WithUrl(rawUrl string)(*ItemCalendarsItemEventsItemInstancesItemExtensionsCountRequestBuilder) {
    return NewItemCalendarsItemEventsItemInstancesItemExtensionsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
