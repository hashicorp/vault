...
func NewConditionalAccessPoliciesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConditionalAccessPoliciesCountRequestBuilder) {
    m := &ConditionalAccessPoliciesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identity/conditionalAccess/policies/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewConditionalAccessPoliciesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConditionalAccessPoliciesCountRequestBuilder) {
    ...
    return NewConditionalAccessPoliciesCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ConditionalAccessPoliciesCountRequestBuilder) WithUrl(rawUrl string)(*ConditionalAccessPoliciesCountRequestBuilder) {
    return NewConditionalAccessPoliciesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
