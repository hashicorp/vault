...
func NewUserFlowAttributesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserFlowAttributesCountRequestBuilder) {
    m := &UserFlowAttributesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identity/userFlowAttributes/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewUserFlowAttributesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserFlowAttributesCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewUserFlowAttributesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *UserFlowAttributesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserFlowAttributesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *UserFlowAttributesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *UserFlowAttributesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UserFlowAttributesCountRequestBuilder) WithUrl(rawUrl string)(*UserFlowAttributesCountRequestBuilder) {
    return NewUserFlowAttributesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
