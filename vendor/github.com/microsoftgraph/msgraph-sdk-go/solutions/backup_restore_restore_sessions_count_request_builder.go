...
type BackupRestoreRestoreSessionsCountRequestBuilderGetQueryParameters struct {
...
type BackupRestoreRestoreSessionsCountRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *BackupRestoreRestoreSessionsCountRequestBuilderGetQueryParameters
}
...
func NewBackupRestoreRestoreSessionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreRestoreSessionsCountRequestBuilder) {
    m := &BackupRestoreRestoreSessionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/backupRestore/restoreSessions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewBackupRestoreRestoreSessionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreRestoreSessionsCountRequestBuilder) {
    ...
    return NewBackupRestoreRestoreSessionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *BackupRestoreRestoreSessionsCountRequestBuilder) WithUrl(rawUrl string)(*BackupRestoreRestoreSessionsCountRequestBuilder) {
    return NewBackupRestoreRestoreSessionsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
