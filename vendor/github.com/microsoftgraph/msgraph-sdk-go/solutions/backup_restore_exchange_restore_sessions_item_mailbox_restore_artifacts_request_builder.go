...
type BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsRequestBuilderGetQueryParameters struct {
...
type BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsRequestBuilderGetQueryParameters
}
...
type BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsRequestBuilderPostRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
func NewBackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsRequestBuilder) {
    m := &BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsRequestBuilder{
...
func NewBackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsRequestBuilder) {
    ...
    return NewBackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.MailboxRestoreArtifactCollectionResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateMailboxRestoreArtifactCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.MailboxRestoreArtifactCollectionResponseable), nil
}
...
func (m *BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsRequestBuilder) Post(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.MailboxRestoreArtifactable, requestConfiguration *BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.MailboxRestoreArtifactable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateMailboxRestoreArtifactFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.MailboxRestoreArtifactable), nil
}
...
func (m *BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsRequestBuilder) WithUrl(rawUrl string)(*BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsRequestBuilder) {
    return NewBackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
