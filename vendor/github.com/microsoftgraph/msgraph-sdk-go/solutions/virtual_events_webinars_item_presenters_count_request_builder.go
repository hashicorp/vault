...
type VirtualEventsWebinarsItemPresentersCountRequestBuilderGetQueryParameters struct {
...
type VirtualEventsWebinarsItemPresentersCountRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *VirtualEventsWebinarsItemPresentersCountRequestBuilderGetQueryParameters
}
...
func NewVirtualEventsWebinarsItemPresentersCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEventsWebinarsItemPresentersCountRequestBuilder) {
    m := &VirtualEventsWebinarsItemPresentersCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/presenters/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewVirtualEventsWebinarsItemPresentersCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEventsWebinarsItemPresentersCountRequestBuilder) {
    ...
    return NewVirtualEventsWebinarsItemPresentersCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
// returns a *VirtualEventsWebinarsItemPresentersCountRequestBuilder when successful
func (m *VirtualEventsWebinarsItemPresentersCountRequestBuilder) WithUrl(rawUrl string)(*VirtualEventsWebinarsItemPresentersCountRequestBuilder) {
    return NewVirtualEventsWebinarsItemPresentersCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
