...
type BackupRestoreRestorePointsCountRequestBuilderGetQueryParameters struct {
...
type BackupRestoreRestorePointsCountRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *BackupRestoreRestorePointsCountRequestBuilderGetQueryParameters
}
...
func NewBackupRestoreRestorePointsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreRestorePointsCountRequestBuilder) {
    m := &BackupRestoreRestorePointsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/backupRestore/restorePoints/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewBackupRestoreRestorePointsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreRestorePointsCountRequestBuilder) {
    ...
    return NewBackupRestoreRestorePointsCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *BackupRestoreRestorePointsCountRequestBuilder) WithUrl(rawUrl string)(*BackupRestoreRestorePointsCountRequestBuilder) {
    return NewBackupRestoreRestorePointsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
