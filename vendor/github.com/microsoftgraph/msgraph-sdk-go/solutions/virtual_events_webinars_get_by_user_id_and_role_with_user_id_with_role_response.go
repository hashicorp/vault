...
func NewVirtualEventsWebinarsGetByUserIdAndRoleWithUserIdWithRoleResponse()(*VirtualEventsWebinarsGetByUserIdAndRoleWithUserIdWithRoleResponse) {
    m := &VirtualEventsWebinarsGetByUserIdAndRoleWithUserIdWithRoleResponse{
        VirtualEventsWebinarsGetByUserIdAndRoleWithUserIdWithRoleGetResponse: *NewVirtualEventsWebinarsGetByUserIdAndRoleWithUserIdWithRoleGetResponse(),
    }
    return m
}
// CreateVirtualEventsWebinarsGetByUserIdAndRoleWithUserIdWithRoleResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
