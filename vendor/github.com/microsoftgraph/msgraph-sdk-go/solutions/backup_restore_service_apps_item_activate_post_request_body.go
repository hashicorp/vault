...
func NewBackupRestoreServiceAppsItemActivatePostRequestBody()(*BackupRestoreServiceAppsItemActivatePostRequestBody) {
    m := &BackupRestoreServiceAppsItemActivatePostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateBackupRestoreServiceAppsItemActivatePostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateBackupRestoreServiceAppsItemActivatePostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewBackupRestoreServiceAppsItemActivatePostRequestBody(), nil
}
...
// GetEffectiveDateTime gets the effectiveDateTime property value. The effectiveDateTime property
...
type BackupRestoreServiceAppsItemActivatePostRequestBodyable interface {
