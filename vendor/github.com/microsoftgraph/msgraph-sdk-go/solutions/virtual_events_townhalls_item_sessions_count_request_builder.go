...
type VirtualEventsTownhallsItemSessionsCountRequestBuilderGetQueryParameters struct {
...
type VirtualEventsTownhallsItemSessionsCountRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *VirtualEventsTownhallsItemSessionsCountRequestBuilderGetQueryParameters
}
...
func NewVirtualEventsTownhallsItemSessionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEventsTownhallsItemSessionsCountRequestBuilder) {
    m := &VirtualEventsTownhallsItemSessionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/sessions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewVirtualEventsTownhallsItemSessionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*VirtualEventsTownhallsItemSessionsCountRequestBuilder) {
    ...
    return NewVirtualEventsTownhallsItemSessionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *VirtualEventsTownhallsItemSessionsCountRequestBuilder) WithUrl(rawUrl string)(*VirtualEventsTownhallsItemSessionsCountRequestBuilder) {
    return NewVirtualEventsTownhallsItemSessionsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
