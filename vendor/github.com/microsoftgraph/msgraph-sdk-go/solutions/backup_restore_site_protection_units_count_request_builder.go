...
type BackupRestoreSiteProtectionUnitsCountRequestBuilderGetQueryParameters struct {
...
type BackupRestoreSiteProtectionUnitsCountRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *BackupRestoreSiteProtectionUnitsCountRequestBuilderGetQueryParameters
}
...
func NewBackupRestoreSiteProtectionUnitsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreSiteProtectionUnitsCountRequestBuilder) {
    m := &BackupRestoreSiteProtectionUnitsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/backupRestore/siteProtectionUnits/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewBackupRestoreSiteProtectionUnitsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreSiteProtectionUnitsCountRequestBuilder) {
    ...
    return NewBackupRestoreSiteProtectionUnitsCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *BackupRestoreSiteProtectionUnitsCountRequestBuilder) WithUrl(rawUrl string)(*BackupRestoreSiteProtectionUnitsCountRequestBuilder) {
    return NewBackupRestoreSiteProtectionUnitsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
