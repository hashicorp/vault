...
type BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsCountRequestBuilderGetQueryParameters struct {
...
type BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsCountRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsCountRequestBuilderGetQueryParameters
}
...
func NewBackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsCountRequestBuilder) {
    m := &BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/backupRestore/exchangeRestoreSessions/{exchangeRestoreSession%2Did}/mailboxRestoreArtifacts/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewBackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsCountRequestBuilder) {
    ...
    return NewBackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsCountRequestBuilder) WithUrl(rawUrl string)(*BackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsCountRequestBuilder) {
    return NewBackupRestoreExchangeRestoreSessionsItemMailboxRestoreArtifactsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
