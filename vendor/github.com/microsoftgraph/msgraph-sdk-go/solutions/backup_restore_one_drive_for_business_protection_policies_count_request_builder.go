...
type BackupRestoreOneDriveForBusinessProtectionPoliciesCountRequestBuilderGetQueryParameters struct {
...
type BackupRestoreOneDriveForBusinessProtectionPoliciesCountRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *BackupRestoreOneDriveForBusinessProtectionPoliciesCountRequestBuilderGetQueryParameters
}
...
func NewBackupRestoreOneDriveForBusinessProtectionPoliciesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreOneDriveForBusinessProtectionPoliciesCountRequestBuilder) {
    m := &BackupRestoreOneDriveForBusinessProtectionPoliciesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/backupRestore/oneDriveForBusinessProtectionPolicies/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewBackupRestoreOneDriveForBusinessProtectionPoliciesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreOneDriveForBusinessProtectionPoliciesCountRequestBuilder) {
    ...
    return NewBackupRestoreOneDriveForBusinessProtectionPoliciesCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *BackupRestoreOneDriveForBusinessProtectionPoliciesCountRequestBuilder) WithUrl(rawUrl string)(*BackupRestoreOneDriveForBusinessProtectionPoliciesCountRequestBuilder) {
    return NewBackupRestoreOneDriveForBusinessProtectionPoliciesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
