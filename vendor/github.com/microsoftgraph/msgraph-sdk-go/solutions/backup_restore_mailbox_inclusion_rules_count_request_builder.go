...
type BackupRestoreMailboxInclusionRulesCountRequestBuilderGetQueryParameters struct {
...
type BackupRestoreMailboxInclusionRulesCountRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *BackupRestoreMailboxInclusionRulesCountRequestBuilderGetQueryParameters
}
...
func NewBackupRestoreMailboxInclusionRulesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreMailboxInclusionRulesCountRequestBuilder) {
    m := &BackupRestoreMailboxInclusionRulesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/backupRestore/mailboxInclusionRules/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewBackupRestoreMailboxInclusionRulesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreMailboxInclusionRulesCountRequestBuilder) {
    ...
    return NewBackupRestoreMailboxInclusionRulesCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *BackupRestoreMailboxInclusionRulesCountRequestBuilder) WithUrl(rawUrl string)(*BackupRestoreMailboxInclusionRulesCountRequestBuilder) {
    return NewBackupRestoreMailboxInclusionRulesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
