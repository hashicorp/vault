...
type BackupRestoreProtectionUnitsCountRequestBuilderGetQueryParameters struct {
...
type BackupRestoreProtectionUnitsCountRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *BackupRestoreProtectionUnitsCountRequestBuilderGetQueryParameters
}
...
func NewBackupRestoreProtectionUnitsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreProtectionUnitsCountRequestBuilder) {
    m := &BackupRestoreProtectionUnitsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/backupRestore/protectionUnits/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewBackupRestoreProtectionUnitsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreProtectionUnitsCountRequestBuilder) {
    ...
    return NewBackupRestoreProtectionUnitsCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *BackupRestoreProtectionUnitsCountRequestBuilder) WithUrl(rawUrl string)(*BackupRestoreProtectionUnitsCountRequestBuilder) {
    return NewBackupRestoreProtectionUnitsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
