...
func NewCommunitiesItemGroupServiceProvisioningErrorsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunitiesItemGroupServiceProvisioningErrorsRequestBuilder) {
    m := &CommunitiesItemGroupServiceProvisioningErrorsRequestBuilder{
...
func NewCommunitiesItemGroupServiceProvisioningErrorsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CommunitiesItemGroupServiceProvisioningErrorsRequestBuilder) {
    ...
    return NewCommunitiesItemGroupServiceProvisioningErrorsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
// returns a *CommunitiesItemGroupServiceProvisioningErrorsCountRequestBuilder when successful
func (m *CommunitiesItemGroupServiceProvisioningErrorsRequestBuilder) Count()(*CommunitiesItemGroupServiceProvisioningErrorsCountRequestBuilder) {
...
func (m *CommunitiesItemGroupServiceProvisioningErrorsRequestBuilder) Get(ctx context.Context, requestConfiguration *CommunitiesItemGroupServiceProvisioningErrorsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ServiceProvisioningErrorCollectionResponseable, error) {
...
func (m *CommunitiesItemGroupServiceProvisioningErrorsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *CommunitiesItemGroupServiceProvisioningErrorsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CommunitiesItemGroupServiceProvisioningErrorsRequestBuilder) WithUrl(rawUrl string)(*CommunitiesItemGroupServiceProvisioningErrorsRequestBuilder) {
    return NewCommunitiesItemGroupServiceProvisioningErrorsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
