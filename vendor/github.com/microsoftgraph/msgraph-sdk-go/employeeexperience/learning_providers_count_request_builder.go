...
func NewLearningProvidersCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LearningProvidersCountRequestBuilder) {
    m := &LearningProvidersCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/employeeExperience/learningProviders/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewLearningProvidersCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LearningProvidersCountRequestBuilder) {
    ...
    return NewLearningProvidersCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *LearningProvidersCountRequestBuilder) WithUrl(rawUrl string)(*LearningProvidersCountRequestBuilder) {
    return NewLearningProvidersCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
