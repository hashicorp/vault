...
// NewClassesItemAssignmentsItemSubmissionsCountRequestBuilderInternal instantiates a new ClassesItemAssignmentsItemSubmissionsCountRequestBuilder and sets the default values.
func NewClassesItemAssignmentsItemSubmissionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ClassesItemAssignmentsItemSubmissionsCountRequestBuilder) {
    m := &ClassesItemAssignmentsItemSubmissionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/submissions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewClassesItemAssignmentsItemSubmissionsCountRequestBuilder instantiates a new ClassesItemAssignmentsItemSubmissionsCountRequestBuilder and sets the default values.
...
// returns a *ClassesItemAssignmentsItemSubmissionsCountRequestBuilder when successful
