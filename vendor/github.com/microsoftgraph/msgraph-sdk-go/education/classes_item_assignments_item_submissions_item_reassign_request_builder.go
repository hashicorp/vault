...
// NewClassesItemAssignmentsItemSubmissionsItemReassignRequestBuilderInternal instantiates a new ClassesItemAssignmentsItemSubmissionsItemReassignRequestBuilder and sets the default values.
func NewClassesItemAssignmentsItemSubmissionsItemReassignRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ClassesItemAssignmentsItemSubmissionsItemReassignRequestBuilder) {
    m := &ClassesItemAssignmentsItemSubmissionsItemReassignRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/reassign", pathParameters),
    }
    return m
}
// NewClassesItemAssignmentsItemSubmissionsItemReassignRequestBuilder instantiates a new ClassesItemAssignmentsItemSubmissionsItemReassignRequestBuilder and sets the default values.
...
func (m *ClassesItemAssignmentsItemSubmissionsItemReassignRequestBuilder) WithUrl(rawUrl string)(*ClassesItemAssignmentsItemSubmissionsItemReassignRequestBuilder) {
    return NewClassesItemAssignmentsItemSubmissionsItemReassignRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
