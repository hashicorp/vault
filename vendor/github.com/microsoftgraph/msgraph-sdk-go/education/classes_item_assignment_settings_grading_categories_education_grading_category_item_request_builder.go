...
// NewClassesItemAssignmentSettingsGradingCategoriesEducationGradingCategoryItemRequestBuilder instantiates a new ClassesItemAssignmentSettingsGradingCategoriesEducationGradingCategoryItemRequestBuilder and sets the default values.
...
// Patch update a single gradingCategory on the educationAssignmentSettings. Only teachers can perform this operation.
// returns a EducationGradingCategoryable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
// 
...
// ToPatchRequestInformation update a single gradingCategory on the educationAssignmentSettings. Only teachers can perform this operation.
// returns a *RequestInformation when successful
