...
// NewUsersItemAssignmentsItemSubmissionsItemSubmittedResourcesCountRequestBuilderInternal instantiates a new UsersItemAssignmentsItemSubmissionsItemSubmittedResourcesCountRequestBuilder and sets the default values.
func NewUsersItemAssignmentsItemSubmissionsItemSubmittedResourcesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UsersItemAssignmentsItemSubmissionsItemSubmittedResourcesCountRequestBuilder) {
    m := &UsersItemAssignmentsItemSubmissionsItemSubmittedResourcesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/submittedResources/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewUsersItemAssignmentsItemSubmissionsItemSubmittedResourcesCountRequestBuilder instantiates a new UsersItemAssignmentsItemSubmissionsItemSubmittedResourcesCountRequestBuilder and sets the default values.
...
func (m *UsersItemAssignmentsItemSubmissionsItemSubmittedResourcesCountRequestBuilder) WithUrl(rawUrl string)(*UsersItemAssignmentsItemSubmissionsItemSubmittedResourcesCountRequestBuilder) {
    return NewUsersItemAssignmentsItemSubmissionsItemSubmittedResourcesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
