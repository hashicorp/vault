...
// ClassesItemAssignmentSettingsGradingCategoriesCountRequestBuilder provides operations to count the resources in the collection.
type ClassesItemAssignmentSettingsGradingCategoriesCountRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ClassesItemAssignmentSettingsGradingCategoriesCountRequestBuilderGetQueryParameters get the number of the resource
type ClassesItemAssignmentSettingsGradingCategoriesCountRequestBuilderGetQueryParameters struct {
    // Filter items by property values
    Filter *string `uriparametername:"%24filter"`
    // Search items by search phrases
    Search *string `uriparametername:"%24search"`
}
// ClassesItemAssignmentSettingsGradingCategoriesCountRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ClassesItemAssignmentSettingsGradingCategoriesCountRequestBuilderGetRequestConfiguration struct {
    // Request headers
