...
func NewInvitedUserSponsorsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*InvitedUserSponsorsCountRequestBuilder) {
    m := &InvitedUserSponsorsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/invitations/invitedUserSponsors/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewInvitedUserSponsorsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*InvitedUserSponsorsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewInvitedUserSponsorsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *InvitedUserSponsorsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *InvitedUserSponsorsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *InvitedUserSponsorsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *InvitedUserSponsorsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *InvitedUserSponsorsCountRequestBuilder) WithUrl(rawUrl string)(*InvitedUserSponsorsCountRequestBuilder) {
    return NewInvitedUserSponsorsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
