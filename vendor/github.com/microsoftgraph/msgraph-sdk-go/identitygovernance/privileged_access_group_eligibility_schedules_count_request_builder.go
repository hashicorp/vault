...
func NewPrivilegedAccessGroupEligibilitySchedulesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivilegedAccessGroupEligibilitySchedulesCountRequestBuilder) {
    m := &PrivilegedAccessGroupEligibilitySchedulesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identityGovernance/privilegedAccess/group/eligibilitySchedules/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewPrivilegedAccessGroupEligibilitySchedulesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrivilegedAccessGroupEligibilitySchedulesCountRequestBuilder) {
    ...
    return NewPrivilegedAccessGroupEligibilitySchedulesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *PrivilegedAccessGroupEligibilitySchedulesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *PrivilegedAccessGroupEligibilitySchedulesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *PrivilegedAccessGroupEligibilitySchedulesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *PrivilegedAccessGroupEligibilitySchedulesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *PrivilegedAccessGroupEligibilitySchedulesCountRequestBuilder) WithUrl(rawUrl string)(*PrivilegedAccessGroupEligibilitySchedulesCountRequestBuilder) {
    return NewPrivilegedAccessGroupEligibilitySchedulesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
