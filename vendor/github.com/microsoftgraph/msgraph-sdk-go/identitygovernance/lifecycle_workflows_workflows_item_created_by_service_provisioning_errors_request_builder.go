...
func NewLifecycleWorkflowsWorkflowsItemCreatedByServiceProvisioningErrorsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LifecycleWorkflowsWorkflowsItemCreatedByServiceProvisioningErrorsRequestBuilder) {
    m := &LifecycleWorkflowsWorkflowsItemCreatedByServiceProvisioningErrorsRequestBuilder{
...
func NewLifecycleWorkflowsWorkflowsItemCreatedByServiceProvisioningErrorsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LifecycleWorkflowsWorkflowsItemCreatedByServiceProvisioningErrorsRequestBuilder) {
    ...
    return NewLifecycleWorkflowsWorkflowsItemCreatedByServiceProvisioningErrorsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *LifecycleWorkflowsWorkflowsItemCreatedByServiceProvisioningErrorsRequestBuilder) Count()(*LifecycleWorkflowsWorkflowsItemCreatedByServiceProvisioningErrorsCountRequestBuilder) {
...
func (m *LifecycleWorkflowsWorkflowsItemCreatedByServiceProvisioningErrorsRequestBuilder) WithUrl(rawUrl string)(*LifecycleWorkflowsWorkflowsItemCreatedByServiceProvisioningErrorsRequestBuilder) {
    return NewLifecycleWorkflowsWorkflowsItemCreatedByServiceProvisioningErrorsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
