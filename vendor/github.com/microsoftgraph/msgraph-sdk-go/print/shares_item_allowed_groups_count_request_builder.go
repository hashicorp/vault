...
func NewSharesItemAllowedGroupsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemAllowedGroupsCountRequestBuilder) {
    m := &SharesItemAllowedGroupsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/print/shares/{printerShare%2Did}/allowedGroups/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewSharesItemAllowedGroupsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemAllowedGroupsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewSharesItemAllowedGroupsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *SharesItemAllowedGroupsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *SharesItemAllowedGroupsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *SharesItemAllowedGroupsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *SharesItemAllowedGroupsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *SharesItemAllowedGroupsCountRequestBuilder) WithUrl(rawUrl string)(*SharesItemAllowedGroupsCountRequestBuilder) {
    return NewSharesItemAllowedGroupsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
