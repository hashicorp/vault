...
func NewSharesItemAllowedUsersItemServiceProvisioningErrorsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemAllowedUsersItemServiceProvisioningErrorsCountRequestBuilder) {
    m := &SharesItemAllowedUsersItemServiceProvisioningErrorsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/print/shares/{printerShare%2Did}/allowedUsers/{user%2Did}/serviceProvisioningErrors/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewSharesItemAllowedUsersItemServiceProvisioningErrorsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SharesItemAllowedUsersItemServiceProvisioningErrorsCountRequestBuilder) {
    ...
    return NewSharesItemAllowedUsersItemServiceProvisioningErrorsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *SharesItemAllowedUsersItemServiceProvisioningErrorsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *SharesItemAllowedUsersItemServiceProvisioningErrorsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
// returns a *SharesItemAllowedUsersItemServiceProvisioningErrorsCountRequestBuilder when successful
func (m *SharesItemAllowedUsersItemServiceProvisioningErrorsCountRequestBuilder) WithUrl(rawUrl string)(*SharesItemAllowedUsersItemServiceProvisioningErrorsCountRequestBuilder) {
    return NewSharesItemAllowedUsersItemServiceProvisioningErrorsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
