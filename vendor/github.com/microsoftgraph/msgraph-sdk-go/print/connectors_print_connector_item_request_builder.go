...
func NewConnectorsPrintConnectorItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConnectorsPrintConnectorItemRequestBuilder) {
    m := &ConnectorsPrintConnectorItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/print/connectors/{printConnector%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
...
func NewConnectorsPrintConnectorItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ConnectorsPrintConnectorItemRequestBuilder) {
...
// returns a *ConnectorsPrintConnectorItemRequestBuilder when successful
func (m *ConnectorsPrintConnectorItemRequestBuilder) WithUrl(rawUrl string)(*ConnectorsPrintConnectorItemRequestBuilder) {
    return NewConnectorsPrintConnectorItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
