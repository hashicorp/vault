...
func NewPrintersItemJobsItemDocumentsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrintersItemJobsItemDocumentsCountRequestBuilder) {
    m := &PrintersItemJobsItemDocumentsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/documents/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewPrintersItemJobsItemDocumentsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PrintersItemJobsItemDocumentsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewPrintersItemJobsItemDocumentsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *PrintersItemJobsItemDocumentsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *PrintersItemJobsItemDocumentsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *PrintersItemJobsItemDocumentsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *PrintersItemJobsItemDocumentsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *PrintersItemJobsItemDocumentsCountRequestBuilder) WithUrl(rawUrl string)(*PrintersItemJobsItemDocumentsCountRequestBuilder) {
    return NewPrintersItemJobsItemDocumentsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
