...
// NewItemEventsItemAcceptPostRequestBody instantiates a new ItemEventsItemAcceptPostRequestBody and sets the default values.
...
type ItemEventsItemAcceptPostRequestBodyable interface {
