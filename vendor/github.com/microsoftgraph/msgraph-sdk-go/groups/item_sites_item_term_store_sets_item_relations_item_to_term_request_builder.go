...
// NewItemSitesItemTermStoreSetsItemRelationsItemToTermRequestBuilderInternal instantiates a new ItemSitesItemTermStoreSetsItemRelationsItemToTermRequestBuilder and sets the default values.
func NewItemSitesItemTermStoreSetsItemRelationsItemToTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemTermStoreSetsItemRelationsItemToTermRequestBuilder) {
    m := &ItemSitesItemTermStoreSetsItemRelationsItemToTermRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/relations/{relation%2Did}/toTerm{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemSitesItemTermStoreSetsItemRelationsItemToTermRequestBuilder instantiates a new ItemSitesItemTermStoreSetsItemRelationsItemToTermRequestBuilder and sets the default values.
...
func (m *ItemSitesItemTermStoreSetsItemRelationsItemToTermRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSitesItemTermStoreSetsItemRelationsItemToTermRequestBuilderGetRequestConfiguration)(ia3c27b33aa3d3ed80f9de797c48fbb8ed73f13887e301daf51f08450e9a634a3.Termable, error) {
...
func (m *ItemSitesItemTermStoreSetsItemRelationsItemToTermRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemSitesItemTermStoreSetsItemRelationsItemToTermRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *ItemSitesItemTermStoreSetsItemRelationsItemToTermRequestBuilder when successful
func (m *ItemSitesItemTermStoreSetsItemRelationsItemToTermRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemTermStoreSetsItemRelationsItemToTermRequestBuilder) {
    return NewItemSitesItemTermStoreSetsItemRelationsItemToTermRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
