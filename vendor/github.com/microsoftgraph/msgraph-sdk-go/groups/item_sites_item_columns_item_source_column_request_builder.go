...
// ItemSitesItemColumnsItemSourceColumnRequestBuilderGetQueryParameters the source column for the content type column.
...
// NewItemSitesItemColumnsItemSourceColumnRequestBuilderInternal instantiates a new ItemSitesItemColumnsItemSourceColumnRequestBuilder and sets the default values.
func NewItemSitesItemColumnsItemSourceColumnRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemColumnsItemSourceColumnRequestBuilder) {
    m := &ItemSitesItemColumnsItemSourceColumnRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/columns/{columnDefinition%2Did}/sourceColumn{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemSitesItemColumnsItemSourceColumnRequestBuilder instantiates a new ItemSitesItemColumnsItemSourceColumnRequestBuilder and sets the default values.
...
func (m *ItemSitesItemColumnsItemSourceColumnRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSitesItemColumnsItemSourceColumnRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ColumnDefinitionable, error) {
...
func (m *ItemSitesItemColumnsItemSourceColumnRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemSitesItemColumnsItemSourceColumnRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *ItemSitesItemColumnsItemSourceColumnRequestBuilder when successful
func (m *ItemSitesItemColumnsItemSourceColumnRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemColumnsItemSourceColumnRequestBuilder) {
    return NewItemSitesItemColumnsItemSourceColumnRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
