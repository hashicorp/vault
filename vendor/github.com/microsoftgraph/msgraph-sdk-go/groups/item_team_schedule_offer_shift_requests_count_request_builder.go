...
// NewItemTeamScheduleOfferShiftRequestsCountRequestBuilderInternal instantiates a new ItemTeamScheduleOfferShiftRequestsCountRequestBuilder and sets the default values.
func NewItemTeamScheduleOfferShiftRequestsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamScheduleOfferShiftRequestsCountRequestBuilder) {
    m := &ItemTeamScheduleOfferShiftRequestsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/schedule/offerShiftRequests/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemTeamScheduleOfferShiftRequestsCountRequestBuilder instantiates a new ItemTeamScheduleOfferShiftRequestsCountRequestBuilder and sets the default values.
