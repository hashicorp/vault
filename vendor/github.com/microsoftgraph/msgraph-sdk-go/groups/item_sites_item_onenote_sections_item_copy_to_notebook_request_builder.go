...
// NewItemSitesItemOnenoteSectionsItemCopyToNotebookRequestBuilderInternal instantiates a new ItemSitesItemOnenoteSectionsItemCopyToNotebookRequestBuilder and sets the default values.
...
// NewItemSitesItemOnenoteSectionsItemCopyToNotebookRequestBuilder instantiates a new ItemSitesItemOnenoteSectionsItemCopyToNotebookRequestBuilder and sets the default values.
...
func (m *ItemSitesItemOnenoteSectionsItemCopyToNotebookRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemOnenoteSectionsItemCopyToNotebookRequestBuilder) {
    return NewItemSitesItemOnenoteSectionsItemCopyToNotebookRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
