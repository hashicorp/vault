...
// NewItemSitesItemOnenoteSectionGroupsItemSectionsItemParentNotebookRequestBuilderInternal instantiates a new ItemSitesItemOnenoteSectionGroupsItemSectionsItemParentNotebookRequestBuilder and sets the default values.
...
// NewItemSitesItemOnenoteSectionGroupsItemSectionsItemParentNotebookRequestBuilder instantiates a new ItemSitesItemOnenoteSectionGroupsItemSectionsItemParentNotebookRequestBuilder and sets the default values.
...
func (m *ItemSitesItemOnenoteSectionGroupsItemSectionsItemParentNotebookRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemSitesItemOnenoteSectionGroupsItemSectionsItemParentNotebookRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemSitesItemOnenoteSectionGroupsItemSectionsItemParentNotebookRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemOnenoteSectionGroupsItemSectionsItemParentNotebookRequestBuilder) {
    return NewItemSitesItemOnenoteSectionGroupsItemSectionsItemParentNotebookRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
