...
// ItemExtensionsRequestBuilder provides operations to manage the extensions property of the microsoft.graph.group entity.
type ItemExtensionsRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemExtensionsRequestBuilderGetQueryParameters the collection of open extensions defined for the group. Read-only. Nullable.
...
// ByExtensionId provides operations to manage the extensions property of the microsoft.graph.group entity.
// returns a *ItemExtensionsExtensionItemRequestBuilder when successful
...
func NewItemExtensionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemExtensionsRequestBuilder) {
    m := &ItemExtensionsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/extensions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
...
// returns a *ItemExtensionsCountRequestBuilder when successful
func (m *ItemExtensionsRequestBuilder) Count()(*ItemExtensionsCountRequestBuilder) {
    return NewItemExtensionsCountRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// ToGetRequestInformation the collection of open extensions defined for the group. Read-only. Nullable.
...
func (m *ItemExtensionsRequestBuilder) WithUrl(rawUrl string)(*ItemExtensionsRequestBuilder) {
    return NewItemExtensionsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
