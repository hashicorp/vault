...
type ItemThreadsItemPostsItemInReplyToForwardPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemThreadsItemPostsItemInReplyToForwardPostRequestBody instantiates a new ItemThreadsItemPostsItemInReplyToForwardPostRequestBody and sets the default values.
func NewItemThreadsItemPostsItemInReplyToForwardPostRequestBody()(*ItemThreadsItemPostsItemInReplyToForwardPostRequestBody) {
    m := &ItemThreadsItemPostsItemInReplyToForwardPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemThreadsItemPostsItemInReplyToForwardPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
type ItemThreadsItemPostsItemInReplyToForwardPostRequestBodyable interface {
