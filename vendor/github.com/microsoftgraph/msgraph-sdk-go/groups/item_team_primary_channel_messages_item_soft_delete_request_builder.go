...
// NewItemTeamPrimaryChannelMessagesItemSoftDeleteRequestBuilderInternal instantiates a new ItemTeamPrimaryChannelMessagesItemSoftDeleteRequestBuilder and sets the default values.
...
// NewItemTeamPrimaryChannelMessagesItemSoftDeleteRequestBuilder instantiates a new ItemTeamPrimaryChannelMessagesItemSoftDeleteRequestBuilder and sets the default values.
...
func (m *ItemTeamPrimaryChannelMessagesItemSoftDeleteRequestBuilder) WithUrl(rawUrl string)(*ItemTeamPrimaryChannelMessagesItemSoftDeleteRequestBuilder) {
    return NewItemTeamPrimaryChannelMessagesItemSoftDeleteRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
