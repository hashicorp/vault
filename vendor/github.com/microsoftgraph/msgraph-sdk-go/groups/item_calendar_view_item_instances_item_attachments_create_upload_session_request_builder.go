...
// NewItemCalendarViewItemInstancesItemAttachmentsCreateUploadSessionRequestBuilderInternal instantiates a new ItemCalendarViewItemInstancesItemAttachmentsCreateUploadSessionRequestBuilder and sets the default values.
func NewItemCalendarViewItemInstancesItemAttachmentsCreateUploadSessionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarViewItemInstancesItemAttachmentsCreateUploadSessionRequestBuilder) {
    m := &ItemCalendarViewItemInstancesItemAttachmentsCreateUploadSessionRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/attachments/createUploadSession", pathParameters),
    }
    return m
}
// NewItemCalendarViewItemInstancesItemAttachmentsCreateUploadSessionRequestBuilder instantiates a new ItemCalendarViewItemInstancesItemAttachmentsCreateUploadSessionRequestBuilder and sets the default values.
...
// returns a *ItemCalendarViewItemInstancesItemAttachmentsCreateUploadSessionRequestBuilder when successful
func (m *ItemCalendarViewItemInstancesItemAttachmentsCreateUploadSessionRequestBuilder) WithUrl(rawUrl string)(*ItemCalendarViewItemInstancesItemAttachmentsCreateUploadSessionRequestBuilder) {
    return NewItemCalendarViewItemInstancesItemAttachmentsCreateUploadSessionRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
