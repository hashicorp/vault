...
// NewItemTeamCompleteMigrationRequestBuilderInternal instantiates a new ItemTeamCompleteMigrationRequestBuilder and sets the default values.
...
// NewItemTeamCompleteMigrationRequestBuilder instantiates a new ItemTeamCompleteMigrationRequestBuilder and sets the default values.
...
func (m *ItemTeamCompleteMigrationRequestBuilder) WithUrl(rawUrl string)(*ItemTeamCompleteMigrationRequestBuilder) {
    return NewItemTeamCompleteMigrationRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
