...
// NewItemConversationsItemThreadsItemPostsItemAttachmentsCountRequestBuilderInternal instantiates a new ItemConversationsItemThreadsItemPostsItemAttachmentsCountRequestBuilder and sets the default values.
func NewItemConversationsItemThreadsItemPostsItemAttachmentsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemConversationsItemThreadsItemPostsItemAttachmentsCountRequestBuilder) {
    m := &ItemConversationsItemThreadsItemPostsItemAttachmentsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/attachments/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemConversationsItemThreadsItemPostsItemAttachmentsCountRequestBuilder instantiates a new ItemConversationsItemThreadsItemPostsItemAttachmentsCountRequestBuilder and sets the default values.
