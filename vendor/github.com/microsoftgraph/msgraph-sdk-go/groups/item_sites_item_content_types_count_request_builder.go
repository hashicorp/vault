...
// NewItemSitesItemContentTypesCountRequestBuilderInternal instantiates a new ItemSitesItemContentTypesCountRequestBuilder and sets the default values.
func NewItemSitesItemContentTypesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemContentTypesCountRequestBuilder) {
    m := &ItemSitesItemContentTypesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemSitesItemContentTypesCountRequestBuilder instantiates a new ItemSitesItemContentTypesCountRequestBuilder and sets the default values.
...
func (m *ItemSitesItemContentTypesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemSitesItemContentTypesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemSitesItemContentTypesCountRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemContentTypesCountRequestBuilder) {
    return NewItemSitesItemContentTypesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
