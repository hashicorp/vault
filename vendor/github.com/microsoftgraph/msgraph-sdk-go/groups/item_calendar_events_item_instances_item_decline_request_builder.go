...
// NewItemCalendarEventsItemInstancesItemDeclineRequestBuilderInternal instantiates a new ItemCalendarEventsItemInstancesItemDeclineRequestBuilder and sets the default values.
...
// NewItemCalendarEventsItemInstancesItemDeclineRequestBuilder instantiates a new ItemCalendarEventsItemInstancesItemDeclineRequestBuilder and sets the default values.
...
func (m *ItemCalendarEventsItemInstancesItemDeclineRequestBuilder) WithUrl(rawUrl string)(*ItemCalendarEventsItemInstancesItemDeclineRequestBuilder) {
    return NewItemCalendarEventsItemInstancesItemDeclineRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
