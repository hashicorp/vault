...
// NewItemSitesItemTermStoreSetsItemTermsItemRelationsItemFromTermRequestBuilderInternal instantiates a new ItemSitesItemTermStoreSetsItemTermsItemRelationsItemFromTermRequestBuilder and sets the default values.
func NewItemSitesItemTermStoreSetsItemTermsItemRelationsItemFromTermRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemTermStoreSetsItemTermsItemRelationsItemFromTermRequestBuilder) {
    m := &ItemSitesItemTermStoreSetsItemTermsItemRelationsItemFromTermRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/terms/{term%2Did}/relations/{relation%2Did}/fromTerm{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemSitesItemTermStoreSetsItemTermsItemRelationsItemFromTermRequestBuilder instantiates a new ItemSitesItemTermStoreSetsItemTermsItemRelationsItemFromTermRequestBuilder and sets the default values.
...
// returns a *ItemSitesItemTermStoreSetsItemTermsItemRelationsItemFromTermRequestBuilder when successful
func (m *ItemSitesItemTermStoreSetsItemTermsItemRelationsItemFromTermRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemTermStoreSetsItemTermsItemRelationsItemFromTermRequestBuilder) {
    return NewItemSitesItemTermStoreSetsItemTermsItemRelationsItemFromTermRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
