...
// NewItemCalendarCalendarViewItemInstancesItemExtensionsCountRequestBuilderInternal instantiates a new ItemCalendarCalendarViewItemInstancesItemExtensionsCountRequestBuilder and sets the default values.
func NewItemCalendarCalendarViewItemInstancesItemExtensionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCalendarCalendarViewItemInstancesItemExtensionsCountRequestBuilder) {
    m := &ItemCalendarCalendarViewItemInstancesItemExtensionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/extensions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemCalendarCalendarViewItemInstancesItemExtensionsCountRequestBuilder instantiates a new ItemCalendarCalendarViewItemInstancesItemExtensionsCountRequestBuilder and sets the default values.
