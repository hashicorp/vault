...
// returns a *ItemSitesItemTermStoreSetsItemTermsItemRelationsRelationItemRequestBuilder when successful
...
// NewItemSitesItemTermStoreSetsItemTermsItemRelationsRequestBuilderInternal instantiates a new ItemSitesItemTermStoreSetsItemTermsItemRelationsRequestBuilder and sets the default values.
func NewItemSitesItemTermStoreSetsItemTermsItemRelationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemTermStoreSetsItemTermsItemRelationsRequestBuilder) {
    m := &ItemSitesItemTermStoreSetsItemTermsItemRelationsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/terms/{term%2Did}/relations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemSitesItemTermStoreSetsItemTermsItemRelationsRequestBuilder instantiates a new ItemSitesItemTermStoreSetsItemTermsItemRelationsRequestBuilder and sets the default values.
...
func (m *ItemSitesItemTermStoreSetsItemTermsItemRelationsRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemTermStoreSetsItemTermsItemRelationsRequestBuilder) {
    return NewItemSitesItemTermStoreSetsItemTermsItemRelationsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
