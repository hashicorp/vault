...
// ItemSitesItemOnenoteNotebooksItemSectionGroupsRequestBuilderGetQueryParameters the section groups in the notebook. Read-only. Nullable.
...
// NewItemSitesItemOnenoteNotebooksItemSectionGroupsRequestBuilderInternal instantiates a new ItemSitesItemOnenoteNotebooksItemSectionGroupsRequestBuilder and sets the default values.
...
// NewItemSitesItemOnenoteNotebooksItemSectionGroupsRequestBuilder instantiates a new ItemSitesItemOnenoteNotebooksItemSectionGroupsRequestBuilder and sets the default values.
