...
// NewItemSitesItemDrivesCountRequestBuilderInternal instantiates a new ItemSitesItemDrivesCountRequestBuilder and sets the default values.
func NewItemSitesItemDrivesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemDrivesCountRequestBuilder) {
    m := &ItemSitesItemDrivesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/drives/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemSitesItemDrivesCountRequestBuilder instantiates a new ItemSitesItemDrivesCountRequestBuilder and sets the default values.
...
func (m *ItemSitesItemDrivesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemSitesItemDrivesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemSitesItemDrivesCountRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemDrivesCountRequestBuilder) {
    return NewItemSitesItemDrivesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
