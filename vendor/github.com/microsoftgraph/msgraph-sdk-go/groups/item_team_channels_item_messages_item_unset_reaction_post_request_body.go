...
type ItemTeamChannelsItemMessagesItemUnsetReactionPostRequestBody struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemTeamChannelsItemMessagesItemUnsetReactionPostRequestBody instantiates a new ItemTeamChannelsItemMessagesItemUnsetReactionPostRequestBody and sets the default values.
func NewItemTeamChannelsItemMessagesItemUnsetReactionPostRequestBody()(*ItemTeamChannelsItemMessagesItemUnsetReactionPostRequestBody) {
    m := &ItemTeamChannelsItemMessagesItemUnsetReactionPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemTeamChannelsItemMessagesItemUnsetReactionPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemTeamChannelsItemMessagesItemUnsetReactionPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemTeamChannelsItemMessagesItemUnsetReactionPostRequestBody) GetReactionType()(*string) {
...
func (m *ItemTeamChannelsItemMessagesItemUnsetReactionPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemTeamChannelsItemMessagesItemUnsetReactionPostRequestBody) SetReactionType(value *string)() {
    err := m.GetBackingStore().Set("reactionType", value)
    if err != nil {
        panic(err)
    }
}
type ItemTeamChannelsItemMessagesItemUnsetReactionPostRequestBodyable interface {
