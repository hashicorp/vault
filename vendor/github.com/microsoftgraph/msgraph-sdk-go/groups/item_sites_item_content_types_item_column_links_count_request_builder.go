...
// NewItemSitesItemContentTypesItemColumnLinksCountRequestBuilderInternal instantiates a new ItemSitesItemContentTypesItemColumnLinksCountRequestBuilder and sets the default values.
func NewItemSitesItemContentTypesItemColumnLinksCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemContentTypesItemColumnLinksCountRequestBuilder) {
    m := &ItemSitesItemContentTypesItemColumnLinksCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes/{contentType%2Did}/columnLinks/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemSitesItemContentTypesItemColumnLinksCountRequestBuilder instantiates a new ItemSitesItemContentTypesItemColumnLinksCountRequestBuilder and sets the default values.
...
func (m *ItemSitesItemContentTypesItemColumnLinksCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemSitesItemContentTypesItemColumnLinksCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemSitesItemContentTypesItemColumnLinksCountRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemContentTypesItemColumnLinksCountRequestBuilder) {
    return NewItemSitesItemContentTypesItemColumnLinksCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
