...
// NewItemSitesItemOnenoteNotebooksItemSectionGroupsItemParentNotebookRequestBuilderInternal instantiates a new ItemSitesItemOnenoteNotebooksItemSectionGroupsItemParentNotebookRequestBuilder and sets the default values.
...
// NewItemSitesItemOnenoteNotebooksItemSectionGroupsItemParentNotebookRequestBuilder instantiates a new ItemSitesItemOnenoteNotebooksItemSectionGroupsItemParentNotebookRequestBuilder and sets the default values.
...
func (m *ItemSitesItemOnenoteNotebooksItemSectionGroupsItemParentNotebookRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemOnenoteNotebooksItemSectionGroupsItemParentNotebookRequestBuilder) {
    return NewItemSitesItemOnenoteNotebooksItemSectionGroupsItemParentNotebookRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
