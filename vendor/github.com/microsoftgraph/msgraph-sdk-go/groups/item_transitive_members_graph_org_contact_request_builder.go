...
// NewItemTransitiveMembersGraphOrgContactRequestBuilderInternal instantiates a new ItemTransitiveMembersGraphOrgContactRequestBuilder and sets the default values.
func NewItemTransitiveMembersGraphOrgContactRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTransitiveMembersGraphOrgContactRequestBuilder) {
    m := &ItemTransitiveMembersGraphOrgContactRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/transitiveMembers/graph.orgContact{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemTransitiveMembersGraphOrgContactRequestBuilder instantiates a new ItemTransitiveMembersGraphOrgContactRequestBuilder and sets the default values.
...
// returns a *ItemTransitiveMembersGraphOrgContactCountRequestBuilder when successful
func (m *ItemTransitiveMembersGraphOrgContactRequestBuilder) Count()(*ItemTransitiveMembersGraphOrgContactCountRequestBuilder) {
    return NewItemTransitiveMembersGraphOrgContactCountRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *ItemTransitiveMembersGraphOrgContactRequestBuilder) WithUrl(rawUrl string)(*ItemTransitiveMembersGraphOrgContactRequestBuilder) {
    return NewItemTransitiveMembersGraphOrgContactRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
