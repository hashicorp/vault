...
// NewItemTeamArchiveRequestBuilderInternal instantiates a new ItemTeamArchiveRequestBuilder and sets the default values.
func NewItemTeamArchiveRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamArchiveRequestBuilder) {
    m := &ItemTeamArchiveRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/team/archive", pathParameters),
    }
    return m
}
// NewItemTeamArchiveRequestBuilder instantiates a new ItemTeamArchiveRequestBuilder and sets the default values.
...
func (m *ItemTeamArchiveRequestBuilder) WithUrl(rawUrl string)(*ItemTeamArchiveRequestBuilder) {
    return NewItemTeamArchiveRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
