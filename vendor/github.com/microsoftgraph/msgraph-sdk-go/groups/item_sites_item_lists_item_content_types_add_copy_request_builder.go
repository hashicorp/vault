...
// NewItemSitesItemListsItemContentTypesAddCopyRequestBuilderInternal instantiates a new ItemSitesItemListsItemContentTypesAddCopyRequestBuilder and sets the default values.
...
// NewItemSitesItemListsItemContentTypesAddCopyRequestBuilder instantiates a new ItemSitesItemListsItemContentTypesAddCopyRequestBuilder and sets the default values.
...
func (m *ItemSitesItemListsItemContentTypesAddCopyRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemListsItemContentTypesAddCopyRequestBuilder) {
    return NewItemSitesItemListsItemContentTypesAddCopyRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
