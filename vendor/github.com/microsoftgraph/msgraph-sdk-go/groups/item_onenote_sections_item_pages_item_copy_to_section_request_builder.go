...
// NewItemOnenoteSectionsItemPagesItemCopyToSectionRequestBuilderInternal instantiates a new ItemOnenoteSectionsItemPagesItemCopyToSectionRequestBuilder and sets the default values.
func NewItemOnenoteSectionsItemPagesItemCopyToSectionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOnenoteSectionsItemPagesItemCopyToSectionRequestBuilder) {
    m := &ItemOnenoteSectionsItemPagesItemCopyToSectionRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/copyToSection", pathParameters),
    }
    return m
}
// NewItemOnenoteSectionsItemPagesItemCopyToSectionRequestBuilder instantiates a new ItemOnenoteSectionsItemPagesItemCopyToSectionRequestBuilder and sets the default values.
