...
// NewItemMembersWithLicenseErrorsItemGraphOrgContactRequestBuilderInternal instantiates a new ItemMembersWithLicenseErrorsItemGraphOrgContactRequestBuilder and sets the default values.
...
// NewItemMembersWithLicenseErrorsItemGraphOrgContactRequestBuilder instantiates a new ItemMembersWithLicenseErrorsItemGraphOrgContactRequestBuilder and sets the default values.
...
func (m *ItemMembersWithLicenseErrorsItemGraphOrgContactRequestBuilder) WithUrl(rawUrl string)(*ItemMembersWithLicenseErrorsItemGraphOrgContactRequestBuilder) {
    return NewItemMembersWithLicenseErrorsItemGraphOrgContactRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
