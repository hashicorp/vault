...
// ItemSitesItemOnenoteNotebooksItemSectionsRequestBuilderGetQueryParameters the sections in the notebook. Read-only. Nullable.
...
// NewItemSitesItemOnenoteNotebooksItemSectionsRequestBuilderInternal instantiates a new ItemSitesItemOnenoteNotebooksItemSectionsRequestBuilder and sets the default values.
func NewItemSitesItemOnenoteNotebooksItemSectionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSitesItemOnenoteNotebooksItemSectionsRequestBuilder) {
    m := &ItemSitesItemOnenoteNotebooksItemSectionsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sections{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewItemSitesItemOnenoteNotebooksItemSectionsRequestBuilder instantiates a new ItemSitesItemOnenoteNotebooksItemSectionsRequestBuilder and sets the default values.
