...
// NewItemOnenoteNotebooksItemSectionGroupsCountRequestBuilderInternal instantiates a new ItemOnenoteNotebooksItemSectionGroupsCountRequestBuilder and sets the default values.
func NewItemOnenoteNotebooksItemSectionGroupsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOnenoteNotebooksItemSectionGroupsCountRequestBuilder) {
    m := &ItemOnenoteNotebooksItemSectionGroupsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/groups/{group%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemOnenoteNotebooksItemSectionGroupsCountRequestBuilder instantiates a new ItemOnenoteNotebooksItemSectionGroupsCountRequestBuilder and sets the default values.
...
func (m *ItemOnenoteNotebooksItemSectionGroupsCountRequestBuilder) WithUrl(rawUrl string)(*ItemOnenoteNotebooksItemSectionGroupsCountRequestBuilder) {
    return NewItemOnenoteNotebooksItemSectionGroupsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
