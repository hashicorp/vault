...
// ItemCalendarCalendarViewItemInstancesRequestBuilderGetQueryParameters the occurrences of a recurring series, if the event is a series master. This property includes occurrences that are part of the recurrence pattern, and exceptions that have been modified, but does not include occurrences that have been cancelled from the series. Navigation property. Read-only. Nullable.
...
func (m *ItemCalendarCalendarViewItemInstancesRequestBuilder) ByEventId1(eventId1 string)(*ItemCalendarCalendarViewItemInstancesEventItemRequestBuilder) {
    ...
    return NewItemCalendarCalendarViewItemInstancesEventItemRequestBuilderInternal(urlTplParams, m.BaseRequestBuilder.RequestAdapter)
}
// NewItemCalendarCalendarViewItemInstancesRequestBuilderInternal instantiates a new ItemCalendarCalendarViewItemInstancesRequestBuilder and sets the default values.
...
// NewItemCalendarCalendarViewItemInstancesRequestBuilder instantiates a new ItemCalendarCalendarViewItemInstancesRequestBuilder and sets the default values.
...
// returns a *ItemCalendarCalendarViewItemInstancesCountRequestBuilder when successful
func (m *ItemCalendarCalendarViewItemInstancesRequestBuilder) Count()(*ItemCalendarCalendarViewItemInstancesCountRequestBuilder) {
    return NewItemCalendarCalendarViewItemInstancesCountRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// Delta provides operations to call the delta method.
// returns a *ItemCalendarCalendarViewItemInstancesDeltaRequestBuilder when successful
func (m *ItemCalendarCalendarViewItemInstancesRequestBuilder) Delta()(*ItemCalendarCalendarViewItemInstancesDeltaRequestBuilder) {
    return NewItemCalendarCalendarViewItemInstancesDeltaRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
