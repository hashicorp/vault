...
func NewPeopleProfileCardPropertiesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PeopleProfileCardPropertiesCountRequestBuilder) {
    m := &PeopleProfileCardPropertiesCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/admin/people/profileCardProperties/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewPeopleProfileCardPropertiesCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PeopleProfileCardPropertiesCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewPeopleProfileCardPropertiesCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *PeopleProfileCardPropertiesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *PeopleProfileCardPropertiesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *PeopleProfileCardPropertiesCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *PeopleProfileCardPropertiesCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *PeopleProfileCardPropertiesCountRequestBuilder) WithUrl(rawUrl string)(*PeopleProfileCardPropertiesCountRequestBuilder) {
    return NewPeopleProfileCardPropertiesCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
