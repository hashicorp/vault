...
func NewOnlineMeetingsItemRecordingsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OnlineMeetingsItemRecordingsCountRequestBuilder) {
    m := &OnlineMeetingsItemRecordingsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/recordings/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewOnlineMeetingsItemRecordingsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OnlineMeetingsItemRecordingsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewOnlineMeetingsItemRecordingsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *OnlineMeetingsItemRecordingsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *OnlineMeetingsItemRecordingsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *OnlineMeetingsItemRecordingsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *OnlineMeetingsItemRecordingsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *OnlineMeetingsItemRecordingsCountRequestBuilder) WithUrl(rawUrl string)(*OnlineMeetingsItemRecordingsCountRequestBuilder) {
    return NewOnlineMeetingsItemRecordingsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
