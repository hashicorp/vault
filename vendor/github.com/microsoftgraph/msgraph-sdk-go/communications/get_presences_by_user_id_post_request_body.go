...
func NewGetPresencesByUserIdPostRequestBody()(*GetPresencesByUserIdPostRequestBody) {
    m := &GetPresencesByUserIdPostRequestBody{
    }
...
func (m *GetPresencesByUserIdPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *GetPresencesByUserIdPostRequestBody) GetIds()([]string) {
...
func (m *GetPresencesByUserIdPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetIds() != nil {
...
type GetPresencesByUserIdPostRequestBodyable interface {
