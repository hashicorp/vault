...
func NewOnlineMeetingsItemTranscriptsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OnlineMeetingsItemTranscriptsCountRequestBuilder) {
    m := &OnlineMeetingsItemTranscriptsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/transcripts/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewOnlineMeetingsItemTranscriptsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OnlineMeetingsItemTranscriptsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewOnlineMeetingsItemTranscriptsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *OnlineMeetingsItemTranscriptsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *OnlineMeetingsItemTranscriptsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *OnlineMeetingsItemTranscriptsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *OnlineMeetingsItemTranscriptsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *OnlineMeetingsItemTranscriptsCountRequestBuilder) WithUrl(rawUrl string)(*OnlineMeetingsItemTranscriptsCountRequestBuilder) {
    return NewOnlineMeetingsItemTranscriptsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
