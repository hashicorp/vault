...
func NewDelegatedAdminCustomersCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DelegatedAdminCustomersCountRequestBuilder) {
    m := &DelegatedAdminCustomersCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/tenantRelationships/delegatedAdminCustomers/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func (m *DelegatedAdminCustomersCountRequestBuilder) WithUrl(rawUrl string)(*DelegatedAdminCustomersCountRequestBuilder) {
    return NewDelegatedAdminCustomersCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
