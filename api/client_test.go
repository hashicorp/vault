...
func TestClientEnvSettings(t *testing.T) {
	...
	os.Setenv("VAULT_CACERT", cwd+"/../test/keys/cert.pem")
	os.Setenv("VAULT_CAPATH", cwd+"/../test/keys")
	os.Setenv("VAULT_CLIENT_CERT", cwd+"/../test/keys/cert.pem")
	os.Setenv("VAULT_CLIENT_KEY", cwd+"/../test/keys/key.pem")
