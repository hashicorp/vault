...
var sudoPaths = map[string]*regexp.Regexp{
	"/auth/token/accessors/":                        regexp.MustCompile(`^/auth/{token_mount_path}/accessors/$`),
	"/pki/root":                                     regexp.MustCompile(`^/{pki_mount_path}/root$`),
	"/pki/root/sign-self-issued":                    regexp.MustCompile(`^/{pki_mount_path}/root/sign-self-issued$`),
