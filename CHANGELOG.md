...
* auth/alicloud: Update plugin to [v0.21.1](https://github.com/hashicorp/vault-plugin-auth-alicloud/releases/tag/v0.21.1)
...
* auth/gcp: Update plugin to v0.21.0
...
* database/redis: Update plugin to [v0.6.1](https://github.com/hashicorp/vault-plugin-database-redis/releases/tag/v0.6.1)
* database/redis: Update plugin to [v0.7.0](https://github.com/hashicorp/vault-plugin-database-redis/releases/tag/v0.7.0)
* database/snowflake: Update plugin to [v0.14.2](https://github.com/hashicorp/vault-plugin-database-snowflake/releases/tag/v0.14.2)
...
* secrets/openldap: update plugin to v0.16.1
...
* core (enterprise): Allow setting of an entropy source on password generation policies, and with it the selection of "seal" to use entropy augmentation.
