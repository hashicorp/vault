...
* secrets/azure: Fix issue where passwords were a UUID instead of a cryptographically secure randomized string [[GH-40](https://github.com/hashicorp/vault-plugin-secrets-azure/pull/40)]
