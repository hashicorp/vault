...
* Update vault-plugin-auth-cf to v0.20.1
* auth/azure: Update plugin to v0.20.4
* core: Bump Go version to 1.24.3.
...
* core: support for X25519MLKEM768 (post quantum key agreement) in the Go TLS stack.
