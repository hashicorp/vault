...
func (*PluginEnvironment) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugin_a3d59f81c780b2df, []int{0}
}
...
func init() { proto.RegisterFile("sdk/logical/plugin.proto", fileDescriptor_plugin_a3d59f81c780b2df) }

var fileDescriptor_plugin_a3d59f81c780b2df = []byte{
