...
const file_sdk_logical_identity_proto_rawDesc = "" +
	"\n" +
	"\x1asdk/logical/identity.proto\x12\alogical\"\x8d\x02\n" +
	"\x06Entity\x12\x0e\n" +
	"\x02ID\x18\x01 \x01(\tR\x02ID\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12(\n" +
	"\aaliases\x18\x03 \x03(\v2\x0e.logical.AliasR\aaliases\x129\n" +
	"\bmetadata\x18\x04 \x03(\v2\x1d.logical.Entity.MetadataEntryR\bmetadata\x12\x1a\n" +
	"\bdisabled\x18\x05 \x01(\bR\bdisabled\x12!\n" +
	"\fnamespace_id\x18\x06 \x01(\tR\vnamespaceID\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xb1\x03\n" +
	"\x05Alias\x12\x1d\n" +
	"\n" +
	"mount_type\x18\x01 \x01(\tR\tmountType\x12%\n" +
	"\x0emount_accessor\x18\x02 \x01(\tR\rmountAccessor\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x128\n" +
	"\bmetadata\x18\x04 \x03(\v2\x1c.logical.Alias.MetadataEntryR\bmetadata\x12\x0e\n" +
	"\x02ID\x18\x05 \x01(\tR\x02ID\x12!\n" +
	"\fnamespace_id\x18\x06 \x01(\tR\vnamespaceID\x12K\n" +
	"\x0fcustom_metadata\x18\a \x03(\v2\".logical.Alias.CustomMetadataEntryR\x0ecustomMetadata\x12\x14\n" +
	"\x05local\x18\b \x01(\bR\x05local\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\bmetadata\x18\x03 \x03(\v2\x1c.logical.Group.MetadataEntryR\bmetadata\x12!\n" +
	"\fnamespace_id\x18\x04 \x01(\tR\vnamespaceID\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"j\n" +
	"\vMFAMethodID\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12#\n" +
	"\ruses_passcode\x18\x03 \x01(\bR\fusesPasscode\x12\x12\n" +
	"\x04name\x18\x04 \x01(\tR\x04name\":\n" +
	"\x10MFAConstraintAny\x12&\n" +
	"\x03any\x18\x01 \x03(\v2\x14.logical.MFAMethodIDR\x03any\"\xea\x01\n" +
	"\x0eMFARequirement\x12$\n" +
	"\x0emfa_request_id\x18\x01 \x01(\tR\fmfaRequestID\x12T\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x19.logical.MFAConstraintAnyR\x05value:\x028\x01B(Z&github.com/hashicorp/vault/sdk/logicalb\x06proto3"
