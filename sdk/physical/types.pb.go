...
package physical // import "github.com/hashicorp/vault/sdk/physical"
...
func (*EncryptedBlobInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_fb351aef11f4cc02, []int{0}
}
...
func (dst *EncryptedBlobInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EncryptedBlobInfo.Merge(dst, src)
}
...
func (*SealKeyInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_fb351aef11f4cc02, []int{1}
}
...
func (dst *SealKeyInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SealKeyInfo.Merge(dst, src)
}
...
func init() { proto.RegisterFile("sdk/physical/types.proto", fileDescriptor_types_fb351aef11f4cc02) }

var fileDescriptor_types_fb351aef11f4cc02 = []byte{
