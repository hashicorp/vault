...
var file_sdk_plugin_pb_backend_proto_rawDesc = []byte{
	...
	0xd0, 0x01, 0x0a, 0x10, 0x52, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4a, 0x6f, 0x62, 0x49,
	...
	0x6d, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x54, 0x79, 0x70,
	...
	0x6e, 0x74, 0x22, 0x5c, 0x0a, 0x1e, 0x44, 0x65, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72,
	...
	0x52, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x32, 0xa5, 0x03, 0x0a, 0x07, 0x42, 0x61, 0x63, 0x6b,
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x09, 0x2e, 0x70, 0x62, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42,
...
var file_sdk_plugin_pb_backend_proto_depIDxs = []int32{
	...
	70, // 33: pb.RotationJobInput.schedule:type_name -> google.protobuf.Struct
	52, // 34: pb.DeregisterRotationJobRequest.req:type_name -> pb.DeregisterRotationRequestInput
	55, // 35: pb.Connection.connection_state:type_name -> pb.ConnectionState
	57, // 36: pb.ConnectionState.peer_certificates:type_name -> pb.CertificateChain
	57, // 37: pb.ConnectionState.verified_chains:type_name -> pb.CertificateChain
	56, // 38: pb.CertificateChain.certificates:type_name -> pb.Certificate
	71, // 39: pb.SendEventRequest.event:type_name -> logical.EventData
	...
	13, // 71: pb.Backend.HandleRequest:output_type -> pb.HandleRequestReply
	16, // 72: pb.Backend.SpecialPaths:output_type -> pb.SpecialPathsReply
	18, // 73: pb.Backend.HandleExistenceCheck:output_type -> pb.HandleExistenceCheckReply
	0,  // 74: pb.Backend.Cleanup:output_type -> pb.Empty
	0,  // 75: pb.Backend.InvalidateKey:output_type -> pb.Empty
	20, // 76: pb.Backend.Setup:output_type -> pb.SetupReply
	15, // 77: pb.Backend.Initialize:output_type -> pb.InitializeReply
	21, // 78: pb.Backend.Type:output_type -> pb.TypeReply
	25, // 79: pb.Storage.List:output_type -> pb.StorageListReply
	27, // 80: pb.Storage.Get:output_type -> pb.StorageGetReply
	29, // 81: pb.Storage.Put:output_type -> pb.StoragePutReply
	31, // 82: pb.Storage.Delete:output_type -> pb.StorageDeleteReply
	32, // 83: pb.SystemView.DefaultLeaseTTL:output_type -> pb.TTLReply
	32, // 84: pb.SystemView.MaxLeaseTTL:output_type -> pb.TTLReply
	33, // 85: pb.SystemView.Tainted:output_type -> pb.TaintedReply
	34, // 86: pb.SystemView.CachingDisabled:output_type -> pb.CachingDisabledReply
	35, // 87: pb.SystemView.ReplicationState:output_type -> pb.ReplicationStateReply
	37, // 88: pb.SystemView.ResponseWrapData:output_type -> pb.ResponseWrapDataReply
	38, // 89: pb.SystemView.MlockEnabled:output_type -> pb.MlockEnabledReply
	39, // 90: pb.SystemView.LocalMount:output_type -> pb.LocalMountReply
	41, // 91: pb.SystemView.EntityInfo:output_type -> pb.EntityInfoReply
	43, // 92: pb.SystemView.PluginEnv:output_type -> pb.PluginEnvReply
	42, // 93: pb.SystemView.GroupsForEntity:output_type -> pb.GroupsForEntityReply
	45, // 94: pb.SystemView.GeneratePasswordFromPolicy:output_type -> pb.GeneratePasswordFromPolicyReply
	46, // 95: pb.SystemView.ClusterInfo:output_type -> pb.ClusterInfoReply
	48, // 96: pb.SystemView.GenerateIdentityToken:output_type -> pb.GenerateIdentityTokenResponse
	50, // 97: pb.SystemView.RegisterRotationJob:output_type -> pb.RegisterRotationJobResponse
	0,  // 98: pb.SystemView.DeregisterRotationJob:output_type -> pb.Empty
	0,  // 99: pb.Events.SendEvent:output_type -> pb.Empty
