...
type APILockShouldBlockRequestReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *APILockShouldBlockRequestReply) Reset() {
	*x = APILockShouldBlockRequestReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *APILockShouldBlockRequestReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*APILockShouldBlockRequestReply) ProtoMessage() {}

func (x *APILockShouldBlockRequestReply) ProtoReflect() protoreflect.Message {
	mi := &file_sdk_plugin_pb_backend_proto_msgTypes[47]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use APILockShouldBlockRequestReply.ProtoReflect.Descriptor instead.
func (*APILockShouldBlockRequestReply) Descriptor() ([]byte, []int) {
	return file_sdk_plugin_pb_backend_proto_rawDescGZIP(), []int{47}
}

func (x *APILockShouldBlockRequestReply) GetShouldBlock() bool {
	if x != nil {
...
var file_sdk_plugin_pb_backend_proto_rawDesc = []byte{
	...
	0x72, 0x22, 0x43, 0x0a, 0x1e, 0x41, 0x50, 0x49, 0x4c, 0x6f, 0x63, 0x6b, 0x53, 0x68, 0x6f, 0x75,
	0x6c, 0x64, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x65,
	0x70, 0x6c, 0x79, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x68, 0x6f, 0x75, 0x6c, 0x64, 0x5f, 0x62, 0x6c,
	0x6f, 0x63, 0x6b, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x73, 0x68, 0x6f, 0x75, 0x6c,
	0x64, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x22, 0x8e, 0x01, 0x0a, 0x0a, 0x43, 0x6f, 0x6e, 0x6e, 0x65,
	...
	0x74, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x32, 0xad, 0x06, 0x0a, 0x0a, 0x53, 0x79, 0x73, 0x74,
	...
	0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x4a, 0x0a, 0x19, 0x41,
	0x50, 0x49, 0x4c, 0x6f, 0x63, 0x6b, 0x53, 0x68, 0x6f, 0x75, 0x6c, 0x64, 0x42, 0x6c, 0x6f, 0x63,
	0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x09, 0x2e, 0x70, 0x62, 0x2e, 0x45, 0x6d,
	0x70, 0x74, 0x79, 0x1a, 0x22, 0x2e, 0x70, 0x62, 0x2e, 0x41, 0x50, 0x49, 0x4c, 0x6f, 0x63, 0x6b,
	0x53, 0x68, 0x6f, 0x75, 0x6c, 0x64, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x32, 0x36, 0x0a, 0x06, 0x45, 0x76, 0x65, 0x6e, 0x74,
...
var file_sdk_plugin_pb_backend_proto_msgTypes = make([]protoimpl.MessageInfo, 59)
var file_sdk_plugin_pb_backend_proto_goTypes = []interface{}{
	...
	(*APILockShouldBlockRequestReply)(nil),    // 47: pb.APILockShouldBlockRequestReply
	...
	(*SendEventRequest)(nil),                  // 52: pb.SendEventRequest
	nil,                                       // 53: pb.Request.HeadersEntry
	nil,                                       // 54: pb.Auth.MetadataEntry
	nil,                                       // 55: pb.TokenEntry.MetaEntry
	nil,                                       // 56: pb.TokenEntry.InternalMetaEntry
	nil,                                       // 57: pb.Response.HeadersEntry
	nil,                                       // 58: pb.SetupArgs.ConfigEntry
	(*logical.Alias)(nil),                     // 59: logical.Alias
	(*timestamppb.Timestamp)(nil),             // 60: google.protobuf.Timestamp
	(*logical.Entity)(nil),                    // 61: logical.Entity
	(*logical.Group)(nil),                     // 62: logical.Group
	(*logical.PluginEnvironment)(nil),         // 63: logical.PluginEnvironment
	(*logical.EventData)(nil),                 // 64: logical.EventData
}
var file_sdk_plugin_pb_backend_proto_depIDxs = []int32{
	...
	53, // 2: pb.Request.headers:type_name -> pb.Request.HeadersEntry
	...
	54, // 6: pb.Auth.metadata:type_name -> pb.Auth.MetadataEntry
	59, // 7: pb.Auth.alias:type_name -> logical.Alias
	59, // 8: pb.Auth.group_aliases:type_name -> logical.Alias
	55, // 9: pb.TokenEntry.meta:type_name -> pb.TokenEntry.MetaEntry
	56, // 10: pb.TokenEntry.internal_meta:type_name -> pb.TokenEntry.InternalMetaEntry
	60, // 11: pb.LeaseOptions.issue_time:type_name -> google.protobuf.Timestamp
	...
	57, // 16: pb.Response.headers:type_name -> pb.Response.HeadersEntry
	60, // 17: pb.ResponseWrapInfo.creation_time:type_name -> google.protobuf.Timestamp
	...
	58, // 25: pb.SetupArgs.Config:type_name -> pb.SetupArgs.ConfigEntry
	...
	61, // 29: pb.EntityInfoReply.entity:type_name -> logical.Entity
	62, // 30: pb.GroupsForEntityReply.groups:type_name -> logical.Group
	63, // 31: pb.PluginEnvReply.plugin_environment:type_name -> logical.PluginEnvironment
	...
	64, // 36: pb.SendEventRequest.event:type_name -> logical.EventData
	...
	0,  // 64: pb.SystemView.APILockShouldBlockRequest:input_type -> pb.Empty
	52, // 65: pb.Events.SendEvent:input_type -> pb.SendEventRequest
	...
	47, // 91: pb.SystemView.APILockShouldBlockRequest:output_type -> pb.APILockShouldBlockRequestReply
...
func file_sdk_plugin_pb_backend_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sdk_plugin_pb_backend_proto_msgTypes[47].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*APILockShouldBlockRequestReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
