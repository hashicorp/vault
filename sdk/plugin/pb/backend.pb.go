...
type HasFeatureRequest struct {
	...
	Feature uint32 `protobuf:"varint,1,opt,name=feature,proto3" json:"feature,omitempty"`
}
...
func (x *HasFeatureRequest) GetFeature() uint32 {
	if x != nil {
		return x.Feature
	}
	return 0
...
func (x *HasFeatureReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HasFeatureReply) ProtoMessage() {}

func (x *HasFeatureReply) ProtoReflect() protoreflect.Message {
	mi := &file_sdk_plugin_pb_backend_proto_msgTypes[50]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HasFeatureReply.ProtoReflect.Descriptor instead.
func (*HasFeatureReply) Descriptor() ([]byte, []int) {
	return file_sdk_plugin_pb_backend_proto_rawDescGZIP(), []int{50}
}

func (x *HasFeatureReply) GetHasFeature() bool {
	if x != nil {
		return x.HasFeature
	}
	return false
...
func (x *LicenseStateReply) Reset() {
	*x = LicenseStateReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *LicenseStateReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LicenseStateReply) ProtoMessage() {}

func (x *LicenseStateReply) ProtoReflect() protoreflect.Message {
	mi := &file_sdk_plugin_pb_backend_proto_msgTypes[51]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LicenseStateReply.ProtoReflect.Descriptor instead.
func (*LicenseStateReply) Descriptor() ([]byte, []int) {
	return file_sdk_plugin_pb_backend_proto_rawDescGZIP(), []int{51}
}

func (x *LicenseStateReply) GetState() string {
	if x != nil {
		return x.State
	}
	return ""
...
func (x *LicenseStateReply) GetExpiryTime() *timestamppb.Timestamp {
	if x != nil {
		return x.ExpiryTime
	}
	return nil
...
func (x *LicenseStateReply) GetTerminated() bool {
	if x != nil {
		return x.Terminated
	}
	return false
...
var file_sdk_plugin_pb_backend_proto_rawDesc = []byte{
	...
	,
	...
	0x79, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x74, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x61,
	0x74, 0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x74, 0x65, 0x72, 0x6d, 0x69,
	0x6e, 0x61, 0x74, 0x65, 0x64, 0x22, 0x8e, 0x01, 0x0a, 0x0a, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63,
	...
	0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x73, 0x22, 0x5b, 0x0a, 0x10, 0x53, 0x65, 0x6e,
	...
	0x09, 0x52, 0x09, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x28, 0x0a, 0x05,
	0x65, 0x76, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6c, 0x6f,
	0x67, 0x69, 0x63, 0x61, 0x6c, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x44, 0x61, 0x74, 0x61, 0x52,
	0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x32, 0xa5, 0x03, 0x0a, 0x07, 0x42, 0x61, 0x63, 0x6b, 0x65,
	...
	0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x32, 0xab, 0x07, 0x0a, 0x0a, 0x53, 0x79, 0x73, 0x74, 0x65,
	...
	,
...
var file_sdk_plugin_pb_backend_proto_goTypes = []any{
	...
	(*HasFeatureRequest)(nil),                 // 49: pb.HasFeatureRequest
	(*HasFeatureReply)(nil),                   // 50: pb.HasFeatureReply
	(*LicenseStateReply)(nil),                 // 51: pb.LicenseStateReply
	...
	(*logical.EventData)(nil),                 // 68: logical.EventData
}
var file_sdk_plugin_pb_backend_proto_depIDxs = []int32{
	...
	64, // 32: pb.LicenseStateReply.expiry_time:type_name -> google.protobuf.Timestamp
	53, // 33: pb.Connection.connection_state:type_name -> pb.ConnectionState
	55, // 34: pb.ConnectionState.peer_certificates:type_name -> pb.CertificateChain
	55, // 35: pb.ConnectionState.verified_chains:type_name -> pb.CertificateChain
	54, // 36: pb.CertificateChain.certificates:type_name -> pb.Certificate
	68, // 37: pb.SendEventRequest.event:type_name -> logical.EventData
	1,  // 38: pb.Request.HeadersEntry.value:type_name -> pb.Header
	1,  // 39: pb.Response.HeadersEntry.value:type_name -> pb.Header
	12, // 40: pb.Backend.HandleRequest:input_type -> pb.HandleRequestArgs
	0,  // 41: pb.Backend.SpecialPaths:input_type -> pb.Empty
	17, // 42: pb.Backend.HandleExistenceCheck:input_type -> pb.HandleExistenceCheckArgs
	0,  // 43: pb.Backend.Cleanup:input_type -> pb.Empty
	22, // 44: pb.Backend.InvalidateKey:input_type -> pb.InvalidateKeyArgs
	19, // 45: pb.Backend.Setup:input_type -> pb.SetupArgs
	14, // 46: pb.Backend.Initialize:input_type -> pb.InitializeArgs
	0,  // 47: pb.Backend.Type:input_type -> pb.Empty
	24, // 48: pb.Storage.List:input_type -> pb.StorageListArgs
	26, // 49: pb.Storage.Get:input_type -> pb.StorageGetArgs
	28, // 50: pb.Storage.Put:input_type -> pb.StoragePutArgs
	30, // 51: pb.Storage.Delete:input_type -> pb.StorageDeleteArgs
	0,  // 52: pb.SystemView.DefaultLeaseTTL:input_type -> pb.Empty
	0,  // 53: pb.SystemView.MaxLeaseTTL:input_type -> pb.Empty
	0,  // 54: pb.SystemView.Tainted:input_type -> pb.Empty
	0,  // 55: pb.SystemView.CachingDisabled:input_type -> pb.Empty
	0,  // 56: pb.SystemView.ReplicationState:input_type -> pb.Empty
	36, // 57: pb.SystemView.ResponseWrapData:input_type -> pb.ResponseWrapDataArgs
	0,  // 58: pb.SystemView.MlockEnabled:input_type -> pb.Empty
	0,  // 59: pb.SystemView.LocalMount:input_type -> pb.Empty
	40, // 60: pb.SystemView.EntityInfo:input_type -> pb.EntityInfoArgs
	0,  // 61: pb.SystemView.PluginEnv:input_type -> pb.Empty
	40, // 62: pb.SystemView.GroupsForEntity:input_type -> pb.EntityInfoArgs
	44, // 63: pb.SystemView.GeneratePasswordFromPolicy:input_type -> pb.GeneratePasswordFromPolicyRequest
	0,  // 64: pb.SystemView.ClusterInfo:input_type -> pb.Empty
	47, // 65: pb.SystemView.GenerateIdentityToken:input_type -> pb.GenerateIdentityTokenRequest
	49, // 66: pb.SystemView.HasFeature:input_type -> pb.HasFeatureRequest
	0,  // 67: pb.SystemView.LicenseState:input_type -> pb.Empty
	...
	50, // 95: pb.SystemView.HasFeature:output_type -> pb.HasFeatureReply
	51, // 96: pb.SystemView.LicenseState:output_type -> pb.LicenseStateReply
	0,  // 97: pb.Events.SendEvent:output_type -> pb.Empty
...
func file_sdk_plugin_pb_backend_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sdk_plugin_pb_backend_proto_msgTypes[49].Exporter = func(v any, i int) any {
			switch v := v.(*HasFeatureRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_sdk_plugin_pb_backend_proto_msgTypes[51].Exporter = func(v any, i int) any {
			switch v := v.(*LicenseStateReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
