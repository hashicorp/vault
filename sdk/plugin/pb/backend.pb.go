...
type HasLicenseReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	HasLicense bool   `protobuf:"varint,1,opt,name=has_license,json=hasLicense,proto3" json:"has_license,omitempty"`
	Err        string `protobuf:"bytes,2,opt,name=err,proto3" json:"err,omitempty"`
}

func (x *HasLicenseReply) Reset() {
	*x = HasLicenseReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *HasLicenseReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HasLicenseReply) ProtoMessage() {}

func (x *HasLicenseReply) ProtoReflect() protoreflect.Message {
	mi := &file_sdk_plugin_pb_backend_proto_msgTypes[49]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HasLicenseReply.ProtoReflect.Descriptor instead.
func (*HasLicenseReply) Descriptor() ([]byte, []int) {
	return file_sdk_plugin_pb_backend_proto_rawDescGZIP(), []int{49}
}

func (x *HasLicenseReply) GetHasLicense() bool {
	if x != nil {
		return x.HasLicense
	}
	return false
...
func (x *HasLicenseReply) GetErr() string {
	if x != nil {
		return x.Err
	}
	return ""
...
var file_sdk_plugin_pb_backend_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x74, 0x74, 0x6c, 0x22, 0x44, 0x0a, 0x0f, 0x48, 0x61, 0x73,
	0x4c, 0x69, 0x63, 0x65, 0x6e, 0x73, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x1f, 0x0a, 0x0b,
	0x68, 0x61, 0x73, 0x5f, 0x6c, 0x69, 0x63, 0x65, 0x6e, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x0a, 0x68, 0x61, 0x73, 0x4c, 0x69, 0x63, 0x65, 0x6e, 0x73, 0x65, 0x12, 0x10, 0x0a,
	0x03, 0x65, 0x72, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x65, 0x72, 0x72, 0x22,
	...
	0x32, 0xed, 0x06, 0x0a, 0x0a, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x56, 0x69, 0x65, 0x77, 0x12,
	...
	0x73, 0x65, 0x12, 0x2c, 0x0a, 0x0a, 0x48, 0x61, 0x73, 0x4c, 0x69, 0x63, 0x65, 0x6e, 0x73, 0x65,
	0x12, 0x09, 0x2e, 0x70, 0x62, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x13, 0x2e, 0x70, 0x62,
	0x2e, 0x48, 0x61, 0x73, 0x4c, 0x69, 0x63, 0x65, 0x6e, 0x73, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79,
	...
	0x70, 0x62, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x2a, 0x5a, 0x28, 0x67, 0x69, 0x74, 0x68,
...
var file_sdk_plugin_pb_backend_proto_goTypes = []any{
	...
	(*HasLicenseReply)(nil),                   // 49: pb.HasLicenseReply
	...
	(*logical.EventData)(nil),                 // 66: logical.EventData
}
var file_sdk_plugin_pb_backend_proto_depIDxs = []int32{
	...
	51, // 32: pb.Connection.connection_state:type_name -> pb.ConnectionState
	53, // 33: pb.ConnectionState.peer_certificates:type_name -> pb.CertificateChain
	53, // 34: pb.ConnectionState.verified_chains:type_name -> pb.CertificateChain
	52, // 35: pb.CertificateChain.certificates:type_name -> pb.Certificate
	66, // 36: pb.SendEventRequest.event:type_name -> logical.EventData
	...
	0,  // 65: pb.SystemView.HasLicense:input_type -> pb.Empty
	54, // 66: pb.Events.SendEvent:input_type -> pb.SendEventRequest
	13, // 67: pb.Backend.HandleRequest:output_type -> pb.HandleRequestReply
	16, // 68: pb.Backend.SpecialPaths:output_type -> pb.SpecialPathsReply
	18, // 69: pb.Backend.HandleExistenceCheck:output_type -> pb.HandleExistenceCheckReply
	0,  // 70: pb.Backend.Cleanup:output_type -> pb.Empty
	0,  // 71: pb.Backend.InvalidateKey:output_type -> pb.Empty
	20, // 72: pb.Backend.Setup:output_type -> pb.SetupReply
	15, // 73: pb.Backend.Initialize:output_type -> pb.InitializeReply
	21, // 74: pb.Backend.Type:output_type -> pb.TypeReply
	25, // 75: pb.Storage.List:output_type -> pb.StorageListReply
	27, // 76: pb.Storage.Get:output_type -> pb.StorageGetReply
	29, // 77: pb.Storage.Put:output_type -> pb.StoragePutReply
	31, // 78: pb.Storage.Delete:output_type -> pb.StorageDeleteReply
	32, // 79: pb.SystemView.DefaultLeaseTTL:output_type -> pb.TTLReply
	32, // 80: pb.SystemView.MaxLeaseTTL:output_type -> pb.TTLReply
	33, // 81: pb.SystemView.Tainted:output_type -> pb.TaintedReply
	34, // 82: pb.SystemView.CachingDisabled:output_type -> pb.CachingDisabledReply
	35, // 83: pb.SystemView.ReplicationState:output_type -> pb.ReplicationStateReply
	37, // 84: pb.SystemView.ResponseWrapData:output_type -> pb.ResponseWrapDataReply
	38, // 85: pb.SystemView.MlockEnabled:output_type -> pb.MlockEnabledReply
	39, // 86: pb.SystemView.LocalMount:output_type -> pb.LocalMountReply
	41, // 87: pb.SystemView.EntityInfo:output_type -> pb.EntityInfoReply
	43, // 88: pb.SystemView.PluginEnv:output_type -> pb.PluginEnvReply
	42, // 89: pb.SystemView.GroupsForEntity:output_type -> pb.GroupsForEntityReply
	45, // 90: pb.SystemView.GeneratePasswordFromPolicy:output_type -> pb.GeneratePasswordFromPolicyReply
	46, // 91: pb.SystemView.ClusterInfo:output_type -> pb.ClusterInfoReply
	48, // 92: pb.SystemView.GenerateIdentityToken:output_type -> pb.GenerateIdentityTokenResponse
	49, // 93: pb.SystemView.HasLicense:output_type -> pb.HasLicenseReply
