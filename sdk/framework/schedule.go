...
func (rs *RootSchedule) NextRotationTimeFromInput(next *RootSchedule, input time.Time) time.Time {
...
func (rs *RootSchedule) IsInsideRotationWindow(t time.Time) bool {
...
func (rs *RootSchedule) ShouldRotate(rotation *RootSchedule, priority int64, t time.Time) bool {
	return priority <= t.Unix() && rs.IsInsideRotationWindow(t)
}
