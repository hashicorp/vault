...
package dbplugin // import "github.com/hashicorp/vault/sdk/database/dbplugin"
...
func (*InitializeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_171d00549ac75f74, []int{0}
}
...
func (*InitRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_171d00549ac75f74, []int{1}
}
...
func (*CreateUserRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_171d00549ac75f74, []int{2}
}
...
func (*RenewUserRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_171d00549ac75f74, []int{3}
}
...
func (*RevokeUserRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_171d00549ac75f74, []int{4}
}
...
func (*RotateRootCredentialsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_171d00549ac75f74, []int{5}
}
...
func (*Statements) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_171d00549ac75f74, []int{6}
}
...
func (*UsernameConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_171d00549ac75f74, []int{7}
}
...
func (*InitResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_171d00549ac75f74, []int{8}
}
...
func (*CreateUserResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_171d00549ac75f74, []int{9}
}
...
func (*TypeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_171d00549ac75f74, []int{10}
}
...
func (*RotateRootCredentialsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_171d00549ac75f74, []int{11}
}
...
func (*Empty) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_171d00549ac75f74, []int{12}
}
...
func (*GenerateCredentialsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_171d00549ac75f74, []int{13}
}
...
func (dst *GenerateCredentialsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GenerateCredentialsResponse.Merge(dst, src)
}
...
func (*StaticUserConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_171d00549ac75f74, []int{14}
}
...
func (dst *StaticUserConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StaticUserConfig.Merge(dst, src)
}
...
func (*SetCredentialsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_171d00549ac75f74, []int{15}
}
...
func (dst *SetCredentialsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetCredentialsRequest.Merge(dst, src)
}
...
func (*SetCredentialsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_database_171d00549ac75f74, []int{16}
}
...
func (dst *SetCredentialsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetCredentialsResponse.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("sdk/database/dbplugin/database.proto", fileDescriptor_database_171d00549ac75f74)
}

var fileDescriptor_database_171d00549ac75f74 = []byte{
