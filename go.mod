...
require (
	...
	github.com/hashicorp/vault-plugin-secrets-gcpkms v0.21.1-0.20250801001812-4333226b09e6
...
require (
	...
	google.golang.org/genproto/googleapis/rpc v0.0.0-20250728155136-f173205681a0 // indirect; indirect\
