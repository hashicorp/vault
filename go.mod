...
require (
	...
	github.com/hashicorp/vault-plugin-database-redis-elasticache v0.5.1-0.20250212220841-4e82a461c913
...
require (
	...
	google.golang.org/genproto/googleapis/rpc v0.0.0-20250124145028-65684f501c47 // indirect; indirect\
