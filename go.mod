...
require (
	...
	github.com/hashicorp/vault-plugin-secrets-kubernetes v0.8.1-0.20240807180744-be7adfe88b64
	...
	github.com/hashicorp/vault/sdk v0.13.1-0.20240807180412-69ae1104f968
