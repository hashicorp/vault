...
require (
	...
	github.com/hashicorp/vault-plugin-database-redis-elasticache v0.9.2-0.20260901010234-7133b97f9cbb
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/elasticache v1.59.0 // indirect
