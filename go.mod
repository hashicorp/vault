...
require (
	...
	github.com/hashicorp/vault-plugin-auth-gcp v0.12.0
	github.com/hashicorp/vault-plugin-auth-jwt v0.12.0
	...
	github.com/hashicorp/vault-plugin-secrets-alicloud v0.11.0
