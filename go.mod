...
require (
	...
	github.com/apple/foundationdb/bindings/go v0.0.0-20241114191626-9427764487ef
	...
	github.com/hashicorp/vault/vault/hcp_link/proto v0.0.0-20241115170530-dc40b23d9a10
