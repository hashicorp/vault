...
require (
	...
	github.com/hashicorp/vault-plugin-auth-jwt v0.16.1-0.20230721191857-a67bee77abf1
	...
	github.com/hashicorp/vault-plugin-secrets-gcp v0.16.1-0.20230721190705-d04080579dca
