...
require (
	...
	github.com/hashicorp/vault-plugin-secrets-gcp v0.23.1-0.20251201004110-4ae9aa29bc64
...
require (
	...
	google.golang.org/genproto/googleapis/rpc v0.0.0-20251103181224-f26f9409b101 // indirect; indirect\
