...
require (
	...
	github.com/hashicorp/vault-plugin-auth-kubernetes v0.19.1-0.20240607224539-f99d87b754b7
	...
	github.com/hashicorp/vault-plugin-secrets-kubernetes v0.8.1-0.20240607225806-24e79b6593c0
