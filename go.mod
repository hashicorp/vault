...
require (
	...
	github.com/hashicorp/vault-plugin-secrets-gcp v0.21.2-0.20250301003159-6a90c14f54a6
...
require (
	...
	google.golang.org/genproto/googleapis/rpc v0.0.0-20250219182151-9fdb1cabc7b2 // indirect; indirect\
