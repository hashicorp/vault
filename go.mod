...
replace github.com/hashicorp/go-kms-wrapping/wrappers/azurekeyvault/v2 => github.com/Xovis/go-kms-wrapping/wrappers/azurekeyvault/v2 v2.0.0-20230324102024-60a01cac746b
