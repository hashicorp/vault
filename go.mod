...
require (
	...
	github.com/hashicorp/vault-plugin-database-mongodbatlas v0.13.1-0.20250209195525-9c1969b18ebd
...
require (
	...
	google.golang.org/genproto/googleapis/rpc v0.0.0-20241209162323-e6fa225c2576 // indirect; indirect\
