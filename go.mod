...
require (
	...
	github.com/hashicorp/vault-plugin-auth-jwt v0.23.1-0.20250428201120-743cf3cd3be6
...
require (
	...
	google.golang.org/genproto/googleapis/rpc v0.0.0-20250414145226-207652e42e2e // indirect; indirect\
