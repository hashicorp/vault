...
require (
	...
	github.com/hashicorp/vault-plugin-database-redis-elasticache v0.9.2-0.20260801005149-32b96cfd26c4
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/elasticache v1.56.3 // indirect
