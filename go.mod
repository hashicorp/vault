...
require (
	...
	github.com/hashicorp/vault-plugin-database-redis-elasticache v0.6.1-0.20250528192446-b8e40a4b78c3
...
require (
	...
	google.golang.org/genproto/googleapis/rpc v0.0.0-20250218202821-56aae31c358a // indirect; indirect\
