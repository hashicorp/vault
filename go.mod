...
require (
	...
	github.com/hashicorp/vault-plugin-database-couchbase v0.15.1-0.20260301005121-dd448be87086
...
require (
	...
	google.golang.org/genproto/googleapis/rpc v0.0.0-20260203192932-546029d2fa20 // indirect; indirect\
