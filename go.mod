...
require (
	...
	github.com/hashicorp/vault-plugin-secrets-gcp v0.21.3-0.20250501003555-d48154f3a053
...
require (
	...
	google.golang.org/genproto/googleapis/rpc v0.0.0-20250425173222-7b384671a197 // indirect; indirect\
