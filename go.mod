...
require (
	...
	github.com/hashicorp/vault-plugin-secrets-openldap v0.16.1-0.20250901000339-af75fb1b9237
...
require (
	...
	github.com/go-ldap/ldif v0.0.0-20250820211448-1f8b40bda3a0 // indirect
