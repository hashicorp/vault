...
func TestLoadConfigFile_AgentAutoAuth_UseExisting_False(t *testing.T) {
	config, err := LoadConfig("./test-fixtures/config-auto_auth-use-existing-false.hcl")
	if err != nil {
		t.Fatalf("err: %s", err)
	}
...
func TestLoadConfigFile_AgentAutoAuth_UseExisting_True(t *testing.T) {
	config, err := LoadConfig("./test-fixtures/config-auto_auth-use-existing-true.hcl")
	if err != nil {
		t.Fatalf("err: %s", err)
	}
