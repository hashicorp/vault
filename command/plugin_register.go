...
func (c *PluginRegisterCommand) Run(args []string) int {
	...
	case c.flagSHA256 == "" && c.flagVersion == "":
		c.UI.Error("One of -sha256 or -version is required. If registering with binary, please provide at least -sha256 (-version optional). If registering with zip artifact, please provide -version only.")
		return 1
