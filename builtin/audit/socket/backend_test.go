...
func TestBackend_formatterConfig(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"invalid-hmac-accessor": {
			...
			want:            audit.FormatterConfig{},
			wantErr:         true,
			expectedMessage: "socket.formatterConfig: unable to parse 'hmac_accessor': strconv.ParseBool: parsing \"maybe\": invalid syntax",
		},
		"invalid-log-raw": {
			config: map[string]string{
				"format":        audit.JSONFormat.String(),
			...
			want:            audit.FormatterConfig{},
			wantErr:         true,
			expectedMessage: "socket.formatterConfig: unable to parse 'log_raw': strconv.ParseBool: parsing \"maybe\": invalid syntax",
		},
		"invalid-elide-bool": {
			config: map[string]string{
				"format":               audit.JSONFormat.String(),
			...
			want:            audit.FormatterConfig{},
			wantErr:         true,
			expectedMessage: "socket.formatterConfig: unable to parse 'elide_list_responses': strconv.ParseBool: parsing \"maybe\": invalid syntax",
		},
	}
