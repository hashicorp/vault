...
when credential_type is %s. This is only required when the IAM user has an MFA device configured.`, sessionTokenCred),
		...
		Operations: map[logical.Operation]framework.OperationHandler{
			logical.DeleteOperation: &framework.PathOperation{
				...
				Summary:  "Delete a named IAM role.",
			...
			logical.ReadOperation: &framework.PathOperation{
				...
				Summary:  "Return the configuration for a named IAM role.",
				Responses: map[int][]framework.Response{
					http.StatusOK: {{
						Description: "OK",
						Fields: map[string]*framework.FieldSchema{
							"credential_type":          {Type: framework.TypeString, Description: "Type of credentials generated by this role."},
							"policy_arns":              {Type: framework.TypeSlice, Description: "ARNs of AWS managed policies attached to the role."},
							"role_arns":                {Type: framework.TypeSlice, Description: "ARNs of AWS roles that can be assumed."},
							"policy_document":          {Type: framework.TypeString, Description: "JSON-encoded inline IAM policy document."},
							"iam_groups":               {Type: framework.TypeSlice, Description: "IAM groups that generated users are added to."},
							"iam_tags":                 {Type: framework.TypeMap, Description: "IAM tags applied to generated users."},
							"session_tags":             {Type: framework.TypeMap, Description: "Session tags applied to assumed-role credentials."},
							"external_id":              {Type: framework.TypeString, Description: "External ID used when assuming a role."},
							"default_sts_ttl":          {Type: framework.TypeDurationSecond, Description: "Default TTL for STS credentials in seconds."},
							"max_sts_ttl":              {Type: framework.TypeDurationSecond, Description: "Maximum allowed TTL for STS credentials in seconds."},
							"user_path":                {Type: framework.TypeString, Description: "Path for generated IAM users."},
							"permissions_boundary_arn": {Type: framework.TypeString, Description: "ARN of the permissions boundary policy attached to generated IAM users."},
							"mfa_serial_number":        {Type: framework.TypeString, Description: "Serial number or ARN of the MFA device."},
						},
					}},
				},
			},
			logical.UpdateOperation: &framework.PathOperation{
				...
				Summary:  "Create or update a named IAM role.",
				Responses: map[int][]framework.Response{
					http.StatusNoContent: {{Description: "No Content"}},
				},
			},
