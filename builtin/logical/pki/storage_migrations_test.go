...
func TestMigration_OnceChainRebuild(t *testing.T) {
	...
	intIssuer, err := fetchIssuerById(ctx, s, intIssuerId)
	require.NoError(t, err)
	...
	rootIssuer, err := fetchIssuerById(ctx, s, rootIssuerId)
	require.NoError(t, err)
