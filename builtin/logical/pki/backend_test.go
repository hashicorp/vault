...
func TestProperAuthing(t *testing.T) {
	...
	paths := map[string]pathAuthChecker{
		...
		"acme/directory":                           shouldBeUnauthedReadList,
		"roles/test/acme/directory":                shouldBeUnauthedReadList,
		"issuer/default/acme/directory":            shouldBeUnauthedReadList,
		"issuer/default/roles/test/acme/directory": shouldBeUnauthedReadList,
	}
