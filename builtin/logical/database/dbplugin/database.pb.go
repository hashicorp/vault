...
It has these top-level messages:
	...
	CreateUserRequest
	RenewUserRequest
	RollUserCredentialRequest
	RevokeUserRequest
	Statements
	UsernameConfig
	CreateUserResponse
	RollUserCredentialResponse
	TypeResponse
	Empty
*/
package dbplugin
...
type RollUserCredentialRequest struct {
	Statements *Statements `protobuf:"bytes,1,opt,name=statements" json:"statements,omitempty"`
	Username   string      `protobuf:"bytes,2,opt,name=username" json:"username,omitempty"`
}

func (m *RollUserCredentialRequest) Reset()                    { *m = RollUserCredentialRequest{} }
func (m *RollUserCredentialRequest) String() string            { return proto.CompactTextString(m) }
func (*RollUserCredentialRequest) ProtoMessage()               {}
func (*RollUserCredentialRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }

func (m *RollUserCredentialRequest) GetStatements() *Statements {
	if m != nil {
		return m.Statements
	}
	return nil
...
func (m *RollUserCredentialRequest) GetUsername() string {
	if m != nil {
		return m.Username
	}
	return ""
...
type Statements struct {
	...
	RollCredentialStatements string `protobuf:"bytes,5,opt,name=roll_credential_statements,json=rollCredentialStatements" json:"roll_credential_statements,omitempty"`
}
...
func (m *Statements) GetRollCredentialStatements() string {
	if m != nil {
		return m.RollCredentialStatements
	}
	return ""
}
...
type RollUserCredentialResponse struct {
	Password string `protobuf:"bytes,1,opt,name=password" json:"password,omitempty"`
}

func (m *RollUserCredentialResponse) Reset()                    { *m = RollUserCredentialResponse{} }
func (m *RollUserCredentialResponse) String() string            { return proto.CompactTextString(m) }
func (*RollUserCredentialResponse) ProtoMessage()               {}
func (*RollUserCredentialResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }

func (m *RollUserCredentialResponse) GetPassword() string {
	if m != nil {
		return m.Password
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*RollUserCredentialRequest)(nil), "dbplugin.RollUserCredentialRequest")
	...
	proto.RegisterType((*RollUserCredentialResponse)(nil), "dbplugin.RollUserCredentialResponse")
...
type DatabaseClient interface {
	...
	RollUserCredential(ctx context.Context, in *RollUserCredentialRequest, opts ...grpc.CallOption) (*RollUserCredentialResponse, error)
...
func (c *databaseClient) RollUserCredential(ctx context.Context, in *RollUserCredentialRequest, opts ...grpc.CallOption) (*RollUserCredentialResponse, error) {
	out := new(RollUserCredentialResponse)
	err := grpc.Invoke(ctx, "/dbplugin.Database/RollUserCredential", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DatabaseServer interface {
	...
	RollUserCredential(context.Context, *RollUserCredentialRequest) (*RollUserCredentialResponse, error)
...
func _Database_RollUserCredential_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RollUserCredentialRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DatabaseServer).RollUserCredential(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dbplugin.Database/RollUserCredential",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DatabaseServer).RollUserCredential(ctx, req.(*RollUserCredentialRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Database_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RollUserCredential",
			Handler:    _Database_RollUserCredential_Handler,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
