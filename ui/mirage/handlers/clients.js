...
const ACTIVITY_RESPONSE = {
  request_id: '857d32d9-b481-2705-79fb-44854daf2f4d',
  lease_id: '',
  renewable: false,
  lease_duration: 0,
  data: {
    by_namespace: [
      {
        ...
        mounts: [
          ...
          {
            mount_path: 'deleted mount; accessor "auth_jwt_4d15da5e"',
            counts: {
              distinct_entities: 1,
              entity_clients: 1,
              non_entity_tokens: 0,
      ...
      {
        namespace_id: 'n1M2M',
        namespace_path: 'deleted namespace "n1M2M"',
        counts: {
          distinct_entities: 2,
          entity_clients: 2,
          non_entity_tokens: 0,
        ...
        mounts: [
          {
            mount_path: 'deleted mount; accessor "auth_userpass_0edc9866"',
            counts: {
              distinct_entities: 1,
              entity_clients: 1,
              non_entity_tokens: 0,
          ...
          {
            mount_path: 'deleted mount; accessor "auth_ns_token_1013df14"',
            counts: {
              distinct_entities: 1,
              entity_clients: 1,
              non_entity_tokens: 0,
      ...
      {
        namespace_id: 'T374O',
        namespace_path: 'deleted namespace "T374O"',
        counts: {
          distinct_entities: 1,
          entity_clients: 1,
          non_entity_tokens: 0,
        ...
        mounts: [
          {
            mount_path: 'deleted mount; accessor "auth_userpass_f8922c54"',
            counts: {
              distinct_entities: 1,
              entity_clients: 1,
              non_entity_tokens: 0,
