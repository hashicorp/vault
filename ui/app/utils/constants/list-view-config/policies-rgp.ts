...
export const policiesRgpListViewConfig: ListViewDisplayConfig = {
  title: 'RGP policies',
  badge: 'Sentinel',
  description:
  ...
  noDataDescription: 'A list of policies will be listed here. Create your first RGP policy to get started.',
  filteredEmptyTitle: 'No results for',
};

export default policiesRgpListViewConfig;
