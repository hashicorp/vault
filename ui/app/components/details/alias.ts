...
import type { Entity } from 'vault/vault/identity';
...
export default class DetailsAliasComponent extends Component<Args> {
  ...
  get aliases() {
    return this.args.entity?.aliases ?? [];
  }
  ...
  syncAliasIndex() {
    ...
    const selectedAliasId = this.args.aliasId;
    if (selectedAliasId) {
