...
export default class TransitKeyActionsTwo extends Component {
  ...
  setExportKeyDefaults() {
    this.exportKeyType = this.args.key.exportKeyTypes.firstObject;
    this.exportKeyVersion = this.args.key.validKeyVersions.lastObject;
  }
  ...
  handleSuccess(resp, options, action) {
    ...
    if (!this.isDestroyed && !this.isDestroying) {
      ...
      this.key_version = props.key_version;
    }
    if (action === 'rotate') {
      this.onRefresh();
    }
