 ...
 * @export
 */
export const PkiIssuerSignVerbatimRequestFormatEnum = {
    Pem: 'pem',
    Der: 'der',
    PemBundle: 'pem_bundle'
} as const;
export type PkiIssuerSignVerbatimRequestFormatEnum = typeof PkiIssuerSignVerbatimRequestFormatEnum[keyof typeof PkiIssuerSignVerbatimRequestFormatEnum];

/**
 * @export
 */
export const PkiIssuerSignVerbatimRequestPrivateKeyFormatEnum = {
    Empty: '',
    Der: 'der',
    Pem: 'pem',
    Pkcs8: 'pkcs8'
} as const;
export type PkiIssuerSignVerbatimRequestPrivateKeyFormatEnum = typeof PkiIssuerSignVerbatimRequestPrivateKeyFormatEnum[keyof typeof PkiIssuerSignVerbatimRequestPrivateKeyFormatEnum];
