 ...
 * @export
 */
export const PkiIssuerSignWithRoleRequestFormatEnum = {
    Pem: 'pem',
    Der: 'der',
    PemBundle: 'pem_bundle'
} as const;
export type PkiIssuerSignWithRoleRequestFormatEnum = typeof PkiIssuerSignWithRoleRequestFormatEnum[keyof typeof PkiIssuerSignWithRoleRequestFormatEnum];

/**
 * @export
 */
export const PkiIssuerSignWithRoleRequestPrivateKeyFormatEnum = {
    Empty: '',
    Der: 'der',
    Pem: 'pem',
    Pkcs8: 'pkcs8'
} as const;
export type PkiIssuerSignWithRoleRequestPrivateKeyFormatEnum = typeof PkiIssuerSignWithRoleRequestPrivateKeyFormatEnum[keyof typeof PkiIssuerSignWithRoleRequestPrivateKeyFormatEnum];
