 ...
 * 
 * @export
 * @interface PkiIssuerSignVerbatimWithRoleRequest
 */
export interface PkiIssuerSignVerbatimWithRoleRequest {
     ...
     * @memberof PkiIssuerSignVerbatimWithRoleRequest
     */
    format?: PkiIssuerSignVerbatimWithRoleRequestFormatEnum;
    /**
 ...
 * @export
 */
export const PkiIssuerSignVerbatimWithRoleRequestFormatEnum = {
    Pem: 'pem',
    Der: 'der',
    PemBundle: 'pem_bundle'
} as const;
export type PkiIssuerSignVerbatimWithRoleRequestFormatEnum = typeof PkiIssuerSignVerbatimWithRoleRequestFormatEnum[keyof typeof PkiIssuerSignVerbatimWithRoleRequestFormatEnum];

/**
 * @export
 */
export const PkiIssuerSignVerbatimWithRoleRequestPrivateKeyFormatEnum = {
    Empty: '',
    Der: 'der',
    Pem: 'pem',
    Pkcs8: 'pkcs8'
} as const;
export type PkiIssuerSignVerbatimWithRoleRequestPrivateKeyFormatEnum = typeof PkiIssuerSignVerbatimWithRoleRequestPrivateKeyFormatEnum[keyof typeof PkiIssuerSignVerbatimWithRoleRequestPrivateKeyFormatEnum];


/**
 * Check if a given object implements the PkiIssuerSignVerbatimWithRoleRequest interface.
 */
export function instanceOfPkiIssuerSignVerbatimWithRoleRequest(value: object): value is PkiIssuerSignVerbatimWithRoleRequest {
    return true;
}

export function PkiIssuerSignVerbatimWithRoleRequestFromJSON(json: any): PkiIssuerSignVerbatimWithRoleRequest {
    return PkiIssuerSignVerbatimWithRoleRequestFromJSONTyped(json, false);
}

export function PkiIssuerSignVerbatimWithRoleRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PkiIssuerSignVerbatimWithRoleRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiIssuerSignVerbatimWithRoleRequestToJSON(json: any): PkiIssuerSignVerbatimWithRoleRequest {
    return PkiIssuerSignVerbatimWithRoleRequestToJSONTyped(json, false);
}

export function PkiIssuerSignVerbatimWithRoleRequestToJSONTyped(value?: PkiIssuerSignVerbatimWithRoleRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
