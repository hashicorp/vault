 ...
 * @export
 */
export const PkiRootSignIntermediateRequestFormatEnum = {
    Pem: 'pem',
    Der: 'der',
    PemBundle: 'pem_bundle'
} as const;
export type PkiRootSignIntermediateRequestFormatEnum = typeof PkiRootSignIntermediateRequestFormatEnum[keyof typeof PkiRootSignIntermediateRequestFormatEnum];

/**
 * @export
 */
export const PkiRootSignIntermediateRequestPrivateKeyFormatEnum = {
    Empty: '',
    Der: 'der',
    Pem: 'pem',
    Pkcs8: 'pkcs8'
} as const;
export type PkiRootSignIntermediateRequestPrivateKeyFormatEnum = typeof PkiRootSignIntermediateRequestPrivateKeyFormatEnum[keyof typeof PkiRootSignIntermediateRequestPrivateKeyFormatEnum];
