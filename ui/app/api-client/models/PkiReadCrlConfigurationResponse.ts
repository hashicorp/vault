 ...
 */
export function instanceOfPkiReadCrlConfigurationResponse(value: object): value is PkiReadCrlConfigurationResponse {
    return true;
}

export function PkiReadCrlConfigurationResponseFromJSON(json: any): PkiReadCrlConfigurationResponse {
    return PkiReadCrlConfigurationResponseFromJSONTyped(json, false);
}

export function PkiReadCrlConfigurationResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PkiReadCrlConfigurationResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiReadCrlConfigurationResponseToJSON(json: any): PkiReadCrlConfigurationResponse {
    return PkiReadCrlConfigurationResponseToJSONTyped(json, false);
}

export function PkiReadCrlConfigurationResponseToJSONTyped(value?: PkiReadCrlConfigurationResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
