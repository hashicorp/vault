 ...
 * @export
 */
export const PkiGenerateRootRequestFormatEnum = {
    Pem: 'pem',
    Der: 'der',
    PemBundle: 'pem_bundle'
} as const;
export type PkiGenerateRootRequestFormatEnum = typeof PkiGenerateRootRequestFormatEnum[keyof typeof PkiGenerateRootRequestFormatEnum];

/**
 * @export
 */
export const PkiGenerateRootRequestKeyTypeEnum = {
    Rsa: 'rsa',
    Ec: 'ec',
    Ed25519: 'ed25519'
} as const;
export type PkiGenerateRootRequestKeyTypeEnum = typeof PkiGenerateRootRequestKeyTypeEnum[keyof typeof PkiGenerateRootRequestKeyTypeEnum];

/**
 * @export
 */
export const PkiGenerateRootRequestPrivateKeyFormatEnum = {
    Empty: '',
    Der: 'der',
    Pem: 'pem',
    Pkcs8: 'pkcs8'
} as const;
export type PkiGenerateRootRequestPrivateKeyFormatEnum = typeof PkiGenerateRootRequestPrivateKeyFormatEnum[keyof typeof PkiGenerateRootRequestPrivateKeyFormatEnum];
