 ...
 * @export
 */
export const PkiIssueWithRoleRequestFormatEnum = {
    Pem: 'pem',
    Der: 'der',
    PemBundle: 'pem_bundle'
} as const;
export type PkiIssueWithRoleRequestFormatEnum = typeof PkiIssueWithRoleRequestFormatEnum[keyof typeof PkiIssueWithRoleRequestFormatEnum];

/**
 * @export
 */
export const PkiIssueWithRoleRequestPrivateKeyFormatEnum = {
    Empty: '',
    Der: 'der',
    Pem: 'pem',
    Pkcs8: 'pkcs8'
} as const;
export type PkiIssueWithRoleRequestPrivateKeyFormatEnum = typeof PkiIssueWithRoleRequestPrivateKeyFormatEnum[keyof typeof PkiIssueWithRoleRequestPrivateKeyFormatEnum];
