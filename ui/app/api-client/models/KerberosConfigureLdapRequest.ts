 ...
 * @export
 */
export const KerberosConfigureLdapRequestDereferenceAliasesEnum = {
    Never: 'never',
    Finding: 'finding',
    Searching: 'searching',
    Always: 'always'
} as const;
export type KerberosConfigureLdapRequestDereferenceAliasesEnum = typeof KerberosConfigureLdapRequestDereferenceAliasesEnum[keyof typeof KerberosConfigureLdapRequestDereferenceAliasesEnum];

/**
 * @export
 */
export const KerberosConfigureLdapRequestTlsMaxVersionEnum = {
    Tls10: 'tls10',
    Tls11: 'tls11',
    Tls12: 'tls12',
    Tls13: 'tls13'
} as const;
export type KerberosConfigureLdapRequestTlsMaxVersionEnum = typeof KerberosConfigureLdapRequestTlsMaxVersionEnum[keyof typeof KerberosConfigureLdapRequestTlsMaxVersionEnum];

/**
 * @export
 */
export const KerberosConfigureLdapRequestTlsMinVersionEnum = {
    Tls10: 'tls10',
    Tls11: 'tls11',
    Tls12: 'tls12',
    Tls13: 'tls13'
} as const;
export type KerberosConfigureLdapRequestTlsMinVersionEnum = typeof KerberosConfigureLdapRequestTlsMinVersionEnum[keyof typeof KerberosConfigureLdapRequestTlsMinVersionEnum];
