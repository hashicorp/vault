 ...
 * @export
 */
export const PkiIssuerIssueWithRoleRequestFormatEnum = {
    Pem: 'pem',
    Der: 'der',
    PemBundle: 'pem_bundle'
} as const;
export type PkiIssuerIssueWithRoleRequestFormatEnum = typeof PkiIssuerIssueWithRoleRequestFormatEnum[keyof typeof PkiIssuerIssueWithRoleRequestFormatEnum];

/**
 * @export
 */
export const PkiIssuerIssueWithRoleRequestPrivateKeyFormatEnum = {
    Empty: '',
    Der: 'der',
    Pem: 'pem',
    Pkcs8: 'pkcs8'
} as const;
export type PkiIssuerIssueWithRoleRequestPrivateKeyFormatEnum = typeof PkiIssuerIssueWithRoleRequestPrivateKeyFormatEnum[keyof typeof PkiIssuerIssueWithRoleRequestPrivateKeyFormatEnum];
