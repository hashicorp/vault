...
export interface PkiWriteRoleRequest {
     ...
     * @memberof PkiWriteRoleRequest
     */
    keyType?: PkiWriteRoleRequestKeyTypeEnum;
    /**
 ...
 * @export
 */
export const PkiWriteRoleRequestKeyTypeEnum = {
    Rsa: 'rsa',
    Ec: 'ec',
    Ed25519: 'ed25519',
    Any: 'any'
} as const;
export type PkiWriteRoleRequestKeyTypeEnum = typeof PkiWriteRoleRequestKeyTypeEnum[keyof typeof PkiWriteRoleRequestKeyTypeEnum];


/**
 * Check if a given object implements the PkiWriteRoleRequest interface.
 */
export function instanceOfPkiWriteRoleRequest(value: object): value is PkiWriteRoleRequest {
    return true;
}

export function PkiWriteRoleRequestFromJSON(json: any): PkiWriteRoleRequest {
    return PkiWriteRoleRequestFromJSONTyped(json, false);
}

export function PkiWriteRoleRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PkiWriteRoleRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiWriteRoleRequestToJSON(json: any): PkiWriteRoleRequest {
    return PkiWriteRoleRequestToJSONTyped(json, false);
}

export function PkiWriteRoleRequestToJSONTyped(value?: PkiWriteRoleRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
