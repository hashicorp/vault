 ...
 * @export
 */
export const PkiGenerateIntermediateRequestFormatEnum = {
    Pem: 'pem',
    Der: 'der',
    PemBundle: 'pem_bundle'
} as const;
export type PkiGenerateIntermediateRequestFormatEnum = typeof PkiGenerateIntermediateRequestFormatEnum[keyof typeof PkiGenerateIntermediateRequestFormatEnum];

/**
 * @export
 */
export const PkiGenerateIntermediateRequestKeyTypeEnum = {
    Rsa: 'rsa',
    Ec: 'ec',
    Ed25519: 'ed25519'
} as const;
export type PkiGenerateIntermediateRequestKeyTypeEnum = typeof PkiGenerateIntermediateRequestKeyTypeEnum[keyof typeof PkiGenerateIntermediateRequestKeyTypeEnum];

/**
 * @export
 */
export const PkiGenerateIntermediateRequestPrivateKeyFormatEnum = {
    Empty: '',
    Der: 'der',
    Pem: 'pem',
    Pkcs8: 'pkcs8'
} as const;
export type PkiGenerateIntermediateRequestPrivateKeyFormatEnum = typeof PkiGenerateIntermediateRequestPrivateKeyFormatEnum[keyof typeof PkiGenerateIntermediateRequestPrivateKeyFormatEnum];
