 ...
 * @export
 */
export const PkiIssuerSignIntermediateRequestFormatEnum = {
    Pem: 'pem',
    Der: 'der',
    PemBundle: 'pem_bundle'
} as const;
export type PkiIssuerSignIntermediateRequestFormatEnum = typeof PkiIssuerSignIntermediateRequestFormatEnum[keyof typeof PkiIssuerSignIntermediateRequestFormatEnum];

/**
 * @export
 */
export const PkiIssuerSignIntermediateRequestPrivateKeyFormatEnum = {
    Empty: '',
    Der: 'der',
    Pem: 'pem',
    Pkcs8: 'pkcs8'
} as const;
export type PkiIssuerSignIntermediateRequestPrivateKeyFormatEnum = typeof PkiIssuerSignIntermediateRequestPrivateKeyFormatEnum[keyof typeof PkiIssuerSignIntermediateRequestPrivateKeyFormatEnum];
