 ...
 * @export
 */
export const PkiSignWithRoleRequestFormatEnum = {
    Pem: 'pem',
    Der: 'der',
    PemBundle: 'pem_bundle'
} as const;
export type PkiSignWithRoleRequestFormatEnum = typeof PkiSignWithRoleRequestFormatEnum[keyof typeof PkiSignWithRoleRequestFormatEnum];

/**
 * @export
 */
export const PkiSignWithRoleRequestPrivateKeyFormatEnum = {
    Empty: '',
    Der: 'der',
    Pem: 'pem',
    Pkcs8: 'pkcs8'
} as const;
export type PkiSignWithRoleRequestPrivateKeyFormatEnum = typeof PkiSignWithRoleRequestPrivateKeyFormatEnum[keyof typeof PkiSignWithRoleRequestPrivateKeyFormatEnum];
