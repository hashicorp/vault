 ...
 * @export
 */
export const PkiWriteAcmeKeyIdRequestStatusEnum = {
    Valid: 'valid',
    Revoked: 'revoked'
} as const;
export type PkiWriteAcmeKeyIdRequestStatusEnum = typeof PkiWriteAcmeKeyIdRequestStatusEnum[keyof typeof PkiWriteAcmeKeyIdRequestStatusEnum];
