 ...
 * @export
 */
export const PkiGenerateExportedKeyRequestKeyTypeEnum = {
    Rsa: 'rsa',
    Ec: 'ec',
    Ed25519: 'ed25519'
} as const;
export type PkiGenerateExportedKeyRequestKeyTypeEnum = typeof PkiGenerateExportedKeyRequestKeyTypeEnum[keyof typeof PkiGenerateExportedKeyRequestKeyTypeEnum];
