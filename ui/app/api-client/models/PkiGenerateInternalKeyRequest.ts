 ...
 * @export
 */
export const PkiGenerateInternalKeyRequestKeyTypeEnum = {
    Rsa: 'rsa',
    Ec: 'ec',
    Ed25519: 'ed25519'
} as const;
export type PkiGenerateInternalKeyRequestKeyTypeEnum = typeof PkiGenerateInternalKeyRequestKeyTypeEnum[keyof typeof PkiGenerateInternalKeyRequestKeyTypeEnum];
