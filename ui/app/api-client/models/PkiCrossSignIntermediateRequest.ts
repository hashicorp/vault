 ...
 * @export
 */
export const PkiCrossSignIntermediateRequestExportedEnum = {
    Internal: 'internal',
    External: 'external',
    Kms: 'kms'
} as const;
export type PkiCrossSignIntermediateRequestExportedEnum = typeof PkiCrossSignIntermediateRequestExportedEnum[keyof typeof PkiCrossSignIntermediateRequestExportedEnum];

/**
 * @export
 */
export const PkiCrossSignIntermediateRequestFormatEnum = {
    Pem: 'pem',
    Der: 'der',
    PemBundle: 'pem_bundle'
} as const;
export type PkiCrossSignIntermediateRequestFormatEnum = typeof PkiCrossSignIntermediateRequestFormatEnum[keyof typeof PkiCrossSignIntermediateRequestFormatEnum];

/**
 * @export
 */
export const PkiCrossSignIntermediateRequestKeyTypeEnum = {
    Rsa: 'rsa',
    Ec: 'ec',
    Ed25519: 'ed25519'
} as const;
export type PkiCrossSignIntermediateRequestKeyTypeEnum = typeof PkiCrossSignIntermediateRequestKeyTypeEnum[keyof typeof PkiCrossSignIntermediateRequestKeyTypeEnum];

/**
 * @export
 */
export const PkiCrossSignIntermediateRequestPrivateKeyFormatEnum = {
    Empty: '',
    Der: 'der',
    Pem: 'pem',
    Pkcs8: 'pkcs8'
} as const;
export type PkiCrossSignIntermediateRequestPrivateKeyFormatEnum = typeof PkiCrossSignIntermediateRequestPrivateKeyFormatEnum[keyof typeof PkiCrossSignIntermediateRequestPrivateKeyFormatEnum];
