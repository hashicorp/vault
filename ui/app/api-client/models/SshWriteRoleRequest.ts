 ...
 * @export
 */
export const SshWriteRoleRequestAlgorithmSignerEnum = {
    Empty: '',
    Default: 'default',
    SshRsa: 'ssh-rsa',
...
export type SshWriteRoleRequestAlgorithmSignerEnum = typeof SshWriteRoleRequestAlgorithmSignerEnum[keyof typeof SshWriteRoleRequestAlgorithmSignerEnum];

/**
 * @export
 */
export const SshWriteRoleRequestKeyTypeEnum = {
    Otp: 'otp',
    Ca: 'ca'
} as const;
export type SshWriteRoleRequestKeyTypeEnum = typeof SshWriteRoleRequestKeyTypeEnum[keyof typeof SshWriteRoleRequestKeyTypeEnum];
