 ...
 * @export
 */
export const PkiGenerateKmsKeyRequestKeyTypeEnum = {
    Rsa: 'rsa',
    Ec: 'ec',
    Ed25519: 'ed25519'
} as const;
export type PkiGenerateKmsKeyRequestKeyTypeEnum = typeof PkiGenerateKmsKeyRequestKeyTypeEnum[keyof typeof PkiGenerateKmsKeyRequestKeyTypeEnum];
