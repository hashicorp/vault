 ...
 * @export
 */
export const PkiSignVerbatimRequestFormatEnum = {
    Pem: 'pem',
    Der: 'der',
    PemBundle: 'pem_bundle'
} as const;
export type PkiSignVerbatimRequestFormatEnum = typeof PkiSignVerbatimRequestFormatEnum[keyof typeof PkiSignVerbatimRequestFormatEnum];

/**
 * @export
 */
export const PkiSignVerbatimRequestPrivateKeyFormatEnum = {
    Empty: '',
    Der: 'der',
    Pem: 'pem',
    Pkcs8: 'pkcs8'
} as const;
export type PkiSignVerbatimRequestPrivateKeyFormatEnum = typeof PkiSignVerbatimRequestPrivateKeyFormatEnum[keyof typeof PkiSignVerbatimRequestPrivateKeyFormatEnum];
