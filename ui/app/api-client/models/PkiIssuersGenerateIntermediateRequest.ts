 ...
 * @export
 */
export const PkiIssuersGenerateIntermediateRequestFormatEnum = {
    Pem: 'pem',
    Der: 'der',
    PemBundle: 'pem_bundle'
} as const;
export type PkiIssuersGenerateIntermediateRequestFormatEnum = typeof PkiIssuersGenerateIntermediateRequestFormatEnum[keyof typeof PkiIssuersGenerateIntermediateRequestFormatEnum];

/**
 * @export
 */
export const PkiIssuersGenerateIntermediateRequestKeyTypeEnum = {
    Rsa: 'rsa',
    Ec: 'ec',
    Ed25519: 'ed25519'
} as const;
export type PkiIssuersGenerateIntermediateRequestKeyTypeEnum = typeof PkiIssuersGenerateIntermediateRequestKeyTypeEnum[keyof typeof PkiIssuersGenerateIntermediateRequestKeyTypeEnum];

/**
 * @export
 */
export const PkiIssuersGenerateIntermediateRequestPrivateKeyFormatEnum = {
    Empty: '',
    Der: 'der',
    Pem: 'pem',
    Pkcs8: 'pkcs8'
} as const;
export type PkiIssuersGenerateIntermediateRequestPrivateKeyFormatEnum = typeof PkiIssuersGenerateIntermediateRequestPrivateKeyFormatEnum[keyof typeof PkiIssuersGenerateIntermediateRequestPrivateKeyFormatEnum];


/**
 * Check if a given object implements the PkiIssuersGenerateIntermediateRequest interface.
 */
export function instanceOfPkiIssuersGenerateIntermediateRequest(value: object): value is PkiIssuersGenerateIntermediateRequest {
    return true;
}

export function PkiIssuersGenerateIntermediateRequestFromJSON(json: any): PkiIssuersGenerateIntermediateRequest {
    return PkiIssuersGenerateIntermediateRequestFromJSONTyped(json, false);
}

export function PkiIssuersGenerateIntermediateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PkiIssuersGenerateIntermediateRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiIssuersGenerateIntermediateRequestToJSON(json: any): PkiIssuersGenerateIntermediateRequest {
    return PkiIssuersGenerateIntermediateRequestToJSONTyped(json, false);
}

export function PkiIssuersGenerateIntermediateRequestToJSONTyped(value?: PkiIssuersGenerateIntermediateRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
