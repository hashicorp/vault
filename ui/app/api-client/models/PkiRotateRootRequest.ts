 ...
 * @export
 */
export const PkiRotateRootRequestFormatEnum = {
    Pem: 'pem',
    Der: 'der',
    PemBundle: 'pem_bundle'
} as const;
export type PkiRotateRootRequestFormatEnum = typeof PkiRotateRootRequestFormatEnum[keyof typeof PkiRotateRootRequestFormatEnum];

/**
 * @export
 */
export const PkiRotateRootRequestKeyTypeEnum = {
    Rsa: 'rsa',
    Ec: 'ec',
    Ed25519: 'ed25519'
} as const;
export type PkiRotateRootRequestKeyTypeEnum = typeof PkiRotateRootRequestKeyTypeEnum[keyof typeof PkiRotateRootRequestKeyTypeEnum];

/**
 * @export
 */
export const PkiRotateRootRequestPrivateKeyFormatEnum = {
    Empty: '',
    Der: 'der',
    Pem: 'pem',
    Pkcs8: 'pkcs8'
} as const;
export type PkiRotateRootRequestPrivateKeyFormatEnum = typeof PkiRotateRootRequestPrivateKeyFormatEnum[keyof typeof PkiRotateRootRequestPrivateKeyFormatEnum];
