 ...
 * @export
 */
export const PkiSignVerbatimWithRoleRequestFormatEnum = {
    Pem: 'pem',
    Der: 'der',
    PemBundle: 'pem_bundle'
} as const;
export type PkiSignVerbatimWithRoleRequestFormatEnum = typeof PkiSignVerbatimWithRoleRequestFormatEnum[keyof typeof PkiSignVerbatimWithRoleRequestFormatEnum];

/**
 * @export
 */
export const PkiSignVerbatimWithRoleRequestPrivateKeyFormatEnum = {
    Empty: '',
    Der: 'der',
    Pem: 'pem',
    Pkcs8: 'pkcs8'
} as const;
export type PkiSignVerbatimWithRoleRequestPrivateKeyFormatEnum = typeof PkiSignVerbatimWithRoleRequestPrivateKeyFormatEnum[keyof typeof PkiSignVerbatimWithRoleRequestPrivateKeyFormatEnum];
