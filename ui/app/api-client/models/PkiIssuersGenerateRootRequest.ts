 ...
 * @export
 */
export const PkiIssuersGenerateRootRequestFormatEnum = {
    Pem: 'pem',
    Der: 'der',
    PemBundle: 'pem_bundle'
} as const;
export type PkiIssuersGenerateRootRequestFormatEnum = typeof PkiIssuersGenerateRootRequestFormatEnum[keyof typeof PkiIssuersGenerateRootRequestFormatEnum];

/**
 * @export
 */
export const PkiIssuersGenerateRootRequestKeyTypeEnum = {
    Rsa: 'rsa',
    Ec: 'ec',
    Ed25519: 'ed25519'
} as const;
export type PkiIssuersGenerateRootRequestKeyTypeEnum = typeof PkiIssuersGenerateRootRequestKeyTypeEnum[keyof typeof PkiIssuersGenerateRootRequestKeyTypeEnum];

/**
 * @export
 */
export const PkiIssuersGenerateRootRequestPrivateKeyFormatEnum = {
    Empty: '',
    Der: 'der',
    Pem: 'pem',
    Pkcs8: 'pkcs8'
} as const;
export type PkiIssuersGenerateRootRequestPrivateKeyFormatEnum = typeof PkiIssuersGenerateRootRequestPrivateKeyFormatEnum[keyof typeof PkiIssuersGenerateRootRequestPrivateKeyFormatEnum];
