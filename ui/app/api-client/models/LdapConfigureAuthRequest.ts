 ...
 * @export
 */
export const LdapConfigureAuthRequestDereferenceAliasesEnum = {
    Never: 'never',
    Finding: 'finding',
    Searching: 'searching',
    Always: 'always'
} as const;
export type LdapConfigureAuthRequestDereferenceAliasesEnum = typeof LdapConfigureAuthRequestDereferenceAliasesEnum[keyof typeof LdapConfigureAuthRequestDereferenceAliasesEnum];

/**
 * @export
 */
export const LdapConfigureAuthRequestTlsMaxVersionEnum = {
    Tls10: 'tls10',
    Tls11: 'tls11',
    Tls12: 'tls12',
    Tls13: 'tls13'
} as const;
export type LdapConfigureAuthRequestTlsMaxVersionEnum = typeof LdapConfigureAuthRequestTlsMaxVersionEnum[keyof typeof LdapConfigureAuthRequestTlsMaxVersionEnum];

/**
 * @export
 */
export const LdapConfigureAuthRequestTlsMinVersionEnum = {
    Tls10: 'tls10',
    Tls11: 'tls11',
    Tls12: 'tls12',
    Tls13: 'tls13'
} as const;
export type LdapConfigureAuthRequestTlsMinVersionEnum = typeof LdapConfigureAuthRequestTlsMinVersionEnum[keyof typeof LdapConfigureAuthRequestTlsMinVersionEnum];
