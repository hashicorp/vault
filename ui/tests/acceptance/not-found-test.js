...
module('Acceptance | not-found', function (hooks) {
  ...
  test('top-level not-found', async function (assert) {
    ...
    assert.dom('[data-test-header-without-nav]').exists('renders not found component with header');
  });
  ...
  test('vault route not-found', async function (assert) {
    ...
    assert.dom('[data-test-header-with-nav]').exists('renders header with nav');
  });
