...
module('Integration | Component | details/agent', function (hooks) {
  ...
  hooks.beforeEach(function () {
    ...
    this.renderComponent = () =>
      render(
        hbs`<Details::Agent @agent={{this.data.agent}} @entity={{this.data.entity}} @aggregatePolicy={{this.data.aggregatePolicy}} />`
      );
  });
