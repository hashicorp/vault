...
module('Integration | Component | pki | external-pki | ExternalPki::Page::RoleDetails', function (hooks) {
  ...
  hooks.beforeEach(function () {
    ...
    this.renderComponent = () =>
      render(hbs`<ExternalPki::Page::RoleDetails @model={{this.model}} />`, { owner: this.engine });
  });
