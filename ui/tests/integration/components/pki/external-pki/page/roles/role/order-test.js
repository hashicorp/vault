...
module(
  'Integration | Component | pki | external-pki | ExternalPki::Page::Roles::Role::Order',
  function (hooks) {
    ...
    hooks.beforeEach(function () {
      ...
      this.renderComponent = () =>
        render(hbs`<ExternalPki::Page::Roles::Role::Order @model={{this.model}} />`, { owner: this.engine });
    });
