...
module('Integration | Component | clients/usage-stats', function (hooks) {
  ...
  module('it renders with full totals data', function () {
    // TODO need to figure out how to simulate this
    test.todo('with secrets sync activated', async function (assert) {
      this.set('counts', {
        clients: 22,
        entity_clients: 7,
        non_entity_clients: 10,
