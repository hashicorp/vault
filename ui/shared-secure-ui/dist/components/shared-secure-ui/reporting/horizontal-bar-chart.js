...
import { HdsTextBody, HdsSeparator, HdsCardContainer } from '@hashicorp/design-system-components/components';
...
class SSUReportingHorizontalBarChart extends Component {
  ...
  #xRangeOffsetWidth = (i(this, "xRangeOffsetWidth"), undefined);
  get data() {
