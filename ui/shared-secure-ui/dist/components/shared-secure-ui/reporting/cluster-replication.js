...
class ClusterReplication extends Component {
  get disasterRecoveryBadge() {
    return this.args.disasterRecoveryState === ENABLED_STATE ? {
      icon: 'check',
      text: 'Enabled',
      color: 'success'
    } : {
  ...
  get performanceBadge() {
    return this.args.performanceState === ENABLED_STATE ? {
      icon: 'check',
      text: 'Enabled',
      color: 'success'
    } : {
...
export { DISABLED_STATE, ENABLED_STATE, ClusterReplication as default };
