...
export class SystemApi extends runtime.BaseAPI {
    ...
    /**
     */
    async pluginsRuntimesCatalogListPluginsRuntimes_3Raw(requestParameters: SystemApiPluginsRuntimesCatalogListPluginsRuntimes0Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PluginsRuntimesCatalogListPluginsRuntimesResponse>> {
        if (requestParameters['list'] == null) {
            throw new runtime.RequiredError(
                'list',
    ...
    /**
     */
    async pluginsRuntimesCatalogListPluginsRuntimes_3(list: PluginsRuntimesCatalogListPluginsRuntimes0ListEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PluginsRuntimesCatalogListPluginsRuntimesResponse> {
     ...
     */
    async readVerbosityLevelFor_4Raw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<runtime.VoidResponse>> {
        const queryParameters: any = {};
     ...
     * Read the current status of the request limiter.
     */
    async readVerbosityLevelFor_4(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.VoidResponse> {
        const response = await this.readVerbosityLevelFor_4Raw(initOverrides);
        return await response.value();
    }
     ...
     */
    async subscriptionsCreate_5Raw(requestParameters: SystemApiSubscriptionsCreate0Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<runtime.VoidResponse>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Deletes the specified event notification subscription and stops sending event notifications to it.
     */
    async subscriptionsCreate_5(id: string, plugin: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.VoidResponse> {
        const response = await this.subscriptionsCreate_5Raw({ id: id, plugin: plugin }, initOverrides);
        return await response.value();
    }
