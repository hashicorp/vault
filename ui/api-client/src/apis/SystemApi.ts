...
export class SystemApi extends runtime.BaseAPI {
   ...
   */
  async activationFlagsActivateRaw(
   ...
   * Activate a flagged feature.
   */
  async activationFlagsActivate_1Raw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Activate a flagged feature.
   */
  async activationFlagsActivate_2Raw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Activate a flagged feature.
   */
  async activationFlagsActivate_2(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
    await this.activationFlagsActivate_2Raw(initOverrides);
  }

  /**
   */
  async auditingCalculateHashRaw(
    requestParameters: SystemApiAuditingCalculateHashOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AuditingCalculateHashResponse>> {
    ...
    const response = await this.request(
      {
        path: `/sys/audit-hash/{path}`.replace(
          `{${'path'}}`,
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AuditingCalculateHashResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async auditingCalculateHash(
    path: string,
    auditingCalculateHashRequest: AuditingCalculateHashRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AuditingCalculateHashResponse> {
    const response = await this.auditingCalculateHashRaw(
      { path: path, auditingCalculateHashRequest: auditingCalculateHashRequest },
      initOverrides
    );
   ...
   */
  async auditingDisableDeviceRaw(
    requestParameters: SystemApiAuditingDisableDeviceRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
   ...
   * Disable the audit device at the given path.
   */
  async auditingDisableDevice(
    path: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.auditingDisableDeviceRaw({ path: path }, initOverrides);
  }

  /**
   * Disable auditing of the given request header.
   */
  async auditingDisableRequestHeaderRaw(
    requestParameters: SystemApiAuditingDisableRequestHeaderRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/sys/config/auditing/request-headers/{header}`.replace(
          `{${'header'}}`,
          encodeURIComponent(String(requestParameters['header']))
        ),
        method: 'DELETE',
        headers: headerParameters,
        query: queryParameters,
   ...
   * Disable auditing of the given request header.
   */
  async auditingDisableRequestHeader(
    header: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.auditingDisableRequestHeaderRaw({ header: header }, initOverrides);
  }

  /**
   * Enable a new audit device at the supplied path.
   */
  async auditingEnableDeviceRaw(
   ...
   * Enable a new audit device at the supplied path.
   */
  async auditingEnableDevice(
    path: string,
    auditingEnableDeviceRequest: AuditingEnableDeviceRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.auditingEnableDeviceRaw(
      { path: path, auditingEnableDeviceRequest: auditingEnableDeviceRequest },
      initOverrides
    );
  }
   ...
   */
  async auditingEnableRequestHeaderRaw(
    requestParameters: SystemApiAuditingEnableRequestHeaderOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['header'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: AuditingEnableRequestHeaderRequestToJSON(
   ...
   * Enable auditing of a header.
   */
  async auditingEnableRequestHeader(
    header: string,
    auditingEnableRequestHeaderRequest: AuditingEnableRequestHeaderRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.auditingEnableRequestHeaderRaw(
      { header: header, auditingEnableRequestHeaderRequest: auditingEnableRequestHeaderRequest },
      initOverrides
    );
  }
   ...
   * List the enabled audit devices.
   */
  async auditingListEnabledDevices(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
   ...
   */
  async auditingListRequestHeadersRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AuditingListRequestHeadersResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AuditingListRequestHeadersResponseFromJSON(jsonValue)
    );
  }
   ...
   * List the request headers that are configured to be audited.
   */
  async auditingListRequestHeaders(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AuditingListRequestHeadersResponse> {
   ...
   */
  async auditingReadRequestHeaderInformationRaw(
    requestParameters: SystemApiAuditingReadRequestHeaderInformationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['header'] == null) {
      throw new runtime.RequiredError(
   ...
   * List the information for the given request header.
   */
  async auditingReadRequestHeaderInformation(
    header: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.auditingReadRequestHeaderInformationRaw({ header: header }, initOverrides);
  }

  /**
   * Disable the auth method at the given auth path
   */
  async authDisableMethodRaw(
    requestParameters: SystemApiAuthDisableMethodRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
   ...
   * Disable the auth method at the given auth path
   */
  async authDisableMethod(
    path: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.authDisableMethodRaw({ path: path }, initOverrides);
  }
   ...
   */
  async authEnableMethodRaw(
    requestParameters: SystemApiAuthEnableMethodOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
   ...
   * Enables a new auth method.
   */
  async authEnableMethod(
    path: string,
    authEnableMethodRequest: AuthEnableMethodRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.authEnableMethodRaw(
      { path: path, authEnableMethodRequest: authEnableMethodRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async authListEnabledMethodsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   */
  async authReadConfigurationRaw(
    requestParameters: SystemApiAuthReadConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AuthReadConfigurationResponse>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
        'path',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AuthReadConfigurationResponseFromJSON(jsonValue)
    );
  }
   ...
   * Read the configuration of the auth engine at the given path.
   */
  async authReadConfiguration(
    path: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AuthReadConfigurationResponse> {
   ...
   */
  async authReadTuningInformationRaw(
    requestParameters: SystemApiAuthReadTuningInformationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AuthReadTuningInformationResponse>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
        'path',
    ...
    const response = await this.request(
      {
        path: `/sys/auth/{path}/tune`.replace(
          `{${'path'}}`,
          encodeURIComponent(String(requestParameters['path']))
        ),
        method: 'GET',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AuthReadTuningInformationResponseFromJSON(jsonValue)
    );
  }
   ...
   * Reads the given auth path\'s configuration.
   */
  async authReadTuningInformation(
    path: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AuthReadTuningInformationResponse> {
   ...
   */
  async authTuneConfigurationParametersRaw(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: AuthTuneConfigurationParametersRequestToJSON(
          requestParameters['authTuneConfigurationParametersRequest']
        ),
      },
      initOverrides
    );
   ...
   * Tune configuration parameters for a given auth path.
   */
  async authTuneConfigurationParameters(
    path: string,
    authTuneConfigurationParametersRequest: AuthTuneConfigurationParametersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.authTuneConfigurationParametersRaw(
      { path: path, authTuneConfigurationParametersRequest: authTuneConfigurationParametersRequest },
      initOverrides
    );
  }
   ...
   */
  async collectHostInformationRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<CollectHostInformationResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      CollectHostInformationResponseFromJSON(jsonValue)
    );
  }
   ...
   * Information about the host instance that this Vault server is running on.
   */
  async collectHostInformation(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<CollectHostInformationResponse> {
   ...
   */
  async collectInFlightRequestInformationRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * reports in-flight requests
   */
  async collectInFlightRequestInformation(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
  ...
  async corsConfigure(
    ...
    await this.corsConfigureRaw({ corsConfigureRequest: corsConfigureRequest }, initOverrides);
  }

  /**
   * Remove any CORS settings.
   */
  async corsDeleteConfigurationRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   */
  async corsReadConfigurationRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<CorsReadConfigurationResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      CorsReadConfigurationResponseFromJSON(jsonValue)
    );
  }
   ...
   * Return the current CORS settings.
   */
  async corsReadConfiguration(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<CorsReadConfigurationResponse> {
   ...
   */
  async createCustomMessageRaw(
    requestParameters: SystemApiCreateCustomMessageOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
  ...
  async createCustomMessage(
    ...
    await this.createCustomMessageRaw(
      { createCustomMessageRequest: createCustomMessageRequest },
      initOverrides
    );
  }
   ...
   */
  async decodeTokenRaw(
    requestParameters: SystemApiDecodeTokenOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
  ...
  async decodeToken(
    ...
    await this.decodeTokenRaw({ decodeTokenRequest: decodeTokenRequest }, initOverrides);
  }

  /**
   */
  async encryptionKeyConfigureRotationRaw(
    requestParameters: SystemApiEncryptionKeyConfigureRotationOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: EncryptionKeyConfigureRotationRequestToJSON(
          requestParameters['encryptionKeyConfigureRotationRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async encryptionKeyConfigureRotation(
    encryptionKeyConfigureRotationRequest: EncryptionKeyConfigureRotationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.encryptionKeyConfigureRotationRaw(
      { encryptionKeyConfigureRotationRequest: encryptionKeyConfigureRotationRequest },
      initOverrides
    );
  }
  ...
  async encryptionKeyReadRotationConfigurationRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<EncryptionKeyReadRotationConfigurationResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      EncryptionKeyReadRotationConfigurationResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async encryptionKeyReadRotationConfiguration(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<EncryptionKeyReadRotationConfigurationResponse> {
  ...
  /**
   */
  async generateHashRaw(
    requestParameters: SystemApiGenerateHashOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<GenerateHashResponse>> {
  ...
  /**
   */
  async generateHashWithAlgorithmRaw(
    requestParameters: SystemApiGenerateHashWithAlgorithmOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<GenerateHashWithAlgorithmResponse>> {
    ...
    const response = await this.request(
      {
        path: `/sys/tools/hash/{urlalgorithm}`.replace(
          `{${'urlalgorithm'}}`,
          encodeURIComponent(String(requestParameters['urlalgorithm']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      GenerateHashWithAlgorithmResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async generateHashWithAlgorithm(
    urlalgorithm: string,
    generateHashWithAlgorithmRequest: GenerateHashWithAlgorithmRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<GenerateHashWithAlgorithmResponse> {
    const response = await this.generateHashWithAlgorithmRaw(
      { urlalgorithm: urlalgorithm, generateHashWithAlgorithmRequest: generateHashWithAlgorithmRequest },
      initOverrides
    );
    return await response.value();
  }
  ...
  /**
   */
  async generateRandomRaw(
    requestParameters: SystemApiGenerateRandomOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<GenerateRandomResponse>> {
  ...
  async generateRandom(
    ...
    const response = await this.generateRandomRaw(
      { generateRandomRequest: generateRandomRequest },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async generateRandomWithBytesRaw(
    requestParameters: SystemApiGenerateRandomWithBytesOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<GenerateRandomWithBytesResponse>> {
    ...
    const response = await this.request(
      {
        path: `/sys/tools/random/{urlbytes}`.replace(
          `{${'urlbytes'}}`,
          encodeURIComponent(String(requestParameters['urlbytes']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      GenerateRandomWithBytesResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async generateRandomWithBytes(
    urlbytes: string,
    generateRandomWithBytesRequest: GenerateRandomWithBytesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<GenerateRandomWithBytesResponse> {
    const response = await this.generateRandomWithBytesRaw(
      { urlbytes: urlbytes, generateRandomWithBytesRequest: generateRandomWithBytesRequest },
      initOverrides
    );
    return await response.value();
  }
  ...
  /**
   */
  async generateRandomWithSourceRaw(
    requestParameters: SystemApiGenerateRandomWithSourceOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<GenerateRandomWithSourceResponse>> {
    ...
    const response = await this.request(
      {
        path: `/sys/tools/random/{source}`.replace(
          `{${'source'}}`,
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      GenerateRandomWithSourceResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async generateRandomWithSource(
    source: string,
    generateRandomWithSourceRequest: GenerateRandomWithSourceRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<GenerateRandomWithSourceResponse> {
    const response = await this.generateRandomWithSourceRaw(
      { source: source, generateRandomWithSourceRequest: generateRandomWithSourceRequest },
      initOverrides
    );
    return await response.value();
  }
  ...
  /**
   */
  async generateRandomWithSourceAndBytesRaw(
    requestParameters: SystemApiGenerateRandomWithSourceAndBytesOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<GenerateRandomWithSourceAndBytesResponse>> {
    if (requestParameters['source'] == null) {
      throw new runtime.RequiredError(
        'source',
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: GenerateRandomWithSourceAndBytesRequestToJSON(
          requestParameters['generateRandomWithSourceAndBytesRequest']
        ),
      },
      initOverrides
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      GenerateRandomWithSourceAndBytesResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async generateRandomWithSourceAndBytes(
    source: string,
    urlbytes: string,
    generateRandomWithSourceAndBytesRequest: GenerateRandomWithSourceAndBytesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<GenerateRandomWithSourceAndBytesResponse> {
    const response = await this.generateRandomWithSourceAndBytesRaw(
      {
        source: source,
        urlbytes: urlbytes,
        generateRandomWithSourceAndBytesRequest: generateRandomWithSourceAndBytesRequest,
  ...
  async haStatusRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<HaStatusResponse>> {
    const queryParameters: any = {};
   ...
   */
  async initializeRaw(
    requestParameters: SystemApiInitializeOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
  ...
  async initialize(
    ...
    await this.initializeRaw({ initializeRequest: initializeRequest }, initOverrides);
  }

  /**
   * Enable or disable collection of client count, set retention period, or set default reporting period.
   */
  async internalClientActivityConfigureRaw(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: InternalClientActivityConfigureRequestToJSON(
          requestParameters['internalClientActivityConfigureRequest']
        ),
      },
      initOverrides
    );
   ...
   * Enable or disable collection of client count, set retention period, or set default reporting period.
   */
  async internalClientActivityConfigure(
    internalClientActivityConfigureRequest: InternalClientActivityConfigureRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.internalClientActivityConfigureRaw(
      { internalClientActivityConfigureRequest: internalClientActivityConfigureRequest },
      initOverrides
    );
  }
   ...
   */
  async internalClientActivityExportRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Report the client count metrics, for this namespace and all child namespaces.
   */
  async internalClientActivityExport(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
   ...
   */
  async internalClientActivityReadConfigurationRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Read the client count tracking configuration.
   */
  async internalClientActivityReadConfiguration(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
   ...
   * Report the client count metrics, for this namespace and all child namespaces.
   */
  async internalClientActivityReportCountsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Report the client count metrics, for this namespace and all child namespaces.
   */
  async internalClientActivityReportCounts(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
   ...
   */
  async internalClientActivityReportCountsThisMonthRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Report the number of clients for this month, for this namespace and all child namespaces.
   */
  async internalClientActivityReportCountsThisMonth(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
   ...
   */
  async internalCountEntitiesRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<InternalCountEntitiesResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      InternalCountEntitiesResponseFromJSON(jsonValue)
    );
  }
   ...
   * Backwards compatibility is not guaranteed for this API
   */
  async internalCountEntities(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<InternalCountEntitiesResponse> {
   ...
   * @deprecated
   */
  async internalCountRequestsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Backwards compatibility is not guaranteed for this API
   */
  async internalCountTokensRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<InternalCountTokensResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      InternalCountTokensResponseFromJSON(jsonValue)
    );
  }
   ...
   * Backwards compatibility is not guaranteed for this API
   */
  async internalCountTokens(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<InternalCountTokensResponse> {
  ...
  /**
   */
  async internalGenerateOpenApiDocumentRaw(
  ...
  /**
   */
  async internalGenerateOpenApiDocument(
    context?: string,
    genericMountPaths?: boolean,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.internalGenerateOpenApiDocumentRaw(
  ...
  /**
   */
  async internalGenerateOpenApiDocumentWithParametersRaw(
    requestParameters: SystemApiInternalGenerateOpenApiDocumentWithParametersOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: InternalGenerateOpenApiDocumentWithParametersRequestToJSON(
          requestParameters['internalGenerateOpenApiDocumentWithParametersRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async internalGenerateOpenApiDocumentWithParameters(
    internalGenerateOpenApiDocumentWithParametersRequest: InternalGenerateOpenApiDocumentWithParametersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.internalGenerateOpenApiDocumentWithParametersRaw(
      {
        internalGenerateOpenApiDocumentWithParametersRequest:
          internalGenerateOpenApiDocumentWithParametersRequest,
      },
   ...
   */
  async internalInspectRouterRaw(
    requestParameters: SystemApiInternalInspectRouterRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/sys/internal/inspect/router/{tag}`.replace(
          `{${'tag'}}`,
   ...
   * Expose the route entry and mount entry tables present in the router
   */
  async internalInspectRouter(
    tag: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.internalInspectRouterRaw({ tag: tag }, initOverrides);
  }

  /**
   * Lists enabled feature flags.
   */
  async internalUiListEnabledFeatureFlagsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<InternalUiListEnabledFeatureFlagsResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      InternalUiListEnabledFeatureFlagsResponseFromJSON(jsonValue)
    );
  }
   ...
   * Lists enabled feature flags.
   */
  async internalUiListEnabledFeatureFlags(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<InternalUiListEnabledFeatureFlagsResponse> {
   ...
   */
  async internalUiListEnabledVisibleMountsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<InternalUiListEnabledVisibleMountsResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      InternalUiListEnabledVisibleMountsResponseFromJSON(jsonValue)
    );
  }
   ...
   * Lists all enabled and visible auth and secrets mounts.
   */
  async internalUiListEnabledVisibleMounts(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<InternalUiListEnabledVisibleMountsResponse> {
   ...
   * Backwards compatibility is not guaranteed for this API
   */
  async internalUiListNamespacesRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<InternalUiListNamespacesResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      InternalUiListNamespacesResponseFromJSON(jsonValue)
    );
  }
   ...
   * Backwards compatibility is not guaranteed for this API
   */
  async internalUiListNamespaces(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<InternalUiListNamespacesResponse> {
   ...
   */
  async internalUiReadAuthenticatedActiveCustomMessagesRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<InternalUiReadAuthenticatedActiveCustomMessagesResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      InternalUiReadAuthenticatedActiveCustomMessagesResponseFromJSON(jsonValue)
    );
  }
   ...
   * Retrieves Active post-login Custom Messages
   */
  async internalUiReadAuthenticatedActiveCustomMessages(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<InternalUiReadAuthenticatedActiveCustomMessagesResponse> {
   ...
   */
  async internalUiReadMountInformationRaw(
    requestParameters: SystemApiInternalUiReadMountInformationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<InternalUiReadMountInformationResponse>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
        'path',
    ...
    const response = await this.request(
      {
        path: `/sys/internal/ui/mounts/{path}`.replace(
          `{${'path'}}`,
          encodeURIComponent(String(requestParameters['path']))
        ),
        method: 'GET',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      InternalUiReadMountInformationResponseFromJSON(jsonValue)
    );
  }
   ...
   * Return information about the given mount.
   */
  async internalUiReadMountInformation(
    path: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<InternalUiReadMountInformationResponse> {
   ...
   * Backwards compatibility is not guaranteed for this API
   */
  async internalUiReadResultantAclRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<InternalUiReadResultantAclResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      InternalUiReadResultantAclResponseFromJSON(jsonValue)
    );
  }
   ...
   * Backwards compatibility is not guaranteed for this API
   */
  async internalUiReadResultantAcl(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<InternalUiReadResultantAclResponse | null | undefined> {
   ...
   */
  async internalUiReadUnauthenticatedActiveCustomMessagesRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<InternalUiReadUnauthenticatedActiveCustomMessagesResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      InternalUiReadUnauthenticatedActiveCustomMessagesResponseFromJSON(jsonValue)
    );
  }
   ...
   * Retrieves Active pre-login Custom Messages
   */
  async internalUiReadUnauthenticatedActiveCustomMessages(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<InternalUiReadUnauthenticatedActiveCustomMessagesResponse> {
   ...
   */
  async leaderStatusRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<LeaderStatusResponse>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async leasesCountRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<LeasesCountResponse>> {
    const queryParameters: any = {};
   ...
   */
  async leasesForceRevokeLeaseWithPrefixRaw(
    requestParameters: SystemApiLeasesForceRevokeLeaseWithPrefixRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/sys/leases/revoke-force/{prefix}`.replace(
          `{${'prefix'}}`,
          encodeURIComponent(String(requestParameters['prefix']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
   ...
   * Revokes all secrets or tokens generated under a given prefix immediately
   */
  async leasesForceRevokeLeaseWithPrefix(
    prefix: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.leasesForceRevokeLeaseWithPrefixRaw({ prefix: prefix }, initOverrides);
  }
   ...
   * Revokes all secrets or tokens generated under a given prefix immediately
   */
  async leasesForceRevokeLeaseWithPrefix2Raw(
    requestParameters: SystemApiLeasesForceRevokeLeaseWithPrefix2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['prefix'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/revoke-force/{prefix}`.replace(
          `{${'prefix'}}`,
          encodeURIComponent(String(requestParameters['prefix']))
        ),
        method: 'POST',
   ...
   * Revokes all secrets or tokens generated under a given prefix immediately
   */
  async leasesForceRevokeLeaseWithPrefix2(
    prefix: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.leasesForceRevokeLeaseWithPrefix2Raw({ prefix: prefix }, initOverrides);
  }
  ...
  async leasesListRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<LeasesListResponse>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async leasesLookUpRaw(
    requestParameters: SystemApiLeasesLookUpRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<LeasesLookUpResponse>> {
    if (requestParameters['prefix'] == null) {
      throw new runtime.RequiredError(
        'prefix',
    ...
    const response = await this.request(
      {
        path: `/sys/leases/lookup/{prefix}/`.replace(
          `{${'prefix'}}`,
          encodeURIComponent(String(requestParameters['prefix']))
        ),
        method: 'GET',
  ...
  /**
   */
  async leasesReadLeaseRaw(
    requestParameters: SystemApiLeasesReadLeaseOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<LeasesReadLeaseResponse>> {
  ...
  /**
   */
  async leasesReadLease(
    leasesReadLeaseRequest: LeasesReadLeaseRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<LeasesReadLeaseResponse> {
    const response = await this.leasesReadLeaseRaw(
      { leasesReadLeaseRequest: leasesReadLeaseRequest },
      initOverrides
    );
    return await response.value();
   ...
   */
  async leasesRenewLeaseRaw(
    requestParameters: SystemApiLeasesRenewLeaseOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
   ...
   * Renews a lease, requesting to extend the lease.
   */
  async leasesRenewLease(
    leasesRenewLeaseRequest: LeasesRenewLeaseRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.leasesRenewLeaseRaw({ leasesRenewLeaseRequest: leasesRenewLeaseRequest }, initOverrides);
  }

  /**
   * Renews a lease, requesting to extend the lease.
   */
  async leasesRenewLease2Raw(
    requestParameters: SystemApiLeasesRenewLease2OperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
   ...
   * Renews a lease, requesting to extend the lease.
   */
  async leasesRenewLease2(
    leasesRenewLease2Request: LeasesRenewLease2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.leasesRenewLease2Raw({ leasesRenewLease2Request: leasesRenewLease2Request }, initOverrides);
  }

  /**
   * Renews a lease, requesting to extend the lease.
   */
  async leasesRenewLeaseWithIdRaw(
    requestParameters: SystemApiLeasesRenewLeaseWithIdOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/sys/leases/renew/{url_lease_id}`.replace(
          `{${'url_lease_id'}}`,
          encodeURIComponent(String(requestParameters['urlLeaseId']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
   ...
   * Renews a lease, requesting to extend the lease.
   */
  async leasesRenewLeaseWithId(
    urlLeaseId: string,
    leasesRenewLeaseWithIdRequest: LeasesRenewLeaseWithIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.leasesRenewLeaseWithIdRaw(
      { urlLeaseId: urlLeaseId, leasesRenewLeaseWithIdRequest: leasesRenewLeaseWithIdRequest },
      initOverrides
    );
  }
   ...
   * Renews a lease, requesting to extend the lease.
   */
  async leasesRenewLeaseWithId2Raw(
    requestParameters: SystemApiLeasesRenewLeaseWithId2OperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['urlLeaseId'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/renew/{url_lease_id}`.replace(
          `{${'url_lease_id'}}`,
          encodeURIComponent(String(requestParameters['urlLeaseId']))
        ),
        method: 'POST',
   ...
   * Renews a lease, requesting to extend the lease.
   */
  async leasesRenewLeaseWithId2(
    urlLeaseId: string,
    leasesRenewLeaseWithId2Request: LeasesRenewLeaseWithId2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.leasesRenewLeaseWithId2Raw(
   ...
   */
  async leasesRevokeLeaseRaw(
    requestParameters: SystemApiLeasesRevokeLeaseOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
   ...
   * Revokes a lease immediately.
   */
  async leasesRevokeLease(
    leasesRevokeLeaseRequest: LeasesRevokeLeaseRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.leasesRevokeLeaseRaw({ leasesRevokeLeaseRequest: leasesRevokeLeaseRequest }, initOverrides);
  }

  /**
   * Revokes a lease immediately.
   */
  async leasesRevokeLease2Raw(
    requestParameters: SystemApiLeasesRevokeLease2OperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
   ...
   * Revokes a lease immediately.
   */
  async leasesRevokeLease2(
    leasesRevokeLease2Request: LeasesRevokeLease2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.leasesRevokeLease2Raw({ leasesRevokeLease2Request: leasesRevokeLease2Request }, initOverrides);
  }

  /**
   * Revokes a lease immediately.
   */
  async leasesRevokeLeaseWithIdRaw(
    requestParameters: SystemApiLeasesRevokeLeaseWithIdOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['urlLeaseId'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/leases/revoke/{url_lease_id}`.replace(
          `{${'url_lease_id'}}`,
          encodeURIComponent(String(requestParameters['urlLeaseId']))
        ),
        method: 'POST',
   ...
   * Revokes a lease immediately.
   */
  async leasesRevokeLeaseWithId(
    urlLeaseId: string,
    leasesRevokeLeaseWithIdRequest: LeasesRevokeLeaseWithIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.leasesRevokeLeaseWithIdRaw(
      { urlLeaseId: urlLeaseId, leasesRevokeLeaseWithIdRequest: leasesRevokeLeaseWithIdRequest },
      initOverrides
    );
  }
   ...
   * Revokes a lease immediately.
   */
  async leasesRevokeLeaseWithId2Raw(
    requestParameters: SystemApiLeasesRevokeLeaseWithId2OperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['urlLeaseId'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/revoke/{url_lease_id}`.replace(
          `{${'url_lease_id'}}`,
          encodeURIComponent(String(requestParameters['urlLeaseId']))
        ),
        method: 'POST',
   ...
   * Revokes a lease immediately.
   */
  async leasesRevokeLeaseWithId2(
    urlLeaseId: string,
    leasesRevokeLeaseWithId2Request: LeasesRevokeLeaseWithId2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.leasesRevokeLeaseWithId2Raw(
      { urlLeaseId: urlLeaseId, leasesRevokeLeaseWithId2Request: leasesRevokeLeaseWithId2Request },
      initOverrides
    );
  }
   ...
   */
  async leasesRevokeLeaseWithPrefixRaw(
    requestParameters: SystemApiLeasesRevokeLeaseWithPrefixOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['prefix'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/leases/revoke-prefix/{prefix}`.replace(
          `{${'prefix'}}`,
          encodeURIComponent(String(requestParameters['prefix']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
        body: LeasesRevokeLeaseWithPrefixRequestToJSON(
          requestParameters['leasesRevokeLeaseWithPrefixRequest']
        ),
      },
      initOverrides
    );
   ...
   * Revokes all secrets (via a lease ID prefix) or tokens (via the tokens\' path property) generated under a given prefix immediately.
   */
  async leasesRevokeLeaseWithPrefix(
    prefix: string,
    leasesRevokeLeaseWithPrefixRequest: LeasesRevokeLeaseWithPrefixRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.leasesRevokeLeaseWithPrefixRaw(
      { prefix: prefix, leasesRevokeLeaseWithPrefixRequest: leasesRevokeLeaseWithPrefixRequest },
      initOverrides
    );
  }
   ...
   * Revokes all secrets (via a lease ID prefix) or tokens (via the tokens\' path property) generated under a given prefix immediately.
   */
  async leasesRevokeLeaseWithPrefix2Raw(
    requestParameters: SystemApiLeasesRevokeLeaseWithPrefix2OperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['prefix'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/revoke-prefix/{prefix}`.replace(
          `{${'prefix'}}`,
          encodeURIComponent(String(requestParameters['prefix']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
        body: LeasesRevokeLeaseWithPrefix2RequestToJSON(
          requestParameters['leasesRevokeLeaseWithPrefix2Request']
        ),
      },
      initOverrides
    );
   ...
   * Revokes all secrets (via a lease ID prefix) or tokens (via the tokens\' path property) generated under a given prefix immediately.
   */
  async leasesRevokeLeaseWithPrefix2(
    prefix: string,
    leasesRevokeLeaseWithPrefix2Request: LeasesRevokeLeaseWithPrefix2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.leasesRevokeLeaseWithPrefix2Raw(
      { prefix: prefix, leasesRevokeLeaseWithPrefix2Request: leasesRevokeLeaseWithPrefix2Request },
      initOverrides
    );
  }
   ...
   */
  async listExperimentalFeaturesRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   */
  async lockedUsersUnlockRaw(
    requestParameters: SystemApiLockedUsersUnlockRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/sys/locked-users/{mount_accessor}/unlock/{alias_identifier}`
          .replace(
            `{${'alias_identifier'}}`,
            encodeURIComponent(String(requestParameters['aliasIdentifier']))
          )
   ...
   * Unlocks the user with given mount_accessor and alias_identifier
   */
  async lockedUsersUnlock(
    aliasIdentifier: string,
    mountAccessor: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.lockedUsersUnlockRaw(
      { aliasIdentifier: aliasIdentifier, mountAccessor: mountAccessor },
      initOverrides
    );
  }
   ...
   */
  async loggersReadVerbosityLevelRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   */
  async loggersReadVerbosityLevelForRaw(
    requestParameters: SystemApiLoggersReadVerbosityLevelForRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
   ...
   * Read the log level for a single logger.
   */
  async loggersReadVerbosityLevelFor(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.loggersReadVerbosityLevelForRaw({ name: name }, initOverrides);
  }

  /**
   * Revert the all loggers to use log level provided in config.
   */
  async loggersRevertVerbosityLevelRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Revert the all loggers to use log level provided in config.
   */
  async loggersRevertVerbosityLevel(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
   ...
   */
  async loggersRevertVerbosityLevelForRaw(
    requestParameters: SystemApiLoggersRevertVerbosityLevelForRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Revert a single logger to use log level provided in config.
   */
  async loggersRevertVerbosityLevelFor(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.loggersRevertVerbosityLevelForRaw({ name: name }, initOverrides);
  }

  /**
   * Modify the log level for all existing loggers.
   */
  async loggersUpdateVerbosityLevelRaw(
    requestParameters: SystemApiLoggersUpdateVerbosityLevelOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: LoggersUpdateVerbosityLevelRequestToJSON(
          requestParameters['loggersUpdateVerbosityLevelRequest']
        ),
      },
      initOverrides
    );
   ...
   * Modify the log level for all existing loggers.
   */
  async loggersUpdateVerbosityLevel(
    loggersUpdateVerbosityLevelRequest: LoggersUpdateVerbosityLevelRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.loggersUpdateVerbosityLevelRaw(
      { loggersUpdateVerbosityLevelRequest: loggersUpdateVerbosityLevelRequest },
      initOverrides
    );
  }
   ...
   */
  async loggersUpdateVerbosityLevelForRaw(
    requestParameters: SystemApiLoggersUpdateVerbosityLevelForOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: LoggersUpdateVerbosityLevelForRequestToJSON(
          requestParameters['loggersUpdateVerbosityLevelForRequest']
        ),
      },
      initOverrides
    );
   ...
   * Modify the log level of a single logger.
   */
  async loggersUpdateVerbosityLevelFor(
    name: string,
    loggersUpdateVerbosityLevelForRequest: LoggersUpdateVerbosityLevelForRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.loggersUpdateVerbosityLevelForRaw(
      { name: name, loggersUpdateVerbosityLevelForRequest: loggersUpdateVerbosityLevelForRequest },
      initOverrides
    );
  }
   ...
   */
  async metricsRaw(
    requestParameters: SystemApiMetricsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async metrics(format?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
    await this.metricsRaw({ format: format }, initOverrides);
  }

  /**
   * Validates the login for the given MFA methods. Upon successful validation, it returns an auth response containing the client token
   */
  async mfaValidateRaw(
    requestParameters: SystemApiMfaValidateOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
  ...
  async mfaValidate(
    ...
    await this.mfaValidateRaw({ mfaValidateRequest: mfaValidateRequest }, initOverrides);
  }

  /**
   */
  async monitorRaw(
    requestParameters: SystemApiMonitorRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  async monitor(
    ...
    await this.monitorRaw({ logFormat: logFormat, logLevel: logLevel }, initOverrides);
  }

  /**
   * Disable the mount point specified at the given path.
   */
  async mountsDisableSecretsEngineRaw(
    requestParameters: SystemApiMountsDisableSecretsEngineRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
   ...
   * Disable the mount point specified at the given path.
   */
  async mountsDisableSecretsEngine(
    path: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.mountsDisableSecretsEngineRaw({ path: path }, initOverrides);
  }

  /**
   * Enable a new secrets engine at the given path.
   */
  async mountsEnableSecretsEngineRaw(
    requestParameters: SystemApiMountsEnableSecretsEngineOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
   ...
   * Enable a new secrets engine at the given path.
   */
  async mountsEnableSecretsEngine(
    path: string,
    mountsEnableSecretsEngineRequest: MountsEnableSecretsEngineRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.mountsEnableSecretsEngineRaw(
      { path: path, mountsEnableSecretsEngineRequest: mountsEnableSecretsEngineRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async mountsListSecretsEnginesRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   */
  async mountsReadConfigurationRaw(
    requestParameters: SystemApiMountsReadConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<MountsReadConfigurationResponse>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
        'path',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      MountsReadConfigurationResponseFromJSON(jsonValue)
    );
  }
   ...
   * Read the configuration of the secret engine at the given path.
   */
  async mountsReadConfiguration(
    path: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<MountsReadConfigurationResponse> {
  ...
  /**
   */
  async mountsReadTuningInformationRaw(
    requestParameters: SystemApiMountsReadTuningInformationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<MountsReadTuningInformationResponse>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
        'path',
    ...
    const response = await this.request(
      {
        path: `/sys/mounts/{path}/tune`.replace(
          `{${'path'}}`,
          encodeURIComponent(String(requestParameters['path']))
        ),
        method: 'GET',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      MountsReadTuningInformationResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async mountsReadTuningInformation(
    path: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<MountsReadTuningInformationResponse> {
  ...
  /**
   */
  async mountsTuneConfigurationParametersRaw(
    requestParameters: SystemApiMountsTuneConfigurationParametersOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: MountsTuneConfigurationParametersRequestToJSON(
          requestParameters['mountsTuneConfigurationParametersRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async mountsTuneConfigurationParameters(
    path: string,
    mountsTuneConfigurationParametersRequest: MountsTuneConfigurationParametersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.mountsTuneConfigurationParametersRaw(
      { path: path, mountsTuneConfigurationParametersRequest: mountsTuneConfigurationParametersRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async pluginsCatalogListPluginsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PluginsCatalogListPluginsResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PluginsCatalogListPluginsResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async pluginsCatalogListPlugins(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<PluginsCatalogListPluginsResponse> {
   ...
   */
  async pluginsCatalogListPluginsWithTypeRaw(
    requestParameters: SystemApiPluginsCatalogListPluginsWithTypeRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PluginsCatalogListPluginsWithTypeResponse>> {
    ...
    const response = await this.request(
      {
        path: `/sys/plugins/catalog/{type}/`.replace(
          `{${'type'}}`,
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PluginsCatalogListPluginsWithTypeResponseFromJSON(jsonValue)
    );
  }
   ...
   * List the plugins in the catalog.
   */
  async pluginsCatalogListPluginsWithType(
    type: string,
    list: PluginsCatalogListPluginsWithTypeListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<PluginsCatalogListPluginsWithTypeResponse> {
    const response = await this.pluginsCatalogListPluginsWithTypeRaw(
      { type: type, list: list },
      initOverrides
    );
    return await response.value();
   ...
   */
  async pluginsCatalogPinsCreatePinnedVersionRaw(
    requestParameters: SystemApiPluginsCatalogPinsCreatePinnedVersionOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: PluginsCatalogPinsCreatePinnedVersionRequestToJSON(
   ...
   * Create or update the pinned version for a plugin with a given type and name.
   */
  async pluginsCatalogPinsCreatePinnedVersion(
    name: string,
    type: string,
    pluginsCatalogPinsCreatePinnedVersionRequest: PluginsCatalogPinsCreatePinnedVersionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.pluginsCatalogPinsCreatePinnedVersionRaw(
      {
        name: name,
        type: type,
        pluginsCatalogPinsCreatePinnedVersionRequest: pluginsCatalogPinsCreatePinnedVersionRequest,
  ...
  /**
   */
  async pluginsCatalogPinsListPinnedVersionsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PluginsCatalogPinsListPinnedVersionsResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PluginsCatalogPinsListPinnedVersionsResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async pluginsCatalogPinsListPinnedVersions(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<PluginsCatalogPinsListPinnedVersionsResponse> {
   ...
   */
  async pluginsCatalogPinsReadPinnedVersionRaw(
    requestParameters: SystemApiPluginsCatalogPinsReadPinnedVersionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PluginsCatalogPinsReadPinnedVersionResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PluginsCatalogPinsReadPinnedVersionResponseFromJSON(jsonValue)
    );
  }
   ...
   * Return the pinned version for the plugin with the given type and name.
   */
  async pluginsCatalogPinsReadPinnedVersion(
    name: string,
    type: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<PluginsCatalogPinsReadPinnedVersionResponse> {
    const response = await this.pluginsCatalogPinsReadPinnedVersionRaw(
      { name: name, type: type },
      initOverrides
    );
    return await response.value();
   ...
   */
  async pluginsCatalogPinsRemovePinnedVersionRaw(
    requestParameters: SystemApiPluginsCatalogPinsRemovePinnedVersionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Remove any pinned version for the plugin with the given type and name.
   */
  async pluginsCatalogPinsRemovePinnedVersion(
    name: string,
    type: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.pluginsCatalogPinsRemovePinnedVersionRaw({ name: name, type: type }, initOverrides);
  }

  /**
   * Return the configuration data for the plugin with the given name.
   */
  async pluginsCatalogReadPluginConfigurationRaw(
    requestParameters: SystemApiPluginsCatalogReadPluginConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PluginsCatalogReadPluginConfigurationResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    const response = await this.request(
      {
        path: `/sys/plugins/catalog/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'GET',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PluginsCatalogReadPluginConfigurationResponseFromJSON(jsonValue)
    );
  }
   ...
   * Return the configuration data for the plugin with the given name.
   */
  async pluginsCatalogReadPluginConfiguration(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<PluginsCatalogReadPluginConfigurationResponse> {
   ...
   * Return the configuration data for the plugin with the given name.
   */
  async pluginsCatalogReadPluginConfigurationWithTypeRaw(
    requestParameters: SystemApiPluginsCatalogReadPluginConfigurationWithTypeRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PluginsCatalogReadPluginConfigurationWithTypeResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PluginsCatalogReadPluginConfigurationWithTypeResponseFromJSON(jsonValue)
    );
  }
   ...
   * Return the configuration data for the plugin with the given name.
   */
  async pluginsCatalogReadPluginConfigurationWithType(
    name: string,
    type: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<PluginsCatalogReadPluginConfigurationWithTypeResponse> {
    const response = await this.pluginsCatalogReadPluginConfigurationWithTypeRaw(
      { name: name, type: type },
      initOverrides
    );
    return await response.value();
   ...
   */
  async pluginsCatalogRegisterPluginRaw(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: PluginsCatalogRegisterPluginRequestToJSON(
          requestParameters['pluginsCatalogRegisterPluginRequest']
        ),
      },
      initOverrides
    );
   ...
   * Register a new plugin, or updates an existing one with the supplied name.
   */
  async pluginsCatalogRegisterPlugin(
    name: string,
    pluginsCatalogRegisterPluginRequest: PluginsCatalogRegisterPluginRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.pluginsCatalogRegisterPluginRaw(
      { name: name, pluginsCatalogRegisterPluginRequest: pluginsCatalogRegisterPluginRequest },
      initOverrides
    );
  }
   ...
   * Register a new plugin, or updates an existing one with the supplied name.
   */
  async pluginsCatalogRegisterPluginWithTypeRaw(
    requestParameters: SystemApiPluginsCatalogRegisterPluginWithTypeOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: PluginsCatalogRegisterPluginWithTypeRequestToJSON(
          requestParameters['pluginsCatalogRegisterPluginWithTypeRequest']
        ),
      },
      initOverrides
    );
   ...
   * Register a new plugin, or updates an existing one with the supplied name.
   */
  async pluginsCatalogRegisterPluginWithType(
    name: string,
    type: string,
    pluginsCatalogRegisterPluginWithTypeRequest: PluginsCatalogRegisterPluginWithTypeRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.pluginsCatalogRegisterPluginWithTypeRaw(
      {
        name: name,
        type: type,
        pluginsCatalogRegisterPluginWithTypeRequest: pluginsCatalogRegisterPluginWithTypeRequest,
   ...
   */
  async pluginsCatalogRemovePluginRaw(
    requestParameters: SystemApiPluginsCatalogRemovePluginRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Remove the plugin with the given name.
   */
  async pluginsCatalogRemovePlugin(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.pluginsCatalogRemovePluginRaw({ name: name }, initOverrides);
  }

  /**
   * Remove the plugin with the given name.
   */
  async pluginsCatalogRemovePluginWithTypeRaw(
    requestParameters: SystemApiPluginsCatalogRemovePluginWithTypeRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Remove the plugin with the given name.
   */
  async pluginsCatalogRemovePluginWithType(
    name: string,
    type: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.pluginsCatalogRemovePluginWithTypeRaw({ name: name, type: type }, initOverrides);
  }
   ...
   */
  async pluginsReloadBackendsRaw(
    requestParameters: SystemApiPluginsReloadBackendsOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PluginsReloadBackendsResponse>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PluginsReloadBackendsResponseFromJSON(jsonValue)
    );
  }
   ...
   * Reload mounted plugin backends.
   */
  async pluginsReloadBackends(
    pluginsReloadBackendsRequest: PluginsReloadBackendsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<PluginsReloadBackendsResponse> {
    const response = await this.pluginsReloadBackendsRaw(
      { pluginsReloadBackendsRequest: pluginsReloadBackendsRequest },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async pluginsRuntimesCatalogListPluginsRuntimesRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PluginsRuntimesCatalogListPluginsRuntimesResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PluginsRuntimesCatalogListPluginsRuntimesResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async pluginsRuntimesCatalogListPluginsRuntimes(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<PluginsRuntimesCatalogListPluginsRuntimesResponse> {
  ...
  /**
   */
  async pluginsRuntimesCatalogListPluginsRuntimes_3Raw(
    ...
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
        'list',
        'Required parameter "list" was null or undefined when calling pluginsRuntimesCatalogListPluginsRuntimes_3().'
      );
    }
  ...
  /**
   */
  async pluginsRuntimesCatalogListPluginsRuntimes_3(
    list: PluginsRuntimesCatalogListPluginsRuntimes0ListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<PluginsRuntimesCatalogListPluginsRuntimesResponse> {
    const response = await this.pluginsRuntimesCatalogListPluginsRuntimes_3Raw({ list: list }, initOverrides);
    return await response.value();
  }
   ...
   */
  async pluginsRuntimesCatalogReadPluginRuntimeConfigurationRaw(
    requestParameters: SystemApiPluginsRuntimesCatalogReadPluginRuntimeConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PluginsRuntimesCatalogReadPluginRuntimeConfigurationResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PluginsRuntimesCatalogReadPluginRuntimeConfigurationResponseFromJSON(jsonValue)
    );
  }
   ...
   * Return the configuration data for the plugin runtime with the given name.
   */
  async pluginsRuntimesCatalogReadPluginRuntimeConfiguration(
    name: string,
    type: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<PluginsRuntimesCatalogReadPluginRuntimeConfigurationResponse> {
    const response = await this.pluginsRuntimesCatalogReadPluginRuntimeConfigurationRaw(
      { name: name, type: type },
      initOverrides
    );
    return await response.value();
   ...
   */
  async pluginsRuntimesCatalogRegisterPluginRuntimeRaw(
    requestParameters: SystemApiPluginsRuntimesCatalogRegisterPluginRuntimeOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: PluginsRuntimesCatalogRegisterPluginRuntimeRequestToJSON(
          requestParameters['pluginsRuntimesCatalogRegisterPluginRuntimeRequest']
        ),
      },
      initOverrides
    );
   ...
   * Register a new plugin runtime, or updates an existing one with the supplied name.
   */
  async pluginsRuntimesCatalogRegisterPluginRuntime(
    name: string,
    type: string,
    pluginsRuntimesCatalogRegisterPluginRuntimeRequest: PluginsRuntimesCatalogRegisterPluginRuntimeRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.pluginsRuntimesCatalogRegisterPluginRuntimeRaw(
      {
        name: name,
        type: type,
        pluginsRuntimesCatalogRegisterPluginRuntimeRequest:
   ...
   */
  async pluginsRuntimesCatalogRemovePluginRuntimeRaw(
   ...
   * Remove the plugin runtime with the given name.
   */
  async pluginsRuntimesCatalogRemovePluginRuntime(
    name: string,
    type: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.pluginsRuntimesCatalogRemovePluginRuntimeRaw({ name: name, type: type }, initOverrides);
  }

  /**
   * Delete the ACL policy with the given name.
   */
  async policiesDeleteAclPolicyRaw(
    requestParameters: SystemApiPoliciesDeleteAclPolicyRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/policies/acl/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'DELETE',
   ...
   * Delete the ACL policy with the given name.
   */
  async policiesDeleteAclPolicy(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.policiesDeleteAclPolicyRaw({ name: name }, initOverrides);
  }

  /**
   * Delete the policy with the given name.
   */
  async policiesDeleteAclPolicy2Raw(
    requestParameters: SystemApiPoliciesDeleteAclPolicy2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Delete the policy with the given name.
   */
  async policiesDeleteAclPolicy2(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.policiesDeleteAclPolicy2Raw({ name: name }, initOverrides);
  }

  /**
   * Delete a password policy.
   */
  async policiesDeletePasswordPolicyRaw(
    requestParameters: SystemApiPoliciesDeletePasswordPolicyRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/policies/password/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'DELETE',
   ...
   * Delete a password policy.
   */
  async policiesDeletePasswordPolicy(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.policiesDeletePasswordPolicyRaw({ name: name }, initOverrides);
  }

  /**
   * Generate a password from an existing password policy.
   */
  async policiesGeneratePasswordFromPasswordPolicyRaw(
    requestParameters: SystemApiPoliciesGeneratePasswordFromPasswordPolicyRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PoliciesGeneratePasswordFromPasswordPolicyResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    const response = await this.request(
      {
        path: `/sys/policies/password/{name}/generate`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'GET',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PoliciesGeneratePasswordFromPasswordPolicyResponseFromJSON(jsonValue)
    );
  }
   ...
   * Generate a password from an existing password policy.
   */
  async policiesGeneratePasswordFromPasswordPolicy(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<PoliciesGeneratePasswordFromPasswordPolicyResponse> {
  ...
  /**
   */
  async policiesListAclPoliciesRaw(
    requestParameters: SystemApiPoliciesListAclPoliciesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PoliciesListAclPoliciesResponse>> {
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
        'list',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PoliciesListAclPoliciesResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async policiesListAclPolicies(
    list: PoliciesListAclPoliciesListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<PoliciesListAclPoliciesResponse> {
  ...
  /**
   */
  async policiesListAclPolicies2Raw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PoliciesListAclPolicies2Response>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PoliciesListAclPolicies2ResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async policiesListAclPolicies2(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<PoliciesListAclPolicies2Response> {
  ...
  /**
   */
  async policiesListAclPolicies3Raw(
    requestParameters: SystemApiPoliciesListAclPolicies3Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PoliciesListAclPolicies3Response>> {
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
        'list',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PoliciesListAclPolicies3ResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async policiesListAclPolicies3(
    list: PoliciesListAclPolicies3ListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<PoliciesListAclPolicies3Response> {
   ...
   */
  async policiesListPasswordPoliciesRaw(
    requestParameters: SystemApiPoliciesListPasswordPoliciesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
   ...
   * List the existing password policies.
   */
  async policiesListPasswordPolicies(
    list: PoliciesListPasswordPoliciesListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
   ...
   */
  async policiesReadAclPolicyRaw(
    requestParameters: SystemApiPoliciesReadAclPolicyRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PoliciesReadAclPolicyResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PoliciesReadAclPolicyResponseFromJSON(jsonValue)
    );
  }
   ...
   * Retrieve information about the named ACL policy.
   */
  async policiesReadAclPolicy(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<PoliciesReadAclPolicyResponse> {
   ...
   */
  async policiesReadAclPolicy2Raw(
    requestParameters: SystemApiPoliciesReadAclPolicy2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PoliciesReadAclPolicy2Response>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PoliciesReadAclPolicy2ResponseFromJSON(jsonValue)
    );
  }
   ...
   * Retrieve the policy body for the named policy.
   */
  async policiesReadAclPolicy2(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<PoliciesReadAclPolicy2Response> {
   ...
   */
  async policiesReadPasswordPolicyRaw(
    requestParameters: SystemApiPoliciesReadPasswordPolicyRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PoliciesReadPasswordPolicyResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PoliciesReadPasswordPolicyResponseFromJSON(jsonValue)
    );
  }
   ...
   * Retrieve an existing password policy.
   */
  async policiesReadPasswordPolicy(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<PoliciesReadPasswordPolicyResponse> {
   ...
   */
  async policiesWriteAclPolicyRaw(
    requestParameters: SystemApiPoliciesWriteAclPolicyOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Add a new or update an existing ACL policy.
   */
  async policiesWriteAclPolicy(
    name: string,
    policiesWriteAclPolicyRequest: PoliciesWriteAclPolicyRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.policiesWriteAclPolicyRaw(
      { name: name, policiesWriteAclPolicyRequest: policiesWriteAclPolicyRequest },
      initOverrides
    );
  }
   ...
   */
  async policiesWriteAclPolicy2Raw(
    requestParameters: SystemApiPoliciesWriteAclPolicy2OperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Add a new or update an existing policy.
   */
  async policiesWriteAclPolicy2(
    name: string,
    policiesWriteAclPolicy2Request: PoliciesWriteAclPolicy2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.policiesWriteAclPolicy2Raw(
      { name: name, policiesWriteAclPolicy2Request: policiesWriteAclPolicy2Request },
      initOverrides
    );
  }
   ...
   */
  async policiesWritePasswordPolicyRaw(
    requestParameters: SystemApiPoliciesWritePasswordPolicyOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: PoliciesWritePasswordPolicyRequestToJSON(
   ...
   * Add a new or update an existing password policy.
   */
  async policiesWritePasswordPolicy(
    name: string,
    policiesWritePasswordPolicyRequest: PoliciesWritePasswordPolicyRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.policiesWritePasswordPolicyRaw(
      { name: name, policiesWritePasswordPolicyRequest: policiesWritePasswordPolicyRequest },
      initOverrides
    );
  }
   ...
   * Returns a sampling of all past memory allocations.
   */
  async pprofMemoryAllocationsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Returns a sampling of memory allocations of live object.
   */
  async pprofMemoryAllocationsLiveRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Returns a sampling of memory allocations of live object.
   */
  async pprofMemoryAllocationsLive(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
  ...
  /**
   */
  async queryTokenAccessorCapabilitiesRaw(
    requestParameters: SystemApiQueryTokenAccessorCapabilitiesOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: QueryTokenAccessorCapabilitiesRequestToJSON(
          requestParameters['queryTokenAccessorCapabilitiesRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async queryTokenAccessorCapabilities(
    queryTokenAccessorCapabilitiesRequest: QueryTokenAccessorCapabilitiesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.queryTokenAccessorCapabilitiesRaw(
      { queryTokenAccessorCapabilitiesRequest: queryTokenAccessorCapabilitiesRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async queryTokenCapabilitiesRaw(
    requestParameters: SystemApiQueryTokenCapabilitiesOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
  ...
  /**
   */
  async queryTokenCapabilities(
    queryTokenCapabilitiesRequest: QueryTokenCapabilitiesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.queryTokenCapabilitiesRaw(
      { queryTokenCapabilitiesRequest: queryTokenCapabilitiesRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async queryTokenSelfCapabilitiesRaw(
    requestParameters: SystemApiQueryTokenSelfCapabilitiesOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
  ...
  /**
   */
  async queryTokenSelfCapabilities(
    queryTokenSelfCapabilitiesRequest: QueryTokenSelfCapabilitiesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.queryTokenSelfCapabilitiesRaw(
      { queryTokenSelfCapabilitiesRequest: queryTokenSelfCapabilitiesRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async rateLimitQuotasConfigureRaw(
    requestParameters: SystemApiRateLimitQuotasConfigureOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
  ...
  /**
   */
  async rateLimitQuotasConfigure(
    rateLimitQuotasConfigureRequest: RateLimitQuotasConfigureRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.rateLimitQuotasConfigureRaw(
      { rateLimitQuotasConfigureRequest: rateLimitQuotasConfigureRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async rateLimitQuotasDeleteRaw(
    requestParameters: SystemApiRateLimitQuotasDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/quotas/rate-limit/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'DELETE',
  ...
  /**
   */
  async rateLimitQuotasDelete(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.rateLimitQuotasDeleteRaw({ name: name }, initOverrides);
  }

  /**
   */
  async rateLimitQuotasListRaw(
    requestParameters: SystemApiRateLimitQuotasListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async rateLimitQuotasReadRaw(
    requestParameters: SystemApiRateLimitQuotasReadRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RateLimitQuotasReadResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RateLimitQuotasReadResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async rateLimitQuotasRead(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RateLimitQuotasReadResponse> {
  ...
  /**
   */
  async rateLimitQuotasReadConfigurationRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RateLimitQuotasReadConfigurationResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RateLimitQuotasReadConfigurationResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async rateLimitQuotasReadConfiguration(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RateLimitQuotasReadConfigurationResponse> {
  ...
  /**
   */
  async rateLimitQuotasWriteRaw(
    requestParameters: SystemApiRateLimitQuotasWriteOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async rateLimitQuotasWrite(
    name: string,
    rateLimitQuotasWriteRequest: RateLimitQuotasWriteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.rateLimitQuotasWriteRaw(
      { name: name, rateLimitQuotasWriteRequest: rateLimitQuotasWriteRequest },
      initOverrides
    );
  }
   ...
   */
  async rawDeleteRaw(
    requestParameters: SystemApiRawDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
   ...
   * Delete the key with given path.
   */
  async rawDelete(path: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
    await this.rawDeleteRaw({ path: path }, initOverrides);
  }
   ...
   */
  async rawListRaw(
    requestParameters: SystemApiRawListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
   ...
   */
  async rawReadRaw(
    requestParameters: SystemApiRawReadRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RawReadResponse>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
        'path',
   ...
   */
  async rawWriteRaw(
    requestParameters: SystemApiRawWriteOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
  ...
  async rawWrite(
    ...
    await this.rawWriteRaw({ path: path, rawWriteRequest: rawWriteRequest }, initOverrides);
  }

  /**
   * Returns the available and activated activation-flagged features.
   */
  async readActivationFlagsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   */
  async readInitializationStatusRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   */
  async readSanitizedConfigurationStateRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Return a sanitized version of the Vault server configuration.
   */
  async readSanitizedConfigurationState(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
   ...
   */
  async readVerbosityLevelForRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Read the current Census agent\'s snapshot fields.
   */
  async readVerbosityLevelFor(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
    await this.readVerbosityLevelForRaw(initOverrides);
  }

  /**
   * Read the current status of the request limiter.
   */
  async readVerbosityLevelFor_4Raw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Read the current status of the request limiter.
   */
  async readVerbosityLevelFor_4(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
    await this.readVerbosityLevelFor_4Raw(initOverrides);
  }

  /**
   * Look up wrapping properties for the given token.
   */
  async readWrappingPropertiesRaw(
    requestParameters: SystemApiReadWrappingPropertiesOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ReadWrappingPropertiesResponse>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ReadWrappingPropertiesResponseFromJSON(jsonValue)
    );
  }
   ...
   * Look up wrapping properties for the given token.
   */
  async readWrappingProperties(
    readWrappingPropertiesRequest: ReadWrappingPropertiesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ReadWrappingPropertiesResponse> {
    const response = await this.readWrappingPropertiesRaw(
      { readWrappingPropertiesRequest: readWrappingPropertiesRequest },
      initOverrides
    );
    return await response.value();
   ...
   */
  async readWrappingProperties2Raw(
    requestParameters: SystemApiReadWrappingProperties2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ReadWrappingProperties2Response>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ReadWrappingProperties2ResponseFromJSON(jsonValue)
    );
  }
   ...
   * Look up wrapping properties for the requester\'s token.
   */
  async readWrappingProperties2(
    token?: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ReadWrappingProperties2Response> {
   ...
   */
  async rekeyAttemptInitializeRaw(
    requestParameters: SystemApiRekeyAttemptInitializeOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RekeyAttemptInitializeResponse>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RekeyAttemptInitializeResponseFromJSON(jsonValue)
    );
  }
   ...
   * Initializes a new rekey attempt.
   */
  async rekeyAttemptInitialize(
    rekeyAttemptInitializeRequest: RekeyAttemptInitializeRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RekeyAttemptInitializeResponse> {
    const response = await this.rekeyAttemptInitializeRaw(
      { rekeyAttemptInitializeRequest: rekeyAttemptInitializeRequest },
      initOverrides
    );
    return await response.value();
   ...
   */
  async rekeyAttemptReadProgressRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RekeyAttemptReadProgressResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RekeyAttemptReadProgressResponseFromJSON(jsonValue)
    );
  }
   ...
   * Reads the configuration and progress of the current rekey attempt.
   */
  async rekeyAttemptReadProgress(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RekeyAttemptReadProgressResponse> {
   ...
   */
  async rekeyAttemptUpdateRaw(
    requestParameters: SystemApiRekeyAttemptUpdateOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RekeyAttemptUpdateResponse>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RekeyAttemptUpdateResponseFromJSON(jsonValue)
    );
  }
   ...
   * Enter a single unseal key share to progress the rekey of the Vault.
   */
  async rekeyAttemptUpdate(
    rekeyAttemptUpdateRequest: RekeyAttemptUpdateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RekeyAttemptUpdateResponse> {
    const response = await this.rekeyAttemptUpdateRaw(
      { rekeyAttemptUpdateRequest: rekeyAttemptUpdateRequest },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async rekeyDeleteBackupRecoveryKeyRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async rekeyDeleteBackupRecoveryKey(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
   ...
   */
  async rekeyReadBackupKeyRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RekeyReadBackupKeyResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RekeyReadBackupKeyResponseFromJSON(jsonValue)
    );
  }
   ...
   * Return the backup copy of PGP-encrypted unseal keys.
   */
  async rekeyReadBackupKey(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RekeyReadBackupKeyResponse> {
  ...
  /**
   */
  async rekeyReadBackupRecoveryKeyRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RekeyReadBackupRecoveryKeyResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RekeyReadBackupRecoveryKeyResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async rekeyReadBackupRecoveryKey(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RekeyReadBackupRecoveryKeyResponse> {
   ...
   */
  async rekeyVerificationCancelRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RekeyVerificationCancelResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RekeyVerificationCancelResponseFromJSON(jsonValue)
    );
  }
   ...
   * Cancel any in-progress rekey verification operation.
   */
  async rekeyVerificationCancel(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RekeyVerificationCancelResponse> {
   ...
   */
  async rekeyVerificationReadProgressRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RekeyVerificationReadProgressResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RekeyVerificationReadProgressResponseFromJSON(jsonValue)
    );
  }
   ...
   * Read the configuration and progress of the current rekey verification attempt.
   */
  async rekeyVerificationReadProgress(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RekeyVerificationReadProgressResponse> {
   ...
   */
  async rekeyVerificationUpdateRaw(
    requestParameters: SystemApiRekeyVerificationUpdateOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RekeyVerificationUpdateResponse>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RekeyVerificationUpdateResponseFromJSON(jsonValue)
    );
  }
   ...
   * Enter a single new key share to progress the rekey verification operation.
   */
  async rekeyVerificationUpdate(
    rekeyVerificationUpdateRequest: RekeyVerificationUpdateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RekeyVerificationUpdateResponse> {
    const response = await this.rekeyVerificationUpdateRaw(
      { rekeyVerificationUpdateRequest: rekeyVerificationUpdateRequest },
      initOverrides
    );
    return await response.value();
   ...
   */
  async reloadPluginsRaw(
    requestParameters: SystemApiReloadPluginsOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ReloadPluginsResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
  ...
  async reloadPlugins(
    ...
    const response = await this.reloadPluginsRaw(
      { name: name, type: type, reloadPluginsRequest: reloadPluginsRequest },
      initOverrides
    );
    return await response.value();
  }
   ...
   */
  async reloadSubsystemRaw(
    requestParameters: SystemApiReloadSubsystemRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/sys/config/reload/{subsystem}`.replace(
          `{${'subsystem'}}`,
          encodeURIComponent(String(requestParameters['subsystem']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
   ...
   * Reload the given subsystem
   */
  async reloadSubsystem(
    subsystem: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.reloadSubsystemRaw({ subsystem: subsystem }, initOverrides);
  }
   ...
   */
  async remountRaw(
    requestParameters: SystemApiRemountOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RemountResponse>> {
   ...
   */
  async remountStatusRaw(
    requestParameters: SystemApiRemountStatusRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RemountStatusResponse>> {
    ...
    const response = await this.request(
      {
        path: `/sys/remount/status/{migration_id}`.replace(
          `{${'migration_id'}}`,
          encodeURIComponent(String(requestParameters['migrationId']))
        ),
        method: 'GET',
        headers: headerParameters,
        query: queryParameters,
   ...
   */
  async rewrapRaw(
    requestParameters: SystemApiRewrapOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
  ...
  async rewrap(
    ...
    await this.rewrapRaw({ rewrapRequest: rewrapRequest }, initOverrides);
  }

  /**
   * Cancels any in-progress root generation attempt.
   */
  async rootTokenGenerationCancelRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Cancels any in-progress root generation attempt.
   */
  async rootTokenGenerationCancel2Raw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Cancels any in-progress root generation attempt.
   */
  async rootTokenGenerationCancel2(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
   ...
   */
  async rootTokenGenerationInitializeRaw(
    requestParameters: SystemApiRootTokenGenerationInitializeOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RootTokenGenerationInitializeResponse>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: RootTokenGenerationInitializeRequestToJSON(
          requestParameters['rootTokenGenerationInitializeRequest']
        ),
      },
      initOverrides
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RootTokenGenerationInitializeResponseFromJSON(jsonValue)
    );
  }
   ...
   * Initializes a new root generation attempt.
   */
  async rootTokenGenerationInitialize(
    rootTokenGenerationInitializeRequest: RootTokenGenerationInitializeRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RootTokenGenerationInitializeResponse> {
    const response = await this.rootTokenGenerationInitializeRaw(
      { rootTokenGenerationInitializeRequest: rootTokenGenerationInitializeRequest },
      initOverrides
    );
    return await response.value();
   ...
   * Initializes a new root generation attempt.
   */
  async rootTokenGenerationInitialize2Raw(
    requestParameters: SystemApiRootTokenGenerationInitialize2OperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RootTokenGenerationInitialize2Response>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: RootTokenGenerationInitialize2RequestToJSON(
          requestParameters['rootTokenGenerationInitialize2Request']
        ),
      },
      initOverrides
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RootTokenGenerationInitialize2ResponseFromJSON(jsonValue)
    );
  }
   ...
   * Initializes a new root generation attempt.
   */
  async rootTokenGenerationInitialize2(
    rootTokenGenerationInitialize2Request: RootTokenGenerationInitialize2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RootTokenGenerationInitialize2Response> {
    const response = await this.rootTokenGenerationInitialize2Raw(
      { rootTokenGenerationInitialize2Request: rootTokenGenerationInitialize2Request },
      initOverrides
    );
    return await response.value();
   ...
   */
  async rootTokenGenerationReadProgressRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RootTokenGenerationReadProgressResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RootTokenGenerationReadProgressResponseFromJSON(jsonValue)
    );
  }
   ...
   * Read the configuration and progress of the current root generation attempt.
   */
  async rootTokenGenerationReadProgress(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RootTokenGenerationReadProgressResponse> {
   ...
   * Read the configuration and progress of the current root generation attempt.
   */
  async rootTokenGenerationReadProgress2Raw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RootTokenGenerationReadProgress2Response>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RootTokenGenerationReadProgress2ResponseFromJSON(jsonValue)
    );
  }
   ...
   * Read the configuration and progress of the current root generation attempt.
   */
  async rootTokenGenerationReadProgress2(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RootTokenGenerationReadProgress2Response> {
   ...
   */
  async rootTokenGenerationUpdateRaw(
    requestParameters: SystemApiRootTokenGenerationUpdateOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RootTokenGenerationUpdateResponse>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RootTokenGenerationUpdateResponseFromJSON(jsonValue)
    );
  }
   ...
   * Enter a single unseal key share to progress the root generation attempt.
   */
  async rootTokenGenerationUpdate(
    rootTokenGenerationUpdateRequest: RootTokenGenerationUpdateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RootTokenGenerationUpdateResponse> {
    const response = await this.rootTokenGenerationUpdateRaw(
      { rootTokenGenerationUpdateRequest: rootTokenGenerationUpdateRequest },
      initOverrides
    );
    return await response.value();
  ...
  async sealStatusRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SealStatusResponse>> {
    const queryParameters: any = {};
   ...
   */
  async subscriptionsCreateRaw(
    requestParameters: SystemApiSubscriptionsCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SubscriptionsCreateResponse>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SubscriptionsCreateResponseFromJSON(jsonValue)
    );
  }
   ...
   */
  async subscriptionsCreate_5Raw(
    requestParameters: SystemApiSubscriptionsCreate0Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['id'] == null) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter "id" was null or undefined when calling subscriptionsCreate_5().'
      );
    }
    ...
    if (requestParameters['plugin'] == null) {
      throw new runtime.RequiredError(
        'plugin',
        'Required parameter "plugin" was null or undefined when calling subscriptionsCreate_5().'
      );
    }
   ...
   * Deletes the specified event notification subscription and stops sending event notifications to it.
   */
  async subscriptionsCreate_5(
    id: string,
    plugin: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.subscriptionsCreate_5Raw({ id: id, plugin: plugin }, initOverrides);
  }

  /**
   * Listing event notifications subscriptions
   */
  async subscriptionsListEventsSubscriptionsRaw(
    requestParameters: SystemApiSubscriptionsListEventsSubscriptionsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SubscriptionsListEventsSubscriptionsResponse>> {
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
        'list',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SubscriptionsListEventsSubscriptionsResponseFromJSON(jsonValue)
    );
  }
   ...
   * Listing event notifications subscriptions
   */
  async subscriptionsListEventsSubscriptions(
    list: SubscriptionsListEventsSubscriptionsListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SubscriptionsListEventsSubscriptionsResponse> {
   ...
   * Listing event notifications subscriptions
   */
  async subscriptionsReadEventsSubscriptionsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SubscriptionsReadEventsSubscriptionsResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SubscriptionsReadEventsSubscriptionsResponseFromJSON(jsonValue)
    );
  }
   ...
   * Listing event notifications subscriptions
   */
  async subscriptionsReadEventsSubscriptions(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SubscriptionsReadEventsSubscriptionsResponse> {
   ...
   */
  async subscriptionsWriteEventsSubscriptionsRaw(
    requestParameters: SystemApiSubscriptionsWriteEventsSubscriptionsOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SubscriptionsWriteEventsSubscriptionsResponse>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SubscriptionsWriteEventsSubscriptionsRequestToJSON(
          requestParameters['subscriptionsWriteEventsSubscriptionsRequest']
        ),
      },
      initOverrides
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SubscriptionsWriteEventsSubscriptionsResponseFromJSON(jsonValue)
    );
  }
   ...
   * Creates a new event notification subscription and starts to send events to it.
   */
  async subscriptionsWriteEventsSubscriptions(
    subscriptionsWriteEventsSubscriptionsRequest: SubscriptionsWriteEventsSubscriptionsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SubscriptionsWriteEventsSubscriptionsResponse> {
    const response = await this.subscriptionsWriteEventsSubscriptionsRaw(
      { subscriptionsWriteEventsSubscriptionsRequest: subscriptionsWriteEventsSubscriptionsRequest },
      initOverrides
    );
    return await response.value();
   ...
   */
  async systemDeleteConfigControlGroupRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Configure control group global settings.
   */
  async systemDeleteConfigControlGroup(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemDeleteConfigControlGroupRaw(initOverrides);
  }

  /**
   */
  async systemDeleteManagedKeysTypeNameRaw(
    requestParameters: SystemApiSystemDeleteManagedKeysTypeNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async systemDeleteManagedKeysTypeName(
    name: string,
    type: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemDeleteManagedKeysTypeNameRaw({ name: name, type: type }, initOverrides);
  }

  /**
   * Defines or updates a Duo MFA method.
   */
  async systemDeleteMfaMethodDuoNameRaw(
    requestParameters: SystemApiSystemDeleteMfaMethodDuoNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/mfa/method/duo/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'DELETE',
   ...
   * Defines or updates a Duo MFA method.
   */
  async systemDeleteMfaMethodDuoName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemDeleteMfaMethodDuoNameRaw({ name: name }, initOverrides);
  }

  /**
   * Defines or updates an Okta MFA method.
   */
  async systemDeleteMfaMethodOktaNameRaw(
    requestParameters: SystemApiSystemDeleteMfaMethodOktaNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/mfa/method/okta/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'DELETE',
   ...
   * Defines or updates an Okta MFA method.
   */
  async systemDeleteMfaMethodOktaName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemDeleteMfaMethodOktaNameRaw({ name: name }, initOverrides);
  }

  /**
   * Defines or updates a PingID MFA method.
   */
  async systemDeleteMfaMethodPingidNameRaw(
    requestParameters: SystemApiSystemDeleteMfaMethodPingidNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/mfa/method/pingid/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'DELETE',
   ...
   * Defines or updates a PingID MFA method.
   */
  async systemDeleteMfaMethodPingidName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemDeleteMfaMethodPingidNameRaw({ name: name }, initOverrides);
  }

  /**
   * Defines or updates a TOTP MFA method.
   */
  async systemDeleteMfaMethodTotpNameRaw(
    requestParameters: SystemApiSystemDeleteMfaMethodTotpNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/mfa/method/totp/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'DELETE',
   ...
   * Defines or updates a TOTP MFA method.
   */
  async systemDeleteMfaMethodTotpName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemDeleteMfaMethodTotpNameRaw({ name: name }, initOverrides);
  }

  /**
   */
  async systemDeleteNamespacesPathRaw(
    requestParameters: SystemApiSystemDeleteNamespacesPathRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/namespaces/{path}`.replace(
          `{${'path'}}`,
          encodeURIComponent(String(requestParameters['path']))
        ),
        method: 'DELETE',
  ...
  /**
   */
  async systemDeleteNamespacesPath(
    path: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemDeleteNamespacesPathRaw({ path: path }, initOverrides);
  }

  /**
   * Read, Modify, or Delete an access control policy.
   */
  async systemDeletePoliciesEgpNameRaw(
    ...
    const response = await this.request(
      {
        path: `/sys/policies/egp/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'DELETE',
   ...
   * Read, Modify, or Delete an access control policy.
   */
  async systemDeletePoliciesEgpName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemDeletePoliciesEgpNameRaw({ name: name }, initOverrides);
  }

  /**
   * Read, Modify, or Delete an access control policy.
   */
  async systemDeletePoliciesRgpNameRaw(
    requestParameters: SystemApiSystemDeletePoliciesRgpNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/policies/rgp/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'DELETE',
   ...
   * Read, Modify, or Delete an access control policy.
   */
  async systemDeletePoliciesRgpName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemDeletePoliciesRgpNameRaw({ name: name }, initOverrides);
  }

  /**
   */
  async systemDeleteQuotasLeaseCountNameRaw(
    requestParameters: SystemApiSystemDeleteQuotasLeaseCountNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/quotas/lease-count/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'DELETE',
  ...
  /**
   */
  async systemDeleteQuotasLeaseCountName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemDeleteQuotasLeaseCountNameRaw({ name: name }, initOverrides);
  }

  /**
   */
  async systemDeleteReplicationPerformancePrimaryPathsFilterIdRaw(
    requestParameters: SystemApiSystemDeleteReplicationPerformancePrimaryPathsFilterIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['id'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/replication/performance/primary/paths-filter/{id}`.replace(
          `{${'id'}}`,
  ...
  /**
   */
  async systemDeleteReplicationPerformancePrimaryPathsFilterId(
    id: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemDeleteReplicationPerformancePrimaryPathsFilterIdRaw({ id: id }, initOverrides);
  }

  /**
   * Delete automated raft snapshot configuration
   */
  async systemDeleteStorageRaftSnapshotAutoConfigNameRaw(
    requestParameters: SystemApiSystemDeleteStorageRaftSnapshotAutoConfigNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/storage/raft/snapshot-auto/config/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'DELETE',
   ...
   * Delete automated raft snapshot configuration
   */
  async systemDeleteStorageRaftSnapshotAutoConfigName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemDeleteStorageRaftSnapshotAutoConfigNameRaw({ name: name }, initOverrides);
  }

  /**
   */
  async systemDeleteSyncConfigRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemDeleteSyncConfigResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemDeleteSyncConfigResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemDeleteSyncConfig(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemDeleteSyncConfigResponse> {
  ...
  /**
   */
  async systemDeleteSyncDestinationsAwsSmNameRaw(
    requestParameters: SystemApiSystemDeleteSyncDestinationsAwsSmNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/sync/destinations/aws-sm/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'DELETE',
  ...
  /**
   */
  async systemDeleteSyncDestinationsAwsSmName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemDeleteSyncDestinationsAwsSmNameRaw({ name: name }, initOverrides);
  }

  /**
   */
  async systemDeleteSyncDestinationsAzureKvNameRaw(
    requestParameters: SystemApiSystemDeleteSyncDestinationsAzureKvNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/sync/destinations/azure-kv/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'DELETE',
  ...
  /**
   */
  async systemDeleteSyncDestinationsAzureKvName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemDeleteSyncDestinationsAzureKvNameRaw({ name: name }, initOverrides);
  }

  /**
   */
  async systemDeleteSyncDestinationsGcpSmNameRaw(
    requestParameters: SystemApiSystemDeleteSyncDestinationsGcpSmNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/sync/destinations/gcp-sm/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'DELETE',
  ...
  /**
   */
  async systemDeleteSyncDestinationsGcpSmName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemDeleteSyncDestinationsGcpSmNameRaw({ name: name }, initOverrides);
  }

  /**
   */
  async systemDeleteSyncDestinationsGhNameRaw(
    requestParameters: SystemApiSystemDeleteSyncDestinationsGhNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/sync/destinations/gh/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'DELETE',
  ...
  /**
   */
  async systemDeleteSyncDestinationsGhName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemDeleteSyncDestinationsGhNameRaw({ name: name }, initOverrides);
  }

  /**
   */
  async systemDeleteSyncDestinationsInMemNameRaw(
    requestParameters: SystemApiSystemDeleteSyncDestinationsInMemNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/sync/destinations/in-mem/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'DELETE',
  ...
  /**
   */
  async systemDeleteSyncDestinationsInMemName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemDeleteSyncDestinationsInMemNameRaw({ name: name }, initOverrides);
  }

  /**
   */
  async systemDeleteSyncDestinationsVercelProjectNameRaw(
    requestParameters: SystemApiSystemDeleteSyncDestinationsVercelProjectNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/sync/destinations/vercel-project/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'DELETE',
  ...
  /**
   */
  async systemDeleteSyncDestinationsVercelProjectName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemDeleteSyncDestinationsVercelProjectNameRaw({ name: name }, initOverrides);
  }

  /**
   */
  async systemDeleteSyncGithubAppsNameRaw(
    requestParameters: SystemApiSystemDeleteSyncGithubAppsNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemDeleteSyncGithubAppsNameResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    const response = await this.request(
      {
        path: `/sys/sync/github-apps/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'DELETE',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemDeleteSyncGithubAppsNameResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemDeleteSyncGithubAppsName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemDeleteSyncGithubAppsNameResponse> {
  ...
  /**
   */
  async systemListManagedKeysTypeRaw(
    requestParameters: SystemApiSystemListManagedKeysTypeRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['type'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/managed-keys/{type}/`.replace(
          `{${'type'}}`,
          encodeURIComponent(String(requestParameters['type']))
        ),
        method: 'GET',
  ...
  /**
   */
  async systemListManagedKeysType(
    type: string,
    list: SystemListManagedKeysTypeListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
   ...
   */
  async systemListMfaMethodRaw(
    requestParameters: SystemApiSystemListMfaMethodRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async systemListNamespacesRaw(
    requestParameters: SystemApiSystemListNamespacesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
   ...
   */
  async systemListPoliciesEgpRaw(
    requestParameters: SystemApiSystemListPoliciesEgpRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
  ...
  async systemListPoliciesRgpRaw(
    requestParameters: SystemApiSystemListPoliciesRgpRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async systemListQuotasLeaseCountRaw(
    requestParameters: SystemApiSystemListQuotasLeaseCountRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async systemListQuotasLeaseCount(
    list: SystemListQuotasLeaseCountListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
   ...
   */
  async systemListStorageRaftSnapshotAutoConfigRaw(
    requestParameters: SystemApiSystemListStorageRaftSnapshotAutoConfigRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
   ...
   * List automated raft snapshot configurations
   */
  async systemListStorageRaftSnapshotAutoConfig(
    list: SystemListStorageRaftSnapshotAutoConfigListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
  ...
  /**
   */
  async systemListSyncAssociationsRaw(
    requestParameters: SystemApiSystemListSyncAssociationsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemListSyncAssociationsResponse>> {
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
        'list',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemListSyncAssociationsResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemListSyncAssociations(
    list: SystemListSyncAssociationsListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemListSyncAssociationsResponse> {
  ...
  /**
   */
  async systemListSyncDestinationsRaw(
    requestParameters: SystemApiSystemListSyncDestinationsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemListSyncDestinationsResponse>> {
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
        'list',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemListSyncDestinationsResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemListSyncDestinations(
    list: SystemListSyncDestinationsListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemListSyncDestinationsResponse> {
  ...
  /**
   */
  async systemListSyncDestinationsTypeRaw(
    requestParameters: SystemApiSystemListSyncDestinationsTypeRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemListSyncDestinationsTypeResponse>> {
    if (requestParameters['type'] == null) {
      throw new runtime.RequiredError(
        'type',
    ...
    const response = await this.request(
      {
        path: `/sys/sync/destinations/{type}/`.replace(
          `{${'type'}}`,
          encodeURIComponent(String(requestParameters['type']))
        ),
        method: 'GET',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemListSyncDestinationsTypeResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemListSyncDestinationsType(
    type: string,
    list: SystemListSyncDestinationsTypeListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemListSyncDestinationsTypeResponse> {
  ...
  /**
   */
  async systemListSyncGithubAppsRaw(
    requestParameters: SystemApiSystemListSyncGithubAppsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemListSyncGithubAppsResponse>> {
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
        'list',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemListSyncGithubAppsResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemListSyncGithubApps(
    list: SystemListSyncGithubAppsListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemListSyncGithubAppsResponse> {
   ...
   * Configure control group global settings.
   */
  async systemReadConfigControlGroupRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Configure control group global settings.
   */
  async systemReadConfigControlGroup(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadConfigControlGroupRaw(initOverrides);
  }
   ...
   * Gets the current status of the policy application mode for Vault.
   */
  async systemReadConfigGroupPolicyApplicationRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemReadConfigGroupPolicyApplicationResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemReadConfigGroupPolicyApplicationResponseFromJSON(jsonValue)
    );
  }
   ...
   * Gets the current status of the policy application mode for Vault.
   */
  async systemReadConfigGroupPolicyApplication(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemReadConfigGroupPolicyApplicationResponse> {
   ...
   */
  async systemReadLicenseStatusRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * The path responds to the following HTTP methods.      GET /         Returns information on the installed license      POST         Sets the license for the server
   */
  async systemReadLicenseStatus(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
    await this.systemReadLicenseStatusRaw(initOverrides);
  }

  /**
   */
  async systemReadManagedKeysTypeNameRaw(
    requestParameters: SystemApiSystemReadManagedKeysTypeNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async systemReadManagedKeysTypeName(
    name: string,
    type: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadManagedKeysTypeNameRaw({ name: name, type: type }, initOverrides);
  }

  /**
   * Defines or updates a Duo MFA method.
   */
  async systemReadMfaMethodDuoNameRaw(
    requestParameters: SystemApiSystemReadMfaMethodDuoNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Defines or updates a Duo MFA method.
   */
  async systemReadMfaMethodDuoName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadMfaMethodDuoNameRaw({ name: name }, initOverrides);
  }

  /**
   * Defines or updates an Okta MFA method.
   */
  async systemReadMfaMethodOktaNameRaw(
    requestParameters: SystemApiSystemReadMfaMethodOktaNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Defines or updates an Okta MFA method.
   */
  async systemReadMfaMethodOktaName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadMfaMethodOktaNameRaw({ name: name }, initOverrides);
  }

  /**
   * Defines or updates a PingID MFA method.
   */
  async systemReadMfaMethodPingidNameRaw(
    requestParameters: SystemApiSystemReadMfaMethodPingidNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Defines or updates a PingID MFA method.
   */
  async systemReadMfaMethodPingidName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadMfaMethodPingidNameRaw({ name: name }, initOverrides);
  }

  /**
   * Defines or updates a TOTP MFA method.
   */
  async systemReadMfaMethodTotpNameRaw(
    requestParameters: SystemApiSystemReadMfaMethodTotpNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Defines or updates a TOTP MFA method.
   */
  async systemReadMfaMethodTotpName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadMfaMethodTotpNameRaw({ name: name }, initOverrides);
  }

  /**
   * Generates a TOTP secret for the given method name on the entity of the   calling token.
   */
  async systemReadMfaMethodTotpNameGenerateRaw(
    ...
    const response = await this.request(
      {
        path: `/sys/mfa/method/totp/{name}/generate`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'GET',
   ...
   * Generates a TOTP secret for the given method name on the entity of the   calling token.
   */
  async systemReadMfaMethodTotpNameGenerate(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadMfaMethodTotpNameGenerateRaw({ name: name }, initOverrides);
  }

  /**
   */
  async systemReadNamespacesPathRaw(
    requestParameters: SystemApiSystemReadNamespacesPathRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async systemReadNamespacesPath(
    path: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadNamespacesPathRaw({ path: path }, initOverrides);
  }
   ...
   */
  async systemReadPluginsReloadBackendStatusRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Get the status of a cluster-scoped reload.
   */
  async systemReadPluginsReloadBackendStatus(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadPluginsReloadBackendStatusRaw(initOverrides);
  }

  /**
   * Read, Modify, or Delete an access control policy.
   */
  async systemReadPoliciesEgpNameRaw(
   ...
   * Read, Modify, or Delete an access control policy.
   */
  async systemReadPoliciesEgpName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadPoliciesEgpNameRaw({ name: name }, initOverrides);
  }

  /**
   * Read, Modify, or Delete an access control policy.
   */
  async systemReadPoliciesRgpNameRaw(
   ...
   * Read, Modify, or Delete an access control policy.
   */
  async systemReadPoliciesRgpName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadPoliciesRgpNameRaw({ name: name }, initOverrides);
  }

  /**
   */
  async systemReadQuotasLeaseCountNameRaw(
    requestParameters: SystemApiSystemReadQuotasLeaseCountNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async systemReadQuotasLeaseCountName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadQuotasLeaseCountNameRaw({ name: name }, initOverrides);
  }

  /**
   */
  async systemReadReplicationDrSecondaryLicenseStatusRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async systemReadReplicationDrSecondaryLicenseStatus(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadReplicationDrSecondaryLicenseStatusRaw(initOverrides);
  }

  /**
   */
  async systemReadReplicationDrStatusRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async systemReadReplicationDrStatus(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadReplicationDrStatusRaw(initOverrides);
  }

  /**
   */
  async systemReadReplicationPerformancePrimaryDynamicFilterIdRaw(
    ...
    const response = await this.request(
      {
        path: `/sys/replication/performance/primary/dynamic-filter/{id}`.replace(
          `{${'id'}}`,
          encodeURIComponent(String(requestParameters['id']))
        ),
        method: 'GET',
  ...
  /**
   */
  async systemReadReplicationPerformancePrimaryDynamicFilterId(
    id: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadReplicationPerformancePrimaryDynamicFilterIdRaw({ id: id }, initOverrides);
  }

  /**
   */
  async systemReadReplicationPerformancePrimaryPathsFilterIdRaw(
    requestParameters: SystemApiSystemReadReplicationPerformancePrimaryPathsFilterIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['id'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async systemReadReplicationPerformancePrimaryPathsFilterId(
    id: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadReplicationPerformancePrimaryPathsFilterIdRaw({ id: id }, initOverrides);
  }

  /**
   */
  async systemReadReplicationPerformanceSecondaryDynamicFilterIdRaw(
    requestParameters: SystemApiSystemReadReplicationPerformanceSecondaryDynamicFilterIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['id'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/replication/performance/secondary/dynamic-filter/{id}`.replace(
          `{${'id'}}`,
          encodeURIComponent(String(requestParameters['id']))
        ),
        method: 'GET',
  ...
  /**
   */
  async systemReadReplicationPerformanceSecondaryDynamicFilterId(
    id: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadReplicationPerformanceSecondaryDynamicFilterIdRaw({ id: id }, initOverrides);
  }

  /**
   */
  async systemReadReplicationPerformanceStatusRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async systemReadReplicationPerformanceStatus(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadReplicationPerformanceStatusRaw(initOverrides);
  }

  /**
   */
  async systemReadReplicationStatusRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async systemReadReplicationStatus(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadReplicationStatusRaw(initOverrides);
  }

  /**
   * Retrieve the state of any ongoing seal rewrap process
   */
  async systemReadSealwrapRewrapRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Retrieve the state of any ongoing seal rewrap process
   */
  async systemReadSealwrapRewrap(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
    await this.systemReadSealwrapRewrapRaw(initOverrides);
  }

  /**
   * Read automated raft snapshot configuration
   */
  async systemReadStorageRaftSnapshotAutoConfigNameRaw(
    requestParameters: SystemApiSystemReadStorageRaftSnapshotAutoConfigNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Read automated raft snapshot configuration
   */
  async systemReadStorageRaftSnapshotAutoConfigName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadStorageRaftSnapshotAutoConfigNameRaw({ name: name }, initOverrides);
  }

  /**
   * Read status of automated raft snapshots
   */
  async systemReadStorageRaftSnapshotAutoStatusNameRaw(
    ...
    const response = await this.request(
      {
        path: `/sys/storage/raft/snapshot-auto/status/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'GET',
   ...
   * Read status of automated raft snapshots
   */
  async systemReadStorageRaftSnapshotAutoStatusName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemReadStorageRaftSnapshotAutoStatusNameRaw({ name: name }, initOverrides);
  }

  /**
   */
  async systemReadSyncAssociationsDestinationsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemReadSyncAssociationsDestinationsResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemReadSyncAssociationsDestinationsResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemReadSyncAssociationsDestinations(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemReadSyncAssociationsDestinationsResponse> {
  ...
  /**
   */
  async systemReadSyncAssociationsMountSecretNameRaw(
    requestParameters: SystemApiSystemReadSyncAssociationsMountSecretNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemReadSyncAssociationsMountSecretNameResponse>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemReadSyncAssociationsMountSecretNameResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemReadSyncAssociationsMountSecretName(
    mount: string,
    secretName: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemReadSyncAssociationsMountSecretNameResponse> {
    const response = await this.systemReadSyncAssociationsMountSecretNameRaw(
      { mount: mount, secretName: secretName },
      initOverrides
    );
    return await response.value();
  }
  ...
  /**
   */
  async systemReadSyncConfigRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemReadSyncConfigResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemReadSyncConfigResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemReadSyncConfig(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemReadSyncConfigResponse> {
  ...
  /**
   */
  async systemReadSyncDestinationsAwsSmNameRaw(
    requestParameters: SystemApiSystemReadSyncDestinationsAwsSmNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemReadSyncDestinationsAwsSmNameResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemReadSyncDestinationsAwsSmNameResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemReadSyncDestinationsAwsSmName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemReadSyncDestinationsAwsSmNameResponse> {
  ...
  /**
   */
  async systemReadSyncDestinationsAzureKvNameRaw(
    requestParameters: SystemApiSystemReadSyncDestinationsAzureKvNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemReadSyncDestinationsAzureKvNameResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemReadSyncDestinationsAzureKvNameResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemReadSyncDestinationsAzureKvName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemReadSyncDestinationsAzureKvNameResponse> {
  ...
  /**
   */
  async systemReadSyncDestinationsGcpSmNameRaw(
    requestParameters: SystemApiSystemReadSyncDestinationsGcpSmNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemReadSyncDestinationsGcpSmNameResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemReadSyncDestinationsGcpSmNameResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemReadSyncDestinationsGcpSmName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemReadSyncDestinationsGcpSmNameResponse> {
  ...
  /**
   */
  async systemReadSyncDestinationsGhNameRaw(
    requestParameters: SystemApiSystemReadSyncDestinationsGhNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemReadSyncDestinationsGhNameResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemReadSyncDestinationsGhNameResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemReadSyncDestinationsGhName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemReadSyncDestinationsGhNameResponse> {
  ...
  /**
   */
  async systemReadSyncDestinationsInMemNameRaw(
    requestParameters: SystemApiSystemReadSyncDestinationsInMemNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemReadSyncDestinationsInMemNameResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemReadSyncDestinationsInMemNameResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemReadSyncDestinationsInMemName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemReadSyncDestinationsInMemNameResponse> {
  ...
  /**
   */
  async systemReadSyncDestinationsTypeNameAssociationsRaw(
    requestParameters: SystemApiSystemReadSyncDestinationsTypeNameAssociationsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemReadSyncDestinationsTypeNameAssociationsResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemReadSyncDestinationsTypeNameAssociationsResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemReadSyncDestinationsTypeNameAssociations(
    name: string,
    type: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemReadSyncDestinationsTypeNameAssociationsResponse> {
    const response = await this.systemReadSyncDestinationsTypeNameAssociationsRaw(
      { name: name, type: type },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async systemReadSyncDestinationsVercelProjectNameRaw(
    requestParameters: SystemApiSystemReadSyncDestinationsVercelProjectNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemReadSyncDestinationsVercelProjectNameResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemReadSyncDestinationsVercelProjectNameResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemReadSyncDestinationsVercelProjectName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemReadSyncDestinationsVercelProjectNameResponse> {
  ...
  /**
   */
  async systemReadSyncGithubAppsNameRaw(
    requestParameters: SystemApiSystemReadSyncGithubAppsNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemReadSyncGithubAppsNameResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemReadSyncGithubAppsNameResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemReadSyncGithubAppsName(
    name: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemReadSyncGithubAppsNameResponse> {
   ...
   * Configure control group global settings.
   */
  async systemWriteConfigControlGroupRaw(
    requestParameters: SystemApiSystemWriteConfigControlGroupOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteConfigControlGroupRequestToJSON(
          requestParameters['systemWriteConfigControlGroupRequest']
        ),
      },
      initOverrides
    );
   ...
   * Configure control group global settings.
   */
  async systemWriteConfigControlGroup(
    systemWriteConfigControlGroupRequest: SystemWriteConfigControlGroupRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteConfigControlGroupRaw(
      { systemWriteConfigControlGroupRequest: systemWriteConfigControlGroupRequest },
      initOverrides
    );
  }
   ...
   */
  async systemWriteConfigGroupPolicyApplicationRaw(
    requestParameters: SystemApiSystemWriteConfigGroupPolicyApplicationOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteConfigGroupPolicyApplicationRequestToJSON(
          requestParameters['systemWriteConfigGroupPolicyApplicationRequest']
        ),
      },
      initOverrides
    );
   ...
   * Updates the policy application mode for Vault.
   */
  async systemWriteConfigGroupPolicyApplication(
    systemWriteConfigGroupPolicyApplicationRequest: SystemWriteConfigGroupPolicyApplicationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteConfigGroupPolicyApplicationRaw(
      { systemWriteConfigGroupPolicyApplicationRequest: systemWriteConfigGroupPolicyApplicationRequest },
      initOverrides
    );
  }
   ...
   */
  async systemWriteControlGroupAuthorizeRaw(
    requestParameters: SystemApiSystemWriteControlGroupAuthorizeOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteControlGroupAuthorizeRequestToJSON(
          requestParameters['systemWriteControlGroupAuthorizeRequest']
        ),
      },
      initOverrides
    );
   ...
   * Authorize a control group request
   */
  async systemWriteControlGroupAuthorize(
    systemWriteControlGroupAuthorizeRequest: SystemWriteControlGroupAuthorizeRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteControlGroupAuthorizeRaw(
      { systemWriteControlGroupAuthorizeRequest: systemWriteControlGroupAuthorizeRequest },
      initOverrides
    );
  }
   ...
   */
  async systemWriteControlGroupRequestRaw(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteControlGroupRequestRequestToJSON(
          requestParameters['systemWriteControlGroupRequestRequest']
        ),
      },
      initOverrides
    );
   ...
   * Check the status of a control group request
   */
  async systemWriteControlGroupRequest(
    systemWriteControlGroupRequestRequest: SystemWriteControlGroupRequestRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteControlGroupRequestRaw(
      { systemWriteControlGroupRequestRequest: systemWriteControlGroupRequestRequest },
      initOverrides
    );
  }
   ...
   */
  async systemWriteInternalCountersActivityWriteRaw(
    requestParameters: SystemApiSystemWriteInternalCountersActivityWriteOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteInternalCountersActivityWriteRequestToJSON(
          requestParameters['systemWriteInternalCountersActivityWriteRequest']
        ),
      },
      initOverrides
    );
   ...
   * Write activity log data
   */
  async systemWriteInternalCountersActivityWrite(
    systemWriteInternalCountersActivityWriteRequest: SystemWriteInternalCountersActivityWriteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteInternalCountersActivityWriteRaw(
      { systemWriteInternalCountersActivityWriteRequest: systemWriteInternalCountersActivityWriteRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async systemWriteManagedKeysTypeNameRaw(
    requestParameters: SystemApiSystemWriteManagedKeysTypeNameOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteManagedKeysTypeNameRequestToJSON(
          requestParameters['systemWriteManagedKeysTypeNameRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async systemWriteManagedKeysTypeName(
    name: string,
    type: string,
    systemWriteManagedKeysTypeNameRequest: SystemWriteManagedKeysTypeNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteManagedKeysTypeNameRaw(
      {
        name: name,
        type: type,
        systemWriteManagedKeysTypeNameRequest: systemWriteManagedKeysTypeNameRequest,
  ...
  /**
   */
  async systemWriteManagedKeysTypeNameTestSignRaw(
    requestParameters: SystemApiSystemWriteManagedKeysTypeNameTestSignOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteManagedKeysTypeNameTestSignRequestToJSON(
  ...
  /**
   */
  async systemWriteManagedKeysTypeNameTestSign(
    name: string,
    type: string,
    systemWriteManagedKeysTypeNameTestSignRequest: SystemWriteManagedKeysTypeNameTestSignRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteManagedKeysTypeNameTestSignRaw(
      {
        name: name,
        type: type,
        systemWriteManagedKeysTypeNameTestSignRequest: systemWriteManagedKeysTypeNameTestSignRequest,
   ...
   * Defines or updates a Duo MFA method.
   */
  async systemWriteMfaMethodDuoNameRaw(
    requestParameters: SystemApiSystemWriteMfaMethodDuoNameOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteMfaMethodDuoNameRequestToJSON(
          requestParameters['systemWriteMfaMethodDuoNameRequest']
        ),
      },
      initOverrides
    );
   ...
   * Defines or updates a Duo MFA method.
   */
  async systemWriteMfaMethodDuoName(
    name: string,
    systemWriteMfaMethodDuoNameRequest: SystemWriteMfaMethodDuoNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteMfaMethodDuoNameRaw(
      { name: name, systemWriteMfaMethodDuoNameRequest: systemWriteMfaMethodDuoNameRequest },
      initOverrides
    );
  }
   ...
   * Defines or updates an Okta MFA method.
   */
  async systemWriteMfaMethodOktaNameRaw(
    requestParameters: SystemApiSystemWriteMfaMethodOktaNameOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteMfaMethodOktaNameRequestToJSON(
          requestParameters['systemWriteMfaMethodOktaNameRequest']
        ),
      },
      initOverrides
    );
   ...
   * Defines or updates an Okta MFA method.
   */
  async systemWriteMfaMethodOktaName(
    name: string,
    systemWriteMfaMethodOktaNameRequest: SystemWriteMfaMethodOktaNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteMfaMethodOktaNameRaw(
      { name: name, systemWriteMfaMethodOktaNameRequest: systemWriteMfaMethodOktaNameRequest },
      initOverrides
    );
  }
   ...
   * Defines or updates a PingID MFA method.
   */
  async systemWriteMfaMethodPingidNameRaw(
    requestParameters: SystemApiSystemWriteMfaMethodPingidNameOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteMfaMethodPingidNameRequestToJSON(
          requestParameters['systemWriteMfaMethodPingidNameRequest']
        ),
      },
      initOverrides
    );
   ...
   * Defines or updates a PingID MFA method.
   */
  async systemWriteMfaMethodPingidName(
    name: string,
    systemWriteMfaMethodPingidNameRequest: SystemWriteMfaMethodPingidNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteMfaMethodPingidNameRaw(
      { name: name, systemWriteMfaMethodPingidNameRequest: systemWriteMfaMethodPingidNameRequest },
      initOverrides
    );
  }
   ...
   * Defines or updates a TOTP MFA method.
   */
  async systemWriteMfaMethodTotpNameRaw(
    requestParameters: SystemApiSystemWriteMfaMethodTotpNameOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteMfaMethodTotpNameRequestToJSON(
   ...
   * Defines or updates a TOTP MFA method.
   */
  async systemWriteMfaMethodTotpName(
    name: string,
    systemWriteMfaMethodTotpNameRequest: SystemWriteMfaMethodTotpNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteMfaMethodTotpNameRaw(
      { name: name, systemWriteMfaMethodTotpNameRequest: systemWriteMfaMethodTotpNameRequest },
      initOverrides
    );
  }
   ...
   */
  async systemWriteMfaMethodTotpNameAdminDestroyRaw(
    ...
    const response = await this.request(
      {
        path: `/sys/mfa/method/totp/{name}/admin-destroy`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteMfaMethodTotpNameAdminDestroyRequestToJSON(
          requestParameters['systemWriteMfaMethodTotpNameAdminDestroyRequest']
        ),
      },
      initOverrides
    );
   ...
   * Deletes the TOTP secret for the given method name on the given entity.
   */
  async systemWriteMfaMethodTotpNameAdminDestroy(
    name: string,
    systemWriteMfaMethodTotpNameAdminDestroyRequest: SystemWriteMfaMethodTotpNameAdminDestroyRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteMfaMethodTotpNameAdminDestroyRaw(
      {
        name: name,
        systemWriteMfaMethodTotpNameAdminDestroyRequest: systemWriteMfaMethodTotpNameAdminDestroyRequest,
      },
   ...
   */
  async systemWriteMfaMethodTotpNameAdminGenerateRaw(
    ...
    const response = await this.request(
      {
        path: `/sys/mfa/method/totp/{name}/admin-generate`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters['name']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteMfaMethodTotpNameAdminGenerateRequestToJSON(
   ...
   * Generates a TOTP secret for the given method name on the given entity.
   */
  async systemWriteMfaMethodTotpNameAdminGenerate(
    name: string,
    systemWriteMfaMethodTotpNameAdminGenerateRequest: SystemWriteMfaMethodTotpNameAdminGenerateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteMfaMethodTotpNameAdminGenerateRaw(
      {
        name: name,
        systemWriteMfaMethodTotpNameAdminGenerateRequest: systemWriteMfaMethodTotpNameAdminGenerateRequest,
      },
   ...
   */
  async systemWriteNamespacesApiLockLockRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Lock the API for a namespace and its descendants
   */
  async systemWriteNamespacesApiLockLock(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteNamespacesApiLockLockRaw(initOverrides);
  }

  /**
   * Lock the API for a namespace and its descendants
   */
  async systemWriteNamespacesApiLockLockPathRaw(
    requestParameters: SystemApiSystemWriteNamespacesApiLockLockPathRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/namespaces/api-lock/lock/{path}`.replace(
          `{${'path'}}`,
          encodeURIComponent(String(requestParameters['path']))
        ),
        method: 'POST',
   ...
   * Lock the API for a namespace and its descendants
   */
  async systemWriteNamespacesApiLockLockPath(
    path: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteNamespacesApiLockLockPathRaw({ path: path }, initOverrides);
  }

  /**
   * Unlock the API for a namespace and its descendants
   */
  async systemWriteNamespacesApiLockUnlockRaw(
    requestParameters: SystemApiSystemWriteNamespacesApiLockUnlockOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteNamespacesApiLockUnlockRequestToJSON(
          requestParameters['systemWriteNamespacesApiLockUnlockRequest']
        ),
      },
      initOverrides
    );
   ...
   * Unlock the API for a namespace and its descendants
   */
  async systemWriteNamespacesApiLockUnlock(
    systemWriteNamespacesApiLockUnlockRequest: SystemWriteNamespacesApiLockUnlockRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteNamespacesApiLockUnlockRaw(
      { systemWriteNamespacesApiLockUnlockRequest: systemWriteNamespacesApiLockUnlockRequest },
      initOverrides
    );
  }
   ...
   * Unlock the API for a namespace and its descendants
   */
  async systemWriteNamespacesApiLockUnlockPathRaw(
    requestParameters: SystemApiSystemWriteNamespacesApiLockUnlockPathOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/namespaces/api-lock/unlock/{path}`.replace(
          `{${'path'}}`,
          encodeURIComponent(String(requestParameters['path']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteNamespacesApiLockUnlockPathRequestToJSON(
          requestParameters['systemWriteNamespacesApiLockUnlockPathRequest']
        ),
      },
      initOverrides
    );
   ...
   * Unlock the API for a namespace and its descendants
   */
  async systemWriteNamespacesApiLockUnlockPath(
    path: string,
    systemWriteNamespacesApiLockUnlockPathRequest: SystemWriteNamespacesApiLockUnlockPathRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteNamespacesApiLockUnlockPathRaw(
      {
        path: path,
        systemWriteNamespacesApiLockUnlockPathRequest: systemWriteNamespacesApiLockUnlockPathRequest,
      },
  ...
  /**
   */
  async systemWriteNamespacesPathRaw(
    requestParameters: SystemApiSystemWriteNamespacesPathOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['path'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async systemWriteNamespacesPath(
    path: string,
    systemWriteNamespacesPathRequest: SystemWriteNamespacesPathRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteNamespacesPathRaw(
      { path: path, systemWriteNamespacesPathRequest: systemWriteNamespacesPathRequest },
      initOverrides
    );
  }
   ...
   * Read, Modify, or Delete an access control policy.
   */
  async systemWritePoliciesEgpNameRaw(
    requestParameters: SystemApiSystemWritePoliciesEgpNameOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Read, Modify, or Delete an access control policy.
   */
  async systemWritePoliciesEgpName(
    name: string,
    systemWritePoliciesEgpNameRequest: SystemWritePoliciesEgpNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWritePoliciesEgpNameRaw(
   ...
   * Read, Modify, or Delete an access control policy.
   */
  async systemWritePoliciesRgpNameRaw(
    requestParameters: SystemApiSystemWritePoliciesRgpNameOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Read, Modify, or Delete an access control policy.
   */
  async systemWritePoliciesRgpName(
    name: string,
    systemWritePoliciesRgpNameRequest: SystemWritePoliciesRgpNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWritePoliciesRgpNameRaw(
      { name: name, systemWritePoliciesRgpNameRequest: systemWritePoliciesRgpNameRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async systemWriteQuotasLeaseCountNameRaw(
    requestParameters: SystemApiSystemWriteQuotasLeaseCountNameOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteQuotasLeaseCountNameRequestToJSON(
          requestParameters['systemWriteQuotasLeaseCountNameRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async systemWriteQuotasLeaseCountName(
    name: string,
    systemWriteQuotasLeaseCountNameRequest: SystemWriteQuotasLeaseCountNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteQuotasLeaseCountNameRaw(
      { name: name, systemWriteQuotasLeaseCountNameRequest: systemWriteQuotasLeaseCountNameRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async systemWriteReplicationDrPrimaryDemoteRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async systemWriteReplicationDrPrimaryDemote(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationDrPrimaryDemoteRaw(initOverrides);
  }

  /**
   */
  async systemWriteReplicationDrPrimaryDisableRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async systemWriteReplicationDrPrimaryDisable(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationDrPrimaryDisableRaw(initOverrides);
  }

  /**
   */
  async systemWriteReplicationDrPrimaryEnableRaw(
    requestParameters: SystemApiSystemWriteReplicationDrPrimaryEnableOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationDrPrimaryEnableRequestToJSON(
          requestParameters['systemWriteReplicationDrPrimaryEnableRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async systemWriteReplicationDrPrimaryEnable(
    systemWriteReplicationDrPrimaryEnableRequest: SystemWriteReplicationDrPrimaryEnableRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationDrPrimaryEnableRaw(
      { systemWriteReplicationDrPrimaryEnableRequest: systemWriteReplicationDrPrimaryEnableRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async systemWriteReplicationDrPrimaryRevokeSecondaryRaw(
    requestParameters: SystemApiSystemWriteReplicationDrPrimaryRevokeSecondaryOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationDrPrimaryRevokeSecondaryRequestToJSON(
          requestParameters['systemWriteReplicationDrPrimaryRevokeSecondaryRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async systemWriteReplicationDrPrimaryRevokeSecondary(
    systemWriteReplicationDrPrimaryRevokeSecondaryRequest: SystemWriteReplicationDrPrimaryRevokeSecondaryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationDrPrimaryRevokeSecondaryRaw(
      {
        systemWriteReplicationDrPrimaryRevokeSecondaryRequest:
          systemWriteReplicationDrPrimaryRevokeSecondaryRequest,
      },
  ...
  /**
   */
  async systemWriteReplicationDrPrimarySecondaryTokenRaw(
    requestParameters: SystemApiSystemWriteReplicationDrPrimarySecondaryTokenOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationDrPrimarySecondaryTokenRequestToJSON(
          requestParameters['systemWriteReplicationDrPrimarySecondaryTokenRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async systemWriteReplicationDrPrimarySecondaryToken(
    systemWriteReplicationDrPrimarySecondaryTokenRequest: SystemWriteReplicationDrPrimarySecondaryTokenRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationDrPrimarySecondaryTokenRaw(
      {
        systemWriteReplicationDrPrimarySecondaryTokenRequest:
          systemWriteReplicationDrPrimarySecondaryTokenRequest,
      },
   ...
   * Reload the given subsystem
   */
  async systemWriteReplicationDrSecondaryConfigReloadSubsystemRaw(
    requestParameters: SystemApiSystemWriteReplicationDrSecondaryConfigReloadSubsystemRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['subsystem'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/replication/dr/secondary/config/reload/{subsystem}`.replace(
          `{${'subsystem'}}`,
          encodeURIComponent(String(requestParameters['subsystem']))
        ),
        method: 'POST',
   ...
   * Reload the given subsystem
   */
  async systemWriteReplicationDrSecondaryConfigReloadSubsystem(
    subsystem: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationDrSecondaryConfigReloadSubsystemRaw(
      { subsystem: subsystem },
      initOverrides
    );
  }
  ...
  /**
   */
  async systemWriteReplicationDrSecondaryDisableRaw(
    requestParameters: SystemApiSystemWriteReplicationDrSecondaryDisableOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationDrSecondaryDisableRequestToJSON(
          requestParameters['systemWriteReplicationDrSecondaryDisableRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async systemWriteReplicationDrSecondaryDisable(
    systemWriteReplicationDrSecondaryDisableRequest: SystemWriteReplicationDrSecondaryDisableRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationDrSecondaryDisableRaw(
      { systemWriteReplicationDrSecondaryDisableRequest: systemWriteReplicationDrSecondaryDisableRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async systemWriteReplicationDrSecondaryEnableRaw(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationDrSecondaryEnableRequestToJSON(
          requestParameters['systemWriteReplicationDrSecondaryEnableRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async systemWriteReplicationDrSecondaryEnable(
    systemWriteReplicationDrSecondaryEnableRequest: SystemWriteReplicationDrSecondaryEnableRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationDrSecondaryEnableRaw(
      { systemWriteReplicationDrSecondaryEnableRequest: systemWriteReplicationDrSecondaryEnableRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async systemWriteReplicationDrSecondaryGeneratePublicKeyRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async systemWriteReplicationDrSecondaryGeneratePublicKey(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationDrSecondaryGeneratePublicKeyRaw(initOverrides);
  }

  /**
   */
  async systemWriteReplicationDrSecondaryMerkleCheckRaw(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationDrSecondaryMerkleCheckRequestToJSON(
          requestParameters['systemWriteReplicationDrSecondaryMerkleCheckRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async systemWriteReplicationDrSecondaryMerkleCheck(
    systemWriteReplicationDrSecondaryMerkleCheckRequest: SystemWriteReplicationDrSecondaryMerkleCheckRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationDrSecondaryMerkleCheckRaw(
      {
        systemWriteReplicationDrSecondaryMerkleCheckRequest:
          systemWriteReplicationDrSecondaryMerkleCheckRequest,
      },
  ...
  /**
   */
  async systemWriteReplicationDrSecondaryOperationTokenDeleteRaw(
    requestParameters: SystemApiSystemWriteReplicationDrSecondaryOperationTokenDeleteOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationDrSecondaryOperationTokenDeleteRequestToJSON(
  ...
  /**
   */
  async systemWriteReplicationDrSecondaryOperationTokenDelete(
    systemWriteReplicationDrSecondaryOperationTokenDeleteRequest: SystemWriteReplicationDrSecondaryOperationTokenDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationDrSecondaryOperationTokenDeleteRaw(
      {
        systemWriteReplicationDrSecondaryOperationTokenDeleteRequest:
          systemWriteReplicationDrSecondaryOperationTokenDeleteRequest,
      },
  ...
  /**
   */
  async systemWriteReplicationDrSecondaryPromoteRaw(
    requestParameters: SystemApiSystemWriteReplicationDrSecondaryPromoteOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationDrSecondaryPromoteRequestToJSON(
  ...
  /**
   */
  async systemWriteReplicationDrSecondaryPromote(
    systemWriteReplicationDrSecondaryPromoteRequest: SystemWriteReplicationDrSecondaryPromoteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationDrSecondaryPromoteRaw(
      { systemWriteReplicationDrSecondaryPromoteRequest: systemWriteReplicationDrSecondaryPromoteRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async systemWriteReplicationDrSecondaryRecoverRaw(
    requestParameters: SystemApiSystemWriteReplicationDrSecondaryRecoverOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationDrSecondaryRecoverRequestToJSON(
  ...
  /**
   */
  async systemWriteReplicationDrSecondaryRecover(
    systemWriteReplicationDrSecondaryRecoverRequest: SystemWriteReplicationDrSecondaryRecoverRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationDrSecondaryRecoverRaw(
      { systemWriteReplicationDrSecondaryRecoverRequest: systemWriteReplicationDrSecondaryRecoverRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async systemWriteReplicationDrSecondaryReindexRaw(
    requestParameters: SystemApiSystemWriteReplicationDrSecondaryReindexOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationDrSecondaryReindexRequestToJSON(
  ...
  /**
   */
  async systemWriteReplicationDrSecondaryReindex(
    systemWriteReplicationDrSecondaryReindexRequest: SystemWriteReplicationDrSecondaryReindexRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationDrSecondaryReindexRaw(
      { systemWriteReplicationDrSecondaryReindexRequest: systemWriteReplicationDrSecondaryReindexRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async systemWriteReplicationDrSecondaryUpdatePrimaryRaw(
    requestParameters: SystemApiSystemWriteReplicationDrSecondaryUpdatePrimaryOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationDrSecondaryUpdatePrimaryRequestToJSON(
          requestParameters['systemWriteReplicationDrSecondaryUpdatePrimaryRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async systemWriteReplicationDrSecondaryUpdatePrimary(
    systemWriteReplicationDrSecondaryUpdatePrimaryRequest: SystemWriteReplicationDrSecondaryUpdatePrimaryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationDrSecondaryUpdatePrimaryRaw(
      {
        systemWriteReplicationDrSecondaryUpdatePrimaryRequest:
          systemWriteReplicationDrSecondaryUpdatePrimaryRequest,
      },
   ...
   */
  async systemWriteReplicationForceCorruptionRaw(
    requestParameters: SystemApiSystemWriteReplicationForceCorruptionOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationForceCorruptionRequestToJSON(
          requestParameters['systemWriteReplicationForceCorruptionRequest']
        ),
      },
      initOverrides
    );
   ...
   * force corrupting stuff
   */
  async systemWriteReplicationForceCorruption(
    systemWriteReplicationForceCorruptionRequest: SystemWriteReplicationForceCorruptionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationForceCorruptionRaw(
      { systemWriteReplicationForceCorruptionRequest: systemWriteReplicationForceCorruptionRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async systemWriteReplicationMerkleCheckRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async systemWriteReplicationMerkleCheck(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationMerkleCheckRaw(initOverrides);
  }

  /**
   */
  async systemWriteReplicationPerformancePrimaryDemoteRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async systemWriteReplicationPerformancePrimaryDemote(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationPerformancePrimaryDemoteRaw(initOverrides);
  }

  /**
   */
  async systemWriteReplicationPerformancePrimaryDisableRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async systemWriteReplicationPerformancePrimaryDisable(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationPerformancePrimaryDisableRaw(initOverrides);
  }

  /**
   */
  async systemWriteReplicationPerformancePrimaryEnableRaw(
    requestParameters: SystemApiSystemWriteReplicationPerformancePrimaryEnableOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationPerformancePrimaryEnableRequestToJSON(
          requestParameters['systemWriteReplicationPerformancePrimaryEnableRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async systemWriteReplicationPerformancePrimaryEnable(
    systemWriteReplicationPerformancePrimaryEnableRequest: SystemWriteReplicationPerformancePrimaryEnableRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationPerformancePrimaryEnableRaw(
      {
        systemWriteReplicationPerformancePrimaryEnableRequest:
          systemWriteReplicationPerformancePrimaryEnableRequest,
      },
  ...
  /**
   */
  async systemWriteReplicationPerformancePrimaryPathsFilterIdRaw(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationPerformancePrimaryPathsFilterIdRequestToJSON(
          requestParameters['systemWriteReplicationPerformancePrimaryPathsFilterIdRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async systemWriteReplicationPerformancePrimaryPathsFilterId(
    id: string,
    systemWriteReplicationPerformancePrimaryPathsFilterIdRequest: SystemWriteReplicationPerformancePrimaryPathsFilterIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationPerformancePrimaryPathsFilterIdRaw(
      {
        id: id,
        systemWriteReplicationPerformancePrimaryPathsFilterIdRequest:
          systemWriteReplicationPerformancePrimaryPathsFilterIdRequest,
  ...
  /**
   */
  async systemWriteReplicationPerformancePrimaryRevokeSecondaryRaw(
    requestParameters: SystemApiSystemWriteReplicationPerformancePrimaryRevokeSecondaryOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationPerformancePrimaryRevokeSecondaryRequestToJSON(
          requestParameters['systemWriteReplicationPerformancePrimaryRevokeSecondaryRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async systemWriteReplicationPerformancePrimaryRevokeSecondary(
    systemWriteReplicationPerformancePrimaryRevokeSecondaryRequest: SystemWriteReplicationPerformancePrimaryRevokeSecondaryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationPerformancePrimaryRevokeSecondaryRaw(
      {
        systemWriteReplicationPerformancePrimaryRevokeSecondaryRequest:
          systemWriteReplicationPerformancePrimaryRevokeSecondaryRequest,
      },
  ...
  /**
   */
  async systemWriteReplicationPerformancePrimarySecondaryTokenRaw(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationPerformancePrimarySecondaryTokenRequestToJSON(
  ...
  /**
   */
  async systemWriteReplicationPerformancePrimarySecondaryToken(
    systemWriteReplicationPerformancePrimarySecondaryTokenRequest: SystemWriteReplicationPerformancePrimarySecondaryTokenRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationPerformancePrimarySecondaryTokenRaw(
      {
        systemWriteReplicationPerformancePrimarySecondaryTokenRequest:
          systemWriteReplicationPerformancePrimarySecondaryTokenRequest,
      },
  ...
  /**
   */
  async systemWriteReplicationPerformanceSecondaryDisableRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async systemWriteReplicationPerformanceSecondaryDisable(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationPerformanceSecondaryDisableRaw(initOverrides);
  }

  /**
   */
  async systemWriteReplicationPerformanceSecondaryEnableRaw(
    requestParameters: SystemApiSystemWriteReplicationPerformanceSecondaryEnableOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationPerformanceSecondaryEnableRequestToJSON(
          requestParameters['systemWriteReplicationPerformanceSecondaryEnableRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async systemWriteReplicationPerformanceSecondaryEnable(
    systemWriteReplicationPerformanceSecondaryEnableRequest: SystemWriteReplicationPerformanceSecondaryEnableRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationPerformanceSecondaryEnableRaw(
      {
        systemWriteReplicationPerformanceSecondaryEnableRequest:
          systemWriteReplicationPerformanceSecondaryEnableRequest,
      },
  ...
  /**
   */
  async systemWriteReplicationPerformanceSecondaryGeneratePublicKeyRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async systemWriteReplicationPerformanceSecondaryGeneratePublicKey(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationPerformanceSecondaryGeneratePublicKeyRaw(initOverrides);
  }

  /**
   */
  async systemWriteReplicationPerformanceSecondaryPromoteRaw(
    requestParameters: SystemApiSystemWriteReplicationPerformanceSecondaryPromoteOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationPerformanceSecondaryPromoteRequestToJSON(
          requestParameters['systemWriteReplicationPerformanceSecondaryPromoteRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async systemWriteReplicationPerformanceSecondaryPromote(
    systemWriteReplicationPerformanceSecondaryPromoteRequest: SystemWriteReplicationPerformanceSecondaryPromoteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationPerformanceSecondaryPromoteRaw(
      {
        systemWriteReplicationPerformanceSecondaryPromoteRequest:
          systemWriteReplicationPerformanceSecondaryPromoteRequest,
      },
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationPerformanceSecondaryUpdatePrimaryRequestToJSON(
  ...
  /**
   */
  async systemWriteReplicationPerformanceSecondaryUpdatePrimary(
    systemWriteReplicationPerformanceSecondaryUpdatePrimaryRequest: SystemWriteReplicationPerformanceSecondaryUpdatePrimaryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationPerformanceSecondaryUpdatePrimaryRaw(
      {
        systemWriteReplicationPerformanceSecondaryUpdatePrimaryRequest:
          systemWriteReplicationPerformanceSecondaryUpdatePrimaryRequest,
      },
  ...
  /**
   */
  async systemWriteReplicationPrimaryDemoteRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async systemWriteReplicationPrimaryDemote(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationPrimaryDemoteRaw(initOverrides);
  }

  /**
   */
  async systemWriteReplicationPrimaryDisableRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async systemWriteReplicationPrimaryDisable(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationPrimaryDisableRaw(initOverrides);
  }

  /**
   */
  async systemWriteReplicationPrimaryEnableRaw(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationPrimaryEnableRequestToJSON(
  ...
  /**
   */
  async systemWriteReplicationPrimaryEnable(
    systemWriteReplicationPrimaryEnableRequest: SystemWriteReplicationPrimaryEnableRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationPrimaryEnableRaw(
      { systemWriteReplicationPrimaryEnableRequest: systemWriteReplicationPrimaryEnableRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async systemWriteReplicationPrimaryRevokeSecondaryRaw(
    requestParameters: SystemApiSystemWriteReplicationPrimaryRevokeSecondaryOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationPrimaryRevokeSecondaryRequestToJSON(
          requestParameters['systemWriteReplicationPrimaryRevokeSecondaryRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async systemWriteReplicationPrimaryRevokeSecondary(
    systemWriteReplicationPrimaryRevokeSecondaryRequest: SystemWriteReplicationPrimaryRevokeSecondaryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationPrimaryRevokeSecondaryRaw(
      {
        systemWriteReplicationPrimaryRevokeSecondaryRequest:
          systemWriteReplicationPrimaryRevokeSecondaryRequest,
      },
  ...
  /**
   */
  async systemWriteReplicationPrimarySecondaryTokenRaw(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationPrimarySecondaryTokenRequestToJSON(
          requestParameters['systemWriteReplicationPrimarySecondaryTokenRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async systemWriteReplicationPrimarySecondaryToken(
    systemWriteReplicationPrimarySecondaryTokenRequest: SystemWriteReplicationPrimarySecondaryTokenRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationPrimarySecondaryTokenRaw(
      {
        systemWriteReplicationPrimarySecondaryTokenRequest:
          systemWriteReplicationPrimarySecondaryTokenRequest,
      },
  ...
  /**
   */
  async systemWriteReplicationRecoverRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async systemWriteReplicationRecover(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationRecoverRaw(initOverrides);
  }

  /**
   */
  async systemWriteReplicationReindexRaw(
    requestParameters: SystemApiSystemWriteReplicationReindexOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationReindexRequestToJSON(
          requestParameters['systemWriteReplicationReindexRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async systemWriteReplicationReindex(
    systemWriteReplicationReindexRequest: SystemWriteReplicationReindexRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationReindexRaw(
      { systemWriteReplicationReindexRequest: systemWriteReplicationReindexRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async systemWriteReplicationSecondaryDisableRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async systemWriteReplicationSecondaryDisable(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationSecondaryDisableRaw(initOverrides);
  }

  /**
   */
  async systemWriteReplicationSecondaryEnableRaw(
    requestParameters: SystemApiSystemWriteReplicationSecondaryEnableOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationSecondaryEnableRequestToJSON(
  ...
  /**
   */
  async systemWriteReplicationSecondaryEnable(
    systemWriteReplicationSecondaryEnableRequest: SystemWriteReplicationSecondaryEnableRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationSecondaryEnableRaw(
      { systemWriteReplicationSecondaryEnableRequest: systemWriteReplicationSecondaryEnableRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async systemWriteReplicationSecondaryPromoteRaw(
    requestParameters: SystemApiSystemWriteReplicationSecondaryPromoteOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationSecondaryPromoteRequestToJSON(
          requestParameters['systemWriteReplicationSecondaryPromoteRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async systemWriteReplicationSecondaryPromote(
    systemWriteReplicationSecondaryPromoteRequest: SystemWriteReplicationSecondaryPromoteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationSecondaryPromoteRaw(
      { systemWriteReplicationSecondaryPromoteRequest: systemWriteReplicationSecondaryPromoteRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async systemWriteReplicationSecondaryUpdatePrimaryRaw(
    requestParameters: SystemApiSystemWriteReplicationSecondaryUpdatePrimaryOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteReplicationSecondaryUpdatePrimaryRequestToJSON(
          requestParameters['systemWriteReplicationSecondaryUpdatePrimaryRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async systemWriteReplicationSecondaryUpdatePrimary(
    systemWriteReplicationSecondaryUpdatePrimaryRequest: SystemWriteReplicationSecondaryUpdatePrimaryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteReplicationSecondaryUpdatePrimaryRaw(
      {
        systemWriteReplicationSecondaryUpdatePrimaryRequest:
          systemWriteReplicationSecondaryUpdatePrimaryRequest,
      },
   ...
   */
  async systemWriteSealwrapRewrapRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Start a seal rewrap process
   */
  async systemWriteSealwrapRewrap(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
    await this.systemWriteSealwrapRewrapRaw(initOverrides);
  }
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteStorageRaftSnapshotAutoConfigNameRequestToJSON(
          requestParameters['systemWriteStorageRaftSnapshotAutoConfigNameRequest']
        ),
      },
      initOverrides
    );
   ...
   * Update automated raft snapshot configuration
   */
  async systemWriteStorageRaftSnapshotAutoConfigName(
    name: string,
    systemWriteStorageRaftSnapshotAutoConfigNameRequest: SystemWriteStorageRaftSnapshotAutoConfigNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.systemWriteStorageRaftSnapshotAutoConfigNameRaw(
      {
        name: name,
        systemWriteStorageRaftSnapshotAutoConfigNameRequest:
          systemWriteStorageRaftSnapshotAutoConfigNameRequest,
  ...
  /**
   */
  async systemWriteSyncDestinationsAwsSmNameRaw(
    requestParameters: SystemApiSystemWriteSyncDestinationsAwsSmNameOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemWriteSyncDestinationsAwsSmNameResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteSyncDestinationsAwsSmNameRequestToJSON(
          requestParameters['systemWriteSyncDestinationsAwsSmNameRequest']
        ),
      },
      initOverrides
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemWriteSyncDestinationsAwsSmNameResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemWriteSyncDestinationsAwsSmName(
    name: string,
    systemWriteSyncDestinationsAwsSmNameRequest: SystemWriteSyncDestinationsAwsSmNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemWriteSyncDestinationsAwsSmNameResponse> {
    const response = await this.systemWriteSyncDestinationsAwsSmNameRaw(
      {
        name: name,
        systemWriteSyncDestinationsAwsSmNameRequest: systemWriteSyncDestinationsAwsSmNameRequest,
      },
  ...
  /**
   */
  async systemWriteSyncDestinationsAzureKvNameRaw(
    requestParameters: SystemApiSystemWriteSyncDestinationsAzureKvNameOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemWriteSyncDestinationsAzureKvNameResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteSyncDestinationsAzureKvNameRequestToJSON(
          requestParameters['systemWriteSyncDestinationsAzureKvNameRequest']
        ),
      },
      initOverrides
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemWriteSyncDestinationsAzureKvNameResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemWriteSyncDestinationsAzureKvName(
    name: string,
    systemWriteSyncDestinationsAzureKvNameRequest: SystemWriteSyncDestinationsAzureKvNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemWriteSyncDestinationsAzureKvNameResponse> {
    const response = await this.systemWriteSyncDestinationsAzureKvNameRaw(
      {
        name: name,
        systemWriteSyncDestinationsAzureKvNameRequest: systemWriteSyncDestinationsAzureKvNameRequest,
      },
  ...
  /**
   */
  async systemWriteSyncDestinationsGcpSmNameRaw(
    requestParameters: SystemApiSystemWriteSyncDestinationsGcpSmNameOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemWriteSyncDestinationsGcpSmNameResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteSyncDestinationsGcpSmNameRequestToJSON(
          requestParameters['systemWriteSyncDestinationsGcpSmNameRequest']
        ),
      },
      initOverrides
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemWriteSyncDestinationsGcpSmNameResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemWriteSyncDestinationsGcpSmName(
    name: string,
    systemWriteSyncDestinationsGcpSmNameRequest: SystemWriteSyncDestinationsGcpSmNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemWriteSyncDestinationsGcpSmNameResponse> {
    const response = await this.systemWriteSyncDestinationsGcpSmNameRaw(
      {
        name: name,
        systemWriteSyncDestinationsGcpSmNameRequest: systemWriteSyncDestinationsGcpSmNameRequest,
      },
  ...
  /**
   */
  async systemWriteSyncDestinationsGhNameRaw(
    requestParameters: SystemApiSystemWriteSyncDestinationsGhNameOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemWriteSyncDestinationsGhNameResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteSyncDestinationsGhNameRequestToJSON(
          requestParameters['systemWriteSyncDestinationsGhNameRequest']
        ),
      },
      initOverrides
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemWriteSyncDestinationsGhNameResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemWriteSyncDestinationsGhName(
    name: string,
    systemWriteSyncDestinationsGhNameRequest: SystemWriteSyncDestinationsGhNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemWriteSyncDestinationsGhNameResponse> {
    const response = await this.systemWriteSyncDestinationsGhNameRaw(
      { name: name, systemWriteSyncDestinationsGhNameRequest: systemWriteSyncDestinationsGhNameRequest },
      initOverrides
    );
    return await response.value();
  }
  ...
  /**
   */
  async systemWriteSyncDestinationsInMemNameRaw(
    requestParameters: SystemApiSystemWriteSyncDestinationsInMemNameOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemWriteSyncDestinationsInMemNameResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteSyncDestinationsInMemNameRequestToJSON(
          requestParameters['systemWriteSyncDestinationsInMemNameRequest']
        ),
      },
      initOverrides
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemWriteSyncDestinationsInMemNameResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemWriteSyncDestinationsInMemName(
    name: string,
    systemWriteSyncDestinationsInMemNameRequest: SystemWriteSyncDestinationsInMemNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemWriteSyncDestinationsInMemNameResponse> {
    const response = await this.systemWriteSyncDestinationsInMemNameRaw(
      {
        name: name,
        systemWriteSyncDestinationsInMemNameRequest: systemWriteSyncDestinationsInMemNameRequest,
      },
  ...
  /**
   */
  async systemWriteSyncDestinationsTypeNameAssociationsRemoveRaw(
    requestParameters: SystemApiSystemWriteSyncDestinationsTypeNameAssociationsRemoveOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemWriteSyncDestinationsTypeNameAssociationsRemoveResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteSyncDestinationsTypeNameAssociationsRemoveRequestToJSON(
          requestParameters['systemWriteSyncDestinationsTypeNameAssociationsRemoveRequest']
        ),
      },
      initOverrides
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemWriteSyncDestinationsTypeNameAssociationsRemoveResponseFromJSON(jsonValue)
    );
  }
  ...
  async systemWriteSyncDestinationsTypeNameAssociationsRemove(
    ...
    systemWriteSyncDestinationsTypeNameAssociationsRemoveRequest: SystemWriteSyncDestinationsTypeNameAssociationsRemoveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemWriteSyncDestinationsTypeNameAssociationsRemoveResponse> {
    const response = await this.systemWriteSyncDestinationsTypeNameAssociationsRemoveRaw(
      {
        name: name,
        type: type,
        systemWriteSyncDestinationsTypeNameAssociationsRemoveRequest:
  ...
  /**
   */
  async systemWriteSyncDestinationsTypeNameAssociationsSetRaw(
    requestParameters: SystemApiSystemWriteSyncDestinationsTypeNameAssociationsSetOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemWriteSyncDestinationsTypeNameAssociationsSetResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteSyncDestinationsTypeNameAssociationsSetRequestToJSON(
          requestParameters['systemWriteSyncDestinationsTypeNameAssociationsSetRequest']
        ),
      },
      initOverrides
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemWriteSyncDestinationsTypeNameAssociationsSetResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemWriteSyncDestinationsTypeNameAssociationsSet(
    name: string,
    type: string,
    systemWriteSyncDestinationsTypeNameAssociationsSetRequest: SystemWriteSyncDestinationsTypeNameAssociationsSetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemWriteSyncDestinationsTypeNameAssociationsSetResponse> {
    const response = await this.systemWriteSyncDestinationsTypeNameAssociationsSetRaw(
      {
        name: name,
        type: type,
        systemWriteSyncDestinationsTypeNameAssociationsSetRequest:
  ...
  /**
   */
  async systemWriteSyncDestinationsVercelProjectNameRaw(
    requestParameters: SystemApiSystemWriteSyncDestinationsVercelProjectNameOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemWriteSyncDestinationsVercelProjectNameResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteSyncDestinationsVercelProjectNameRequestToJSON(
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemWriteSyncDestinationsVercelProjectNameResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemWriteSyncDestinationsVercelProjectName(
    name: string,
    systemWriteSyncDestinationsVercelProjectNameRequest: SystemWriteSyncDestinationsVercelProjectNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemWriteSyncDestinationsVercelProjectNameResponse> {
    const response = await this.systemWriteSyncDestinationsVercelProjectNameRaw(
      {
        name: name,
        systemWriteSyncDestinationsVercelProjectNameRequest:
          systemWriteSyncDestinationsVercelProjectNameRequest,
  ...
  /**
   */
  async systemWriteSyncGithubAppsNameRaw(
    requestParameters: SystemApiSystemWriteSyncGithubAppsNameOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemWriteSyncGithubAppsNameResponse>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
        'name',
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SystemWriteSyncGithubAppsNameRequestToJSON(
          requestParameters['systemWriteSyncGithubAppsNameRequest']
        ),
      },
      initOverrides
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemWriteSyncGithubAppsNameResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async systemWriteSyncGithubAppsName(
    name: string,
    systemWriteSyncGithubAppsNameRequest: SystemWriteSyncGithubAppsNameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemWriteSyncGithubAppsNameResponse> {
    const response = await this.systemWriteSyncGithubAppsNameRaw(
      { name: name, systemWriteSyncGithubAppsNameRequest: systemWriteSyncGithubAppsNameRequest },
      initOverrides
    );
    return await response.value();
  }
   ...
   */
  async systemWriteUtilizationRaw(
    requestParameters: SystemApiSystemWriteUtilizationOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SystemWriteUtilizationResponse>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SystemWriteUtilizationResponseFromJSON(jsonValue)
    );
  }
   ...
   * returns manual license reporting report data
   */
  async systemWriteUtilization(
    systemWriteUtilizationRequest: SystemWriteUtilizationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SystemWriteUtilizationResponse> {
    const response = await this.systemWriteUtilizationRaw(
      { systemWriteUtilizationRequest: systemWriteUtilizationRequest },
      initOverrides
    );
    return await response.value();
   ...
   */
  async uiConfigDeleteCustomMessageRaw(
    requestParameters: SystemApiUiConfigDeleteCustomMessageRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<UiConfigDeleteCustomMessageResponse>> {
    if (requestParameters['id'] == null) {
      throw new runtime.RequiredError(
        'id',
    ...
    const response = await this.request(
      {
        path: `/sys/config/ui/custom-messages/{id}`.replace(
          `{${'id'}}`,
          encodeURIComponent(String(requestParameters['id']))
        ),
        method: 'DELETE',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      UiConfigDeleteCustomMessageResponseFromJSON(jsonValue)
    );
  }
   ...
   * Delete custom message
   */
  async uiConfigDeleteCustomMessage(
    id: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<UiConfigDeleteCustomMessageResponse> {
   ...
   */
  async uiConfigListCustomMessagesRaw(
    requestParameters: SystemApiUiConfigListCustomMessagesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
   ...
   * Lists custom messages
   */
  async uiConfigListCustomMessages(
    list: UiConfigListCustomMessagesListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.uiConfigListCustomMessagesRaw({ list: list }, initOverrides);
  }

  /**
   * Read custom message
   */
  async uiConfigReadCustomMessageRaw(
    requestParameters: SystemApiUiConfigReadCustomMessageRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<UiConfigReadCustomMessageResponse>> {
    if (requestParameters['id'] == null) {
      throw new runtime.RequiredError(
        'id',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      UiConfigReadCustomMessageResponseFromJSON(jsonValue)
    );
  }
   ...
   * Read custom message
   */
  async uiConfigReadCustomMessage(
    id: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<UiConfigReadCustomMessageResponse> {
   ...
   */
  async uiConfigUpdateCustomMessageRaw(
    requestParameters: SystemApiUiConfigUpdateCustomMessageOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<UiConfigUpdateCustomMessageResponse>> {
    if (requestParameters['id'] == null) {
      throw new runtime.RequiredError(
        'id',
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: UiConfigUpdateCustomMessageRequestToJSON(
          requestParameters['uiConfigUpdateCustomMessageRequest']
        ),
      },
      initOverrides
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      UiConfigUpdateCustomMessageResponseFromJSON(jsonValue)
    );
  }
   ...
   * Update custom message
   */
  async uiConfigUpdateCustomMessage(
    id: string,
    uiConfigUpdateCustomMessageRequest: UiConfigUpdateCustomMessageRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<UiConfigUpdateCustomMessageResponse> {
    const response = await this.uiConfigUpdateCustomMessageRaw(
      { id: id, uiConfigUpdateCustomMessageRequest: uiConfigUpdateCustomMessageRequest },
      initOverrides
    );
    return await response.value();
  }
   ...
   */
  async uiHeadersConfigureRaw(
    requestParameters: SystemApiUiHeadersConfigureOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['header'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/sys/config/ui/headers/{header}`.replace(
          `{${'header'}}`,
          encodeURIComponent(String(requestParameters['header']))
        ),
        method: 'POST',
   ...
   * Configure the values to be returned for the UI header.
   */
  async uiHeadersConfigure(
    header: string,
    uiHeadersConfigureRequest: UiHeadersConfigureRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.uiHeadersConfigureRaw(
      { header: header, uiHeadersConfigureRequest: uiHeadersConfigureRequest },
      initOverrides
    );
  }
   ...
   * Remove a UI header.
   */
  async uiHeadersDeleteConfigurationRaw(
    requestParameters: SystemApiUiHeadersDeleteConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['header'] == null) {
      throw new runtime.RequiredError(
   ...
   * Remove a UI header.
   */
  async uiHeadersDeleteConfiguration(
    header: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.uiHeadersDeleteConfigurationRaw({ header: header }, initOverrides);
  }

  /**
   * Return a list of configured UI headers.
   */
  async uiHeadersListRaw(
    requestParameters: SystemApiUiHeadersListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<UiHeadersListResponse>> {
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
        'list',
   ...
   */
  async uiHeadersReadConfigurationRaw(
    requestParameters: SystemApiUiHeadersReadConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<UiHeadersReadConfigurationResponse>> {
    if (requestParameters['header'] == null) {
      throw new runtime.RequiredError(
        'header',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      UiHeadersReadConfigurationResponseFromJSON(jsonValue)
    );
  }
   ...
   * Return the given UI header\'s configuration
   */
  async uiHeadersReadConfiguration(
    header: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<UiHeadersReadConfigurationResponse> {
   ...
   */
  async unsealRaw(
    requestParameters: SystemApiUnsealOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<UnsealResponse>> {
   ...
   */
  async unwrapRaw(
    requestParameters: SystemApiUnwrapOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
  ...
  async unwrap(
    ...
    await this.unwrapRaw({ unwrapRequest: unwrapRequest }, initOverrides);
  }

  /**
   * Returns map of historical version change entries
   */
  async versionHistoryRaw(
    requestParameters: SystemApiVersionHistoryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<VersionHistoryResponse>> {
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
        'list',
  ...
  /**
   */
  async wellKnownListLabelsRaw(
    requestParameters: SystemApiWellKnownListLabelsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<WellKnownListLabelsResponse>> {
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
        'list',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      WellKnownListLabelsResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async wellKnownListLabels(
    list: WellKnownListLabelsListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<WellKnownListLabelsResponse> {
  ...
  /**
   */
  async wellKnownListLabels2Raw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<WellKnownListLabels2Response>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      WellKnownListLabels2ResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async wellKnownListLabels2(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<WellKnownListLabels2Response> {
   ...
   */
  async wellKnownReadLabelRaw(
    requestParameters: SystemApiWellKnownReadLabelRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<WellKnownReadLabelResponse>> {
    ...
    const response = await this.request(
      {
        path: `/sys/well-known/{label}`.replace(
          `{${'label'}}`,
          encodeURIComponent(String(requestParameters['label']))
        ),
        method: 'GET',
        headers: headerParameters,
        query: queryParameters,
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      WellKnownReadLabelResponseFromJSON(jsonValue)
    );
  }
   ...
   * Retrieve the associated mount information for a registered well-known label.
   */
  async wellKnownReadLabel(
    label: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<WellKnownReadLabelResponse> {
   ...
   */
  async wrapRaw(
    requestParameters: SystemApiWrapRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
