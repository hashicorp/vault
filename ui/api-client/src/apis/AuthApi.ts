...
export class AuthApi extends runtime.BaseAPI {
   ...
   */
  async aliCloudDeleteAuthRoleRaw(
    requestParameters: AuthApiAliCloudDeleteAuthRoleRequest,
    ...
    const response = await this.request(
      {
        path: `/auth/{alicloud_mount_path}/role/{role}`
          .replace(`{${'role'}}`, encodeURIComponent(String(requestParameters['role'])))
          .replace(
            `{${'alicloud_mount_path'}}`,
            encodeURIComponent(String(requestParameters['alicloudMountPath']))
          ),
        method: 'DELETE',
   ...
   * Create a role and associate policies to it.
   */
  async aliCloudDeleteAuthRole(
    role: string,
    alicloudMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.aliCloudDeleteAuthRoleRaw({ role: role, alicloudMountPath: alicloudMountPath }, initOverrides);
  }

  /**
   * Lists all the roles that are registered with Vault.
   */
  async aliCloudListAuthRolesRaw(
    requestParameters: AuthApiAliCloudListAuthRolesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['alicloudMountPath'] == null) {
      throw new runtime.RequiredError(
        'alicloudMountPath',
    ...
    const response = await this.request(
      {
        path: `/auth/{alicloud_mount_path}/role/`.replace(
          `{${'alicloud_mount_path'}}`,
          encodeURIComponent(String(requestParameters['alicloudMountPath']))
        ),
        method: 'GET',
   ...
   * Lists all the roles that are registered with Vault.
   */
  async aliCloudListAuthRoles(
    alicloudMountPath: string,
    list: AliCloudListAuthRolesListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.aliCloudListAuthRolesRaw(
      { alicloudMountPath: alicloudMountPath, list: list },
      initOverrides
    );
   ...
   * Lists all the roles that are registered with Vault.
   */
  async aliCloudListAuthRoles2Raw(
    requestParameters: AuthApiAliCloudListAuthRoles2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['alicloudMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{alicloud_mount_path}/roles/`.replace(
          `{${'alicloud_mount_path'}}`,
          encodeURIComponent(String(requestParameters['alicloudMountPath']))
        ),
        method: 'GET',
   ...
   * Lists all the roles that are registered with Vault.
   */
  async aliCloudListAuthRoles2(
    alicloudMountPath: string,
    list: AliCloudListAuthRoles2ListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.aliCloudListAuthRoles2Raw(
      { alicloudMountPath: alicloudMountPath, list: list },
      initOverrides
    );
    return await response.value();
   ...
   */
  async aliCloudLoginRaw(
    requestParameters: AuthApiAliCloudLoginOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['alicloudMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{alicloud_mount_path}/login`.replace(
          `{${'alicloud_mount_path'}}`,
          encodeURIComponent(String(requestParameters['alicloudMountPath']))
        ),
        method: 'POST',
  ...
  async aliCloudLogin(
    ...
    await this.aliCloudLoginRaw(
      { alicloudMountPath: alicloudMountPath, aliCloudLoginRequest: aliCloudLoginRequest },
      initOverrides
    );
  }
   ...
   * Create a role and associate policies to it.
   */
  async aliCloudReadAuthRoleRaw(
    requestParameters: AuthApiAliCloudReadAuthRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['role'] == null) {
      throw new runtime.RequiredError(
   ...
   * Create a role and associate policies to it.
   */
  async aliCloudReadAuthRole(
    role: string,
    alicloudMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.aliCloudReadAuthRoleRaw({ role: role, alicloudMountPath: alicloudMountPath }, initOverrides);
  }

  /**
   * Create a role and associate policies to it.
   */
  async aliCloudWriteAuthRoleRaw(
    requestParameters: AuthApiAliCloudWriteAuthRoleOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['role'] == null) {
      throw new runtime.RequiredError(
   ...
   * Create a role and associate policies to it.
   */
  async aliCloudWriteAuthRole(
    role: string,
    alicloudMountPath: string,
    aliCloudWriteAuthRoleRequest: AliCloudWriteAuthRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.aliCloudWriteAuthRoleRaw(
      {
        role: role,
  ...
  /**
   */
  async appRoleDeleteBindSecretIdRaw(
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}/bind-secret-id`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
          ),
        method: 'DELETE',
        headers: headerParameters,
        query: queryParameters,
  ...
  /**
   */
  async appRoleDeleteBindSecretId(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleDeleteBindSecretIdRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
  }
  ...
  /**
   */
  async appRoleDeleteBoundCidrListRaw(
    requestParameters: AuthApiAppRoleDeleteBoundCidrListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}/bound-cidr-list`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
  ...
  /**
   */
  async appRoleDeleteBoundCidrList(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleDeleteBoundCidrListRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
  }
  ...
  /**
   */
  async appRoleDeletePeriodRaw(
    requestParameters: AuthApiAppRoleDeletePeriodRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}/period`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
  ...
  /**
   */
  async appRoleDeletePeriod(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleDeletePeriodRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
  }
  ...
  /**
   */
  async appRoleDeletePoliciesRaw(
    requestParameters: AuthApiAppRoleDeletePoliciesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}/policies`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
  ...
  /**
   */
  async appRoleDeletePolicies(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleDeletePoliciesRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
  }
  ...
  /**
   */
  async appRoleDeleteRoleRaw(
    requestParameters: AuthApiAppRoleDeleteRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
  ...
  /**
   */
  async appRoleDeleteRole(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleDeleteRoleRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
  }
  ...
  /**
   */
  async appRoleDeleteSecretIdBoundCidrsRaw(
    requestParameters: AuthApiAppRoleDeleteSecretIdBoundCidrsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}/secret-id-bound-cidrs`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
  ...
  /**
   */
  async appRoleDeleteSecretIdBoundCidrs(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleDeleteSecretIdBoundCidrsRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
  }
  ...
  /**
   */
  async appRoleDeleteSecretIdNumUsesRaw(
    requestParameters: AuthApiAppRoleDeleteSecretIdNumUsesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}/secret-id-num-uses`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
  ...
  /**
   */
  async appRoleDeleteSecretIdNumUses(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleDeleteSecretIdNumUsesRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
  }
  ...
  /**
   */
  async appRoleDeleteSecretIdTtlRaw(
    requestParameters: AuthApiAppRoleDeleteSecretIdTtlRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}/secret-id-ttl`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
  ...
  /**
   */
  async appRoleDeleteSecretIdTtl(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleDeleteSecretIdTtlRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
  }
  ...
  /**
   */
  async appRoleDeleteTokenBoundCidrsRaw(
    requestParameters: AuthApiAppRoleDeleteTokenBoundCidrsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}/token-bound-cidrs`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
  ...
  /**
   */
  async appRoleDeleteTokenBoundCidrs(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleDeleteTokenBoundCidrsRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
  }
  ...
  /**
   */
  async appRoleDeleteTokenMaxTtlRaw(
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}/token-max-ttl`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
  ...
  /**
   */
  async appRoleDeleteTokenMaxTtl(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleDeleteTokenMaxTtlRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
  }
  ...
  /**
   */
  async appRoleDeleteTokenNumUsesRaw(
    requestParameters: AuthApiAppRoleDeleteTokenNumUsesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}/token-num-uses`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
  ...
  /**
   */
  async appRoleDeleteTokenNumUses(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleDeleteTokenNumUsesRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
  }
  ...
  /**
   */
  async appRoleDeleteTokenTtlRaw(
    requestParameters: AuthApiAppRoleDeleteTokenTtlRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}/token-ttl`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
  ...
  /**
   */
  async appRoleDeleteTokenTtl(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleDeleteTokenTtlRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
  }
  ...
  /**
   */
  async appRoleDestroySecretIdRaw(
    requestParameters: AuthApiAppRoleDestroySecretIdOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}/secret-id/destroy`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
  ...
  async appRoleDestroySecretId(
    ...
    await this.appRoleDestroySecretIdRaw(
      {
        roleName: roleName,
  ...
  /**
   */
  async appRoleDestroySecretId2Raw(
    requestParameters: AuthApiAppRoleDestroySecretId2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async appRoleDestroySecretId2(
    roleName: string,
    approleMountPath: string,
    secretId?: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleDestroySecretId2Raw(
      { roleName: roleName, approleMountPath: approleMountPath, secretId: secretId },
      initOverrides
    );
  }
  ...
  /**
   */
  async appRoleDestroySecretIdByAccessorRaw(
    requestParameters: AuthApiAppRoleDestroySecretIdByAccessorOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}/secret-id-accessor/destroy`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
        ...
        headers: headerParameters,
        query: queryParameters,
        body: AppRoleDestroySecretIdByAccessorRequestToJSON(
  ...
  /**
   */
  async appRoleDestroySecretIdByAccessor(
    roleName: string,
    approleMountPath: string,
    appRoleDestroySecretIdByAccessorRequest: AppRoleDestroySecretIdByAccessorRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleDestroySecretIdByAccessorRaw(
      {
        roleName: roleName,
        approleMountPath: approleMountPath,
        appRoleDestroySecretIdByAccessorRequest: appRoleDestroySecretIdByAccessorRequest,
  ...
  /**
   */
  async appRoleDestroySecretIdByAccessor2Raw(
    requestParameters: AuthApiAppRoleDestroySecretIdByAccessor2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async appRoleDestroySecretIdByAccessor2(
    roleName: string,
    approleMountPath: string,
    secretIdAccessor?: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleDestroySecretIdByAccessor2Raw(
      { roleName: roleName, approleMountPath: approleMountPath, secretIdAccessor: secretIdAccessor },
      initOverrides
    );
  }
  ...
  /**
   */
  async appRoleListRolesRaw(
    requestParameters: AuthApiAppRoleListRolesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['approleMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/`.replace(
          `{${'approle_mount_path'}}`,
          encodeURIComponent(String(requestParameters['approleMountPath']))
        ),
        method: 'GET',
  ...
  /**
   */
  async appRoleListRoles(
    approleMountPath: string,
    list: AppRoleListRolesListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.appRoleListRolesRaw(
      { approleMountPath: approleMountPath, list: list },
      initOverrides
    );
    return await response.value();
  }
  ...
  async appRoleListSecretIdsRaw(
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}/secret-id/`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
  ...
  /**
   */
  async appRoleListSecretIds(
    roleName: string,
    approleMountPath: string,
    list: AppRoleListSecretIdsListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.appRoleListSecretIdsRaw(
      { roleName: roleName, approleMountPath: approleMountPath, list: list },
      initOverrides
    );
    return await response.value();
  }
  ...
  /**
   */
  async appRoleLoginRaw(
    requestParameters: AuthApiAppRoleLoginOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['approleMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/login`.replace(
          `{${'approle_mount_path'}}`,
          encodeURIComponent(String(requestParameters['approleMountPath']))
        ),
        method: 'POST',
  ...
  async appRoleLogin(
    ...
    await this.appRoleLoginRaw(
      { approleMountPath: approleMountPath, appRoleLoginRequest: appRoleLoginRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async appRoleLookUpSecretIdRaw(
    requestParameters: AuthApiAppRoleLookUpSecretIdOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AppRoleLookUpSecretIdResponse>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
        'roleName',
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}/secret-id/lookup`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AppRoleLookUpSecretIdResponseFromJSON(jsonValue)
    );
  }
  ...
  async appRoleLookUpSecretId(
    ...
    appRoleLookUpSecretIdRequest: AppRoleLookUpSecretIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AppRoleLookUpSecretIdResponse> {
    const response = await this.appRoleLookUpSecretIdRaw(
      {
        roleName: roleName,
        approleMountPath: approleMountPath,
        appRoleLookUpSecretIdRequest: appRoleLookUpSecretIdRequest,
  ...
  /**
   */
  async appRoleLookUpSecretIdByAccessorRaw(
    requestParameters: AuthApiAppRoleLookUpSecretIdByAccessorOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AppRoleLookUpSecretIdByAccessorResponse>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
        'roleName',
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}/secret-id-accessor/lookup`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
        ...
        headers: headerParameters,
        query: queryParameters,
        body: AppRoleLookUpSecretIdByAccessorRequestToJSON(
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AppRoleLookUpSecretIdByAccessorResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async appRoleLookUpSecretIdByAccessor(
    roleName: string,
    approleMountPath: string,
    appRoleLookUpSecretIdByAccessorRequest: AppRoleLookUpSecretIdByAccessorRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AppRoleLookUpSecretIdByAccessorResponse> {
    const response = await this.appRoleLookUpSecretIdByAccessorRaw(
      {
        roleName: roleName,
        approleMountPath: approleMountPath,
        appRoleLookUpSecretIdByAccessorRequest: appRoleLookUpSecretIdByAccessorRequest,
  ...
  /**
   */
  async appRoleReadBindSecretIdRaw(
    requestParameters: AuthApiAppRoleReadBindSecretIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AppRoleReadBindSecretIdResponse>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
        'roleName',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AppRoleReadBindSecretIdResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async appRoleReadBindSecretId(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AppRoleReadBindSecretIdResponse> {
    const response = await this.appRoleReadBindSecretIdRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async appRoleReadBoundCidrListRaw(
    requestParameters: AuthApiAppRoleReadBoundCidrListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AppRoleReadBoundCidrListResponse>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
        'roleName',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AppRoleReadBoundCidrListResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async appRoleReadBoundCidrList(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AppRoleReadBoundCidrListResponse> {
    const response = await this.appRoleReadBoundCidrListRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async appRoleReadLocalSecretIdsRaw(
    requestParameters: AuthApiAppRoleReadLocalSecretIdsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AppRoleReadLocalSecretIdsResponse>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
        'roleName',
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}/local-secret-ids`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AppRoleReadLocalSecretIdsResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async appRoleReadLocalSecretIds(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AppRoleReadLocalSecretIdsResponse> {
    const response = await this.appRoleReadLocalSecretIdsRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async appRoleReadPeriodRaw(
    requestParameters: AuthApiAppRoleReadPeriodRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AppRoleReadPeriodResponse>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
        'roleName',
  ...
  /**
   */
  async appRoleReadPeriod(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AppRoleReadPeriodResponse> {
    const response = await this.appRoleReadPeriodRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async appRoleReadPoliciesRaw(
    requestParameters: AuthApiAppRoleReadPoliciesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AppRoleReadPoliciesResponse>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
        'roleName',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AppRoleReadPoliciesResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async appRoleReadPolicies(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AppRoleReadPoliciesResponse> {
    const response = await this.appRoleReadPoliciesRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async appRoleReadRoleRaw(
    requestParameters: AuthApiAppRoleReadRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AppRoleReadRoleResponse>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
        'roleName',
  ...
  /**
   */
  async appRoleReadRole(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AppRoleReadRoleResponse> {
    const response = await this.appRoleReadRoleRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async appRoleReadRoleIdRaw(
    requestParameters: AuthApiAppRoleReadRoleIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AppRoleReadRoleIdResponse>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
        'roleName',
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}/role-id`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
  ...
  /**
   */
  async appRoleReadRoleId(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AppRoleReadRoleIdResponse> {
    const response = await this.appRoleReadRoleIdRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async appRoleReadSecretIdBoundCidrsRaw(
    requestParameters: AuthApiAppRoleReadSecretIdBoundCidrsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AppRoleReadSecretIdBoundCidrsResponse>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
        'roleName',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AppRoleReadSecretIdBoundCidrsResponseFromJSON(jsonValue)
    );
  }
  ...
  async appRoleReadSecretIdBoundCidrs(
    ...
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AppRoleReadSecretIdBoundCidrsResponse> {
    const response = await this.appRoleReadSecretIdBoundCidrsRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async appRoleReadSecretIdNumUsesRaw(
    requestParameters: AuthApiAppRoleReadSecretIdNumUsesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AppRoleReadSecretIdNumUsesResponse>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
        'roleName',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AppRoleReadSecretIdNumUsesResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async appRoleReadSecretIdNumUses(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AppRoleReadSecretIdNumUsesResponse> {
    const response = await this.appRoleReadSecretIdNumUsesRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async appRoleReadSecretIdTtlRaw(
    requestParameters: AuthApiAppRoleReadSecretIdTtlRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AppRoleReadSecretIdTtlResponse>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
        'roleName',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AppRoleReadSecretIdTtlResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async appRoleReadSecretIdTtl(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AppRoleReadSecretIdTtlResponse> {
    const response = await this.appRoleReadSecretIdTtlRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async appRoleReadTokenBoundCidrsRaw(
    requestParameters: AuthApiAppRoleReadTokenBoundCidrsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AppRoleReadTokenBoundCidrsResponse>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
        'roleName',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AppRoleReadTokenBoundCidrsResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async appRoleReadTokenBoundCidrs(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AppRoleReadTokenBoundCidrsResponse> {
    const response = await this.appRoleReadTokenBoundCidrsRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async appRoleReadTokenMaxTtlRaw(
    requestParameters: AuthApiAppRoleReadTokenMaxTtlRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AppRoleReadTokenMaxTtlResponse>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
        'roleName',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AppRoleReadTokenMaxTtlResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async appRoleReadTokenMaxTtl(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AppRoleReadTokenMaxTtlResponse> {
    const response = await this.appRoleReadTokenMaxTtlRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async appRoleReadTokenNumUsesRaw(
    requestParameters: AuthApiAppRoleReadTokenNumUsesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AppRoleReadTokenNumUsesResponse>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
        'roleName',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AppRoleReadTokenNumUsesResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async appRoleReadTokenNumUses(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AppRoleReadTokenNumUsesResponse> {
    const response = await this.appRoleReadTokenNumUsesRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async appRoleReadTokenTtlRaw(
    requestParameters: AuthApiAppRoleReadTokenTtlRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AppRoleReadTokenTtlResponse>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
        'roleName',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AppRoleReadTokenTtlResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async appRoleReadTokenTtl(
    roleName: string,
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AppRoleReadTokenTtlResponse> {
    const response = await this.appRoleReadTokenTtlRaw(
      { roleName: roleName, approleMountPath: approleMountPath },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async appRoleTidySecretIdRaw(
    requestParameters: AuthApiAppRoleTidySecretIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['approleMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/tidy/secret-id`.replace(
          `{${'approle_mount_path'}}`,
          encodeURIComponent(String(requestParameters['approleMountPath']))
        ),
        method: 'POST',
  ...
  /**
   */
  async appRoleTidySecretId(
    approleMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleTidySecretIdRaw({ approleMountPath: approleMountPath }, initOverrides);
  }

  /**
   */
  async appRoleWriteBindSecretIdRaw(
  ...
  /**
   */
  async appRoleWriteBindSecretId(
    roleName: string,
    approleMountPath: string,
    appRoleWriteBindSecretIdRequest: AppRoleWriteBindSecretIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleWriteBindSecretIdRaw(
      {
        roleName: roleName,
        approleMountPath: approleMountPath,
        appRoleWriteBindSecretIdRequest: appRoleWriteBindSecretIdRequest,
  ...
  /**
   */
  async appRoleWriteBoundCidrListRaw(
    requestParameters: AuthApiAppRoleWriteBoundCidrListOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async appRoleWriteBoundCidrList(
    roleName: string,
    approleMountPath: string,
    appRoleWriteBoundCidrListRequest: AppRoleWriteBoundCidrListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleWriteBoundCidrListRaw(
      {
        roleName: roleName,
        approleMountPath: approleMountPath,
        appRoleWriteBoundCidrListRequest: appRoleWriteBoundCidrListRequest,
  ...
  /**
   */
  async appRoleWriteCustomSecretIdRaw(
    requestParameters: AuthApiAppRoleWriteCustomSecretIdOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AppRoleWriteCustomSecretIdResponse>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
        'roleName',
    ...
    const response = await this.request(
      {
        path: `/auth/{approle_mount_path}/role/{role_name}/custom-secret-id`
          .replace(`{${'role_name'}}`, encodeURIComponent(String(requestParameters['roleName'])))
          .replace(
            `{${'approle_mount_path'}}`,
            encodeURIComponent(String(requestParameters['approleMountPath']))
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AppRoleWriteCustomSecretIdResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async appRoleWriteCustomSecretId(
    roleName: string,
    approleMountPath: string,
    appRoleWriteCustomSecretIdRequest: AppRoleWriteCustomSecretIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AppRoleWriteCustomSecretIdResponse> {
    const response = await this.appRoleWriteCustomSecretIdRaw(
      {
        roleName: roleName,
        approleMountPath: approleMountPath,
        appRoleWriteCustomSecretIdRequest: appRoleWriteCustomSecretIdRequest,
  ...
  /**
   */
  async appRoleWritePeriodRaw(
    requestParameters: AuthApiAppRoleWritePeriodOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async appRoleWritePeriod(
    roleName: string,
    approleMountPath: string,
    appRoleWritePeriodRequest: AppRoleWritePeriodRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleWritePeriodRaw(
      {
        roleName: roleName,
        approleMountPath: approleMountPath,
        appRoleWritePeriodRequest: appRoleWritePeriodRequest,
  ...
  /**
   */
  async appRoleWritePoliciesRaw(
    requestParameters: AuthApiAppRoleWritePoliciesOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async appRoleWritePolicies(
    roleName: string,
    approleMountPath: string,
    appRoleWritePoliciesRequest: AppRoleWritePoliciesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleWritePoliciesRaw(
      {
        roleName: roleName,
        approleMountPath: approleMountPath,
        appRoleWritePoliciesRequest: appRoleWritePoliciesRequest,
  ...
  /**
   */
  async appRoleWriteRoleRaw(
    requestParameters: AuthApiAppRoleWriteRoleOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async appRoleWriteRole(
    roleName: string,
    approleMountPath: string,
    appRoleWriteRoleRequest: AppRoleWriteRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleWriteRoleRaw(
      {
        roleName: roleName,
        approleMountPath: approleMountPath,
        appRoleWriteRoleRequest: appRoleWriteRoleRequest,
  ...
  /**
   */
  async appRoleWriteRoleIdRaw(
    requestParameters: AuthApiAppRoleWriteRoleIdOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async appRoleWriteRoleId(
    roleName: string,
    approleMountPath: string,
    appRoleWriteRoleIdRequest: AppRoleWriteRoleIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleWriteRoleIdRaw(
      {
        roleName: roleName,
        approleMountPath: approleMountPath,
        appRoleWriteRoleIdRequest: appRoleWriteRoleIdRequest,
  ...
  /**
   */
  async appRoleWriteSecretIdRaw(
    requestParameters: AuthApiAppRoleWriteSecretIdOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AppRoleWriteSecretIdResponse>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
        'roleName',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AppRoleWriteSecretIdResponseFromJSON(jsonValue)
    );
  }

  /**
   */
  async appRoleWriteSecretId(
    roleName: string,
    approleMountPath: string,
    appRoleWriteSecretIdRequest: AppRoleWriteSecretIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AppRoleWriteSecretIdResponse> {
    const response = await this.appRoleWriteSecretIdRaw(
      {
        roleName: roleName,
        approleMountPath: approleMountPath,
        appRoleWriteSecretIdRequest: appRoleWriteSecretIdRequest,
  ...
  /**
   */
  async appRoleWriteSecretIdBoundCidrsRaw(
    requestParameters: AuthApiAppRoleWriteSecretIdBoundCidrsOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: AppRoleWriteSecretIdBoundCidrsRequestToJSON(
          requestParameters['appRoleWriteSecretIdBoundCidrsRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async appRoleWriteSecretIdBoundCidrs(
    roleName: string,
    approleMountPath: string,
    appRoleWriteSecretIdBoundCidrsRequest: AppRoleWriteSecretIdBoundCidrsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleWriteSecretIdBoundCidrsRaw(
      {
        roleName: roleName,
        approleMountPath: approleMountPath,
        appRoleWriteSecretIdBoundCidrsRequest: appRoleWriteSecretIdBoundCidrsRequest,
  ...
  /**
   */
  async appRoleWriteSecretIdNumUsesRaw(
    requestParameters: AuthApiAppRoleWriteSecretIdNumUsesOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: AppRoleWriteSecretIdNumUsesRequestToJSON(
          requestParameters['appRoleWriteSecretIdNumUsesRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async appRoleWriteSecretIdNumUses(
    roleName: string,
    approleMountPath: string,
    appRoleWriteSecretIdNumUsesRequest: AppRoleWriteSecretIdNumUsesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleWriteSecretIdNumUsesRaw(
      {
        roleName: roleName,
        approleMountPath: approleMountPath,
        appRoleWriteSecretIdNumUsesRequest: appRoleWriteSecretIdNumUsesRequest,
  ...
  /**
   */
  async appRoleWriteSecretIdTtlRaw(
    requestParameters: AuthApiAppRoleWriteSecretIdTtlOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async appRoleWriteSecretIdTtl(
    roleName: string,
    approleMountPath: string,
    appRoleWriteSecretIdTtlRequest: AppRoleWriteSecretIdTtlRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleWriteSecretIdTtlRaw(
      {
        roleName: roleName,
        approleMountPath: approleMountPath,
        appRoleWriteSecretIdTtlRequest: appRoleWriteSecretIdTtlRequest,
  ...
  /**
   */
  async appRoleWriteTokenBoundCidrsRaw(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: AppRoleWriteTokenBoundCidrsRequestToJSON(
          requestParameters['appRoleWriteTokenBoundCidrsRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async appRoleWriteTokenBoundCidrs(
    roleName: string,
    approleMountPath: string,
    appRoleWriteTokenBoundCidrsRequest: AppRoleWriteTokenBoundCidrsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleWriteTokenBoundCidrsRaw(
      {
        roleName: roleName,
        approleMountPath: approleMountPath,
        appRoleWriteTokenBoundCidrsRequest: appRoleWriteTokenBoundCidrsRequest,
  ...
  /**
   */
  async appRoleWriteTokenMaxTtlRaw(
    requestParameters: AuthApiAppRoleWriteTokenMaxTtlOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async appRoleWriteTokenMaxTtl(
    roleName: string,
    approleMountPath: string,
    appRoleWriteTokenMaxTtlRequest: AppRoleWriteTokenMaxTtlRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleWriteTokenMaxTtlRaw(
      {
        roleName: roleName,
        approleMountPath: approleMountPath,
        appRoleWriteTokenMaxTtlRequest: appRoleWriteTokenMaxTtlRequest,
  ...
  /**
   */
  async appRoleWriteTokenNumUsesRaw(
    requestParameters: AuthApiAppRoleWriteTokenNumUsesOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async appRoleWriteTokenNumUses(
    roleName: string,
    approleMountPath: string,
    appRoleWriteTokenNumUsesRequest: AppRoleWriteTokenNumUsesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleWriteTokenNumUsesRaw(
      {
        roleName: roleName,
        approleMountPath: approleMountPath,
        appRoleWriteTokenNumUsesRequest: appRoleWriteTokenNumUsesRequest,
  ...
  /**
   */
  async appRoleWriteTokenTtlRaw(
    requestParameters: AuthApiAppRoleWriteTokenTtlOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async appRoleWriteTokenTtl(
    roleName: string,
    approleMountPath: string,
    appRoleWriteTokenTtlRequest: AppRoleWriteTokenTtlRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.appRoleWriteTokenTtlRaw(
      {
        roleName: roleName,
        approleMountPath: approleMountPath,
        appRoleWriteTokenTtlRequest: appRoleWriteTokenTtlRequest,
  ...
  /**
   */
  async awsConfigureCertificateRaw(
    requestParameters: AuthApiAwsConfigureCertificateOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/config/certificate/{cert_name}`
          .replace(`{${'cert_name'}}`, encodeURIComponent(String(requestParameters['certName'])))
  ...
  /**
   */
  async awsConfigureCertificate(
    certName: string,
    awsMountPath: string,
    awsConfigureCertificateRequest: AwsConfigureCertificateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsConfigureCertificateRaw(
      {
        certName: certName,
  ...
  /**
   */
  async awsConfigureClientRaw(
    requestParameters: AuthApiAwsConfigureClientOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/config/client`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
  ...
  /**
   */
  async awsConfigureClient(
    awsMountPath: string,
    awsConfigureClientRequest: AwsConfigureClientRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsConfigureClientRaw(
      { awsMountPath: awsMountPath, awsConfigureClientRequest: awsConfigureClientRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async awsConfigureIdentityAccessListTidyOperationRaw(
    requestParameters: AuthApiAwsConfigureIdentityAccessListTidyOperationOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/config/tidy/identity-accesslist`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
        body: AwsConfigureIdentityAccessListTidyOperationRequestToJSON(
  ...
  /**
   */
  async awsConfigureIdentityAccessListTidyOperation(
    awsMountPath: string,
    awsConfigureIdentityAccessListTidyOperationRequest: AwsConfigureIdentityAccessListTidyOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsConfigureIdentityAccessListTidyOperationRaw(
      {
        awsMountPath: awsMountPath,
        awsConfigureIdentityAccessListTidyOperationRequest:
          awsConfigureIdentityAccessListTidyOperationRequest,
  ...
  /**
   */
  async awsConfigureIdentityIntegrationRaw(
    requestParameters: AuthApiAwsConfigureIdentityIntegrationOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/config/identity`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
        body: AwsConfigureIdentityIntegrationRequestToJSON(
  ...
  /**
   */
  async awsConfigureIdentityIntegration(
    awsMountPath: string,
    awsConfigureIdentityIntegrationRequest: AwsConfigureIdentityIntegrationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsConfigureIdentityIntegrationRaw(
      {
        awsMountPath: awsMountPath,
        awsConfigureIdentityIntegrationRequest: awsConfigureIdentityIntegrationRequest,
      },
  ...
  /**
   */
  async awsConfigureIdentityWhitelistTidyOperationRaw(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/config/tidy/identity-whitelist`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
        body: AwsConfigureIdentityWhitelistTidyOperationRequestToJSON(
          requestParameters['awsConfigureIdentityWhitelistTidyOperationRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async awsConfigureIdentityWhitelistTidyOperation(
    awsMountPath: string,
    awsConfigureIdentityWhitelistTidyOperationRequest: AwsConfigureIdentityWhitelistTidyOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsConfigureIdentityWhitelistTidyOperationRaw(
      {
        awsMountPath: awsMountPath,
        awsConfigureIdentityWhitelistTidyOperationRequest: awsConfigureIdentityWhitelistTidyOperationRequest,
      },
  ...
  /**
   */
  async awsConfigureRoleTagBlacklistTidyOperationRaw(
    requestParameters: AuthApiAwsConfigureRoleTagBlacklistTidyOperationOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/config/tidy/roletag-blacklist`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
        body: AwsConfigureRoleTagBlacklistTidyOperationRequestToJSON(
  ...
  /**
   */
  async awsConfigureRoleTagBlacklistTidyOperation(
    awsMountPath: string,
    awsConfigureRoleTagBlacklistTidyOperationRequest: AwsConfigureRoleTagBlacklistTidyOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsConfigureRoleTagBlacklistTidyOperationRaw(
      {
        awsMountPath: awsMountPath,
        awsConfigureRoleTagBlacklistTidyOperationRequest: awsConfigureRoleTagBlacklistTidyOperationRequest,
      },
  ...
  /**
   */
  async awsConfigureRoleTagDenyListTidyOperationRaw(
    requestParameters: AuthApiAwsConfigureRoleTagDenyListTidyOperationOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/config/tidy/roletag-denylist`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
        body: AwsConfigureRoleTagDenyListTidyOperationRequestToJSON(
          requestParameters['awsConfigureRoleTagDenyListTidyOperationRequest']
        ),
      },
      initOverrides
    );
  ...
  /**
   */
  async awsConfigureRoleTagDenyListTidyOperation(
    awsMountPath: string,
    awsConfigureRoleTagDenyListTidyOperationRequest: AwsConfigureRoleTagDenyListTidyOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsConfigureRoleTagDenyListTidyOperationRaw(
      {
        awsMountPath: awsMountPath,
        awsConfigureRoleTagDenyListTidyOperationRequest: awsConfigureRoleTagDenyListTidyOperationRequest,
      },
  ...
  /**
   */
  async awsDeleteAuthRoleRaw(
    requestParameters: AuthApiAwsDeleteAuthRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['role'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/role/{role}`
          .replace(`{${'role'}}`, encodeURIComponent(String(requestParameters['role'])))
          .replace(`{${'aws_mount_path'}}`, encodeURIComponent(String(requestParameters['awsMountPath']))),
        method: 'DELETE',
        headers: headerParameters,
  ...
  /**
   */
  async awsDeleteAuthRole(
    role: string,
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsDeleteAuthRoleRaw({ role: role, awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsDeleteCertificateConfigurationRaw(
  ...
  /**
   */
  async awsDeleteCertificateConfiguration(
    certName: string,
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsDeleteCertificateConfigurationRaw(
      { certName: certName, awsMountPath: awsMountPath },
      initOverrides
    );
  }
  ...
  /**
   */
  async awsDeleteClientConfigurationRaw(
  ...
  /**
   */
  async awsDeleteClientConfiguration(
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsDeleteClientConfigurationRaw({ awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsDeleteIdentityAccessListRaw(
    requestParameters: AuthApiAwsDeleteIdentityAccessListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/identity-accesslist/{instance_id}`
          .replace(`{${'instance_id'}}`, encodeURIComponent(String(requestParameters['instanceId'])))
          .replace(`{${'aws_mount_path'}}`, encodeURIComponent(String(requestParameters['awsMountPath']))),
        method: 'DELETE',
        headers: headerParameters,
        query: queryParameters,
  ...
  /**
   */
  async awsDeleteIdentityAccessList(
    instanceId: string,
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsDeleteIdentityAccessListRaw(
      { instanceId: instanceId, awsMountPath: awsMountPath },
      initOverrides
    );
  }
  ...
  /**
   */
  async awsDeleteIdentityAccessListTidySettingsRaw(
    requestParameters: AuthApiAwsDeleteIdentityAccessListTidySettingsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async awsDeleteIdentityAccessListTidySettings(
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsDeleteIdentityAccessListTidySettingsRaw({ awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsDeleteIdentityWhitelistRaw(
    requestParameters: AuthApiAwsDeleteIdentityWhitelistRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['instanceId'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/identity-whitelist/{instance_id}`
          .replace(`{${'instance_id'}}`, encodeURIComponent(String(requestParameters['instanceId'])))
          .replace(`{${'aws_mount_path'}}`, encodeURIComponent(String(requestParameters['awsMountPath']))),
        method: 'DELETE',
        headers: headerParameters,
  ...
  /**
   */
  async awsDeleteIdentityWhitelist(
    instanceId: string,
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsDeleteIdentityWhitelistRaw(
      { instanceId: instanceId, awsMountPath: awsMountPath },
      initOverrides
    );
  }
  ...
  /**
   */
  async awsDeleteIdentityWhitelistTidySettingsRaw(
  ...
  /**
   */
  async awsDeleteIdentityWhitelistTidySettings(
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsDeleteIdentityWhitelistTidySettingsRaw({ awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsDeleteRoleTagBlacklistRaw(
    requestParameters: AuthApiAwsDeleteRoleTagBlacklistRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/roletag-blacklist/{role_tag}`
          .replace(`{${'role_tag'}}`, encodeURIComponent(String(requestParameters['roleTag'])))
          .replace(`{${'aws_mount_path'}}`, encodeURIComponent(String(requestParameters['awsMountPath']))),
        method: 'DELETE',
        headers: headerParameters,
        query: queryParameters,
  ...
  /**
   */
  async awsDeleteRoleTagBlacklist(
    roleTag: string,
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsDeleteRoleTagBlacklistRaw({ roleTag: roleTag, awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsDeleteRoleTagBlacklistTidySettingsRaw(
  ...
  /**
   */
  async awsDeleteRoleTagBlacklistTidySettings(
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsDeleteRoleTagBlacklistTidySettingsRaw({ awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsDeleteRoleTagDenyListRaw(
    requestParameters: AuthApiAwsDeleteRoleTagDenyListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleTag'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/roletag-denylist/{role_tag}`
          .replace(`{${'role_tag'}}`, encodeURIComponent(String(requestParameters['roleTag'])))
          .replace(`{${'aws_mount_path'}}`, encodeURIComponent(String(requestParameters['awsMountPath']))),
        method: 'DELETE',
        headers: headerParameters,
  ...
  /**
   */
  async awsDeleteRoleTagDenyList(
    roleTag: string,
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsDeleteRoleTagDenyListRaw({ roleTag: roleTag, awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsDeleteRoleTagDenyListTidySettingsRaw(
    requestParameters: AuthApiAwsDeleteRoleTagDenyListTidySettingsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async awsDeleteRoleTagDenyListTidySettings(
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsDeleteRoleTagDenyListTidySettingsRaw({ awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsDeleteStsRoleRaw(
    requestParameters: AuthApiAwsDeleteStsRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/config/sts/{account_id}`
          .replace(`{${'account_id'}}`, encodeURIComponent(String(requestParameters['accountId'])))
          .replace(`{${'aws_mount_path'}}`, encodeURIComponent(String(requestParameters['awsMountPath']))),
        method: 'DELETE',
        headers: headerParameters,
        query: queryParameters,
  ...
  /**
   */
  async awsDeleteStsRole(
    accountId: string,
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsDeleteStsRoleRaw({ accountId: accountId, awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsListAuthRolesRaw(
    requestParameters: AuthApiAwsListAuthRolesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/role/`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'GET',
  ...
  /**
   */
  async awsListAuthRoles(
    awsMountPath: string,
    list: AwsListAuthRolesListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.awsListAuthRolesRaw(
      { awsMountPath: awsMountPath, list: list },
      initOverrides
    );
    return await response.value();
  }
  ...
  /**
   */
  async awsListAuthRoles2Raw(
    requestParameters: AuthApiAwsListAuthRoles2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/roles/`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'GET',
  ...
  /**
   */
  async awsListAuthRoles2(
    awsMountPath: string,
    list: AwsListAuthRoles2ListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.awsListAuthRoles2Raw(
      { awsMountPath: awsMountPath, list: list },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async awsListCertificateConfigurationsRaw(
    requestParameters: AuthApiAwsListCertificateConfigurationsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/config/certificates/`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'GET',
  ...
  /**
   */
  async awsListCertificateConfigurations(
    awsMountPath: string,
    list: AwsListCertificateConfigurationsListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.awsListCertificateConfigurationsRaw(
      { awsMountPath: awsMountPath, list: list },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async awsListIdentityAccessListRaw(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/identity-accesslist/`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'GET',
  ...
  /**
   */
  async awsListIdentityAccessList(
    awsMountPath: string,
    list: AwsListIdentityAccessListListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.awsListIdentityAccessListRaw(
      { awsMountPath: awsMountPath, list: list },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async awsListIdentityWhitelistRaw(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/identity-whitelist/`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'GET',
  ...
  /**
   */
  async awsListIdentityWhitelist(
    awsMountPath: string,
    list: AwsListIdentityWhitelistListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.awsListIdentityWhitelistRaw(
      { awsMountPath: awsMountPath, list: list },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async awsListRoleTagBlacklistsRaw(
    requestParameters: AuthApiAwsListRoleTagBlacklistsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/roletag-blacklist/`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'GET',
  ...
  /**
   */
  async awsListRoleTagBlacklists(
    awsMountPath: string,
    list: AwsListRoleTagBlacklistsListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.awsListRoleTagBlacklistsRaw(
      { awsMountPath: awsMountPath, list: list },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async awsListRoleTagDenyListsRaw(
    requestParameters: AuthApiAwsListRoleTagDenyListsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/roletag-denylist/`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'GET',
  ...
  async awsListRoleTagDenyLists(
    ...
    const response = await this.awsListRoleTagDenyListsRaw(
      { awsMountPath: awsMountPath, list: list },
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async awsListStsRoleRelationshipsRaw(
    requestParameters: AuthApiAwsListStsRoleRelationshipsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/config/sts/`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'GET',
  ...
  /**
   */
  async awsListStsRoleRelationships(
    awsMountPath: string,
    list: AwsListStsRoleRelationshipsListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.awsListStsRoleRelationshipsRaw(
      { awsMountPath: awsMountPath, list: list },
      initOverrides
    );
    return await response.value();
   ...
   */
  async awsLoginRaw(
    requestParameters: AuthApiAwsLoginOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/login`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'POST',
  ...
  async awsLogin(
    ...
    await this.awsLoginRaw({ awsMountPath: awsMountPath, awsLoginRequest: awsLoginRequest }, initOverrides);
  }

  /**
   */
  async awsReadAuthRoleRaw(
    requestParameters: AuthApiAwsReadAuthRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['role'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async awsReadAuthRole(
    role: string,
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsReadAuthRoleRaw({ role: role, awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsReadCertificateConfigurationRaw(
    requestParameters: AuthApiAwsReadCertificateConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['certName'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async awsReadCertificateConfiguration(
    certName: string,
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsReadCertificateConfigurationRaw(
      { certName: certName, awsMountPath: awsMountPath },
      initOverrides
    );
  }
  ...
  /**
   */
  async awsReadClientConfigurationRaw(
    requestParameters: AuthApiAwsReadClientConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async awsReadClientConfiguration(
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsReadClientConfigurationRaw({ awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsReadIdentityAccessListRaw(
    requestParameters: AuthApiAwsReadIdentityAccessListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['instanceId'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async awsReadIdentityAccessList(
    instanceId: string,
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsReadIdentityAccessListRaw(
      { instanceId: instanceId, awsMountPath: awsMountPath },
      initOverrides
    );
  }
  ...
  /**
   */
  async awsReadIdentityAccessListTidySettingsRaw(
  ...
  /**
   */
  async awsReadIdentityAccessListTidySettings(
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsReadIdentityAccessListTidySettingsRaw({ awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsReadIdentityIntegrationConfigurationRaw(
    requestParameters: AuthApiAwsReadIdentityIntegrationConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async awsReadIdentityIntegrationConfiguration(
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsReadIdentityIntegrationConfigurationRaw({ awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsReadIdentityWhitelistRaw(
    requestParameters: AuthApiAwsReadIdentityWhitelistRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['instanceId'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async awsReadIdentityWhitelist(
    instanceId: string,
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsReadIdentityWhitelistRaw(
      { instanceId: instanceId, awsMountPath: awsMountPath },
      initOverrides
    );
  }
  ...
  /**
   */
  async awsReadIdentityWhitelistTidySettingsRaw(
    requestParameters: AuthApiAwsReadIdentityWhitelistTidySettingsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async awsReadIdentityWhitelistTidySettings(
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsReadIdentityWhitelistTidySettingsRaw({ awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsReadRoleTagBlacklistRaw(
    requestParameters: AuthApiAwsReadRoleTagBlacklistRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleTag'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async awsReadRoleTagBlacklist(
    roleTag: string,
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsReadRoleTagBlacklistRaw({ roleTag: roleTag, awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsReadRoleTagBlacklistTidySettingsRaw(
  ...
  /**
   */
  async awsReadRoleTagBlacklistTidySettings(
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsReadRoleTagBlacklistTidySettingsRaw({ awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsReadRoleTagDenyListRaw(
    requestParameters: AuthApiAwsReadRoleTagDenyListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleTag'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async awsReadRoleTagDenyList(
    roleTag: string,
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsReadRoleTagDenyListRaw({ roleTag: roleTag, awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsReadRoleTagDenyListTidySettingsRaw(
    requestParameters: AuthApiAwsReadRoleTagDenyListTidySettingsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async awsReadRoleTagDenyListTidySettings(
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsReadRoleTagDenyListTidySettingsRaw({ awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsReadStsRoleRaw(
    requestParameters: AuthApiAwsReadStsRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['accountId'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async awsReadStsRole(
    accountId: string,
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsReadStsRoleRaw({ accountId: accountId, awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsRotateRootCredentialsRaw(
    requestParameters: AuthApiAwsRotateRootCredentialsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/config/rotate-root`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'POST',
  ...
  /**
   */
  async awsRotateRootCredentials(
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsRotateRootCredentialsRaw({ awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsTidyIdentityAccessListRaw(
    requestParameters: AuthApiAwsTidyIdentityAccessListOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/tidy/identity-accesslist`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'POST',
  ...
  /**
   */
  async awsTidyIdentityAccessList(
    awsMountPath: string,
    awsTidyIdentityAccessListRequest: AwsTidyIdentityAccessListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsTidyIdentityAccessListRaw(
      { awsMountPath: awsMountPath, awsTidyIdentityAccessListRequest: awsTidyIdentityAccessListRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async awsTidyIdentityWhitelistRaw(
    requestParameters: AuthApiAwsTidyIdentityWhitelistOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/tidy/identity-whitelist`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'POST',
  ...
  /**
   */
  async awsTidyIdentityWhitelist(
    awsMountPath: string,
    awsTidyIdentityWhitelistRequest: AwsTidyIdentityWhitelistRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsTidyIdentityWhitelistRaw(
      { awsMountPath: awsMountPath, awsTidyIdentityWhitelistRequest: awsTidyIdentityWhitelistRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async awsTidyRoleTagBlacklistRaw(
    requestParameters: AuthApiAwsTidyRoleTagBlacklistOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/tidy/roletag-blacklist`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'POST',
  ...
  /**
   */
  async awsTidyRoleTagBlacklist(
    awsMountPath: string,
    awsTidyRoleTagBlacklistRequest: AwsTidyRoleTagBlacklistRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsTidyRoleTagBlacklistRaw(
      { awsMountPath: awsMountPath, awsTidyRoleTagBlacklistRequest: awsTidyRoleTagBlacklistRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async awsTidyRoleTagDenyListRaw(
    requestParameters: AuthApiAwsTidyRoleTagDenyListOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['awsMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/tidy/roletag-denylist`.replace(
          `{${'aws_mount_path'}}`,
          encodeURIComponent(String(requestParameters['awsMountPath']))
        ),
        method: 'POST',
  ...
  /**
   */
  async awsTidyRoleTagDenyList(
    awsMountPath: string,
    awsTidyRoleTagDenyListRequest: AwsTidyRoleTagDenyListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsTidyRoleTagDenyListRaw(
      { awsMountPath: awsMountPath, awsTidyRoleTagDenyListRequest: awsTidyRoleTagDenyListRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async awsWriteAuthRoleRaw(
    requestParameters: AuthApiAwsWriteAuthRoleOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['role'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async awsWriteAuthRole(
    role: string,
    awsMountPath: string,
    awsWriteAuthRoleRequest: AwsWriteAuthRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsWriteAuthRoleRaw(
      { role: role, awsMountPath: awsMountPath, awsWriteAuthRoleRequest: awsWriteAuthRoleRequest },
      initOverrides
    );
  }
  ...
  async awsWriteRoleTagRaw(
    ...
    const response = await this.request(
      {
        path: `/auth/{aws_mount_path}/role/{role}/tag`
          .replace(`{${'role'}}`, encodeURIComponent(String(requestParameters['role'])))
          .replace(`{${'aws_mount_path'}}`, encodeURIComponent(String(requestParameters['awsMountPath']))),
        method: 'POST',
        headers: headerParameters,
  ...
  /**
   */
  async awsWriteRoleTag(
    role: string,
    awsMountPath: string,
    awsWriteRoleTagRequest: AwsWriteRoleTagRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsWriteRoleTagRaw(
      { role: role, awsMountPath: awsMountPath, awsWriteRoleTagRequest: awsWriteRoleTagRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async awsWriteRoleTagBlacklistRaw(
    requestParameters: AuthApiAwsWriteRoleTagBlacklistRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleTag'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async awsWriteRoleTagBlacklist(
    roleTag: string,
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsWriteRoleTagBlacklistRaw({ roleTag: roleTag, awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsWriteRoleTagDenyListRaw(
    requestParameters: AuthApiAwsWriteRoleTagDenyListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleTag'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async awsWriteRoleTagDenyList(
    roleTag: string,
    awsMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsWriteRoleTagDenyListRaw({ roleTag: roleTag, awsMountPath: awsMountPath }, initOverrides);
  }

  /**
   */
  async awsWriteStsRoleRaw(
    requestParameters: AuthApiAwsWriteStsRoleOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['accountId'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async awsWriteStsRole(
    accountId: string,
    awsMountPath: string,
    awsWriteStsRoleRequest: AwsWriteStsRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.awsWriteStsRoleRaw(
      { accountId: accountId, awsMountPath: awsMountPath, awsWriteStsRoleRequest: awsWriteStsRoleRequest },
      initOverrides
    );
  }
  ...
  async azureConfigureAuthRaw(
    ...
    const response = await this.request(
      {
        path: `/auth/{azure_mount_path}/config`.replace(
          `{${'azure_mount_path'}}`,
          encodeURIComponent(String(requestParameters['azureMountPath']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
  ...
  /**
   */
  async azureConfigureAuth(
    azureMountPath: string,
    azureConfigureAuthRequest: AzureConfigureAuthRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.azureConfigureAuthRaw(
      { azureMountPath: azureMountPath, azureConfigureAuthRequest: azureConfigureAuthRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async azureDeleteAuthConfigurationRaw(
    requestParameters: AuthApiAzureDeleteAuthConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['azureMountPath'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async azureDeleteAuthConfiguration(
    azureMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.azureDeleteAuthConfigurationRaw({ azureMountPath: azureMountPath }, initOverrides);
  }

  /**
   */
  async azureDeleteAuthRoleRaw(
    requestParameters: AuthApiAzureDeleteAuthRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/auth/{azure_mount_path}/role/{name}`
  ...
  /**
   */
  async azureDeleteAuthRole(
    name: string,
    azureMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.azureDeleteAuthRoleRaw({ name: name, azureMountPath: azureMountPath }, initOverrides);
  }

  /**
   */
  async azureListAuthRolesRaw(
    requestParameters: AuthApiAzureListAuthRolesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['azureMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{azure_mount_path}/role/`.replace(
          `{${'azure_mount_path'}}`,
          encodeURIComponent(String(requestParameters['azureMountPath']))
        ),
        method: 'GET',
  ...
  /**
   */
  async azureListAuthRoles(
    azureMountPath: string,
    list: AzureListAuthRolesListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.azureListAuthRolesRaw(
      { azureMountPath: azureMountPath, list: list },
      initOverrides
    );
    return await response.value();
  }
   ...
   */
  async azureLoginRaw(
    requestParameters: AuthApiAzureLoginOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['azureMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{azure_mount_path}/login`.replace(
          `{${'azure_mount_path'}}`,
          encodeURIComponent(String(requestParameters['azureMountPath']))
        ),
        method: 'POST',
  ...
  async azureLogin(
    ...
    await this.azureLoginRaw(
      { azureMountPath: azureMountPath, azureLoginRequest: azureLoginRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async azureReadAuthConfigurationRaw(
  ...
  /**
   */
  async azureReadAuthConfiguration(
    azureMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.azureReadAuthConfigurationRaw({ azureMountPath: azureMountPath }, initOverrides);
  }

  /**
   */
  async azureReadAuthRoleRaw(
    requestParameters: AuthApiAzureReadAuthRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async azureReadAuthRole(
    name: string,
    azureMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.azureReadAuthRoleRaw({ name: name, azureMountPath: azureMountPath }, initOverrides);
  }

  /**
   */
  async azureRotateRootCredentialsRaw(
    requestParameters: AuthApiAzureRotateRootCredentialsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['azureMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{azure_mount_path}/rotate-root`.replace(
          `{${'azure_mount_path'}}`,
          encodeURIComponent(String(requestParameters['azureMountPath']))
        ),
        method: 'POST',
  ...
  /**
   */
  async azureRotateRootCredentials(
    azureMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.azureRotateRootCredentialsRaw({ azureMountPath: azureMountPath }, initOverrides);
  }

  /**
   */
  async azureWriteAuthRoleRaw(
    requestParameters: AuthApiAzureWriteAuthRoleOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async azureWriteAuthRole(
    name: string,
    azureMountPath: string,
    azureWriteAuthRoleRequest: AzureWriteAuthRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.azureWriteAuthRoleRaw(
      { name: name, azureMountPath: azureMountPath, azureWriteAuthRoleRequest: azureWriteAuthRoleRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async certConfigureRaw(
    requestParameters: AuthApiCertConfigureOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/auth/{cert_mount_path}/config`.replace(
          `{${'cert_mount_path'}}`,
          encodeURIComponent(String(requestParameters['certMountPath']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
  ...
  async certConfigure(
    ...
    await this.certConfigureRaw(
      { certMountPath: certMountPath, certConfigureRequest: certConfigureRequest },
      initOverrides
    );
  }
   ...
   */
  async certDeleteCertificateRaw(
    requestParameters: AuthApiCertDeleteCertificateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{cert_mount_path}/certs/{name}`
          .replace(`{${'name'}}`, encodeURIComponent(String(requestParameters['name'])))
          .replace(`{${'cert_mount_path'}}`, encodeURIComponent(String(requestParameters['certMountPath']))),
        method: 'DELETE',
        headers: headerParameters,
        query: queryParameters,
      },
   ...
   * Manage trusted certificates used for authentication.
   */
  async certDeleteCertificate(
    name: string,
    certMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.certDeleteCertificateRaw({ name: name, certMountPath: certMountPath }, initOverrides);
  }

  /**
   * Manage Certificate Revocation Lists checked during authentication.
   */
  async certDeleteCrlRaw(
    requestParameters: AuthApiCertDeleteCrlRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{cert_mount_path}/crls/{name}`
          .replace(`{${'name'}}`, encodeURIComponent(String(requestParameters['name'])))
          .replace(`{${'cert_mount_path'}}`, encodeURIComponent(String(requestParameters['certMountPath']))),
        method: 'DELETE',
        headers: headerParameters,
  ...
  async certDeleteCrl(
    ...
    await this.certDeleteCrlRaw({ name: name, certMountPath: certMountPath }, initOverrides);
  }

  /**
   * Manage trusted certificates used for authentication.
   */
  async certListCertificatesRaw(
    requestParameters: AuthApiCertListCertificatesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['certMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{cert_mount_path}/certs/`.replace(
          `{${'cert_mount_path'}}`,
          encodeURIComponent(String(requestParameters['certMountPath']))
        ),
        method: 'GET',
   ...
   * Manage trusted certificates used for authentication.
   */
  async certListCertificates(
    certMountPath: string,
    list: CertListCertificatesListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.certListCertificatesRaw(
      { certMountPath: certMountPath, list: list },
      initOverrides
    );
    return await response.value();
  }
  ...
  /**
   */
  async certListCrlsRaw(
    requestParameters: AuthApiCertListCrlsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['certMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{cert_mount_path}/crls/`.replace(
          `{${'cert_mount_path'}}`,
          encodeURIComponent(String(requestParameters['certMountPath']))
        ),
        method: 'GET',
  ...
  async certLoginRaw(
    ...
    const response = await this.request(
      {
        path: `/auth/{cert_mount_path}/login`.replace(
          `{${'cert_mount_path'}}`,
          encodeURIComponent(String(requestParameters['certMountPath']))
        ),
        method: 'POST',
  ...
  async certLogin(
    ...
    await this.certLoginRaw(
      { certMountPath: certMountPath, certLoginRequest: certLoginRequest },
      initOverrides
    );
  }
   ...
   * Manage trusted certificates used for authentication.
   */
  async certReadCertificateRaw(
    requestParameters: AuthApiCertReadCertificateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Manage trusted certificates used for authentication.
   */
  async certReadCertificate(
    name: string,
    certMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.certReadCertificateRaw({ name: name, certMountPath: certMountPath }, initOverrides);
  }

  /**
   */
  async certReadConfigurationRaw(
    requestParameters: AuthApiCertReadConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['certMountPath'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async certReadConfiguration(
    certMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.certReadConfigurationRaw({ certMountPath: certMountPath }, initOverrides);
  }

  /**
   * Manage Certificate Revocation Lists checked during authentication.
   */
  async certReadCrlRaw(
    requestParameters: AuthApiCertReadCrlRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
  ...
  async certReadCrl(
    ...
    await this.certReadCrlRaw({ name: name, certMountPath: certMountPath }, initOverrides);
  }

  /**
   * Manage trusted certificates used for authentication.
   */
  async certWriteCertificateRaw(
    requestParameters: AuthApiCertWriteCertificateOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Manage trusted certificates used for authentication.
   */
  async certWriteCertificate(
    name: string,
    certMountPath: string,
    certWriteCertificateRequest: CertWriteCertificateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.certWriteCertificateRaw(
      { name: name, certMountPath: certMountPath, certWriteCertificateRequest: certWriteCertificateRequest },
      initOverrides
    );
  }
  ...
  async certWriteCrl(
    ...
    await this.certWriteCrlRaw(
      { name: name, certMountPath: certMountPath, certWriteCrlRequest: certWriteCrlRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async cloudFoundryConfigureRaw(
    requestParameters: AuthApiCloudFoundryConfigureOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/auth/{cf_mount_path}/config`.replace(
          `{${'cf_mount_path'}}`,
          encodeURIComponent(String(requestParameters['cfMountPath']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
  ...
  /**
   */
  async cloudFoundryConfigure(
    cfMountPath: string,
    cloudFoundryConfigureRequest: CloudFoundryConfigureRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.cloudFoundryConfigureRaw(
      { cfMountPath: cfMountPath, cloudFoundryConfigureRequest: cloudFoundryConfigureRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async cloudFoundryDeleteConfigurationRaw(
    requestParameters: AuthApiCloudFoundryDeleteConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['cfMountPath'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async cloudFoundryDeleteConfiguration(
    cfMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.cloudFoundryDeleteConfigurationRaw({ cfMountPath: cfMountPath }, initOverrides);
  }

  /**
   */
  async cloudFoundryDeleteRoleRaw(
    requestParameters: AuthApiCloudFoundryDeleteRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['role'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{cf_mount_path}/roles/{role}`
          .replace(`{${'role'}}`, encodeURIComponent(String(requestParameters['role'])))
          .replace(`{${'cf_mount_path'}}`, encodeURIComponent(String(requestParameters['cfMountPath']))),
        method: 'DELETE',
        headers: headerParameters,
        query: queryParameters,
      },
  ...
  /**
   */
  async cloudFoundryDeleteRole(
    role: string,
    cfMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.cloudFoundryDeleteRoleRaw({ role: role, cfMountPath: cfMountPath }, initOverrides);
  }

  /**
   */
  async cloudFoundryListRolesRaw(
    requestParameters: AuthApiCloudFoundryListRolesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['cfMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{cf_mount_path}/roles/`.replace(
          `{${'cf_mount_path'}}`,
          encodeURIComponent(String(requestParameters['cfMountPath']))
        ),
        method: 'GET',
  ...
  async cloudFoundryListRoles(
    ...
    const response = await this.cloudFoundryListRolesRaw(
      { cfMountPath: cfMountPath, list: list },
      initOverrides
    );
    return await response.value();
  }
  ...
  /**
   */
  async cloudFoundryLoginRaw(
    requestParameters: AuthApiCloudFoundryLoginOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['cfMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{cf_mount_path}/login`.replace(
          `{${'cf_mount_path'}}`,
          encodeURIComponent(String(requestParameters['cfMountPath']))
        ),
        method: 'POST',
  ...
  /**
   */
  async cloudFoundryLogin(
    cfMountPath: string,
    cloudFoundryLoginRequest: CloudFoundryLoginRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.cloudFoundryLoginRaw(
      { cfMountPath: cfMountPath, cloudFoundryLoginRequest: cloudFoundryLoginRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async cloudFoundryReadConfigurationRaw(
    requestParameters: AuthApiCloudFoundryReadConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['cfMountPath'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async cloudFoundryReadConfiguration(
    cfMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.cloudFoundryReadConfigurationRaw({ cfMountPath: cfMountPath }, initOverrides);
  }

  /**
   */
  async cloudFoundryReadRoleRaw(
    requestParameters: AuthApiCloudFoundryReadRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['role'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async cloudFoundryReadRole(
    role: string,
    cfMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.cloudFoundryReadRoleRaw({ role: role, cfMountPath: cfMountPath }, initOverrides);
  }

  /**
   */
  async cloudFoundryWriteRoleRaw(
    requestParameters: AuthApiCloudFoundryWriteRoleOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['role'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async cloudFoundryWriteRole(
    role: string,
    cfMountPath: string,
    cloudFoundryWriteRoleRequest: CloudFoundryWriteRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.cloudFoundryWriteRoleRaw(
      { role: role, cfMountPath: cfMountPath, cloudFoundryWriteRoleRequest: cloudFoundryWriteRoleRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async githubConfigureRaw(
    requestParameters: AuthApiGithubConfigureOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/auth/{github_mount_path}/config`.replace(
          `{${'github_mount_path'}}`,
          encodeURIComponent(String(requestParameters['githubMountPath']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
  ...
  /**
   */
  async githubConfigure(
    githubMountPath: string,
    githubConfigureRequest: GithubConfigureRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.githubConfigureRaw(
   ...
   */
  async githubDeleteTeamMappingRaw(
    requestParameters: AuthApiGithubDeleteTeamMappingRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/auth/{github_mount_path}/map/teams/{key}`
   ...
   * Read/write/delete a single teams mapping
   */
  async githubDeleteTeamMapping(
    key: string,
    githubMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.githubDeleteTeamMappingRaw({ key: key, githubMountPath: githubMountPath }, initOverrides);
  }

  /**
   * Read/write/delete a single users mapping
   */
  async githubDeleteUserMappingRaw(
    requestParameters: AuthApiGithubDeleteUserMappingRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['key'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{github_mount_path}/map/users/{key}`
          .replace(`{${'key'}}`, encodeURIComponent(String(requestParameters['key'])))
          .replace(
            `{${'github_mount_path'}}`,
            encodeURIComponent(String(requestParameters['githubMountPath']))
   ...
   * Read/write/delete a single users mapping
   */
  async githubDeleteUserMapping(
    key: string,
    githubMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.githubDeleteUserMappingRaw({ key: key, githubMountPath: githubMountPath }, initOverrides);
  }

  /**
   * Read mappings for teams
   */
  async githubListTeamsRaw(
    requestParameters: AuthApiGithubListTeamsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['githubMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{github_mount_path}/map/teams/`.replace(
          `{${'github_mount_path'}}`,
          encodeURIComponent(String(requestParameters['githubMountPath']))
        ),
        method: 'GET',
   ...
   * Read mappings for teams
   */
  async githubListTeams(
    githubMountPath: string,
    list: GithubListTeamsListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.githubListTeamsRaw(
      { githubMountPath: githubMountPath, list: list },
      initOverrides
    );
    return await response.value();
  }
   ...
   * Read mappings for teams
   */
  async githubListTeams2Raw(
    requestParameters: AuthApiGithubListTeams2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['githubMountPath'] == null) {
      throw new runtime.RequiredError(
   ...
   * Read mappings for teams
   */
  async githubListTeams2(
    githubMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.githubListTeams2Raw({ githubMountPath: githubMountPath }, initOverrides);
  }

  /**
   * Read mappings for users
   */
  async githubListUsersRaw(
    requestParameters: AuthApiGithubListUsersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['githubMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{github_mount_path}/map/users/`.replace(
          `{${'github_mount_path'}}`,
          encodeURIComponent(String(requestParameters['githubMountPath']))
        ),
        method: 'GET',
   ...
   * Read mappings for users
   */
  async githubListUsers(
    githubMountPath: string,
    list: GithubListUsersListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.githubListUsersRaw(
      { githubMountPath: githubMountPath, list: list },
      initOverrides
    );
    return await response.value();
   ...
   * Read mappings for users
   */
  async githubListUsers2Raw(
    requestParameters: AuthApiGithubListUsers2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['githubMountPath'] == null) {
      throw new runtime.RequiredError(
   ...
   * Read mappings for users
   */
  async githubListUsers2(
    githubMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.githubListUsers2Raw({ githubMountPath: githubMountPath }, initOverrides);
  }

  /**
   */
  async githubLoginRaw(
    requestParameters: AuthApiGithubLoginOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['githubMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{github_mount_path}/login`.replace(
          `{${'github_mount_path'}}`,
          encodeURIComponent(String(requestParameters['githubMountPath']))
        ),
        method: 'POST',
  ...
  async githubLogin(
    ...
    await this.githubLoginRaw(
      { githubMountPath: githubMountPath, githubLoginRequest: githubLoginRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async githubReadConfigurationRaw(
    requestParameters: AuthApiGithubReadConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['githubMountPath'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async githubReadConfiguration(
    githubMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.githubReadConfigurationRaw({ githubMountPath: githubMountPath }, initOverrides);
  }

  /**
   * Read/write/delete a single teams mapping
   */
  async githubReadTeamMappingRaw(
    requestParameters: AuthApiGithubReadTeamMappingRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['key'] == null) {
      throw new runtime.RequiredError(
   ...
   * Read/write/delete a single teams mapping
   */
  async githubReadTeamMapping(
    key: string,
    githubMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.githubReadTeamMappingRaw({ key: key, githubMountPath: githubMountPath }, initOverrides);
  }

  /**
   * Read/write/delete a single users mapping
   */
  async githubReadUserMappingRaw(
    requestParameters: AuthApiGithubReadUserMappingRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['key'] == null) {
      throw new runtime.RequiredError(
   ...
   * Read/write/delete a single users mapping
   */
  async githubReadUserMapping(
    key: string,
    githubMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.githubReadUserMappingRaw({ key: key, githubMountPath: githubMountPath }, initOverrides);
  }

  /**
   * Read/write/delete a single teams mapping
   */
  async githubWriteTeamMappingRaw(
    requestParameters: AuthApiGithubWriteTeamMappingOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['key'] == null) {
      throw new runtime.RequiredError(
   ...
   * Read/write/delete a single teams mapping
   */
  async githubWriteTeamMapping(
    key: string,
    githubMountPath: string,
    githubWriteTeamMappingRequest: GithubWriteTeamMappingRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.githubWriteTeamMappingRaw(
      {
        key: key,
        githubMountPath: githubMountPath,
        githubWriteTeamMappingRequest: githubWriteTeamMappingRequest,
      },
      initOverrides
    );
   ...
   * Read/write/delete a single users mapping
   */
  async githubWriteUserMappingRaw(
   ...
   * Read/write/delete a single users mapping
   */
  async githubWriteUserMapping(
    key: string,
    githubMountPath: string,
    githubWriteUserMappingRequest: GithubWriteUserMappingRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.githubWriteUserMappingRaw(
      {
        key: key,
        githubMountPath: githubMountPath,
        githubWriteUserMappingRequest: githubWriteUserMappingRequest,
  ...
  /**
   */
  async googleCloudConfigureAuthRaw(
    ...
    const response = await this.request(
      {
        path: `/auth/{gcp_mount_path}/config`.replace(
          `{${'gcp_mount_path'}}`,
          encodeURIComponent(String(requestParameters['gcpMountPath']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
  ...
  /**
   */
  async googleCloudConfigureAuth(
    gcpMountPath: string,
    googleCloudConfigureAuthRequest: GoogleCloudConfigureAuthRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.googleCloudConfigureAuthRaw(
      { gcpMountPath: gcpMountPath, googleCloudConfigureAuthRequest: googleCloudConfigureAuthRequest },
      initOverrides
    );
  }
   ...
   */
  async googleCloudDeleteRoleRaw(
    requestParameters: AuthApiGoogleCloudDeleteRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{gcp_mount_path}/role/{name}`
          .replace(`{${'name'}}`, encodeURIComponent(String(requestParameters['name'])))
   ...
   * Create a GCP role with associated policies and required attributes.
   */
  async googleCloudDeleteRole(
    name: string,
    gcpMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.googleCloudDeleteRoleRaw({ name: name, gcpMountPath: gcpMountPath }, initOverrides);
  }

  /**
   * Add or remove labels for an existing \'gce\' role
   */
  async googleCloudEditLabelsForRoleRaw(
    requestParameters: AuthApiGoogleCloudEditLabelsForRoleOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{gcp_mount_path}/role/{name}/labels`
          .replace(`{${'name'}}`, encodeURIComponent(String(requestParameters['name'])))
          .replace(`{${'gcp_mount_path'}}`, encodeURIComponent(String(requestParameters['gcpMountPath']))),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
        body: GoogleCloudEditLabelsForRoleRequestToJSON(
          requestParameters['googleCloudEditLabelsForRoleRequest']
        ),
      },
      initOverrides
    );
   ...
   * Add or remove labels for an existing \'gce\' role
   */
  async googleCloudEditLabelsForRole(
    name: string,
    gcpMountPath: string,
    googleCloudEditLabelsForRoleRequest: GoogleCloudEditLabelsForRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.googleCloudEditLabelsForRoleRaw(
      {
        name: name,
   ...
   */
  async googleCloudEditServiceAccountsForRoleRaw(
    ...
    const response = await this.request(
      {
        path: `/auth/{gcp_mount_path}/role/{name}/service-accounts`
          .replace(`{${'name'}}`, encodeURIComponent(String(requestParameters['name'])))
          .replace(`{${'gcp_mount_path'}}`, encodeURIComponent(String(requestParameters['gcpMountPath']))),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
        body: GoogleCloudEditServiceAccountsForRoleRequestToJSON(
          requestParameters['googleCloudEditServiceAccountsForRoleRequest']
        ),
      },
      initOverrides
    );
   ...
   * Add or remove service accounts for an existing `iam` role
   */
  async googleCloudEditServiceAccountsForRole(
    name: string,
    gcpMountPath: string,
    googleCloudEditServiceAccountsForRoleRequest: GoogleCloudEditServiceAccountsForRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.googleCloudEditServiceAccountsForRoleRaw(
      {
        name: name,
        gcpMountPath: gcpMountPath,
        googleCloudEditServiceAccountsForRoleRequest: googleCloudEditServiceAccountsForRoleRequest,
  ...
  async googleCloudListRolesRaw(
    ...
    const response = await this.request(
      {
        path: `/auth/{gcp_mount_path}/role/`.replace(
          `{${'gcp_mount_path'}}`,
          encodeURIComponent(String(requestParameters['gcpMountPath']))
        ),
        method: 'GET',
   ...
   * Lists all the roles that are registered with Vault.
   */
  async googleCloudListRoles(
    gcpMountPath: string,
    list: GoogleCloudListRolesListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.googleCloudListRolesRaw(
      { gcpMountPath: gcpMountPath, list: list },
      initOverrides
    );
    return await response.value();
  }
   ...
   * Lists all the roles that are registered with Vault.
   */
  async googleCloudListRoles2Raw(
    requestParameters: AuthApiGoogleCloudListRoles2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['gcpMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{gcp_mount_path}/roles/`.replace(
          `{${'gcp_mount_path'}}`,
          encodeURIComponent(String(requestParameters['gcpMountPath']))
        ),
        method: 'GET',
   ...
   * Lists all the roles that are registered with Vault.
   */
  async googleCloudListRoles2(
    gcpMountPath: string,
    list: GoogleCloudListRoles2ListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.googleCloudListRoles2Raw(
      { gcpMountPath: gcpMountPath, list: list },
      initOverrides
    );
    return await response.value();
  ...
  async googleCloudLoginRaw(
    ...
    const response = await this.request(
      {
        path: `/auth/{gcp_mount_path}/login`.replace(
          `{${'gcp_mount_path'}}`,
          encodeURIComponent(String(requestParameters['gcpMountPath']))
        ),
        method: 'POST',
  ...
  /**
   */
  async googleCloudLogin(
    gcpMountPath: string,
    googleCloudLoginRequest: GoogleCloudLoginRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.googleCloudLoginRaw(
      { gcpMountPath: gcpMountPath, googleCloudLoginRequest: googleCloudLoginRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async googleCloudReadAuthConfigurationRaw(
  ...
  /**
   */
  async googleCloudReadAuthConfiguration(
    gcpMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.googleCloudReadAuthConfigurationRaw({ gcpMountPath: gcpMountPath }, initOverrides);
  }

  /**
   * Create a GCP role with associated policies and required attributes.
   */
  async googleCloudReadRoleRaw(
    requestParameters: AuthApiGoogleCloudReadRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Create a GCP role with associated policies and required attributes.
   */
  async googleCloudReadRole(
    name: string,
    gcpMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.googleCloudReadRoleRaw({ name: name, gcpMountPath: gcpMountPath }, initOverrides);
  }

  /**
   */
  async googleCloudRotateRootCredentialsRaw(
    requestParameters: AuthApiGoogleCloudRotateRootCredentialsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['gcpMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{gcp_mount_path}/config/rotate-root`.replace(
          `{${'gcp_mount_path'}}`,
          encodeURIComponent(String(requestParameters['gcpMountPath']))
        ),
        method: 'POST',
  ...
  /**
   */
  async googleCloudRotateRootCredentials(
    gcpMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.googleCloudRotateRootCredentialsRaw({ gcpMountPath: gcpMountPath }, initOverrides);
  }

  /**
   * Create a GCP role with associated policies and required attributes.
   */
  async googleCloudWriteRoleRaw(
   ...
   * Create a GCP role with associated policies and required attributes.
   */
  async googleCloudWriteRole(
    name: string,
    gcpMountPath: string,
    googleCloudWriteRoleRequest: GoogleCloudWriteRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.googleCloudWriteRoleRaw(
      { name: name, gcpMountPath: gcpMountPath, googleCloudWriteRoleRequest: googleCloudWriteRoleRequest },
      initOverrides
    );
  }
   ...
   */
  async jwtConfigureRaw(
    requestParameters: AuthApiJwtConfigureOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/auth/{jwt_mount_path}/config`.replace(
          `{${'jwt_mount_path'}}`,
          encodeURIComponent(String(requestParameters['jwtMountPath']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
  ...
  async jwtConfigure(
    ...
    await this.jwtConfigureRaw(
      { jwtMountPath: jwtMountPath, jwtConfigureRequest: jwtConfigureRequest },
      initOverrides
    );
  }
   ...
   */
  async jwtDeleteRoleRaw(
    requestParameters: AuthApiJwtDeleteRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{jwt_mount_path}/role/{name}`
          .replace(`{${'name'}}`, encodeURIComponent(String(requestParameters['name'])))
          .replace(`{${'jwt_mount_path'}}`, encodeURIComponent(String(requestParameters['jwtMountPath']))),
        method: 'DELETE',
        headers: headerParameters,
        query: queryParameters,
      },
  ...
  async jwtDeleteRole(
    ...
    await this.jwtDeleteRoleRaw({ name: name, jwtMountPath: jwtMountPath }, initOverrides);
  }
   ...
   */
  async jwtListRolesRaw(
    requestParameters: AuthApiJwtListRolesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['jwtMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{jwt_mount_path}/role/`.replace(
          `{${'jwt_mount_path'}}`,
          encodeURIComponent(String(requestParameters['jwtMountPath']))
        ),
        method: 'GET',
   ...
   */
  async jwtLoginRaw(
    requestParameters: AuthApiJwtLoginOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['jwtMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{jwt_mount_path}/login`.replace(
          `{${'jwt_mount_path'}}`,
          encodeURIComponent(String(requestParameters['jwtMountPath']))
        ),
        method: 'POST',
  ...
  async jwtLogin(
    ...
    await this.jwtLoginRaw({ jwtMountPath: jwtMountPath, jwtLoginRequest: jwtLoginRequest }, initOverrides);
  }

  /**
   * Callback endpoint to complete an OIDC login.
   */
  async jwtOidcCallbackRaw(
    requestParameters: AuthApiJwtOidcCallbackRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['jwtMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{jwt_mount_path}/oidc/callback`.replace(
          `{${'jwt_mount_path'}}`,
          encodeURIComponent(String(requestParameters['jwtMountPath']))
        ),
        method: 'GET',
  ...
  async jwtOidcCallback(
    ...
    await this.jwtOidcCallbackRaw(
      { jwtMountPath: jwtMountPath, clientNonce: clientNonce, code: code, state: state },
      initOverrides
    );
  }
   ...
   */
  async jwtOidcCallbackFormPostRaw(
    requestParameters: AuthApiJwtOidcCallbackFormPostOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['jwtMountPath'] == null) {
      throw new runtime.RequiredError(
   ...
   * Callback endpoint to handle form_posts.
   */
  async jwtOidcCallbackFormPost(
    jwtMountPath: string,
    jwtOidcCallbackFormPostRequest: JwtOidcCallbackFormPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.jwtOidcCallbackFormPostRaw(
      { jwtMountPath: jwtMountPath, jwtOidcCallbackFormPostRequest: jwtOidcCallbackFormPostRequest },
      initOverrides
    );
  }
   ...
   */
  async jwtOidcRequestAuthorizationUrlRaw(
    ...
    const response = await this.request(
      {
        path: `/auth/{jwt_mount_path}/oidc/auth_url`.replace(
          `{${'jwt_mount_path'}}`,
          encodeURIComponent(String(requestParameters['jwtMountPath']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
        body: JwtOidcRequestAuthorizationUrlRequestToJSON(
          requestParameters['jwtOidcRequestAuthorizationUrlRequest']
        ),
      },
      initOverrides
    );
   ...
   * Request an authorization URL to start an OIDC login flow.
   */
  async jwtOidcRequestAuthorizationUrl(
    jwtMountPath: string,
    jwtOidcRequestAuthorizationUrlRequest: JwtOidcRequestAuthorizationUrlRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.jwtOidcRequestAuthorizationUrlRaw(
      {
        jwtMountPath: jwtMountPath,
        jwtOidcRequestAuthorizationUrlRequest: jwtOidcRequestAuthorizationUrlRequest,
      },
      initOverrides
    );
   ...
   */
  async jwtReadConfigurationRaw(
    requestParameters: AuthApiJwtReadConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['jwtMountPath'] == null) {
      throw new runtime.RequiredError(
   ...
   * Read the current JWT authentication backend configuration.
   */
  async jwtReadConfiguration(
    jwtMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.jwtReadConfigurationRaw({ jwtMountPath: jwtMountPath }, initOverrides);
  }

  /**
   * Read an existing role.
   */
  async jwtReadRoleRaw(
    requestParameters: AuthApiJwtReadRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
  ...
  async jwtReadRole(
    ...
    await this.jwtReadRoleRaw({ name: name, jwtMountPath: jwtMountPath }, initOverrides);
  }
   ...
   */
  async jwtWriteRoleRaw(
    requestParameters: AuthApiJwtWriteRoleOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
  ...
  async jwtWriteRole(
    ...
    await this.jwtWriteRoleRaw(
      { name: name, jwtMountPath: jwtMountPath, jwtWriteRoleRequest: jwtWriteRoleRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async kerberosConfigureRaw(
    requestParameters: AuthApiKerberosConfigureOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/auth/{kerberos_mount_path}/config`.replace(
          `{${'kerberos_mount_path'}}`,
          encodeURIComponent(String(requestParameters['kerberosMountPath']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
  ...
  /**
   */
  async kerberosConfigure(
    kerberosMountPath: string,
    kerberosConfigureRequest: KerberosConfigureRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.kerberosConfigureRaw(
      { kerberosMountPath: kerberosMountPath, kerberosConfigureRequest: kerberosConfigureRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async kerberosConfigureLdapRaw(
    ...
    const response = await this.request(
      {
        path: `/auth/{kerberos_mount_path}/config/ldap`.replace(
          `{${'kerberos_mount_path'}}`,
          encodeURIComponent(String(requestParameters['kerberosMountPath']))
        ),
        method: 'POST',
  ...
  /**
   */
  async kerberosConfigureLdap(
    kerberosMountPath: string,
    kerberosConfigureLdapRequest: KerberosConfigureLdapRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.kerberosConfigureLdapRaw(
      { kerberosMountPath: kerberosMountPath, kerberosConfigureLdapRequest: kerberosConfigureLdapRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async kerberosDeleteGroupRaw(
    requestParameters: AuthApiKerberosDeleteGroupRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{kerberos_mount_path}/groups/{name}`
          .replace(`{${'name'}}`, encodeURIComponent(String(requestParameters['name'])))
          .replace(
            `{${'kerberos_mount_path'}}`,
            encodeURIComponent(String(requestParameters['kerberosMountPath']))
  ...
  /**
   */
  async kerberosDeleteGroup(
    name: string,
    kerberosMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.kerberosDeleteGroupRaw({ name: name, kerberosMountPath: kerberosMountPath }, initOverrides);
  }

  /**
   */
  async kerberosListGroupsRaw(
    requestParameters: AuthApiKerberosListGroupsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['kerberosMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{kerberos_mount_path}/groups/`.replace(
          `{${'kerberos_mount_path'}}`,
          encodeURIComponent(String(requestParameters['kerberosMountPath']))
        ),
        method: 'GET',
  ...
  /**
   */
  async kerberosListGroups(
    kerberosMountPath: string,
    list: KerberosListGroupsListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.kerberosListGroupsRaw(
      { kerberosMountPath: kerberosMountPath, list: list },
      initOverrides
    );
    return await response.value();
  }
  ...
  /**
   */
  async kerberosLoginRaw(
    requestParameters: AuthApiKerberosLoginOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['kerberosMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{kerberos_mount_path}/login`.replace(
          `{${'kerberos_mount_path'}}`,
          encodeURIComponent(String(requestParameters['kerberosMountPath']))
        ),
        method: 'POST',
  ...
  async kerberosLogin(
    ...
    await this.kerberosLoginRaw(
      { kerberosMountPath: kerberosMountPath, kerberosLoginRequest: kerberosLoginRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async kerberosLogin2Raw(
    requestParameters: AuthApiKerberosLogin2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['kerberosMountPath'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async kerberosLogin2(
    kerberosMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.kerberosLogin2Raw({ kerberosMountPath: kerberosMountPath }, initOverrides);
  }

  /**
   */
  async kerberosReadConfigurationRaw(
  ...
  /**
   */
  async kerberosReadConfiguration(
    kerberosMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.kerberosReadConfigurationRaw({ kerberosMountPath: kerberosMountPath }, initOverrides);
  }

  /**
   */
  async kerberosReadGroupRaw(
    requestParameters: AuthApiKerberosReadGroupRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async kerberosReadGroup(
    name: string,
    kerberosMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.kerberosReadGroupRaw({ name: name, kerberosMountPath: kerberosMountPath }, initOverrides);
  }

  /**
   */
  async kerberosReadLdapConfigurationRaw(
    requestParameters: AuthApiKerberosReadLdapConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['kerberosMountPath'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async kerberosReadLdapConfiguration(
    kerberosMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.kerberosReadLdapConfigurationRaw({ kerberosMountPath: kerberosMountPath }, initOverrides);
  }

  /**
   */
  async kerberosWriteGroupRaw(
    requestParameters: AuthApiKerberosWriteGroupOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async kerberosWriteGroup(
    name: string,
    kerberosMountPath: string,
    kerberosWriteGroupRequest: KerberosWriteGroupRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.kerberosWriteGroupRaw(
      {
        name: name,
        kerberosMountPath: kerberosMountPath,
        kerberosWriteGroupRequest: kerberosWriteGroupRequest,
      },
      initOverrides
    );
  ...
  /**
   */
  async kubernetesConfigureAuthRaw(
    requestParameters: AuthApiKubernetesConfigureAuthOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/auth/{kubernetes_mount_path}/config`.replace(
          `{${'kubernetes_mount_path'}}`,
          encodeURIComponent(String(requestParameters['kubernetesMountPath']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
  ...
  /**
   */
  async kubernetesConfigureAuth(
    kubernetesMountPath: string,
    kubernetesConfigureAuthRequest: KubernetesConfigureAuthRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.kubernetesConfigureAuthRaw(
      {
   ...
   * Register an role with the backend.
   */
  async kubernetesDeleteAuthRoleRaw(
    requestParameters: AuthApiKubernetesDeleteAuthRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{kubernetes_mount_path}/role/{name}`
          .replace(`{${'name'}}`, encodeURIComponent(String(requestParameters['name'])))
          .replace(
            `{${'kubernetes_mount_path'}}`,
            encodeURIComponent(String(requestParameters['kubernetesMountPath']))
   ...
   * Register an role with the backend.
   */
  async kubernetesDeleteAuthRole(
    name: string,
    kubernetesMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.kubernetesDeleteAuthRoleRaw(
      { name: name, kubernetesMountPath: kubernetesMountPath },
      initOverrides
    );
  }
   ...
   * Lists all the roles registered with the backend.
   */
  async kubernetesListAuthRolesRaw(
    requestParameters: AuthApiKubernetesListAuthRolesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['kubernetesMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{kubernetes_mount_path}/role/`.replace(
          `{${'kubernetes_mount_path'}}`,
          encodeURIComponent(String(requestParameters['kubernetesMountPath']))
        ),
        method: 'GET',
   ...
   * Lists all the roles registered with the backend.
   */
  async kubernetesListAuthRoles(
    kubernetesMountPath: string,
    list: KubernetesListAuthRolesListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.kubernetesListAuthRolesRaw(
      { kubernetesMountPath: kubernetesMountPath, list: list },
      initOverrides
    );
    return await response.value();
  }
  ...
  async kubernetesLoginRaw(
    ...
    const response = await this.request(
      {
        path: `/auth/{kubernetes_mount_path}/login`.replace(
          `{${'kubernetes_mount_path'}}`,
          encodeURIComponent(String(requestParameters['kubernetesMountPath']))
        ),
        method: 'POST',
   ...
   * Authenticates Kubernetes service accounts with Vault.
   */
  async kubernetesLogin(
    kubernetesMountPath: string,
    kubernetesLoginRequest: KubernetesLoginRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.kubernetesLoginRaw(
      { kubernetesMountPath: kubernetesMountPath, kubernetesLoginRequest: kubernetesLoginRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async kubernetesReadAuthConfigurationRaw(
    requestParameters: AuthApiKubernetesReadAuthConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['kubernetesMountPath'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async kubernetesReadAuthConfiguration(
    kubernetesMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.kubernetesReadAuthConfigurationRaw(
      { kubernetesMountPath: kubernetesMountPath },
      initOverrides
    );
  }
   ...
   * Register an role with the backend.
   */
  async kubernetesReadAuthRoleRaw(
    requestParameters: AuthApiKubernetesReadAuthRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Register an role with the backend.
   */
  async kubernetesReadAuthRole(
    name: string,
    kubernetesMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.kubernetesReadAuthRoleRaw(
      { name: name, kubernetesMountPath: kubernetesMountPath },
      initOverrides
    );
  }
   ...
   * Register an role with the backend.
   */
  async kubernetesWriteAuthRoleRaw(
    requestParameters: AuthApiKubernetesWriteAuthRoleOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Register an role with the backend.
   */
  async kubernetesWriteAuthRole(
    name: string,
    kubernetesMountPath: string,
    kubernetesWriteAuthRoleRequest: KubernetesWriteAuthRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.kubernetesWriteAuthRoleRaw(
      {
        name: name,
        kubernetesMountPath: kubernetesMountPath,
        kubernetesWriteAuthRoleRequest: kubernetesWriteAuthRoleRequest,
  ...
  /**
   */
  async ldapConfigureAuthRaw(
    requestParameters: AuthApiLdapConfigureAuthOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/auth/{ldap_mount_path}/config`.replace(
          `{${'ldap_mount_path'}}`,
          encodeURIComponent(String(requestParameters['ldapMountPath']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
  ...
  /**
   */
  async ldapConfigureAuth(
    ldapMountPath: string,
    ldapConfigureAuthRequest: LdapConfigureAuthRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.ldapConfigureAuthRaw(
      { ldapMountPath: ldapMountPath, ldapConfigureAuthRequest: ldapConfigureAuthRequest },
      initOverrides
    );
  }
   ...
   */
  async ldapDeleteGroupRaw(
    requestParameters: AuthApiLdapDeleteGroupRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{ldap_mount_path}/groups/{name}`
          .replace(`{${'name'}}`, encodeURIComponent(String(requestParameters['name'])))
   ...
   * Manage additional groups for users allowed to authenticate.
   */
  async ldapDeleteGroup(
    name: string,
    ldapMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.ldapDeleteGroupRaw({ name: name, ldapMountPath: ldapMountPath }, initOverrides);
  }

  /**
   * Manage users allowed to authenticate.
   */
  async ldapDeleteUserRaw(
    requestParameters: AuthApiLdapDeleteUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{ldap_mount_path}/users/{name}`
          .replace(`{${'name'}}`, encodeURIComponent(String(requestParameters['name'])))
          .replace(`{${'ldap_mount_path'}}`, encodeURIComponent(String(requestParameters['ldapMountPath']))),
        method: 'DELETE',
        headers: headerParameters,
   ...
   * Manage users allowed to authenticate.
   */
  async ldapDeleteUser(
    name: string,
    ldapMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.ldapDeleteUserRaw({ name: name, ldapMountPath: ldapMountPath }, initOverrides);
  }

  /**
   * Manage additional groups for users allowed to authenticate.
   */
  async ldapListGroupsRaw(
    requestParameters: AuthApiLdapListGroupsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['ldapMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{ldap_mount_path}/groups/`.replace(
          `{${'ldap_mount_path'}}`,
          encodeURIComponent(String(requestParameters['ldapMountPath']))
        ),
        method: 'GET',
   ...
   * Manage additional groups for users allowed to authenticate.
   */
  async ldapListGroups(
    ldapMountPath: string,
    list: LdapListGroupsListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.ldapListGroupsRaw(
      { ldapMountPath: ldapMountPath, list: list },
      initOverrides
    );
    return await response.value();
  }
  ...
  async ldapListUsersRaw(
    ...
    const response = await this.request(
      {
        path: `/auth/{ldap_mount_path}/users/`.replace(
          `{${'ldap_mount_path'}}`,
          encodeURIComponent(String(requestParameters['ldapMountPath']))
        ),
        method: 'GET',
   ...
   */
  async ldapLoginRaw(
    requestParameters: AuthApiLdapLoginOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/auth/{ldap_mount_path}/login/{username}`
  ...
  async ldapLogin(
    ...
    await this.ldapLoginRaw(
      { username: username, ldapMountPath: ldapMountPath, ldapLoginRequest: ldapLoginRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async ldapReadAuthConfigurationRaw(
    requestParameters: AuthApiLdapReadAuthConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['ldapMountPath'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async ldapReadAuthConfiguration(
    ldapMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.ldapReadAuthConfigurationRaw({ ldapMountPath: ldapMountPath }, initOverrides);
  }

  /**
   * Manage additional groups for users allowed to authenticate.
   */
  async ldapReadGroupRaw(
    requestParameters: AuthApiLdapReadGroupRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
  ...
  async ldapReadGroup(
    ...
    await this.ldapReadGroupRaw({ name: name, ldapMountPath: ldapMountPath }, initOverrides);
  }

  /**
   * Manage users allowed to authenticate.
   */
  async ldapReadUserRaw(
    requestParameters: AuthApiLdapReadUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
  ...
  async ldapReadUser(
    ...
    await this.ldapReadUserRaw({ name: name, ldapMountPath: ldapMountPath }, initOverrides);
  }

  /**
   */
  async ldapRotateRootCredentialsRaw(
    requestParameters: AuthApiLdapRotateRootCredentialsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['ldapMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{ldap_mount_path}/config/rotate-root`.replace(
          `{${'ldap_mount_path'}}`,
          encodeURIComponent(String(requestParameters['ldapMountPath']))
        ),
        method: 'POST',
  ...
  /**
   */
  async ldapRotateRootCredentials(
    ldapMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.ldapRotateRootCredentialsRaw({ ldapMountPath: ldapMountPath }, initOverrides);
  }

  /**
   * Manage additional groups for users allowed to authenticate.
   */
  async ldapWriteGroupRaw(
    requestParameters: AuthApiLdapWriteGroupOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Manage additional groups for users allowed to authenticate.
   */
  async ldapWriteGroup(
    name: string,
    ldapMountPath: string,
    ldapWriteGroupRequest: LdapWriteGroupRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.ldapWriteGroupRaw(
      { name: name, ldapMountPath: ldapMountPath, ldapWriteGroupRequest: ldapWriteGroupRequest },
      initOverrides
    );
  }
   ...
   * Manage users allowed to authenticate.
   */
  async ldapWriteUserRaw(
    requestParameters: AuthApiLdapWriteUserOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
  ...
  async ldapWriteUser(
    ...
    await this.ldapWriteUserRaw(
      { name: name, ldapMountPath: ldapMountPath, ldapWriteUserRequest: ldapWriteUserRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async ociConfigureRaw(
    requestParameters: AuthApiOciConfigureOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/auth/{oci_mount_path}/config`.replace(
          `{${'oci_mount_path'}}`,
          encodeURIComponent(String(requestParameters['ociMountPath']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
  ...
  async ociConfigure(
    ...
    await this.ociConfigureRaw(
      { ociMountPath: ociMountPath, ociConfigureRequest: ociConfigureRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async ociDeleteConfigurationRaw(
    requestParameters: AuthApiOciDeleteConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['ociMountPath'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async ociDeleteConfiguration(
    ociMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.ociDeleteConfigurationRaw({ ociMountPath: ociMountPath }, initOverrides);
  }

  /**
   * Create a role and associate policies to it.
   */
  async ociDeleteRoleRaw(
    requestParameters: AuthApiOciDeleteRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['role'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{oci_mount_path}/role/{role}`
          .replace(`{${'role'}}`, encodeURIComponent(String(requestParameters['role'])))
          .replace(`{${'oci_mount_path'}}`, encodeURIComponent(String(requestParameters['ociMountPath']))),
        method: 'DELETE',
        headers: headerParameters,
        query: queryParameters,
      },
  ...
  async ociDeleteRole(
    ...
    await this.ociDeleteRoleRaw({ role: role, ociMountPath: ociMountPath }, initOverrides);
  }

  /**
   * Lists all the roles that are registered with Vault.
   */
  async ociListRolesRaw(
    requestParameters: AuthApiOciListRolesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['ociMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{oci_mount_path}/role/`.replace(
          `{${'oci_mount_path'}}`,
          encodeURIComponent(String(requestParameters['ociMountPath']))
        ),
        method: 'GET',
   ...
   */
  async ociLoginRaw(
    requestParameters: AuthApiOciLoginOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['role'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{oci_mount_path}/login/{role}`
          .replace(`{${'role'}}`, encodeURIComponent(String(requestParameters['role'])))
          .replace(`{${'oci_mount_path'}}`, encodeURIComponent(String(requestParameters['ociMountPath']))),
        method: 'POST',
        headers: headerParameters,
  ...
  async ociLogin(
    ...
    await this.ociLoginRaw(
      { role: role, ociMountPath: ociMountPath, ociLoginRequest: ociLoginRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async ociReadConfigurationRaw(
    requestParameters: AuthApiOciReadConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['ociMountPath'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async ociReadConfiguration(
    ociMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.ociReadConfigurationRaw({ ociMountPath: ociMountPath }, initOverrides);
  }

  /**
   * Create a role and associate policies to it.
   */
  async ociReadRoleRaw(
    requestParameters: AuthApiOciReadRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['role'] == null) {
      throw new runtime.RequiredError(
  ...
  async ociReadRole(
    ...
    await this.ociReadRoleRaw({ role: role, ociMountPath: ociMountPath }, initOverrides);
  }

  /**
   * Create a role and associate policies to it.
   */
  async ociWriteRoleRaw(
    requestParameters: AuthApiOciWriteRoleOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['role'] == null) {
      throw new runtime.RequiredError(
  ...
  async ociWriteRole(
    ...
    await this.ociWriteRoleRaw(
      { role: role, ociMountPath: ociMountPath, ociWriteRoleRequest: ociWriteRoleRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async oktaConfigureRaw(
    requestParameters: AuthApiOktaConfigureOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/auth/{okta_mount_path}/config`.replace(
          `{${'okta_mount_path'}}`,
          encodeURIComponent(String(requestParameters['oktaMountPath']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
  ...
  async oktaConfigure(
    ...
    await this.oktaConfigureRaw(
      { oktaMountPath: oktaMountPath, oktaConfigureRequest: oktaConfigureRequest },
      initOverrides
    );
  }
   ...
   * Manage users allowed to authenticate.
   */
  async oktaDeleteGroupRaw(
    requestParameters: AuthApiOktaDeleteGroupRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{okta_mount_path}/groups/{name}`
          .replace(`{${'name'}}`, encodeURIComponent(String(requestParameters['name'])))
          .replace(`{${'okta_mount_path'}}`, encodeURIComponent(String(requestParameters['oktaMountPath']))),
        method: 'DELETE',
        headers: headerParameters,
        query: queryParameters,
      },
   ...
   * Manage users allowed to authenticate.
   */
  async oktaDeleteGroup(
    name: string,
    oktaMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.oktaDeleteGroupRaw({ name: name, oktaMountPath: oktaMountPath }, initOverrides);
  }

  /**
   * Manage additional groups for users allowed to authenticate.
   */
  async oktaDeleteUserRaw(
    requestParameters: AuthApiOktaDeleteUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{okta_mount_path}/users/{name}`
          .replace(`{${'name'}}`, encodeURIComponent(String(requestParameters['name'])))
          .replace(`{${'okta_mount_path'}}`, encodeURIComponent(String(requestParameters['oktaMountPath']))),
        method: 'DELETE',
        headers: headerParameters,
   ...
   * Manage additional groups for users allowed to authenticate.
   */
  async oktaDeleteUser(
    name: string,
    oktaMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.oktaDeleteUserRaw({ name: name, oktaMountPath: oktaMountPath }, initOverrides);
  }

  /**
   * Manage users allowed to authenticate.
   */
  async oktaListGroupsRaw(
    requestParameters: AuthApiOktaListGroupsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['oktaMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{okta_mount_path}/groups/`.replace(
          `{${'okta_mount_path'}}`,
          encodeURIComponent(String(requestParameters['oktaMountPath']))
        ),
        method: 'GET',
   ...
   * Manage users allowed to authenticate.
   */
  async oktaListGroups(
    oktaMountPath: string,
    list: OktaListGroupsListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.oktaListGroupsRaw(
      { oktaMountPath: oktaMountPath, list: list },
      initOverrides
    );
    return await response.value();
  }
   ...
   * Manage additional groups for users allowed to authenticate.
   */
  async oktaListUsersRaw(
    requestParameters: AuthApiOktaListUsersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['oktaMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{okta_mount_path}/users/`.replace(
          `{${'okta_mount_path'}}`,
          encodeURIComponent(String(requestParameters['oktaMountPath']))
        ),
        method: 'GET',
   ...
   */
  async oktaLoginRaw(
    requestParameters: AuthApiOktaLoginOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['username'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{okta_mount_path}/login/{username}`
          .replace(`{${'username'}}`, encodeURIComponent(String(requestParameters['username'])))
          .replace(`{${'okta_mount_path'}}`, encodeURIComponent(String(requestParameters['oktaMountPath']))),
        method: 'POST',
        headers: headerParameters,
  ...
  async oktaLogin(
    ...
    await this.oktaLoginRaw(
      { username: username, oktaMountPath: oktaMountPath, oktaLoginRequest: oktaLoginRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async oktaReadConfigurationRaw(
    requestParameters: AuthApiOktaReadConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['oktaMountPath'] == null) {
      throw new runtime.RequiredError(
  ...
  async oktaReadConfiguration(
    ...
    await this.oktaReadConfigurationRaw({ oktaMountPath: oktaMountPath }, initOverrides);
  }

  /**
   * Manage users allowed to authenticate.
   */
  async oktaReadGroupRaw(
    requestParameters: AuthApiOktaReadGroupRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
  ...
  async oktaReadGroup(
    ...
    await this.oktaReadGroupRaw({ name: name, oktaMountPath: oktaMountPath }, initOverrides);
  }

  /**
   * Manage additional groups for users allowed to authenticate.
   */
  async oktaReadUserRaw(
    requestParameters: AuthApiOktaReadUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
  ...
  async oktaReadUser(
    ...
    await this.oktaReadUserRaw({ name: name, oktaMountPath: oktaMountPath }, initOverrides);
  }

  /**
   */
  async oktaVerifyRaw(
    requestParameters: AuthApiOktaVerifyRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/auth/{okta_mount_path}/verify/{nonce}`
          .replace(`{${'nonce'}}`, encodeURIComponent(String(requestParameters['nonce'])))
          .replace(`{${'okta_mount_path'}}`, encodeURIComponent(String(requestParameters['oktaMountPath']))),
        method: 'GET',
        headers: headerParameters,
        query: queryParameters,
  ...
  async oktaVerify(
    ...
    await this.oktaVerifyRaw({ nonce: nonce, oktaMountPath: oktaMountPath }, initOverrides);
  }

  /**
   * Manage users allowed to authenticate.
   */
  async oktaWriteGroupRaw(
    requestParameters: AuthApiOktaWriteGroupOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Manage users allowed to authenticate.
   */
  async oktaWriteGroup(
    name: string,
    oktaMountPath: string,
    oktaWriteGroupRequest: OktaWriteGroupRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.oktaWriteGroupRaw(
      { name: name, oktaMountPath: oktaMountPath, oktaWriteGroupRequest: oktaWriteGroupRequest },
      initOverrides
    );
  }
   ...
   * Manage additional groups for users allowed to authenticate.
   */
  async oktaWriteUserRaw(
    requestParameters: AuthApiOktaWriteUserOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
  ...
  async oktaWriteUser(
    ...
    await this.oktaWriteUserRaw(
      { name: name, oktaMountPath: oktaMountPath, oktaWriteUserRequest: oktaWriteUserRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async radiusConfigureRaw(
    requestParameters: AuthApiRadiusConfigureOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/auth/{radius_mount_path}/config`.replace(
          `{${'radius_mount_path'}}`,
          encodeURIComponent(String(requestParameters['radiusMountPath']))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
  ...
  /**
   */
  async radiusConfigure(
    radiusMountPath: string,
    radiusConfigureRequest: RadiusConfigureRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.radiusConfigureRaw(
      { radiusMountPath: radiusMountPath, radiusConfigureRequest: radiusConfigureRequest },
      initOverrides
    );
  }
   ...
   * Manage users allowed to authenticate.
   */
  async radiusDeleteUserRaw(
    requestParameters: AuthApiRadiusDeleteUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{radius_mount_path}/users/{name}`
          .replace(`{${'name'}}`, encodeURIComponent(String(requestParameters['name'])))
          .replace(
            `{${'radius_mount_path'}}`,
            encodeURIComponent(String(requestParameters['radiusMountPath']))
   ...
   * Manage users allowed to authenticate.
   */
  async radiusDeleteUser(
    name: string,
    radiusMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.radiusDeleteUserRaw({ name: name, radiusMountPath: radiusMountPath }, initOverrides);
  }

  /**
   * Manage users allowed to authenticate.
   */
  async radiusListUsersRaw(
    requestParameters: AuthApiRadiusListUsersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['radiusMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{radius_mount_path}/users/`.replace(
          `{${'radius_mount_path'}}`,
          encodeURIComponent(String(requestParameters['radiusMountPath']))
        ),
        method: 'GET',
   ...
   * Manage users allowed to authenticate.
   */
  async radiusListUsers(
    radiusMountPath: string,
    list: RadiusListUsersListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.radiusListUsersRaw(
      { radiusMountPath: radiusMountPath, list: list },
      initOverrides
    );
    return await response.value();
  }
   ...
   * Log in with a username and password.
   */
  async radiusLoginRaw(
    requestParameters: AuthApiRadiusLoginOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['radiusMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{radius_mount_path}/login`.replace(
          `{${'radius_mount_path'}}`,
          encodeURIComponent(String(requestParameters['radiusMountPath']))
        ),
        method: 'POST',
  ...
  async radiusLogin(
    ...
    await this.radiusLoginRaw(
      { radiusMountPath: radiusMountPath, radiusLoginRequest: radiusLoginRequest },
      initOverrides
    );
  }
   ...
   * Log in with a username and password.
   */
  async radiusLoginWithUsernameRaw(
    requestParameters: AuthApiRadiusLoginWithUsernameOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/auth/{radius_mount_path}/login/{urlusername}`
          .replace(`{${'urlusername'}}`, encodeURIComponent(String(requestParameters['urlusername'])))
          .replace(
            `{${'radius_mount_path'}}`,
            encodeURIComponent(String(requestParameters['radiusMountPath']))
          ),
   ...
   * Log in with a username and password.
   */
  async radiusLoginWithUsername(
    urlusername: string,
    radiusMountPath: string,
    radiusLoginWithUsernameRequest: RadiusLoginWithUsernameRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.radiusLoginWithUsernameRaw(
      {
        urlusername: urlusername,
        radiusMountPath: radiusMountPath,
        radiusLoginWithUsernameRequest: radiusLoginWithUsernameRequest,
      },
      initOverrides
    );
  ...
  /**
   */
  async radiusReadConfigurationRaw(
    requestParameters: AuthApiRadiusReadConfigurationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['radiusMountPath'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async radiusReadConfiguration(
    radiusMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.radiusReadConfigurationRaw({ radiusMountPath: radiusMountPath }, initOverrides);
  }

  /**
   * Manage users allowed to authenticate.
   */
  async radiusReadUserRaw(
    requestParameters: AuthApiRadiusReadUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Manage users allowed to authenticate.
   */
  async radiusReadUser(
    name: string,
    radiusMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.radiusReadUserRaw({ name: name, radiusMountPath: radiusMountPath }, initOverrides);
  }

  /**
   * Manage users allowed to authenticate.
   */
  async radiusWriteUserRaw(
    requestParameters: AuthApiRadiusWriteUserOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['name'] == null) {
      throw new runtime.RequiredError(
   ...
   * Manage users allowed to authenticate.
   */
  async radiusWriteUser(
    name: string,
    radiusMountPath: string,
    radiusWriteUserRequest: RadiusWriteUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.radiusWriteUserRaw(
      { name: name, radiusMountPath: radiusMountPath, radiusWriteUserRequest: radiusWriteUserRequest },
      initOverrides
    );
  }
   ...
   */
  async tokenCreateRaw(
    requestParameters: AuthApiTokenCreateOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
  ...
  async tokenCreate(
    ...
    await this.tokenCreateRaw({ tokenCreateRequest: tokenCreateRequest }, initOverrides);
  }

  /**
   * This token create path is used to create new tokens adhering to the given role.
   */
  async tokenCreateAgainstRoleRaw(
    requestParameters: AuthApiTokenCreateAgainstRoleOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/token/create/{role_name}`.replace(
          `{${'role_name'}}`,
   ...
   * This token create path is used to create new tokens adhering to the given role.
   */
  async tokenCreateAgainstRole(
    roleName: string,
    tokenCreateAgainstRoleRequest: TokenCreateAgainstRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.tokenCreateAgainstRoleRaw(
      { roleName: roleName, tokenCreateAgainstRoleRequest: tokenCreateAgainstRoleRequest },
      initOverrides
    );
  }
   ...
   */
  async tokenCreateOrphanRaw(
    requestParameters: AuthApiTokenCreateOrphanOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
   ...
   * The token create path is used to create new orphan tokens.
   */
  async tokenCreateOrphan(
    tokenCreateOrphanRequest: TokenCreateOrphanRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.tokenCreateOrphanRaw({ tokenCreateOrphanRequest: tokenCreateOrphanRequest }, initOverrides);
  }

  /**
   */
  async tokenDeleteRoleRaw(
    requestParameters: AuthApiTokenDeleteRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/token/roles/{role_name}`.replace(
          `{${'role_name'}}`,
          encodeURIComponent(String(requestParameters['roleName']))
        ),
        method: 'DELETE',
  ...
  /**
   */
  async tokenDeleteRole(
    roleName: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.tokenDeleteRoleRaw({ roleName: roleName }, initOverrides);
  }

  /**
   * List token accessors, which can then be be used to iterate and discover their properties or revoke them. Because this can be used to cause a denial of service, this endpoint requires \'sudo\' capability in addition to \'list\'.
   */
  async tokenListAccessorsRaw(
    requestParameters: AuthApiTokenListAccessorsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
   ...
   */
  async tokenListRolesRaw(
    requestParameters: AuthApiTokenListRolesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['list'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async tokenLookUpRaw(
    requestParameters: AuthApiTokenLookUpOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
  ...
  async tokenLookUp(
    ...
    await this.tokenLookUpRaw({ tokenLookUpRequest: tokenLookUpRequest }, initOverrides);
  }

  /**
   */
  async tokenLookUp2Raw(
    requestParameters: AuthApiTokenLookUp2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  async tokenLookUp2(
    ...
    await this.tokenLookUp2Raw({ token: token }, initOverrides);
  }

  /**
   * This endpoint will lookup a token associated with the given accessor and its properties. Response will not contain the token ID.
   */
  async tokenLookUpAccessorRaw(
    requestParameters: AuthApiTokenLookUpAccessorOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
   ...
   * This endpoint will lookup a token associated with the given accessor and its properties. Response will not contain the token ID.
   */
  async tokenLookUpAccessor(
    tokenLookUpAccessorRequest: TokenLookUpAccessorRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.tokenLookUpAccessorRaw(
      { tokenLookUpAccessorRequest: tokenLookUpAccessorRequest },
      initOverrides
    );
  }
  ...
  /**
   */
  async tokenLookUpSelf2Raw(
    requestParameters: AuthApiTokenLookUpSelf2OperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
  ...
  /**
   */
  async tokenLookUpSelf2(
    tokenLookUpSelf2Request: TokenLookUpSelf2Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.tokenLookUpSelf2Raw({ tokenLookUpSelf2Request: tokenLookUpSelf2Request }, initOverrides);
  }

  /**
   */
  async tokenReadRoleRaw(
    requestParameters: AuthApiTokenReadRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
  ...
  async tokenReadRole(
    ...
    await this.tokenReadRoleRaw({ roleName: roleName }, initOverrides);
  }
   ...
   */
  async tokenRenewRaw(
    requestParameters: AuthApiTokenRenewOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
  ...
  async tokenRenew(
    ...
    await this.tokenRenewRaw({ tokenRenewRequest: tokenRenewRequest }, initOverrides);
  }

  /**
   * This endpoint will renew a token associated with the given accessor and its properties. Response will not contain the token ID.
   */
  async tokenRenewAccessorRaw(
    requestParameters: AuthApiTokenRenewAccessorOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
   ...
   * This endpoint will renew a token associated with the given accessor and its properties. Response will not contain the token ID.
   */
  async tokenRenewAccessor(
    tokenRenewAccessorRequest: TokenRenewAccessorRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.tokenRenewAccessorRaw({ tokenRenewAccessorRequest: tokenRenewAccessorRequest }, initOverrides);
  }

  /**
   * This endpoint will renew the token used to call it and prevent expiration.
   */
  async tokenRenewSelfRaw(
    requestParameters: AuthApiTokenRenewSelfOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
  ...
  async tokenRenewSelf(
    ...
    await this.tokenRenewSelfRaw({ tokenRenewSelfRequest: tokenRenewSelfRequest }, initOverrides);
  }

  /**
   * This endpoint will delete the given token and all of its child tokens.
   */
  async tokenRevokeRaw(
    requestParameters: AuthApiTokenRevokeOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
  ...
  async tokenRevoke(
    ...
    await this.tokenRevokeRaw({ tokenRevokeRequest: tokenRevokeRequest }, initOverrides);
  }

  /**
   * This endpoint will delete the token associated with the accessor and all of its child tokens.
   */
  async tokenRevokeAccessorRaw(
    requestParameters: AuthApiTokenRevokeAccessorOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
   ...
   * This endpoint will delete the token associated with the accessor and all of its child tokens.
   */
  async tokenRevokeAccessor(
    tokenRevokeAccessorRequest: TokenRevokeAccessorRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.tokenRevokeAccessorRaw(
      { tokenRevokeAccessorRequest: tokenRevokeAccessorRequest },
      initOverrides
    );
  }
   ...
   * This endpoint will delete the token and orphan its child tokens.
   */
  async tokenRevokeOrphan(
    tokenRevokeOrphanRequest: TokenRevokeOrphanRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.tokenRevokeOrphanRaw({ tokenRevokeOrphanRequest: tokenRevokeOrphanRequest }, initOverrides);
  }

  /**
   * This endpoint will delete the token used to call it and all of its child tokens.
   */
  async tokenRevokeSelfRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async tokenWriteRoleRaw(
    requestParameters: AuthApiTokenWriteRoleOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['roleName'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async tokenWriteRole(
    roleName: string,
    tokenWriteRoleRequest: TokenWriteRoleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.tokenWriteRoleRaw(
      { roleName: roleName, tokenWriteRoleRequest: tokenWriteRoleRequest },
      initOverrides
    );
  }
   ...
   * Manage users allowed to authenticate.
   */
  async userpassDeleteUserRaw(
    requestParameters: AuthApiUserpassDeleteUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['username'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{userpass_mount_path}/users/{username}`
          .replace(`{${'username'}}`, encodeURIComponent(String(requestParameters['username'])))
          .replace(
            `{${'userpass_mount_path'}}`,
            encodeURIComponent(String(requestParameters['userpassMountPath']))
          ),
        method: 'DELETE',
        headers: headerParameters,
        query: queryParameters,
   ...
   * Manage users allowed to authenticate.
   */
  async userpassDeleteUser(
    username: string,
    userpassMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.userpassDeleteUserRaw(
      { username: username, userpassMountPath: userpassMountPath },
      initOverrides
    );
  }
   ...
   * Manage users allowed to authenticate.
   */
  async userpassListUsersRaw(
    requestParameters: AuthApiUserpassListUsersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StandardListResponse>> {
    if (requestParameters['userpassMountPath'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{userpass_mount_path}/users/`.replace(
          `{${'userpass_mount_path'}}`,
          encodeURIComponent(String(requestParameters['userpassMountPath']))
        ),
        method: 'GET',
   ...
   * Manage users allowed to authenticate.
   */
  async userpassListUsers(
    userpassMountPath: string,
    list: UserpassListUsersListEnum,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StandardListResponse> {
    const response = await this.userpassListUsersRaw(
      { userpassMountPath: userpassMountPath, list: list },
      initOverrides
    );
    return await response.value();
  }
   ...
   * Log in with a username and password.
   */
  async userpassLoginRaw(
    requestParameters: AuthApiUserpassLoginOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['username'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{userpass_mount_path}/login/{username}`
          .replace(`{${'username'}}`, encodeURIComponent(String(requestParameters['username'])))
          .replace(
            `{${'userpass_mount_path'}}`,
            encodeURIComponent(String(requestParameters['userpassMountPath']))
  ...
  async userpassLogin(
    ...
    await this.userpassLoginRaw(
      {
        username: username,
        userpassMountPath: userpassMountPath,
        userpassLoginRequest: userpassLoginRequest,
      },
      initOverrides
    );
   ...
   * Manage users allowed to authenticate.
   */
  async userpassReadUserRaw(
    requestParameters: AuthApiUserpassReadUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['username'] == null) {
      throw new runtime.RequiredError(
   ...
   * Manage users allowed to authenticate.
   */
  async userpassReadUser(
    username: string,
    userpassMountPath: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.userpassReadUserRaw(
      { username: username, userpassMountPath: userpassMountPath },
      initOverrides
    );
  }
   ...
   */
  async userpassResetPasswordRaw(
    requestParameters: AuthApiUserpassResetPasswordOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['username'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{userpass_mount_path}/users/{username}/password`
          .replace(`{${'username'}}`, encodeURIComponent(String(requestParameters['username'])))
          .replace(
            `{${'userpass_mount_path'}}`,
            encodeURIComponent(String(requestParameters['userpassMountPath']))
   ...
   * Reset user\'s password.
   */
  async userpassResetPassword(
    username: string,
    userpassMountPath: string,
    userpassResetPasswordRequest: UserpassResetPasswordRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.userpassResetPasswordRaw(
      {
        username: username,
        userpassMountPath: userpassMountPath,
        userpassResetPasswordRequest: userpassResetPasswordRequest,
   ...
   */
  async userpassUpdatePoliciesRaw(
    requestParameters: AuthApiUserpassUpdatePoliciesOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['username'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/auth/{userpass_mount_path}/users/{username}/policies`
          .replace(`{${'username'}}`, encodeURIComponent(String(requestParameters['username'])))
          .replace(
            `{${'userpass_mount_path'}}`,
            encodeURIComponent(String(requestParameters['userpassMountPath']))
  ...
  async userpassUpdatePolicies(
    ...
    await this.userpassUpdatePoliciesRaw(
      {
        username: username,
        userpassMountPath: userpassMountPath,
        userpassUpdatePoliciesRequest: userpassUpdatePoliciesRequest,
   ...
   * Manage users allowed to authenticate.
   */
  async userpassWriteUserRaw(
    requestParameters: AuthApiUserpassWriteUserOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['username'] == null) {
      throw new runtime.RequiredError(
   ...
   * Manage users allowed to authenticate.
   */
  async userpassWriteUser(
    username: string,
    userpassMountPath: string,
    userpassWriteUserRequest: UserpassWriteUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.userpassWriteUserRaw(
      {
        username: username,
        userpassMountPath: userpassMountPath,
        userpassWriteUserRequest: userpassWriteUserRequest,
