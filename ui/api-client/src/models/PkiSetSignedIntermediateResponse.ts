 ...
 */
export function instanceOfPkiSetSignedIntermediateResponse(
  value: object
): value is PkiSetSignedIntermediateResponse {
  return true;
}
...
export function PkiSetSignedIntermediateResponseFromJSONTyped(
  json: any,
...
export function PkiSetSignedIntermediateResponseToJSONTyped(
  value?: PkiSetSignedIntermediateResponse | null,
