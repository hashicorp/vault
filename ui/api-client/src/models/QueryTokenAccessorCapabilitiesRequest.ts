 ...
 */
export function instanceOfQueryTokenAccessorCapabilitiesRequest(
  value: object
): value is QueryTokenAccessorCapabilitiesRequest {
  return true;
}

export function QueryTokenAccessorCapabilitiesRequestFromJSON(
  json: any
): QueryTokenAccessorCapabilitiesRequest {
  return QueryTokenAccessorCapabilitiesRequestFromJSONTyped(json, false);
}

export function QueryTokenAccessorCapabilitiesRequestFromJSONTyped(
  json: any,
...
export function QueryTokenAccessorCapabilitiesRequestToJSON(
  json: any
): QueryTokenAccessorCapabilitiesRequest {
  return QueryTokenAccessorCapabilitiesRequestToJSONTyped(json, false);
}

export function QueryTokenAccessorCapabilitiesRequestToJSONTyped(
  value?: QueryTokenAccessorCapabilitiesRequest | null,
