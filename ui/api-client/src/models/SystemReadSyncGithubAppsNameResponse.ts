 ...
 */
export function instanceOfSystemReadSyncGithubAppsNameResponse(
  value: object
): value is SystemReadSyncGithubAppsNameResponse {
  return true;
}

export function SystemReadSyncGithubAppsNameResponseFromJSON(
  json: any
): SystemReadSyncGithubAppsNameResponse {
  return SystemReadSyncGithubAppsNameResponseFromJSONTyped(json, false);
}

export function SystemReadSyncGithubAppsNameResponseFromJSONTyped(
  json: any,
...
export function SystemReadSyncGithubAppsNameResponseToJSONTyped(
  value?: SystemReadSyncGithubAppsNameResponse | null,
