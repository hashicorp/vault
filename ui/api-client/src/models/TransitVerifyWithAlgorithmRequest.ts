 ...
 */
export function instanceOfTransitVerifyWithAlgorithmRequest(
  value: object
): value is TransitVerifyWithAlgorithmRequest {
  return true;
}
...
export function TransitVerifyWithAlgorithmRequestFromJSONTyped(
  json: any,
...
export function TransitVerifyWithAlgorithmRequestToJSONTyped(
  value?: TransitVerifyWithAlgorithmRequest | null,
