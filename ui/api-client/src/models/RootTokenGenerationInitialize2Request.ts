 ...
 */
export function instanceOfRootTokenGenerationInitialize2Request(
  value: object
): value is RootTokenGenerationInitialize2Request {
  return true;
}

export function RootTokenGenerationInitialize2RequestFromJSON(
  json: any
): RootTokenGenerationInitialize2Request {
  return RootTokenGenerationInitialize2RequestFromJSONTyped(json, false);
}

export function RootTokenGenerationInitialize2RequestFromJSONTyped(
  json: any,
...
export function RootTokenGenerationInitialize2RequestToJSON(
  json: any
): RootTokenGenerationInitialize2Request {
  return RootTokenGenerationInitialize2RequestToJSONTyped(json, false);
}

export function RootTokenGenerationInitialize2RequestToJSONTyped(
  value?: RootTokenGenerationInitialize2Request | null,
