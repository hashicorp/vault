 ...
 */
export function instanceOfPluginsCatalogRegisterPluginWithTypeRequest(
  value: object
): value is PluginsCatalogRegisterPluginWithTypeRequest {
  return true;
}

export function PluginsCatalogRegisterPluginWithTypeRequestFromJSON(
  json: any
): PluginsCatalogRegisterPluginWithTypeRequest {
  return PluginsCatalogRegisterPluginWithTypeRequestFromJSONTyped(json, false);
}

export function PluginsCatalogRegisterPluginWithTypeRequestFromJSONTyped(
  json: any,
...
export function PluginsCatalogRegisterPluginWithTypeRequestToJSON(
  json: any
): PluginsCatalogRegisterPluginWithTypeRequest {
  return PluginsCatalogRegisterPluginWithTypeRequestToJSONTyped(json, false);
}

export function PluginsCatalogRegisterPluginWithTypeRequestToJSONTyped(
  value?: PluginsCatalogRegisterPluginWithTypeRequest | null,
