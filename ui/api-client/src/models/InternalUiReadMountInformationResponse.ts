 ...
 */
export function instanceOfInternalUiReadMountInformationResponse(
  value: object
): value is InternalUiReadMountInformationResponse {
  return true;
}

export function InternalUiReadMountInformationResponseFromJSON(
  json: any
): InternalUiReadMountInformationResponse {
  return InternalUiReadMountInformationResponseFromJSONTyped(json, false);
}

export function InternalUiReadMountInformationResponseFromJSONTyped(
  json: any,
...
export function InternalUiReadMountInformationResponseToJSON(
  json: any
): InternalUiReadMountInformationResponse {
  return InternalUiReadMountInformationResponseToJSONTyped(json, false);
}

export function InternalUiReadMountInformationResponseToJSONTyped(
  value?: InternalUiReadMountInformationResponse | null,
