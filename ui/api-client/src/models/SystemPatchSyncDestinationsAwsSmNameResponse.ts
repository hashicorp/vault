 ...
 */
export function instanceOfSystemPatchSyncDestinationsAwsSmNameResponse(
  value: object
): value is SystemPatchSyncDestinationsAwsSmNameResponse {
  return true;
}

export function SystemPatchSyncDestinationsAwsSmNameResponseFromJSON(
  json: any
): SystemPatchSyncDestinationsAwsSmNameResponse {
  return SystemPatchSyncDestinationsAwsSmNameResponseFromJSONTyped(json, false);
}

export function SystemPatchSyncDestinationsAwsSmNameResponseFromJSONTyped(
  json: any,
...
export function SystemPatchSyncDestinationsAwsSmNameResponseToJSON(
  json: any
): SystemPatchSyncDestinationsAwsSmNameResponse {
  return SystemPatchSyncDestinationsAwsSmNameResponseToJSONTyped(json, false);
}

export function SystemPatchSyncDestinationsAwsSmNameResponseToJSONTyped(
  value?: SystemPatchSyncDestinationsAwsSmNameResponse | null,
