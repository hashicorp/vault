 ...
 */
export function instanceOfPkiWriteAcmeNewAccountRequest(
  value: object
): value is PkiWriteAcmeNewAccountRequest {
  return true;
}
...
export function PkiWriteAcmeNewAccountRequestFromJSONTyped(
  json: any,
...
export function PkiWriteAcmeNewAccountRequestToJSONTyped(
  value?: PkiWriteAcmeNewAccountRequest | null,
