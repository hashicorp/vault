 ...
 */
export function instanceOfGenerateHashWithAlgorithmResponse(
  value: object
): value is GenerateHashWithAlgorithmResponse {
  return true;
}
...
export function GenerateHashWithAlgorithmResponseFromJSONTyped(
  json: any,
...
export function GenerateHashWithAlgorithmResponseToJSONTyped(
  value?: GenerateHashWithAlgorithmResponse | null,
