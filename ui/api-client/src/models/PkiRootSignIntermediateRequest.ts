 ...
 */
export function instanceOfPkiRootSignIntermediateRequest(
  value: object
): value is PkiRootSignIntermediateRequest {
  return true;
}
...
export function PkiRootSignIntermediateRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    enforceLeafNotAfterBehavior:
      json['enforce_leaf_not_after_behavior'] == null ? undefined : json['enforce_leaf_not_after_behavior'],
...
export function PkiRootSignIntermediateRequestToJSONTyped(
  value?: PkiRootSignIntermediateRequest | null,
