 ...
 */
export function instanceOfJwtOidcRequestAuthorizationUrlRequest(
  value: object
): value is JwtOidcRequestAuthorizationUrlRequest {
  return true;
}

export function JwtOidcRequestAuthorizationUrlRequestFromJSON(
  json: any
): JwtOidcRequestAuthorizationUrlRequest {
  return JwtOidcRequestAuthorizationUrlRequestFromJSONTyped(json, false);
}

export function JwtOidcRequestAuthorizationUrlRequestFromJSONTyped(
  json: any,
...
export function JwtOidcRequestAuthorizationUrlRequestToJSON(
  json: any
): JwtOidcRequestAuthorizationUrlRequest {
  return JwtOidcRequestAuthorizationUrlRequestToJSONTyped(json, false);
}

export function JwtOidcRequestAuthorizationUrlRequestToJSONTyped(
  value?: JwtOidcRequestAuthorizationUrlRequest | null,
