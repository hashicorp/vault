...
export function CloudFoundryWriteRoleRequestFromJSONTyped(
  json: any,
...
export function CloudFoundryWriteRoleRequestToJSONTyped(
  value?: CloudFoundryWriteRoleRequest | null,
