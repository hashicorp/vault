 ...
 */
export function instanceOfSystemWriteQuotasLeaseCountNameRequest(
  value: object
): value is SystemWriteQuotasLeaseCountNameRequest {
  return true;
}

export function SystemWriteQuotasLeaseCountNameRequestFromJSON(
  json: any
): SystemWriteQuotasLeaseCountNameRequest {
  return SystemWriteQuotasLeaseCountNameRequestFromJSONTyped(json, false);
}

export function SystemWriteQuotasLeaseCountNameRequestFromJSONTyped(
  json: any,
...
export function SystemWriteQuotasLeaseCountNameRequestToJSON(
  json: any
): SystemWriteQuotasLeaseCountNameRequest {
  return SystemWriteQuotasLeaseCountNameRequestToJSONTyped(json, false);
}

export function SystemWriteQuotasLeaseCountNameRequestToJSONTyped(
  value?: SystemWriteQuotasLeaseCountNameRequest | null,
