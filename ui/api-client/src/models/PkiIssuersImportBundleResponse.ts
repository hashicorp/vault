 ...
 */
export function instanceOfPkiIssuersImportBundleResponse(
  value: object
): value is PkiIssuersImportBundleResponse {
  return true;
}
...
export function PkiIssuersImportBundleResponseFromJSONTyped(
  json: any,
...
export function PkiIssuersImportBundleResponseToJSONTyped(
  value?: PkiIssuersImportBundleResponse | null,
