 ...
 */
export function instanceOfPkiIssuerSignVerbatimResponse(
  value: object
): value is PkiIssuerSignVerbatimResponse {
  return true;
}
...
export function PkiIssuerSignVerbatimResponseFromJSONTyped(
  json: any,
...
export function PkiIssuerSignVerbatimResponseToJSONTyped(
  value?: PkiIssuerSignVerbatimResponse | null,
