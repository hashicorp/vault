...
export function PkiConfigureAutoTidyRequestFromJSONTyped(
  json: any,
  ...
  return {
    acmeAccountSafetyBuffer:
      json['acme_account_safety_buffer'] == null ? undefined : json['acme_account_safety_buffer'],
    ...
    maintainStoredCertificateCounts:
      json['maintain_stored_certificate_counts'] == null
        ? undefined
        : json['maintain_stored_certificate_counts'],
    maxStartupBackoffDuration:
      json['max_startup_backoff_duration'] == null ? undefined : json['max_startup_backoff_duration'],
    minStartupBackoffDuration:
      json['min_startup_backoff_duration'] == null ? undefined : json['min_startup_backoff_duration'],
    pauseDuration: json['pause_duration'] == null ? undefined : json['pause_duration'],
    publishStoredCertificateCountMetrics:
      json['publish_stored_certificate_count_metrics'] == null
        ? undefined
        : json['publish_stored_certificate_count_metrics'],
    revocationQueueSafetyBuffer:
      json['revocation_queue_safety_buffer'] == null ? undefined : json['revocation_queue_safety_buffer'],
    ...
    tidyCrossClusterRevokedCerts:
      json['tidy_cross_cluster_revoked_certs'] == null ? undefined : json['tidy_cross_cluster_revoked_certs'],
    tidyExpiredIssuers: json['tidy_expired_issuers'] == null ? undefined : json['tidy_expired_issuers'],
    tidyMoveLegacyCaBundle:
      json['tidy_move_legacy_ca_bundle'] == null ? undefined : json['tidy_move_legacy_ca_bundle'],
    ...
    tidyRevokedCertIssuerAssociations:
      json['tidy_revoked_cert_issuer_associations'] == null
        ? undefined
...
export function PkiConfigureAutoTidyRequestToJSONTyped(
  value?: PkiConfigureAutoTidyRequest | null,
