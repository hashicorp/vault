 ...
 */
export function instanceOfRootTokenGenerationInitializeResponse(
  value: object
): value is RootTokenGenerationInitializeResponse {
  return true;
}

export function RootTokenGenerationInitializeResponseFromJSON(
  json: any
): RootTokenGenerationInitializeResponse {
  return RootTokenGenerationInitializeResponseFromJSONTyped(json, false);
}

export function RootTokenGenerationInitializeResponseFromJSONTyped(
  json: any,
...
export function RootTokenGenerationInitializeResponseToJSON(
  json: any
): RootTokenGenerationInitializeResponse {
  return RootTokenGenerationInitializeResponseToJSONTyped(json, false);
}

export function RootTokenGenerationInitializeResponseToJSONTyped(
  value?: RootTokenGenerationInitializeResponse | null,
