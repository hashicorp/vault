 ...
 */
export function instanceOfLeasesRevokeLeaseWithId2Request(
  value: object
): value is LeasesRevokeLeaseWithId2Request {
  return true;
}
...
export function LeasesRevokeLeaseWithId2RequestFromJSONTyped(
  json: any,
...
export function LeasesRevokeLeaseWithId2RequestToJSONTyped(
  value?: LeasesRevokeLeaseWithId2Request | null,
