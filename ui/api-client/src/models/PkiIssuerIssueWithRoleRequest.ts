...
export interface PkiIssuerIssueWithRoleRequest {
   ...
   * @memberof PkiIssuerIssueWithRoleRequest
   */
  privateKeyFormat?: PkiIssuerIssueWithRoleRequestPrivateKeyFormatEnum;
  /**
 ...
 */
export function instanceOfPkiIssuerIssueWithRoleRequest(
  value: object
): value is PkiIssuerIssueWithRoleRequest {
  return true;
}
...
export function PkiIssuerIssueWithRoleRequestFromJSONTyped(
  json: any,
...
export function PkiIssuerIssueWithRoleRequestToJSONTyped(
  value?: PkiIssuerIssueWithRoleRequest | null,
