...
export function instanceOfPkiWriteExternalPolicyAcmeOrderOrderIdFinalizeRequest(
  value: object
): value is PkiWriteExternalPolicyAcmeOrderOrderIdFinalizeRequest {
  return true;
}

export function PkiWriteExternalPolicyAcmeOrderOrderIdFinalizeRequestFromJSON(
  json: any
...
export function PkiWriteExternalPolicyAcmeOrderOrderIdFinalizeRequestFromJSONTyped(
  json: any,
...
export function PkiWriteExternalPolicyAcmeOrderOrderIdFinalizeRequestToJSON(
  json: any
): PkiWriteExternalPolicyAcmeOrderOrderIdFinalizeRequest {
  return PkiWriteExternalPolicyAcmeOrderOrderIdFinalizeRequestToJSONTyped(json, false);
}

export function PkiWriteExternalPolicyAcmeOrderOrderIdFinalizeRequestToJSONTyped(
  value?: PkiWriteExternalPolicyAcmeOrderOrderIdFinalizeRequest | null,
