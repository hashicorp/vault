 ...
 */
export function instanceOfPkiWriteIssuerIssuerRefExternalPolicyAcmeNewOrderRequest(
  value: object
): value is PkiWriteIssuerIssuerRefExternalPolicyAcmeNewOrderRequest {
  return true;
}

export function PkiWriteIssuerIssuerRefExternalPolicyAcmeNewOrderRequestFromJSON(
  json: any
...
export function PkiWriteIssuerIssuerRefExternalPolicyAcmeNewOrderRequestFromJSONTyped(
  json: any,
...
export function PkiWriteIssuerIssuerRefExternalPolicyAcmeNewOrderRequestToJSON(
  json: any
): PkiWriteIssuerIssuerRefExternalPolicyAcmeNewOrderRequest {
  return PkiWriteIssuerIssuerRefExternalPolicyAcmeNewOrderRequestToJSONTyped(json, false);
}

export function PkiWriteIssuerIssuerRefExternalPolicyAcmeNewOrderRequestToJSONTyped(
  value?: PkiWriteIssuerIssuerRefExternalPolicyAcmeNewOrderRequest | null,
