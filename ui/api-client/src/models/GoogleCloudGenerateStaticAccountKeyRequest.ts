 ...
 */
export function instanceOfGoogleCloudGenerateStaticAccountKeyRequest(
  value: object
): value is GoogleCloudGenerateStaticAccountKeyRequest {
  return true;
}

export function GoogleCloudGenerateStaticAccountKeyRequestFromJSON(
  json: any
): GoogleCloudGenerateStaticAccountKeyRequest {
  return GoogleCloudGenerateStaticAccountKeyRequestFromJSONTyped(json, false);
}

export function GoogleCloudGenerateStaticAccountKeyRequestFromJSONTyped(
  json: any,
...
export function GoogleCloudGenerateStaticAccountKeyRequestToJSON(
  json: any
): GoogleCloudGenerateStaticAccountKeyRequest {
  return GoogleCloudGenerateStaticAccountKeyRequestToJSONTyped(json, false);
}

export function GoogleCloudGenerateStaticAccountKeyRequestToJSONTyped(
  value?: GoogleCloudGenerateStaticAccountKeyRequest | null,
