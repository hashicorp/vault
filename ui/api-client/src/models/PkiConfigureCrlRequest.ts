...
export function PkiConfigureCrlRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    autoRebuildGracePeriod:
      json['auto_rebuild_grace_period'] == null ? undefined : json['auto_rebuild_grace_period'],
    crossClusterRevocation:
      json['cross_cluster_revocation'] == null ? undefined : json['cross_cluster_revocation'],
    ...
    unifiedCrlOnExistingPaths:
      json['unified_crl_on_existing_paths'] == null ? undefined : json['unified_crl_on_existing_paths'],
  };
}
...
export function PkiConfigureCrlRequestToJSONTyped(
  value?: PkiConfigureCrlRequest | null,
