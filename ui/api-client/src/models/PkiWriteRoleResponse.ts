 ...
 */
export function instanceOfPkiWriteRoleResponse(value: object): value is PkiWriteRoleResponse {
    return true;
}

export function PkiWriteRoleResponseFromJSON(json: any): PkiWriteRoleResponse {
    return PkiWriteRoleResponseFromJSONTyped(json, false);
}

export function PkiWriteRoleResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PkiWriteRoleResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiWriteRoleResponseToJSON(json: any): PkiWriteRoleResponse {
    return PkiWriteRoleResponseToJSONTyped(json, false);
}

export function PkiWriteRoleResponseToJSONTyped(value?: PkiWriteRoleResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
