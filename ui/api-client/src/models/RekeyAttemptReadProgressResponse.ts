 ...
 */
export function instanceOfRekeyAttemptReadProgressResponse(
  value: object
): value is RekeyAttemptReadProgressResponse {
  return true;
}
...
export function RekeyAttemptReadProgressResponseFromJSONTyped(
  json: any,
...
export function RekeyAttemptReadProgressResponseToJSONTyped(
  value?: RekeyAttemptReadProgressResponse | null,
