...
export function LdapConfigureRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    enableSamaccountnameLogin:
      json['enable_samaccountname_login'] == null ? undefined : json['enable_samaccountname_login'],
    ...
    usePre111GroupCnBehavior:
      json['use_pre111_group_cn_behavior'] == null ? undefined : json['use_pre111_group_cn_behavior'],
...
export function LdapConfigureRequestToJSONTyped(
  value?: LdapConfigureRequest | null,
