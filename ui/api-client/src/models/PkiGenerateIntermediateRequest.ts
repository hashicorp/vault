 ...
 */
export function instanceOfPkiGenerateIntermediateRequest(
  value: object
): value is PkiGenerateIntermediateRequest {
  return true;
}
...
export function PkiGenerateIntermediateRequestFromJSONTyped(
  json: any,
...
export function PkiGenerateIntermediateRequestToJSONTyped(
  value?: PkiGenerateIntermediateRequest | null,
