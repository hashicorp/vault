 ...
 */
export function instanceOfTransitHashWithAlgorithmRequest(
  value: object
): value is TransitHashWithAlgorithmRequest {
  return true;
}
...
export function TransitHashWithAlgorithmRequestFromJSONTyped(
  json: any,
...
export function TransitHashWithAlgorithmRequestToJSONTyped(
  value?: TransitHashWithAlgorithmRequest | null,
