 ...
 */
export function instanceOfRootTokenGenerationReadProgressResponse(
  value: object
): value is RootTokenGenerationReadProgressResponse {
  return true;
}

export function RootTokenGenerationReadProgressResponseFromJSON(
  json: any
): RootTokenGenerationReadProgressResponse {
  return RootTokenGenerationReadProgressResponseFromJSONTyped(json, false);
}

export function RootTokenGenerationReadProgressResponseFromJSONTyped(
  json: any,
...
export function RootTokenGenerationReadProgressResponseToJSON(
  json: any
): RootTokenGenerationReadProgressResponse {
  return RootTokenGenerationReadProgressResponseToJSONTyped(json, false);
}

export function RootTokenGenerationReadProgressResponseToJSONTyped(
  value?: RootTokenGenerationReadProgressResponse | null,
