...
* @enum {string}
*/
export enum PkiPatchRoleRequestKeyTypeEnum {
    RSA = 'rsa',
    EC = 'ec',
    ED25519 = 'ed25519',
    ANY = 'any'
 ...
 */
export function instanceOfPkiPatchRoleRequest(value: object): value is PkiPatchRoleRequest {
    return true;
}

export function PkiPatchRoleRequestFromJSON(json: any): PkiPatchRoleRequest {
    return PkiPatchRoleRequestFromJSONTyped(json, false);
}

export function PkiPatchRoleRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PkiPatchRoleRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiPatchRoleRequestToJSON(json: any): PkiPatchRoleRequest {
    return PkiPatchRoleRequestToJSONTyped(json, false);
}

export function PkiPatchRoleRequestToJSONTyped(value?: PkiPatchRoleRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
