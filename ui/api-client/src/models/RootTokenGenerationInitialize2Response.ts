 ...
 */
export function instanceOfRootTokenGenerationInitialize2Response(
  value: object
): value is RootTokenGenerationInitialize2Response {
  return true;
}

export function RootTokenGenerationInitialize2ResponseFromJSON(
  json: any
): RootTokenGenerationInitialize2Response {
  return RootTokenGenerationInitialize2ResponseFromJSONTyped(json, false);
}

export function RootTokenGenerationInitialize2ResponseFromJSONTyped(
  json: any,
...
export function RootTokenGenerationInitialize2ResponseToJSON(
  json: any
): RootTokenGenerationInitialize2Response {
  return RootTokenGenerationInitialize2ResponseToJSONTyped(json, false);
}

export function RootTokenGenerationInitialize2ResponseToJSONTyped(
  value?: RootTokenGenerationInitialize2Response | null,
