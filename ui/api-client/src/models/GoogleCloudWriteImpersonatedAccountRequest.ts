 ...
 */
export function instanceOfGoogleCloudWriteImpersonatedAccountRequest(
  value: object
): value is GoogleCloudWriteImpersonatedAccountRequest {
  return true;
}

export function GoogleCloudWriteImpersonatedAccountRequestFromJSON(
  json: any
): GoogleCloudWriteImpersonatedAccountRequest {
  return GoogleCloudWriteImpersonatedAccountRequestFromJSONTyped(json, false);
}

export function GoogleCloudWriteImpersonatedAccountRequestFromJSONTyped(
  json: any,
...
export function GoogleCloudWriteImpersonatedAccountRequestToJSON(
  json: any
): GoogleCloudWriteImpersonatedAccountRequest {
  return GoogleCloudWriteImpersonatedAccountRequestToJSONTyped(json, false);
}

export function GoogleCloudWriteImpersonatedAccountRequestToJSONTyped(
  value?: GoogleCloudWriteImpersonatedAccountRequest | null,
