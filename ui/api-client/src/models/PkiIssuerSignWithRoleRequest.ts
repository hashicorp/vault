...
export function PkiIssuerSignWithRoleRequestFromJSONTyped(
  json: any,
...
export function PkiIssuerSignWithRoleRequestToJSONTyped(
  value?: PkiIssuerSignWithRoleRequest | null,
