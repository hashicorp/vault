 ...
 */
export function instanceOfPkiIssuerIssueWithRoleResponse(
  value: object
): value is PkiIssuerIssueWithRoleResponse {
  return true;
}
...
export function PkiIssuerIssueWithRoleResponseFromJSONTyped(
  json: any,
...
export function PkiIssuerIssueWithRoleResponseToJSONTyped(
  value?: PkiIssuerIssueWithRoleResponse | null,
