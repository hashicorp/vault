 ...
 */
export function instanceOfPkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeNewAccountRequest(
  value: object
): value is PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeNewAccountRequest {
  return true;
}

export function PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeNewAccountRequestFromJSON(
  json: any
...
export function PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeNewAccountRequestFromJSONTyped(
  json: any,
...
export function PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeNewAccountRequestToJSON(
  json: any
): PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeNewAccountRequest {
  return PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeNewAccountRequestToJSONTyped(json, false);
}

export function PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeNewAccountRequestToJSONTyped(
  value?: PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeNewAccountRequest | null,
