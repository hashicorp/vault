 ...
 */
export function instanceOfPkiWriteExternalPolicyAcmeAuthorizationAuthIdRequest(
  value: object
): value is PkiWriteExternalPolicyAcmeAuthorizationAuthIdRequest {
  return true;
}

export function PkiWriteExternalPolicyAcmeAuthorizationAuthIdRequestFromJSON(
  json: any
...
export function PkiWriteExternalPolicyAcmeAuthorizationAuthIdRequestFromJSONTyped(
  json: any,
...
export function PkiWriteExternalPolicyAcmeAuthorizationAuthIdRequestToJSON(
  json: any
): PkiWriteExternalPolicyAcmeAuthorizationAuthIdRequest {
  return PkiWriteExternalPolicyAcmeAuthorizationAuthIdRequestToJSONTyped(json, false);
}

export function PkiWriteExternalPolicyAcmeAuthorizationAuthIdRequestToJSONTyped(
  value?: PkiWriteExternalPolicyAcmeAuthorizationAuthIdRequest | null,
