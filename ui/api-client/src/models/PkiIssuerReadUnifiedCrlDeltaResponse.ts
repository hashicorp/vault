 ...
 */
export function instanceOfPkiIssuerReadUnifiedCrlDeltaResponse(
  value: object
): value is PkiIssuerReadUnifiedCrlDeltaResponse {
  return true;
}

export function PkiIssuerReadUnifiedCrlDeltaResponseFromJSON(
  json: any
): PkiIssuerReadUnifiedCrlDeltaResponse {
  return PkiIssuerReadUnifiedCrlDeltaResponseFromJSONTyped(json, false);
}

export function PkiIssuerReadUnifiedCrlDeltaResponseFromJSONTyped(
  json: any,
...
export function PkiIssuerReadUnifiedCrlDeltaResponseToJSONTyped(
  value?: PkiIssuerReadUnifiedCrlDeltaResponse | null,
