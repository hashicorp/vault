 ...
 */
export function instanceOfPkiIssuerSignIntermediateRequest(
  value: object
): value is PkiIssuerSignIntermediateRequest {
  return true;
}
...
export function PkiIssuerSignIntermediateRequestFromJSONTyped(
  json: any,
...
export function PkiIssuerSignIntermediateRequestToJSONTyped(
  value?: PkiIssuerSignIntermediateRequest | null,
