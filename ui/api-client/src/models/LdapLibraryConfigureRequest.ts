...
export function LdapLibraryConfigureRequestFromJSONTyped(
  json: any,
  ...
  return {
    disableCheckInEnforcement:
      json['disable_check_in_enforcement'] == null ? undefined : json['disable_check_in_enforcement'],
...
export function LdapLibraryConfigureRequestToJSONTyped(
  value?: LdapLibraryConfigureRequest | null,
