 ...
 */
export function instanceOfQueryTokenSelfCapabilitiesRequest(
  value: object
): value is QueryTokenSelfCapabilitiesRequest {
  return true;
}
...
export function QueryTokenSelfCapabilitiesRequestFromJSONTyped(
  json: any,
...
export function QueryTokenSelfCapabilitiesRequestToJSONTyped(
  value?: QueryTokenSelfCapabilitiesRequest | null,
