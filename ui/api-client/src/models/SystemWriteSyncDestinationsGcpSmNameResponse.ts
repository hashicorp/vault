 ...
 */
export function instanceOfSystemWriteSyncDestinationsGcpSmNameResponse(
  value: object
): value is SystemWriteSyncDestinationsGcpSmNameResponse {
  return true;
}

export function SystemWriteSyncDestinationsGcpSmNameResponseFromJSON(
  json: any
): SystemWriteSyncDestinationsGcpSmNameResponse {
  return SystemWriteSyncDestinationsGcpSmNameResponseFromJSONTyped(json, false);
}

export function SystemWriteSyncDestinationsGcpSmNameResponseFromJSONTyped(
  json: any,
...
export function SystemWriteSyncDestinationsGcpSmNameResponseToJSON(
  json: any
): SystemWriteSyncDestinationsGcpSmNameResponse {
  return SystemWriteSyncDestinationsGcpSmNameResponseToJSONTyped(json, false);
}

export function SystemWriteSyncDestinationsGcpSmNameResponseToJSONTyped(
  value?: SystemWriteSyncDestinationsGcpSmNameResponse | null,
