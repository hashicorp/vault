...
export function MfaCreatePingIdMethodRequestFromJSONTyped(
  json: any,
...
export function MfaCreatePingIdMethodRequestToJSONTyped(
  value?: MfaCreatePingIdMethodRequest | null,
