 ...
 */
export function instanceOfPluginsCatalogPinsCreatePinnedVersionRequest(
  value: object
): value is PluginsCatalogPinsCreatePinnedVersionRequest {
  return true;
}

export function PluginsCatalogPinsCreatePinnedVersionRequestFromJSON(
  json: any
): PluginsCatalogPinsCreatePinnedVersionRequest {
  return PluginsCatalogPinsCreatePinnedVersionRequestFromJSONTyped(json, false);
}

export function PluginsCatalogPinsCreatePinnedVersionRequestFromJSONTyped(
  json: any,
...
export function PluginsCatalogPinsCreatePinnedVersionRequestToJSON(
  json: any
): PluginsCatalogPinsCreatePinnedVersionRequest {
  return PluginsCatalogPinsCreatePinnedVersionRequestToJSONTyped(json, false);
}

export function PluginsCatalogPinsCreatePinnedVersionRequestToJSONTyped(
  value?: PluginsCatalogPinsCreatePinnedVersionRequest | null,
