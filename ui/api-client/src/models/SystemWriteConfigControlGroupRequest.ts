 ...
 */
export function instanceOfSystemWriteConfigControlGroupRequest(
  value: object
): value is SystemWriteConfigControlGroupRequest {
  return true;
}

export function SystemWriteConfigControlGroupRequestFromJSON(
  json: any
): SystemWriteConfigControlGroupRequest {
  return SystemWriteConfigControlGroupRequestFromJSONTyped(json, false);
}

export function SystemWriteConfigControlGroupRequestFromJSONTyped(
  json: any,
...
export function SystemWriteConfigControlGroupRequestToJSONTyped(
  value?: SystemWriteConfigControlGroupRequest | null,
