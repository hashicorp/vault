 ...
 */
export function instanceOfTransitSignWithAlgorithmRequest(
  value: object
): value is TransitSignWithAlgorithmRequest {
  return true;
}
...
export function TransitSignWithAlgorithmRequestFromJSONTyped(
  json: any,
...
export function TransitSignWithAlgorithmRequestToJSONTyped(
  value?: TransitSignWithAlgorithmRequest | null,
