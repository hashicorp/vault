...
export function PkiConfigureEstRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    enableSentinelParsing:
      json['enable_sentinel_parsing'] == null ? undefined : json['enable_sentinel_parsing'],
...
export function PkiConfigureEstRequestToJSONTyped(
  value?: PkiConfigureEstRequest | null,
