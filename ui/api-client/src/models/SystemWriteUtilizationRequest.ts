 ...
 */
export function instanceOfSystemWriteUtilizationRequest(
  value: object
): value is SystemWriteUtilizationRequest {
  return true;
}
...
export function SystemWriteUtilizationRequestFromJSONTyped(
  json: any,
...
export function SystemWriteUtilizationRequestToJSONTyped(
  value?: SystemWriteUtilizationRequest | null,
