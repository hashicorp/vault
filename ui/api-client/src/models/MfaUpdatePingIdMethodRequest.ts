...
export function MfaUpdatePingIdMethodRequestFromJSONTyped(
  json: any,
...
export function MfaUpdatePingIdMethodRequestToJSONTyped(
  value?: MfaUpdatePingIdMethodRequest | null,
