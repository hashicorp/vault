 ...
 */
export function instanceOfPkiWriteExternalPolicyAcmeChallengeAuthIdChallengeTypeRequest(
  value: object
): value is PkiWriteExternalPolicyAcmeChallengeAuthIdChallengeTypeRequest {
  return true;
}

export function PkiWriteExternalPolicyAcmeChallengeAuthIdChallengeTypeRequestFromJSON(
  json: any
...
export function PkiWriteExternalPolicyAcmeChallengeAuthIdChallengeTypeRequestFromJSONTyped(
  json: any,
...
export function PkiWriteExternalPolicyAcmeChallengeAuthIdChallengeTypeRequestToJSON(
  json: any
): PkiWriteExternalPolicyAcmeChallengeAuthIdChallengeTypeRequest {
  return PkiWriteExternalPolicyAcmeChallengeAuthIdChallengeTypeRequestToJSONTyped(json, false);
}

export function PkiWriteExternalPolicyAcmeChallengeAuthIdChallengeTypeRequestToJSONTyped(
  value?: PkiWriteExternalPolicyAcmeChallengeAuthIdChallengeTypeRequest | null,
