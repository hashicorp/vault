 ...
 */
export function instanceOfSystemWriteReplicationReindexRequest(
  value: object
): value is SystemWriteReplicationReindexRequest {
  return true;
}

export function SystemWriteReplicationReindexRequestFromJSON(
  json: any
): SystemWriteReplicationReindexRequest {
  return SystemWriteReplicationReindexRequestFromJSONTyped(json, false);
}

export function SystemWriteReplicationReindexRequestFromJSONTyped(
  json: any,
...
export function SystemWriteReplicationReindexRequestToJSONTyped(
  value?: SystemWriteReplicationReindexRequest | null,
