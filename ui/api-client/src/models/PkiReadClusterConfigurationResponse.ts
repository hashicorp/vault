 ...
 */
export function instanceOfPkiReadClusterConfigurationResponse(value: object): value is PkiReadClusterConfigurationResponse {
    return true;
}

export function PkiReadClusterConfigurationResponseFromJSON(json: any): PkiReadClusterConfigurationResponse {
    return PkiReadClusterConfigurationResponseFromJSONTyped(json, false);
}

export function PkiReadClusterConfigurationResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PkiReadClusterConfigurationResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiReadClusterConfigurationResponseToJSON(json: any): PkiReadClusterConfigurationResponse {
    return PkiReadClusterConfigurationResponseToJSONTyped(json, false);
}

export function PkiReadClusterConfigurationResponseToJSONTyped(value?: PkiReadClusterConfigurationResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
