 ...
 */
export function instanceOfSystemWriteReplicationSecondaryPromoteRequest(
  value: object
): value is SystemWriteReplicationSecondaryPromoteRequest {
  return true;
}

export function SystemWriteReplicationSecondaryPromoteRequestFromJSON(
  json: any
...
export function SystemWriteReplicationSecondaryPromoteRequestFromJSONTyped(
  json: any,
...
export function SystemWriteReplicationSecondaryPromoteRequestToJSON(
  json: any
): SystemWriteReplicationSecondaryPromoteRequest {
  return SystemWriteReplicationSecondaryPromoteRequestToJSONTyped(json, false);
}

export function SystemWriteReplicationSecondaryPromoteRequestToJSONTyped(
  value?: SystemWriteReplicationSecondaryPromoteRequest | null,
