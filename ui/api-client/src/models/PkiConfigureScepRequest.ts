...
export function PkiConfigureScepRequestFromJSONTyped(
  json: any,
  ...
  return {
    allowedDigestAlgorithms:
      json['allowed_digest_algorithms'] == null ? undefined : json['allowed_digest_algorithms'],
    allowedEncryptionAlgorithms:
      json['allowed_encryption_algorithms'] == null ? undefined : json['allowed_encryption_algorithms'],
...
export function PkiConfigureScepRequestToJSONTyped(
  value?: PkiConfigureScepRequest | null,
