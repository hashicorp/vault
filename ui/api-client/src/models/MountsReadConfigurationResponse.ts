 ...
 */
export function instanceOfMountsReadConfigurationResponse(
  value: object
): value is MountsReadConfigurationResponse {
  return true;
}
...
export function MountsReadConfigurationResponseFromJSONTyped(
  json: any,
...
export function MountsReadConfigurationResponseToJSONTyped(
  value?: MountsReadConfigurationResponse | null,
