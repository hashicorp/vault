...
export function PkiRootSignSelfIssuedRequestFromJSONTyped(
  json: any,
...
export function PkiRootSignSelfIssuedRequestToJSONTyped(
  value?: PkiRootSignSelfIssuedRequest | null,
