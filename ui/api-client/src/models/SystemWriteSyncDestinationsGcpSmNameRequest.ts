 ...
 */
export function instanceOfSystemWriteSyncDestinationsGcpSmNameRequest(
  value: object
): value is SystemWriteSyncDestinationsGcpSmNameRequest {
  return true;
}

export function SystemWriteSyncDestinationsGcpSmNameRequestFromJSON(
  json: any
): SystemWriteSyncDestinationsGcpSmNameRequest {
  return SystemWriteSyncDestinationsGcpSmNameRequestFromJSONTyped(json, false);
}

export function SystemWriteSyncDestinationsGcpSmNameRequestFromJSONTyped(
  json: any,
...
export function SystemWriteSyncDestinationsGcpSmNameRequestToJSON(
  json: any
): SystemWriteSyncDestinationsGcpSmNameRequest {
  return SystemWriteSyncDestinationsGcpSmNameRequestToJSONTyped(json, false);
}

export function SystemWriteSyncDestinationsGcpSmNameRequestToJSONTyped(
  value?: SystemWriteSyncDestinationsGcpSmNameRequest | null,
