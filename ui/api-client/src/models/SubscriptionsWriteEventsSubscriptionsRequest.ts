 ...
 */
export function instanceOfSubscriptionsWriteEventsSubscriptionsRequest(
  value: object
): value is SubscriptionsWriteEventsSubscriptionsRequest {
  return true;
}

export function SubscriptionsWriteEventsSubscriptionsRequestFromJSON(
  json: any
): SubscriptionsWriteEventsSubscriptionsRequest {
  return SubscriptionsWriteEventsSubscriptionsRequestFromJSONTyped(json, false);
}

export function SubscriptionsWriteEventsSubscriptionsRequestFromJSONTyped(
  json: any,
...
export function SubscriptionsWriteEventsSubscriptionsRequestToJSON(
  json: any
): SubscriptionsWriteEventsSubscriptionsRequest {
  return SubscriptionsWriteEventsSubscriptionsRequestToJSONTyped(json, false);
}

export function SubscriptionsWriteEventsSubscriptionsRequestToJSONTyped(
  value?: SubscriptionsWriteEventsSubscriptionsRequest | null,
