 ...
 */
export function instanceOfMountsTuneConfigurationParametersRequest(
  value: object
): value is MountsTuneConfigurationParametersRequest {
  return true;
}

export function MountsTuneConfigurationParametersRequestFromJSON(
  json: any
): MountsTuneConfigurationParametersRequest {
  return MountsTuneConfigurationParametersRequestFromJSONTyped(json, false);
}

export function MountsTuneConfigurationParametersRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    delegatedAuthAccessors:
      json['delegated_auth_accessors'] == null ? undefined : json['delegated_auth_accessors'],
...
export function MountsTuneConfigurationParametersRequestToJSON(
  json: any
): MountsTuneConfigurationParametersRequest {
  return MountsTuneConfigurationParametersRequestToJSONTyped(json, false);
}

export function MountsTuneConfigurationParametersRequestToJSONTyped(
  value?: MountsTuneConfigurationParametersRequest | null,
