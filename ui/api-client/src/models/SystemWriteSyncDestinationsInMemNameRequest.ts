 ...
 */
export function instanceOfSystemWriteSyncDestinationsInMemNameRequest(
  value: object
): value is SystemWriteSyncDestinationsInMemNameRequest {
  return true;
}

export function SystemWriteSyncDestinationsInMemNameRequestFromJSON(
  json: any
): SystemWriteSyncDestinationsInMemNameRequest {
  return SystemWriteSyncDestinationsInMemNameRequestFromJSONTyped(json, false);
}

export function SystemWriteSyncDestinationsInMemNameRequestFromJSONTyped(
  json: any,
...
export function SystemWriteSyncDestinationsInMemNameRequestToJSON(
  json: any
): SystemWriteSyncDestinationsInMemNameRequest {
  return SystemWriteSyncDestinationsInMemNameRequestToJSONTyped(json, false);
}

export function SystemWriteSyncDestinationsInMemNameRequestToJSONTyped(
  value?: SystemWriteSyncDestinationsInMemNameRequest | null,
