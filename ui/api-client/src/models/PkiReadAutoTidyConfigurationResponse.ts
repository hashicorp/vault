 ...
 */
export function instanceOfPkiReadAutoTidyConfigurationResponse(
  value: object
): value is PkiReadAutoTidyConfigurationResponse {
  return true;
}

export function PkiReadAutoTidyConfigurationResponseFromJSON(
  json: any
): PkiReadAutoTidyConfigurationResponse {
  return PkiReadAutoTidyConfigurationResponseFromJSONTyped(json, false);
}

export function PkiReadAutoTidyConfigurationResponseFromJSONTyped(
  json: any,
...
export function PkiReadAutoTidyConfigurationResponseToJSONTyped(
  value?: PkiReadAutoTidyConfigurationResponse | null,
