 ...
 */
export function instanceOfSystemWriteReplicationPrimarySecondaryTokenRequest(
  value: object
): value is SystemWriteReplicationPrimarySecondaryTokenRequest {
  return true;
}

export function SystemWriteReplicationPrimarySecondaryTokenRequestFromJSON(
  json: any
...
export function SystemWriteReplicationPrimarySecondaryTokenRequestFromJSONTyped(
  json: any,
...
export function SystemWriteReplicationPrimarySecondaryTokenRequestToJSON(
  json: any
): SystemWriteReplicationPrimarySecondaryTokenRequest {
  return SystemWriteReplicationPrimarySecondaryTokenRequestToJSONTyped(json, false);
}

export function SystemWriteReplicationPrimarySecondaryTokenRequestToJSONTyped(
  value?: SystemWriteReplicationPrimarySecondaryTokenRequest | null,
