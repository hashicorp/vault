 ...
 */
export function instanceOfPkiGenerateEabKeyForIssuerAndRoleResponse(
  value: object
): value is PkiGenerateEabKeyForIssuerAndRoleResponse {
  return true;
}

export function PkiGenerateEabKeyForIssuerAndRoleResponseFromJSON(
  json: any
): PkiGenerateEabKeyForIssuerAndRoleResponse {
  return PkiGenerateEabKeyForIssuerAndRoleResponseFromJSONTyped(json, false);
}

export function PkiGenerateEabKeyForIssuerAndRoleResponseFromJSONTyped(
  json: any,
...
export function PkiGenerateEabKeyForIssuerAndRoleResponseToJSON(
  json: any
): PkiGenerateEabKeyForIssuerAndRoleResponse {
  return PkiGenerateEabKeyForIssuerAndRoleResponseToJSONTyped(json, false);
}

export function PkiGenerateEabKeyForIssuerAndRoleResponseToJSONTyped(
  value?: PkiGenerateEabKeyForIssuerAndRoleResponse | null,
