 ...
 */
export function instanceOfSystemWriteReplicationPerformanceSecondaryUpdatePrimaryRequest(
  value: object
): value is SystemWriteReplicationPerformanceSecondaryUpdatePrimaryRequest {
  return true;
}

export function SystemWriteReplicationPerformanceSecondaryUpdatePrimaryRequestFromJSON(
  json: any
...
export function SystemWriteReplicationPerformanceSecondaryUpdatePrimaryRequestFromJSONTyped(
  json: any,
...
export function SystemWriteReplicationPerformanceSecondaryUpdatePrimaryRequestToJSON(
  json: any
): SystemWriteReplicationPerformanceSecondaryUpdatePrimaryRequest {
  return SystemWriteReplicationPerformanceSecondaryUpdatePrimaryRequestToJSONTyped(json, false);
}

export function SystemWriteReplicationPerformanceSecondaryUpdatePrimaryRequestToJSONTyped(
  value?: SystemWriteReplicationPerformanceSecondaryUpdatePrimaryRequest | null,
