 ...
 */
export function instanceOfGoogleCloudKmsWriteKeyRequest(
  value: object
): value is GoogleCloudKmsWriteKeyRequest {
  return true;
}
...
export function GoogleCloudKmsWriteKeyRequestFromJSONTyped(
  json: any,
...
export function GoogleCloudKmsWriteKeyRequestToJSONTyped(
  value?: GoogleCloudKmsWriteKeyRequest | null,
