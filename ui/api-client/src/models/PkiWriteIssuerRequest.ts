...
export function PkiWriteIssuerRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PkiWriteIssuerRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiWriteIssuerRequestToJSONTyped(value?: PkiWriteIssuerRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
