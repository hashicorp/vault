...
export function PkiConfigureAutoTidyResponseFromJSONTyped(
  json: any,
...
export function PkiConfigureAutoTidyResponseToJSONTyped(
  value?: PkiConfigureAutoTidyResponse | null,
