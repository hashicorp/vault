 ...
 */
export function instanceOfPkiIssuersGenerateIntermediateRequest(
  value: object
): value is PkiIssuersGenerateIntermediateRequest {
  return true;
}

export function PkiIssuersGenerateIntermediateRequestFromJSON(
  json: any
): PkiIssuersGenerateIntermediateRequest {
  return PkiIssuersGenerateIntermediateRequestFromJSONTyped(json, false);
}

export function PkiIssuersGenerateIntermediateRequestFromJSONTyped(
  json: any,
...
export function PkiIssuersGenerateIntermediateRequestToJSON(
  json: any
): PkiIssuersGenerateIntermediateRequest {
  return PkiIssuersGenerateIntermediateRequestToJSONTyped(json, false);
}

export function PkiIssuersGenerateIntermediateRequestToJSONTyped(
  value?: PkiIssuersGenerateIntermediateRequest | null,
