...
* @enum {string}
*/
export enum PkiIssuersGenerateIntermediateRequestFormatEnum {
    PEM = 'pem',
    DER = 'der',
...
* @enum {string}
*/
export enum PkiIssuersGenerateIntermediateRequestKeyTypeEnum {
    RSA = 'rsa',
    EC = 'ec',
    ED25519 = 'ed25519'
}
...
* @enum {string}
*/
export enum PkiIssuersGenerateIntermediateRequestPrivateKeyFormatEnum {
    EMPTY = '',
    DER = 'der',
    PEM = 'pem',
    PKCS8 = 'pkcs8'
