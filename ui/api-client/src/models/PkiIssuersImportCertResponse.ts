...
export function PkiIssuersImportCertResponseFromJSONTyped(
  json: any,
...
export function PkiIssuersImportCertResponseToJSONTyped(
  value?: PkiIssuersImportCertResponse | null,
