 ...
 */
export function instanceOfPkiWriteIssuerIssuerRefExternalPolicyIssueRequest(
  value: object
): value is PkiWriteIssuerIssuerRefExternalPolicyIssueRequest {
  return true;
}

export function PkiWriteIssuerIssuerRefExternalPolicyIssueRequestFromJSON(
  json: any
...
export function PkiWriteIssuerIssuerRefExternalPolicyIssueRequestFromJSONTyped(
  json: any,
...
export function PkiWriteIssuerIssuerRefExternalPolicyIssueRequestToJSON(
  json: any
): PkiWriteIssuerIssuerRefExternalPolicyIssueRequest {
  return PkiWriteIssuerIssuerRefExternalPolicyIssueRequestToJSONTyped(json, false);
}

export function PkiWriteIssuerIssuerRefExternalPolicyIssueRequestToJSONTyped(
  value?: PkiWriteIssuerIssuerRefExternalPolicyIssueRequest | null,
