...
export function PkiConfigureAcmeRequestFromJSONTyped(
  json: any,
  ...
  return {
    allowRoleExtKeyUsage:
      json['allow_role_ext_key_usage'] == null ? undefined : json['allow_role_ext_key_usage'],
    ...
    defaultDirectoryPolicy:
      json['default_directory_policy'] == null ? undefined : json['default_directory_policy'],
...
export function PkiConfigureAcmeRequestToJSONTyped(
  value?: PkiConfigureAcmeRequest | null,
