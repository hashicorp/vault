 ...
 */
export function instanceOfRabbitMqConfigureConnectionRequest(
  value: object
): value is RabbitMqConfigureConnectionRequest {
  return true;
}
...
export function RabbitMqConfigureConnectionRequestFromJSONTyped(
  json: any,
...
export function RabbitMqConfigureConnectionRequestToJSONTyped(
  value?: RabbitMqConfigureConnectionRequest | null,
