 ...
 */
export function instanceOfSystemWriteMfaMethodTotpNameAdminDestroyRequest(
  value: object
): value is SystemWriteMfaMethodTotpNameAdminDestroyRequest {
  return true;
}

export function SystemWriteMfaMethodTotpNameAdminDestroyRequestFromJSON(
  json: any
...
export function SystemWriteMfaMethodTotpNameAdminDestroyRequestFromJSONTyped(
  json: any,
...
export function SystemWriteMfaMethodTotpNameAdminDestroyRequestToJSON(
  json: any
): SystemWriteMfaMethodTotpNameAdminDestroyRequest {
  return SystemWriteMfaMethodTotpNameAdminDestroyRequestToJSONTyped(json, false);
}

export function SystemWriteMfaMethodTotpNameAdminDestroyRequestToJSONTyped(
  value?: SystemWriteMfaMethodTotpNameAdminDestroyRequest | null,
