 ...
 */
export function instanceOfRekeyVerificationUpdateResponse(
  value: object
): value is RekeyVerificationUpdateResponse {
  return true;
}
...
export function RekeyVerificationUpdateResponseFromJSONTyped(
  json: any,
...
export function RekeyVerificationUpdateResponseToJSONTyped(
  value?: RekeyVerificationUpdateResponse | null,
