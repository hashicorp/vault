 ...
 */
export function instanceOfPkiWriteExternalPolicyIssuePolicyRequest(
  value: object
): value is PkiWriteExternalPolicyIssuePolicyRequest {
  return true;
}

export function PkiWriteExternalPolicyIssuePolicyRequestFromJSON(
  json: any
): PkiWriteExternalPolicyIssuePolicyRequest {
  return PkiWriteExternalPolicyIssuePolicyRequestFromJSONTyped(json, false);
}

export function PkiWriteExternalPolicyIssuePolicyRequestFromJSONTyped(
  json: any,
...
export function PkiWriteExternalPolicyIssuePolicyRequestToJSON(
  json: any
): PkiWriteExternalPolicyIssuePolicyRequest {
  return PkiWriteExternalPolicyIssuePolicyRequestToJSONTyped(json, false);
}

export function PkiWriteExternalPolicyIssuePolicyRequestToJSONTyped(
  value?: PkiWriteExternalPolicyIssuePolicyRequest | null,
