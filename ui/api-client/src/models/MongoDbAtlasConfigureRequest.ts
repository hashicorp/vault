...
export function MongoDbAtlasConfigureRequestFromJSONTyped(
  json: any,
...
export function MongoDbAtlasConfigureRequestToJSONTyped(
  value?: MongoDbAtlasConfigureRequest | null,
