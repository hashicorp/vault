 ...
 */
export function instanceOfSystemListSyncAssociationsResponse(
  value: object
): value is SystemListSyncAssociationsResponse {
  return true;
}
...
export function SystemListSyncAssociationsResponseFromJSONTyped(
  json: any,
...
export function SystemListSyncAssociationsResponseToJSONTyped(
  value?: SystemListSyncAssociationsResponse | null,
