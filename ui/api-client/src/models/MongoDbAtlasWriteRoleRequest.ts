...
export function MongoDbAtlasWriteRoleRequestFromJSONTyped(
  json: any,
...
export function MongoDbAtlasWriteRoleRequestToJSONTyped(
  value?: MongoDbAtlasWriteRoleRequest | null,
