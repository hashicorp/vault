 ...
 */
export function instanceOfGoogleCloudKmsReencryptRequest(
  value: object
): value is GoogleCloudKmsReencryptRequest {
  return true;
}
...
export function GoogleCloudKmsReencryptRequestFromJSONTyped(
  json: any,
...
export function GoogleCloudKmsReencryptRequestToJSONTyped(
  value?: GoogleCloudKmsReencryptRequest | null,
