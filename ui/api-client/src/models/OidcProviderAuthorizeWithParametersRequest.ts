 ...
 */
export function instanceOfOidcProviderAuthorizeWithParametersRequest(
  value: object
): value is OidcProviderAuthorizeWithParametersRequest {
...
export function OidcProviderAuthorizeWithParametersRequestFromJSON(
  json: any
): OidcProviderAuthorizeWithParametersRequest {
  return OidcProviderAuthorizeWithParametersRequestFromJSONTyped(json, false);
}

export function OidcProviderAuthorizeWithParametersRequestFromJSONTyped(
  json: any,
...
export function OidcProviderAuthorizeWithParametersRequestToJSON(
  json: any
): OidcProviderAuthorizeWithParametersRequest {
  return OidcProviderAuthorizeWithParametersRequestToJSONTyped(json, false);
}

export function OidcProviderAuthorizeWithParametersRequestToJSONTyped(
  value?: OidcProviderAuthorizeWithParametersRequest | null,
