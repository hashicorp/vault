 ...
 */
export function instanceOfPkiWriteRolesRoleAcmeAccountKidRequest(
  value: object
): value is PkiWriteRolesRoleAcmeAccountKidRequest {
  return true;
}

export function PkiWriteRolesRoleAcmeAccountKidRequestFromJSON(
  json: any
): PkiWriteRolesRoleAcmeAccountKidRequest {
  return PkiWriteRolesRoleAcmeAccountKidRequestFromJSONTyped(json, false);
}

export function PkiWriteRolesRoleAcmeAccountKidRequestFromJSONTyped(
  json: any,
...
export function PkiWriteRolesRoleAcmeAccountKidRequestToJSON(
  json: any
): PkiWriteRolesRoleAcmeAccountKidRequest {
  return PkiWriteRolesRoleAcmeAccountKidRequestToJSONTyped(json, false);
}

export function PkiWriteRolesRoleAcmeAccountKidRequestToJSONTyped(
  value?: PkiWriteRolesRoleAcmeAccountKidRequest | null,
