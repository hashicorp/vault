 ...
 */
export function instanceOfSystemWriteReplicationDrSecondaryUpdatePrimaryRequest(
  value: object
): value is SystemWriteReplicationDrSecondaryUpdatePrimaryRequest {
  return true;
}

export function SystemWriteReplicationDrSecondaryUpdatePrimaryRequestFromJSON(
  json: any
...
export function SystemWriteReplicationDrSecondaryUpdatePrimaryRequestFromJSONTyped(
  json: any,
...
export function SystemWriteReplicationDrSecondaryUpdatePrimaryRequestToJSON(
  json: any
): SystemWriteReplicationDrSecondaryUpdatePrimaryRequest {
  return SystemWriteReplicationDrSecondaryUpdatePrimaryRequestToJSONTyped(json, false);
}

export function SystemWriteReplicationDrSecondaryUpdatePrimaryRequestToJSONTyped(
  value?: SystemWriteReplicationDrSecondaryUpdatePrimaryRequest | null,
