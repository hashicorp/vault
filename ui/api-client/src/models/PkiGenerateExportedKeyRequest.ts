 ...
 */
export function instanceOfPkiGenerateExportedKeyRequest(
  value: object
): value is PkiGenerateExportedKeyRequest {
  return true;
}
...
export function PkiGenerateExportedKeyRequestFromJSONTyped(
  json: any,
...
export function PkiGenerateExportedKeyRequestToJSONTyped(
  value?: PkiGenerateExportedKeyRequest | null,
