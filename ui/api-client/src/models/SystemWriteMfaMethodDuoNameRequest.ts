 ...
 */
export function instanceOfSystemWriteMfaMethodDuoNameRequest(
  value: object
): value is SystemWriteMfaMethodDuoNameRequest {
  return true;
}
...
export function SystemWriteMfaMethodDuoNameRequestFromJSONTyped(
  json: any,
...
export function SystemWriteMfaMethodDuoNameRequestToJSONTyped(
  value?: SystemWriteMfaMethodDuoNameRequest | null,
