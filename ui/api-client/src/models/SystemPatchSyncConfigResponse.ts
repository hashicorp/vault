 ...
 */
export function instanceOfSystemPatchSyncConfigResponse(
  value: object
): value is SystemPatchSyncConfigResponse {
  return true;
}
...
export function SystemPatchSyncConfigResponseFromJSONTyped(
  json: any,
...
export function SystemPatchSyncConfigResponseToJSONTyped(
  value?: SystemPatchSyncConfigResponse | null,
