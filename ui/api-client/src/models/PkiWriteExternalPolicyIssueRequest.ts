 ...
 */
export function instanceOfPkiWriteExternalPolicyIssueRequest(
  value: object
): value is PkiWriteExternalPolicyIssueRequest {
  return true;
}
...
export function PkiWriteExternalPolicyIssueRequestFromJSONTyped(
  json: any,
...
export function PkiWriteExternalPolicyIssueRequestToJSONTyped(
  value?: PkiWriteExternalPolicyIssueRequest | null,
