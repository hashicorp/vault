 ...
 */
export function instanceOfGoogleCloudKmsConfigureKeyRequest(
  value: object
): value is GoogleCloudKmsConfigureKeyRequest {
  return true;
}
...
export function GoogleCloudKmsConfigureKeyRequestFromJSONTyped(
  json: any,
...
export function GoogleCloudKmsConfigureKeyRequestToJSONTyped(
  value?: GoogleCloudKmsConfigureKeyRequest | null,
