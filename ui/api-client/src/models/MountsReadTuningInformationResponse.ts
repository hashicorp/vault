 ...
 */
export function instanceOfMountsReadTuningInformationResponse(
  value: object
): value is MountsReadTuningInformationResponse {
  return true;
}
...
export function MountsReadTuningInformationResponseFromJSONTyped(
  json: any,
...
export function MountsReadTuningInformationResponseToJSONTyped(
  value?: MountsReadTuningInformationResponse | null,
