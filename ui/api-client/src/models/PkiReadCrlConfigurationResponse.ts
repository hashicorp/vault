 ...
 */
export function instanceOfPkiReadCrlConfigurationResponse(
  value: object
): value is PkiReadCrlConfigurationResponse {
  return true;
}
...
export function PkiReadCrlConfigurationResponseFromJSONTyped(
  json: any,
...
export function PkiReadCrlConfigurationResponseToJSONTyped(
  value?: PkiReadCrlConfigurationResponse | null,
