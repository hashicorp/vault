 ...
 */
export function instanceOfRateLimitQuotasReadConfigurationResponse(
  value: object
): value is RateLimitQuotasReadConfigurationResponse {
  return true;
}

export function RateLimitQuotasReadConfigurationResponseFromJSON(
  json: any
): RateLimitQuotasReadConfigurationResponse {
  return RateLimitQuotasReadConfigurationResponseFromJSONTyped(json, false);
}

export function RateLimitQuotasReadConfigurationResponseFromJSONTyped(
  json: any,
  ...
  return {
    absoluteRateLimitExemptPaths:
      json['absolute_rate_limit_exempt_paths'] == null ? undefined : json['absolute_rate_limit_exempt_paths'],
    enableRateLimitAuditLogging:
      json['enable_rate_limit_audit_logging'] == null ? undefined : json['enable_rate_limit_audit_logging'],
    enableRateLimitResponseHeaders:
      json['enable_rate_limit_response_headers'] == null
        ? undefined
        : json['enable_rate_limit_response_headers'],
    rateLimitExemptPaths:
      json['rate_limit_exempt_paths'] == null ? undefined : json['rate_limit_exempt_paths'],
  };
}
...
export function RateLimitQuotasReadConfigurationResponseToJSONTyped(
  value?: RateLimitQuotasReadConfigurationResponse | null,
