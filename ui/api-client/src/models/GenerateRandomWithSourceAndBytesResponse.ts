 ...
 */
export function instanceOfGenerateRandomWithSourceAndBytesResponse(
  value: object
): value is GenerateRandomWithSourceAndBytesResponse {
  return true;
}

export function GenerateRandomWithSourceAndBytesResponseFromJSON(
  json: any
): GenerateRandomWithSourceAndBytesResponse {
  return GenerateRandomWithSourceAndBytesResponseFromJSONTyped(json, false);
}

export function GenerateRandomWithSourceAndBytesResponseFromJSONTyped(
  json: any,
...
export function GenerateRandomWithSourceAndBytesResponseToJSON(
  json: any
): GenerateRandomWithSourceAndBytesResponse {
  return GenerateRandomWithSourceAndBytesResponseToJSONTyped(json, false);
}

export function GenerateRandomWithSourceAndBytesResponseToJSONTyped(
  value?: GenerateRandomWithSourceAndBytesResponse | null,
