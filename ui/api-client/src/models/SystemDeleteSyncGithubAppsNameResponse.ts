 ...
 */
export function instanceOfSystemDeleteSyncGithubAppsNameResponse(
  value: object
): value is SystemDeleteSyncGithubAppsNameResponse {
  return true;
}

export function SystemDeleteSyncGithubAppsNameResponseFromJSON(
  json: any
): SystemDeleteSyncGithubAppsNameResponse {
  return SystemDeleteSyncGithubAppsNameResponseFromJSONTyped(json, false);
}

export function SystemDeleteSyncGithubAppsNameResponseFromJSONTyped(
  json: any,
...
export function SystemDeleteSyncGithubAppsNameResponseToJSON(
  json: any
): SystemDeleteSyncGithubAppsNameResponse {
  return SystemDeleteSyncGithubAppsNameResponseToJSONTyped(json, false);
}

export function SystemDeleteSyncGithubAppsNameResponseToJSONTyped(
  value?: SystemDeleteSyncGithubAppsNameResponse | null,
