 ...
 */
export function instanceOfSystemWritePoliciesRgpNameRequest(
  value: object
): value is SystemWritePoliciesRgpNameRequest {
  return true;
}
...
export function SystemWritePoliciesRgpNameRequestFromJSONTyped(
  json: any,
...
export function SystemWritePoliciesRgpNameRequestToJSONTyped(
  value?: SystemWritePoliciesRgpNameRequest | null,
