 ...
 */
export function instanceOfSystemPatchSyncDestinationsInMemNameResponse(
  value: object
): value is SystemPatchSyncDestinationsInMemNameResponse {
  return true;
}

export function SystemPatchSyncDestinationsInMemNameResponseFromJSON(
  json: any
): SystemPatchSyncDestinationsInMemNameResponse {
  return SystemPatchSyncDestinationsInMemNameResponseFromJSONTyped(json, false);
}

export function SystemPatchSyncDestinationsInMemNameResponseFromJSONTyped(
  json: any,
...
export function SystemPatchSyncDestinationsInMemNameResponseToJSON(
  json: any
): SystemPatchSyncDestinationsInMemNameResponse {
  return SystemPatchSyncDestinationsInMemNameResponseToJSONTyped(json, false);
}

export function SystemPatchSyncDestinationsInMemNameResponseToJSONTyped(
  value?: SystemPatchSyncDestinationsInMemNameResponse | null,
