 ...
 */
export function instanceOfPluginsCatalogReadPluginConfigurationResponse(
  value: object
): value is PluginsCatalogReadPluginConfigurationResponse {
  return true;
}

export function PluginsCatalogReadPluginConfigurationResponseFromJSON(
  json: any
...
export function PluginsCatalogReadPluginConfigurationResponseFromJSONTyped(
  json: any,
...
export function PluginsCatalogReadPluginConfigurationResponseToJSON(
  json: any
): PluginsCatalogReadPluginConfigurationResponse {
  return PluginsCatalogReadPluginConfigurationResponseToJSONTyped(json, false);
}

export function PluginsCatalogReadPluginConfigurationResponseToJSONTyped(
  value?: PluginsCatalogReadPluginConfigurationResponse | null,
