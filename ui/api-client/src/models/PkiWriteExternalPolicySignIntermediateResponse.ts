 ...
 */
export function instanceOfPkiWriteExternalPolicySignIntermediateResponse(
  value: object
): value is PkiWriteExternalPolicySignIntermediateResponse {
  return true;
}

export function PkiWriteExternalPolicySignIntermediateResponseFromJSON(
  json: any
...
export function PkiWriteExternalPolicySignIntermediateResponseFromJSONTyped(
  json: any,
...
export function PkiWriteExternalPolicySignIntermediateResponseToJSON(
  json: any
): PkiWriteExternalPolicySignIntermediateResponse {
  return PkiWriteExternalPolicySignIntermediateResponseToJSONTyped(json, false);
}

export function PkiWriteExternalPolicySignIntermediateResponseToJSONTyped(
