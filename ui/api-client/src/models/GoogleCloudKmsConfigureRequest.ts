 ...
 */
export function instanceOfGoogleCloudKmsConfigureRequest(
  value: object
): value is GoogleCloudKmsConfigureRequest {
  return true;
}
...
export function GoogleCloudKmsConfigureRequestFromJSONTyped(
  json: any,
...
export function GoogleCloudKmsConfigureRequestToJSONTyped(
  value?: GoogleCloudKmsConfigureRequest | null,
