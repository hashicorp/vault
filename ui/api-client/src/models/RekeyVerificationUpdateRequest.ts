 ...
 */
export function instanceOfRekeyVerificationUpdateRequest(
  value: object
): value is RekeyVerificationUpdateRequest {
  return true;
}
...
export function RekeyVerificationUpdateRequestFromJSONTyped(
  json: any,
...
export function RekeyVerificationUpdateRequestToJSONTyped(
  value?: RekeyVerificationUpdateRequest | null,
