 ...
 */
export function instanceOfPkiWriteExternalPolicyPolicyAcmeAccountKidRequest(
  value: object
): value is PkiWriteExternalPolicyPolicyAcmeAccountKidRequest {
  return true;
}

export function PkiWriteExternalPolicyPolicyAcmeAccountKidRequestFromJSON(
  json: any
...
export function PkiWriteExternalPolicyPolicyAcmeAccountKidRequestFromJSONTyped(
  json: any,
...
export function PkiWriteExternalPolicyPolicyAcmeAccountKidRequestToJSON(
  json: any
): PkiWriteExternalPolicyPolicyAcmeAccountKidRequest {
  return PkiWriteExternalPolicyPolicyAcmeAccountKidRequestToJSONTyped(json, false);
}

export function PkiWriteExternalPolicyPolicyAcmeAccountKidRequestToJSONTyped(
  value?: PkiWriteExternalPolicyPolicyAcmeAccountKidRequest | null,
