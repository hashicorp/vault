 ...
 */
export function instanceOfSystemWriteReplicationSecondaryUpdatePrimaryRequest(
  value: object
): value is SystemWriteReplicationSecondaryUpdatePrimaryRequest {
  return true;
}

export function SystemWriteReplicationSecondaryUpdatePrimaryRequestFromJSON(
  json: any
...
export function SystemWriteReplicationSecondaryUpdatePrimaryRequestFromJSONTyped(
  json: any,
...
export function SystemWriteReplicationSecondaryUpdatePrimaryRequestToJSON(
  json: any
): SystemWriteReplicationSecondaryUpdatePrimaryRequest {
  return SystemWriteReplicationSecondaryUpdatePrimaryRequestToJSONTyped(json, false);
}

export function SystemWriteReplicationSecondaryUpdatePrimaryRequestToJSONTyped(
  value?: SystemWriteReplicationSecondaryUpdatePrimaryRequest | null,
