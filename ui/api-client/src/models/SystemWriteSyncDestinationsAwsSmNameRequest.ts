 ...
 */
export function instanceOfSystemWriteSyncDestinationsAwsSmNameRequest(
  value: object
): value is SystemWriteSyncDestinationsAwsSmNameRequest {
  return true;
}

export function SystemWriteSyncDestinationsAwsSmNameRequestFromJSON(
  json: any
): SystemWriteSyncDestinationsAwsSmNameRequest {
  return SystemWriteSyncDestinationsAwsSmNameRequestFromJSONTyped(json, false);
}

export function SystemWriteSyncDestinationsAwsSmNameRequestFromJSONTyped(
  json: any,
...
export function SystemWriteSyncDestinationsAwsSmNameRequestToJSON(
  json: any
): SystemWriteSyncDestinationsAwsSmNameRequest {
  return SystemWriteSyncDestinationsAwsSmNameRequestToJSONTyped(json, false);
}

export function SystemWriteSyncDestinationsAwsSmNameRequestToJSONTyped(
  value?: SystemWriteSyncDestinationsAwsSmNameRequest | null,
