 ...
 */
export function instanceOfSystemPatchSyncDestinationsGcpSmNameResponse(
  value: object
): value is SystemPatchSyncDestinationsGcpSmNameResponse {
  return true;
}

export function SystemPatchSyncDestinationsGcpSmNameResponseFromJSON(
  json: any
): SystemPatchSyncDestinationsGcpSmNameResponse {
  return SystemPatchSyncDestinationsGcpSmNameResponseFromJSONTyped(json, false);
}

export function SystemPatchSyncDestinationsGcpSmNameResponseFromJSONTyped(
  json: any,
...
export function SystemPatchSyncDestinationsGcpSmNameResponseToJSON(
  json: any
): SystemPatchSyncDestinationsGcpSmNameResponse {
  return SystemPatchSyncDestinationsGcpSmNameResponseToJSONTyped(json, false);
}

export function SystemPatchSyncDestinationsGcpSmNameResponseToJSONTyped(
  value?: SystemPatchSyncDestinationsGcpSmNameResponse | null,
