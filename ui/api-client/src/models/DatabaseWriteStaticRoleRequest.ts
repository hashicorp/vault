...
export function instanceOfDatabaseWriteStaticRoleRequest(
  value: object
): value is DatabaseWriteStaticRoleRequest {
  return true;
}
...
export function DatabaseWriteStaticRoleRequestFromJSONTyped(
  json: any,
...
export function DatabaseWriteStaticRoleRequestToJSONTyped(
  value?: DatabaseWriteStaticRoleRequest | null,
