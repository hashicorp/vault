 ...
 */
export function instanceOfKubernetesGenerateCredentialsRequest(
  value: object
): value is KubernetesGenerateCredentialsRequest {
  if (!('kubernetesNamespace' in value) || value['kubernetesNamespace'] === undefined) return false;
  return true;
}

export function KubernetesGenerateCredentialsRequestFromJSON(
  json: any
): KubernetesGenerateCredentialsRequest {
  return KubernetesGenerateCredentialsRequestFromJSONTyped(json, false);
}

export function KubernetesGenerateCredentialsRequestFromJSONTyped(
  json: any,
...
export function KubernetesGenerateCredentialsRequestToJSONTyped(
  value?: KubernetesGenerateCredentialsRequest | null,
