 ...
 */
export function instanceOfPkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeNewOrderRequest(
  value: object
): value is PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeNewOrderRequest {
  return true;
}

export function PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeNewOrderRequestFromJSON(
  json: any
...
export function PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeNewOrderRequestFromJSONTyped(
  json: any,
...
export function PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeNewOrderRequestToJSON(
  json: any
): PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeNewOrderRequest {
  return PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeNewOrderRequestToJSONTyped(json, false);
}

export function PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeNewOrderRequestToJSONTyped(
  value?: PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeNewOrderRequest | null,
