 ...
 */
export function instanceOfInternalUiReadResultantAclResponse(
  value: object
): value is InternalUiReadResultantAclResponse {
  return true;
}
...
export function InternalUiReadResultantAclResponseFromJSONTyped(
  json: any,
...
export function InternalUiReadResultantAclResponseToJSONTyped(
  value?: InternalUiReadResultantAclResponse | null,
