 ...
 */
export function instanceOfSystemWriteReplicationDrSecondaryPromoteRequest(
  value: object
): value is SystemWriteReplicationDrSecondaryPromoteRequest {
  return true;
}

export function SystemWriteReplicationDrSecondaryPromoteRequestFromJSON(
  json: any
...
export function SystemWriteReplicationDrSecondaryPromoteRequestFromJSONTyped(
  json: any,
...
export function SystemWriteReplicationDrSecondaryPromoteRequestToJSON(
  json: any
): SystemWriteReplicationDrSecondaryPromoteRequest {
  return SystemWriteReplicationDrSecondaryPromoteRequestToJSONTyped(json, false);
}

export function SystemWriteReplicationDrSecondaryPromoteRequestToJSONTyped(
  value?: SystemWriteReplicationDrSecondaryPromoteRequest | null,
