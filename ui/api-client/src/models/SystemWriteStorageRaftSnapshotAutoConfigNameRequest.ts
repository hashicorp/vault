 ...
 */
export function instanceOfSystemWriteStorageRaftSnapshotAutoConfigNameRequest(
  value: object
): value is SystemWriteStorageRaftSnapshotAutoConfigNameRequest {
  return true;
}

export function SystemWriteStorageRaftSnapshotAutoConfigNameRequestFromJSON(
  json: any
...
export function SystemWriteStorageRaftSnapshotAutoConfigNameRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    awsS3ForcePathStyle:
      json['aws_s3_force_path_style'] == null ? undefined : json['aws_s3_force_path_style'],
    ...
    awsS3ServerSideEncryption:
      json['aws_s3_server_side_encryption'] == null ? undefined : json['aws_s3_server_side_encryption'],
    ...
    googleServiceAccountKey:
      json['google_service_account_key'] == null ? undefined : json['google_service_account_key'],
...
export function SystemWriteStorageRaftSnapshotAutoConfigNameRequestToJSON(
  json: any
): SystemWriteStorageRaftSnapshotAutoConfigNameRequest {
  return SystemWriteStorageRaftSnapshotAutoConfigNameRequestToJSONTyped(json, false);
}

export function SystemWriteStorageRaftSnapshotAutoConfigNameRequestToJSONTyped(
  value?: SystemWriteStorageRaftSnapshotAutoConfigNameRequest | null,
