 ...
 */
export function instanceOfPkiIssuersGenerateRootResponse(
  value: object
): value is PkiIssuersGenerateRootResponse {
  return true;
}
...
export function PkiIssuersGenerateRootResponseFromJSONTyped(
  json: any,
...
export function PkiIssuersGenerateRootResponseToJSONTyped(
  value?: PkiIssuersGenerateRootResponse | null,
