 ...
 */
export function instanceOfSystemWriteMfaMethodOktaNameRequest(
  value: object
): value is SystemWriteMfaMethodOktaNameRequest {
  return true;
}
...
export function SystemWriteMfaMethodOktaNameRequestFromJSONTyped(
  json: any,
...
export function SystemWriteMfaMethodOktaNameRequestToJSONTyped(
