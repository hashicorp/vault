 ...
 */
export function instanceOfPkiWriteIssuerIssuerRefExternalPolicyAcmeAuthorizationAuthIdRequest(
  value: object
): value is PkiWriteIssuerIssuerRefExternalPolicyAcmeAuthorizationAuthIdRequest {
  return true;
}

export function PkiWriteIssuerIssuerRefExternalPolicyAcmeAuthorizationAuthIdRequestFromJSON(
  json: any
...
export function PkiWriteIssuerIssuerRefExternalPolicyAcmeAuthorizationAuthIdRequestFromJSONTyped(
  json: any,
...
export function PkiWriteIssuerIssuerRefExternalPolicyAcmeAuthorizationAuthIdRequestToJSON(
  json: any
): PkiWriteIssuerIssuerRefExternalPolicyAcmeAuthorizationAuthIdRequest {
  return PkiWriteIssuerIssuerRefExternalPolicyAcmeAuthorizationAuthIdRequestToJSONTyped(json, false);
}

export function PkiWriteIssuerIssuerRefExternalPolicyAcmeAuthorizationAuthIdRequestToJSONTyped(
  value?: PkiWriteIssuerIssuerRefExternalPolicyAcmeAuthorizationAuthIdRequest | null,
