...
export function TokenWriteRoleRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    disallowedPoliciesGlob:
      json['disallowed_policies_glob'] == null ? undefined : json['disallowed_policies_glob'],
...
export function TokenWriteRoleRequestToJSONTyped(
  value?: TokenWriteRoleRequest | null,
