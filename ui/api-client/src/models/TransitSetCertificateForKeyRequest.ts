 ...
 */
export function instanceOfTransitSetCertificateForKeyRequest(
  value: object
): value is TransitSetCertificateForKeyRequest {
...
export function TransitSetCertificateForKeyRequestFromJSONTyped(
  json: any,
...
export function TransitSetCertificateForKeyRequestToJSONTyped(
  value?: TransitSetCertificateForKeyRequest | null,
