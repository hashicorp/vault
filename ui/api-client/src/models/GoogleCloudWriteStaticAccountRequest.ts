 ...
 */
export function instanceOfGoogleCloudWriteStaticAccountRequest(
  value: object
): value is GoogleCloudWriteStaticAccountRequest {
  return true;
}

export function GoogleCloudWriteStaticAccountRequestFromJSON(
  json: any
): GoogleCloudWriteStaticAccountRequest {
  return GoogleCloudWriteStaticAccountRequestFromJSONTyped(json, false);
}

export function GoogleCloudWriteStaticAccountRequestFromJSONTyped(
  json: any,
...
export function GoogleCloudWriteStaticAccountRequestToJSONTyped(
  value?: GoogleCloudWriteStaticAccountRequest | null,
