...
export function CloudFoundryConfigureRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    cfApiMutualTlsCertificate:
      json['cf_api_mutual_tls_certificate'] == null ? undefined : json['cf_api_mutual_tls_certificate'],
    cfApiMutualTlsKey: json['cf_api_mutual_tls_key'] == null ? undefined : json['cf_api_mutual_tls_key'],
    cfApiTrustedCertificates:
      json['cf_api_trusted_certificates'] == null ? undefined : json['cf_api_trusted_certificates'],
    ...
    identityCaCertificates:
      json['identity_ca_certificates'] == null ? undefined : json['identity_ca_certificates'],
    loginMaxSecondsNotAfter:
      json['login_max_seconds_not_after'] == null ? undefined : json['login_max_seconds_not_after'],
    loginMaxSecondsNotBefore:
      json['login_max_seconds_not_before'] == null ? undefined : json['login_max_seconds_not_before'],
    pcfApiAddr: json['pcf_api_addr'] == null ? undefined : json['pcf_api_addr'],
    pcfApiTrustedCertificates:
      json['pcf_api_trusted_certificates'] == null ? undefined : json['pcf_api_trusted_certificates'],
...
export function CloudFoundryConfigureRequestToJSONTyped(
  value?: CloudFoundryConfigureRequest | null,
