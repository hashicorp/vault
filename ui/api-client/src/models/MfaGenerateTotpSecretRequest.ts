...
export function MfaGenerateTotpSecretRequestFromJSONTyped(
  json: any,
...
export function MfaGenerateTotpSecretRequestToJSONTyped(
  value?: MfaGenerateTotpSecretRequest | null,
