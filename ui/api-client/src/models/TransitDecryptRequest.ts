...
export function TransitDecryptRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    partialFailureResponseCode:
      json['partial_failure_response_code'] == null ? undefined : json['partial_failure_response_code'],
  };
}
...
export function TransitDecryptRequestToJSONTyped(
  value?: TransitDecryptRequest | null,
