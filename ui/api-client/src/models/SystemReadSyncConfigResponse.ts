...
export function SystemReadSyncConfigResponseFromJSONTyped(
  json: any,
...
export function SystemReadSyncConfigResponseToJSONTyped(
  value?: SystemReadSyncConfigResponse | null,
