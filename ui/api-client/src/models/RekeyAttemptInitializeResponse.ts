 ...
 */
export function instanceOfRekeyAttemptInitializeResponse(
  value: object
): value is RekeyAttemptInitializeResponse {
  return true;
}
...
export function RekeyAttemptInitializeResponseFromJSONTyped(
  json: any,
...
export function RekeyAttemptInitializeResponseToJSONTyped(
  value?: RekeyAttemptInitializeResponse | null,
