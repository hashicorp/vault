...
export function EntityMergeRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityMergeRequest {
  ...
  return {
    conflictingAliasIdsToKeep:
      json['conflicting_alias_ids_to_keep'] == null ? undefined : json['conflicting_alias_ids_to_keep'],
...
export function EntityMergeRequestToJSONTyped(
  value?: EntityMergeRequest | null,
