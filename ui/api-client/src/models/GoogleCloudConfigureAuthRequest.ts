 ...
 */
export function instanceOfGoogleCloudConfigureAuthRequest(
  value: object
): value is GoogleCloudConfigureAuthRequest {
  return true;
}
...
export function GoogleCloudConfigureAuthRequestFromJSONTyped(
  json: any,
...
export function GoogleCloudConfigureAuthRequestToJSONTyped(
  value?: GoogleCloudConfigureAuthRequest | null,
