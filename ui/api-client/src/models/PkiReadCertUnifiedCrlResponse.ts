 ...
 */
export function instanceOfPkiReadCertUnifiedCrlResponse(
  value: object
): value is PkiReadCertUnifiedCrlResponse {
  return true;
}
...
export function PkiReadCertUnifiedCrlResponseFromJSONTyped(
  json: any,
...
export function PkiReadCertUnifiedCrlResponseToJSONTyped(
  value?: PkiReadCertUnifiedCrlResponse | null,
