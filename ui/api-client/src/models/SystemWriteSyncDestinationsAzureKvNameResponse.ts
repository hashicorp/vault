 ...
 */
export function instanceOfSystemWriteSyncDestinationsAzureKvNameResponse(
  value: object
): value is SystemWriteSyncDestinationsAzureKvNameResponse {
  return true;
}

export function SystemWriteSyncDestinationsAzureKvNameResponseFromJSON(
  json: any
...
export function SystemWriteSyncDestinationsAzureKvNameResponseFromJSONTyped(
  json: any,
...
export function SystemWriteSyncDestinationsAzureKvNameResponseToJSON(
  json: any
): SystemWriteSyncDestinationsAzureKvNameResponse {
  return SystemWriteSyncDestinationsAzureKvNameResponseToJSONTyped(json, false);
}

export function SystemWriteSyncDestinationsAzureKvNameResponseToJSONTyped(
  value?: SystemWriteSyncDestinationsAzureKvNameResponse | null,
