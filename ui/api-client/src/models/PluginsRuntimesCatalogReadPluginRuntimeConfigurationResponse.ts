 ...
 */
export function instanceOfPluginsRuntimesCatalogReadPluginRuntimeConfigurationResponse(
  value: object
): value is PluginsRuntimesCatalogReadPluginRuntimeConfigurationResponse {
  return true;
}

export function PluginsRuntimesCatalogReadPluginRuntimeConfigurationResponseFromJSON(
  json: any
...
export function PluginsRuntimesCatalogReadPluginRuntimeConfigurationResponseFromJSONTyped(
  json: any,
...
export function PluginsRuntimesCatalogReadPluginRuntimeConfigurationResponseToJSON(
  json: any
): PluginsRuntimesCatalogReadPluginRuntimeConfigurationResponse {
  return PluginsRuntimesCatalogReadPluginRuntimeConfigurationResponseToJSONTyped(json, false);
}

export function PluginsRuntimesCatalogReadPluginRuntimeConfigurationResponseToJSONTyped(
  value?: PluginsRuntimesCatalogReadPluginRuntimeConfigurationResponse | null,
