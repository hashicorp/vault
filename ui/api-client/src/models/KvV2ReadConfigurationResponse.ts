 ...
 */
export function instanceOfKvV2ReadConfigurationResponse(
  value: object
): value is KvV2ReadConfigurationResponse {
  return true;
}
...
export function KvV2ReadConfigurationResponseFromJSONTyped(
  json: any,
...
export function KvV2ReadConfigurationResponseToJSONTyped(
  value?: KvV2ReadConfigurationResponse | null,
