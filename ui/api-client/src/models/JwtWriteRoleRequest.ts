...
export function JwtWriteRoleRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    userClaimJsonPointer:
      json['user_claim_json_pointer'] == null ? undefined : json['user_claim_json_pointer'],
...
export function JwtWriteRoleRequestToJSONTyped(
  value?: JwtWriteRoleRequest | null,
