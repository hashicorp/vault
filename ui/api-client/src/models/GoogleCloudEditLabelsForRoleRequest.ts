 ...
 */
export function instanceOfGoogleCloudEditLabelsForRoleRequest(
  value: object
): value is GoogleCloudEditLabelsForRoleRequest {
  return true;
}
...
export function GoogleCloudEditLabelsForRoleRequestFromJSONTyped(
  json: any,
...
export function GoogleCloudEditLabelsForRoleRequestToJSONTyped(
  value?: GoogleCloudEditLabelsForRoleRequest | null,
