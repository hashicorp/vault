 ...
 */
export function instanceOfPkiWriteExternalPolicyPolicyAcmeOrderOrderIdFinalizeRequest(
  value: object
): value is PkiWriteExternalPolicyPolicyAcmeOrderOrderIdFinalizeRequest {
  return true;
}

export function PkiWriteExternalPolicyPolicyAcmeOrderOrderIdFinalizeRequestFromJSON(
  json: any
...
export function PkiWriteExternalPolicyPolicyAcmeOrderOrderIdFinalizeRequestFromJSONTyped(
  json: any,
...
export function PkiWriteExternalPolicyPolicyAcmeOrderOrderIdFinalizeRequestToJSON(
  json: any
): PkiWriteExternalPolicyPolicyAcmeOrderOrderIdFinalizeRequest {
  return PkiWriteExternalPolicyPolicyAcmeOrderOrderIdFinalizeRequestToJSONTyped(json, false);
}

export function PkiWriteExternalPolicyPolicyAcmeOrderOrderIdFinalizeRequestToJSONTyped(
  value?: PkiWriteExternalPolicyPolicyAcmeOrderOrderIdFinalizeRequest | null,
