 ...
 */
export function instanceOfPkiWriteRolesRoleAcmeRevokeCertRequest(
  value: object
): value is PkiWriteRolesRoleAcmeRevokeCertRequest {
  return true;
}

export function PkiWriteRolesRoleAcmeRevokeCertRequestFromJSON(
  json: any
): PkiWriteRolesRoleAcmeRevokeCertRequest {
  return PkiWriteRolesRoleAcmeRevokeCertRequestFromJSONTyped(json, false);
}

export function PkiWriteRolesRoleAcmeRevokeCertRequestFromJSONTyped(
  json: any,
...
export function PkiWriteRolesRoleAcmeRevokeCertRequestToJSON(
  json: any
): PkiWriteRolesRoleAcmeRevokeCertRequest {
  return PkiWriteRolesRoleAcmeRevokeCertRequestToJSONTyped(json, false);
}

export function PkiWriteRolesRoleAcmeRevokeCertRequestToJSONTyped(
  value?: PkiWriteRolesRoleAcmeRevokeCertRequest | null,
