...
export function instanceOfPkiIssuersImportBundleRequest(
  value: object
): value is PkiIssuersImportBundleRequest {
  return true;
}
...
export function PkiIssuersImportBundleRequestFromJSONTyped(
  json: any,
...
export function PkiIssuersImportBundleRequestToJSONTyped(
  value?: PkiIssuersImportBundleRequest | null,
