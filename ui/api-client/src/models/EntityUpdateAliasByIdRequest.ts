...
export function EntityUpdateAliasByIdRequestFromJSONTyped(
  json: any,
...
export function EntityUpdateAliasByIdRequestToJSONTyped(
  value?: EntityUpdateAliasByIdRequest | null,
