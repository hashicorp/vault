 ...
 */
export function instanceOfSystemWriteReplicationPerformancePrimarySecondaryTokenRequest(
  value: object
): value is SystemWriteReplicationPerformancePrimarySecondaryTokenRequest {
  return true;
}

export function SystemWriteReplicationPerformancePrimarySecondaryTokenRequestFromJSON(
  json: any
...
export function SystemWriteReplicationPerformancePrimarySecondaryTokenRequestFromJSONTyped(
  json: any,
...
export function SystemWriteReplicationPerformancePrimarySecondaryTokenRequestToJSON(
  json: any
): SystemWriteReplicationPerformancePrimarySecondaryTokenRequest {
  return SystemWriteReplicationPerformancePrimarySecondaryTokenRequestToJSONTyped(json, false);
}

export function SystemWriteReplicationPerformancePrimarySecondaryTokenRequestToJSONTyped(
  value?: SystemWriteReplicationPerformancePrimarySecondaryTokenRequest | null,
