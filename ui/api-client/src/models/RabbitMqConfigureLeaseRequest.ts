 ...
 */
export function instanceOfRabbitMqConfigureLeaseRequest(
  value: object
): value is RabbitMqConfigureLeaseRequest {
  return true;
}
...
export function RabbitMqConfigureLeaseRequestFromJSONTyped(
  json: any,
...
export function RabbitMqConfigureLeaseRequestToJSONTyped(
  value?: RabbitMqConfigureLeaseRequest | null,
