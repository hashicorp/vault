 ...
 */
export function instanceOfPkiGenerateExportedKeyResponse(
  value: object
): value is PkiGenerateExportedKeyResponse {
  return true;
}
...
export function PkiGenerateExportedKeyResponseFromJSONTyped(
  json: any,
...
export function PkiGenerateExportedKeyResponseToJSONTyped(
  value?: PkiGenerateExportedKeyResponse | null,
