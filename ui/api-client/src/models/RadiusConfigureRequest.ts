...
export function RadiusConfigureRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    unregisteredUserPolicies:
      json['unregistered_user_policies'] == null ? undefined : json['unregistered_user_policies'],
  };
}
...
export function RadiusConfigureRequestToJSONTyped(
  value?: RadiusConfigureRequest | null,
