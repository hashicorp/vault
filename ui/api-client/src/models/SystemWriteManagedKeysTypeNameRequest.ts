 ...
 */
export function instanceOfSystemWriteManagedKeysTypeNameRequest(
  value: object
): value is SystemWriteManagedKeysTypeNameRequest {
  return true;
}

export function SystemWriteManagedKeysTypeNameRequestFromJSON(
  json: any
): SystemWriteManagedKeysTypeNameRequest {
  return SystemWriteManagedKeysTypeNameRequestFromJSONTyped(json, false);
}

export function SystemWriteManagedKeysTypeNameRequestFromJSONTyped(
  json: any,
...
export function SystemWriteManagedKeysTypeNameRequestToJSON(
  json: any
): SystemWriteManagedKeysTypeNameRequest {
  return SystemWriteManagedKeysTypeNameRequestToJSONTyped(json, false);
}

export function SystemWriteManagedKeysTypeNameRequestToJSONTyped(
  value?: SystemWriteManagedKeysTypeNameRequest | null,
