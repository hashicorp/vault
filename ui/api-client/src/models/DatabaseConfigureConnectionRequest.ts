 ...
 */
export function instanceOfDatabaseConfigureConnectionRequest(
  value: object
): value is DatabaseConfigureConnectionRequest {
  return true;
}
...
export function DatabaseConfigureConnectionRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    rootRotationStatements:
      json['root_rotation_statements'] == null ? undefined : json['root_rotation_statements'],
    ...
    skipStaticRoleImportRotation:
      json['skip_static_role_import_rotation'] == null ? undefined : json['skip_static_role_import_rotation'],
...
export function DatabaseConfigureConnectionRequestToJSONTyped(
  value?: DatabaseConfigureConnectionRequest | null,
