...
export function PluginsReloadBackendsRequestFromJSONTyped(
  json: any,
...
export function PluginsReloadBackendsRequestToJSONTyped(
  value?: PluginsReloadBackendsRequest | null,
