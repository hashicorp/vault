...
export function GoogleCloudKmsEncryptRequestFromJSONTyped(
  json: any,
...
export function GoogleCloudKmsEncryptRequestToJSONTyped(
  value?: GoogleCloudKmsEncryptRequest | null,
