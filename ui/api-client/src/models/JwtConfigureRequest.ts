...
export function JwtConfigureRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    unsupportedCriticalCertExtensions:
      json['unsupported_critical_cert_extensions'] == null
        ? undefined
...
export function JwtConfigureRequestToJSONTyped(
  value?: JwtConfigureRequest | null,
