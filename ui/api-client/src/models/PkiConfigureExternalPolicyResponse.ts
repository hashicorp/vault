 ...
 */
export function instanceOfPkiConfigureExternalPolicyResponse(
  value: object
): value is PkiConfigureExternalPolicyResponse {
  return true;
}
...
export function PkiConfigureExternalPolicyResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    externalServiceLastUpdated:
      json['external_service_last_updated'] == null ? undefined : json['external_service_last_updated'],
    externalServiceUrl: json['external_service_url'] == null ? undefined : json['external_service_url'],
    externalServiceValidated:
      json['external_service_validated'] == null ? undefined : json['external_service_validated'],
    groupJmespath: json['group_jmespath'] == null ? undefined : json['group_jmespath'],
    lastSuccessfulRequest:
      json['last_successful_request'] == null ? undefined : json['last_successful_request'],
    timeout: json['timeout'] == null ? undefined : json['timeout'],
    trustedCa: json['trusted_ca'] == null ? undefined : json['trusted_ca'],
    trustedLeafCertificateBundle:
      json['trusted_leaf_certificate_bundle'] == null ? undefined : json['trusted_leaf_certificate_bundle'],
    vaultClientCertBundleNoKeys:
      json['vault_client_cert_bundle_no_keys'] == null ? undefined : json['vault_client_cert_bundle_no_keys'],
  };
}
...
export function PkiConfigureExternalPolicyResponseToJSONTyped(
  value?: PkiConfigureExternalPolicyResponse | null,
