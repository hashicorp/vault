 ...
 */
export function instanceOfCorsReadConfigurationResponse(
  value: object
): value is CorsReadConfigurationResponse {
  return true;
}
...
export function CorsReadConfigurationResponseFromJSONTyped(
  json: any,
...
export function CorsReadConfigurationResponseToJSONTyped(
  value?: CorsReadConfigurationResponse | null,
