 ...
 */
export function instanceOfSystemWriteUtilizationResponse(
  value: object
): value is SystemWriteUtilizationResponse {
  return true;
}
...
export function SystemWriteUtilizationResponseFromJSONTyped(
  json: any,
...
export function SystemWriteUtilizationResponseToJSONTyped(
  value?: SystemWriteUtilizationResponse | null,
