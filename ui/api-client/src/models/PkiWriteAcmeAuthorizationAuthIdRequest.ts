 ...
 */
export function instanceOfPkiWriteAcmeAuthorizationAuthIdRequest(
  value: object
): value is PkiWriteAcmeAuthorizationAuthIdRequest {
  return true;
}

export function PkiWriteAcmeAuthorizationAuthIdRequestFromJSON(
  json: any
): PkiWriteAcmeAuthorizationAuthIdRequest {
  return PkiWriteAcmeAuthorizationAuthIdRequestFromJSONTyped(json, false);
}

export function PkiWriteAcmeAuthorizationAuthIdRequestFromJSONTyped(
  json: any,
...
export function PkiWriteAcmeAuthorizationAuthIdRequestToJSON(
  json: any
): PkiWriteAcmeAuthorizationAuthIdRequest {
  return PkiWriteAcmeAuthorizationAuthIdRequestToJSONTyped(json, false);
}

export function PkiWriteAcmeAuthorizationAuthIdRequestToJSONTyped(
  value?: PkiWriteAcmeAuthorizationAuthIdRequest | null,
