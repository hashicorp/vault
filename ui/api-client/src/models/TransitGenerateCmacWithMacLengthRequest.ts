 ...
 */
export function instanceOfTransitGenerateCmacWithMacLengthRequest(
  value: object
): value is TransitGenerateCmacWithMacLengthRequest {
  return true;
}

export function TransitGenerateCmacWithMacLengthRequestFromJSON(
  json: any
): TransitGenerateCmacWithMacLengthRequest {
  return TransitGenerateCmacWithMacLengthRequestFromJSONTyped(json, false);
}

export function TransitGenerateCmacWithMacLengthRequestFromJSONTyped(
  json: any,
...
export function TransitGenerateCmacWithMacLengthRequestToJSON(
  json: any
): TransitGenerateCmacWithMacLengthRequest {
  return TransitGenerateCmacWithMacLengthRequestToJSONTyped(json, false);
}

export function TransitGenerateCmacWithMacLengthRequestToJSONTyped(
  value?: TransitGenerateCmacWithMacLengthRequest | null,
