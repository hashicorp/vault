 ...
 */
export function instanceOfCollectHostInformationResponse(
  value: object
): value is CollectHostInformationResponse {
  return true;
}
...
export function CollectHostInformationResponseFromJSONTyped(
  json: any,
...
export function CollectHostInformationResponseToJSONTyped(
  value?: CollectHostInformationResponse | null,
