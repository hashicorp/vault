 ...
 */
export function instanceOfKubernetesConfigureAuthRequest(
  value: object
): value is KubernetesConfigureAuthRequest {
  return true;
}
...
export function KubernetesConfigureAuthRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    useAnnotationsAsAliasMetadata:
      json['use_annotations_as_alias_metadata'] == null
        ? undefined
...
export function KubernetesConfigureAuthRequestToJSONTyped(
  value?: KubernetesConfigureAuthRequest | null,
