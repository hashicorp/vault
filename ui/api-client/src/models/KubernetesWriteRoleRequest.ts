...
export function KubernetesWriteRoleRequestFromJSONTyped(
  json: any,
  ...
  return {
    allowedKubernetesNamespaceSelector:
      json['allowed_kubernetes_namespace_selector'] == null
        ? undefined
        : json['allowed_kubernetes_namespace_selector'],
    allowedKubernetesNamespaces:
      json['allowed_kubernetes_namespaces'] == null ? undefined : json['allowed_kubernetes_namespaces'],
    ...
    tokenDefaultAudiences:
      json['token_default_audiences'] == null ? undefined : json['token_default_audiences'],
...
export function KubernetesWriteRoleRequestToJSONTyped(
  value?: KubernetesWriteRoleRequest | null,
