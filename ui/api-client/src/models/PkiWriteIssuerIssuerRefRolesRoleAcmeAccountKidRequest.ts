 ...
 */
export function instanceOfPkiWriteIssuerIssuerRefRolesRoleAcmeAccountKidRequest(
  value: object
): value is PkiWriteIssuerIssuerRefRolesRoleAcmeAccountKidRequest {
  return true;
}

export function PkiWriteIssuerIssuerRefRolesRoleAcmeAccountKidRequestFromJSON(
  json: any
...
export function PkiWriteIssuerIssuerRefRolesRoleAcmeAccountKidRequestFromJSONTyped(
  json: any,
...
export function PkiWriteIssuerIssuerRefRolesRoleAcmeAccountKidRequestToJSON(
  json: any
): PkiWriteIssuerIssuerRefRolesRoleAcmeAccountKidRequest {
  return PkiWriteIssuerIssuerRefRolesRoleAcmeAccountKidRequestToJSONTyped(json, false);
}

export function PkiWriteIssuerIssuerRefRolesRoleAcmeAccountKidRequestToJSONTyped(
  value?: PkiWriteIssuerIssuerRefRolesRoleAcmeAccountKidRequest | null,
