 ...
 */
export function instanceOfSystemWriteReplicationPrimaryEnableRequest(
  value: object
): value is SystemWriteReplicationPrimaryEnableRequest {
  return true;
}

export function SystemWriteReplicationPrimaryEnableRequestFromJSON(
  json: any
): SystemWriteReplicationPrimaryEnableRequest {
  return SystemWriteReplicationPrimaryEnableRequestFromJSONTyped(json, false);
}

export function SystemWriteReplicationPrimaryEnableRequestFromJSONTyped(
  json: any,
...
export function SystemWriteReplicationPrimaryEnableRequestToJSON(
  json: any
): SystemWriteReplicationPrimaryEnableRequest {
  return SystemWriteReplicationPrimaryEnableRequestToJSONTyped(json, false);
}

export function SystemWriteReplicationPrimaryEnableRequestToJSONTyped(
  value?: SystemWriteReplicationPrimaryEnableRequest | null,
