...
export function instanceOfPkiWriteIssuerIssuerRefExternalPolicyIssuePolicyRequest(
  value: object
): value is PkiWriteIssuerIssuerRefExternalPolicyIssuePolicyRequest {
  return true;
}

export function PkiWriteIssuerIssuerRefExternalPolicyIssuePolicyRequestFromJSON(
  json: any
...
export function PkiWriteIssuerIssuerRefExternalPolicyIssuePolicyRequestFromJSONTyped(
  json: any,
...
export function PkiWriteIssuerIssuerRefExternalPolicyIssuePolicyRequestToJSON(
  json: any
): PkiWriteIssuerIssuerRefExternalPolicyIssuePolicyRequest {
  return PkiWriteIssuerIssuerRefExternalPolicyIssuePolicyRequestToJSONTyped(json, false);
}

export function PkiWriteIssuerIssuerRefExternalPolicyIssuePolicyRequestToJSONTyped(
  value?: PkiWriteIssuerIssuerRefExternalPolicyIssuePolicyRequest | null,
