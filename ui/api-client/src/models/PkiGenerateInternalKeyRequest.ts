 ...
 */
export function instanceOfPkiGenerateInternalKeyRequest(
  value: object
): value is PkiGenerateInternalKeyRequest {
  return true;
}
...
export function PkiGenerateInternalKeyRequestFromJSONTyped(
  json: any,
...
export function PkiGenerateInternalKeyRequestToJSONTyped(
  value?: PkiGenerateInternalKeyRequest | null,
