...
export function ConsulConfigureAccessRequestFromJSONTyped(
  json: any,
...
export function ConsulConfigureAccessRequestToJSONTyped(
  value?: ConsulConfigureAccessRequest | null,
