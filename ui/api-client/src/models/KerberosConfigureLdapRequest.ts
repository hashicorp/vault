...
export function KerberosConfigureLdapRequestFromJSONTyped(
  json: any,
...
export function KerberosConfigureLdapRequestToJSONTyped(
  value?: KerberosConfigureLdapRequest | null,
