 ...
 */
export function instanceOfGoogleCloudGenerateRolesetKeyRequest(
  value: object
): value is GoogleCloudGenerateRolesetKeyRequest {
  return true;
}

export function GoogleCloudGenerateRolesetKeyRequestFromJSON(
  json: any
): GoogleCloudGenerateRolesetKeyRequest {
  return GoogleCloudGenerateRolesetKeyRequestFromJSONTyped(json, false);
}

export function GoogleCloudGenerateRolesetKeyRequestFromJSONTyped(
  json: any,
...
export function GoogleCloudGenerateRolesetKeyRequestToJSONTyped(
  value?: GoogleCloudGenerateRolesetKeyRequest | null,
