 ...
 */
export function instanceOfPkiGenerateEabKeyForRoleResponse(
  value: object
): value is PkiGenerateEabKeyForRoleResponse {
  return true;
}
...
export function PkiGenerateEabKeyForRoleResponseFromJSONTyped(
  json: any,
...
export function PkiGenerateEabKeyForRoleResponseToJSONTyped(
  value?: PkiGenerateEabKeyForRoleResponse | null,
