...
export function instanceOfSystemReadConfigGroupPolicyApplicationResponse(
  value: object
): value is SystemReadConfigGroupPolicyApplicationResponse {
  return true;
}

export function SystemReadConfigGroupPolicyApplicationResponseFromJSON(
  json: any
...
export function SystemReadConfigGroupPolicyApplicationResponseFromJSONTyped(
  json: any,
...
export function SystemReadConfigGroupPolicyApplicationResponseToJSON(
  json: any
): SystemReadConfigGroupPolicyApplicationResponse {
  return SystemReadConfigGroupPolicyApplicationResponseToJSONTyped(json, false);
}

export function SystemReadConfigGroupPolicyApplicationResponseToJSONTyped(
  value?: SystemReadConfigGroupPolicyApplicationResponse | null,
