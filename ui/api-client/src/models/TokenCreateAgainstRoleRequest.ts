 ...
 */
export function instanceOfTokenCreateAgainstRoleRequest(
  value: object
): value is TokenCreateAgainstRoleRequest {
  return true;
}
...
export function TokenCreateAgainstRoleRequestFromJSONTyped(
  json: any,
...
export function TokenCreateAgainstRoleRequestToJSONTyped(
  value?: TokenCreateAgainstRoleRequest | null,
