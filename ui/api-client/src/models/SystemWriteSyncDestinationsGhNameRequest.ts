 ...
 */
export function instanceOfSystemWriteSyncDestinationsGhNameRequest(
  value: object
): value is SystemWriteSyncDestinationsGhNameRequest {
  return true;
}

export function SystemWriteSyncDestinationsGhNameRequestFromJSON(
  json: any
): SystemWriteSyncDestinationsGhNameRequest {
  return SystemWriteSyncDestinationsGhNameRequestFromJSONTyped(json, false);
}

export function SystemWriteSyncDestinationsGhNameRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    organizationVisibility:
      json['organization_visibility'] == null ? undefined : json['organization_visibility'],
    ...
    selectedRepositoryNames:
      json['selected_repository_names'] == null ? undefined : json['selected_repository_names'],
  };
}

export function SystemWriteSyncDestinationsGhNameRequestToJSON(
  json: any
): SystemWriteSyncDestinationsGhNameRequest {
  return SystemWriteSyncDestinationsGhNameRequestToJSONTyped(json, false);
}

export function SystemWriteSyncDestinationsGhNameRequestToJSONTyped(
  value?: SystemWriteSyncDestinationsGhNameRequest | null,
