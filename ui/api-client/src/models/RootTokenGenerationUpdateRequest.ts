 ...
 */
export function instanceOfRootTokenGenerationUpdateRequest(
  value: object
): value is RootTokenGenerationUpdateRequest {
  return true;
}
...
export function RootTokenGenerationUpdateRequestFromJSONTyped(
  json: any,
...
export function RootTokenGenerationUpdateRequestToJSONTyped(
  value?: RootTokenGenerationUpdateRequest | null,
