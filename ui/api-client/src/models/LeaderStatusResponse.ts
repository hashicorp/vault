...
export function LeaderStatusResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    performanceStandbyLastRemoteWal:
      json['performance_standby_last_remote_wal'] == null
        ? undefined
...
export function LeaderStatusResponseToJSONTyped(
  value?: LeaderStatusResponse | null,
