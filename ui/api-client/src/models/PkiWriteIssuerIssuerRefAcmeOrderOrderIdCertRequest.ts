 ...
 */
export function instanceOfPkiWriteIssuerIssuerRefAcmeOrderOrderIdCertRequest(
  value: object
): value is PkiWriteIssuerIssuerRefAcmeOrderOrderIdCertRequest {
  return true;
}

export function PkiWriteIssuerIssuerRefAcmeOrderOrderIdCertRequestFromJSON(
  json: any
...
export function PkiWriteIssuerIssuerRefAcmeOrderOrderIdCertRequestFromJSONTyped(
  json: any,
...
export function PkiWriteIssuerIssuerRefAcmeOrderOrderIdCertRequestToJSON(
  json: any
): PkiWriteIssuerIssuerRefAcmeOrderOrderIdCertRequest {
  return PkiWriteIssuerIssuerRefAcmeOrderOrderIdCertRequestToJSONTyped(json, false);
}

export function PkiWriteIssuerIssuerRefAcmeOrderOrderIdCertRequestToJSONTyped(
  value?: PkiWriteIssuerIssuerRefAcmeOrderOrderIdCertRequest | null,
