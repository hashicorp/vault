 ...
 */
export function instanceOfRootTokenGenerationUpdateResponse(
  value: object
): value is RootTokenGenerationUpdateResponse {
  return true;
}
...
export function RootTokenGenerationUpdateResponseFromJSONTyped(
  json: any,
...
export function RootTokenGenerationUpdateResponseToJSONTyped(
  value?: RootTokenGenerationUpdateResponse | null,
