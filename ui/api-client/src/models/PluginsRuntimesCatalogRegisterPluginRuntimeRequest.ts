 ...
 */
export function instanceOfPluginsRuntimesCatalogRegisterPluginRuntimeRequest(
  value: object
): value is PluginsRuntimesCatalogRegisterPluginRuntimeRequest {
  return true;
}

export function PluginsRuntimesCatalogRegisterPluginRuntimeRequestFromJSON(
  json: any
...
export function PluginsRuntimesCatalogRegisterPluginRuntimeRequestFromJSONTyped(
  json: any,
...
export function PluginsRuntimesCatalogRegisterPluginRuntimeRequestToJSON(
  json: any
): PluginsRuntimesCatalogRegisterPluginRuntimeRequest {
  return PluginsRuntimesCatalogRegisterPluginRuntimeRequestToJSONTyped(json, false);
}

export function PluginsRuntimesCatalogRegisterPluginRuntimeRequestToJSONTyped(
  value?: PluginsRuntimesCatalogRegisterPluginRuntimeRequest | null,
