 ...
 */
export function instanceOfSystemReadSyncDestinationsGcpSmNameResponse(
  value: object
): value is SystemReadSyncDestinationsGcpSmNameResponse {
  return true;
}

export function SystemReadSyncDestinationsGcpSmNameResponseFromJSON(
  json: any
): SystemReadSyncDestinationsGcpSmNameResponse {
  return SystemReadSyncDestinationsGcpSmNameResponseFromJSONTyped(json, false);
}

export function SystemReadSyncDestinationsGcpSmNameResponseFromJSONTyped(
  json: any,
...
export function SystemReadSyncDestinationsGcpSmNameResponseToJSON(
  json: any
): SystemReadSyncDestinationsGcpSmNameResponse {
  return SystemReadSyncDestinationsGcpSmNameResponseToJSONTyped(json, false);
}

export function SystemReadSyncDestinationsGcpSmNameResponseToJSONTyped(
  value?: SystemReadSyncDestinationsGcpSmNameResponse | null,
