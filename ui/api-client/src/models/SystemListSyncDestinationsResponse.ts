 ...
 */
export function instanceOfSystemListSyncDestinationsResponse(
  value: object
): value is SystemListSyncDestinationsResponse {
  return true;
}
...
export function SystemListSyncDestinationsResponseFromJSONTyped(
  json: any,
...
export function SystemListSyncDestinationsResponseToJSONTyped(
  value?: SystemListSyncDestinationsResponse | null,
