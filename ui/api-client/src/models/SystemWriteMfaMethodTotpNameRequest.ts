 ...
 */
export function instanceOfSystemWriteMfaMethodTotpNameRequest(
  value: object
): value is SystemWriteMfaMethodTotpNameRequest {
  return true;
}
...
export function SystemWriteMfaMethodTotpNameRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    maxValidationAttempts:
      json['max_validation_attempts'] == null ? undefined : json['max_validation_attempts'],
...
export function SystemWriteMfaMethodTotpNameRequestToJSONTyped(
  value?: SystemWriteMfaMethodTotpNameRequest | null,
