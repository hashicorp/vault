 ...
 */
export function instanceOfEntityAliasCreateDuplicatesRequest(
  value: object
): value is EntityAliasCreateDuplicatesRequest {
  return true;
}
...
export function EntityAliasCreateDuplicatesRequestFromJSONTyped(
  json: any,
...
export function EntityAliasCreateDuplicatesRequestToJSONTyped(
  value?: EntityAliasCreateDuplicatesRequest | null,
