 ...
 */
export function instanceOfSystemReadSyncDestinationsInMemNameResponse(
  value: object
): value is SystemReadSyncDestinationsInMemNameResponse {
  return true;
}

export function SystemReadSyncDestinationsInMemNameResponseFromJSON(
  json: any
): SystemReadSyncDestinationsInMemNameResponse {
  return SystemReadSyncDestinationsInMemNameResponseFromJSONTyped(json, false);
}

export function SystemReadSyncDestinationsInMemNameResponseFromJSONTyped(
  json: any,
...
export function SystemReadSyncDestinationsInMemNameResponseToJSON(
  json: any
): SystemReadSyncDestinationsInMemNameResponse {
  return SystemReadSyncDestinationsInMemNameResponseToJSONTyped(json, false);
}

export function SystemReadSyncDestinationsInMemNameResponseToJSONTyped(
  value?: SystemReadSyncDestinationsInMemNameResponse | null,
