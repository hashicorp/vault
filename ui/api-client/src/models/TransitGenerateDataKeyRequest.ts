 ...
 */
export function instanceOfTransitGenerateDataKeyRequest(
  value: object
): value is TransitGenerateDataKeyRequest {
  return true;
}
...
export function TransitGenerateDataKeyRequestFromJSONTyped(
  json: any,
...
export function TransitGenerateDataKeyRequestToJSONTyped(
  value?: TransitGenerateDataKeyRequest | null,
