 ...
 */
export function instanceOfPkiWriteIssuerIssuerRefExternalPolicyAcmeOrderOrderIdFinalizeRequest(
  value: object
): value is PkiWriteIssuerIssuerRefExternalPolicyAcmeOrderOrderIdFinalizeRequest {
  return true;
}

export function PkiWriteIssuerIssuerRefExternalPolicyAcmeOrderOrderIdFinalizeRequestFromJSON(
  json: any
...
export function PkiWriteIssuerIssuerRefExternalPolicyAcmeOrderOrderIdFinalizeRequestFromJSONTyped(
  json: any,
...
export function PkiWriteIssuerIssuerRefExternalPolicyAcmeOrderOrderIdFinalizeRequestToJSON(
  json: any
): PkiWriteIssuerIssuerRefExternalPolicyAcmeOrderOrderIdFinalizeRequest {
  return PkiWriteIssuerIssuerRefExternalPolicyAcmeOrderOrderIdFinalizeRequestToJSONTyped(json, false);
}

export function PkiWriteIssuerIssuerRefExternalPolicyAcmeOrderOrderIdFinalizeRequestToJSONTyped(
  value?: PkiWriteIssuerIssuerRefExternalPolicyAcmeOrderOrderIdFinalizeRequest | null,
