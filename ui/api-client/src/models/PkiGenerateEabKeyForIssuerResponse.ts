 ...
 */
export function instanceOfPkiGenerateEabKeyForIssuerResponse(
  value: object
): value is PkiGenerateEabKeyForIssuerResponse {
  return true;
}
...
export function PkiGenerateEabKeyForIssuerResponseFromJSONTyped(
  json: any,
...
export function PkiGenerateEabKeyForIssuerResponseToJSONTyped(
  value?: PkiGenerateEabKeyForIssuerResponse | null,
