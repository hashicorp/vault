 ...
 */
export function instanceOfRekeyAttemptInitializeRequest(
  value: object
): value is RekeyAttemptInitializeRequest {
  return true;
}
...
export function RekeyAttemptInitializeRequestFromJSONTyped(
  json: any,
...
export function RekeyAttemptInitializeRequestToJSONTyped(
  value?: RekeyAttemptInitializeRequest | null,
