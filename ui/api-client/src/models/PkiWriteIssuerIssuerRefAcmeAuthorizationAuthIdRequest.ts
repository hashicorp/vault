 ...
 */
export function instanceOfPkiWriteIssuerIssuerRefAcmeAuthorizationAuthIdRequest(
  value: object
): value is PkiWriteIssuerIssuerRefAcmeAuthorizationAuthIdRequest {
  return true;
}

export function PkiWriteIssuerIssuerRefAcmeAuthorizationAuthIdRequestFromJSON(
  json: any
...
export function PkiWriteIssuerIssuerRefAcmeAuthorizationAuthIdRequestFromJSONTyped(
  json: any,
...
export function PkiWriteIssuerIssuerRefAcmeAuthorizationAuthIdRequestToJSON(
  json: any
): PkiWriteIssuerIssuerRefAcmeAuthorizationAuthIdRequest {
  return PkiWriteIssuerIssuerRefAcmeAuthorizationAuthIdRequestToJSONTyped(json, false);
}

export function PkiWriteIssuerIssuerRefAcmeAuthorizationAuthIdRequestToJSONTyped(
  value?: PkiWriteIssuerIssuerRefAcmeAuthorizationAuthIdRequest | null,
