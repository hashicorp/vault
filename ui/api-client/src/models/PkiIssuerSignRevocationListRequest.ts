 ...
 */
export function instanceOfPkiIssuerSignRevocationListRequest(
  value: object
): value is PkiIssuerSignRevocationListRequest {
  return true;
}
...
export function PkiIssuerSignRevocationListRequestFromJSONTyped(
  json: any,
...
export function PkiIssuerSignRevocationListRequestToJSONTyped(
  value?: PkiIssuerSignRevocationListRequest | null,
