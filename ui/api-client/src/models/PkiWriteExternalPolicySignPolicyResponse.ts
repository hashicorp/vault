 ...
 */
export function instanceOfPkiWriteExternalPolicySignPolicyResponse(
  value: object
): value is PkiWriteExternalPolicySignPolicyResponse {
  return true;
}

export function PkiWriteExternalPolicySignPolicyResponseFromJSON(
  json: any
): PkiWriteExternalPolicySignPolicyResponse {
  return PkiWriteExternalPolicySignPolicyResponseFromJSONTyped(json, false);
}

export function PkiWriteExternalPolicySignPolicyResponseFromJSONTyped(
  json: any,
...
export function PkiWriteExternalPolicySignPolicyResponseToJSON(
  json: any
): PkiWriteExternalPolicySignPolicyResponse {
  return PkiWriteExternalPolicySignPolicyResponseToJSONTyped(json, false);
}

export function PkiWriteExternalPolicySignPolicyResponseToJSONTyped(
  value?: PkiWriteExternalPolicySignPolicyResponse | null,
