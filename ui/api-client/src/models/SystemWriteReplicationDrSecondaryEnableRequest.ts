 ...
 */
export function instanceOfSystemWriteReplicationDrSecondaryEnableRequest(
  value: object
): value is SystemWriteReplicationDrSecondaryEnableRequest {
  return true;
}

export function SystemWriteReplicationDrSecondaryEnableRequestFromJSON(
  json: any
...
export function SystemWriteReplicationDrSecondaryEnableRequestFromJSONTyped(
  json: any,
...
export function SystemWriteReplicationDrSecondaryEnableRequestToJSON(
  json: any
): SystemWriteReplicationDrSecondaryEnableRequest {
  return SystemWriteReplicationDrSecondaryEnableRequestToJSONTyped(json, false);
}

export function SystemWriteReplicationDrSecondaryEnableRequestToJSONTyped(
  value?: SystemWriteReplicationDrSecondaryEnableRequest | null,
