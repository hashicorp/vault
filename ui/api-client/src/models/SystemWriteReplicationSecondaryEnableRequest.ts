 ...
 */
export function instanceOfSystemWriteReplicationSecondaryEnableRequest(
  value: object
): value is SystemWriteReplicationSecondaryEnableRequest {
  return true;
}

export function SystemWriteReplicationSecondaryEnableRequestFromJSON(
  json: any
): SystemWriteReplicationSecondaryEnableRequest {
  return SystemWriteReplicationSecondaryEnableRequestFromJSONTyped(json, false);
}

export function SystemWriteReplicationSecondaryEnableRequestFromJSONTyped(
  json: any,
...
export function SystemWriteReplicationSecondaryEnableRequestToJSON(
  json: any
): SystemWriteReplicationSecondaryEnableRequest {
  return SystemWriteReplicationSecondaryEnableRequestToJSONTyped(json, false);
}

export function SystemWriteReplicationSecondaryEnableRequestToJSONTyped(
  value?: SystemWriteReplicationSecondaryEnableRequest | null,
