 ...
 */
export function instanceOfPkiWriteExternalPolicySignPolicyRequest(
  value: object
): value is PkiWriteExternalPolicySignPolicyRequest {
  if (!('csr' in value) || value['csr'] === undefined) return false;
  return true;
}

export function PkiWriteExternalPolicySignPolicyRequestFromJSON(
  json: any
): PkiWriteExternalPolicySignPolicyRequest {
  return PkiWriteExternalPolicySignPolicyRequestFromJSONTyped(json, false);
}

export function PkiWriteExternalPolicySignPolicyRequestFromJSONTyped(
  json: any,
...
export function PkiWriteExternalPolicySignPolicyRequestToJSON(
  json: any
): PkiWriteExternalPolicySignPolicyRequest {
  return PkiWriteExternalPolicySignPolicyRequestToJSONTyped(json, false);
}

export function PkiWriteExternalPolicySignPolicyRequestToJSONTyped(
  value?: PkiWriteExternalPolicySignPolicyRequest | null,
