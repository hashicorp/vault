 ...
 */
export function instanceOfEntityAliasesCreateDuplicatesRequest(
  value: object
): value is EntityAliasesCreateDuplicatesRequest {
  return true;
}

export function EntityAliasesCreateDuplicatesRequestFromJSON(
  json: any
): EntityAliasesCreateDuplicatesRequest {
  return EntityAliasesCreateDuplicatesRequestFromJSONTyped(json, false);
}

export function EntityAliasesCreateDuplicatesRequestFromJSONTyped(
  json: any,
...
export function EntityAliasesCreateDuplicatesRequestToJSONTyped(
  value?: EntityAliasesCreateDuplicatesRequest | null,
