 ...
 */
export function instanceOfPkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeOrderOrderIdCertRequest(
  value: object
): value is PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeOrderOrderIdCertRequest {
  return true;
}

export function PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeOrderOrderIdCertRequestFromJSON(
  json: any
...
export function PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeOrderOrderIdCertRequestFromJSONTyped(
  json: any,
...
export function PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeOrderOrderIdCertRequestToJSON(
  json: any
): PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeOrderOrderIdCertRequest {
  return PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeOrderOrderIdCertRequestToJSONTyped(json, false);
}

export function PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeOrderOrderIdCertRequestToJSONTyped(
  value?: PkiWriteIssuerIssuerRefExternalPolicyPolicyAcmeOrderOrderIdCertRequest | null,
