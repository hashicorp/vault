 ...
 */
export function instanceOfPkiCrossSignIntermediateRequest(
  value: object
): value is PkiCrossSignIntermediateRequest {
  return true;
}
...
export function PkiCrossSignIntermediateRequestFromJSONTyped(
  json: any,
...
export function PkiCrossSignIntermediateRequestToJSONTyped(
  value?: PkiCrossSignIntermediateRequest | null,
