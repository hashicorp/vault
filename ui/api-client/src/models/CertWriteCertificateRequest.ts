...
export function CertWriteCertificateRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    allowedMetadataExtensions:
      json['allowed_metadata_extensions'] == null ? undefined : json['allowed_metadata_extensions'],
    allowedNames: json['allowed_names'] == null ? undefined : json['allowed_names'],
    allowedOrganizationalUnits:
      json['allowed_organizational_units'] == null ? undefined : json['allowed_organizational_units'],
    ...
    ocspThisUpdateMaxAge:
      json['ocsp_this_update_max_age'] == null ? undefined : json['ocsp_this_update_max_age'],
...
export function CertWriteCertificateRequestToJSONTyped(
  value?: CertWriteCertificateRequest | null,
