 ...
 */
export function instanceOfGoogleCloudKmsRegisterKeyRequest(
  value: object
): value is GoogleCloudKmsRegisterKeyRequest {
  return true;
}
...
export function GoogleCloudKmsRegisterKeyRequestFromJSONTyped(
  json: any,
...
export function GoogleCloudKmsRegisterKeyRequestToJSONTyped(
  value?: GoogleCloudKmsRegisterKeyRequest | null,
