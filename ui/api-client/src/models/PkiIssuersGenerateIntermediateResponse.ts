 ...
 */
export function instanceOfPkiIssuersGenerateIntermediateResponse(
  value: object
): value is PkiIssuersGenerateIntermediateResponse {
  return true;
}

export function PkiIssuersGenerateIntermediateResponseFromJSON(
  json: any
): PkiIssuersGenerateIntermediateResponse {
  return PkiIssuersGenerateIntermediateResponseFromJSONTyped(json, false);
}

export function PkiIssuersGenerateIntermediateResponseFromJSONTyped(
  json: any,
...
export function PkiIssuersGenerateIntermediateResponseToJSON(
  json: any
): PkiIssuersGenerateIntermediateResponse {
  return PkiIssuersGenerateIntermediateResponseToJSONTyped(json, false);
}

export function PkiIssuersGenerateIntermediateResponseToJSONTyped(
  value?: PkiIssuersGenerateIntermediateResponse | null,
