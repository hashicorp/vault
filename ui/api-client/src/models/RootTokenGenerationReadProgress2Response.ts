 ...
 */
export function instanceOfRootTokenGenerationReadProgress2Response(
  value: object
): value is RootTokenGenerationReadProgress2Response {
  return true;
}

export function RootTokenGenerationReadProgress2ResponseFromJSON(
  json: any
): RootTokenGenerationReadProgress2Response {
  return RootTokenGenerationReadProgress2ResponseFromJSONTyped(json, false);
}

export function RootTokenGenerationReadProgress2ResponseFromJSONTyped(
  json: any,
...
export function RootTokenGenerationReadProgress2ResponseToJSON(
  json: any
): RootTokenGenerationReadProgress2Response {
  return RootTokenGenerationReadProgress2ResponseToJSONTyped(json, false);
}

export function RootTokenGenerationReadProgress2ResponseToJSONTyped(
  value?: RootTokenGenerationReadProgress2Response | null,
