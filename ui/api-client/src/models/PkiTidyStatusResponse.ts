...
export function PkiTidyStatusResponseFromJSONTyped(
  json: any,
  ...
  return {
    acmeAccountDeletedCount:
      json['acme_account_deleted_count'] == null ? undefined : json['acme_account_deleted_count'],
    acmeAccountRevokedCount:
      json['acme_account_revoked_count'] == null ? undefined : json['acme_account_revoked_count'],
    acmeAccountSafetyBuffer:
      json['acme_account_safety_buffer'] == null ? undefined : json['acme_account_safety_buffer'],
    acmeOrdersDeletedCount:
      json['acme_orders_deleted_count'] == null ? undefined : json['acme_orders_deleted_count'],
    certMetadataDeletedCount:
      json['cert_metadata_deleted_count'] == null ? undefined : json['cert_metadata_deleted_count'],
    certStoreDeletedCount:
      json['cert_store_deleted_count'] == null ? undefined : json['cert_store_deleted_count'],
    cmpv2NonceDeletedCount:
      json['cmpv2_nonce_deleted_count'] == null ? undefined : json['cmpv2_nonce_deleted_count'],
    crossRevokedCertDeletedCount:
      json['cross_revoked_cert_deleted_count'] == null ? undefined : json['cross_revoked_cert_deleted_count'],
    currentCertStoreCount:
      json['current_cert_store_count'] == null ? undefined : json['current_cert_store_count'],
    currentRevokedCertCount:
      json['current_revoked_cert_count'] == null ? undefined : json['current_revoked_cert_count'],
    ...
    lastAutoTidyFinished:
      json['last_auto_tidy_finished'] == null ? undefined : json['last_auto_tidy_finished'],
    message: json['message'] == null ? undefined : json['message'],
    missingIssuerCertCount:
      json['missing_issuer_cert_count'] == null ? undefined : json['missing_issuer_cert_count'],
    pauseDuration: json['pause_duration'] == null ? undefined : json['pause_duration'],
    revocationQueueDeletedCount:
      json['revocation_queue_deleted_count'] == null ? undefined : json['revocation_queue_deleted_count'],
    revocationQueueSafetyBuffer:
      json['revocation_queue_safety_buffer'] == null ? undefined : json['revocation_queue_safety_buffer'],
    revokedCertDeletedCount:
      json['revoked_cert_deleted_count'] == null ? undefined : json['revoked_cert_deleted_count'],
    ...
    totalAcmeAccountCount:
      json['total_acme_account_count'] == null ? undefined : json['total_acme_account_count'],
  };
}
...
export function PkiTidyStatusResponseToJSONTyped(
  value?: PkiTidyStatusResponse | null,
