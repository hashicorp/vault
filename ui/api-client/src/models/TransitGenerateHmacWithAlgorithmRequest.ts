 ...
 */
export function instanceOfTransitGenerateHmacWithAlgorithmRequest(
  value: object
): value is TransitGenerateHmacWithAlgorithmRequest {
  return true;
}

export function TransitGenerateHmacWithAlgorithmRequestFromJSON(
  json: any
): TransitGenerateHmacWithAlgorithmRequest {
  return TransitGenerateHmacWithAlgorithmRequestFromJSONTyped(json, false);
}

export function TransitGenerateHmacWithAlgorithmRequestFromJSONTyped(
  json: any,
...
export function TransitGenerateHmacWithAlgorithmRequestToJSON(
  json: any
): TransitGenerateHmacWithAlgorithmRequest {
  return TransitGenerateHmacWithAlgorithmRequestToJSONTyped(json, false);
}

export function TransitGenerateHmacWithAlgorithmRequestToJSONTyped(
  value?: TransitGenerateHmacWithAlgorithmRequest | null,
