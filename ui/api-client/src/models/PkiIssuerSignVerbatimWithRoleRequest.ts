 ...
 * @enum {string}
 */
export enum PkiIssuerSignVerbatimWithRoleRequestFormatEnum {
  PEM = 'pem',
  DER = 'der',
 ...
 * @enum {string}
 */
export enum PkiIssuerSignVerbatimWithRoleRequestPrivateKeyFormatEnum {
  EMPTY = '',
  DER = 'der',
  PEM = 'pem',
  PKCS8 = 'pkcs8',
 ...
 */
export function instanceOfPkiIssuerSignVerbatimWithRoleRequest(
  value: object
): value is PkiIssuerSignVerbatimWithRoleRequest {
  return true;
}

export function PkiIssuerSignVerbatimWithRoleRequestFromJSON(
  json: any
): PkiIssuerSignVerbatimWithRoleRequest {
  return PkiIssuerSignVerbatimWithRoleRequestFromJSONTyped(json, false);
}

export function PkiIssuerSignVerbatimWithRoleRequestFromJSONTyped(
  json: any,
...
export function PkiIssuerSignVerbatimWithRoleRequestToJSONTyped(
  value?: PkiIssuerSignVerbatimWithRoleRequest | null,
