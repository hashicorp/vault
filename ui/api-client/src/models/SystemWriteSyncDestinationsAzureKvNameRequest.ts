 ...
 */
export function instanceOfSystemWriteSyncDestinationsAzureKvNameRequest(
  value: object
): value is SystemWriteSyncDestinationsAzureKvNameRequest {
  return true;
}

export function SystemWriteSyncDestinationsAzureKvNameRequestFromJSON(
  json: any
...
export function SystemWriteSyncDestinationsAzureKvNameRequestFromJSONTyped(
  json: any,
...
export function SystemWriteSyncDestinationsAzureKvNameRequestToJSON(
  json: any
): SystemWriteSyncDestinationsAzureKvNameRequest {
  return SystemWriteSyncDestinationsAzureKvNameRequestToJSONTyped(json, false);
}

export function SystemWriteSyncDestinationsAzureKvNameRequestToJSONTyped(
  value?: SystemWriteSyncDestinationsAzureKvNameRequest | null,
