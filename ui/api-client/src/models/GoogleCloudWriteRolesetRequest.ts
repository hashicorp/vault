 ...
 */
export function instanceOfGoogleCloudWriteRolesetRequest(
  value: object
): value is GoogleCloudWriteRolesetRequest {
  return true;
}
...
export function GoogleCloudWriteRolesetRequestFromJSONTyped(
  json: any,
...
export function GoogleCloudWriteRolesetRequestToJSONTyped(
  value?: GoogleCloudWriteRolesetRequest | null,
