 ...
 */
export function instanceOfSystemWriteManagedKeysTypeNameTestSignRequest(
  value: object
): value is SystemWriteManagedKeysTypeNameTestSignRequest {
  return true;
}

export function SystemWriteManagedKeysTypeNameTestSignRequestFromJSON(
  json: any
...
export function SystemWriteManagedKeysTypeNameTestSignRequestFromJSONTyped(
  json: any,
...
export function SystemWriteManagedKeysTypeNameTestSignRequestToJSON(
  json: any
): SystemWriteManagedKeysTypeNameTestSignRequest {
  return SystemWriteManagedKeysTypeNameTestSignRequestToJSONTyped(json, false);
}

export function SystemWriteManagedKeysTypeNameTestSignRequestToJSONTyped(
  value?: SystemWriteManagedKeysTypeNameTestSignRequest | null,
