 ...
 */
export function instanceOfPkiWriteRolesRoleAcmeNewOrderRequest(
  value: object
): value is PkiWriteRolesRoleAcmeNewOrderRequest {
  return true;
}

export function PkiWriteRolesRoleAcmeNewOrderRequestFromJSON(
  json: any
): PkiWriteRolesRoleAcmeNewOrderRequest {
  return PkiWriteRolesRoleAcmeNewOrderRequestFromJSONTyped(json, false);
}

export function PkiWriteRolesRoleAcmeNewOrderRequestFromJSONTyped(
  json: any,
...
export function PkiWriteRolesRoleAcmeNewOrderRequestToJSONTyped(
  value?: PkiWriteRolesRoleAcmeNewOrderRequest | null,
