 ...
 */
export function instanceOfPkiWriteIssuerIssuerRefExternalPolicyAcmeNewAccountRequest(
  value: object
): value is PkiWriteIssuerIssuerRefExternalPolicyAcmeNewAccountRequest {
  return true;
}

export function PkiWriteIssuerIssuerRefExternalPolicyAcmeNewAccountRequestFromJSON(
  json: any
...
export function PkiWriteIssuerIssuerRefExternalPolicyAcmeNewAccountRequestFromJSONTyped(
  json: any,
...
export function PkiWriteIssuerIssuerRefExternalPolicyAcmeNewAccountRequestToJSON(
  json: any
): PkiWriteIssuerIssuerRefExternalPolicyAcmeNewAccountRequest {
  return PkiWriteIssuerIssuerRefExternalPolicyAcmeNewAccountRequestToJSONTyped(json, false);
}

export function PkiWriteIssuerIssuerRefExternalPolicyAcmeNewAccountRequestToJSONTyped(
  value?: PkiWriteIssuerIssuerRefExternalPolicyAcmeNewAccountRequest | null,
