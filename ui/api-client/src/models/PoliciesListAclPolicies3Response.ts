 ...
 */
export function instanceOfPoliciesListAclPolicies3Response(
  value: object
): value is PoliciesListAclPolicies3Response {
  return true;
}
...
export function PoliciesListAclPolicies3ResponseFromJSONTyped(
  json: any,
...
export function PoliciesListAclPolicies3ResponseToJSONTyped(
  value?: PoliciesListAclPolicies3Response | null,
