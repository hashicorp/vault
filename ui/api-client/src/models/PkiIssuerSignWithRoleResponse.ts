 ...
 */
export function instanceOfPkiIssuerSignWithRoleResponse(
  value: object
): value is PkiIssuerSignWithRoleResponse {
  return true;
}
...
export function PkiIssuerSignWithRoleResponseFromJSONTyped(
  json: any,
...
export function PkiIssuerSignWithRoleResponseToJSONTyped(
  value?: PkiIssuerSignWithRoleResponse | null,
