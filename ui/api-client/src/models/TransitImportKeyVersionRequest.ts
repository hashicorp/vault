 ...
 */
export function instanceOfTransitImportKeyVersionRequest(
  value: object
): value is TransitImportKeyVersionRequest {
  return true;
}
...
export function TransitImportKeyVersionRequestFromJSONTyped(
  json: any,
...
export function TransitImportKeyVersionRequestToJSONTyped(
  value?: TransitImportKeyVersionRequest | null,
