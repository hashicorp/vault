 ...
 */
export function instanceOfPkiConfigureExternalPolicyRequest(
  value: object
): value is PkiConfigureExternalPolicyRequest {
  return true;
}
...
export function PkiConfigureExternalPolicyRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    vaultClientCertBundle:
      json['vault_client_cert_bundle'] == null ? undefined : json['vault_client_cert_bundle'],
  };
}
...
export function PkiConfigureExternalPolicyRequestToJSONTyped(
  value?: PkiConfigureExternalPolicyRequest | null,
