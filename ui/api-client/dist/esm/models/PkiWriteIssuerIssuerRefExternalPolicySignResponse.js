 ...
 */
export function instanceOfPkiWriteIssuerIssuerRefExternalPolicySignResponse(value) {
    return true;
}
export function PkiWriteIssuerIssuerRefExternalPolicySignResponseFromJSON(json) {
    return PkiWriteIssuerIssuerRefExternalPolicySignResponseFromJSONTyped(json, false);
}
export function PkiWriteIssuerIssuerRefExternalPolicySignResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiWriteIssuerIssuerRefExternalPolicySignResponseToJSON(json) {
    return PkiWriteIssuerIssuerRefExternalPolicySignResponseToJSONTyped(json, false);
}
export function PkiWriteIssuerIssuerRefExternalPolicySignResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
