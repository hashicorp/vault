 ...
 */
export function instanceOfUnsealResponse(value) {
    return true;
}
export function UnsealResponseFromJSON(json) {
    return UnsealResponseFromJSONTyped(json, false);
}
export function UnsealResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function UnsealResponseToJSON(json) {
    return UnsealResponseToJSONTyped(json, false);
}
export function UnsealResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
