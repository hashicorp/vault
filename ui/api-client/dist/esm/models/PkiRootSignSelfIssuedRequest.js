 ...
 */
export function instanceOfPkiRootSignSelfIssuedRequest(value) {
    return true;
}
export function PkiRootSignSelfIssuedRequestFromJSON(json) {
    return PkiRootSignSelfIssuedRequestFromJSONTyped(json, false);
}
export function PkiRootSignSelfIssuedRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiRootSignSelfIssuedRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
