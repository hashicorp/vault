 ...
 */
export function instanceOfPkiIssuersImportBundleResponse(value) {
    return true;
}
export function PkiIssuersImportBundleResponseFromJSON(json) {
    return PkiIssuersImportBundleResponseFromJSONTyped(json, false);
}
export function PkiIssuersImportBundleResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiIssuersImportBundleResponseToJSON(json) {
    return PkiIssuersImportBundleResponseToJSONTyped(json, false);
}
export function PkiIssuersImportBundleResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
