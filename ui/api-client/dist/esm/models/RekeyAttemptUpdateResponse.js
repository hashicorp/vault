 ...
 */
export function instanceOfRekeyAttemptUpdateResponse(value) {
    return true;
}
export function RekeyAttemptUpdateResponseFromJSON(json) {
    return RekeyAttemptUpdateResponseFromJSONTyped(json, false);
}
export function RekeyAttemptUpdateResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function RekeyAttemptUpdateResponseToJSON(json) {
    return RekeyAttemptUpdateResponseToJSONTyped(json, false);
}
export function RekeyAttemptUpdateResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
