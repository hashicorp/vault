 ...
 */
export function instanceOfTransitSignWithAlgorithmRequest(value) {
    return true;
}
export function TransitSignWithAlgorithmRequestFromJSON(json) {
    return TransitSignWithAlgorithmRequestFromJSONTyped(json, false);
}
export function TransitSignWithAlgorithmRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function TransitSignWithAlgorithmRequestToJSON(json) {
    return TransitSignWithAlgorithmRequestToJSONTyped(json, false);
}
export function TransitSignWithAlgorithmRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
