 ...
 */
export function instanceOfTransitVerifyRequest(value) {
    return true;
}
export function TransitVerifyRequestFromJSON(json) {
    return TransitVerifyRequestFromJSONTyped(json, false);
}
export function TransitVerifyRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function TransitVerifyRequestToJSON(json) {
    return TransitVerifyRequestToJSONTyped(json, false);
}
export function TransitVerifyRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
