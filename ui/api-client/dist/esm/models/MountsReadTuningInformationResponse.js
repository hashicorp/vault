 ...
 */
export function instanceOfMountsReadTuningInformationResponse(value) {
    return true;
}
export function MountsReadTuningInformationResponseFromJSON(json) {
    return MountsReadTuningInformationResponseFromJSONTyped(json, false);
}
export function MountsReadTuningInformationResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function MountsReadTuningInformationResponseToJSON(json) {
    return MountsReadTuningInformationResponseToJSONTyped(json, false);
}
export function MountsReadTuningInformationResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
