 ...
 */
export function instanceOfPkiTidyRequest(value) {
    return true;
}
export function PkiTidyRequestFromJSON(json) {
    return PkiTidyRequestFromJSONTyped(json, false);
}
export function PkiTidyRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiTidyRequestToJSON(json) {
    return PkiTidyRequestToJSONTyped(json, false);
}
export function PkiTidyRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
