 ...
 */
export function instanceOfPkiRootSignIntermediateResponse(value) {
    return true;
}
export function PkiRootSignIntermediateResponseFromJSON(json) {
    return PkiRootSignIntermediateResponseFromJSONTyped(json, false);
}
export function PkiRootSignIntermediateResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiRootSignIntermediateResponseToJSON(json) {
    return PkiRootSignIntermediateResponseToJSONTyped(json, false);
}
export function PkiRootSignIntermediateResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
