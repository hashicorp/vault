 ...
 */
export function instanceOfPkiRevokeIssuerResponse(value) {
    return true;
}
export function PkiRevokeIssuerResponseFromJSON(json) {
    return PkiRevokeIssuerResponseFromJSONTyped(json, false);
}
export function PkiRevokeIssuerResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiRevokeIssuerResponseToJSON(json) {
    return PkiRevokeIssuerResponseToJSONTyped(json, false);
}
export function PkiRevokeIssuerResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
