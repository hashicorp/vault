 ...
 */
export function instanceOfPkiIssuersGenerateRootResponse(value) {
    return true;
}
export function PkiIssuersGenerateRootResponseFromJSON(json) {
    return PkiIssuersGenerateRootResponseFromJSONTyped(json, false);
}
export function PkiIssuersGenerateRootResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiIssuersGenerateRootResponseToJSON(json) {
    return PkiIssuersGenerateRootResponseToJSONTyped(json, false);
}
export function PkiIssuersGenerateRootResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
