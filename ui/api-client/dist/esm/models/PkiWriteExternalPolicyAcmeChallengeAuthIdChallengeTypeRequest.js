 ...
 */
export function instanceOfPkiWriteExternalPolicyAcmeChallengeAuthIdChallengeTypeRequest(value) {
    return true;
}
export function PkiWriteExternalPolicyAcmeChallengeAuthIdChallengeTypeRequestFromJSON(json) {
    return PkiWriteExternalPolicyAcmeChallengeAuthIdChallengeTypeRequestFromJSONTyped(json, false);
}
export function PkiWriteExternalPolicyAcmeChallengeAuthIdChallengeTypeRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiWriteExternalPolicyAcmeChallengeAuthIdChallengeTypeRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
