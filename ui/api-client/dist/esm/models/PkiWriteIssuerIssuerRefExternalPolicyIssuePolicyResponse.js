 ...
 */
export function instanceOfPkiWriteIssuerIssuerRefExternalPolicyIssuePolicyResponse(value) {
    return true;
}
export function PkiWriteIssuerIssuerRefExternalPolicyIssuePolicyResponseFromJSON(json) {
    return PkiWriteIssuerIssuerRefExternalPolicyIssuePolicyResponseFromJSONTyped(json, false);
}
export function PkiWriteIssuerIssuerRefExternalPolicyIssuePolicyResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiWriteIssuerIssuerRefExternalPolicyIssuePolicyResponseToJSON(json) {
    return PkiWriteIssuerIssuerRefExternalPolicyIssuePolicyResponseToJSONTyped(json, false);
}
export function PkiWriteIssuerIssuerRefExternalPolicyIssuePolicyResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
