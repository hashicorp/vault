 ...
 */
export function instanceOfSealStatusResponse(value) {
    return true;
}
export function SealStatusResponseFromJSON(json) {
    return SealStatusResponseFromJSONTyped(json, false);
}
export function SealStatusResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SealStatusResponseToJSON(json) {
    return SealStatusResponseToJSONTyped(json, false);
}
export function SealStatusResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
