 ...
 */
export function instanceOfRateLimitQuotasReadConfigurationResponse(value) {
    return true;
}
export function RateLimitQuotasReadConfigurationResponseFromJSON(json) {
    return RateLimitQuotasReadConfigurationResponseFromJSONTyped(json, false);
}
export function RateLimitQuotasReadConfigurationResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function RateLimitQuotasReadConfigurationResponseToJSON(json) {
    return RateLimitQuotasReadConfigurationResponseToJSONTyped(json, false);
}
export function RateLimitQuotasReadConfigurationResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
