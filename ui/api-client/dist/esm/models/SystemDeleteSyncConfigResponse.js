 ...
 */
export function instanceOfSystemDeleteSyncConfigResponse(value) {
    return true;
}
export function SystemDeleteSyncConfigResponseFromJSON(json) {
    return SystemDeleteSyncConfigResponseFromJSONTyped(json, false);
}
export function SystemDeleteSyncConfigResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SystemDeleteSyncConfigResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
