 ...
 */
export function instanceOfSystemWriteStorageRaftSnapshotLoadResponse(value) {
    return true;
}
export function SystemWriteStorageRaftSnapshotLoadResponseFromJSON(json) {
    return SystemWriteStorageRaftSnapshotLoadResponseFromJSONTyped(json, false);
}
export function SystemWriteStorageRaftSnapshotLoadResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SystemWriteStorageRaftSnapshotLoadResponseToJSON(json) {
    return SystemWriteStorageRaftSnapshotLoadResponseToJSONTyped(json, false);
}
export function SystemWriteStorageRaftSnapshotLoadResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
