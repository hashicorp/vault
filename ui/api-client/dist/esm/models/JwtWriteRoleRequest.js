 ...
 */
export function instanceOfJwtWriteRoleRequest(value) {
    return true;
}
export function JwtWriteRoleRequestFromJSON(json) {
    return JwtWriteRoleRequestFromJSONTyped(json, false);
}
export function JwtWriteRoleRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function JwtWriteRoleRequestToJSON(json) {
    return JwtWriteRoleRequestToJSONTyped(json, false);
}
export function JwtWriteRoleRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
