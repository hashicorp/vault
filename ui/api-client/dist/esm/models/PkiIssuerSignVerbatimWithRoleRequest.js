...
* @enum {string}
*/
export var PkiIssuerSignVerbatimWithRoleRequestFormatEnum;
...
})(PkiIssuerSignVerbatimWithRoleRequestFormatEnum || (PkiIssuerSignVerbatimWithRoleRequestFormatEnum = {}));
/**
* @export
* @enum {string}
*/
export var PkiIssuerSignVerbatimWithRoleRequestPrivateKeyFormatEnum;
...
})(PkiIssuerSignVerbatimWithRoleRequestPrivateKeyFormatEnum || (PkiIssuerSignVerbatimWithRoleRequestPrivateKeyFormatEnum = {}));
/**
 * Check if a given object implements the PkiIssuerSignVerbatimWithRoleRequest interface.
 */
export function instanceOfPkiIssuerSignVerbatimWithRoleRequest(value) {
    return true;
}
export function PkiIssuerSignVerbatimWithRoleRequestFromJSON(json) {
    return PkiIssuerSignVerbatimWithRoleRequestFromJSONTyped(json, false);
}
export function PkiIssuerSignVerbatimWithRoleRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiIssuerSignVerbatimWithRoleRequestToJSON(json) {
    return PkiIssuerSignVerbatimWithRoleRequestToJSONTyped(json, false);
}
export function PkiIssuerSignVerbatimWithRoleRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
