 ...
 */
export function instanceOfSystemWriteManagedKeysTypeNameRequest(value) {
    return true;
}
export function SystemWriteManagedKeysTypeNameRequestFromJSON(json) {
    return SystemWriteManagedKeysTypeNameRequestFromJSONTyped(json, false);
}
export function SystemWriteManagedKeysTypeNameRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SystemWriteManagedKeysTypeNameRequestToJSON(json) {
    return SystemWriteManagedKeysTypeNameRequestToJSONTyped(json, false);
}
export function SystemWriteManagedKeysTypeNameRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
