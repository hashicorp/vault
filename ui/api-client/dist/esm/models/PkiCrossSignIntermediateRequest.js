...
* @enum {string}
*/
export var PkiCrossSignIntermediateRequestExportedEnum;
...
})(PkiCrossSignIntermediateRequestExportedEnum || (PkiCrossSignIntermediateRequestExportedEnum = {}));
/**
* @export
* @enum {string}
*/
export var PkiCrossSignIntermediateRequestFormatEnum;
...
})(PkiCrossSignIntermediateRequestFormatEnum || (PkiCrossSignIntermediateRequestFormatEnum = {}));
/**
* @export
* @enum {string}
*/
export var PkiCrossSignIntermediateRequestKeyTypeEnum;
...
})(PkiCrossSignIntermediateRequestKeyTypeEnum || (PkiCrossSignIntermediateRequestKeyTypeEnum = {}));
/**
* @export
* @enum {string}
*/
export var PkiCrossSignIntermediateRequestPrivateKeyFormatEnum;
...
})(PkiCrossSignIntermediateRequestPrivateKeyFormatEnum || (PkiCrossSignIntermediateRequestPrivateKeyFormatEnum = {}));
/**
 * Check if a given object implements the PkiCrossSignIntermediateRequest interface.
 */
export function instanceOfPkiCrossSignIntermediateRequest(value) {
    return true;
}
export function PkiCrossSignIntermediateRequestFromJSON(json) {
    return PkiCrossSignIntermediateRequestFromJSONTyped(json, false);
}
export function PkiCrossSignIntermediateRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiCrossSignIntermediateRequestToJSON(json) {
    return PkiCrossSignIntermediateRequestToJSONTyped(json, false);
}
export function PkiCrossSignIntermediateRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
