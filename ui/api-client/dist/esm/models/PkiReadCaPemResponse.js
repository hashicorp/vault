 ...
 */
export function instanceOfPkiReadCaPemResponse(value) {
    return true;
}
export function PkiReadCaPemResponseFromJSON(json) {
    return PkiReadCaPemResponseFromJSONTyped(json, false);
}
export function PkiReadCaPemResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiReadCaPemResponseToJSON(json) {
    return PkiReadCaPemResponseToJSONTyped(json, false);
}
export function PkiReadCaPemResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
