...
* @enum {string}
*/
export var PkiIssuerSignVerbatimRequestFormatEnum;
...
})(PkiIssuerSignVerbatimRequestFormatEnum || (PkiIssuerSignVerbatimRequestFormatEnum = {}));
/**
* @export
* @enum {string}
*/
export var PkiIssuerSignVerbatimRequestPrivateKeyFormatEnum;
...
})(PkiIssuerSignVerbatimRequestPrivateKeyFormatEnum || (PkiIssuerSignVerbatimRequestPrivateKeyFormatEnum = {}));
/**
 * Check if a given object implements the PkiIssuerSignVerbatimRequest interface.
 */
export function instanceOfPkiIssuerSignVerbatimRequest(value) {
    return true;
}
export function PkiIssuerSignVerbatimRequestFromJSON(json) {
    return PkiIssuerSignVerbatimRequestFromJSONTyped(json, false);
}
export function PkiIssuerSignVerbatimRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiIssuerSignVerbatimRequestToJSON(json) {
    return PkiIssuerSignVerbatimRequestToJSONTyped(json, false);
}
export function PkiIssuerSignVerbatimRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
