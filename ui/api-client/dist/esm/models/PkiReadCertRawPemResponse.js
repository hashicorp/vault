 ...
 */
export function instanceOfPkiReadCertRawPemResponse(value) {
    return true;
}
export function PkiReadCertRawPemResponseFromJSON(json) {
    return PkiReadCertRawPemResponseFromJSONTyped(json, false);
}
export function PkiReadCertRawPemResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiReadCertRawPemResponseToJSON(json) {
    return PkiReadCertRawPemResponseToJSONTyped(json, false);
}
export function PkiReadCertRawPemResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
