 ...
 */
export function instanceOfRootTokenGenerationReadProgress2Response(value) {
    return true;
}
export function RootTokenGenerationReadProgress2ResponseFromJSON(json) {
    return RootTokenGenerationReadProgress2ResponseFromJSONTyped(json, false);
}
export function RootTokenGenerationReadProgress2ResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function RootTokenGenerationReadProgress2ResponseToJSON(json) {
    return RootTokenGenerationReadProgress2ResponseToJSONTyped(json, false);
}
export function RootTokenGenerationReadProgress2ResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
