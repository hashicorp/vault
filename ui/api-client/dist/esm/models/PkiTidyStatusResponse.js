 ...
 */
export function instanceOfPkiTidyStatusResponse(value) {
    return true;
}
export function PkiTidyStatusResponseFromJSON(json) {
    return PkiTidyStatusResponseFromJSONTyped(json, false);
}
export function PkiTidyStatusResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiTidyStatusResponseToJSON(json) {
    return PkiTidyStatusResponseToJSONTyped(json, false);
}
export function PkiTidyStatusResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
