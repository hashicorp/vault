 ...
 */
export function instanceOfCloudFoundryConfigureRequest(value) {
    return true;
}
export function CloudFoundryConfigureRequestFromJSON(json) {
    return CloudFoundryConfigureRequestFromJSONTyped(json, false);
}
export function CloudFoundryConfigureRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function CloudFoundryConfigureRequestToJSON(json) {
    return CloudFoundryConfigureRequestToJSONTyped(json, false);
}
export function CloudFoundryConfigureRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
