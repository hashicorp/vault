...
* @enum {string}
*/
export var KerberosConfigureLdapRequestDereferenceAliasesEnum;
...
})(KerberosConfigureLdapRequestDereferenceAliasesEnum || (KerberosConfigureLdapRequestDereferenceAliasesEnum = {}));
/**
* @export
* @enum {string}
*/
export var KerberosConfigureLdapRequestTlsMaxVersionEnum;
...
})(KerberosConfigureLdapRequestTlsMaxVersionEnum || (KerberosConfigureLdapRequestTlsMaxVersionEnum = {}));
/**
* @export
* @enum {string}
*/
export var KerberosConfigureLdapRequestTlsMinVersionEnum;
...
})(KerberosConfigureLdapRequestTlsMinVersionEnum || (KerberosConfigureLdapRequestTlsMinVersionEnum = {}));
/**
 * Check if a given object implements the KerberosConfigureLdapRequest interface.
 */
export function instanceOfKerberosConfigureLdapRequest(value) {
    return true;
}
export function KerberosConfigureLdapRequestFromJSON(json) {
    return KerberosConfigureLdapRequestFromJSONTyped(json, false);
}
export function KerberosConfigureLdapRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function KerberosConfigureLdapRequestToJSON(json) {
    return KerberosConfigureLdapRequestToJSONTyped(json, false);
}
export function KerberosConfigureLdapRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
