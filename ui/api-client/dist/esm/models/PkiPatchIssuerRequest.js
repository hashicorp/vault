 ...
 */
export function instanceOfPkiPatchIssuerRequest(value) {
    return true;
}
export function PkiPatchIssuerRequestFromJSON(json) {
    return PkiPatchIssuerRequestFromJSONTyped(json, false);
}
export function PkiPatchIssuerRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiPatchIssuerRequestToJSON(json) {
    return PkiPatchIssuerRequestToJSONTyped(json, false);
}
export function PkiPatchIssuerRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
