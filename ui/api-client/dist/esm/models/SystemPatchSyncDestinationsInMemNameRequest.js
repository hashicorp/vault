 ...
 */
export function instanceOfSystemPatchSyncDestinationsInMemNameRequest(value) {
    return true;
}
export function SystemPatchSyncDestinationsInMemNameRequestFromJSON(json) {
    return SystemPatchSyncDestinationsInMemNameRequestFromJSONTyped(json, false);
}
export function SystemPatchSyncDestinationsInMemNameRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SystemPatchSyncDestinationsInMemNameRequestToJSON(json) {
    return SystemPatchSyncDestinationsInMemNameRequestToJSONTyped(json, false);
}
export function SystemPatchSyncDestinationsInMemNameRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
