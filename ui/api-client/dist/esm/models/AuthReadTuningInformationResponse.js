 ...
 */
export function instanceOfAuthReadTuningInformationResponse(value) {
    return true;
}
export function AuthReadTuningInformationResponseFromJSON(json) {
    return AuthReadTuningInformationResponseFromJSONTyped(json, false);
}
export function AuthReadTuningInformationResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthReadTuningInformationResponseToJSON(json) {
    return AuthReadTuningInformationResponseToJSONTyped(json, false);
}
export function AuthReadTuningInformationResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
