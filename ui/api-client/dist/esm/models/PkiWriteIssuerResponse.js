 ...
 */
export function instanceOfPkiWriteIssuerResponse(value) {
    return true;
}
export function PkiWriteIssuerResponseFromJSON(json) {
    return PkiWriteIssuerResponseFromJSONTyped(json, false);
}
export function PkiWriteIssuerResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiWriteIssuerResponseToJSON(json) {
    return PkiWriteIssuerResponseToJSONTyped(json, false);
}
export function PkiWriteIssuerResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
