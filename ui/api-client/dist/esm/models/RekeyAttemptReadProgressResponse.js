 ...
 */
export function instanceOfRekeyAttemptReadProgressResponse(value) {
    return true;
}
export function RekeyAttemptReadProgressResponseFromJSON(json) {
    return RekeyAttemptReadProgressResponseFromJSONTyped(json, false);
}
export function RekeyAttemptReadProgressResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function RekeyAttemptReadProgressResponseToJSON(json) {
    return RekeyAttemptReadProgressResponseToJSONTyped(json, false);
}
export function RekeyAttemptReadProgressResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
