 ...
 */
export function instanceOfRootTokenGenerationInitializeResponse(value) {
    return true;
}
export function RootTokenGenerationInitializeResponseFromJSON(json) {
    return RootTokenGenerationInitializeResponseFromJSONTyped(json, false);
}
export function RootTokenGenerationInitializeResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function RootTokenGenerationInitializeResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
