 ...
 */
export function instanceOfPkiReadIssuerResponse(value) {
    return true;
}
export function PkiReadIssuerResponseFromJSON(json) {
    return PkiReadIssuerResponseFromJSONTyped(json, false);
}
export function PkiReadIssuerResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiReadIssuerResponseToJSON(json) {
    return PkiReadIssuerResponseToJSONTyped(json, false);
}
export function PkiReadIssuerResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
