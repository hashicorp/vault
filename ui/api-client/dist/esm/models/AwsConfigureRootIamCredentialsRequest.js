 ...
 */
export function instanceOfAwsConfigureRootIamCredentialsRequest(value) {
    return true;
}
export function AwsConfigureRootIamCredentialsRequestFromJSON(json) {
    return AwsConfigureRootIamCredentialsRequestFromJSONTyped(json, false);
}
export function AwsConfigureRootIamCredentialsRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function AwsConfigureRootIamCredentialsRequestToJSON(json) {
    return AwsConfigureRootIamCredentialsRequestToJSONTyped(json, false);
}
export function AwsConfigureRootIamCredentialsRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
