 ...
 */
export function instanceOfPkiPatchRoleResponse(value) {
    return true;
}
export function PkiPatchRoleResponseFromJSON(json) {
    return PkiPatchRoleResponseFromJSONTyped(json, false);
}
export function PkiPatchRoleResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiPatchRoleResponseToJSON(json) {
    return PkiPatchRoleResponseToJSONTyped(json, false);
}
export function PkiPatchRoleResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
