 ...
 */
export function instanceOfPkiConfigureIssuersRequest(value) {
    return true;
}
export function PkiConfigureIssuersRequestFromJSON(json) {
    return PkiConfigureIssuersRequestFromJSONTyped(json, false);
}
export function PkiConfigureIssuersRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiConfigureIssuersRequestToJSON(json) {
    return PkiConfigureIssuersRequestToJSONTyped(json, false);
}
export function PkiConfigureIssuersRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
