...
* @enum {string}
*/
export var PkiSignWithRoleRequestFormatEnum;
...
})(PkiSignWithRoleRequestFormatEnum || (PkiSignWithRoleRequestFormatEnum = {}));
/**
* @export
* @enum {string}
*/
export var PkiSignWithRoleRequestPrivateKeyFormatEnum;
...
})(PkiSignWithRoleRequestPrivateKeyFormatEnum || (PkiSignWithRoleRequestPrivateKeyFormatEnum = {}));
/**
 * Check if a given object implements the PkiSignWithRoleRequest interface.
 */
export function instanceOfPkiSignWithRoleRequest(value) {
    return true;
}
export function PkiSignWithRoleRequestFromJSON(json) {
    return PkiSignWithRoleRequestFromJSONTyped(json, false);
}
export function PkiSignWithRoleRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiSignWithRoleRequestToJSON(json) {
    return PkiSignWithRoleRequestToJSONTyped(json, false);
}
export function PkiSignWithRoleRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
