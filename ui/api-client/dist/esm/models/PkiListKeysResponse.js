 ...
 */
export function instanceOfPkiListKeysResponse(value) {
    return true;
}
export function PkiListKeysResponseFromJSON(json) {
    return PkiListKeysResponseFromJSONTyped(json, false);
}
export function PkiListKeysResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiListKeysResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
