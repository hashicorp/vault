 ...
 */
export function instanceOfAwsWriteStaticRolesNameResponse(value) {
    return true;
}
export function AwsWriteStaticRolesNameResponseFromJSON(json) {
    return AwsWriteStaticRolesNameResponseFromJSONTyped(json, false);
}
export function AwsWriteStaticRolesNameResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function AwsWriteStaticRolesNameResponseToJSON(json) {
    return AwsWriteStaticRolesNameResponseToJSONTyped(json, false);
}
export function AwsWriteStaticRolesNameResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
