 ...
 */
export declare function instanceOfGroupsCreateDuplicatesRequest(value: object): value is GroupsCreateDuplicatesRequest;
export declare function GroupsCreateDuplicatesRequestFromJSON(json: any): GroupsCreateDuplicatesRequest;
export declare function GroupsCreateDuplicatesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): GroupsCreateDuplicatesRequest;
export declare function GroupsCreateDuplicatesRequestToJSON(json: any): GroupsCreateDuplicatesRequest;
