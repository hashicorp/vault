...
* @enum {string}
*/
export var SystemWriteStorageRaftSnapshotAutoConfigNameRequestStorageTypeEnum;
...
})(SystemWriteStorageRaftSnapshotAutoConfigNameRequestStorageTypeEnum || (SystemWriteStorageRaftSnapshotAutoConfigNameRequestStorageTypeEnum = {}));
/**
 * Check if a given object implements the SystemWriteStorageRaftSnapshotAutoConfigNameRequest interface.
 */
export function instanceOfSystemWriteStorageRaftSnapshotAutoConfigNameRequest(value) {
    return true;
}
export function SystemWriteStorageRaftSnapshotAutoConfigNameRequestFromJSON(json) {
    return SystemWriteStorageRaftSnapshotAutoConfigNameRequestFromJSONTyped(json, false);
}
export function SystemWriteStorageRaftSnapshotAutoConfigNameRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SystemWriteStorageRaftSnapshotAutoConfigNameRequestToJSON(json) {
    return SystemWriteStorageRaftSnapshotAutoConfigNameRequestToJSONTyped(json, false);
}
export function SystemWriteStorageRaftSnapshotAutoConfigNameRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
