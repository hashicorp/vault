 ...
 */
export function instanceOfAuthReadConfigurationResponse(value) {
    return true;
}
export function AuthReadConfigurationResponseFromJSON(json) {
    return AuthReadConfigurationResponseFromJSONTyped(json, false);
}
export function AuthReadConfigurationResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthReadConfigurationResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
