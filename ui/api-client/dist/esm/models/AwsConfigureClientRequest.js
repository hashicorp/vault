 ...
 */
export function instanceOfAwsConfigureClientRequest(value) {
    return true;
}
export function AwsConfigureClientRequestFromJSON(json) {
    return AwsConfigureClientRequestFromJSONTyped(json, false);
}
export function AwsConfigureClientRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function AwsConfigureClientRequestToJSON(json) {
    return AwsConfigureClientRequestToJSONTyped(json, false);
}
export function AwsConfigureClientRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
