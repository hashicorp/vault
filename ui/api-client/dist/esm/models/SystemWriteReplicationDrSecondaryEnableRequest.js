 ...
 */
export function instanceOfSystemWriteReplicationDrSecondaryEnableRequest(value) {
    return true;
}
export function SystemWriteReplicationDrSecondaryEnableRequestFromJSON(json) {
    return SystemWriteReplicationDrSecondaryEnableRequestFromJSONTyped(json, false);
}
export function SystemWriteReplicationDrSecondaryEnableRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SystemWriteReplicationDrSecondaryEnableRequestToJSON(json) {
    return SystemWriteReplicationDrSecondaryEnableRequestToJSONTyped(json, false);
}
export function SystemWriteReplicationDrSecondaryEnableRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
