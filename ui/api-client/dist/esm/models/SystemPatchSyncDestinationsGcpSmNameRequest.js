 ...
 */
export function instanceOfSystemPatchSyncDestinationsGcpSmNameRequest(value) {
    return true;
}
export function SystemPatchSyncDestinationsGcpSmNameRequestFromJSON(json) {
    return SystemPatchSyncDestinationsGcpSmNameRequestFromJSONTyped(json, false);
}
export function SystemPatchSyncDestinationsGcpSmNameRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SystemPatchSyncDestinationsGcpSmNameRequestToJSON(json) {
    return SystemPatchSyncDestinationsGcpSmNameRequestToJSONTyped(json, false);
}
export function SystemPatchSyncDestinationsGcpSmNameRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
