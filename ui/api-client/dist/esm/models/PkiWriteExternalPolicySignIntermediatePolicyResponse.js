 ...
 */
export function instanceOfPkiWriteExternalPolicySignIntermediatePolicyResponse(value) {
    return true;
}
export function PkiWriteExternalPolicySignIntermediatePolicyResponseFromJSON(json) {
    return PkiWriteExternalPolicySignIntermediatePolicyResponseFromJSONTyped(json, false);
}
export function PkiWriteExternalPolicySignIntermediatePolicyResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiWriteExternalPolicySignIntermediatePolicyResponseToJSON(json) {
    return PkiWriteExternalPolicySignIntermediatePolicyResponseToJSONTyped(json, false);
}
export function PkiWriteExternalPolicySignIntermediatePolicyResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
