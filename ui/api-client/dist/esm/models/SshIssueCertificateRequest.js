 ...
 */
export function instanceOfSshIssueCertificateRequest(value) {
    return true;
}
export function SshIssueCertificateRequestFromJSON(json) {
    return SshIssueCertificateRequestFromJSONTyped(json, false);
}
export function SshIssueCertificateRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SshIssueCertificateRequestToJSON(json) {
    return SshIssueCertificateRequestToJSONTyped(json, false);
}
export function SshIssueCertificateRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
