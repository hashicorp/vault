 ...
 */
export function instanceOfSystemWriteSyncDestinationsVercelProjectNameResponse(value) {
    return true;
}
export function SystemWriteSyncDestinationsVercelProjectNameResponseFromJSON(json) {
    return SystemWriteSyncDestinationsVercelProjectNameResponseFromJSONTyped(json, false);
}
export function SystemWriteSyncDestinationsVercelProjectNameResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SystemWriteSyncDestinationsVercelProjectNameResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
