 ...
 */
export declare function instanceOfPkiIssueWithRoleRequest(value: object): value is PkiIssueWithRoleRequest;
export declare function PkiIssueWithRoleRequestFromJSON(json: any): PkiIssueWithRoleRequest;
export declare function PkiIssueWithRoleRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PkiIssueWithRoleRequest;
export declare function PkiIssueWithRoleRequestToJSON(json: any): PkiIssueWithRoleRequest;
export declare function PkiIssueWithRoleRequestToJSONTyped(value?: PkiIssueWithRoleRequest | null, ignoreDiscriminator?: boolean): any;
