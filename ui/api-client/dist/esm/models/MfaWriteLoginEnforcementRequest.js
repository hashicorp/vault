 ...
 */
export function instanceOfMfaWriteLoginEnforcementRequest(value) {
    if (!('mfaMethodIds' in value) || value['mfaMethodIds'] === undefined)
        return false;
    return true;
}
export function MfaWriteLoginEnforcementRequestFromJSON(json) {
    return MfaWriteLoginEnforcementRequestFromJSONTyped(json, false);
}
export function MfaWriteLoginEnforcementRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function MfaWriteLoginEnforcementRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
