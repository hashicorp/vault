 ...
 */
export function instanceOfPkiWriteRolesRoleAcmeAccountKidRequest(value) {
    return true;
}
export function PkiWriteRolesRoleAcmeAccountKidRequestFromJSON(json) {
    return PkiWriteRolesRoleAcmeAccountKidRequestFromJSONTyped(json, false);
}
export function PkiWriteRolesRoleAcmeAccountKidRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiWriteRolesRoleAcmeAccountKidRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
