...
* @enum {string}
*/
export var KmipConfigureRequestDefaultTlsClientKeyTypeEnum;
...
})(KmipConfigureRequestDefaultTlsClientKeyTypeEnum || (KmipConfigureRequestDefaultTlsClientKeyTypeEnum = {}));
/**
* @export
* @enum {string}
*/
export var KmipConfigureRequestTlsCaKeyTypeEnum;
...
})(KmipConfigureRequestTlsCaKeyTypeEnum || (KmipConfigureRequestTlsCaKeyTypeEnum = {}));
/**
 * Check if a given object implements the KmipConfigureRequest interface.
 */
export function instanceOfKmipConfigureRequest(value) {
    return true;
}
export function KmipConfigureRequestFromJSON(json) {
    return KmipConfigureRequestFromJSONTyped(json, false);
}
export function KmipConfigureRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function KmipConfigureRequestToJSON(json) {
    return KmipConfigureRequestToJSONTyped(json, false);
}
export function KmipConfigureRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
