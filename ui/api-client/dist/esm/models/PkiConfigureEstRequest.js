 ...
 */
export function instanceOfPkiConfigureEstRequest(value) {
    return true;
}
export function PkiConfigureEstRequestFromJSON(json) {
    return PkiConfigureEstRequestFromJSONTyped(json, false);
}
export function PkiConfigureEstRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiConfigureEstRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
