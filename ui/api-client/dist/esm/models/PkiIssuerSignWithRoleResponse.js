 ...
 */
export function instanceOfPkiIssuerSignWithRoleResponse(value) {
    return true;
}
export function PkiIssuerSignWithRoleResponseFromJSON(json) {
    return PkiIssuerSignWithRoleResponseFromJSONTyped(json, false);
}
export function PkiIssuerSignWithRoleResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiIssuerSignWithRoleResponseToJSON(json) {
    return PkiIssuerSignWithRoleResponseToJSONTyped(json, false);
}
export function PkiIssuerSignWithRoleResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
