 ...
 */
export function instanceOfEntityLookUpRequest(value) {
    return true;
}
export function EntityLookUpRequestFromJSON(json) {
    return EntityLookUpRequestFromJSONTyped(json, false);
}
export function EntityLookUpRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function EntityLookUpRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
