 ...
 */
export function instanceOfTransitVerifyWithAlgorithmRequest(value) {
    return true;
}
export function TransitVerifyWithAlgorithmRequestFromJSON(json) {
    return TransitVerifyWithAlgorithmRequestFromJSONTyped(json, false);
}
export function TransitVerifyWithAlgorithmRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function TransitVerifyWithAlgorithmRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
