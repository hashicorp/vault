 ...
 */
export function instanceOfKerberosLoginRequest(value) {
    return true;
}
export function KerberosLoginRequestFromJSON(json) {
    return KerberosLoginRequestFromJSONTyped(json, false);
}
export function KerberosLoginRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function KerberosLoginRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
