 ...
 */
export function instanceOfPkiReadAutoTidyConfigurationResponse(value) {
    return true;
}
export function PkiReadAutoTidyConfigurationResponseFromJSON(json) {
    return PkiReadAutoTidyConfigurationResponseFromJSONTyped(json, false);
}
export function PkiReadAutoTidyConfigurationResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiReadAutoTidyConfigurationResponseToJSON(json) {
    return PkiReadAutoTidyConfigurationResponseToJSONTyped(json, false);
}
export function PkiReadAutoTidyConfigurationResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
