...
* @enum {string}
*/
export var PkiRotateRootRequestFormatEnum;
(function (PkiRotateRootRequestFormatEnum) {
    PkiRotateRootRequestFormatEnum["PEM"] = "pem";
    PkiRotateRootRequestFormatEnum["DER"] = "der";
    PkiRotateRootRequestFormatEnum["PEM_BUNDLE"] = "pem_bundle";
})(PkiRotateRootRequestFormatEnum || (PkiRotateRootRequestFormatEnum = {}));
/**
* @export
* @enum {string}
*/
export var PkiRotateRootRequestKeyTypeEnum;
(function (PkiRotateRootRequestKeyTypeEnum) {
    PkiRotateRootRequestKeyTypeEnum["RSA"] = "rsa";
    PkiRotateRootRequestKeyTypeEnum["EC"] = "ec";
    PkiRotateRootRequestKeyTypeEnum["ED25519"] = "ed25519";
})(PkiRotateRootRequestKeyTypeEnum || (PkiRotateRootRequestKeyTypeEnum = {}));
/**
* @export
* @enum {string}
*/
export var PkiRotateRootRequestPrivateKeyFormatEnum;
(function (PkiRotateRootRequestPrivateKeyFormatEnum) {
    PkiRotateRootRequestPrivateKeyFormatEnum["EMPTY"] = "";
    PkiRotateRootRequestPrivateKeyFormatEnum["DER"] = "der";
    PkiRotateRootRequestPrivateKeyFormatEnum["PEM"] = "pem";
    PkiRotateRootRequestPrivateKeyFormatEnum["PKCS8"] = "pkcs8";
})(PkiRotateRootRequestPrivateKeyFormatEnum || (PkiRotateRootRequestPrivateKeyFormatEnum = {}));
/**
 * Check if a given object implements the PkiRotateRootRequest interface.
 */
export function instanceOfPkiRotateRootRequest(value) {
    return true;
}
export function PkiRotateRootRequestFromJSON(json) {
    return PkiRotateRootRequestFromJSONTyped(json, false);
}
export function PkiRotateRootRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiRotateRootRequestToJSON(json) {
    return PkiRotateRootRequestToJSONTyped(json, false);
}
export function PkiRotateRootRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
