 ...
 */
export function instanceOfSystemWriteReplicationPerformanceSecondaryUpdatePrimaryRequest(value) {
    return true;
}
export function SystemWriteReplicationPerformanceSecondaryUpdatePrimaryRequestFromJSON(json) {
    return SystemWriteReplicationPerformanceSecondaryUpdatePrimaryRequestFromJSONTyped(json, false);
}
export function SystemWriteReplicationPerformanceSecondaryUpdatePrimaryRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SystemWriteReplicationPerformanceSecondaryUpdatePrimaryRequestToJSON(json) {
    return SystemWriteReplicationPerformanceSecondaryUpdatePrimaryRequestToJSONTyped(json, false);
}
export function SystemWriteReplicationPerformanceSecondaryUpdatePrimaryRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
