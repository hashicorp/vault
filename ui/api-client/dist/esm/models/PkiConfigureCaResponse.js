 ...
 */
export function instanceOfPkiConfigureCaResponse(value) {
    return true;
}
export function PkiConfigureCaResponseFromJSON(json) {
    return PkiConfigureCaResponseFromJSONTyped(json, false);
}
export function PkiConfigureCaResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiConfigureCaResponseToJSON(json) {
    return PkiConfigureCaResponseToJSONTyped(json, false);
}
export function PkiConfigureCaResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
