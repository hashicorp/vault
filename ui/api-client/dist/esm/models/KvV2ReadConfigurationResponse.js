 ...
 */
export function instanceOfKvV2ReadConfigurationResponse(value) {
    return true;
}
export function KvV2ReadConfigurationResponseFromJSON(json) {
    return KvV2ReadConfigurationResponseFromJSONTyped(json, false);
}
export function KvV2ReadConfigurationResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function KvV2ReadConfigurationResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
