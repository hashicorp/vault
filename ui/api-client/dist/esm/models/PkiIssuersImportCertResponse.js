 ...
 */
export function instanceOfPkiIssuersImportCertResponse(value) {
    return true;
}
export function PkiIssuersImportCertResponseFromJSON(json) {
    return PkiIssuersImportCertResponseFromJSONTyped(json, false);
}
export function PkiIssuersImportCertResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiIssuersImportCertResponseToJSON(json) {
    return PkiIssuersImportCertResponseToJSONTyped(json, false);
}
export function PkiIssuersImportCertResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
