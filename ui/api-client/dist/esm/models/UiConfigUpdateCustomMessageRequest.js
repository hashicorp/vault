 ...
 */
export function instanceOfUiConfigUpdateCustomMessageRequest(value) {
...
export function UiConfigUpdateCustomMessageRequestFromJSON(json) {
    return UiConfigUpdateCustomMessageRequestFromJSONTyped(json, false);
}
export function UiConfigUpdateCustomMessageRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function UiConfigUpdateCustomMessageRequestToJSON(json) {
    return UiConfigUpdateCustomMessageRequestToJSONTyped(json, false);
}
export function UiConfigUpdateCustomMessageRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
