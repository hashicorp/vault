 ...
 */
export function instanceOfMountsReadConfigurationResponse(value) {
    return true;
}
export function MountsReadConfigurationResponseFromJSON(json) {
    return MountsReadConfigurationResponseFromJSONTyped(json, false);
}
export function MountsReadConfigurationResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function MountsReadConfigurationResponseToJSON(json) {
    return MountsReadConfigurationResponseToJSONTyped(json, false);
}
export function MountsReadConfigurationResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
