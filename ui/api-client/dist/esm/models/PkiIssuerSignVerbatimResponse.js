 ...
 */
export function instanceOfPkiIssuerSignVerbatimResponse(value) {
    return true;
}
export function PkiIssuerSignVerbatimResponseFromJSON(json) {
    return PkiIssuerSignVerbatimResponseFromJSONTyped(json, false);
}
export function PkiIssuerSignVerbatimResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiIssuerSignVerbatimResponseToJSON(json) {
    return PkiIssuerSignVerbatimResponseToJSONTyped(json, false);
}
export function PkiIssuerSignVerbatimResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
