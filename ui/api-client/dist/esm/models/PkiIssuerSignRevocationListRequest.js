 ...
 */
export function instanceOfPkiIssuerSignRevocationListRequest(value) {
    return true;
}
export function PkiIssuerSignRevocationListRequestFromJSON(json) {
    return PkiIssuerSignRevocationListRequestFromJSONTyped(json, false);
}
export function PkiIssuerSignRevocationListRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiIssuerSignRevocationListRequestToJSON(json) {
    return PkiIssuerSignRevocationListRequestToJSONTyped(json, false);
}
export function PkiIssuerSignRevocationListRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
