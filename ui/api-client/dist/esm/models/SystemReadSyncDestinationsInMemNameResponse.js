 ...
 */
export function instanceOfSystemReadSyncDestinationsInMemNameResponse(value) {
    return true;
}
export function SystemReadSyncDestinationsInMemNameResponseFromJSON(json) {
    return SystemReadSyncDestinationsInMemNameResponseFromJSONTyped(json, false);
}
export function SystemReadSyncDestinationsInMemNameResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SystemReadSyncDestinationsInMemNameResponseToJSON(json) {
    return SystemReadSyncDestinationsInMemNameResponseToJSONTyped(json, false);
}
export function SystemReadSyncDestinationsInMemNameResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
