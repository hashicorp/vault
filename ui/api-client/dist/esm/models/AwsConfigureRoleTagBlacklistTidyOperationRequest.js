 ...
 */
export function instanceOfAwsConfigureRoleTagBlacklistTidyOperationRequest(value) {
    return true;
}
export function AwsConfigureRoleTagBlacklistTidyOperationRequestFromJSON(json) {
    return AwsConfigureRoleTagBlacklistTidyOperationRequestFromJSONTyped(json, false);
}
export function AwsConfigureRoleTagBlacklistTidyOperationRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function AwsConfigureRoleTagBlacklistTidyOperationRequestToJSON(json) {
    return AwsConfigureRoleTagBlacklistTidyOperationRequestToJSONTyped(json, false);
}
export function AwsConfigureRoleTagBlacklistTidyOperationRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
