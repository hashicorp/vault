 ...
 */
export function instanceOfRootTokenGenerationUpdateResponse(value) {
    return true;
}
export function RootTokenGenerationUpdateResponseFromJSON(json) {
    return RootTokenGenerationUpdateResponseFromJSONTyped(json, false);
}
export function RootTokenGenerationUpdateResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function RootTokenGenerationUpdateResponseToJSON(json) {
    return RootTokenGenerationUpdateResponseToJSONTyped(json, false);
}
export function RootTokenGenerationUpdateResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
