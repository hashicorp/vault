 ...
 */
export function instanceOfEntityUpdateAliasByIdRequest(value) {
    return true;
}
export function EntityUpdateAliasByIdRequestFromJSON(json) {
    return EntityUpdateAliasByIdRequestFromJSONTyped(json, false);
}
export function EntityUpdateAliasByIdRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function EntityUpdateAliasByIdRequestToJSON(json) {
    return EntityUpdateAliasByIdRequestToJSONTyped(json, false);
}
export function EntityUpdateAliasByIdRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
