 ...
 */
export function instanceOfPkiWriteKeyResponse(value) {
    return true;
}
export function PkiWriteKeyResponseFromJSON(json) {
    return PkiWriteKeyResponseFromJSONTyped(json, false);
}
export function PkiWriteKeyResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiWriteKeyResponseToJSON(json) {
    return PkiWriteKeyResponseToJSONTyped(json, false);
}
export function PkiWriteKeyResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
