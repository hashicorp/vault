 ...
 */
export function instanceOfSystemPatchSyncDestinationsAwsSmNameRequest(value) {
    return true;
}
export function SystemPatchSyncDestinationsAwsSmNameRequestFromJSON(json) {
    return SystemPatchSyncDestinationsAwsSmNameRequestFromJSONTyped(json, false);
}
export function SystemPatchSyncDestinationsAwsSmNameRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SystemPatchSyncDestinationsAwsSmNameRequestToJSON(json) {
    return SystemPatchSyncDestinationsAwsSmNameRequestToJSONTyped(json, false);
}
export function SystemPatchSyncDestinationsAwsSmNameRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
