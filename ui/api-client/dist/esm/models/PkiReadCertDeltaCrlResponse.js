 ...
 */
export function instanceOfPkiReadCertDeltaCrlResponse(value) {
    return true;
}
export function PkiReadCertDeltaCrlResponseFromJSON(json) {
    return PkiReadCertDeltaCrlResponseFromJSONTyped(json, false);
}
export function PkiReadCertDeltaCrlResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiReadCertDeltaCrlResponseToJSON(json) {
    return PkiReadCertDeltaCrlResponseToJSONTyped(json, false);
}
export function PkiReadCertDeltaCrlResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
