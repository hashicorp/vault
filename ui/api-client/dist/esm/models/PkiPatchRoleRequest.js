...
* @enum {string}
*/
export var PkiPatchRoleRequestKeyTypeEnum;
...
})(PkiPatchRoleRequestKeyTypeEnum || (PkiPatchRoleRequestKeyTypeEnum = {}));
/**
 * Check if a given object implements the PkiPatchRoleRequest interface.
 */
export function instanceOfPkiPatchRoleRequest(value) {
    return true;
}
export function PkiPatchRoleRequestFromJSON(json) {
    return PkiPatchRoleRequestFromJSONTyped(json, false);
}
export function PkiPatchRoleRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiPatchRoleRequestToJSON(json) {
    return PkiPatchRoleRequestToJSONTyped(json, false);
}
export function PkiPatchRoleRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
