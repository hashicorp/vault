 ...
 */
export function instanceOfUserpassWriteUserRequest(value) {
    return true;
}
export function UserpassWriteUserRequestFromJSON(json) {
    return UserpassWriteUserRequestFromJSONTyped(json, false);
}
export function UserpassWriteUserRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function UserpassWriteUserRequestToJSON(json) {
    return UserpassWriteUserRequestToJSONTyped(json, false);
}
export function UserpassWriteUserRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
