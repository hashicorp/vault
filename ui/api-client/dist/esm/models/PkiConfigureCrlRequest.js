 ...
 */
export function instanceOfPkiConfigureCrlRequest(value) {
    return true;
}
export function PkiConfigureCrlRequestFromJSON(json) {
    return PkiConfigureCrlRequestFromJSONTyped(json, false);
}
export function PkiConfigureCrlRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiConfigureCrlRequestToJSON(json) {
    return PkiConfigureCrlRequestToJSONTyped(json, false);
}
export function PkiConfigureCrlRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
