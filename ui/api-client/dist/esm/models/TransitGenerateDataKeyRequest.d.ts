 ...
 */
export declare function instanceOfTransitGenerateDataKeyRequest(value: object): value is TransitGenerateDataKeyRequest;
export declare function TransitGenerateDataKeyRequestFromJSON(json: any): TransitGenerateDataKeyRequest;
export declare function TransitGenerateDataKeyRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransitGenerateDataKeyRequest;
export declare function TransitGenerateDataKeyRequestToJSON(json: any): TransitGenerateDataKeyRequest;
