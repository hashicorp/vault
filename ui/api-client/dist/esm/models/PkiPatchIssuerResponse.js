 ...
 */
export function instanceOfPkiPatchIssuerResponse(value) {
    return true;
}
export function PkiPatchIssuerResponseFromJSON(json) {
    return PkiPatchIssuerResponseFromJSONTyped(json, false);
}
export function PkiPatchIssuerResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiPatchIssuerResponseToJSON(json) {
    return PkiPatchIssuerResponseToJSONTyped(json, false);
}
export function PkiPatchIssuerResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
