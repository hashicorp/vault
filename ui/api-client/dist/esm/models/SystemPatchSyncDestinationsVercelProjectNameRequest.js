 ...
 */
export function instanceOfSystemPatchSyncDestinationsVercelProjectNameRequest(value) {
    return true;
}
export function SystemPatchSyncDestinationsVercelProjectNameRequestFromJSON(json) {
    return SystemPatchSyncDestinationsVercelProjectNameRequestFromJSONTyped(json, false);
}
export function SystemPatchSyncDestinationsVercelProjectNameRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SystemPatchSyncDestinationsVercelProjectNameRequestToJSON(json) {
    return SystemPatchSyncDestinationsVercelProjectNameRequestToJSONTyped(json, false);
}
export function SystemPatchSyncDestinationsVercelProjectNameRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
