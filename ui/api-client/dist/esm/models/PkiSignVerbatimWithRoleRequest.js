...
* @enum {string}
*/
export var PkiSignVerbatimWithRoleRequestFormatEnum;
(function (PkiSignVerbatimWithRoleRequestFormatEnum) {
    PkiSignVerbatimWithRoleRequestFormatEnum["PEM"] = "pem";
    PkiSignVerbatimWithRoleRequestFormatEnum["DER"] = "der";
    PkiSignVerbatimWithRoleRequestFormatEnum["PEM_BUNDLE"] = "pem_bundle";
})(PkiSignVerbatimWithRoleRequestFormatEnum || (PkiSignVerbatimWithRoleRequestFormatEnum = {}));
/**
* @export
* @enum {string}
*/
export var PkiSignVerbatimWithRoleRequestPrivateKeyFormatEnum;
(function (PkiSignVerbatimWithRoleRequestPrivateKeyFormatEnum) {
    PkiSignVerbatimWithRoleRequestPrivateKeyFormatEnum["EMPTY"] = "";
    PkiSignVerbatimWithRoleRequestPrivateKeyFormatEnum["DER"] = "der";
    PkiSignVerbatimWithRoleRequestPrivateKeyFormatEnum["PEM"] = "pem";
    PkiSignVerbatimWithRoleRequestPrivateKeyFormatEnum["PKCS8"] = "pkcs8";
})(PkiSignVerbatimWithRoleRequestPrivateKeyFormatEnum || (PkiSignVerbatimWithRoleRequestPrivateKeyFormatEnum = {}));
/**
 * Check if a given object implements the PkiSignVerbatimWithRoleRequest interface.
 */
export function instanceOfPkiSignVerbatimWithRoleRequest(value) {
    return true;
}
export function PkiSignVerbatimWithRoleRequestFromJSON(json) {
    return PkiSignVerbatimWithRoleRequestFromJSONTyped(json, false);
}
export function PkiSignVerbatimWithRoleRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiSignVerbatimWithRoleRequestToJSON(json) {
    return PkiSignVerbatimWithRoleRequestToJSONTyped(json, false);
}
export function PkiSignVerbatimWithRoleRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
