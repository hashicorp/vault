...
* @enum {string}
*/
export var PkiIssuersGenerateRootRequestFormatEnum;
...
})(PkiIssuersGenerateRootRequestFormatEnum || (PkiIssuersGenerateRootRequestFormatEnum = {}));
/**
* @export
* @enum {string}
*/
export var PkiIssuersGenerateRootRequestKeyTypeEnum;
...
})(PkiIssuersGenerateRootRequestKeyTypeEnum || (PkiIssuersGenerateRootRequestKeyTypeEnum = {}));
/**
* @export
* @enum {string}
*/
export var PkiIssuersGenerateRootRequestPrivateKeyFormatEnum;
...
})(PkiIssuersGenerateRootRequestPrivateKeyFormatEnum || (PkiIssuersGenerateRootRequestPrivateKeyFormatEnum = {}));
/**
 * Check if a given object implements the PkiIssuersGenerateRootRequest interface.
 */
export function instanceOfPkiIssuersGenerateRootRequest(value) {
    return true;
}
export function PkiIssuersGenerateRootRequestFromJSON(json) {
    return PkiIssuersGenerateRootRequestFromJSONTyped(json, false);
}
export function PkiIssuersGenerateRootRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiIssuersGenerateRootRequestToJSON(json) {
    return PkiIssuersGenerateRootRequestToJSONTyped(json, false);
}
export function PkiIssuersGenerateRootRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
