 ...
 */
export function instanceOfGoogleCloudWriteRoleRequest(value) {
    return true;
}
export function GoogleCloudWriteRoleRequestFromJSON(json) {
    return GoogleCloudWriteRoleRequestFromJSONTyped(json, false);
}
export function GoogleCloudWriteRoleRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function GoogleCloudWriteRoleRequestToJSON(json) {
    return GoogleCloudWriteRoleRequestToJSONTyped(json, false);
}
export function GoogleCloudWriteRoleRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
