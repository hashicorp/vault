 ...
 */
export function instanceOfPkiWriteRoleResponse(value) {
    return true;
}
export function PkiWriteRoleResponseFromJSON(json) {
    return PkiWriteRoleResponseFromJSONTyped(json, false);
}
export function PkiWriteRoleResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiWriteRoleResponseToJSON(json) {
    return PkiWriteRoleResponseToJSONTyped(json, false);
}
export function PkiWriteRoleResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
