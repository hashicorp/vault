 ...
 */
export function instanceOfTransitGenerateHmacRequest(value) {
    return true;
}
export function TransitGenerateHmacRequestFromJSON(json) {
    return TransitGenerateHmacRequestFromJSONTyped(json, false);
}
export function TransitGenerateHmacRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function TransitGenerateHmacRequestToJSON(json) {
    return TransitGenerateHmacRequestToJSONTyped(json, false);
}
export function TransitGenerateHmacRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
