 ...
 */
export declare function instanceOfTransitSignRequest(value: object): value is TransitSignRequest;
export declare function TransitSignRequestFromJSON(json: any): TransitSignRequest;
export declare function TransitSignRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransitSignRequest;
export declare function TransitSignRequestToJSON(json: any): TransitSignRequest;
export declare function TransitSignRequestToJSONTyped(value?: TransitSignRequest | null, ignoreDiscriminator?: boolean): any;
