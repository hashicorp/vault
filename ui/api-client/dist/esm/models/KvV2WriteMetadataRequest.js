 ...
 */
export function instanceOfKvV2WriteMetadataRequest(value) {
    return true;
}
export function KvV2WriteMetadataRequestFromJSON(json) {
    return KvV2WriteMetadataRequestFromJSONTyped(json, false);
}
export function KvV2WriteMetadataRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function KvV2WriteMetadataRequestToJSON(json) {
    return KvV2WriteMetadataRequestToJSONTyped(json, false);
}
export function KvV2WriteMetadataRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
