 ...
 */
export function instanceOfTokenCreateAgainstRoleRequest(value) {
    return true;
}
export function TokenCreateAgainstRoleRequestFromJSON(json) {
    return TokenCreateAgainstRoleRequestFromJSONTyped(json, false);
}
export function TokenCreateAgainstRoleRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function TokenCreateAgainstRoleRequestToJSON(json) {
    return TokenCreateAgainstRoleRequestToJSONTyped(json, false);
}
export function TokenCreateAgainstRoleRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
