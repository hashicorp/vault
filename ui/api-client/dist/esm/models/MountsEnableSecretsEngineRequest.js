 ...
 */
export function instanceOfMountsEnableSecretsEngineRequest(value) {
    return true;
}
export function MountsEnableSecretsEngineRequestFromJSON(json) {
    return MountsEnableSecretsEngineRequestFromJSONTyped(json, false);
}
export function MountsEnableSecretsEngineRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function MountsEnableSecretsEngineRequestToJSON(json) {
    return MountsEnableSecretsEngineRequestToJSONTyped(json, false);
}
export function MountsEnableSecretsEngineRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
