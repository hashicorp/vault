 ...
 */
export function instanceOfSystemWriteSyncDestinationsAwsSmNameRequest(value) {
    return true;
}
export function SystemWriteSyncDestinationsAwsSmNameRequestFromJSON(json) {
    return SystemWriteSyncDestinationsAwsSmNameRequestFromJSONTyped(json, false);
}
export function SystemWriteSyncDestinationsAwsSmNameRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SystemWriteSyncDestinationsAwsSmNameRequestToJSON(json) {
    return SystemWriteSyncDestinationsAwsSmNameRequestToJSONTyped(json, false);
}
export function SystemWriteSyncDestinationsAwsSmNameRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
