 ...
 */
export function instanceOfSubscriptionsWriteEventsSubscriptionsResponse(value) {
    return true;
}
export function SubscriptionsWriteEventsSubscriptionsResponseFromJSON(json) {
    return SubscriptionsWriteEventsSubscriptionsResponseFromJSONTyped(json, false);
}
export function SubscriptionsWriteEventsSubscriptionsResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SubscriptionsWriteEventsSubscriptionsResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
