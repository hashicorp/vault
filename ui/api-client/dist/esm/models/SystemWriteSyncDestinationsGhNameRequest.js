 ...
 */
export function instanceOfSystemWriteSyncDestinationsGhNameRequest(value) {
    return true;
}
export function SystemWriteSyncDestinationsGhNameRequestFromJSON(json) {
    return SystemWriteSyncDestinationsGhNameRequestFromJSONTyped(json, false);
}
export function SystemWriteSyncDestinationsGhNameRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SystemWriteSyncDestinationsGhNameRequestToJSON(json) {
    return SystemWriteSyncDestinationsGhNameRequestToJSONTyped(json, false);
}
export function SystemWriteSyncDestinationsGhNameRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
