 ...
 */
export function instanceOfPkiReadRoleResponse(value) {
    return true;
}
export function PkiReadRoleResponseFromJSON(json) {
    return PkiReadRoleResponseFromJSONTyped(json, false);
}
export function PkiReadRoleResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiReadRoleResponseToJSON(json) {
    return PkiReadRoleResponseToJSONTyped(json, false);
}
export function PkiReadRoleResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
