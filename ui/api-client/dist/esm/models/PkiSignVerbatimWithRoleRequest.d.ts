...
* @enum {string}
*/
export declare enum PkiSignVerbatimWithRoleRequestFormatEnum {
    PEM = "pem",
    DER = "der",
...
* @enum {string}
*/
export declare enum PkiSignVerbatimWithRoleRequestPrivateKeyFormatEnum {
    EMPTY = "",
    DER = "der",
    PEM = "pem",
    PKCS8 = "pkcs8"
 ...
 */
export declare function instanceOfPkiSignVerbatimWithRoleRequest(value: object): value is PkiSignVerbatimWithRoleRequest;
export declare function PkiSignVerbatimWithRoleRequestFromJSON(json: any): PkiSignVerbatimWithRoleRequest;
export declare function PkiSignVerbatimWithRoleRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PkiSignVerbatimWithRoleRequest;
export declare function PkiSignVerbatimWithRoleRequestToJSON(json: any): PkiSignVerbatimWithRoleRequest;
export declare function PkiSignVerbatimWithRoleRequestToJSONTyped(value?: PkiSignVerbatimWithRoleRequest | null, ignoreDiscriminator?: boolean): any;
