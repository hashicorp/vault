 ...
 */
export function instanceOfKubernetesWriteAuthRoleRequest(value) {
    return true;
}
export function KubernetesWriteAuthRoleRequestFromJSON(json) {
    return KubernetesWriteAuthRoleRequestFromJSONTyped(json, false);
}
export function KubernetesWriteAuthRoleRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function KubernetesWriteAuthRoleRequestToJSON(json) {
    return KubernetesWriteAuthRoleRequestToJSONTyped(json, false);
}
export function KubernetesWriteAuthRoleRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
