 ...
 */
export function instanceOfConsulWriteRoleRequest(value) {
    return true;
}
export function ConsulWriteRoleRequestFromJSON(json) {
    return ConsulWriteRoleRequestFromJSONTyped(json, false);
}
export function ConsulWriteRoleRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function ConsulWriteRoleRequestToJSON(json) {
    return ConsulWriteRoleRequestToJSONTyped(json, false);
}
export function ConsulWriteRoleRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
