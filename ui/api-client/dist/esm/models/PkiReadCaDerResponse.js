 ...
 */
export function instanceOfPkiReadCaDerResponse(value) {
    return true;
}
export function PkiReadCaDerResponseFromJSON(json) {
    return PkiReadCaDerResponseFromJSONTyped(json, false);
}
export function PkiReadCaDerResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiReadCaDerResponseToJSON(json) {
    return PkiReadCaDerResponseToJSONTyped(json, false);
}
export function PkiReadCaDerResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
