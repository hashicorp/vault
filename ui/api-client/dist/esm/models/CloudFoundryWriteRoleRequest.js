 ...
 */
export function instanceOfCloudFoundryWriteRoleRequest(value) {
    return true;
}
export function CloudFoundryWriteRoleRequestFromJSON(json) {
    return CloudFoundryWriteRoleRequestFromJSONTyped(json, false);
}
export function CloudFoundryWriteRoleRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function CloudFoundryWriteRoleRequestToJSON(json) {
    return CloudFoundryWriteRoleRequestToJSONTyped(json, false);
}
export function CloudFoundryWriteRoleRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
