...
})(PkiGenerateExportedKeyRequestKeyTypeEnum || (PkiGenerateExportedKeyRequestKeyTypeEnum = {}));
/**
 * Check if a given object implements the PkiGenerateExportedKeyRequest interface.
 */
export function instanceOfPkiGenerateExportedKeyRequest(value) {
    return true;
}
export function PkiGenerateExportedKeyRequestFromJSON(json) {
    return PkiGenerateExportedKeyRequestFromJSONTyped(json, false);
}
export function PkiGenerateExportedKeyRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiGenerateExportedKeyRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
