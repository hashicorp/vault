 ...
 */
export function instanceOfAppRoleWriteSecretIdTtlRequest(value) {
    return true;
}
export function AppRoleWriteSecretIdTtlRequestFromJSON(json) {
    return AppRoleWriteSecretIdTtlRequestFromJSONTyped(json, false);
}
export function AppRoleWriteSecretIdTtlRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function AppRoleWriteSecretIdTtlRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
