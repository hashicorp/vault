 ...
 */
export function instanceOfAuthTuneConfigurationParametersRequest(value) {
    return true;
}
export function AuthTuneConfigurationParametersRequestFromJSON(json) {
    return AuthTuneConfigurationParametersRequestFromJSONTyped(json, false);
}
export function AuthTuneConfigurationParametersRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthTuneConfigurationParametersRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
