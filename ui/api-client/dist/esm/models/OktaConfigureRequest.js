 ...
 */
export function instanceOfOktaConfigureRequest(value) {
    return true;
}
export function OktaConfigureRequestFromJSON(json) {
    return OktaConfigureRequestFromJSONTyped(json, false);
}
export function OktaConfigureRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function OktaConfigureRequestToJSON(json) {
    return OktaConfigureRequestToJSONTyped(json, false);
}
export function OktaConfigureRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
