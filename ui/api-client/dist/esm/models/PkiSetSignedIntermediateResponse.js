 ...
 */
export function instanceOfPkiSetSignedIntermediateResponse(value) {
    return true;
}
export function PkiSetSignedIntermediateResponseFromJSON(json) {
    return PkiSetSignedIntermediateResponseFromJSONTyped(json, false);
}
export function PkiSetSignedIntermediateResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiSetSignedIntermediateResponseToJSON(json) {
    return PkiSetSignedIntermediateResponseToJSONTyped(json, false);
}
export function PkiSetSignedIntermediateResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
