 ...
 */
export function instanceOfPkiRotateRootResponse(value) {
    return true;
}
export function PkiRotateRootResponseFromJSON(json) {
    return PkiRotateRootResponseFromJSONTyped(json, false);
}
export function PkiRotateRootResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiRotateRootResponseToJSON(json) {
    return PkiRotateRootResponseToJSONTyped(json, false);
}
export function PkiRotateRootResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
