 ...
 */
export function instanceOfGroupUpdateByNameRequest(value) {
    return true;
}
export function GroupUpdateByNameRequestFromJSON(json) {
    return GroupUpdateByNameRequestFromJSONTyped(json, false);
}
export function GroupUpdateByNameRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function GroupUpdateByNameRequestToJSON(json) {
    return GroupUpdateByNameRequestToJSONTyped(json, false);
}
export function GroupUpdateByNameRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
