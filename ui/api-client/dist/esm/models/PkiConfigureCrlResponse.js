 ...
 */
export function instanceOfPkiConfigureCrlResponse(value) {
    return true;
}
export function PkiConfigureCrlResponseFromJSON(json) {
    return PkiConfigureCrlResponseFromJSONTyped(json, false);
}
export function PkiConfigureCrlResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiConfigureCrlResponseToJSON(json) {
    return PkiConfigureCrlResponseToJSONTyped(json, false);
}
export function PkiConfigureCrlResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
