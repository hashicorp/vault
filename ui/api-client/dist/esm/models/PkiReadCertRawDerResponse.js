 ...
 */
export function instanceOfPkiReadCertRawDerResponse(value) {
    return true;
}
export function PkiReadCertRawDerResponseFromJSON(json) {
    return PkiReadCertRawDerResponseFromJSONTyped(json, false);
}
export function PkiReadCertRawDerResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiReadCertRawDerResponseToJSON(json) {
    return PkiReadCertRawDerResponseToJSONTyped(json, false);
}
export function PkiReadCertRawDerResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
