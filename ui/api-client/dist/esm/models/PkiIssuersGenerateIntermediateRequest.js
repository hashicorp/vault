...
* @enum {string}
*/
export var PkiIssuersGenerateIntermediateRequestFormatEnum;
...
})(PkiIssuersGenerateIntermediateRequestFormatEnum || (PkiIssuersGenerateIntermediateRequestFormatEnum = {}));
/**
* @export
* @enum {string}
*/
export var PkiIssuersGenerateIntermediateRequestKeyTypeEnum;
...
})(PkiIssuersGenerateIntermediateRequestKeyTypeEnum || (PkiIssuersGenerateIntermediateRequestKeyTypeEnum = {}));
/**
* @export
* @enum {string}
*/
export var PkiIssuersGenerateIntermediateRequestPrivateKeyFormatEnum;
...
})(PkiIssuersGenerateIntermediateRequestPrivateKeyFormatEnum || (PkiIssuersGenerateIntermediateRequestPrivateKeyFormatEnum = {}));
/**
 * Check if a given object implements the PkiIssuersGenerateIntermediateRequest interface.
 */
export function instanceOfPkiIssuersGenerateIntermediateRequest(value) {
    return true;
}
export function PkiIssuersGenerateIntermediateRequestFromJSON(json) {
    return PkiIssuersGenerateIntermediateRequestFromJSONTyped(json, false);
}
export function PkiIssuersGenerateIntermediateRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiIssuersGenerateIntermediateRequestToJSON(json) {
    return PkiIssuersGenerateIntermediateRequestToJSONTyped(json, false);
}
export function PkiIssuersGenerateIntermediateRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
