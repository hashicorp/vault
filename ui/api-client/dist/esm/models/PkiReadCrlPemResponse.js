 ...
 */
export function instanceOfPkiReadCrlPemResponse(value) {
    return true;
}
export function PkiReadCrlPemResponseFromJSON(json) {
    return PkiReadCrlPemResponseFromJSONTyped(json, false);
}
export function PkiReadCrlPemResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiReadCrlPemResponseToJSON(json) {
    return PkiReadCrlPemResponseToJSONTyped(json, false);
}
export function PkiReadCrlPemResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
