...
* @enum {string}
*/
export var PkiIssuerIssueWithRoleRequestFormatEnum;
...
})(PkiIssuerIssueWithRoleRequestFormatEnum || (PkiIssuerIssueWithRoleRequestFormatEnum = {}));
/**
* @export
* @enum {string}
*/
export var PkiIssuerIssueWithRoleRequestPrivateKeyFormatEnum;
...
})(PkiIssuerIssueWithRoleRequestPrivateKeyFormatEnum || (PkiIssuerIssueWithRoleRequestPrivateKeyFormatEnum = {}));
/**
 * Check if a given object implements the PkiIssuerIssueWithRoleRequest interface.
 */
export function instanceOfPkiIssuerIssueWithRoleRequest(value) {
    return true;
}
export function PkiIssuerIssueWithRoleRequestFromJSON(json) {
    return PkiIssuerIssueWithRoleRequestFromJSONTyped(json, false);
}
export function PkiIssuerIssueWithRoleRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiIssuerIssueWithRoleRequestToJSON(json) {
    return PkiIssuerIssueWithRoleRequestToJSONTyped(json, false);
}
export function PkiIssuerIssueWithRoleRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
