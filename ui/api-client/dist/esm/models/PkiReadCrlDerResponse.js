 ...
 */
export function instanceOfPkiReadCrlDerResponse(value) {
    return true;
}
export function PkiReadCrlDerResponseFromJSON(json) {
    return PkiReadCrlDerResponseFromJSONTyped(json, false);
}
export function PkiReadCrlDerResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PkiReadCrlDerResponseToJSON(json) {
    return PkiReadCrlDerResponseToJSONTyped(json, false);
}
export function PkiReadCrlDerResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
