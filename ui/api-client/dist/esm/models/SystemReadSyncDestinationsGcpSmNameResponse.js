 ...
 */
export function instanceOfSystemReadSyncDestinationsGcpSmNameResponse(value) {
    return true;
}
export function SystemReadSyncDestinationsGcpSmNameResponseFromJSON(json) {
    return SystemReadSyncDestinationsGcpSmNameResponseFromJSONTyped(json, false);
}
export function SystemReadSyncDestinationsGcpSmNameResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function SystemReadSyncDestinationsGcpSmNameResponseToJSON(json) {
    return SystemReadSyncDestinationsGcpSmNameResponseToJSONTyped(json, false);
}
export function SystemReadSyncDestinationsGcpSmNameResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
