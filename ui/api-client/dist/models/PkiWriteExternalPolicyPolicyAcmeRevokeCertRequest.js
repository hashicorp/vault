...
exports.instanceOfPkiWriteExternalPolicyPolicyAcmeRevokeCertRequest = instanceOfPkiWriteExternalPolicyPolicyAcmeRevokeCertRequest;
...
exports.PkiWriteExternalPolicyPolicyAcmeRevokeCertRequestFromJSONTyped = PkiWriteExternalPolicyPolicyAcmeRevokeCertRequestFromJSONTyped;
 ...
 */
function instanceOfPkiWriteExternalPolicyPolicyAcmeRevokeCertRequest(value) {
    return true;
}
function PkiWriteExternalPolicyPolicyAcmeRevokeCertRequestFromJSON(json) {
    return PkiWriteExternalPolicyPolicyAcmeRevokeCertRequestFromJSONTyped(json, false);
}
function PkiWriteExternalPolicyPolicyAcmeRevokeCertRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PkiWriteExternalPolicyPolicyAcmeRevokeCertRequestToJSON(json) {
    return PkiWriteExternalPolicyPolicyAcmeRevokeCertRequestToJSONTyped(json, false);
}
function PkiWriteExternalPolicyPolicyAcmeRevokeCertRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
