...
exports.SamlWriteRoleNameRequestBoundSubjectsTypeEnum = exports.SamlWriteRoleNameRequestBoundAttributesTypeEnum = void 0;
exports.instanceOfSamlWriteRoleNameRequest = instanceOfSamlWriteRoleNameRequest;
exports.SamlWriteRoleNameRequestFromJSON = SamlWriteRoleNameRequestFromJSON;
exports.SamlWriteRoleNameRequestFromJSONTyped = SamlWriteRoleNameRequestFromJSONTyped;
exports.SamlWriteRoleNameRequestToJSON = SamlWriteRoleNameRequestToJSON;
exports.SamlWriteRoleNameRequestToJSONTyped = SamlWriteRoleNameRequestToJSONTyped;
/**
* @export
* @enum {string}
*/
var SamlWriteRoleNameRequestBoundAttributesTypeEnum;
...
})(SamlWriteRoleNameRequestBoundAttributesTypeEnum || (exports.SamlWriteRoleNameRequestBoundAttributesTypeEnum = SamlWriteRoleNameRequestBoundAttributesTypeEnum = {}));
/**
* @export
* @enum {string}
*/
var SamlWriteRoleNameRequestBoundSubjectsTypeEnum;
...
})(SamlWriteRoleNameRequestBoundSubjectsTypeEnum || (exports.SamlWriteRoleNameRequestBoundSubjectsTypeEnum = SamlWriteRoleNameRequestBoundSubjectsTypeEnum = {}));
/**
 * Check if a given object implements the SamlWriteRoleNameRequest interface.
 */
function instanceOfSamlWriteRoleNameRequest(value) {
    return true;
}
function SamlWriteRoleNameRequestFromJSON(json) {
    return SamlWriteRoleNameRequestFromJSONTyped(json, false);
}
function SamlWriteRoleNameRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function SamlWriteRoleNameRequestToJSON(json) {
    return SamlWriteRoleNameRequestToJSONTyped(json, false);
}
function SamlWriteRoleNameRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
