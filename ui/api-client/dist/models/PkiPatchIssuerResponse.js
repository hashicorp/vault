...
exports.instanceOfPkiPatchIssuerResponse = instanceOfPkiPatchIssuerResponse;
exports.PkiPatchIssuerResponseFromJSON = PkiPatchIssuerResponseFromJSON;
exports.PkiPatchIssuerResponseFromJSONTyped = PkiPatchIssuerResponseFromJSONTyped;
exports.PkiPatchIssuerResponseToJSON = PkiPatchIssuerResponseToJSON;
exports.PkiPatchIssuerResponseToJSONTyped = PkiPatchIssuerResponseToJSONTyped;
/**
 * Check if a given object implements the PkiPatchIssuerResponse interface.
 */
function instanceOfPkiPatchIssuerResponse(value) {
    return true;
}
function PkiPatchIssuerResponseFromJSON(json) {
    return PkiPatchIssuerResponseFromJSONTyped(json, false);
}
function PkiPatchIssuerResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PkiPatchIssuerResponseToJSON(json) {
    return PkiPatchIssuerResponseToJSONTyped(json, false);
}
function PkiPatchIssuerResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
