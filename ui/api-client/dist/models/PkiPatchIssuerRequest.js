...
exports.instanceOfPkiPatchIssuerRequest = instanceOfPkiPatchIssuerRequest;
exports.PkiPatchIssuerRequestFromJSON = PkiPatchIssuerRequestFromJSON;
exports.PkiPatchIssuerRequestFromJSONTyped = PkiPatchIssuerRequestFromJSONTyped;
exports.PkiPatchIssuerRequestToJSON = PkiPatchIssuerRequestToJSON;
exports.PkiPatchIssuerRequestToJSONTyped = PkiPatchIssuerRequestToJSONTyped;
/**
 * Check if a given object implements the PkiPatchIssuerRequest interface.
 */
function instanceOfPkiPatchIssuerRequest(value) {
    return true;
}
function PkiPatchIssuerRequestFromJSON(json) {
    return PkiPatchIssuerRequestFromJSONTyped(json, false);
}
function PkiPatchIssuerRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PkiPatchIssuerRequestToJSON(json) {
    return PkiPatchIssuerRequestToJSONTyped(json, false);
}
function PkiPatchIssuerRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
