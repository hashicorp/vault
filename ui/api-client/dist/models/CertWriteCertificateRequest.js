...
exports.instanceOfCertWriteCertificateRequest = instanceOfCertWriteCertificateRequest;
exports.CertWriteCertificateRequestFromJSON = CertWriteCertificateRequestFromJSON;
exports.CertWriteCertificateRequestFromJSONTyped = CertWriteCertificateRequestFromJSONTyped;
exports.CertWriteCertificateRequestToJSON = CertWriteCertificateRequestToJSON;
exports.CertWriteCertificateRequestToJSONTyped = CertWriteCertificateRequestToJSONTyped;
/**
 * Check if a given object implements the CertWriteCertificateRequest interface.
 */
function instanceOfCertWriteCertificateRequest(value) {
    return true;
}
function CertWriteCertificateRequestFromJSON(json) {
    return CertWriteCertificateRequestFromJSONTyped(json, false);
}
function CertWriteCertificateRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function CertWriteCertificateRequestToJSON(json) {
    return CertWriteCertificateRequestToJSONTyped(json, false);
}
function CertWriteCertificateRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
