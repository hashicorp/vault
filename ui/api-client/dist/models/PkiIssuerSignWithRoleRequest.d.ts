...
* @enum {string}
*/
export declare enum PkiIssuerSignWithRoleRequestFormatEnum {
    PEM = "pem",
    DER = "der",
...
* @enum {string}
*/
export declare enum PkiIssuerSignWithRoleRequestPrivateKeyFormatEnum {
    EMPTY = "",
    DER = "der",
    PEM = "pem",
    PKCS8 = "pkcs8"
 ...
 */
export declare function instanceOfPkiIssuerSignWithRoleRequest(value: object): value is PkiIssuerSignWithRoleRequest;
export declare function PkiIssuerSignWithRoleRequestFromJSON(json: any): PkiIssuerSignWithRoleRequest;
export declare function PkiIssuerSignWithRoleRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PkiIssuerSignWithRoleRequest;
export declare function PkiIssuerSignWithRoleRequestToJSON(json: any): PkiIssuerSignWithRoleRequest;
export declare function PkiIssuerSignWithRoleRequestToJSONTyped(value?: PkiIssuerSignWithRoleRequest | null, ignoreDiscriminator?: boolean): any;
