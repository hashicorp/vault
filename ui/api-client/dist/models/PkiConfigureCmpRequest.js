...
exports.instanceOfPkiConfigureCmpRequest = instanceOfPkiConfigureCmpRequest;
exports.PkiConfigureCmpRequestFromJSON = PkiConfigureCmpRequestFromJSON;
exports.PkiConfigureCmpRequestFromJSONTyped = PkiConfigureCmpRequestFromJSONTyped;
exports.PkiConfigureCmpRequestToJSON = PkiConfigureCmpRequestToJSON;
exports.PkiConfigureCmpRequestToJSONTyped = PkiConfigureCmpRequestToJSONTyped;
/**
 * Check if a given object implements the PkiConfigureCmpRequest interface.
 */
function instanceOfPkiConfigureCmpRequest(value) {
    return true;
}
function PkiConfigureCmpRequestFromJSON(json) {
    return PkiConfigureCmpRequestFromJSONTyped(json, false);
}
function PkiConfigureCmpRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PkiConfigureCmpRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
