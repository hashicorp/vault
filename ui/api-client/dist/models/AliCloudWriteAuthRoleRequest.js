...
exports.instanceOfAliCloudWriteAuthRoleRequest = instanceOfAliCloudWriteAuthRoleRequest;
exports.AliCloudWriteAuthRoleRequestFromJSON = AliCloudWriteAuthRoleRequestFromJSON;
exports.AliCloudWriteAuthRoleRequestFromJSONTyped = AliCloudWriteAuthRoleRequestFromJSONTyped;
exports.AliCloudWriteAuthRoleRequestToJSON = AliCloudWriteAuthRoleRequestToJSON;
exports.AliCloudWriteAuthRoleRequestToJSONTyped = AliCloudWriteAuthRoleRequestToJSONTyped;
/**
 * Check if a given object implements the AliCloudWriteAuthRoleRequest interface.
 */
function instanceOfAliCloudWriteAuthRoleRequest(value) {
    return true;
}
function AliCloudWriteAuthRoleRequestFromJSON(json) {
    return AliCloudWriteAuthRoleRequestFromJSONTyped(json, false);
}
function AliCloudWriteAuthRoleRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function AliCloudWriteAuthRoleRequestToJSON(json) {
    return AliCloudWriteAuthRoleRequestToJSONTyped(json, false);
}
function AliCloudWriteAuthRoleRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
