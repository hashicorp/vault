...
* @enum {string}
*/
export declare enum SamlWriteRoleNameRequestBoundAttributesTypeEnum {
    STRING = "string",
    GLOB = "glob"
}
/**
...
* @enum {string}
*/
export declare enum SamlWriteRoleNameRequestBoundSubjectsTypeEnum {
    STRING = "string",
    GLOB = "glob"
}
/**
 ...
 */
export declare function instanceOfSamlWriteRoleNameRequest(value: object): value is SamlWriteRoleNameRequest;
export declare function SamlWriteRoleNameRequestFromJSON(json: any): SamlWriteRoleNameRequest;
export declare function SamlWriteRoleNameRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SamlWriteRoleNameRequest;
export declare function SamlWriteRoleNameRequestToJSON(json: any): SamlWriteRoleNameRequest;
export declare function SamlWriteRoleNameRequestToJSONTyped(value?: SamlWriteRoleNameRequest | null, ignoreDiscriminator?: boolean): any;
