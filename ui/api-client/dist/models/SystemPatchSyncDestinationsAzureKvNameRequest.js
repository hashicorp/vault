...
exports.instanceOfSystemPatchSyncDestinationsAzureKvNameRequest = instanceOfSystemPatchSyncDestinationsAzureKvNameRequest;
exports.SystemPatchSyncDestinationsAzureKvNameRequestFromJSON = SystemPatchSyncDestinationsAzureKvNameRequestFromJSON;
exports.SystemPatchSyncDestinationsAzureKvNameRequestFromJSONTyped = SystemPatchSyncDestinationsAzureKvNameRequestFromJSONTyped;
exports.SystemPatchSyncDestinationsAzureKvNameRequestToJSON = SystemPatchSyncDestinationsAzureKvNameRequestToJSON;
exports.SystemPatchSyncDestinationsAzureKvNameRequestToJSONTyped = SystemPatchSyncDestinationsAzureKvNameRequestToJSONTyped;
/**
 * Check if a given object implements the SystemPatchSyncDestinationsAzureKvNameRequest interface.
 */
function instanceOfSystemPatchSyncDestinationsAzureKvNameRequest(value) {
    return true;
}
function SystemPatchSyncDestinationsAzureKvNameRequestFromJSON(json) {
    return SystemPatchSyncDestinationsAzureKvNameRequestFromJSONTyped(json, false);
}
function SystemPatchSyncDestinationsAzureKvNameRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function SystemPatchSyncDestinationsAzureKvNameRequestToJSON(json) {
    return SystemPatchSyncDestinationsAzureKvNameRequestToJSONTyped(json, false);
}
function SystemPatchSyncDestinationsAzureKvNameRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
