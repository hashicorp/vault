...
exports.instanceOfAppRoleWriteSecretIdResponse = instanceOfAppRoleWriteSecretIdResponse;
exports.AppRoleWriteSecretIdResponseFromJSON = AppRoleWriteSecretIdResponseFromJSON;
exports.AppRoleWriteSecretIdResponseFromJSONTyped = AppRoleWriteSecretIdResponseFromJSONTyped;
exports.AppRoleWriteSecretIdResponseToJSON = AppRoleWriteSecretIdResponseToJSON;
exports.AppRoleWriteSecretIdResponseToJSONTyped = AppRoleWriteSecretIdResponseToJSONTyped;
/**
 * Check if a given object implements the AppRoleWriteSecretIdResponse interface.
 */
function instanceOfAppRoleWriteSecretIdResponse(value) {
    return true;
}
function AppRoleWriteSecretIdResponseFromJSON(json) {
    return AppRoleWriteSecretIdResponseFromJSONTyped(json, false);
}
function AppRoleWriteSecretIdResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function AppRoleWriteSecretIdResponseToJSON(json) {
    return AppRoleWriteSecretIdResponseToJSONTyped(json, false);
}
function AppRoleWriteSecretIdResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
