 ...
 */
export declare function instanceOfPkiPatchRoleResponse(value: object): value is PkiPatchRoleResponse;
export declare function PkiPatchRoleResponseFromJSON(json: any): PkiPatchRoleResponse;
export declare function PkiPatchRoleResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PkiPatchRoleResponse;
export declare function PkiPatchRoleResponseToJSON(json: any): PkiPatchRoleResponse;
export declare function PkiPatchRoleResponseToJSONTyped(value?: PkiPatchRoleResponse | null, ignoreDiscriminator?: boolean): any;
