...
exports.PkiGenerateRootRequestPrivateKeyFormatEnum = exports.PkiGenerateRootRequestKeyTypeEnum = exports.PkiGenerateRootRequestFormatEnum = void 0;
exports.instanceOfPkiGenerateRootRequest = instanceOfPkiGenerateRootRequest;
exports.PkiGenerateRootRequestFromJSON = PkiGenerateRootRequestFromJSON;
exports.PkiGenerateRootRequestFromJSONTyped = PkiGenerateRootRequestFromJSONTyped;
exports.PkiGenerateRootRequestToJSON = PkiGenerateRootRequestToJSON;
exports.PkiGenerateRootRequestToJSONTyped = PkiGenerateRootRequestToJSONTyped;
/**
* @export
* @enum {string}
*/
var PkiGenerateRootRequestFormatEnum;
...
})(PkiGenerateRootRequestFormatEnum || (exports.PkiGenerateRootRequestFormatEnum = PkiGenerateRootRequestFormatEnum = {}));
/**
* @export
* @enum {string}
*/
var PkiGenerateRootRequestKeyTypeEnum;
...
})(PkiGenerateRootRequestKeyTypeEnum || (exports.PkiGenerateRootRequestKeyTypeEnum = PkiGenerateRootRequestKeyTypeEnum = {}));
/**
* @export
* @enum {string}
*/
var PkiGenerateRootRequestPrivateKeyFormatEnum;
...
})(PkiGenerateRootRequestPrivateKeyFormatEnum || (exports.PkiGenerateRootRequestPrivateKeyFormatEnum = PkiGenerateRootRequestPrivateKeyFormatEnum = {}));
/**
 * Check if a given object implements the PkiGenerateRootRequest interface.
 */
function instanceOfPkiGenerateRootRequest(value) {
    return true;
}
function PkiGenerateRootRequestFromJSON(json) {
    return PkiGenerateRootRequestFromJSONTyped(json, false);
}
function PkiGenerateRootRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PkiGenerateRootRequestToJSON(json) {
    return PkiGenerateRootRequestToJSONTyped(json, false);
}
function PkiGenerateRootRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
