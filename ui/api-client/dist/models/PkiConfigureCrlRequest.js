...
exports.instanceOfPkiConfigureCrlRequest = instanceOfPkiConfigureCrlRequest;
exports.PkiConfigureCrlRequestFromJSON = PkiConfigureCrlRequestFromJSON;
exports.PkiConfigureCrlRequestFromJSONTyped = PkiConfigureCrlRequestFromJSONTyped;
exports.PkiConfigureCrlRequestToJSON = PkiConfigureCrlRequestToJSON;
exports.PkiConfigureCrlRequestToJSONTyped = PkiConfigureCrlRequestToJSONTyped;
/**
 * Check if a given object implements the PkiConfigureCrlRequest interface.
 */
function instanceOfPkiConfigureCrlRequest(value) {
    return true;
}
function PkiConfigureCrlRequestFromJSON(json) {
    return PkiConfigureCrlRequestFromJSONTyped(json, false);
}
function PkiConfigureCrlRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PkiConfigureCrlRequestToJSON(json) {
    return PkiConfigureCrlRequestToJSONTyped(json, false);
}
function PkiConfigureCrlRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
