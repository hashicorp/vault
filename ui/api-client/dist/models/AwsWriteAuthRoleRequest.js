...
exports.instanceOfAwsWriteAuthRoleRequest = instanceOfAwsWriteAuthRoleRequest;
exports.AwsWriteAuthRoleRequestFromJSON = AwsWriteAuthRoleRequestFromJSON;
exports.AwsWriteAuthRoleRequestFromJSONTyped = AwsWriteAuthRoleRequestFromJSONTyped;
exports.AwsWriteAuthRoleRequestToJSON = AwsWriteAuthRoleRequestToJSON;
exports.AwsWriteAuthRoleRequestToJSONTyped = AwsWriteAuthRoleRequestToJSONTyped;
/**
 * Check if a given object implements the AwsWriteAuthRoleRequest interface.
 */
function instanceOfAwsWriteAuthRoleRequest(value) {
    return true;
}
function AwsWriteAuthRoleRequestFromJSON(json) {
    return AwsWriteAuthRoleRequestFromJSONTyped(json, false);
}
function AwsWriteAuthRoleRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function AwsWriteAuthRoleRequestToJSON(json) {
    return AwsWriteAuthRoleRequestToJSONTyped(json, false);
}
function AwsWriteAuthRoleRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
