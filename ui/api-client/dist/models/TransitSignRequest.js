...
exports.instanceOfTransitSignRequest = instanceOfTransitSignRequest;
exports.TransitSignRequestFromJSON = TransitSignRequestFromJSON;
exports.TransitSignRequestFromJSONTyped = TransitSignRequestFromJSONTyped;
exports.TransitSignRequestToJSON = TransitSignRequestToJSON;
 ...
 */
function instanceOfTransitSignRequest(value) {
    return true;
}
function TransitSignRequestFromJSON(json) {
    return TransitSignRequestFromJSONTyped(json, false);
}
function TransitSignRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function TransitSignRequestToJSON(json) {
    return TransitSignRequestToJSONTyped(json, false);
}
function TransitSignRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
