...
exports.instanceOfMfaCreateDuoMethodRequest = instanceOfMfaCreateDuoMethodRequest;
exports.MfaCreateDuoMethodRequestFromJSON = MfaCreateDuoMethodRequestFromJSON;
exports.MfaCreateDuoMethodRequestFromJSONTyped = MfaCreateDuoMethodRequestFromJSONTyped;
exports.MfaCreateDuoMethodRequestToJSON = MfaCreateDuoMethodRequestToJSON;
exports.MfaCreateDuoMethodRequestToJSONTyped = MfaCreateDuoMethodRequestToJSONTyped;
/**
 * Check if a given object implements the MfaCreateDuoMethodRequest interface.
 */
function instanceOfMfaCreateDuoMethodRequest(value) {
    return true;
}
function MfaCreateDuoMethodRequestFromJSON(json) {
    return MfaCreateDuoMethodRequestFromJSONTyped(json, false);
}
function MfaCreateDuoMethodRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function MfaCreateDuoMethodRequestToJSON(json) {
    return MfaCreateDuoMethodRequestToJSONTyped(json, false);
}
function MfaCreateDuoMethodRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
