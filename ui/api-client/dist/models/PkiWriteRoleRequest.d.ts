 ...
 */
export declare function instanceOfPkiWriteRoleRequest(value: object): value is PkiWriteRoleRequest;
export declare function PkiWriteRoleRequestFromJSON(json: any): PkiWriteRoleRequest;
export declare function PkiWriteRoleRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PkiWriteRoleRequest;
export declare function PkiWriteRoleRequestToJSON(json: any): PkiWriteRoleRequest;
export declare function PkiWriteRoleRequestToJSONTyped(value?: PkiWriteRoleRequest | null, ignoreDiscriminator?: boolean): any;
