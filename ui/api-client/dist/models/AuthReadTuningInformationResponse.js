...
exports.instanceOfAuthReadTuningInformationResponse = instanceOfAuthReadTuningInformationResponse;
exports.AuthReadTuningInformationResponseFromJSON = AuthReadTuningInformationResponseFromJSON;
exports.AuthReadTuningInformationResponseFromJSONTyped = AuthReadTuningInformationResponseFromJSONTyped;
exports.AuthReadTuningInformationResponseToJSON = AuthReadTuningInformationResponseToJSON;
exports.AuthReadTuningInformationResponseToJSONTyped = AuthReadTuningInformationResponseToJSONTyped;
/**
 * Check if a given object implements the AuthReadTuningInformationResponse interface.
 */
function instanceOfAuthReadTuningInformationResponse(value) {
    return true;
}
function AuthReadTuningInformationResponseFromJSON(json) {
    return AuthReadTuningInformationResponseFromJSONTyped(json, false);
}
function AuthReadTuningInformationResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function AuthReadTuningInformationResponseToJSON(json) {
    return AuthReadTuningInformationResponseToJSONTyped(json, false);
}
function AuthReadTuningInformationResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
