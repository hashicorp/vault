...
exports.instanceOfMountsTuneConfigurationParametersRequest = instanceOfMountsTuneConfigurationParametersRequest;
exports.MountsTuneConfigurationParametersRequestFromJSON = MountsTuneConfigurationParametersRequestFromJSON;
exports.MountsTuneConfigurationParametersRequestFromJSONTyped = MountsTuneConfigurationParametersRequestFromJSONTyped;
exports.MountsTuneConfigurationParametersRequestToJSON = MountsTuneConfigurationParametersRequestToJSON;
exports.MountsTuneConfigurationParametersRequestToJSONTyped = MountsTuneConfigurationParametersRequestToJSONTyped;
/**
 * Check if a given object implements the MountsTuneConfigurationParametersRequest interface.
 */
function instanceOfMountsTuneConfigurationParametersRequest(value) {
    return true;
}
function MountsTuneConfigurationParametersRequestFromJSON(json) {
    return MountsTuneConfigurationParametersRequestFromJSONTyped(json, false);
}
function MountsTuneConfigurationParametersRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function MountsTuneConfigurationParametersRequestToJSON(json) {
    return MountsTuneConfigurationParametersRequestToJSONTyped(json, false);
}
function MountsTuneConfigurationParametersRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
