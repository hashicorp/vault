...
exports.instanceOfPkiTidyStatusResponse = instanceOfPkiTidyStatusResponse;
exports.PkiTidyStatusResponseFromJSON = PkiTidyStatusResponseFromJSON;
exports.PkiTidyStatusResponseFromJSONTyped = PkiTidyStatusResponseFromJSONTyped;
exports.PkiTidyStatusResponseToJSON = PkiTidyStatusResponseToJSON;
exports.PkiTidyStatusResponseToJSONTyped = PkiTidyStatusResponseToJSONTyped;
/**
 * Check if a given object implements the PkiTidyStatusResponse interface.
 */
function instanceOfPkiTidyStatusResponse(value) {
    return true;
}
function PkiTidyStatusResponseFromJSON(json) {
    return PkiTidyStatusResponseFromJSONTyped(json, false);
}
function PkiTidyStatusResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PkiTidyStatusResponseToJSON(json) {
    return PkiTidyStatusResponseToJSONTyped(json, false);
}
function PkiTidyStatusResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
