...
exports.instanceOfPkiConfigureCaResponse = instanceOfPkiConfigureCaResponse;
exports.PkiConfigureCaResponseFromJSON = PkiConfigureCaResponseFromJSON;
exports.PkiConfigureCaResponseFromJSONTyped = PkiConfigureCaResponseFromJSONTyped;
exports.PkiConfigureCaResponseToJSON = PkiConfigureCaResponseToJSON;
exports.PkiConfigureCaResponseToJSONTyped = PkiConfigureCaResponseToJSONTyped;
/**
 * Check if a given object implements the PkiConfigureCaResponse interface.
 */
function instanceOfPkiConfigureCaResponse(value) {
    return true;
}
function PkiConfigureCaResponseFromJSON(json) {
    return PkiConfigureCaResponseFromJSONTyped(json, false);
}
function PkiConfigureCaResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PkiConfigureCaResponseToJSON(json) {
    return PkiConfigureCaResponseToJSONTyped(json, false);
}
function PkiConfigureCaResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
