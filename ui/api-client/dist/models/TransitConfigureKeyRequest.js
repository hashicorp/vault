...
exports.instanceOfTransitConfigureKeyRequest = instanceOfTransitConfigureKeyRequest;
exports.TransitConfigureKeyRequestFromJSON = TransitConfigureKeyRequestFromJSON;
exports.TransitConfigureKeyRequestFromJSONTyped = TransitConfigureKeyRequestFromJSONTyped;
exports.TransitConfigureKeyRequestToJSON = TransitConfigureKeyRequestToJSON;
exports.TransitConfigureKeyRequestToJSONTyped = TransitConfigureKeyRequestToJSONTyped;
/**
 * Check if a given object implements the TransitConfigureKeyRequest interface.
 */
function instanceOfTransitConfigureKeyRequest(value) {
    return true;
}
function TransitConfigureKeyRequestFromJSON(json) {
    return TransitConfigureKeyRequestFromJSONTyped(json, false);
}
function TransitConfigureKeyRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function TransitConfigureKeyRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
