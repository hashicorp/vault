...
exports.instanceOfSystemWriteMfaMethodDuoNameRequest = instanceOfSystemWriteMfaMethodDuoNameRequest;
exports.SystemWriteMfaMethodDuoNameRequestFromJSON = SystemWriteMfaMethodDuoNameRequestFromJSON;
exports.SystemWriteMfaMethodDuoNameRequestFromJSONTyped = SystemWriteMfaMethodDuoNameRequestFromJSONTyped;
exports.SystemWriteMfaMethodDuoNameRequestToJSON = SystemWriteMfaMethodDuoNameRequestToJSON;
exports.SystemWriteMfaMethodDuoNameRequestToJSONTyped = SystemWriteMfaMethodDuoNameRequestToJSONTyped;
/**
 * Check if a given object implements the SystemWriteMfaMethodDuoNameRequest interface.
 */
function instanceOfSystemWriteMfaMethodDuoNameRequest(value) {
    return true;
}
function SystemWriteMfaMethodDuoNameRequestFromJSON(json) {
    return SystemWriteMfaMethodDuoNameRequestFromJSONTyped(json, false);
}
function SystemWriteMfaMethodDuoNameRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function SystemWriteMfaMethodDuoNameRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
