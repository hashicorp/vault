...
exports.PkiRotateRootRequestPrivateKeyFormatEnum = exports.PkiRotateRootRequestKeyTypeEnum = exports.PkiRotateRootRequestFormatEnum = void 0;
exports.instanceOfPkiRotateRootRequest = instanceOfPkiRotateRootRequest;
exports.PkiRotateRootRequestFromJSON = PkiRotateRootRequestFromJSON;
exports.PkiRotateRootRequestFromJSONTyped = PkiRotateRootRequestFromJSONTyped;
exports.PkiRotateRootRequestToJSON = PkiRotateRootRequestToJSON;
exports.PkiRotateRootRequestToJSONTyped = PkiRotateRootRequestToJSONTyped;
/**
* @export
* @enum {string}
*/
var PkiRotateRootRequestFormatEnum;
...
})(PkiRotateRootRequestFormatEnum || (exports.PkiRotateRootRequestFormatEnum = PkiRotateRootRequestFormatEnum = {}));
/**
* @export
* @enum {string}
*/
var PkiRotateRootRequestKeyTypeEnum;
...
})(PkiRotateRootRequestKeyTypeEnum || (exports.PkiRotateRootRequestKeyTypeEnum = PkiRotateRootRequestKeyTypeEnum = {}));
/**
* @export
* @enum {string}
*/
var PkiRotateRootRequestPrivateKeyFormatEnum;
...
})(PkiRotateRootRequestPrivateKeyFormatEnum || (exports.PkiRotateRootRequestPrivateKeyFormatEnum = PkiRotateRootRequestPrivateKeyFormatEnum = {}));
/**
 * Check if a given object implements the PkiRotateRootRequest interface.
 */
function instanceOfPkiRotateRootRequest(value) {
    return true;
}
function PkiRotateRootRequestFromJSON(json) {
    return PkiRotateRootRequestFromJSONTyped(json, false);
}
function PkiRotateRootRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PkiRotateRootRequestToJSON(json) {
    return PkiRotateRootRequestToJSONTyped(json, false);
}
function PkiRotateRootRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
