...
exports.instanceOfPkiWriteIssuerResponse = instanceOfPkiWriteIssuerResponse;
exports.PkiWriteIssuerResponseFromJSON = PkiWriteIssuerResponseFromJSON;
exports.PkiWriteIssuerResponseFromJSONTyped = PkiWriteIssuerResponseFromJSONTyped;
exports.PkiWriteIssuerResponseToJSON = PkiWriteIssuerResponseToJSON;
exports.PkiWriteIssuerResponseToJSONTyped = PkiWriteIssuerResponseToJSONTyped;
/**
 * Check if a given object implements the PkiWriteIssuerResponse interface.
 */
function instanceOfPkiWriteIssuerResponse(value) {
    return true;
}
function PkiWriteIssuerResponseFromJSON(json) {
    return PkiWriteIssuerResponseFromJSONTyped(json, false);
}
function PkiWriteIssuerResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PkiWriteIssuerResponseToJSON(json) {
    return PkiWriteIssuerResponseToJSONTyped(json, false);
}
function PkiWriteIssuerResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
