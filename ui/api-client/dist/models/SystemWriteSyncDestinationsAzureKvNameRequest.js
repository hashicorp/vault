...
exports.instanceOfSystemWriteSyncDestinationsAzureKvNameRequest = instanceOfSystemWriteSyncDestinationsAzureKvNameRequest;
exports.SystemWriteSyncDestinationsAzureKvNameRequestFromJSON = SystemWriteSyncDestinationsAzureKvNameRequestFromJSON;
exports.SystemWriteSyncDestinationsAzureKvNameRequestFromJSONTyped = SystemWriteSyncDestinationsAzureKvNameRequestFromJSONTyped;
exports.SystemWriteSyncDestinationsAzureKvNameRequestToJSON = SystemWriteSyncDestinationsAzureKvNameRequestToJSON;
exports.SystemWriteSyncDestinationsAzureKvNameRequestToJSONTyped = SystemWriteSyncDestinationsAzureKvNameRequestToJSONTyped;
/**
 * Check if a given object implements the SystemWriteSyncDestinationsAzureKvNameRequest interface.
 */
function instanceOfSystemWriteSyncDestinationsAzureKvNameRequest(value) {
    return true;
}
function SystemWriteSyncDestinationsAzureKvNameRequestFromJSON(json) {
    return SystemWriteSyncDestinationsAzureKvNameRequestFromJSONTyped(json, false);
}
function SystemWriteSyncDestinationsAzureKvNameRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function SystemWriteSyncDestinationsAzureKvNameRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
