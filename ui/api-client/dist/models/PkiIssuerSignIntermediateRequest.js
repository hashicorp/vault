...
exports.PkiIssuerSignIntermediateRequestPrivateKeyFormatEnum = exports.PkiIssuerSignIntermediateRequestFormatEnum = void 0;
exports.instanceOfPkiIssuerSignIntermediateRequest = instanceOfPkiIssuerSignIntermediateRequest;
exports.PkiIssuerSignIntermediateRequestFromJSON = PkiIssuerSignIntermediateRequestFromJSON;
exports.PkiIssuerSignIntermediateRequestFromJSONTyped = PkiIssuerSignIntermediateRequestFromJSONTyped;
...
})(PkiIssuerSignIntermediateRequestPrivateKeyFormatEnum || (exports.PkiIssuerSignIntermediateRequestPrivateKeyFormatEnum = PkiIssuerSignIntermediateRequestPrivateKeyFormatEnum = {}));
/**
 * Check if a given object implements the PkiIssuerSignIntermediateRequest interface.
 */
function instanceOfPkiIssuerSignIntermediateRequest(value) {
    return true;
}
function PkiIssuerSignIntermediateRequestFromJSON(json) {
    return PkiIssuerSignIntermediateRequestFromJSONTyped(json, false);
}
function PkiIssuerSignIntermediateRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PkiIssuerSignIntermediateRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
