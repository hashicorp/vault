...
exports.PkiGenerateIntermediateRequestPrivateKeyFormatEnum = exports.PkiGenerateIntermediateRequestKeyTypeEnum = exports.PkiGenerateIntermediateRequestFormatEnum = void 0;
exports.instanceOfPkiGenerateIntermediateRequest = instanceOfPkiGenerateIntermediateRequest;
exports.PkiGenerateIntermediateRequestFromJSON = PkiGenerateIntermediateRequestFromJSON;
exports.PkiGenerateIntermediateRequestFromJSONTyped = PkiGenerateIntermediateRequestFromJSONTyped;
exports.PkiGenerateIntermediateRequestToJSON = PkiGenerateIntermediateRequestToJSON;
exports.PkiGenerateIntermediateRequestToJSONTyped = PkiGenerateIntermediateRequestToJSONTyped;
/**
* @export
* @enum {string}
*/
var PkiGenerateIntermediateRequestFormatEnum;
...
})(PkiGenerateIntermediateRequestFormatEnum || (exports.PkiGenerateIntermediateRequestFormatEnum = PkiGenerateIntermediateRequestFormatEnum = {}));
/**
* @export
* @enum {string}
*/
var PkiGenerateIntermediateRequestKeyTypeEnum;
...
})(PkiGenerateIntermediateRequestKeyTypeEnum || (exports.PkiGenerateIntermediateRequestKeyTypeEnum = PkiGenerateIntermediateRequestKeyTypeEnum = {}));
/**
* @export
* @enum {string}
*/
var PkiGenerateIntermediateRequestPrivateKeyFormatEnum;
...
})(PkiGenerateIntermediateRequestPrivateKeyFormatEnum || (exports.PkiGenerateIntermediateRequestPrivateKeyFormatEnum = PkiGenerateIntermediateRequestPrivateKeyFormatEnum = {}));
/**
 * Check if a given object implements the PkiGenerateIntermediateRequest interface.
 */
function instanceOfPkiGenerateIntermediateRequest(value) {
    return true;
}
function PkiGenerateIntermediateRequestFromJSON(json) {
    return PkiGenerateIntermediateRequestFromJSONTyped(json, false);
}
function PkiGenerateIntermediateRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PkiGenerateIntermediateRequestToJSON(json) {
    return PkiGenerateIntermediateRequestToJSONTyped(json, false);
}
function PkiGenerateIntermediateRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
