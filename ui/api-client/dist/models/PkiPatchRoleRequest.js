...
exports.PkiPatchRoleRequestKeyTypeEnum = void 0;
exports.instanceOfPkiPatchRoleRequest = instanceOfPkiPatchRoleRequest;
exports.PkiPatchRoleRequestFromJSON = PkiPatchRoleRequestFromJSON;
exports.PkiPatchRoleRequestFromJSONTyped = PkiPatchRoleRequestFromJSONTyped;
exports.PkiPatchRoleRequestToJSON = PkiPatchRoleRequestToJSON;
exports.PkiPatchRoleRequestToJSONTyped = PkiPatchRoleRequestToJSONTyped;
/**
* @export
* @enum {string}
*/
var PkiPatchRoleRequestKeyTypeEnum;
(function (PkiPatchRoleRequestKeyTypeEnum) {
    PkiPatchRoleRequestKeyTypeEnum["RSA"] = "rsa";
    PkiPatchRoleRequestKeyTypeEnum["EC"] = "ec";
    PkiPatchRoleRequestKeyTypeEnum["ED25519"] = "ed25519";
    PkiPatchRoleRequestKeyTypeEnum["ANY"] = "any";
})(PkiPatchRoleRequestKeyTypeEnum || (exports.PkiPatchRoleRequestKeyTypeEnum = PkiPatchRoleRequestKeyTypeEnum = {}));
/**
 * Check if a given object implements the PkiPatchRoleRequest interface.
 */
function instanceOfPkiPatchRoleRequest(value) {
    return true;
}
function PkiPatchRoleRequestFromJSON(json) {
    return PkiPatchRoleRequestFromJSONTyped(json, false);
}
function PkiPatchRoleRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PkiPatchRoleRequestToJSON(json) {
    return PkiPatchRoleRequestToJSONTyped(json, false);
}
function PkiPatchRoleRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
