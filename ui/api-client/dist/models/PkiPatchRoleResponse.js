...
exports.instanceOfPkiPatchRoleResponse = instanceOfPkiPatchRoleResponse;
exports.PkiPatchRoleResponseFromJSON = PkiPatchRoleResponseFromJSON;
exports.PkiPatchRoleResponseFromJSONTyped = PkiPatchRoleResponseFromJSONTyped;
 ...
 */
function instanceOfPkiPatchRoleResponse(value) {
    return true;
}
function PkiPatchRoleResponseFromJSON(json) {
    return PkiPatchRoleResponseFromJSONTyped(json, false);
}
function PkiPatchRoleResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PkiPatchRoleResponseToJSON(json) {
    return PkiPatchRoleResponseToJSONTyped(json, false);
}
function PkiPatchRoleResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
