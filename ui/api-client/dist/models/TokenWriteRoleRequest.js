...
exports.instanceOfTokenWriteRoleRequest = instanceOfTokenWriteRoleRequest;
exports.TokenWriteRoleRequestFromJSON = TokenWriteRoleRequestFromJSON;
exports.TokenWriteRoleRequestFromJSONTyped = TokenWriteRoleRequestFromJSONTyped;
exports.TokenWriteRoleRequestToJSON = TokenWriteRoleRequestToJSON;
exports.TokenWriteRoleRequestToJSONTyped = TokenWriteRoleRequestToJSONTyped;
/**
 * Check if a given object implements the TokenWriteRoleRequest interface.
 */
function instanceOfTokenWriteRoleRequest(value) {
    return true;
}
function TokenWriteRoleRequestFromJSON(json) {
    return TokenWriteRoleRequestFromJSONTyped(json, false);
}
function TokenWriteRoleRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function TokenWriteRoleRequestToJSON(json) {
    return TokenWriteRoleRequestToJSONTyped(json, false);
}
function TokenWriteRoleRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
