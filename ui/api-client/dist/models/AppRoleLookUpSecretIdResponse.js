...
exports.instanceOfAppRoleLookUpSecretIdResponse = instanceOfAppRoleLookUpSecretIdResponse;
exports.AppRoleLookUpSecretIdResponseFromJSON = AppRoleLookUpSecretIdResponseFromJSON;
exports.AppRoleLookUpSecretIdResponseFromJSONTyped = AppRoleLookUpSecretIdResponseFromJSONTyped;
exports.AppRoleLookUpSecretIdResponseToJSON = AppRoleLookUpSecretIdResponseToJSON;
exports.AppRoleLookUpSecretIdResponseToJSONTyped = AppRoleLookUpSecretIdResponseToJSONTyped;
/**
 * Check if a given object implements the AppRoleLookUpSecretIdResponse interface.
 */
function instanceOfAppRoleLookUpSecretIdResponse(value) {
    return true;
}
function AppRoleLookUpSecretIdResponseFromJSON(json) {
    return AppRoleLookUpSecretIdResponseFromJSONTyped(json, false);
}
function AppRoleLookUpSecretIdResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function AppRoleLookUpSecretIdResponseToJSON(json) {
    return AppRoleLookUpSecretIdResponseToJSONTyped(json, false);
}
function AppRoleLookUpSecretIdResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
