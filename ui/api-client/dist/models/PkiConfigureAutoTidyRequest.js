...
exports.instanceOfPkiConfigureAutoTidyRequest = instanceOfPkiConfigureAutoTidyRequest;
exports.PkiConfigureAutoTidyRequestFromJSON = PkiConfigureAutoTidyRequestFromJSON;
exports.PkiConfigureAutoTidyRequestFromJSONTyped = PkiConfigureAutoTidyRequestFromJSONTyped;
exports.PkiConfigureAutoTidyRequestToJSON = PkiConfigureAutoTidyRequestToJSON;
exports.PkiConfigureAutoTidyRequestToJSONTyped = PkiConfigureAutoTidyRequestToJSONTyped;
/**
 * Check if a given object implements the PkiConfigureAutoTidyRequest interface.
 */
function instanceOfPkiConfigureAutoTidyRequest(value) {
    return true;
}
function PkiConfigureAutoTidyRequestFromJSON(json) {
    return PkiConfigureAutoTidyRequestFromJSONTyped(json, false);
}
function PkiConfigureAutoTidyRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PkiConfigureAutoTidyRequestToJSON(json) {
    return PkiConfigureAutoTidyRequestToJSONTyped(json, false);
}
function PkiConfigureAutoTidyRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
