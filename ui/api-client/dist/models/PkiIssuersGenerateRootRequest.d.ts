...
* @enum {string}
*/
export declare enum PkiIssuersGenerateRootRequestFormatEnum {
    PEM = "pem",
    DER = "der",
...
* @enum {string}
*/
export declare enum PkiIssuersGenerateRootRequestKeyTypeEnum {
    RSA = "rsa",
    EC = "ec",
    ED25519 = "ed25519"
}
...
* @enum {string}
*/
export declare enum PkiIssuersGenerateRootRequestPrivateKeyFormatEnum {
    EMPTY = "",
    DER = "der",
    PEM = "pem",
    PKCS8 = "pkcs8"
 ...
 */
export declare function instanceOfPkiIssuersGenerateRootRequest(value: object): value is PkiIssuersGenerateRootRequest;
export declare function PkiIssuersGenerateRootRequestFromJSON(json: any): PkiIssuersGenerateRootRequest;
export declare function PkiIssuersGenerateRootRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PkiIssuersGenerateRootRequest;
export declare function PkiIssuersGenerateRootRequestToJSON(json: any): PkiIssuersGenerateRootRequest;
export declare function PkiIssuersGenerateRootRequestToJSONTyped(value?: PkiIssuersGenerateRootRequest | null, ignoreDiscriminator?: boolean): any;
