...
exports.instanceOfTokenCreateRequest = instanceOfTokenCreateRequest;
exports.TokenCreateRequestFromJSON = TokenCreateRequestFromJSON;
exports.TokenCreateRequestFromJSONTyped = TokenCreateRequestFromJSONTyped;
exports.TokenCreateRequestToJSON = TokenCreateRequestToJSON;
exports.TokenCreateRequestToJSONTyped = TokenCreateRequestToJSONTyped;
/**
 * Check if a given object implements the TokenCreateRequest interface.
 */
function instanceOfTokenCreateRequest(value) {
    return true;
}
function TokenCreateRequestFromJSON(json) {
    return TokenCreateRequestFromJSONTyped(json, false);
}
function TokenCreateRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function TokenCreateRequestToJSON(json) {
    return TokenCreateRequestToJSONTyped(json, false);
}
function TokenCreateRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
