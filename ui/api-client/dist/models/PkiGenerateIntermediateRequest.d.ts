 ...
 */
export declare function instanceOfPkiGenerateIntermediateRequest(value: object): value is PkiGenerateIntermediateRequest;
export declare function PkiGenerateIntermediateRequestFromJSON(json: any): PkiGenerateIntermediateRequest;
export declare function PkiGenerateIntermediateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PkiGenerateIntermediateRequest;
export declare function PkiGenerateIntermediateRequestToJSON(json: any): PkiGenerateIntermediateRequest;
export declare function PkiGenerateIntermediateRequestToJSONTyped(value?: PkiGenerateIntermediateRequest | null, ignoreDiscriminator?: boolean): any;
