...
exports.instanceOfMountsReadConfigurationResponse = instanceOfMountsReadConfigurationResponse;
exports.MountsReadConfigurationResponseFromJSON = MountsReadConfigurationResponseFromJSON;
exports.MountsReadConfigurationResponseFromJSONTyped = MountsReadConfigurationResponseFromJSONTyped;
exports.MountsReadConfigurationResponseToJSON = MountsReadConfigurationResponseToJSON;
exports.MountsReadConfigurationResponseToJSONTyped = MountsReadConfigurationResponseToJSONTyped;
/**
 * Check if a given object implements the MountsReadConfigurationResponse interface.
 */
function instanceOfMountsReadConfigurationResponse(value) {
    return true;
}
function MountsReadConfigurationResponseFromJSON(json) {
    return MountsReadConfigurationResponseFromJSONTyped(json, false);
}
function MountsReadConfigurationResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function MountsReadConfigurationResponseToJSON(json) {
    return MountsReadConfigurationResponseToJSONTyped(json, false);
}
function MountsReadConfigurationResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
