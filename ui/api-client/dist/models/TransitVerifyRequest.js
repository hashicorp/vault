...
exports.instanceOfTransitVerifyRequest = instanceOfTransitVerifyRequest;
exports.TransitVerifyRequestFromJSON = TransitVerifyRequestFromJSON;
exports.TransitVerifyRequestFromJSONTyped = TransitVerifyRequestFromJSONTyped;
exports.TransitVerifyRequestToJSON = TransitVerifyRequestToJSON;
exports.TransitVerifyRequestToJSONTyped = TransitVerifyRequestToJSONTyped;
/**
 * Check if a given object implements the TransitVerifyRequest interface.
 */
function instanceOfTransitVerifyRequest(value) {
    return true;
}
function TransitVerifyRequestFromJSON(json) {
    return TransitVerifyRequestFromJSONTyped(json, false);
}
function TransitVerifyRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function TransitVerifyRequestToJSON(json) {
    return TransitVerifyRequestToJSONTyped(json, false);
}
function TransitVerifyRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
