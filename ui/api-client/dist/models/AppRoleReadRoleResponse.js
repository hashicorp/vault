...
exports.instanceOfAppRoleReadRoleResponse = instanceOfAppRoleReadRoleResponse;
exports.AppRoleReadRoleResponseFromJSON = AppRoleReadRoleResponseFromJSON;
exports.AppRoleReadRoleResponseFromJSONTyped = AppRoleReadRoleResponseFromJSONTyped;
exports.AppRoleReadRoleResponseToJSON = AppRoleReadRoleResponseToJSON;
exports.AppRoleReadRoleResponseToJSONTyped = AppRoleReadRoleResponseToJSONTyped;
/**
 * Check if a given object implements the AppRoleReadRoleResponse interface.
 */
function instanceOfAppRoleReadRoleResponse(value) {
    return true;
}
function AppRoleReadRoleResponseFromJSON(json) {
    return AppRoleReadRoleResponseFromJSONTyped(json, false);
}
function AppRoleReadRoleResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function AppRoleReadRoleResponseToJSON(json) {
    return AppRoleReadRoleResponseToJSONTyped(json, false);
}
function AppRoleReadRoleResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
