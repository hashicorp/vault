...
exports.instanceOfRadiusConfigureRequest = instanceOfRadiusConfigureRequest;
exports.RadiusConfigureRequestFromJSON = RadiusConfigureRequestFromJSON;
exports.RadiusConfigureRequestFromJSONTyped = RadiusConfigureRequestFromJSONTyped;
exports.RadiusConfigureRequestToJSON = RadiusConfigureRequestToJSON;
exports.RadiusConfigureRequestToJSONTyped = RadiusConfigureRequestToJSONTyped;
/**
 * Check if a given object implements the RadiusConfigureRequest interface.
 */
function instanceOfRadiusConfigureRequest(value) {
    return true;
}
function RadiusConfigureRequestFromJSON(json) {
    return RadiusConfigureRequestFromJSONTyped(json, false);
}
function RadiusConfigureRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function RadiusConfigureRequestToJSON(json) {
    return RadiusConfigureRequestToJSONTyped(json, false);
}
function RadiusConfigureRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
