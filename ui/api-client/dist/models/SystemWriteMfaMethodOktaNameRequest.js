...
exports.instanceOfSystemWriteMfaMethodOktaNameRequest = instanceOfSystemWriteMfaMethodOktaNameRequest;
exports.SystemWriteMfaMethodOktaNameRequestFromJSON = SystemWriteMfaMethodOktaNameRequestFromJSON;
exports.SystemWriteMfaMethodOktaNameRequestFromJSONTyped = SystemWriteMfaMethodOktaNameRequestFromJSONTyped;
exports.SystemWriteMfaMethodOktaNameRequestToJSON = SystemWriteMfaMethodOktaNameRequestToJSON;
exports.SystemWriteMfaMethodOktaNameRequestToJSONTyped = SystemWriteMfaMethodOktaNameRequestToJSONTyped;
/**
 * Check if a given object implements the SystemWriteMfaMethodOktaNameRequest interface.
 */
function instanceOfSystemWriteMfaMethodOktaNameRequest(value) {
    return true;
}
function SystemWriteMfaMethodOktaNameRequestFromJSON(json) {
    return SystemWriteMfaMethodOktaNameRequestFromJSONTyped(json, false);
}
function SystemWriteMfaMethodOktaNameRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function SystemWriteMfaMethodOktaNameRequestToJSON(json) {
    return SystemWriteMfaMethodOktaNameRequestToJSONTyped(json, false);
}
function SystemWriteMfaMethodOktaNameRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
