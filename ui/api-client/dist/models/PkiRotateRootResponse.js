...
exports.instanceOfPkiRotateRootResponse = instanceOfPkiRotateRootResponse;
exports.PkiRotateRootResponseFromJSON = PkiRotateRootResponseFromJSON;
exports.PkiRotateRootResponseFromJSONTyped = PkiRotateRootResponseFromJSONTyped;
exports.PkiRotateRootResponseToJSON = PkiRotateRootResponseToJSON;
exports.PkiRotateRootResponseToJSONTyped = PkiRotateRootResponseToJSONTyped;
/**
 * Check if a given object implements the PkiRotateRootResponse interface.
 */
function instanceOfPkiRotateRootResponse(value) {
    return true;
}
function PkiRotateRootResponseFromJSON(json) {
    return PkiRotateRootResponseFromJSONTyped(json, false);
}
function PkiRotateRootResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PkiRotateRootResponseToJSON(json) {
    return PkiRotateRootResponseToJSONTyped(json, false);
}
function PkiRotateRootResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
