...
exports.instanceOfSystemPatchSyncDestinationsGhNameRequest = instanceOfSystemPatchSyncDestinationsGhNameRequest;
exports.SystemPatchSyncDestinationsGhNameRequestFromJSON = SystemPatchSyncDestinationsGhNameRequestFromJSON;
exports.SystemPatchSyncDestinationsGhNameRequestFromJSONTyped = SystemPatchSyncDestinationsGhNameRequestFromJSONTyped;
 ...
 */
function instanceOfSystemPatchSyncDestinationsGhNameRequest(value) {
    return true;
}
function SystemPatchSyncDestinationsGhNameRequestFromJSON(json) {
    return SystemPatchSyncDestinationsGhNameRequestFromJSONTyped(json, false);
}
function SystemPatchSyncDestinationsGhNameRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function SystemPatchSyncDestinationsGhNameRequestToJSON(json) {
    return SystemPatchSyncDestinationsGhNameRequestToJSONTyped(json, false);
}
function SystemPatchSyncDestinationsGhNameRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
