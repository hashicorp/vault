...
exports.KmipWriteRoleRequestTlsClientKeyTypeEnum = void 0;
exports.instanceOfKmipWriteRoleRequest = instanceOfKmipWriteRoleRequest;
exports.KmipWriteRoleRequestFromJSON = KmipWriteRoleRequestFromJSON;
exports.KmipWriteRoleRequestFromJSONTyped = KmipWriteRoleRequestFromJSONTyped;
exports.KmipWriteRoleRequestToJSON = KmipWriteRoleRequestToJSON;
exports.KmipWriteRoleRequestToJSONTyped = KmipWriteRoleRequestToJSONTyped;
/**
* @export
* @enum {string}
*/
var KmipWriteRoleRequestTlsClientKeyTypeEnum;
...
})(KmipWriteRoleRequestTlsClientKeyTypeEnum || (exports.KmipWriteRoleRequestTlsClientKeyTypeEnum = KmipWriteRoleRequestTlsClientKeyTypeEnum = {}));
/**
 * Check if a given object implements the KmipWriteRoleRequest interface.
 */
function instanceOfKmipWriteRoleRequest(value) {
    return true;
}
function KmipWriteRoleRequestFromJSON(json) {
    return KmipWriteRoleRequestFromJSONTyped(json, false);
}
function KmipWriteRoleRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function KmipWriteRoleRequestToJSON(json) {
    return KmipWriteRoleRequestToJSONTyped(json, false);
}
function KmipWriteRoleRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
