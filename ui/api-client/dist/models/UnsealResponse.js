...
exports.instanceOfUnsealResponse = instanceOfUnsealResponse;
exports.UnsealResponseFromJSON = UnsealResponseFromJSON;
exports.UnsealResponseFromJSONTyped = UnsealResponseFromJSONTyped;
exports.UnsealResponseToJSON = UnsealResponseToJSON;
exports.UnsealResponseToJSONTyped = UnsealResponseToJSONTyped;
/**
 * Check if a given object implements the UnsealResponse interface.
 */
function instanceOfUnsealResponse(value) {
    return true;
}
function UnsealResponseFromJSON(json) {
    return UnsealResponseFromJSONTyped(json, false);
}
function UnsealResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function UnsealResponseToJSON(json) {
    return UnsealResponseToJSONTyped(json, false);
}
function UnsealResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
