...
exports.instanceOfPkiReadAutoTidyConfigurationResponse = instanceOfPkiReadAutoTidyConfigurationResponse;
exports.PkiReadAutoTidyConfigurationResponseFromJSON = PkiReadAutoTidyConfigurationResponseFromJSON;
exports.PkiReadAutoTidyConfigurationResponseFromJSONTyped = PkiReadAutoTidyConfigurationResponseFromJSONTyped;
exports.PkiReadAutoTidyConfigurationResponseToJSON = PkiReadAutoTidyConfigurationResponseToJSON;
exports.PkiReadAutoTidyConfigurationResponseToJSONTyped = PkiReadAutoTidyConfigurationResponseToJSONTyped;
/**
 * Check if a given object implements the PkiReadAutoTidyConfigurationResponse interface.
 */
function instanceOfPkiReadAutoTidyConfigurationResponse(value) {
    return true;
}
function PkiReadAutoTidyConfigurationResponseFromJSON(json) {
    return PkiReadAutoTidyConfigurationResponseFromJSONTyped(json, false);
}
function PkiReadAutoTidyConfigurationResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PkiReadAutoTidyConfigurationResponseToJSON(json) {
    return PkiReadAutoTidyConfigurationResponseToJSONTyped(json, false);
}
function PkiReadAutoTidyConfigurationResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
