...
exports.instanceOfPkiWriteRoleResponse = instanceOfPkiWriteRoleResponse;
exports.PkiWriteRoleResponseFromJSON = PkiWriteRoleResponseFromJSON;
exports.PkiWriteRoleResponseFromJSONTyped = PkiWriteRoleResponseFromJSONTyped;
exports.PkiWriteRoleResponseToJSON = PkiWriteRoleResponseToJSON;
exports.PkiWriteRoleResponseToJSONTyped = PkiWriteRoleResponseToJSONTyped;
/**
 * Check if a given object implements the PkiWriteRoleResponse interface.
 */
function instanceOfPkiWriteRoleResponse(value) {
    return true;
}
function PkiWriteRoleResponseFromJSON(json) {
    return PkiWriteRoleResponseFromJSONTyped(json, false);
}
function PkiWriteRoleResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PkiWriteRoleResponseToJSON(json) {
    return PkiWriteRoleResponseToJSONTyped(json, false);
}
function PkiWriteRoleResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
