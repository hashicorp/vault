...
* @enum {string}
*/
export declare enum PkiIssuerIssueWithRoleRequestFormatEnum {
    PEM = "pem",
    DER = "der",
...
* @enum {string}
*/
export declare enum PkiIssuerIssueWithRoleRequestPrivateKeyFormatEnum {
    EMPTY = "",
    DER = "der",
    PEM = "pem",
    PKCS8 = "pkcs8"
 ...
 */
export declare function instanceOfPkiIssuerIssueWithRoleRequest(value: object): value is PkiIssuerIssueWithRoleRequest;
export declare function PkiIssuerIssueWithRoleRequestFromJSON(json: any): PkiIssuerIssueWithRoleRequest;
export declare function PkiIssuerIssueWithRoleRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PkiIssuerIssueWithRoleRequest;
export declare function PkiIssuerIssueWithRoleRequestToJSON(json: any): PkiIssuerIssueWithRoleRequest;
export declare function PkiIssuerIssueWithRoleRequestToJSONTyped(value?: PkiIssuerIssueWithRoleRequest | null, ignoreDiscriminator?: boolean): any;
