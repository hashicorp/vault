 ...
 * @param {Function} [onBlur] - action to preform when codemirror looses focus. This is used to update the value for the KVDataFields component. unlike onFocusOut this event does not bubble.
