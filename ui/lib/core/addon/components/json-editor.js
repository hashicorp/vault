 ...
 * @param {String} [viewportMargin] - Specifies the amount of lines that are rendered above and below the part of the document that's currently scrolled into view. For KVv2, we calculate the height of the editor based on the number of lines in the value. This is a way to ensure that the editor is tall enough to show all the lines. This also allows the user to search the secret using cntrl +f.
