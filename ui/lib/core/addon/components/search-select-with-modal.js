 ...
 * @param {string} [fallbackComponentPlaceholder] - specific placeholder text relevant to fallback component. In some cases, the placeholder text does not make sense for both the search-select and the fallback component. Ex: "key name" for input-search and "Search or type to create a new item" for search-select.
