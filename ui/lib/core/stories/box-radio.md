...
| key | <code>string</code> |  | value of this radio option. Please use a value without spaces. |
...
| onRadioChange | <code>function</code> |  | This callback will return selected radio's "key" when the radio option is selected |
