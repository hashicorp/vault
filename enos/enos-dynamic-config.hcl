...
globals {
  sample_attributes = {
    ...
    upgrade_initial_version = ["1.17.0", "1.17.1", "1.17.2", "1.17.3", "1.17.4", "1.17.5", "1.17.6", "1.18.0", "1.18.1", "1.18.2", "1.18.3", "1.18.4", "1.18.5", "1.19.0", "1.19.1", "1.19.2", "1.19.3", "1.19.4", "1.19.5"]
  }
}
