...
locals {
  ...
  rules_per_security_group_quota = "L-0EA8095F"
}
...
resource "aws_servicequotas_service_quota" "rules_per_security_group_us_east_1" {
  provider     = aws.us_east_1
  quota_code   = local.rules_per_security_group_quota
  service_code = "vpc"
  value        = 100
}

resource "aws_servicequotas_service_quota" "rules_per_security_group_us_east_2" {
  provider     = aws.us_east_2
  quota_code   = local.rules_per_security_group_quota
  service_code = "vpc"
  value        = 100
...
resource "aws_servicequotas_service_quota" "rules_per_security_group_us_west_1" {
  provider     = aws.us_west_1
  quota_code   = local.rules_per_security_group_quota
  service_code = "vpc"
  value        = 100
...
resource "aws_servicequotas_service_quota" "rules_per_security_group_us_west_2" {
  provider     = aws.us_west_2
  quota_code   = local.rules_per_security_group_quota
  service_code = "vpc"
  value        = 100
