...
* transform (enterprise): Add a `reference` field to batch items, and propagate it to the response
...
* http: Fix superfluous call messages from the http package on logs caused by missing returns after
...
* storage/postgresql: Add support for setting `connection_url` from environment
...
* secrets/database/cassandra: Add ability to skip verification of connection
...
* **Vault API explorer**: The Vault UI now includes an embedded API explorer
   where you can browse the endpoints available to you and make requests. To try
...
* replication: Stop forwarding before stopping replication to eliminate some
   possible bad states
* secrets/database: Allow cassandra queries to be canceled [[GH-6954](https://github.com/hashicorp/vault/pull/6954)]
...
* ui: Support for authentication via the RADIUS auth method [[GH-6488](https://github.com/hashicorp/vault/pull/6488)]
...
* ui: Display additional wrap info when unwrapping. [[GH-5664](https://github.com/hashicorp/vault/pull/5664)]
