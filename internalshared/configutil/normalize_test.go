...
func TestNormalizeAddr(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"ipv6 destination address no brackets": {
			addr:     "username@2001:0db8::0001:8500",
			expected: "username@2001:db8::1:8500",
		},
		"ipv6 destination address with brackets": {
			addr:     "username@[2001:0db8::0001]:8500",
			expected: "username@[2001:db8::1]:8500",
		},
		...
		"ipv6 destination address RFC-5952 4.1 conformance leading zeroes": {
		...
		"ipv6 destination address RFC-5952 4.2.2 conformance one 16-bit 0 field": {
		...
		"ipv6 destination address RFC-5952 4.2.3 conformance longest run of 0 bits shortened": {
		...
		"ipv6 destination address RFC-5952 4.2.3 conformance equal runs of 0 bits shortened": {
		...
		"ipv6 destination address RFC-5952 4.3 conformance downcase hex letters": {
