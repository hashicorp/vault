...
Make sure you have the FoundationDB client library installed on your system,
along with Mono (core is enough), as they are necessary to install the Go bindings
for FoundationDB.
